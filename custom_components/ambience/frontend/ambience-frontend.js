...
`;function bt(t,r){return l`<span class="category-swatch" style=${ji(t)}>
    ...
    `],c([m({attribute:!1})],he.prototype,"hass",2),c([f()],he.prototype,"_categories",2),c([f()],he.prototype,"_filterCategory",2),c([f()],he.prototype,"_open",2),c([f()],he.prototype,"_loaded",2),he=c([w("ambience-category-filter")],he);var Se={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ui=t=>(...r)=>({_$litDirective$:t,values:r}),wt=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,i){this._$Ct=r,this._$AM=e,this._$Ci=i}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var{I:Dl}=Zn,hs=t=>t;var _s=t=>t.strings===void 0,ms=()=>document.createComment(""),xt=(t,r,e)=>{let i=t._$AA.parentNode,n=r===void 0?t._$AB:r._$AA;if(e===void 0){let o=i.insertBefore(ms(),n),s=i.insertBefore(ms(),n);e=new Dl(o,s,t,t.options)}else{let o=e._$AB.nextSibling,s=e._$AM,d=s!==t;if(d){let u;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(u=t._$AU)!==s._$AU&&e._$AP(u)}if(o!==n||d){let u=e._$AA;for(;u!==o;){let p=hs(u).nextSibling;hs(i).insertBefore(u,n),u=p}}}return e},Ie=(t,r,e=t)=>(t._$AI(r,e),t),Hl={},Wi=(t,r=Hl)=>t._$AH=r,fs=t=>t._$AH,Vi=t=>{t._$AR(),t._$AA.remove()};var gs=(t,r,e)=>{let i=new Map;for(let n=r;n<=e;n++)i.set(t[n],n);return i},vs=Ui(class extends wt{constructor(t){if(super(t),t.type!==Se.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,r,e){let i;e===void 0?e=r:r!==void 0&&(i=r);let n=[],o=[],s=0;for(let d of t)n[s]=i?i(d,s):s,o[s]=e(d,s),s++;return{values:o,keys:n}}render(t,r,e){return this.dt(t,r,e).values}update(t,[r,e,i]){let n=fs(t),{values:o,keys:s}=this.dt(r,e,i);if(!Array.isArray(n))return this.ut=s,o;let d=this.ut??=[],u=[],p,h,_=0,g=n.length-1,v=0,x=o.length-1;for(;_<=g&&v<=x;)if(n[_]===null)_++;else if(n[g]===null)g--;else if(d[_]===s[v])u[v]=Ie(n[_],o[v]),_++,v++;else if(d[g]===s[x])u[x]=Ie(n[g],o[x]),g--,x--;else if(d[_]===s[x])u[x]=Ie(n[_],o[x]),xt(t,u[x+1],n[_]),_++,x--;else if(d[g]===s[v])u[v]=Ie(n[g],o[v]),xt(t,n[_],n[g]),g--,v++;else if(p===void 0&&(p=gs(s,v,x),h=gs(d,_,g)),p.has(d[_]))if(p.has(d[g])){let C=h.get(s[v]),P=C!==void 0?n[C]:null;if(P===null){let Q=xt(t,n[_]);Ie(Q,o[v]),u[v]=Q}else u[v]=Ie(P,o[v]),xt(t,n[_],P),n[C]=null;v++}else Vi(n[g]),g--;else Vi(n[_]),_++;for(;v<=x;){let C=xt(t,u[x+1]);Ie(C,o[v]),u[v++]=C}for(;_<=g;){let C=n[_++];C!==null&&Vi(C)}return this.ut=s,Wi(t,u),J}});function Bi(t,r){let e=t.entities?.[r];return e?e.area_id!=null?e.area_id:e.device_id?t.devices?.[e.device_id]?.area_id??null:null:null}function D(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function Gi(t,r){return r==null?{kind:"house"}:{kind:t,id:r}}function ys(t,r){return`${D(t)}\0${r}`}function Ee(t,r){return ys(t,r)}function Ki(t,r){return ys(t,r)}function bs(t,r){if(!r||r.entity==null)return[...t];let e=Array.isArray(r.entity)?r.entity:[r.entity];if(e.length===0)return[...t];let i=new Set,n=!1;for(let o of e){if(!o||typeof o!="object")continue;let s=o.domain;if(s==null){n=!0;continue}if(Array.isArray(s))for(let d of s)typeof d=="string"&&i.add(d);else typeof s=="string"&&i.add(s)}return n||i.size===0?[...t]:t.filter(o=>{let s=o.indexOf(".");return s<0?!1:i.has(o.slice(0,s))})}function Yi(t,r,e=[]){let i=t;if(!i?.entities)return[];let n=i.entities,o=i.areas??{},s=r.kind==="area"?new Set([r.id]):r.kind==="floor"?new Set(Object.values(o).filter(u=>u.floor_id===r.id).map(u=>u.area_id)):null,d=u=>{let p=Bi(i,u.entity_id);return p==null?!1:s===null?!0:s.has(p)};return Object.values(n).filter(d).filter(u=>u.platform!=="ambience").filter(u=>e.length===0||e.includes(u.entity_id.split(".")[0])).map(u=>u.entity_id).sort()}var Zr=Ui(class extends wt{constructor(t){if(super(t),t.type!==Se.PROPERTY&&t.type!==Se.ATTRIBUTE&&t.type!==Se.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!_s(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[r]){if(r===J||r===$)return r;let e=t.element,i=t.name;if(t.type===Se.PROPERTY){if(r===e[i])return J}else if(t.type===Se.BOOLEAN_ATTRIBUTE){if(!!r===e.hasAttribute(i))return J}else if(t.type===Se.ATTRIBUTE&&e.getAttribute(i)===r+"")return J;return Wi(t),r}});function $t(t){let{checked:r,dataTest:e,onChange:i,className:n,onClick:o,disabled:s}=t;return customElements.get("ha-switch")?l`<ha-switch
      class=${n??$}
      data-test=${e}
      ?disabled=${s??!1}
      .checked=${Zr(r)}
    ...
    @click=${o}
    @change=${i}
  />`}function Yt(t){let{priority:r,pinned:e,shadowed_by:i,...n}=t;return n}function ws(t,r){if(r<0||r>=t.length)return[];let e=new Set(t[r].entity_ids??[]),i=new Set;return t.forEach((n,o)=>{if(o!==r)for(let s of n.entity_ids??[])e.has(s)||i.add(s)}),[...i]}var en={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Qt(t,r){return t.kind==="house"?en.house:t.kind==="floor"?r?.floors?.[t.id]?.icon||en.floor:r?.areas?.[t.id]?.icon||en.area}var xs=y`
  .banner {
    display: flex;
...
`;var le=class extends b{constructor(){super(...arguments);this.icon="";this.ctaLabel="";this.ctaHref="";this.dismissLabel="";this.hint=!1;this.dismissible=!0}_onDismiss(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("banner-dismiss",{bubbles:!0,composed:!0}))}_onCta(){this.dispatchEvent(new CustomEvent("banner-cta",{bubbles:!0,composed:!0}))}_renderCta(){return this.ctaLabel?this.ctaHref?l`<a
    ...
    `],c([m()],le.prototype,"icon",2),c([m()],le.prototype,"ctaLabel",2),c([m()],le.prototype,"ctaHref",2),c([m()],le.prototype,"dismissLabel",2),c([m({type:Boolean})],le.prototype,"hint",2),c([m({type:Boolean})],le.prototype,"dismissible",2),le=c([w("ambience-banner")],le);var tn="https://github.com/clintongormley/ambience";function $s(t,r){let e=new URLSearchParams({labels:"translation",title:`Translation request: ${r} (${t})`,body:[`I'd like Ambience to be translated into: **${r}** (\`${t}\`).`,"","- [ ] I'm happy to review the translations"].join(`
`)});return`${tn}/issues/new?${e.toString()}`}var Il="Ambience",nt=class extends b{constructor(){super(...arguments);this._visible=!1;this._href="";this._message="";this._actionLabel="";this._dismissLabel="";this._code="";this._dismissedCodes=new Set}willUpdate(e){if(!e.has("hass"))return;let i=no(this.hass);if(i.available||this._dismissedCodes.has(i.code)||To(i.code)){this._visible=!1;return}this._code=i.code;let n=oo(i.code);this._href=$s(i.code,n),this._message=this._buildMessage(n),this._actionLabel=a(this.hass,"ui.language_request.action","Request a translation \u2192"),this._dismissLabel=a(this.hass,"ui.language_request.dismiss","Dismiss"),this._visible=!0}_dismiss(){this._dismissedCodes.add(this._code),Po(this._code),this._visible=!1}_buildMessage(e){let n=a(this.hass,"ui.language_request.message","Your Home Assistant language is {language}, but {product} isn't translated into it yet.").split(/\{(language|product)\}/).map((o,s)=>s%2===0?o:l`<strong>${o==="language"?e:Il}</strong>`);return l`<span class="message">${n}</span>`}render(){return this._visible?l`
      <ambience-banner
  ...
  `,c([m({attribute:!1})],Oe.prototype,"hass",2),c([m({attribute:!1})],Oe.prototype,"value",2),c([m({attribute:!1})],Oe.prototype,"mode",2),Oe=c([w("ambience-for-duration")],Oe);function ii(t,r,e){if(r&&e){let i=e[r]?.fields?.[t];if(i&&typeof i=="object"){let n=i.name;if(typeof n=="string"&&n)return n}}return z(t)}function or(t,r,e){return t.name?.trim()?t.name:r??a(e,"ui.new_scene_default","New scene")}function Lt(t,r,e){return r==null?a(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?lr(r,e):t==="day"?Wl(r,e):t==="weather"?Kl(r,e):t==="sun"?Yl(r,e):t==="state"?cn(r,e):t==="script"?ql(r,e):t==="people"?Ul(r,e):t==="occupancy"?Ql(r,e):t==="unavailable"?id(r,e):t==="lux"?rd(r,e):t==="template"?jl(r,e):String(r)}function jl(t,r={}){return t===null?a(r.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function ql(t,r={}){if(t===null)return a(r.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=ei(r,t.script),i=t.args??{},n=Object.keys(i).sort();if(n.length===0)return e;let o=n.map(s=>`${sn(r.hass,t.script,s)}: ${Me(r.hass,i[s])}`).join(", ");return`${e} (${o})`}function sn(t,r,e){let i=r.replace(/^script\./,""),o=t?.services?.script?.[i]?.fields?.[e]?.name;return typeof o=="string"&&o?o:z(e)}function ei(t,r){let i=t.hass?.states?.[r]?.attributes?.friendly_name;if(typeof i=="string"&&i)return i;let n=r.indexOf("."),o=n>=0?r.slice(n+1):r;return o.charAt(0).toUpperCase()+o.slice(1)}function Ps(t,r){return t==="home"?a(r.hass,"people_summary.home","Home"):ei(r,t)}function Ul(t,r={}){if(t==null)return a(r.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let s=ei(r,t.who[0]),u=t.quant==="nobody"!=!!t.negate?a(r.hass,"people_summary.is_not_at","is not at"):a(r.hass,"people_summary.is_at","is at"),p=`${s} ${u} ${Ps(e,r)}`;return t.for&&ti(t.for)?`${p} ${a(r.hass,"ui.for_prefix","for")} ${Xt(t.for_mode)}${nr(t.for)}`:p}let i;if(Array.isArray(t.who)){let s=t.quant??"any",d=s==="any"?a(r.hass,"ui.people_mode_any","Any of:"):s==="everyone"?a(r.hass,"ui.people_mode_all","All of:"):a(r.hass,"ui.people_mode_none","None of:"),u=t.who.map(p=>ei(r,p)).join(", ");i=`${d} (${u})`}else{let s=t.quant??"any";i=s==="nobody"?a(r.hass,"ui.people_mode_nobody","Nobody"):s==="any"?a(r.hass,"ui.people_mode_anybody","Anybody"):a(r.hass,"ui.people_mode_everybody","Everybody")}let n=t.negate?a(r.hass,"people_summary.is_not_at","is not at"):a(r.hass,"people_summary.is_at","is at"),o=`${i} ${n} ${Ps(e,r)}`;return t.for&&ti(t.for)?`${o} ${a(r.hass,"ui.for_prefix","for")} ${Xt(t.for_mode)}${nr(t.for)}`:o}function Wl(t,r={}){if(t===null)return a(r.hass,"day_summary.any","any");let e=t.include??[],i=t.exclude??[],n=e.length===0?a(r.hass,"day_summary.any_day","any day"):e.map(s=>Rs(s,r)).join(", ");if(i.length===0)return n;let o=a(r.hass,"day_summary.except","except");return`${n} (${o} ${i.map(s=>Rs(s,r)).join(", ")})`}function Rs(t,r){switch(t.kind){case"weekday":return t.days.map(e=>Ri(r.hass,e)).join("/");case"day_of_month":return`${a(r.hass,"day_summary.day_prefix","day")} ${t.days}`;case"date":return`${vt(r.hass,t.month)} ${t.day}`;case"date_range":return`${vt(r.hass,t.from.month)} ${t.from.day} \u2192 ${vt(r.hass,t.to.month)} ${t.to.day}`;case"last_day":return a(r.hass,"day_summary.last_day","last day");case"workday":return a(r.hass,"day_summary.workday","workday");case"holiday":return a(r.hass,"day_summary.holiday","holiday");case"first_workday":return a(r.hass,"day_summary.first_workday","first workday");case"last_workday":return a(r.hass,"day_summary.last_workday","last workday")}}function an(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var Vl=["entity_id","device_id","area_id","label_id","floor_id"],Ds=2;function Bl(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let r=t;if(!Object.keys(r).every(n=>Vl.includes(n)))return null;let e=r.entity_id,i=typeof e=="string"?[e]:Array.isArray(e)?e.filter(n=>typeof n=="string"):[];return i.length?i:null}function Me(t,r){let e=Bl(r);if(!e)return an(r);let i=e.slice(0,Ds).map(s=>ei({hass:t},s)),n=e.length-Ds;return`[${n>0?`${i.join(", ")} +${n} more`:i.join(", ")}]`}function sr(t){if(!(!t||typeof t!="object")){for(let r of Object.values(t))if(r&&typeof r=="object"){let e=r.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function Gl(t){return t.split(/[\s_-]+/).filter(r=>r!=="").map(r=>r.charAt(0).toUpperCase()+r.slice(1).toLowerCase()).join(" ")}function Kl(t,r={}){if(t===null)return a(r.hass,"ui.summary_any","any");let e=new Map((r.weatherGroups??[]).map(s=>[s.id,s.label])),i=(t.groups??[]).map(s=>e.get(s)??Gl(s)).join("/"),n=(t.thresholds??[]).map(s=>`${qt(r.hass,s.attribute)} ${j(r.hass,s.op)} ${s.value}`).join(", "),o=[i,n].filter(s=>s!=="");return o.length===0?a(r.hass,"ui.summary_any","any"):o.join(", ")}function Yl(t,r={}){if(t===null)return a(r.hass,"ui.summary_any","any");let e=[],i=t.elevation;i&&(i.min!=null&&i.max!=null?e.push(`${i.min}\xB0\u2013${i.max}\xB0`):i.min!=null?e.push(`\u2265${i.min}\xB0`):i.max!=null&&e.push(`\u2264${i.max}\xB0`));let n=t.azimuth;if(n){n.sectors?.length&&e.push(n.sectors.join("/"));for(let o of n.ranges??[])e.push(`${o.from}\xB0\u2013${o.to}\xB0`)}return e.length===0?a(r.hass,"ui.summary_any","any"):e.join(", ")}function ar(t,r){return Ts(t.hass,r)}function ln(t,r,e,i,n={}){let o=n.negate?`${a(t.hass,`${r}.not`,"not")} `:"";if(e.length===1)return`${e[0]} ${a(t.hass,`${r}.is`,"is")} ${o}${i}`;let s=n.all===!0,d=s?a(t.hass,`${r}.all_of`,"All of"):a(t.hass,`${r}.any_of`,"Any of"),u=s?a(t.hass,`${r}.are`,"are"):a(t.hass,`${r}.is`,"is");return`${d} (${e.join(", ")}) ${u} ${o}${i}`}function Ql(t,r={}){if(t==null||!t.sensors?.length)return a(r.hass,"ui.summary_any","any");let e=t.sensors.map(o=>ar(r,o)),i=t.occupied===!1?a(r.hass,"occupancy_summary.clear","clear"):a(r.hass,"occupancy_summary.detected","detected"),n=ln(r,"occupancy_summary",e,i,{all:t.quant==="all",negate:t.negate});return t.for&&ti(t.for)?`${n} ${a(r.hass,"ui.for_prefix","for")} ${Xt(t.for_mode)}${nr(t.for)}`:n}function Jl(t,r){if(r==null||typeof r!="object")return!1;if(t==="occupancy"||t==="lux")return!!r.negate;if(t==="people"){let e=r;return!!e.negate&&Array.isArray(e.who)&&e.who.length===1}return!1}function Xl(t){return{...t,negate:!1}}function rn(t){if(t.kind==="and"||t.kind==="or"){let r=t.items.map(rn);return r.length===1?r[0]:{...t,items:r}}return t.kind==="not"?{...t,item:rn(t.item)}:t}function Zt(t){if(t.kind==="is_not")return t.for&&ti(t.for)?null:{...t,kind:"is"};if(t.kind==="not"){let r=t.item.kind;return r==="is"||r===">"||r===">="||r==="<"||r==="<="||r==="and"||r==="or"?t.item:null}if(t.kind==="or"){let r=[];for(let e of t.items){let i=Zt(e);if(!i)return null;r.push(i)}return r.length===1?r[0]:{kind:"and",items:r}}return null}function Zl(t,r){let e=At("state",t,r);return(t.kind==="and"||t.kind==="or")&&t.items.length>1?`(${e})`:e}function tr(t,r,e){let i=[],n=[];for(let h of t.items){let _=Zt(h);_?n.push(_):i.push(h)}let o=` ${j(r.hass,"or")} `,s=i.map(h=>nn(h,r)).join(o),d="";if(n.length){let h=n.length===1?n[0]:{kind:"and",items:n};d=`${a(r.hass,"blocker_summary.until","until")} ${Zl(h,r)}`}let u=[s,d].filter(h=>h!=="").join(o),p=i.length+(n.length?1:0);return e&&p>1?`(${u})`:u}function ir(t,r){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return rr(t,r,!1);if(t.kind==="and"){let e=` ${j(r.hass,"and")} `;return t.items.map(i=>nn(i,r)).join(e)}if(t.kind==="or")return tr(t,r,!1);if(t.kind==="not"){let e=t.item;return e.kind==="is"?rr(e,r,!0):`${j(r.hass,"not")} ${nn(e,r)}`}return""}function nn(t,r){return t.kind==="or"?tr(t,r,!0):t.kind==="and"?`(${ir(t,r)})`:ir(t,r)}function ed(t,r,e){let i=rn(t);if(i.kind==="and"){let o=[],s=[];for(let p of i.items){let h=Zt(p);h?s.push(h):o.push(p)}let d=[];if(o.length>0){let p=o.length===1?o[0]:{kind:"and",items:o};d=[p.kind==="or"?tr(p,r,!e):ir(p,r)]}let u=s.map(p=>At("state",p,r));return{guards:d,releases:u}}if(i.kind==="or"){let o=Zt(i);return o?{guards:[],releases:[At("state",o,r)]}:{guards:[tr(i,r,!e)],releases:[]}}let n=Zt(i);return n?{guards:[],releases:[At("state",n,r)]}:{guards:[ir(i,r)],releases:[]}}var td=new Set(["occupancy","people","state","lux","unavailable","script","template","day","time_of_day","weather"]);function At(t,r,e){let i=Lt(t,r,e);return td.has(t)?i:`${G(e.hass,t)}: ${i}`}function Ns(t,r={}){let e=a(r.hass,"blocker_summary.block","Block"),i=Object.keys(t.when).filter(_=>t.when[_]!=null);if(r.priorities){let _=r.priorities;i=i.sort((g,v)=>{let x=_.get(g),C=_.get(v);return x===void 0&&C===void 0?0:(C??-1/0)-(x??-1/0)})}let n=[],o=[];for(let _ of i){let g=t.when[_];if(_==="state"){let v=ed(g,r,i.length===1);o.push(...v.guards),n.push(...v.releases);continue}Jl(_,g)?n.push(At(_,Xl(g),r)):o.push(At(_,g,r))}let s=a(r.hass,"blocker_summary.until","until"),d=` ${a(r.hass,"blocker_summary.or","or")} `,u=` ${a(r.hass,"blocker_summary.and","and")} `,p=n.join(d),h=o.join(u);if(n.length&&o.length){let _=a(r.hass,"blocker_summary.while_lead","While"),g=a(r.hass,"blocker_summary.block_mid","block");return`${_} ${h}, ${g} ${s} ${p}`}if(n.length)return`${e} ${s} ${p}`;if(o.length){let _=a(r.hass,"blocker_summary.while","while");return`${e} ${_} ${h}`}return`${e} ${a(r.hass,"blocker_summary.always","always")}`}function id(t,r={}){if(t==null||!t.entities?.length)return a(r.hass,"ui.summary_any","any");let e=t.entities.map(n=>ar(r,n)),i=a(r.hass,"unavailable_summary.unavailable","unavailable");return ln(r,"unavailable_summary",e,i)}function dn(t,r,e="any lux"){return t!=null&&r!=null?`${t}\u2013${r} lx`:r!=null?`<${r} lx`:t!=null?`\u2265${t} lx`:e}function rd(t,r={}){if(t==null||!t.sensors?.length)return a(r.hass,"ui.summary_any","any");let e=t.sensors.map(n=>ar(r,n)),i=t.range!=null?De(r.hass,t.range,r.luxRanges?.custom??{}):dn(t.min,t.max);return ln(r,"lux_summary",e,i,{all:t.quant==="all",negate:t.negate})}function cn(t,r={}){return t==null?a(r.hass,"ui.summary_any","any"):on(t,r)}function rr(t,r,e){let i=j(r.hass,t.kind),n=ar(r,t.entity_id),o=r.hass?.states?.[t.entity_id],d=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.map(_=>Re(r.hass,o,t.attribute,_)).join("/"),u=t.attribute?`${n}.${Ti(r.hass,o,t.attribute)}`:n,p=e?`${j(r.hass,"not")} `:"",h=`${u} ${i} ${p}${d}`;return t.for&&ti(t.for)?`${h} ${a(r.hass,"ui.for_prefix","for")} ${Xt(t.for_mode)}${nr(t.for)}`:h}function on(t,r){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return rr(t,r,!1);if(t.kind==="and"||t.kind==="or"){let e=` ${j(r.hass,t.kind)} `;return t.items.map(i=>Hs(i,r)).join(e)}if(t.kind==="not"){let e=t.item;return e.kind==="is"?rr(e,r,!0):`${j(r.hass,"not")} ${Hs(e,r)}`}return""}function Hs(t,r){return t.kind==="and"||t.kind==="or"?`(${on(t,r)})`:on(t,r)}function ti(t){return t.h>0||t.m>0||t.s>0}function nr(t){let r=[];return t.h&&r.push(`${t.h}h`),t.m&&r.push(`${t.m}m`),t.s&&r.push(`${t.s}s`),r.length?r.join(" "):"0s"}function lr(t,r){if(t===null)return a(r.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],i=r.periods?.custom??{};return e.map(n=>"period"in n?pe(r.hass,n.period,i):`${Is(n.from,r)} \u2192 ${Is(n.to,r)}`).join(", ")}function Is(t,r){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=re(r.hass,t.anchor),i=e;if(t.offset_min!==0){let n=Math.abs(t.offset_min),o=n%60===0?`${n/60}${a(r.hass,"ui.unit_hour_abbr","h")}`:`${n}${a(r.hass,"ui.unit_min_abbr","m")}`;i=`${e}${t.offset_min<0?"-":"+"}${o}`}if(t.clamp){let n=t.clamp.dir==="not_before"?a(r.hass,"ui.clamp_not_before","not before"):a(r.hass,"ui.clamp_not_after","not after"),o=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;i=`${i} (${n} ${o})`}return i}function nd(t,r){return gt(t.service,r.exposedActions,()=>r.schemas?.[t.service]?.name?.trim()||Pi(r.hass,t.service))}function od(t,r){let e=new Set;for(let i of t.entity_ids){let n=i.indexOf(".");n>0&&e.add(i.slice(0,n))}return e.size===1?[...e][0]:a(r.hass,"ui.target_noun","target")}function Os(t,r){let e=nd(t,r),i=od(t,r),n=t.entity_ids.length,o;n===0?o=a(r.hass,"ui.no_targets","(no targets)"):n===1?o=`1 ${i}`:o=`${n} ${i}s`;let s=Object.entries(t.params).filter(([,d])=>d!=null&&d!=="").map(([d,u])=>`${ii(d,t.service,r.schemas)}: ${Me(r.hass,u)}`).join(", ");return s?`${e}: ${o}, ${s}`:`${e}: ${o}`}var N=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this.collapsedCategories=[];this.liveSuppressed=!1;this._drag=new St(this,(e,i)=>this._emit("reorder-scenes",{from:e,to:i}));this._expanded=new Set}willUpdate(e){e.has("scenes")&&(this._expanded=new Set)}_renderSectionHeader(e,i,n){return l`<div
...
`;return d.replace(/\n$/,"")}var vd=gd,yd=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],bd=["scalar","sequence","mapping"];function wd(t){var r={};return t!==null&&Object.keys(t).forEach(function(e){t[e].forEach(function(i){r[String(i)]=e})}),r}function xd(t,r){if(r=r||{},Object.keys(r).forEach(function(e){if(yd.indexOf(e)===-1)throw new Z('Unknown option "'+e+'" is met in definition of "'+t+'" YAML type.')}),this.options=r,this.tag=t,this.kind=r.kind||null,this.resolve=r.resolve||function(){return!0},this.construct=r.construct||function(e){return e},this.instanceOf=r.instanceOf||null,this.predicate=r.predicate||null,this.represent=r.represent||null,this.representName=r.representName||null,this.defaultStyle=r.defaultStyle||null,this.multi=r.multi||!1,this.styleAliases=wd(r.styleAliases||null),bd.indexOf(this.kind)===-1)throw new Z('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var W=xd;function Ms(t,r){var e=[];return t[r].forEach(function(i){var n=e.length;e.forEach(function(o,s){o.tag===i.tag&&o.kind===i.kind&&o.multi===i.multi&&(n=s)}),e[n]=i}),e}function $d(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},r,e;function i(n){n.multi?(t.multi[n.kind].push(n),t.multi.fallback.push(n)):t[n.kind][n.tag]=t.fallback[n.tag]=n}for(r=0,e=arguments.length;r<e;r+=1)arguments[r].forEach(i);return t}function mn(t){return this.extend(t)}mn.prototype.extend=function(r){var e=[],i=[];if(r instanceof W)i.push(r);else if(Array.isArray(r))i=i.concat(r);else if(r&&(Array.isArray(r.implicit)||Array.isArray(r.explicit)))r.implicit&&(e=e.concat(r.implicit)),r.explicit&&(i=i.concat(r.explicit));else throw new Z("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.forEach(function(o){if(!(o instanceof W))throw new Z("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(o.loadKind&&o.loadKind!=="scalar")throw new Z("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(o.multi)throw new Z("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(o){if(!(o instanceof W))throw new Z("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var n=Object.create(mn.prototype);return n.implicit=(this.implicit||[]).concat(e),n.explicit=(this.explicit||[]).concat(i),n.compiledImplicit=Ms(n,"implicit"),n.compiledExplicit=Ms(n,"explicit"),n.compiledTypeMap=$d(n.compiledImplicit,n.compiledExplicit),n};var kd=mn,Cd=new W("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),Sd=new W("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),Ed=new W("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),Ad=new kd({explicit:[Cd,Sd,Ed]});function Ld(t){if(t===null)return!0;var r=t.length;return r===1&&t==="~"||r===4&&(t==="null"||t==="Null"||t==="NULL")}function Td(){return null}function Pd(t){return t===null}var Rd=new W("tag:yaml.org,2002:null",{kind:"scalar",resolve:Ld,construct:Td,predicate:Pd,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Dd(t){if(t===null)return!1;var r=t.length;return r===4&&(t==="true"||t==="True"||t==="TRUE")||r===5&&(t==="false"||t==="False"||t==="FALSE")}function Hd(t){return t==="true"||t==="True"||t==="TRUE"}function Id(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var Nd=new W("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Dd,construct:Hd,predicate:Id,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function Od(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function Md(t){return 48<=t&&t<=55}function Fd(t){return 48<=t&&t<=57}function zd(t){if(t===null)return!1;var r=t.length,e=0,i=!1,n;if(!r)return!1;if(n=t[e],(n==="-"||n==="+")&&(n=t[++e]),n==="0"){if(e+1===r)return!0;if(n=t[++e],n==="b"){for(e++;e<r;e++)if(n=t[e],n!=="_"){if(n!=="0"&&n!=="1")return!1;i=!0}return i&&n!=="_"}if(n==="x"){for(e++;e<r;e++)if(n=t[e],n!=="_"){if(!Od(t.charCodeAt(e)))return!1;i=!0}return i&&n!=="_"}if(n==="o"){for(e++;e<r;e++)if(n=t[e],n!=="_"){if(!Md(t.charCodeAt(e)))return!1;i=!0}return i&&n!=="_"}}if(n==="_")return!1;for(;e<r;e++)if(n=t[e],n!=="_"){if(!Fd(t.charCodeAt(e)))return!1;i=!0}return!(!i||n==="_")}function jd(t){var r=t,e=1,i;if(r.indexOf("_")!==-1&&(r=r.replace(/_/g,"")),i=r[0],(i==="-"||i==="+")&&(i==="-"&&(e=-1),r=r.slice(1),i=r[0]),r==="0")return 0;if(i==="0"){if(r[1]==="b")return e*parseInt(r.slice(2),2);if(r[1]==="x")return e*parseInt(r.slice(2),16);if(r[1]==="o")return e*parseInt(r.slice(2),8)}return e*parseInt(r,10)}function qd(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!M.isNegativeZero(t)}var Ud=new W("tag:yaml.org,2002:int",{kind:"scalar",resolve:zd,construct:jd,predicate:qd,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Wd=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Vd(t){return!(t===null||!Wd.test(t)||t[t.length-1]==="_")}function Bd(t){var r,e;return r=t.replace(/_/g,"").toLowerCase(),e=r[0]==="-"?-1:1,"+-".indexOf(r[0])>=0&&(r=r.slice(1)),r===".inf"?e===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:r===".nan"?NaN:e*parseFloat(r,10)}var Gd=/^[-+]?[0-9]+e/;function Kd(t,r){var e;if(isNaN(t))switch(r){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(r){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(r){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(M.isNegativeZero(t))return"-0.0";return e=t.toString(10),Gd.test(e)?e.replace("e",".e"):e}function Yd(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||M.isNegativeZero(t))}var Qd=new W("tag:yaml.org,2002:float",{kind:"scalar",resolve:Vd,construct:Bd,predicate:Yd,represent:Kd,defaultStyle:"lowercase"}),Jd=Ad.extend({implicit:[Rd,Nd,Ud,Qd]}),Xd=Jd,ta=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),ia=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Zd(t){return t===null?!1:ta.exec(t)!==null||ia.exec(t)!==null}function ec(t){var r,e,i,n,o,s,d,u=0,p=null,h,_,g;if(r=ta.exec(t),r===null&&(r=ia.exec(t)),r===null)throw new Error("Date resolve error");if(e=+r[1],i=+r[2]-1,n=+r[3],!r[4])return new Date(Date.UTC(e,i,n));if(o=+r[4],s=+r[5],d=+r[6],r[7]){for(u=r[7].slice(0,3);u.length<3;)u+="0";u=+u}return r[9]&&(h=+r[10],_=+(r[11]||0),p=(h*60+_)*6e4,r[9]==="-"&&(p=-p)),g=new Date(Date.UTC(e,i,n,o,s,d,u)),p&&g.setTime(g.getTime()-p),g}function tc(t){return t.toISOString()}var ic=new W("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Zd,construct:ec,instanceOf:Date,represent:tc});function rc(t){return t==="<<"||t===null}var nc=new W("tag:yaml.org,2002:merge",{kind:"scalar",resolve:rc}),yn=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function oc(t){if(t===null)return!1;var r,e,i=0,n=t.length,o=yn;for(e=0;e<n;e++)if(r=o.indexOf(t.charAt(e)),!(r>64)){if(r<0)return!1;i+=6}return i%8===0}function sc(t){var r,e,i=t.replace(/[\r\n=]/g,""),n=i.length,o=yn,s=0,d=[];for(r=0;r<n;r++)r%4===0&&r&&(d.push(s>>16&255),d.push(s>>8&255),d.push(s&255)),s=s<<6|o.indexOf(i.charAt(r));return e=n%4*6,e===0?(d.push(s>>16&255),d.push(s>>8&255),d.push(s&255)):e===18?(d.push(s>>10&255),d.push(s>>2&255)):e===12&&d.push(s>>4&255),new Uint8Array(d)}function ac(t){var r="",e=0,i,n,o=t.length,s=yn;for(i=0;i<o;i++)i%3===0&&i&&(r+=s[e>>18&63],r+=s[e>>12&63],r+=s[e>>6&63],r+=s[e&63]),e=(e<<8)+t[i];return n=o%3,n===0?(r+=s[e>>18&63],r+=s[e>>12&63],r+=s[e>>6&63],r+=s[e&63]):n===2?(r+=s[e>>10&63],r+=s[e>>4&63],r+=s[e<<2&63],r+=s[64]):n===1&&(r+=s[e>>2&63],r+=s[e<<4&63],r+=s[64],r+=s[64]),r}function lc(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var dc=new W("tag:yaml.org,2002:binary",{kind:"scalar",resolve:oc,construct:sc,predicate:lc,represent:ac}),cc=Object.prototype.hasOwnProperty,uc=Object.prototype.toString;function pc(t){if(t===null)return!0;var r=[],e,i,n,o,s,d=t;for(e=0,i=d.length;e<i;e+=1){if(n=d[e],s=!1,uc.call(n)!=="[object Object]")return!1;for(o in n)if(cc.call(n,o))if(!s)s=!0;else return!1;if(!s)return!1;if(r.indexOf(o)===-1)r.push(o);else return!1}return!0}function hc(t){return t!==null?t:[]}var mc=new W("tag:yaml.org,2002:omap",{kind:"sequence",resolve:pc,construct:hc}),_c=Object.prototype.toString;function fc(t){if(t===null)return!0;var r,e,i,n,o,s=t;for(o=new Array(s.length),r=0,e=s.length;r<e;r+=1){if(i=s[r],_c.call(i)!=="[object Object]"||(n=Object.keys(i),n.length!==1))return!1;o[r]=[n[0],i[n[0]]]}return!0}function gc(t){if(t===null)return[];var r,e,i,n,o,s=t;for(o=new Array(s.length),r=0,e=s.length;r<e;r+=1)i=s[r],n=Object.keys(i),o[r]=[n[0],i[n[0]]];return o}var vc=new W("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:fc,construct:gc}),yc=Object.prototype.hasOwnProperty;function bc(t){if(t===null)return!0;var r,e=t;for(r in e)if(yc.call(e,r)&&e[r]!==null)return!1;return!0}function wc(t){return t!==null?t:{}}var xc=new W("tag:yaml.org,2002:set",{kind:"mapping",resolve:bc,construct:wc}),ra=Xd.extend({implicit:[ic,nc],explicit:[dc,mc,vc,xc]}),ze=Object.prototype.hasOwnProperty,dr=1,na=2,oa=3,cr=4,hn=1,$c=2,Fs=3,kc=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Cc=/[\x85\u2028\u2029]/,Sc=/[,\[\]\{\}]/,sa=/^(?:!|!!|![a-z\-]+!)$/i,aa=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function zs(t){return Object.prototype.toString.call(t)}function fe(t){return t===10||t===13}function at(t){return t===9||t===32}function ee(t){return t===9||t===32||t===10||t===13}function Pt(t){return t===44||t===91||t===93||t===123||t===125}function Ec(t){var r;return 48<=t&&t<=57?t-48:(r=t|32,97<=r&&r<=102?r-97+10:-1)}function Ac(t){return t===120?2:t===117?4:t===85?8:0}function Lc(t){return 48<=t&&t<=57?t-48:-1}function js(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function Tc(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function la(t,r,e){r==="__proto__"?Object.defineProperty(t,r,{configurable:!0,enumerable:!0,writable:!0,value:e}):t[r]=e}var da=new Array(256),ca=new Array(256);for(st=0;st<256;st++)da[st]=js(st)?1:0,ca[st]=js(st);var st;function Pc(t,r){this.input=t,this.filename=r.filename||null,this.schema=r.schema||ra,this.onWarning=r.onWarning||null,this.legacy=r.legacy||!1,this.json=r.json||!1,this.listener=r.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function ua(t,r){var e={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return e.snippet=vd(e),new Z(r,e)}function k(t,r){throw ua(t,r)}function ur(t,r){t.onWarning&&t.onWarning.call(null,ua(t,r))}var qs={YAML:function(r,e,i){var n,o,s;r.version!==null&&k(r,"duplication of %YAML directive"),i.length!==1&&k(r,"YAML directive accepts exactly one argument"),n=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),n===null&&k(r,"ill-formed argument of the YAML directive"),o=parseInt(n[1],10),s=parseInt(n[2],10),o!==1&&k(r,"unacceptable YAML version of the document"),r.version=i[0],r.checkLineBreaks=s<2,s!==1&&s!==2&&ur(r,"unsupported YAML version of the document")},TAG:function(r,e,i){var n,o;i.length!==2&&k(r,"TAG directive accepts exactly two arguments"),n=i[0],o=i[1],sa.test(n)||k(r,"ill-formed tag handle (first argument) of the TAG directive"),ze.call(r.tagMap,n)&&k(r,'there is a previously declared suffix for "'+n+'" tag handle'),aa.test(o)||k(r,"ill-formed tag prefix (second argument) of the TAG directive");try{o=decodeURIComponent(o)}catch{k(r,"tag prefix is malformed: "+o)}r.tagMap[n]=o}};function Fe(t,r,e,i){var n,o,s,d;if(r<e){if(d=t.input.slice(r,e),i)for(n=0,o=d.length;n<o;n+=1)s=d.charCodeAt(n),s===9||32<=s&&s<=1114111||k(t,"expected valid JSON character");else kc.test(d)&&k(t,"the stream contains non-printable characters");t.result+=d}}function Us(t,r,e,i){var n,o,s,d;for(M.isObject(e)||k(t,"cannot merge mappings; the provided source object is unacceptable"),n=Object.keys(e),s=0,d=n.length;s<d;s+=1)o=n[s],ze.call(r,o)||(la(r,o,e[o]),i[o]=!0)}function Rt(t,r,e,i,n,o,s,d,u){var p,h;if(Array.isArray(n))for(n=Array.prototype.slice.call(n),p=0,h=n.length;p<h;p+=1)Array.isArray(n[p])&&k(t,"nested arrays are not supported inside keys"),typeof n=="object"&&zs(n[p])==="[object Object]"&&(n[p]="[object Object]");if(typeof n=="object"&&zs(n)==="[object Object]"&&(n="[object Object]"),n=String(n),r===null&&(r={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(p=0,h=o.length;p<h;p+=1)Us(t,r,o[p],e);else Us(t,r,o,e);else!t.json&&!ze.call(e,n)&&ze.call(r,n)&&(t.line=s||t.line,t.lineStart=d||t.lineStart,t.position=u||t.position,k(t,"duplicated mapping key")),la(r,n,o),delete e[n];return r}function bn(t){var r;r=t.input.charCodeAt(t.position),r===10?t.position++:r===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):k(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function O(t,r,e){for(var i=0,n=t.input.charCodeAt(t.position);n!==0;){for(;at(n);)n===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),n=t.input.charCodeAt(++t.position);if(r&&n===35)do n=t.input.charCodeAt(++t.position);while(n!==10&&n!==13&&n!==0);if(fe(n))for(bn(t),n=t.input.charCodeAt(t.position),i++,t.lineIndent=0;n===32;)t.lineIndent++,n=t.input.charCodeAt(++t.position);else break}return e!==-1&&i!==0&&t.lineIndent<e&&ur(t,"deficient indentation"),i}function mr(t){var r=t.position,e;return e=t.input.charCodeAt(r),!!((e===45||e===46)&&e===t.input.charCodeAt(r+1)&&e===t.input.charCodeAt(r+2)&&(r+=3,e=t.input.charCodeAt(r),e===0||ee(e)))}function wn(t,r){r===1?t.result+=" ":r>1&&(t.result+=M.repeat(`
`,r-1))}function Rc(t,r,e){var i,n,o,s,d,u,p,h,_=t.kind,g=t.result,v;if(v=t.input.charCodeAt(t.position),ee(v)||Pt(v)||v===35||v===38||v===42||v===33||v===124||v===62||v===39||v===34||v===37||v===64||v===96||(v===63||v===45)&&(n=t.input.charCodeAt(t.position+1),ee(n)||e&&Pt(n)))return!1;for(t.kind="scalar",t.result="",o=s=t.position,d=!1;v!==0;){if(v===58){if(n=t.input.charCodeAt(t.position+1),ee(n)||e&&Pt(n))break}else if(v===35){if(i=t.input.charCodeAt(t.position-1),ee(i))break}else{if(t.position===t.lineStart&&mr(t)||e&&Pt(v))break;if(fe(v))if(u=t.line,p=t.lineStart,h=t.lineIndent,O(t,!1,-1),t.lineIndent>=r){d=!0,v=t.input.charCodeAt(t.position);continue}else{t.position=s,t.line=u,t.lineStart=p,t.lineIndent=h;break}}d&&(Fe(t,o,s,!1),wn(t,t.line-u),o=s=t.position,d=!1),at(v)||(s=t.position+1),v=t.input.charCodeAt(++t.position)}return Fe(t,o,s,!1),t.result?!0:(t.kind=_,t.result=g,!1)}function Dc(t,r){var e,i,n;if(e=t.input.charCodeAt(t.position),e!==39)return!1;for(t.kind="scalar",t.result="",t.position++,i=n=t.position;(e=t.input.charCodeAt(t.position))!==0;)if(e===39)if(Fe(t,i,t.position,!0),e=t.input.charCodeAt(++t.position),e===39)i=t.position,t.position++,n=t.position;else return!0;else fe(e)?(Fe(t,i,n,!0),wn(t,O(t,!1,r)),i=n=t.position):t.position===t.lineStart&&mr(t)?k(t,"unexpected end of the document within a single quoted scalar"):(t.position++,n=t.position);k(t,"unexpected end of the stream within a single quoted scalar")}function Hc(t,r){var e,i,n,o,s,d;if(d=t.input.charCodeAt(t.position),d!==34)return!1;for(t.kind="scalar",t.result="",t.position++,e=i=t.position;(d=t.input.charCodeAt(t.position))!==0;){if(d===34)return Fe(t,e,t.position,!0),t.position++,!0;if(d===92){if(Fe(t,e,t.position,!0),d=t.input.charCodeAt(++t.position),fe(d))O(t,!1,r);else if(d<256&&da[d])t.result+=ca[d],t.position++;else if((s=Ac(d))>0){for(n=s,o=0;n>0;n--)d=t.input.charCodeAt(++t.position),(s=Ec(d))>=0?o=(o<<4)+s:k(t,"expected hexadecimal character");t.result+=Tc(o),t.position++}else k(t,"unknown escape sequence");e=i=t.position}else fe(d)?(Fe(t,e,i,!0),wn(t,O(t,!1,r)),e=i=t.position):t.position===t.lineStart&&mr(t)?k(t,"unexpected end of the document within a double quoted scalar"):(t.position++,i=t.position)}k(t,"unexpected end of the stream within a double quoted scalar")}function Ic(t,r){var e=!0,i,n,o,s=t.tag,d,u=t.anchor,p,h,_,g,v,x=Object.create(null),C,P,Q,L;if(L=t.input.charCodeAt(t.position),L===91)h=93,v=!1,d=[];else if(L===123)h=125,v=!0,d={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=d),L=t.input.charCodeAt(++t.position);L!==0;){if(O(t,!0,r),L=t.input.charCodeAt(t.position),L===h)return t.position++,t.tag=s,t.anchor=u,t.kind=v?"mapping":"sequence",t.result=d,!0;e?L===44&&k(t,"expected the node content, but found ','"):k(t,"missed comma between flow collection entries"),P=C=Q=null,_=g=!1,L===63&&(p=t.input.charCodeAt(t.position+1),ee(p)&&(_=g=!0,t.position++,O(t,!0,r))),i=t.line,n=t.lineStart,o=t.position,Dt(t,r,dr,!1,!0),P=t.tag,C=t.result,O(t,!0,r),L=t.input.charCodeAt(t.position),(g||t.line===i)&&L===58&&(_=!0,L=t.input.charCodeAt(++t.position),O(t,!0,r),Dt(t,r,dr,!1,!0),Q=t.result),v?Rt(t,d,x,P,C,Q,i,n,o):_?d.push(Rt(t,null,x,P,C,Q,i,n,o)):d.push(C),O(t,!0,r),L=t.input.charCodeAt(t.position),L===44?(e=!0,L=t.input.charCodeAt(++t.position)):e=!1}k(t,"unexpected end of the stream within a flow collection")}function Nc(t,r){var e,i,n=hn,o=!1,s=!1,d=r,u=0,p=!1,h,_;if(_=t.input.charCodeAt(t.position),_===124)i=!1;else if(_===62)i=!0;else return!1;for(t.kind="scalar",t.result="";_!==0;)if(_=t.input.charCodeAt(++t.position),_===43||_===45)hn===n?n=_===43?Fs:$c:k(t,"repeat of a chomping mode identifier");else if((h=Lc(_))>=0)h===0?k(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?k(t,"repeat of an indentation width identifier"):(d=r+h-1,s=!0);else break;if(at(_)){do _=t.input.charCodeAt(++t.position);while(at(_));if(_===35)do _=t.input.charCodeAt(++t.position);while(!fe(_)&&_!==0)}for(;_!==0;){for(bn(t),t.lineIndent=0,_=t.input.charCodeAt(t.position);(!s||t.lineIndent<d)&&_===32;)t.lineIndent++,_=t.input.charCodeAt(++t.position);if(!s&&t.lineIndent>d&&(d=t.lineIndent),fe(_)){u++;continue}if(t.lineIndent<d){n===Fs?t.result+=M.repeat(`
...
`,u):t.result+=M.repeat(`
`,o?1+u:u),o=!0,s=!0,u=0,e=t.position;!fe(_)&&_!==0;)_=t.input.charCodeAt(++t.position);Fe(t,e,t.position,!1)}return!0}function Ws(t,r){var e,i=t.tag,n=t.anchor,o=[],s,d=!1,u;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=o),u=t.input.charCodeAt(t.position);u!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),!(u!==45||(s=t.input.charCodeAt(t.position+1),!ee(s))));){if(d=!0,t.position++,O(t,!0,-1)&&t.lineIndent<=r){o.push(null),u=t.input.charCodeAt(t.position);continue}if(e=t.line,Dt(t,r,oa,!1,!0),o.push(t.result),O(t,!0,-1),u=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>r)&&u!==0)k(t,"bad indentation of a sequence entry");else if(t.lineIndent<r)break}return d?(t.tag=i,t.anchor=n,t.kind="sequence",t.result=o,!0):!1}function Oc(t,r,e){var i,n,o,s,d,u,p=t.tag,h=t.anchor,_={},g=Object.create(null),v=null,x=null,C=null,P=!1,Q=!1,L;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=_),L=t.input.charCodeAt(t.position);L!==0;){if(!P&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),i=t.input.charCodeAt(t.position+1),o=t.line,(L===63||L===58)&&ee(i))L===63?(P&&(Rt(t,_,g,v,x,null,s,d,u),v=x=C=null),Q=!0,P=!0,n=!0):P?(P=!1,n=!0):k(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,L=i;else{if(s=t.line,d=t.lineStart,u=t.position,!Dt(t,e,na,!1,!0))break;if(t.line===o){for(L=t.input.charCodeAt(t.position);at(L);)L=t.input.charCodeAt(++t.position);if(L===58)L=t.input.charCodeAt(++t.position),ee(L)||k(t,"a whitespace character is expected after the key-value separator within a block mapping"),P&&(Rt(t,_,g,v,x,null,s,d,u),v=x=C=null),Q=!0,P=!1,n=!1,v=t.tag,x=t.result;else if(Q)k(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=p,t.anchor=h,!0}else if(Q)k(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=p,t.anchor=h,!0}if((t.line===o||t.lineIndent>r)&&(P&&(s=t.line,d=t.lineStart,u=t.position),Dt(t,r,cr,!0,n)&&(P?x=t.result:C=t.result),P||(Rt(t,_,g,v,x,C,s,d,u),v=x=C=null),O(t,!0,-1),L=t.input.charCodeAt(t.position)),(t.line===o||t.lineIndent>r)&&L!==0)k(t,"bad indentation of a mapping entry");else if(t.lineIndent<r)break}return P&&Rt(t,_,g,v,x,null,s,d,u),Q&&(t.tag=p,t.anchor=h,t.kind="mapping",t.result=_),Q}function Mc(t){var r,e=!1,i=!1,n,o,s;if(s=t.input.charCodeAt(t.position),s!==33)return!1;if(t.tag!==null&&k(t,"duplication of a tag property"),s=t.input.charCodeAt(++t.position),s===60?(e=!0,s=t.input.charCodeAt(++t.position)):s===33?(i=!0,n="!!",s=t.input.charCodeAt(++t.position)):n="!",r=t.position,e){do s=t.input.charCodeAt(++t.position);while(s!==0&&s!==62);t.position<t.length?(o=t.input.slice(r,t.position),s=t.input.charCodeAt(++t.position)):k(t,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!ee(s);)s===33&&(i?k(t,"tag suffix cannot contain exclamation marks"):(n=t.input.slice(r-1,t.position+1),sa.test(n)||k(t,"named tag handle cannot contain such characters"),i=!0,r=t.position+1)),s=t.input.charCodeAt(++t.position);o=t.input.slice(r,t.position),Sc.test(o)&&k(t,"tag suffix cannot contain flow indicator characters")}o&&!aa.test(o)&&k(t,"tag name cannot contain such characters: "+o);try{o=decodeURIComponent(o)}catch{k(t,"tag name is malformed: "+o)}return e?t.tag=o:ze.call(t.tagMap,n)?t.tag=t.tagMap[n]+o:n==="!"?t.tag="!"+o:n==="!!"?t.tag="tag:yaml.org,2002:"+o:k(t,'undeclared tag handle "'+n+'"'),!0}function Fc(t){var r,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&k(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),r=t.position;e!==0&&!ee(e)&&!Pt(e);)e=t.input.charCodeAt(++t.position);return t.position===r&&k(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(r,t.position),!0}function zc(t){var r,e,i;if(i=t.input.charCodeAt(t.position),i!==42)return!1;for(i=t.input.charCodeAt(++t.position),r=t.position;i!==0&&!ee(i)&&!Pt(i);)i=t.input.charCodeAt(++t.position);return t.position===r&&k(t,"name of an alias node must contain at least one character"),e=t.input.slice(r,t.position),ze.call(t.anchorMap,e)||k(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],O(t,!0,-1),!0}function Dt(t,r,e,i,n){var o,s,d,u=1,p=!1,h=!1,_,g,v,x,C,P;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,o=s=d=cr===e||oa===e,i&&O(t,!0,-1)&&(p=!0,t.lineIndent>r?u=1:t.lineIndent===r?u=0:t.lineIndent<r&&(u=-1)),u===1)for(;Mc(t)||Fc(t);)O(t,!0,-1)?(p=!0,d=o,t.lineIndent>r?u=1:t.lineIndent===r?u=0:t.lineIndent<r&&(u=-1)):d=!1;if(d&&(d=p||n),(u===1||cr===e)&&(dr===e||na===e?C=r:C=r+1,P=t.position-t.lineStart,u===1?d&&(Ws(t,P)||Oc(t,P,C))||Ic(t,C)?h=!0:(s&&Nc(t,C)||Dc(t,C)||Hc(t,C)?h=!0:zc(t)?(h=!0,(t.tag!==null||t.anchor!==null)&&k(t,"alias node should not have any properties")):Rc(t,C,dr===e)&&(h=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):u===0&&(h=d&&Ws(t,P))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&k(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),_=0,g=t.implicitTypes.length;_<g;_+=1)if(x=t.implicitTypes[_],x.resolve(t.result)){t.result=x.construct(t.result),t.tag=x.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(ze.call(t.typeMap[t.kind||"fallback"],t.tag))x=t.typeMap[t.kind||"fallback"][t.tag];else for(x=null,v=t.typeMap.multi[t.kind||"fallback"],_=0,g=v.length;_<g;_+=1)if(t.tag.slice(0,v[_].tag.length)===v[_].tag){x=v[_];break}x||k(t,"unknown tag !<"+t.tag+">"),t.result!==null&&x.kind!==t.kind&&k(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+x.kind+'", not "'+t.kind+'"'),x.resolve(t.result,t.tag)?(t.result=x.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):k(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||h}function jc(t){var r=t.position,e,i,n,o=!1,s;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(s=t.input.charCodeAt(t.position))!==0&&(O(t,!0,-1),s=t.input.charCodeAt(t.position),!(t.lineIndent>0||s!==37));){for(o=!0,s=t.input.charCodeAt(++t.position),e=t.position;s!==0&&!ee(s);)s=t.input.charCodeAt(++t.position);for(i=t.input.slice(e,t.position),n=[],i.length<1&&k(t,"directive name must not be less than one character in length");s!==0;){for(;at(s);)s=t.input.charCodeAt(++t.position);if(s===35){do s=t.input.charCodeAt(++t.position);while(s!==0&&!fe(s));break}if(fe(s))break;for(e=t.position;s!==0&&!ee(s);)s=t.input.charCodeAt(++t.position);n.push(t.input.slice(e,t.position))}s!==0&&bn(t),ze.call(qs,i)?qs[i](t,i,n):ur(t,'unknown document directive "'+i+'"')}if(O(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,O(t,!0,-1)):o&&k(t,"directives end mark is expected"),Dt(t,t.lineIndent-1,cr,!1,!0),O(t,!0,-1),t.checkLineBreaks&&Cc.test(t.input.slice(r,t.position))&&ur(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&mr(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,O(t,!0,-1));return}if(t.position<t.length-1)k(t,"end of the stream or a document separator is expected");else return}function pa(t,r){t=String(t),r=r||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Pc(t,r),i=t.indexOf("\0");for(i!==-1&&(e.position=i,k(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)jc(e);return e.documents}function qc(t,r,e){r!==null&&typeof r=="object"&&typeof e>"u"&&(e=r,r=null);var i=pa(t,e);if(typeof r!="function")return i;for(var n=0,o=i.length;n<o;n+=1)r(i[n])}function Uc(t,r){var e=pa(t,r);if(e.length!==0){if(e.length===1)return e[0];throw new Z("expected a single document in the stream, but found more")}}var Wc=qc,Vc=Uc,ha={loadAll:Wc,load:Vc},ma=Object.prototype.toString,_a=Object.prototype.hasOwnProperty,xn=65279,Bc=9,oi=10,Gc=13,Kc=32,Yc=33,Qc=34,_n=35,Jc=37,Xc=38,Zc=39,eu=42,fa=44,tu=45,pr=58,iu=61,ru=62,nu=63,ou=64,ga=91,va=93,su=96,ya=123,au=124,ba=125,V={};V[0]="\\0";V[7]="\\a";V[8]="\\b";V[9]="\\t";V[10]="\\n";V[11]="\\v";V[12]="\\f";V[13]="\\r";V[27]="\\e";V[34]='\\"';V[92]="\\\\";V[133]="\\N";V[160]="\\_";V[8232]="\\L";V[8233]="\\P";var lu=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],du=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function cu(t,r){var e,i,n,o,s,d,u;if(r===null)return{};for(e={},i=Object.keys(r),n=0,o=i.length;n<o;n+=1)s=i[n],d=String(r[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),u=t.compiledTypeMap.fallback[s],u&&_a.call(u.styleAliases,d)&&(d=u.styleAliases[d]),e[s]=d;return e}function uu(t){var r,e,i;if(r=t.toString(16).toUpperCase(),t<=255)e="x",i=2;else if(t<=65535)e="u",i=4;else if(t<=4294967295)e="U",i=8;else throw new Z("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+M.repeat("0",i-r.length)+r}var pu=1,si=2;function hu(t){this.schema=t.schema||ra,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=M.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=cu(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?si:pu,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Vs(t,r){for(var e=M.repeat(" ",r),i=0,n=-1,o="",s,d=t.length;i<d;)n=t.indexOf(`
`,i),n===-1?(s=t.slice(i),i=d):(s=t.slice(i,n+1),i=n+1),s.length&&s!==`
`&&(o+=e),o+=s;return o}function fn(t,r){return`
`+M.repeat(" ",t.indent*r)}function mu(t,r){var e,i,n;for(e=0,i=t.implicitTypes.length;e<i;e+=1)if(n=t.implicitTypes[e],n.resolve(r))return!0;return!1}function hr(t){return t===Kc||t===Bc}function ai(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==xn||65536<=t&&t<=1114111}function Bs(t){return ai(t)&&t!==xn&&t!==Gc&&t!==oi}function Gs(t,r,e){var i=Bs(t),n=i&&!hr(t);return(e?i:i&&t!==fa&&t!==ga&&t!==va&&t!==ya&&t!==ba)&&t!==_n&&!(r===pr&&!n)||Bs(r)&&!hr(r)&&t===_n||r===pr&&n}function _u(t){return ai(t)&&t!==xn&&!hr(t)&&t!==tu&&t!==nu&&t!==pr&&t!==fa&&t!==ga&&t!==va&&t!==ya&&t!==ba&&t!==_n&&t!==Xc&&t!==eu&&t!==Yc&&t!==au&&t!==iu&&t!==ru&&t!==Zc&&t!==Qc&&t!==Jc&&t!==ou&&t!==su}function fu(t){return!hr(t)&&t!==pr}function ri(t,r){var e=t.charCodeAt(r),i;return e>=55296&&e<=56319&&r+1<t.length&&(i=t.charCodeAt(r+1),i>=56320&&i<=57343)?(e-55296)*1024+i-56320+65536:e}function wa(t){var r=/^\n* /;return r.test(t)}var xa=1,gn=2,$a=3,ka=4,Tt=5;function gu(t,r,e,i,n,o,s,d){var u,p=0,h=null,_=!1,g=!1,v=i!==-1,x=-1,C=_u(ri(t,0))&&fu(ri(t,t.length-1));if(r||s)for(u=0;u<t.length;p>=65536?u+=2:u++){if(p=ri(t,u),!ai(p))return Tt;C=C&&Gs(p,h,d),h=p}else{for(u=0;u<t.length;p>=65536?u+=2:u++){if(p=ri(t,u),p===oi)_=!0,v&&(g=g||u-x-1>i&&t[x+1]!==" ",x=u);else if(!ai(p))return Tt;C=C&&Gs(p,h,d),h=p}g=g||v&&u-x-1>i&&t[x+1]!==" "}return!_&&!g?C&&!s&&!n(t)?xa:o===si?Tt:gn:e>9&&wa(t)?Tt:s?o===si?Tt:gn:g?ka:$a}function vu(t,r,e,i,n){t.dump=(function(){if(r.length===0)return t.quotingType===si?'""':"''";if(!t.noCompatMode&&(lu.indexOf(r)!==-1||du.test(r)))return t.quotingType===si?'"'+r+'"':"'"+r+"'";var o=t.indent*Math.max(1,e),s=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-o),d=i||t.flowLevel>-1&&e>=t.flowLevel;function u(p){return mu(t,p)}switch(gu(r,d,t.indent,s,u,t.quotingType,t.forceQuotes&&!i,n)){case xa:return r;case gn:return"'"+r.replace(/'/g,"''")+"'";case $a:return"|"+Ks(r,t.indent)+Ys(Vs(r,o));case ka:return">"+Ks(r,t.indent)+Ys(Vs(yu(r,s),o));case Tt:return'"'+bu(r)+'"';default:throw new Z("impossible error: invalid scalar style")}})()}function Ks(t,r){var e=wa(t)?String(r):"",i=t[t.length-1]===`
`,n=i&&(t[t.length-2]===`
`||t===`
`),o=n?"+":i?"":"-";return e+o+`
`}function Ys(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function yu(t,r){for(var e=/(\n+)([^\n]*)/g,i=(function(){var p=t.indexOf(`
`);return p=p!==-1?p:t.length,e.lastIndex=p,Qs(t.slice(0,p),r)})(),n=t[0]===`
`||t[0]===" ",o,s;s=e.exec(t);){var d=s[1],u=s[2];o=u[0]===" ",i+=d+(!n&&!o&&u!==""?`
`:"")+Qs(u,r),n=o}return i}function Qs(t,r){if(t===""||t[0]===" ")return t;for(var e=/ [^ ]/g,i,n=0,o,s=0,d=0,u="";i=e.exec(t);)d=i.index,d-n>r&&(o=s>n?s:d,u+=`
`+t.slice(n,o),n=o+1),s=d;return u+=`
`,t.length-n>r&&s>n?u+=t.slice(n,s)+`
`+t.slice(s+1):u+=t.slice(n),u.slice(1)}function bu(t){for(var r="",e=0,i,n=0;n<t.length;e>=65536?n+=2:n++)e=ri(t,n),i=V[e],!i&&ai(e)?(r+=t[n],e>=65536&&(r+=t[n+1])):r+=i||uu(e);return r}function wu(t,r,e){var i="",n=t.tag,o,s,d;for(o=0,s=e.length;o<s;o+=1)d=e[o],t.replacer&&(d=t.replacer.call(e,String(o),d)),(Le(t,r,d,!1,!1)||typeof d>"u"&&Le(t,r,null,!1,!1))&&(i!==""&&(i+=","+(t.condenseFlow?"":" ")),i+=t.dump);t.tag=n,t.dump="["+i+"]"}function Js(t,r,e,i){var n="",o=t.tag,s,d,u;for(s=0,d=e.length;s<d;s+=1)u=e[s],t.replacer&&(u=t.replacer.call(e,String(s),u)),(Le(t,r+1,u,!0,!0,!1,!0)||typeof u>"u"&&Le(t,r+1,null,!0,!0,!1,!0))&&((!i||n!=="")&&(n+=fn(t,r)),t.dump&&oi===t.dump.charCodeAt(0)?n+="-":n+="- ",n+=t.dump);t.tag=o,t.dump=n||"[]"}function xu(t,r,e){var i="",n=t.tag,o=Object.keys(e),s,d,u,p,h;for(s=0,d=o.length;s<d;s+=1)h="",i!==""&&(h+=", "),t.condenseFlow&&(h+='"'),u=o[s],p=e[u],t.replacer&&(p=t.replacer.call(e,u,p)),Le(t,r,u,!1,!1)&&(t.dump.length>1024&&(h+="? "),h+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),Le(t,r,p,!1,!1)&&(h+=t.dump,i+=h));t.tag=n,t.dump="{"+i+"}"}function $u(t,r,e,i){var n="",o=t.tag,s=Object.keys(e),d,u,p,h,_,g;if(t.sortKeys===!0)s.sort();else if(typeof t.sortKeys=="function")s.sort(t.sortKeys);else if(t.sortKeys)throw new Z("sortKeys must be a boolean or a function");for(d=0,u=s.length;d<u;d+=1)g="",(!i||n!=="")&&(g+=fn(t,r)),p=s[d],h=e[p],t.replacer&&(h=t.replacer.call(e,p,h)),Le(t,r+1,p,!0,!0,!0)&&(_=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,_&&(t.dump&&oi===t.dump.charCodeAt(0)?g+="?":g+="? "),g+=t.dump,_&&(g+=fn(t,r)),Le(t,r+1,h,!0,_)&&(t.dump&&oi===t.dump.charCodeAt(0)?g+=":":g+=": ",g+=t.dump,n+=g));t.tag=o,t.dump=n||"{}"}function Xs(t,r,e){var i,n,o,s,d,u;for(n=e?t.explicitTypes:t.implicitTypes,o=0,s=n.length;o<s;o+=1)if(d=n[o],(d.instanceOf||d.predicate)&&(!d.instanceOf||typeof r=="object"&&r instanceof d.instanceOf)&&(!d.predicate||d.predicate(r))){if(e?d.multi&&d.representName?t.tag=d.representName(r):t.tag=d.tag:t.tag="?",d.represent){if(u=t.styleMap[d.tag]||d.defaultStyle,ma.call(d.represent)==="[object Function]")i=d.represent(r,u);else if(_a.call(d.represent,u))i=d.represent[u](r,u);else throw new Z("!<"+d.tag+'> tag resolver accepts not "'+u+'" style');t.dump=i}return!0}return!1}function Le(t,r,e,i,n,o,s){t.tag=null,t.dump=e,Xs(t,e,!1)||Xs(t,e,!0);var d=ma.call(t.dump),u=i,p;i&&(i=t.flowLevel<0||t.flowLevel>r);var h=d==="[object Object]"||d==="[object Array]",_,g;if(h&&(_=t.duplicates.indexOf(e),g=_!==-1),(t.tag!==null&&t.tag!=="?"||g||t.indent!==2&&r>0)&&(n=!1),g&&t.usedDuplicates[_])t.dump="*ref_"+_;else{if(h&&g&&!t.usedDuplicates[_]&&(t.usedDuplicates[_]=!0),d==="[object Object]")i&&Object.keys(t.dump).length!==0?($u(t,r,t.dump,n),g&&(t.dump="&ref_"+_+t.dump)):(xu(t,r,t.dump),g&&(t.dump="&ref_"+_+" "+t.dump));else if(d==="[object Array]")i&&t.dump.length!==0?(t.noArrayIndent&&!s&&r>0?Js(t,r-1,t.dump,n):Js(t,r,t.dump,n),g&&(t.dump="&ref_"+_+t.dump)):(wu(t,r,t.dump),g&&(t.dump="&ref_"+_+" "+t.dump));else if(d==="[object String]")t.tag!=="?"&&vu(t,t.dump,r,o,u);else{if(d==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new Z("unacceptable kind of an object to dump "+d)}t.tag!==null&&t.tag!=="?"&&(p=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?p="!"+p:p.slice(0,18)==="tag:yaml.org,2002:"?p="!!"+p.slice(18):p="!<"+p+">",t.dump=p+" "+t.dump)}return!0}function ku(t,r){var e=[],i=[],n,o;for(vn(t,e,i),n=0,o=i.length;n<o;n+=1)r.duplicates.push(e[i[n]]);r.usedDuplicates=new Array(o)}function vn(t,r,e){var i,n,o;if(t!==null&&typeof t=="object")if(n=r.indexOf(t),n!==-1)e.indexOf(n)===-1&&e.push(n);else if(r.push(t),Array.isArray(t))for(n=0,o=t.length;n<o;n+=1)vn(t[n],r,e);else for(i=Object.keys(t),n=0,o=i.length;n<o;n+=1)vn(t[i[n]],r,e)}function Cu(t,r){r=r||{};var e=new hu(r);e.noRefs||ku(t,e);var i=t;return e.replacer&&(i=e.replacer.call({"":i},"",i)),Le(e,0,i,!0,!0)?e.dump+`
`:""}var Su=Cu,Eu={dump:Su};function $n(t,r){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+r+" instead, which is now safe by default.")}}var _r=ha.load,Y_=ha.loadAll,fr=Eu.dump;var Q_=$n("safeLoad","load"),J_=$n("safeLoadAll","loadAll"),X_=$n("safeDump","dump");var Au={light:"mdi:lightbulb",switch:"mdi:toggle-switch-variant",binary_sensor:"mdi:motion-sensor",sensor:"mdi:eye",person:"mdi:account",device_tracker:"mdi:account",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:cast",lock:"mdi:lock",fan:"mdi:fan",weather:"mdi:weather-partly-cloudy",input_boolean:"mdi:toggle-switch",event:"mdi:eye-check",script:"mdi:script-text",template:"mdi:code-braces"},kn="mdi:eye";function je(t,r){let e=t?.states?.[r]?.attributes?.friendly_name;return typeof e=="string"&&e?e:r}function Lu(t,r){let e=t?.states?.[r]?.attributes?.icon;if(typeof e=="string"&&e)return e;let i=r.split(".")[0];return Au[i]??kn}function li(t,r){let e=t?.states?.[r];return e&&customElements.get("ha-state-icon")?l`<ha-state-icon class="row-icon" .hass=${t} .stateObj=${e}></ha-state-icon>`:l`<ha-icon class="row-icon" icon=${Lu(t,r)}></ha-icon>`}var Ca=y`
  .row-icon {
    flex: 0 0 auto;
    color: var(--secondary-text-color, #888);
    --mdc-icon-size: 22px;
...
`;var ge=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>sn(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let n=this._currentFields()?.[e.name]?.description;return typeof n=="string"?n:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=fr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=fr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=fr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=_r(e)}catch(u){this._yamlError=u.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=a(this.hass,"ui.yaml_expect_object","Expected an object");return}let n=i,o=n.script;if(typeof o!="string"||!o.startsWith("script.")){this._yamlError=a(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let s=n.args;if(s!==void 0&&(typeof s!="object"||Array.isArray(s)||s===null)){this._yamlError=a(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let d=n.triggers;if(d!==void 0&&(!Array.isArray(d)||!d.every(u=>typeof u=="string"))){this._yamlError=a(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:o,args:s??{},triggers:d})}_emit(e){this.value=e,A(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(n=>`script.${n}`)}_label(e){return je(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},n={};for(let[o,s]of Object.entries(i))s&&Object.hasOwn(s,"default")&&(n[o]=s.default);return n}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,n])=>({name:i,required:n.required,selector:n.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),n=(this.value&&typeof this.value=="object"?this.value.args:{})??{},o=i.length>0;return l`
  ...
  `,c([m({attribute:!1})],lt.prototype,"hass",2),c([m({attribute:!1})],lt.prototype,"value",2),lt=c([w("ambience-time-endpoint")],lt);function Tu(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function En(t,r){if(t===0)return"";let e=Math.abs(t),i=t<0?"\u2212":"+";if(e%60===0){let n=e/60,o=n===1?a(r,"ui.unit_hour","hour"):a(r,"ui.unit_hours","hours");return`${i}${n} ${o}`}return`${i}${e} ${a(r,"ui.unit_min","min")}`}function gr(t,r){if(!t)return[];let e=Object.keys(t.builtins??{}),i=r?e.slice().sort(r):e,n=new Set(t.hidden??[]),o=Object.keys(t.custom??{}).filter(s=>!(s in(t.builtins??{})));return[...i.filter(s=>!n.has(s)),...o]}var ve=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._error=""}static{this.styles=y`
    :host { display: block; }
  ...
  `,c([m({attribute:!1})],Te.prototype,"hass",2),c([m({attribute:!1})],Te.prototype,"value",2),c([m({attribute:!1})],Te.prototype,"groups",2),c([m({attribute:!1})],Te.prototype,"weatherEntity",2),Te=c([w("ambience-weather-predicate-input")],Te);var Ou=["NW","N","NE","W",null,"E","SW","S","SE"],dt=class extends b{constructor(){super(...arguments);this.value=null}_current(){let e=this.value?.azimuth?.ranges??[];return{elevation:this.value?.elevation??null,sectors:[...this.value?.azimuth?.sectors??[]],range:e.length?{...e[0]}:null}}_emit(e){let i={};e.elevation&&(e.elevation.min!=null||e.elevation.max!=null)&&(i.elevation=e.elevation);let n={};e.sectors.length&&(n.sectors=e.sectors),e.range&&(n.ranges=[e.range]),(n.sectors||n.ranges)&&(i.azimuth=n),this.value=i.elevation||i.azimuth?i:null,A(this,this.value)}_setElevation(e){this._emit({...this._current(),elevation:e})}_setSectors(e){this._emit({...this._current(),sectors:e})}_setRange(e){this._emit({...this._current(),range:e})}_mode(e){return!e||e.min==null&&e.max==null?"any":e.min!=null&&e.max!=null?"between":e.min!=null?"above":"below"}_onModeChange(e,i){let n=i?.min??0,o=i?.max??0;e==="any"?this._setElevation(null):e==="above"?this._setElevation({min:n}):e==="below"?this._setElevation({max:o}):this._setElevation({min:n,max:o})}_toggleSector(e,i,n){this._setSectors(n?[...e,i]:e.filter(o=>o!==i))}_renderSectors(e){return l`<div class="sectors">${Ou.map(i=>i===null?l`<span class="spacer"></span>`:l`<label>
  ...
  `,c([m({attribute:!1})],ct.prototype,"hass",2),c([m({attribute:!1})],ct.prototype,"value",2),ct=c([w("ambience-people-predicate-input")],ct);var ut=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[]}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_build(e){let i={...this._cur(),...e},n={sensors:i.sensors??[]};if(i.occupied===!1&&(n.occupied=!1),i.quant==="all"&&(n.quant="all"),Jt(i.for)){n.for=i.for;let o=Et(i.for,i.for_mode);o&&(n.for_mode=o)}return i.negate===!0&&(n.negate=!0),n}_emit(e){this.value=e,A(this,e)}_setSensors(e){this._emit(e.length?this._build({sensors:e}):null)}_setOccupied(e){this._emit(this._build({occupied:e}))}_setNegate(e){this._emit(this._build({negate:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setFor(e){let{mode:i,...n}=e;this._emit(this._build({for:n,for_mode:i??"at_least"}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"binary_sensor",device_class:["occupancy","presence","motion"],multiple:!0}}}]}_renderSensors(){return Ht(this.hass,this._sensorSchema(),this._sensors(),"binary_sensor.a, binary_sensor.b",e=>this._setSensors(e))}_renderNegate(e){return ne(this.hass,"negate",e?"is_not":"is",[{value:"is",label:a(this.hass,"ui.occupancy_is","is")},{value:"is_not",label:a(this.hass,"ui.occupancy_is_not","is not")}],i=>this._setNegate(i==="is_not"))}_renderOccupied(e){return ne(this.hass,"state",e?"occupied":"vacant",[{value:"occupied",label:a(this.hass,"ui.occupancy_detected","Detected")},{value:"vacant",label:a(this.hass,"ui.occupancy_clear","Clear")}],i=>this._setOccupied(i==="occupied"))}_renderQuant(e){return ne(this.hass,"quant",e,[{value:"any",label:a(this.hass,"ui.occupancy_any","Any of")},{value:"all",label:a(this.hass,"ui.occupancy_all","All of")}],i=>this._setQuant(i))}_renderFor(){return l`<ambience-for-duration
    ...
    .for-row { display: flex; gap: 0.25rem; align-items: center; }
    .for-row input[type='number'] { width: 3.5rem; }
  `,c([m({attribute:!1})],ut.prototype,"hass",2),c([m({attribute:!1})],ut.prototype,"value",2),ut=c([w("ambience-occupancy-predicate-input")],ut);function Na(t,r){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?a(r,"ui.unavailable_select_one","Select at least one entity"):null}var zu=[{name:"sensors",selector:{entity:{multiple:!0}}}],pt=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,A(this,i)}render(){return l`
      <div class="row">
        ${Ht(this.hass,zu,this._entities(),"binary_sensor.a, light.b",e=>this._setEntities(e))}
      </div>
    `}};pt.styles=y`
    :host {
      display: block;
        ...
        ${o?l`
          <div class="body">
            <ambience-action-slot
              ...
              .excludeEntities=${ws(this._draft?.actions??[],i)}
              .params=${e.params}
...
`;function Fa(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function $r(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Fa(n,r))};return l`<span
    class="entity-link"
    role="button"
    tabindex="0"
    ...
    @keydown=${i}
    >${e}</span
  >`}function ja(t,r){return $r(t,r,je(t,r))}var Gu=new Set(["occupancy","people","lux","state"]);function Ku(t,r,e,i){if(!i?.length||!Gu.has(r))return e;let n=[],o=i.map(u=>({id:u,name:je(t,u)})).sort((u,p)=>p.name.length-u.name.length);for(let{id:u,name:p}of o)for(let h=0;h<=e.length;){let _=e.indexOf(p,h);if(_===-1)break;let g=_+p.length;if(!n.some(v=>_<v.end&&v.start<g)){n.push({start:_,end:g,id:u,name:p});break}h=_+1}if(n.length===0)return e;n.sort((u,p)=>u.start-p.start);let s=[],d=0;for(let u of n)u.start>d&&s.push(e.slice(d,u.start)),s.push($r(t,u.id,u.name)),d=u.end;return d<e.length&&s.push(e.slice(d)),l`${s}`}var Yu={has_time:["ui.cause_has_time","Periodic time check"],switch:["ui.cause_switch","Switch turned on"],manual:["ui.cause_manual","Manual apply"],startup:["ui.cause_startup","Startup"],reloaded:["ui.cause_reloaded","Reloaded"],simulated:["ui.cause_simulated","Simulation"]},Qu={clock:["ui.cause_clock","Time of day"],sun:["ui.cause_sun","Sun position"],reapply:["ui.cause_reapply","Re-run"]};function be(t){return t??"?"}function qa(t,r){if(r.kind==="entity")return`${r.entity_id} ${be(r.old)} \u2192 ${be(r.new)}`;if(r.kind==="duration"){let o=a(t,"ui.cause_duration_for","for");return r.entity_id?`${r.entity_id} ${be(r.new)} ${o} ${be(r.detail)}`:`${be(r.new)} ${o} ${be(r.detail)}`}let e=Yu[r.kind];if(e)return a(t,e[0],e[1]);let i=Qu[r.kind],n=i?a(t,i[0],i[1]):z(r.kind);return r.detail?`${n} ${r.detail}`:n}function Ju(t,r){if(!kr(r)||!r.entity_id)return l`${qa(t,r)}`;let e=$r(t,r.entity_id,r.entity_id);return r.kind==="duration"?l`${e} ${be(r.new)} ${a(t,"ui.cause_duration_for","for")} ${be(r.detail)}`:l`${e} ${be(r.old)} → ${be(r.new)}`}function kr(t){return t.kind==="entity"||t.kind==="duration"&&!!t.entity_id}function Ua(t,r){let e=t.entity_id?r?.states?.[t.entity_id]:void 0,i=n=>n===null?"?":Re(r,e,null,n);return{old:i(t.old),new:i(t.new)}}function Xu(t,r){if(!kr(t))return qa(r,t);let e=t.entity_id?je(r,t.entity_id):"?",i=Ua(t,r);return t.kind==="duration"?`${e}: ${i.new} ${a(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:`${e}: ${i.old} \u2192 ${i.new}`}function Zu(t,r){if(!kr(t)||!t.entity_id)return l`${Xu(t,r)}`;let e=ja(r,t.entity_id),i=Ua(t,r);return t.kind==="duration"?l`${e}: ${i.new} ${a(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:l`${e}: ${i.old} → ${i.new}`}var ep={acted:["ui.outcome_label_acted","applied"],no_op:["ui.outcome_label_no_op","blocked"],debounced:["ui.outcome_label_debounced","unchanged"],no_match:["ui.outcome_label_no_match","no match"],skipped_switch_off:["ui.outcome_label_skipped","skipped"],skipped_scope_disabled:["ui.outcome_label_skipped","skipped"],skipped_unavailable:["ui.outcome_label_skipped","skipped"]};function tp(t,r){let e=ep[r];return e?a(t,e[0],e[1]):r.replace(/_/g," ")}function wr(t,r,e,i,n,o){return r===1?a(t,e,n,{n:String(r)}):a(t,i,o,{n:String(r)})}function Wa(t,r){let e=r.winner_name??a(t,"ui.winner_default","The matching scene");switch(r.outcome){case"acted":{let i=r.actions.filter(p=>!p.unexposed),n=r.actions.length-i.length;if(i.length===0&&n){let p=wr(t,n,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions");return a(t,"ui.outcome_summary_acted_all_skipped","{winner} matched \u2014 {skipped_phrase} skipped (not exposed); nothing applied.",{winner:e,skipped_phrase:p})}let o=wr(t,i.length,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions"),s=Ba(i),d=n?a(t,"ui.outcome_summary_skipped_tail"," ({skipped} skipped \u2014 not exposed)",{skipped:String(n)}):"",u=wr(t,s,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities");return s?a(t,"ui.outcome_summary_acted_entities","Applied {winner} \u2014 {acts} on {entities}.{tail}",{winner:e,acts:o,entities:u,tail:d}):a(t,"ui.outcome_summary_acted","Applied {winner} \u2014 {acts}.{tail}",{winner:e,acts:o,tail:d})}case"no_op":return a(t,"ui.outcome_summary_no_op","{winner} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.",{winner:e});case"debounced":return a(t,"ui.outcome_summary_debounced","{winner} matched, but it's already applied \u2014 nothing was re-sent.",{winner:e});case"no_match":return a(t,"ui.outcome_summary_no_match","No scene matched \u2014 nothing applied.");case"skipped_switch_off":return a(t,"ui.outcome_summary_skipped_switch_off","Skipped \u2014 the scope's pause switch is off.");case"skipped_scope_disabled":return a(t,"ui.outcome_summary_skipped_scope_disabled","Skipped \u2014 the scope is disabled.");case"skipped_unavailable":return a(t,"ui.outcome_summary_skipped_unavailable","Skipped \u2014 the triggering entity went unavailable; devices left as they are.");default:return""}}function Va(t,r,e){return gt(t,r,()=>e?.[t]?.name?.trim()||Li(t))}function ip(t,r,e,i){let n=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,d])=>`${ii(s,t.service,e)}: ${Me(r,d)}`).join(", "),o=Va(t.service,i,e);return n?`${o} \xB7 ${n}`:o}function Ba(t){return t.reduce((r,e)=>r+(e.entity_ids?.length??0),0)}function rp(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"||t==="skipped_unavailable"}function za(t,r,e){let i=r.detail??"";return r.detail_key?a(t,`trace_reason.${r.detail_key}`,i,r.detail_placeholders??{}):r.detail_segments?.length?np(t,r.detail_segments):Bu(t,r.condition_key,i,e)}function np(t,r){let e=r.map(i=>i.k?a(t,`trace_detail.${i.k}`,i.t??"",i.p??{}):i.e?$r(t,i.e,i.t??i.e):i.t??"");return l`${e}`}function op(t,r,e){let i=t.index+1,n=a(r,"ui.trace_scene_prefix","Scene #");return t.disabled?l`<div class="scene disabled">${n}${i} ${t.name??"\u2014"}: ${a(r,"ui.trace_scene_disabled","disabled")}</div>`:t.evaluated?l`
    ...
    ${t.predicates.map(o=>l`
        <div class="pred ${o.passed?"pass":"fail"}" style="padding-left:1rem">
          ${o.passed?"\u2713":"\u2717"} ${G(r,o.condition_key)}${o.detail?l` <span class="dim">[${!o.detail_key&&o.detail_segments?.length?za(r,o,e):Ku(r,o.condition_key,za(r,o,e),o.entity_ids)}]</span>`:$}
        </div>`)}
  `:l`<div class="scene skipped">${n}${i} ${t.name??"\u2014"}: ${a(r,"ui.trace_scene_not_reached","not reached")}</div>`}function Cr(t,r,e,i,n,o={},s){let d=t.actions.filter(g=>!g.unexposed),u=d.map(g=>Va(g.service,s,n)).join(", "),p=Ba(d),h=t.explanation!==null||t.actions.length>0||rp(t.outcome),_=g=>{(g.key==="Enter"||g.key===" ")&&!g.repeat&&(g.preventDefault(),e())};return l`
    <div class="eval">
      <div
        ...
        @keydown=${h?_:void 0}
      >
        <span class="label">${tp(i,t.outcome)}</span>
        <span class="ts">${t.timestamp?new Date(t.timestamp).toLocaleTimeString():""}</span>
      </div>
      <div class="eval-body">
        <div class="cause-line">${a(i,"ui.trigger_prefix","Trigger: ")}${Zu(t.cause,i)}</div>
        ...
        ${d.length?l`<div class="action-summary">→ ${u}
              ${p?l`<span class="n">· ${wr(i,p,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities")}</span>`:$}</div>`:r?$:l`<div class="action-summary">${Wa(i,t)}</div>`}
      </div>
      ${r?sp(t,i,n,o,s):$}
    </div>
  `}function sp(t,r,e,i,n){let o=Wa(r,t),s=kr(t.cause);return l`
    <div class="why">
      ${s?l`<div class="raw-trigger">${a(r,"ui.trigger_prefix","Trigger: ")}${Ju(r,t.cause)}</div>`:$}
      ...
      ${t.explanation?l`<div class="section">
            ...
            <div class="scenes">${t.explanation.scenes.map(d=>op(d,r,i))}</div>
          </div>`:$}
  ...
  `,c([m({attribute:!1})],K.prototype,"hass",2),c([m({attribute:!1})],K.prototype,"scope",2),c([m()],K.prototype,"category",2),c([m()],K.prototype,"categoryName",2),c([m({attribute:!1})],K.prototype,"scenes",2),c([m({type:Boolean,reflect:!0})],K.prototype,"open",2),c([f()],K.prototype,"_triggers",2),c([f()],K.prototype,"_opaque",2),c([f()],K.prototype,"_loading",2),c([f()],K.prototype,"_error",2),K=c([w("ambience-auto-triggers-modal")],K);function Ga(t,r){return r==="not_home"?a(t,"ui.away","Away"):r==="home"?a(t,"ui.home","Home"):z(r)}function Ka(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(r=>[r.name,r.live_value==null?"":String(r.live_value)])),for:{h:0,m:0,s:0}}}function Er(t){return String(t).padStart(2,"0")}function Sr(t){return`${t.getFullYear()}-${Er(t.getMonth()+1)}-${Er(t.getDate())}`}function mi(t){return`${Er(t.getHours())}:${Er(t.getMinutes())}`}var T=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._whenMode="time";this._anchor="sunset";this._offset=0;this._anchors=null;this._anchorsDate="";this._anchorsError="";this._results=[];this._appliedIndex=null;this._expanded=new Set;this._running=!1;this._runToken=0;new Be(this,()=>this._onClose())}_reloadTriggered(e){return this.open&&(e.has("open")||e.has("category")||e.has("scope"))}willUpdate(e){this._reloadTriggered(e)&&this._beginLoad()}updated(e){this._reloadTriggered(e)&&this._fetch()}_vkey(e){return`${e.condition}:${e.key}`}_beginLoad(){this._error="",this._loading=!0,this._resetResults();let e=new Date;this._date=Sr(e),this._time=mi(e),this._whenMode="time",this._anchor="sunset",this._offset=0,this._anchors=null,this._anchorsDate="",this._anchorsError=""}async _fetch(){try{let e=await cs(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=e.knobs,this._hasTime=e.has_time;let i={},n={};for(let o of e.knobs)o.kind==="entity"?i[o.entity_id]=Ka(o):n[this._vkey(o)]=o.live_value;this._values=i,this._verdicts=n,this._loading=!1}catch(e){this._error=S(this.hass,e),this._loading=!1}}_setState(e,i){this._values={...this._values,[e]:{...this._values[e],state:i}}}_setAttr(e,i,n){let o=this._values[e];this._values={...this._values,[e]:{...o,attributes:{...o.attributes,[i]:n}}}}_setFor(e,i,n){let o=this._values[e],s=Number.isFinite(n)&&n>0?Math.trunc(n):0;this._values={...this._values,[e]:{...o,for:{...o.for,[i]:s}}}}_setVerdict(e,i){this._verdicts={...this._verdicts,[e]:i}}_resetWhen(){let e=new Date;this._date=Sr(e),this._time=mi(e),this._whenMode="time"}_setWhenMode(e){e!==this._whenMode&&(this._whenMode=e,e==="sun"&&this._fetchAnchors(this._date))}_setDate(e){this._date=e,this._whenMode==="sun"&&this._fetchAnchors(e)}_onOffsetInput(e){let i=Sn(e);i!==null&&(this._offset=i)}async _fetchAnchors(e){if(e&&!(this._anchorsDate===e&&this._anchors)){this._anchorsError="";try{let i=await us(this.hass,e);if(!this.isConnected||this._date!==e)return;this._anchors=i,this._anchorsDate=e}catch(i){if(!this.isConnected||this._date!==e)return;this._anchors=null,this._anchorsError=S(this.hass,i)}}}_resolvedInstant(){if(this._anchorsDate!==this._date)return null;let e=this._anchors?.[this._anchor];return e?new Date(e).getTime()+this._offset*6e4:null}_renderSunReadout(){if(this._anchorsError)return l`<span class="hint err">${this._anchorsError}</span>`;if(!this._anchors||this._anchorsDate!==this._date)return $;if(this._anchors[this._anchor]===null)return l`<span class="hint">${a(this.hass,"ui.simulate_sun_undefined","no {anchor} on this date",{anchor:re(this.hass,this._anchor)})}</span>`;let e=this._resolvedInstant();if(e===null||Number.isNaN(new Date(e).getTime()))return $;let i=this._anchors[this._anchor],n=new Date(e),o=Sr(n)===this._date?mi(n):`${Sr(n)} ${mi(n)}`,s=En(this._offset,this.hass);return l`<span class="hint">${re(this.hass,this._anchor)} ${mi(new Date(i))}${s?l` ${s}`:""} ${a(this.hass,"ui.simulate_sun_resolved","\u2192 {time}",{time:o})}</span>`}_resetEntity(e){this._values={...this._values,[e.entity_id]:Ka(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let i of this._knobs){if(i.kind!=="entity")continue;let n=this._values[i.entity_id];if(!n)continue;let o={};for(let d of i.attributes){let u=n.attributes[d.name];if(!(u===void 0||u===""))if(d.control==="number"){let p=Number(u);Number.isNaN(p)||(o[d.name]=p)}else o[d.name]=u}let s={attributes:o};n.state!==""&&(s.state=n.state),(n.for.h||n.for.m||n.for.s)&&(s.for=n.for),(s.state!==void 0||s.for!==void 0||Object.keys(o).length>0)&&(e[i.entity_id]=s)}return e}_buildVerdicts(){let e={};for(let i of this._knobs)i.kind==="verdict"&&(e[i.condition]||(e[i.condition]={}),e[i.condition][i.key]=this._verdicts[this._vkey(i)]??i.live_value);return e}_resolveNow(){if(this._whenMode==="sun"){let i=this._resolvedInstant();return i===null||Number.isNaN(new Date(i).getTime())?null:new Date(i).toISOString()}let e=new Date(`${this._date}T${this._time}`);return!this._date||!this._time||Number.isNaN(e.getTime())?null:e.toISOString()}async _run(){if(this._running)return;this._error="";let e=this._resolveNow();if(e===null){this._error=this._whenMode==="sun"?a(this.hass,"ui.simulate_sun_unresolved","This sun time can't be resolved for the selected date."):a(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}this._running=!0;let i=this._runToken;try{let n=await ps(this.hass,this.scope,this.category,e,this._buildOverrides(),this._buildVerdicts(),this._appliedIndex);if(i!==this._runToken)return;this._results=[...this._results,n.result],this._appliedIndex=n.applied_index}catch(n){if(i!==this._runToken)return;this._error=S(this.hass,n)}finally{i===this._runToken&&(this._running=!1)}}_clearHistory(){this._resetResults()}_resetResults(){this._results=[],this._appliedIndex=null,this._expanded=new Set,this._runToken++,this._running=!1}_toggle(e){let i=new Set(this._expanded);i.has(e)?i.delete(e):i.add(e),this._expanded=i}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      ...
      ${e.attributes.map((s,d)=>l`
        <div class="row attr ${d===e.attributes.length-1?"last-attr":""}">
          <div class="row-text"><div class="row-title">${Ga(this.hass,s.name)}</div></div>
          <div class="row-ctrl">
    ...
    `}_renderAttrControl(e,i,n){let o=s=>this._setAttr(e.entity_id,i.name,s.target.value);if(i.control==="select"){let s=qe(this.hass)[e.entity_id];return l`<select data-attr=${`${e.entity_id}:${i.name}`} .value=${n} @change=${o}>
      ...
      @input=${o} />`}_renderControl(e,i){if(e.control==="select")return l`<select data-entity=${e.entity_id} .value=${i}
        ...
        ${(e.options??[i]).map(o=>l`<option value=${o} ?selected=${o===i}>${Ga(this.hass,o)}</option>`)}
    ...
    `}_historyCaption(){return this._store.canUndo?this._historyButtonLabel("undo"):this._store.canRedo?this._historyButtonLabel("redo"):""}_editingScopeIsStale(){return this._editing!==null&&this._store.isScopeStale(this._editing.scope)}render(){let e=this._historyCaption();return l`
      ...
      ${this._renderBanners()}
      <ul>
        ${vs(this._orderedScopeRows(),i=>D(i.scope),i=>this._renderScopeRow(i.scope,i.name,i.cfg,i.rowClass))}
    ...
    >
      ...
      <span class="countdown">${lp(d)}</span>
    </button>`}_renderScopeSwitch(e,i){let n=i.enabled!==!1;return $t({checked:n,dataTest:"scope-switch",onChange:async d=>{d.stopPropagation();try{await Bo(this.hass,e,!n),await Promise.all([this._store.reloadScope(e),this._store.refreshSwitches()])}catch(u){this._store.error=S(this.hass,u)}},className:"scope-switch",onClick:d=>d.stopPropagation()})}};Y.styles=[y`
      :host {
        display: block;
        padding: 1rem;
  ...
  `,c([m({attribute:!1})],we.prototype,"hass",2),c([f()],we.prototype,"_defaults",2),c([f()],we.prototype,"_reapply",2),c([f()],we.prototype,"_exposed",2),c([f()],we.prototype,"_error",2),we=c([w("ambience-ambience-settings")],we);function Ya(){let t=globalThis.crypto;if(t?.randomUUID)return t.randomUUID().replace(/-/g,"");if(t?.getRandomValues){let r=t.getRandomValues(new Uint8Array(16));return Array.from(r,e=>e.toString(16).padStart(2,"0")).join("")}return Array.from({length:4},()=>Math.floor(Math.random()*4294967296).toString(16).padStart(8,"0")).join("")}var xe=class extends b{constructor(){super(...arguments);this._categories=[];this._error="";this._editing=null;this._modalError=""}async connectedCallback(){super.connectedCallback();try{this._categories=await Ce(this.hass)}catch(e){this._error=S(this.hass,e)}}_sorted(){return[...this._categories].sort((e,i)=>e.name.localeCompare(i.name))}_validate(e){let i=e.name.trim();if(i==="")return a(this.hass,"ui.category_name_blank_error","Category names can't be empty.");let n=i.toLocaleLowerCase();return this._categories.some(s=>s.id!==e.id&&s.name.trim().toLocaleLowerCase()===n)?a(this.hass,"ui.category_name_duplicate_error","Two categories can't have the same name."):""}_openEditor(e){this._editing={...e},this._modalError=""}_addCategory(){let e=Ya();this._editing={id:e,name:""},this._modalError=""}_closeModal(){this._editing=null,this._modalError=""}_patchDraft(e){this._editing&&(this._editing={...this._editing,...e})}_onName(e){this._patchDraft({name:e.target.value})}_onIcon(e){this._patchDraft({icon:e||void 0})}_onColor(e){this._patchDraft({color:e})}_save(){if(!this._editing)return;let e=this._validate(this._editing);if(e){this._modalError=e;return}let i={...this._editing,name:this._editing.name.trim()},n=this._categories.some(s=>s.id===i.id),o=this._categories;this._categories=n?this._categories.map(s=>s.id===i.id?i:s):[...this._categories,i],this._closeModal(),zi(this.hass,this._categories).then(()=>{window.dispatchEvent(new CustomEvent("ambience-categories-changed"))}).catch(s=>{this._categories=o,this._error=S(this.hass,s)})}_deleteCategory(){if(!this._editing)return;let e=this._editing.id;if(this._categories.length<=1){this._modalError=a(this.hass,"ui.category_delete_blocked_last","You can't delete the last category.");return}let i=this._categories;this._categories=this._categories.filter(n=>n.id!==e),Xo(this.hass,e).then(()=>{this._closeModal(),window.dispatchEvent(new CustomEvent("ambience-categories-changed"))}).catch(n=>{this._categories=i;let o=n.code;o==="category_in_use"?this._modalError=a(this.hass,"ui.category_delete_blocked_in_use","This category still has scenes \u2014 move or delete them first."):o==="category_last"?this._modalError=a(this.hass,"ui.category_delete_blocked_last","You can't delete the last category."):this._modalError=S(this.hass,n)})}_renderIconField(){return customElements.get("ha-icon-picker")?l`<ha-icon-picker
    ...
    />`}_renderSwatches(){let e=this._editing.color;return l`
      <div class="swatches">
        ${Jr.map(i=>{let n=so(this.hass,i.id,i.label);return l`<button
            type="button"
  ...
  `,c([m({attribute:!1})],Pe.prototype,"hass",2),c([m()],Pe.prototype,"conditionName",2),c([m()],Pe.prototype,"conditionDescription",2),c([f()],Pe.prototype,"_expanded",2),Pe=c([w("ambience-condition-card")],Pe);var up=/^[a-z][a-z0-9_]*$/;function pp(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var _i=y`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,ue=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=_i}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!up.test(e)?a(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?a(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":a(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??pp(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return l`
  ...
  `,c([m({attribute:!1})],Ye.prototype,"hass",2),c([f()],Ye.prototype,"_config",2),c([f()],Ye.prototype,"_expanded",2),Ye=c([w("ambience-weather-config")],Ye);var Ja={time_of_day:t=>l`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>l`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>l`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>l`<ambience-weather-config .hass=${t}></ambience-weather-config>`},mp=new Set(Object.keys(Ja)),Qe=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await Ni(this.hass)}catch(e){this._error=S(this.hass,e)}}render(){let e=this._conditions.filter(i=>mp.has(i.name)).slice().sort((i,n)=>n.priority-i.priority);return l`
  ...
  `,c([m({attribute:!1})],Qe.prototype,"hass",2),c([f()],Qe.prototype,"_conditions",2),c([f()],Qe.prototype,"_error",2),Qe=c([w("ambience-conditions-settings")],Qe);function Xa(t,r){let e=t?.config?.components;return Array.isArray(e)&&e.includes(r)}var _p="fado",fp="https://my.home-assistant.io/redirect/hacs_repository/?owner=clintongormley&repository=ha-fado",I=class extends b{constructor(){super(...arguments);this._actions=[];this._services=[];this._schemas={};this._fieldSchemas={};this._addSchema=[];this._serviceById=new Map;this._availableServices=[];this._expanded=new Set;this._adding=!1;this._loadError=null;this._saveError=null;this._loaded=!1;this._fadoNoticeDismissed=!1;this._installId=null;this._editingDefault=null;this._editingOriginalValue=void 0;this._editingOriginalHad=!1;this._drag=new St(this,(e,i)=>{let n=[...this._actions],[o]=n.splice(e,1);n.splice(i,0,o),this._actions=n,this._autoSave()});this._onDocPointerDown=e=>{if(!this._adding&&this._editingDefault===null)return;let i=e.composedPath(),n=i.some(o=>o instanceof Element&&I._OVERLAY_TAG_RE.test(o.localName));this._collapseAddFormOnClickAway(i,n),this._cancelEditingDefaultOnClickAway(i,n)}}_collapseAddFormOnClickAway(e,i){if(!this._adding)return;let n=this.shadowRoot?.querySelector(".add-row");!(!!n&&e.includes(n))&&!i&&(this._adding=!1)}_cancelEditingDefaultOnClickAway(e,i){if(this._editingDefault===null)return;let n=this.shadowRoot?.querySelector(`.field-row-editor[data-editing-key="${this._editingDefault}"]`);(!n||!e.includes(n))&&!i&&this._cancelEditingDefault()}connectedCallback(){super.connectedCallback(),document.addEventListener("pointerdown",this._onDocPointerDown),customElements.get("ha-service-picker")||customElements.whenDefined("ha-service-picker").then(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerdown",this._onDocPointerDown)}_startEditingDefault(e,i){let o=this._actions.find(s=>s.id===e)?.defaults??{};this._editingOriginalHad=i in o,this._editingOriginalValue=o[i],this._editingDefault=`${e}:${i}`}_saveEditingDefault(){this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1,this._autoSave()}_cancelEditingDefault(){let e=this._editingDefault;if(e){let i=e.indexOf(":"),n=e.slice(0,i),o=e.slice(i+1);this._actions=this._actions.map(s=>{if(s.id!==n)return s;let d={...s.defaults??{}};return this._editingOriginalHad?d[o]=this._editingOriginalValue:delete d[o],{...s,defaults:d}})}this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}async firstUpdated(){await this._reload()}willUpdate(e){if(e.has("_actions")||e.has("_schemas")){let i={};for(let n of this._actions){let o=this._schemas[n.id];if(o)for(let[s,d]of Object.entries(o.fields))i[`${n.id}:${s}`]=[{name:s,selector:d.selector??{text:{}},required:!1}]}this._fieldSchemas=i}if(e.has("_services")&&(this._serviceById=new Map(this._services.map(i=>[i.id,i]))),e.has("_actions")||e.has("_services")){let i=new Set(this._actions.map(n=>n.id));this._availableServices=this._services.filter(n=>!i.has(n.id)),this._addSchema=[{name:"service",selector:{select:{options:this._availableServices.map(n=>({value:n.id,label:this._addOptionLabel(n.id)})),custom_value:!0,mode:"dropdown",sort:!0}}}]}}async _reload(){this._loadError=null;try{let[e,i,n]=await Promise.all([Bt(this.hass),Oo(this.hass),Oi(this.hass)]);this._actions=e,this._services=i,this._installId=n,this._fadoNoticeDismissed=So(n)}catch(e){this._loadError=S(this.hass,e);return}await Promise.all(this._actions.map(e=>this._ensureSchema(e.id))),this._loaded=!0}async _ensureSchema(e){if(!(e in this._schemas))try{let i=await He(this.hass,e);this._schemas={...this._schemas,[e]:i}}catch{this._schemas={...this._schemas,[e]:null}}}_setShowInEditor(e,i,n){this._actions=this._actions.map(o=>{if(o.id!==e)return o;let s=new Set(o.visible_fields??[]);return n?s.add(i):s.delete(i),{...o,visible_fields:[...s]}}),this._autoSave()}_setDefault(e,i,n){this._actions=this._actions.map(o=>o.id!==e?o:{...o,defaults:{...o.defaults??{},[i]:n}})}_clearDefault(e,i){this._actions=this._actions.map(n=>{if(n.id!==e)return n;let o={...n.defaults??{}};return delete o[i],{...n,defaults:o}})}_setLabel(e,i){this._actions=this._actions.map(n=>n.id===e?{...n,label:i}:n)}_toggleExpand(e){this._expanded.has(e)?this._expanded=new Set:(this._expanded=new Set([e]),this._ensureSchema(e))}async _addService(e){if(e&&this._services.some(i=>i.id===e)){if(this._actions.some(i=>i.id===e)){this._expanded=new Set([e]),this._adding=!1;return}await this._ensureSchema(e),this._actions=[...this._actions,{id:e,label:this._labelForService(e),visible_fields:[],defaults:{}}],this._expanded=new Set([e]),this._adding=!1,this._autoSave()}}_removeService(e){this._actions=this._actions.filter(n=>n.id!==e);let i=new Set(this._expanded);i.delete(e),this._expanded=i,this._autoSave()}async _autoSave(){this._saveError=null;try{await No(this.hass,this._actions),window.dispatchEvent(new CustomEvent("ambience-exposed-actions-changed"))}catch(e){this._saveError=S(this.hass,e)}}render(){return this._loadError!==null?l`
    ...
    `:l`<div>${a(this.hass,"ui.loading","Loading\u2026")}</div>`}_renderFadoNotice(){return this._fadoNoticeDismissed||Xa(this.hass,_p)?"":l`
      <ambience-banner
    ...
    `}_dismissFadoNotice(){this._fadoNoticeDismissed=!0,Eo(this._installId)}_renderCard(e,i){let n=this._schemas[e.id],o=this._expanded.has(e.id);return l`
      <div
  ...
  `],I._OVERLAY_TAG_RE=/vaadin|combo-box|overlay|listbox|menu|mwc-|md-/i,c([m({attribute:!1})],I.prototype,"hass",2),c([f()],I.prototype,"_actions",2),c([f()],I.prototype,"_services",2),c([f()],I.prototype,"_schemas",2),c([f()],I.prototype,"_fieldSchemas",2),c([f()],I.prototype,"_addSchema",2),c([f()],I.prototype,"_expanded",2),c([f()],I.prototype,"_adding",2),c([f()],I.prototype,"_loadError",2),c([f()],I.prototype,"_saveError",2),c([f()],I.prototype,"_loaded",2),c([f()],I.prototype,"_fadoNoticeDismissed",2),c([f()],I.prototype,"_editingDefault",2),c([f()],I.prototype,"_editingOriginalValue",2),c([f()],I.prototype,"_editingOriginalHad",2),I=c([w("ambience-actions-settings")],I);var B=class extends Error{constructor(r){super(r),this.name="ImportError"}};function Pr(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function gp(t){if(!Pr(t))throw new B("`scope` must be an object with a `kind`.");let r=t.kind;if(r==="house")return{kind:"house"};if(r==="area"||r==="floor"){if(typeof t.id!="string"||t.id==="")throw new B(`A ${r} scope needs a non-empty \`id\`.`);return{kind:r,id:t.id}}throw new B("`scope.kind` must be one of: area, floor, house.")}function vp(t){if(!Array.isArray(t))throw new B("`scenes` must be a list.");return t.map((r,e)=>{if(!Pr(r))throw new B(`Scene ${e+1} must be an object.`);if(typeof r.category!="string"||r.category==="")throw new B(`Scene ${e+1} is missing a \`category\`.`);return r})}function yp(t){if(t!==void 0){if(!Pr(t)||typeof t.id!="string"||t.id==="")throw new B("`category` must be an object with a non-empty `id`.");return t}}function Za(t){let r;try{r=_r(t)}catch(n){throw new B(`Could not parse YAML/JSON: ${n.message}`)}if(!Pr(r))throw new B("Import must be a YAML/JSON object (an `ambience_import` block).");let e=Number(r.ambience_import);if(r.ambience_import===void 0||!Number.isFinite(e)||e<1)throw new B("Missing or invalid `ambience_import` marker \u2014 is this an Ambience import block?");if(e>1)throw new B(`This is import format v${e}, but this Ambience only understands v1 \u2014 update Ambience.`);let i=r.mode??"merge";if(i!=="merge"&&i!=="replace")throw new B("`mode` must be `merge` or `replace`.");return{ambience_import:e,scope:gp(r.scope),category:yp(r.category),mode:i,scenes:vp(r.scenes)}}function Nn(t){return`${t.category}\0${(t.name??"").trim().toLowerCase()}`}function Tr(t){return t.name??"(unnamed)"}function el(t,r,e){let i=new Set(e.map(v=>v.id)),n=t.category?.id,o=t.category&&!i.has(t.category.id)?t.category:null,s=new Set(i);n&&s.add(n);let d=[...new Set(t.scenes.map(v=>v.category).filter(v=>!s.has(v)))],u=r.scenes??[],p=[],h=[],_=[],g;if(t.mode==="replace"){let v=new Set(t.scenes.map(x=>x.category));for(let x of u)v.has(x.category)&&_.push(Tr(x));g=u.filter(x=>!v.has(x.category));for(let x of t.scenes)p.push(Tr(x)),g.push(x)}else{g=u.map(x=>({...x}));let v=new Map(g.map((x,C)=>[Nn(x),C]));for(let x of t.scenes){let P=(x.name??"").trim()!==""?v.get(Nn(x)):void 0;P!==void 0?(g[P]=x,h.push(Tr(x))):(v.set(Nn(x),g.length),g.push(x),p.push(Tr(x)))}}return{scope:t.scope,mode:t.mode,newCategory:o,unknownCategories:d,adds:p,updates:h,removes:_,resultConfig:{...r,scenes:g}}}var bp=Ct("reference/ai/mcp-server"),wp=Ct("reference/ai/download-and-paste"),xp=`${tn}/issues/new`,ae=class extends b{constructor(){super(...arguments);this.text="";this.error=null;this.preview=null;this.categories=[];this.busy=!1;this.done=null}async _download(){try{await ss(this.hass)}catch(e){this.error=S(this.hass,e)}}async _onFile(e){let i=e.target,n=i.files?.[0];if(i.value="",!!n){this.error=null,this.done=null,this.preview=null;try{this.text=await n.text()}catch(o){this.error=S(this.hass,o);return}await this._doPreview()}}async _doPreview(){this.done=null;try{let e=Za(this.text),[i,n]=await Promise.all([ls(this.hass,e.scope),Ce(this.hass)]);this.categories=n,this.preview=el(e,i,n),this.error=null}catch(e){this.preview=null,this.error=e instanceof B?e.message:S(this.hass,e)}}async _confirm(){let e=this.preview;if(!(!e||e.unknownCategories.length>0||this.busy)){this.busy=!0;try{await as(this.hass,e.resultConfig),e.newCategory&&await zi(this.hass,[...this.categories,e.newCategory]),await ds(this.hass,e.scope,e.resultConfig,{action:"import",scene_name:null},{minimisePins:!0}),window.dispatchEvent(new CustomEvent("ambience-config-imported")),e.newCategory&&window.dispatchEvent(new CustomEvent("ambience-categories-changed")),this.done=a(this.hass,"ui.import_done","Imported successfully."),this.preview=null,this.text=""}catch(i){this.error=S(this.hass,i)}finally{this.busy=!1}}}_list(e,i){return i.length===0?$:l`<div>${e}<ul>${i.map(n=>l`<li>${n}</li>`)}</ul></div>`}_renderPreview(e){let i=e.scope.kind==="house"?e.scope.kind:`${e.scope.kind} ${e.scope.id}`;return l`
    ...
    `}render(){return l`
      ...
      <section class="path">
        ...
        <li>
          ...
          <div class="step-body">
            ...
            <a class="help-link" href=${wp} target="_blank" rel="noopener noreferrer"
      ...
      <div class="feedback card">
        ...
        <div class="fb-body">
          ...
          <a class="fb-link" href=${xp} target="_blank" rel="noopener noreferrer"
  ...
  `,c([m({attribute:!1})],Xe.prototype,"hass",2),c([m({type:Boolean,reflect:!0})],Xe.prototype,"open",2),c([m({attribute:!1})],Xe.prototype,"initialTab",2),Xe=c([w("ambience-settings-modal")],Xe);function $p(t){let r=t.indexOf("?");return r===-1?"":new URLSearchParams(t.slice(r+1)).get("fe")??""}var tl={runningFrontendHash(){return $p(import.meta.url)}};var kp={reload(){location.reload()}},fi=class extends b{constructor(){super(...arguments);this._serverVersion=null;this._checked=!1}static{this.styles=y`
    :host {
      display: block;
    }
    .message {
