...
`:""}var pc=hc,mc={dump:pc};function Wr(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var bo=ao.load,Vp=ao.loadAll,Gi=mc.dump;var qp=Wr("safeLoad","load"),Kp=Wr("safeLoadAll","loadAll"),Gp=Wr("safeDump","dump");var ue=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>Tr(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let r=this._currentFields()?.[e.name]?.description;return typeof r=="string"?r:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Gi(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Gi(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Gi(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=bo(e)}catch(c){this._yamlError=c.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=l(this.hass,"ui.yaml_expect_object","Expected an object");return}let r=i,s=r.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=l(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=r.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=l(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let a=r.triggers;if(a!==void 0&&(!Array.isArray(a)||!a.every(c=>typeof c=="string"))){this._yamlError=l(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:a})}_emit(e){this.value=e,T(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(r=>`script.${r}`)}_label(e){return j(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},r={};for(let[s,o]of Object.entries(i))o&&Object.hasOwn(o,"default")&&(r[s]=o.default);return r}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,r])=>({name:i,required:r.required,selector:r.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),r=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return d`
  ...
  `,u([m({attribute:!1})],Qe.prototype,"hass",2),u([m({attribute:!1})],Qe.prototype,"value",2),Qe=u([w("ambience-time-endpoint")],Qe);function gc(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function _c(t,n){if(t===0)return"";let e=Math.abs(t),i=t<0?"\u2212":"+";if(e%60===0){let r=e/60,s=r===1?l(n,"ui.unit_hour","hour"):l(n,"ui.unit_hours","hours");return`${i}${r} ${s}`}return`${i}${e} ${l(n,"ui.unit_min","min")}`}function Yi(t,n){if(!t)return[];let e=Object.keys(t.builtins??{}),i=n?e.slice().sort(n):e,r=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(o=>!(o in(t.builtins??{})));return[...i.filter(o=>!r.has(o)),...s]}var he=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._error=""}static{this.styles=y`
    :host { display: block; }
  ...
  `,u([m({attribute:!1})],Ze.prototype,"hass",2),u([m({attribute:!1})],Ze.prototype,"value",2),Ze=u([w("ambience-people-predicate-input")],Ze);var et=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[]}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_build(e){let i={...this._cur(),...e},r={sensors:i.sensors??[]};if(i.occupied===!1&&(r.occupied=!1),i.quant==="all"&&(r.quant="all"),jt(i.for)){r.for=i.for;let s=gt(i.for,i.for_mode);s&&(r.for_mode=s)}return i.negate===!0&&(r.negate=!0),r}_emit(e){this.value=e,T(this,e)}_setSensors(e){this._emit(this._build({sensors:e}))}_setOccupied(e){this._emit(this._build({occupied:e}))}_setNegate(e){this._emit(this._build({negate:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setFor(e){let{mode:i,...r}=e;this._emit(this._build({for:r,for_mode:i??"at_least"}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"binary_sensor",device_class:["occupancy","presence","motion"],multiple:!0}}}]}_renderSensors(){return xt(this.hass,this._sensorSchema(),this._sensors(),"binary_sensor.a, binary_sensor.b",e=>this._setSensors(e))}_renderNegate(e){return Je(this.hass,"negate","negate",e?"is_not":"is",[{value:"is",label:l(this.hass,"ui.occupancy_is","is")},{value:"is_not",label:l(this.hass,"ui.occupancy_is_not","is not")}],i=>this._setNegate(i==="is_not"))}_renderOccupied(e){return Je(this.hass,"state","state",e?"occupied":"vacant",[{value:"occupied",label:l(this.hass,"ui.occupancy_detected","Detected")},{value:"vacant",label:l(this.hass,"ui.occupancy_clear","Clear")}],i=>this._setOccupied(i==="occupied"))}_renderQuant(e){return Je(this.hass,"quant","quant",e,[{value:"any",label:l(this.hass,"ui.occupancy_any","Any of")},{value:"all",label:l(this.hass,"ui.occupancy_all","All of")}],i=>this._setQuant(i))}_renderFor(){return d`<ambience-for-duration
    ...
    .for-row { display: flex; gap: 0.25rem; align-items: center; }
    .for-row input[type='number'] { width: 3.5rem; }
  `,u([m({attribute:!1})],et.prototype,"hass",2),u([m({attribute:!1})],et.prototype,"value",2),et=u([w("ambience-occupancy-predicate-input")],et);function Ao(t,n){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?l(n,"ui.unavailable_select_one","Select at least one entity"):null}var kc=[{name:"sensors",selector:{entity:{multiple:!0}}}],tt=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,T(this,i)}render(){return d`
      <div class="row">
...
`;function Oo(t,n){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:n},bubbles:!0,composed:!0}))}function Qr(t,n){return d`<span
    class="entity-link"
    role="button"
    tabindex="0"
    title="Show more info"
    @click=${i=>Oo(i,t)}
    @keydown=${i=>{(i.key==="Enter"||i.key===" ")&&!i.repeat&&(i.preventDefault(),Oo(i,t))}}
    >${n}</span
  >`}function No(t,n){return Qr(n,ji(t,n))}var Rc=new Set(["occupancy","people","lux","state"]);function Ac(t,n,e,i,r){let s=Pc(t,n,e,i);if(!r?.length||!Rc.has(n))return s;let o=[],a=r.map(p=>({id:p,name:ji(t,p)})).sort((p,f)=>f.name.length-p.name.length);for(let{id:p,name:f}of a)for(let _=0;_<=s.length;){let v=s.indexOf(f,_);if(v===-1)break;let x=v+f.length;if(!o.some(E=>v<E.end&&E.start<x)){o.push({start:v,end:x,id:p,name:f});break}_=v+1}if(o.length===0)return s;o.sort((p,f)=>p.start-f.start);let c=[],h=0;for(let p of o)p.start>h&&c.push(s.slice(h,p.start)),c.push(Qr(p.id,p.name)),h=p.end;return h<s.length&&c.push(s.slice(h)),d`${c}`}var Dc={has_time:"Periodic time check",switch:"Switch turned on",manual:"Manual apply",startup:"Startup",reloaded:"Reloaded",simulated:"Simulation"},Hc={clock:"Time of day",sun:"Sun position",reapply:"Reapply"};function me(t){return t??"?"}function Io(t){if(t.kind==="entity")return`${t.entity_id} ${me(t.old)} \u2192 ${me(t.new)}`;if(t.kind==="duration")return t.entity_id?`${t.entity_id} ${me(t.new)} for ${me(t.detail)}`:`${me(t.new)} for ${me(t.detail)}`;let n=Dc[t.kind];if(n)return n;let e=Hc[t.kind]??F(t.kind);return t.detail?`${e} ${t.detail}`:e}function Oc(t){if(!tr(t)||!t.entity_id)return d`${Io(t)}`;let n=Qr(t.entity_id,t.entity_id);return t.kind==="duration"?d`${n} ${me(t.new)} for ${me(t.detail)}`:d`${n} ${me(t.old)} → ${me(t.new)}`}function tr(t){return t.kind==="entity"||t.kind==="duration"&&!!t.entity_id}function Fo(t,n){let e=t.entity_id?n?.states?.[t.entity_id]:void 0,i=r=>r===null?"?":at(n,e,null,r);return{old:i(t.old),new:i(t.new)}}function Nc(t,n){if(!tr(t))return Io(t);let e=t.entity_id?ji(n,t.entity_id):"?",i=Fo(t,n);return t.kind==="duration"?`${e}: ${i.new} for ${t.detail??"?"}`:`${e}: ${i.old} \u2192 ${i.new}`}function Ic(t,n){if(!tr(t)||!t.entity_id)return d`${Nc(t,n)}`;let e=No(n,t.entity_id),i=Fo(t,n);return t.kind==="duration"?d`${e}: ${i.new} for ${t.detail??"?"}`:d`${e}: ${i.old} → ${i.new}`}var Fc={acted:"applied",no_op:"blocked",debounced:"unchanged",no_match:"no match",skipped_switch_off:"skipped",skipped_scope_disabled:"skipped",skipped_unavailable:"skipped"};function Mc(t){return Fc[t]??t.replace(/_/g," ")}function Mo(t){let n=t.winner_name??"The matching scene";switch(t.outcome){case"acted":{let e=t.actions.filter(a=>!a.unexposed),i=t.actions.length-e.length;if(e.length===0&&i)return`${n} matched \u2014 ${Zi(i,"action","actions")} skipped (not exposed); nothing applied.`;let r=Zi(e.length,"action","actions"),s=zo(e),o=i?` (${i} skipped \u2014 not exposed)`:"";return s?`Applied ${n} \u2014 ${r} on ${Zi(s,"entity","entities")}.${o}`:`Applied ${n} \u2014 ${r}.${o}`}case"no_op":return`${n} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.`;case"debounced":return`${n} matched, but it's already applied \u2014 nothing was re-sent.`;case"no_match":return"No scene matched \u2014 nothing applied.";case"skipped_switch_off":return"Skipped \u2014 the category switch is off.";case"skipped_scope_disabled":return"Skipped \u2014 the scope is disabled.";case"skipped_unavailable":return"Skipped \u2014 the triggering entity went unavailable; devices left as they are.";default:return""}}function jo(t,n){return ot(t,n,()=>hi(t))}function jc(t,n,e,i){let r=Object.entries(t.params??{}).filter(([,o])=>o!=null&&o!=="").map(([o,a])=>`${Bt(o,t.service,e)}: ${Le(n,a)}`).join(", "),s=jo(t.service,i);return r?`${s} \xB7 ${r}`:s}function zo(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function Zi(t,n,e){return`${t} ${t===1?n:e}`}function zc(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"||t==="skipped_unavailable"}function Uc(t,n,e){let i=t.index+1;return t.disabled?d`<div class="scene disabled">Scene #${i} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?d`
  ...
  `:d`<div class="scene skipped">Scene #${i} ${t.name??"\u2014"}: not reached</div>`}function ir(t,n,e,i,r,s={},o){let a=t.actions.filter(_=>!_.unexposed),c=a.map(_=>jo(_.service,o)).join(", "),h=zo(a),p=t.explanation!==null||t.actions.length>0||zc(t.outcome),f=_=>{(_.key==="Enter"||_.key===" ")&&!_.repeat&&(_.preventDefault(),e())};return d`
    <div class="eval">
      <div
        ...
        @keydown=${p?f:void 0}
      >
        <span class="label">${Mc(t.outcome)}</span>
      ...
      <div class="eval-body">
        ...
        ${a.length?d`<div class="action-summary">→ ${c}
              ${h?d`<span class="n">· ${Zi(h,"entity","entities")}</span>`:$}</div>`:n?$:d`<div class="action-summary">${Mo(t)}</div>`}
      </div>
      ${n?Wc(t,i,r,s,o):$}
    </div>
  `}function Wc(t,n,e,i,r){let s=Mo(t),o=tr(t.cause);return d`
    <div class="why">
      ${o?d`<div class="raw-trigger">Trigger: ${Oc(t.cause)}</div>`:$}
