...
`;function tt(t,n){return l`<span class="category-swatch" style=${nr(t)}>
    ...
    `],u([m({attribute:!1})],te.prototype,"hass",2),u([g()],te.prototype,"_categories",2),u([g()],te.prototype,"_filterCategory",2),u([g()],te.prototype,"_open",2),u([g()],te.prototype,"_loaded",2),te=u([x("ambience-category-filter")],te);var ce={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ar=t=>(...n)=>({_$litDirective$:t,values:n}),rt=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,e,r){this._$Ct=n,this._$AM=e,this._$Ci=r}_$AS(n,e){return this.update(n,e)}update(n,e){return this.render(...e)}};var{I:qa}=Vi,Dn=t=>t;var Hn=t=>t.strings===void 0,An=()=>document.createComment(""),it=(t,n,e)=>{let r=t._$AA.parentNode,i=n===void 0?t._$AB:n._$AA;if(e===void 0){let s=r.insertBefore(An(),i),a=r.insertBefore(An(),i);e=new qa(s,a,t,t.options)}else{let s=e._$AB.nextSibling,a=e._$AM,o=a!==t;if(o){let c;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(c=t._$AU)!==a._$AU&&e._$AP(c)}if(s!==i||o){let c=e._$AA;for(;c!==s;){let h=Dn(c).nextSibling;Dn(r).insertBefore(c,i),c=h}}}return e},xe=(t,n,e=t)=>(t._$AI(n,e),t),Va={},or=(t,n=Va)=>t._$AH=n,On=t=>t._$AH,lr=t=>{t._$AR(),t._$AA.remove()};var ri=ar(class extends rt{constructor(t){if(super(t),t.type!==ce.PROPERTY&&t.type!==ce.ATTRIBUTE&&t.type!==ce.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Hn(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[n]){if(n===B||n===$)return n;let e=t.element,r=t.name;if(t.type===ce.PROPERTY){if(n===e[r])return B}else if(t.type===ce.BOOLEAN_ATTRIBUTE){if(!!n===e.hasAttribute(r))return B}else if(t.type===ce.ATTRIBUTE&&e.getAttribute(r)===n+"")return B;return or(t),n}});var Nn=(t,n,e)=>{let r=new Map;for(let i=n;i<=e;i++)r.set(t[i],i);return r},Fn=ar(class extends rt{constructor(t){if(super(t),t.type!==ce.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,n,e){let r;e===void 0?e=n:n!==void 0&&(r=n);let i=[],s=[],a=0;for(let o of t)i[a]=r?r(o,a):a,s[a]=e(o,a),a++;return{values:s,keys:i}}render(t,n,e){return this.dt(t,n,e).values}update(t,[n,e,r]){let i=On(t),{values:s,keys:a}=this.dt(n,e,r);if(!Array.isArray(i))return this.ut=a,s;let o=this.ut??=[],c=[],h,p,f=0,_=i.length-1,y=0,k=s.length-1;for(;f<=_&&y<=k;)if(i[f]===null)f++;else if(i[_]===null)_--;else if(o[f]===a[y])c[y]=xe(i[f],s[y]),f++,y++;else if(o[_]===a[k])c[k]=xe(i[_],s[k]),_--,k--;else if(o[f]===a[k])c[k]=xe(i[f],s[k]),it(t,c[k+1],i[f]),f++,k--;else if(o[_]===a[y])c[y]=xe(i[_],s[y]),it(t,i[f],i[_]),_--,y++;else if(h===void 0&&(h=Nn(a,y,k),p=Nn(o,f,_)),h.has(o[f]))if(h.has(o[_])){let E=p.get(a[y]),R=E!==void 0?i[E]:null;if(R===null){let W=it(t,i[f]);xe(W,s[y]),c[y]=W}else c[y]=xe(R,s[y]),it(t,i[f],R),i[E]=null;y++}else lr(i[_]),_--;else lr(i[f]),f++;for(;y<=k;){let E=it(t,c[k+1]);xe(E,s[y]),c[y++]=E}for(;f<=_;){let E=i[f++];E!==null&&lr(E)}return this.ut=a,or(t,c),B}});function U(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function dr(t,n){return`${U(t)}\0${n}`}function In(t,n){if(!n||n.entity==null)return[...t];let e=Array.isArray(n.entity)?n.entity:[n.entity];if(e.length===0)return[...t];let r=new Set,i=!1;for(let s of e){if(!s||typeof s!="object")continue;let a=s.domain;if(a==null){i=!0;continue}if(Array.isArray(a))for(let o of a)typeof o=="string"&&r.add(o);else typeof a=="string"&&r.add(a)}return i||r.size===0?[...t]:t.filter(s=>{let a=s.indexOf(".");return a<0?!1:r.has(s.slice(0,a))})}function cr(t,n,e=[]){let r=t;if(!r?.entities)return[];let i=r.entities,s=r.devices??{},a=r.areas??{},o=n.kind==="area"?new Set([n.id]):n.kind==="floor"?new Set(Object.values(a).filter(h=>h.floor_id===n.id).map(h=>h.area_id)):null,c=h=>{let p=h.area_id??(h.device_id?s[h.device_id]?.area_id??null:null);return p==null?!1:o===null?!0:o.has(p)};return Object.values(i).filter(c).filter(h=>e.length===0||e.includes(h.entity_id.split(".")[0])).map(h=>h.entity_id).sort()}function kt(t){let{priority:n,pinned:e,shadowed_by:r,...i}=t;return i}function Mn(t,n){if(n<0||n>=t.length)return[];let e=new Set(t[n].entity_ids??[]),r=new Set;return t.forEach((i,s)=>{if(s!==n)for(let a of i.entity_ids??[])e.has(a)||r.add(a)}),[...r]}var ii={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Et(t,n){return t.kind==="house"?ii.house:t.kind==="floor"?n?.floors?.[t.id]?.icon||ii.floor:n?.areas?.[t.id]?.icon||ii.area}var ue=class extends b{constructor(){super(...arguments);this.items=[];this._open=!1;this._onKeydown=e=>{e.key==="Escape"&&this._open&&(this._open=!1)}}_triggerLabel(){return this.label??d(this.hass,"ui.more_actions","More actions")}_select(e,r){r.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("menu-action",{detail:{id:e},bubbles:!0,composed:!0}))}_renderItems(){return this.items.map(e=>l`
  ...
  `,u([m({attribute:!1})],ue.prototype,"items",2),u([m({attribute:!1})],ue.prototype,"hass",2),u([m()],ue.prototype,"label",2),u([g()],ue.prototype,"_open",2),ue=u([x("ambience-kebab-menu")],ue);function Ka(t){return t.style.pointerEvents="none",t.style.willChange="transform",()=>{t.style.pointerEvents="",t.style.willChange="",t.style.transform=""}}function ur(t,n,e={}){let r=t.pointerId;try{t.target?.setPointerCapture?.(r)}catch{}let i=e.follow??null,s=t.clientX,a=t.clientY,o=i?Ka(i):null,c=_=>{_.pointerId===r&&(n.onMove(_.clientX,_.clientY),i&&(i.style.transform=`translate(${_.clientX-s}px, ${_.clientY-a}px)`))},h=_=>{_.pointerId===r&&(f(),n.onEnd(_.clientX,_.clientY))},p=_=>{_.pointerId===r&&(f(),n.onCancel())},f=()=>{window.removeEventListener("pointermove",c,!0),window.removeEventListener("pointerup",h,!0),window.removeEventListener("pointercancel",p,!0),o?.()};return window.addEventListener("pointermove",c,!0),window.addEventListener("pointerup",h,!0),window.addEventListener("pointercancel",p,!0),f}function hr(t,n){let e=document.elementFromPoint?.(t,n)??null;if(!e)return null;for(;e.shadowRoot;){let r=e.shadowRoot.elementFromPoint?.(t,n);if(!r||r===e)break;e=r}return e}var nt=class{constructor(n,e,r={}){this.host=n;this.onReorder=e;this.from=null;this.over=null;this.moved=!1;this._cancelDrag=null;this._locate=r.locate??((i,s)=>this._domLocate(i,s)),n.addController(this)}hostDisconnected(){this._reset()}start(n,e){if(!e.isPrimary||e.button>0)return;this._reset(),this.from=n,this.moved=!1,this.host.requestUpdate();let r=e.target?.closest("[data-drag-index]");this._cancelDrag=ur(e,{onMove:(i,s)=>this._hover(this._locate(i,s)),onEnd:(i,s)=>this.drop(this._locate(i,s)),onCancel:()=>this.end()},{follow:r})}_hover(n){if(this.from===null)return;let e=n===null||n===this.from?null:n;e!==null&&(this.moved=!0),this.over!==e&&(this.over=e,this.host.requestUpdate())}drop(n){let e=this.from;this._reset(),!(e===null||n===null||e===n)&&this.onReorder(e,n)}end(){this._reset()}_domLocate(n,e){let r=this.host.renderRoot,s=(r?.elementFromPoint?r.elementFromPoint(n,e):hr(n,e))?.closest?.("[data-drag-index]");if(!s)return null;let a=Number(s.getAttribute("data-drag-index"));return Number.isNaN(a)?null:a}_reset(){this._cancelDrag?.(),this._cancelDrag=null;let n=this.from!==null||this.over!==null;this.from=null,this.over=null,n&&this.host.requestUpdate()}};var Ya={light:"mdi:lightbulb",switch:"mdi:toggle-switch-variant",binary_sensor:"mdi:motion-sensor",sensor:"mdi:eye",person:"mdi:account",device_tracker:"mdi:account",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:cast",lock:"mdi:lock",fan:"mdi:fan",weather:"mdi:weather-partly-cloudy",input_boolean:"mdi:toggle-switch",event:"mdi:eye-check",script:"mdi:script-text",template:"mdi:code-braces"},ni="mdi:eye";function N(t,n){let e=t?.states?.[n]?.attributes?.friendly_name;return typeof e=="string"&&e?e:n}function Ga(t,n){let e=t?.states?.[n]?.attributes?.icon;if(typeof e=="string"&&e)return e;let r=n.split(".")[0];return Ya[r]??ni}function St(t,n){let e=t?.states?.[n];return e&&customElements.get("ha-state-icon")?l`<ha-state-icon class="row-icon" .hass=${t} .stateObj=${e}></ha-state-icon>`:l`<ha-icon class="row-icon" icon=${Ga(t,n)}></ha-icon>`}var jn=v`
  .row-icon {
    flex: 0 0 auto;
    color: var(--secondary-text-color, #888);
    --mdc-icon-size: 22px;
...
`;function Tt(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return st(t)}function fr(t,n="New scene"){return t.name?.trim()?t.name:n}function Lt(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?_r(n,e):t==="day"?Za(n,e):t==="weather"?so(n,e):t==="sun"?ao(n,e):t==="state"?di(n,e):t==="script"?Ja(n,e):t==="people"?Xa(n,e):t==="occupancy"?oo(n,e):t==="lux"?lo(n,e):t==="template"?Qa(n,e):String(n)}function Qa(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function Ja(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=Ct(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(a=>`${ai(n.hass,t.script,a)}: ${we(n.hass,r[a])}`).join(", ");return`${e} (${s})`}function ai(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:st(e)}function Ct(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function zn(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):Ct(n,t)}function Xa(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=Ct(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${c} ${zn(e,n)}`;return t.for&&pr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>Ct(n,h)).join(", ");r=`${o} (${c})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${zn(e,n)}`;return t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function Za(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>Un(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>Un(a,n)).join(", ")})`}function Un(t,n){switch(t.kind){case"weekday":return t.days.map(e=>Xt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Ze(n.hass,t.month)} ${t.day}`;case"date_range":return`${Ze(n.hass,t.from.month)} ${t.from.day} \u2192 ${Ze(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var eo={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function st(t){return _e(t)}function to(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var ro=["entity_id","device_id","area_id","label_id","floor_id"],Wn=2;function io(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>ro.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function we(t,n){let e=io(n);if(!e)return to(n);let r=e.slice(0,Wn).map(a=>Ct({hass:t},a)),i=e.length-Wn;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function gr(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function no(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function so(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??no(a)).join("/"),i=(t.thresholds??[]).map(a=>`${bt(n.hass,a.attribute)} ${eo[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function ao(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function Kn(t,n){return N(t.hass,n)}function oi(t,n){return Kn({hass:t},n)}function oo(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(a=>N(n.hass,a)),r=t.occupied===!1?d(n.hass,"occupancy_summary.clear","clear"):d(n.hass,"occupancy_summary.detected","detected"),i=t.negate?`${d(n.hass,"occupancy_summary.not","not")} `:"",s;return e.length===1?s=`${e[0]} is ${i}${r}`:s=`${t.quant==="all"?d(n.hass,"occupancy_summary.all_of","all of"):d(n.hass,"occupancy_summary.any_of","any of")} (${e.join(", ")}) ${i}${r}`,t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function li(t,n,e="any lux"){return t!=null&&n!=null?`${t}\u2013${n} lx`:n!=null?`<${n} lx`:t!=null?`\u2265${t} lx`:e}function lo(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(s=>N(n.hass,s)),r=t.range!=null?Xe(n.hass,t.range,n.luxRanges?.custom??{}):li(t.min,t.max);return e.length===1?`${e[0]} ${r}`:`${t.quant==="all"?d(n.hass,"lux_summary.all_of","all of"):d(n.hass,"lux_summary.any_of","any of")} (${e.join(", ")}) ${r}`}function di(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):si(t,n)}function Bn(t,n,e){let r=J(n.hass,t.kind),i=Kn(n,t.entity_id),s=n.hass?.states?.[t.entity_id],o=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.map(f=>Je(n.hass,s,t.attribute,f)).join("/"),c=t.attribute?`${i}.${Qt(n.hass,s,t.attribute)}`:i,h=e?`${J(n.hass,"not")} `:"",p=`${c} ${r} ${h}${o}`;return t.for&&pr(t.for)?`${p} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:p}function si(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return Bn(t,n,!1);if(t.kind==="and"||t.kind==="or"){let e=` ${J(n.hass,t.kind)} `;return t.items.map(r=>qn(r,n)).join(e)}if(t.kind==="not"){let e=t.item;return e.kind==="is"?Bn(e,n,!0):`${J(n.hass,"not")} ${qn(e,n)}`}return""}function qn(t,n){return t.kind==="and"||t.kind==="or"?`(${si(t,n)})`:si(t,n)}function pr(t){return t.h>0||t.m>0||t.s>0}function mr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function _r(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ye(n.hass,i.period,r):`${Vn(i.from,n)} \u2192 ${Vn(i.to,n)}`).join(", ")}function Vn(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=ve(n.hass,t.anchor),r=e;if(t.offset_min!==0){let i=Math.abs(t.offset_min),s=i%60===0?`${i/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${i}${d(n.hass,"ui.unit_min_abbr","m")}`;r=`${e}${t.offset_min<0?"-":"+"}${s}`}if(t.clamp){let i=t.clamp.dir==="not_before"?d(n.hass,"ui.clamp_not_before","not before"):d(n.hass,"ui.clamp_not_after","not after"),s=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;r=`${r} (${i} ${s})`}return r}function co(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label?.trim()?e.label:Jt(n.hass,t.service)}function uo(t,n){let e=new Set;for(let r of t.entity_ids){let i=r.indexOf(".");i>0&&e.add(r.slice(0,i))}return e.size===1?[...e][0]:d(n.hass,"ui.target_noun","target")}function Yn(t,n){let e=co(t,n),r=uo(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,c])=>`${Tt(o,t.service,n.schemas)}: ${we(n.hass,c)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var F=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this._drag=new nt(this,(e,r)=>this._emit("reorder-scenes",{from:e,to:r}));this._expanded=new Set}_renderSectionHeader(e){return l`<div
  ...
  `,u([m({attribute:!1})],re.prototype,"hass",2),u([m({attribute:!1})],re.prototype,"entities",2),u([m({attribute:!1})],re.prototype,"value",2),u([m({attribute:!1})],re.prototype,"target",2),u([m()],re.prototype,"label",2),re=u([x("ambience-target-picker")],re);var I=class extends b{constructor(){super(...arguments);this.entityIds=[];this.params={};this.excludeEntities=[];this._schema=void 0;this._schemaError=null;this._exposedMissing=!1;this._formSchema=[];this._perFieldSchemas={};this._schemaServiceId=null;this._onTargetChanged=e=>{e.stopPropagation(),this._emit("entity-ids-changed",{entityIds:e.detail.value})};this._onFieldInput=e=>r=>{r.stopPropagation();let i=r.target,s={...this.params,[e]:i.value};this._emit("params-changed",{params:s})};this._onHaFormChanged=e=>{e.stopPropagation(),this._emit("params-changed",{params:{...this.params,...e.detail.value}})}}connectedCallback(){super.connectedCallback(),ge(this,this.hass)}willUpdate(e){if((e.has("exposed")&&e.get("exposed")?.id!==this.exposed?.id||e.has("hass")&&this._schema===void 0)&&this._loadSchema(),(e.has("exposed")||e.has("_schema"))&&(this._formSchema=this._buildFormSchema()),e.has("_formSchema")||e.has("_schema")||e.has("exposed")){let r={};for(let i of this._formSchema)r[i.name]=[i];this._perFieldSchemas=r}}async _loadSchema(){if(this.exposed===void 0&&this.hass){this._exposedMissing=!0,this._schema=null,this._schemaServiceId=null;return}let e=this.exposed?.id;if(!e||!this.hass){this._exposedMissing=!1,this._schema=void 0,this._schemaServiceId=null;return}this._exposedMissing=!1,this._schemaServiceId=e,this._schemaError=null,this._schema=void 0;try{let r=await be(this.hass,e);if(this._schemaServiceId!==e)return;this._schema=r}catch(r){if(this._schemaServiceId!==e)return;this._schema=null,this._schemaError=r instanceof Error?r.message:String(r)}}_buildFormSchema(){let e=this._schema,r=this.exposed;if(!e||!r)return[];let i=new Set(r.visible_fields??[]),s=[];for(let[a,o]of Object.entries(e.fields))i.has(a)&&s.push({name:a,selector:o.selector??{text:{}},required:!!o.required,description:typeof o.description=="string"&&o.description?o.description:void 0});return s}updated(e){super.updated?.(e),e.has("_schema")&&this.dispatchEvent(new CustomEvent("target-mode-changed",{detail:{hasTarget:this.hasTarget()},bubbles:!0,composed:!0}))}_hasTarget(){let e=this._schema?.target??null;return!e||typeof e!="object"?!1:Object.keys(e).length>0}hasTarget(){return this._schema===void 0?!1:this._hasTarget()}_scopeEntities(){return!this.scope||!this.hass?[]:cr(this.hass,this.scope,[])}_renderTargetPicker(){if(!this._hasTarget())return"";let e=new Set(this.excludeEntities),r=this._scopeEntities().filter(a=>!e.has(a)),i=this._schema?.target??null,s=d(this.hass,"ui.target","Target");return l`
...
`;return o.replace(/\n$/,"")}var ko=$o,Eo=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],So=["scalar","sequence","mapping"];function Co(t){var n={};return t!==null&&Object.keys(t).forEach(function(e){t[e].forEach(function(r){n[String(r)]=e})}),n}function To(t,n){if(n=n||{},Object.keys(n).forEach(function(e){if(Eo.indexOf(e)===-1)throw new q('Unknown option "'+e+'" is met in definition of "'+t+'" YAML type.')}),this.options=n,this.tag=t,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(e){return e},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.representName=n.representName||null,this.defaultStyle=n.defaultStyle||null,this.multi=n.multi||!1,this.styleAliases=Co(n.styleAliases||null),So.indexOf(this.kind)===-1)throw new q('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var M=To;function es(t,n){var e=[];return t[n].forEach(function(r){var i=e.length;e.forEach(function(s,a){s.tag===r.tag&&s.kind===r.kind&&s.multi===r.multi&&(i=a)}),e[i]=r}),e}function Lo(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},n,e;function r(i){i.multi?(t.multi[i.kind].push(i),t.multi.fallback.push(i)):t[i.kind][i.tag]=t.fallback[i.tag]=i}for(n=0,e=arguments.length;n<e;n+=1)arguments[n].forEach(r);return t}function pi(t){return this.extend(t)}pi.prototype.extend=function(n){var e=[],r=[];if(n instanceof M)r.push(n);else if(Array.isArray(n))r=r.concat(n);else if(n&&(Array.isArray(n.implicit)||Array.isArray(n.explicit)))n.implicit&&(e=e.concat(n.implicit)),n.explicit&&(r=r.concat(n.explicit));else throw new q("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.forEach(function(s){if(!(s instanceof M))throw new q("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new q("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new q("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),r.forEach(function(s){if(!(s instanceof M))throw new q("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var i=Object.create(pi.prototype);return i.implicit=(this.implicit||[]).concat(e),i.explicit=(this.explicit||[]).concat(r),i.compiledImplicit=es(i,"implicit"),i.compiledExplicit=es(i,"explicit"),i.compiledTypeMap=Lo(i.compiledImplicit,i.compiledExplicit),i};var Ro=pi,Po=new M("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),Do=new M("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),Ao=new M("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),Ho=new Ro({explicit:[Po,Do,Ao]});function Oo(t){if(t===null)return!0;var n=t.length;return n===1&&t==="~"||n===4&&(t==="null"||t==="Null"||t==="NULL")}function No(){return null}function Fo(t){return t===null}var Io=new M("tag:yaml.org,2002:null",{kind:"scalar",resolve:Oo,construct:No,predicate:Fo,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Mo(t){if(t===null)return!1;var n=t.length;return n===4&&(t==="true"||t==="True"||t==="TRUE")||n===5&&(t==="false"||t==="False"||t==="FALSE")}function jo(t){return t==="true"||t==="True"||t==="TRUE"}function zo(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var Uo=new M("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Mo,construct:jo,predicate:zo,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function Wo(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function Bo(t){return 48<=t&&t<=55}function qo(t){return 48<=t&&t<=57}function Vo(t){if(t===null)return!1;var n=t.length,e=0,r=!1,i;if(!n)return!1;if(i=t[e],(i==="-"||i==="+")&&(i=t[++e]),i==="0"){if(e+1===n)return!0;if(i=t[++e],i==="b"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(i!=="0"&&i!=="1")return!1;r=!0}return r&&i!=="_"}if(i==="x"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(!Wo(t.charCodeAt(e)))return!1;r=!0}return r&&i!=="_"}if(i==="o"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(!Bo(t.charCodeAt(e)))return!1;r=!0}return r&&i!=="_"}}if(i==="_")return!1;for(;e<n;e++)if(i=t[e],i!=="_"){if(!qo(t.charCodeAt(e)))return!1;r=!0}return!(!r||i==="_")}function Ko(t){var n=t,e=1,r;if(n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),r=n[0],(r==="-"||r==="+")&&(r==="-"&&(e=-1),n=n.slice(1),r=n[0]),n==="0")return 0;if(r==="0"){if(n[1]==="b")return e*parseInt(n.slice(2),2);if(n[1]==="x")return e*parseInt(n.slice(2),16);if(n[1]==="o")return e*parseInt(n.slice(2),8)}return e*parseInt(n,10)}function Yo(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!H.isNegativeZero(t)}var Go=new M("tag:yaml.org,2002:int",{kind:"scalar",resolve:Vo,construct:Ko,predicate:Yo,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Qo=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Jo(t){return!(t===null||!Qo.test(t)||t[t.length-1]==="_")}function Xo(t){var n,e;return n=t.replace(/_/g,"").toLowerCase(),e=n[0]==="-"?-1:1,"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?e===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:e*parseFloat(n,10)}var Zo=/^[-+]?[0-9]+e/;function el(t,n){var e;if(isNaN(t))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(H.isNegativeZero(t))return"-0.0";return e=t.toString(10),Zo.test(e)?e.replace("e",".e"):e}function tl(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||H.isNegativeZero(t))}var rl=new M("tag:yaml.org,2002:float",{kind:"scalar",resolve:Jo,construct:Xo,predicate:tl,represent:el,defaultStyle:"lowercase"}),il=Ho.extend({implicit:[Io,Uo,Go,rl]}),nl=il,_s=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),vs=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function sl(t){return t===null?!1:_s.exec(t)!==null||vs.exec(t)!==null}function al(t){var n,e,r,i,s,a,o,c=0,h=null,p,f,_;if(n=_s.exec(t),n===null&&(n=vs.exec(t)),n===null)throw new Error("Date resolve error");if(e=+n[1],r=+n[2]-1,i=+n[3],!n[4])return new Date(Date.UTC(e,r,i));if(s=+n[4],a=+n[5],o=+n[6],n[7]){for(c=n[7].slice(0,3);c.length<3;)c+="0";c=+c}return n[9]&&(p=+n[10],f=+(n[11]||0),h=(p*60+f)*6e4,n[9]==="-"&&(h=-h)),_=new Date(Date.UTC(e,r,i,s,a,o,c)),h&&_.setTime(_.getTime()-h),_}function ol(t){return t.toISOString()}var ll=new M("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:sl,construct:al,instanceOf:Date,represent:ol});function dl(t){return t==="<<"||t===null}var cl=new M("tag:yaml.org,2002:merge",{kind:"scalar",resolve:dl}),vi=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function ul(t){if(t===null)return!1;var n,e,r=0,i=t.length,s=vi;for(e=0;e<i;e++)if(n=s.indexOf(t.charAt(e)),!(n>64)){if(n<0)return!1;r+=6}return r%8===0}function hl(t){var n,e,r=t.replace(/[\r\n=]/g,""),i=r.length,s=vi,a=0,o=[];for(n=0;n<i;n++)n%4===0&&n&&(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)),a=a<<6|s.indexOf(r.charAt(n));return e=i%4*6,e===0?(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)):e===18?(o.push(a>>10&255),o.push(a>>2&255)):e===12&&o.push(a>>4&255),new Uint8Array(o)}function pl(t){var n="",e=0,r,i,s=t.length,a=vi;for(r=0;r<s;r++)r%3===0&&r&&(n+=a[e>>18&63],n+=a[e>>12&63],n+=a[e>>6&63],n+=a[e&63]),e=(e<<8)+t[r];return i=s%3,i===0?(n+=a[e>>18&63],n+=a[e>>12&63],n+=a[e>>6&63],n+=a[e&63]):i===2?(n+=a[e>>10&63],n+=a[e>>4&63],n+=a[e<<2&63],n+=a[64]):i===1&&(n+=a[e>>2&63],n+=a[e<<4&63],n+=a[64],n+=a[64]),n}function ml(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var fl=new M("tag:yaml.org,2002:binary",{kind:"scalar",resolve:ul,construct:hl,predicate:ml,represent:pl}),gl=Object.prototype.hasOwnProperty,_l=Object.prototype.toString;function vl(t){if(t===null)return!0;var n=[],e,r,i,s,a,o=t;for(e=0,r=o.length;e<r;e+=1){if(i=o[e],a=!1,_l.call(i)!=="[object Object]")return!1;for(s in i)if(gl.call(i,s))if(!a)a=!0;else return!1;if(!a)return!1;if(n.indexOf(s)===-1)n.push(s);else return!1}return!0}function yl(t){return t!==null?t:[]}var bl=new M("tag:yaml.org,2002:omap",{kind:"sequence",resolve:vl,construct:yl}),xl=Object.prototype.toString;function wl(t){if(t===null)return!0;var n,e,r,i,s,a=t;for(s=new Array(a.length),n=0,e=a.length;n<e;n+=1){if(r=a[n],xl.call(r)!=="[object Object]"||(i=Object.keys(r),i.length!==1))return!1;s[n]=[i[0],r[i[0]]]}return!0}function $l(t){if(t===null)return[];var n,e,r,i,s,a=t;for(s=new Array(a.length),n=0,e=a.length;n<e;n+=1)r=a[n],i=Object.keys(r),s[n]=[i[0],r[i[0]]];return s}var kl=new M("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:wl,construct:$l}),El=Object.prototype.hasOwnProperty;function Sl(t){if(t===null)return!0;var n,e=t;for(n in e)if(El.call(e,n)&&e[n]!==null)return!1;return!0}function Cl(t){return t!==null?t:{}}var Tl=new M("tag:yaml.org,2002:set",{kind:"mapping",resolve:Sl,construct:Cl}),ys=nl.extend({implicit:[ll,cl],explicit:[fl,bl,kl,Tl]}),ke=Object.prototype.hasOwnProperty,vr=1,bs=2,xs=3,yr=4,hi=1,Ll=2,ts=3,Rl=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Pl=/[\x85\u2028\u2029]/,Dl=/[,\[\]\{\}]/,ws=/^(?:!|!!|![a-z\-]+!)$/i,$s=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function rs(t){return Object.prototype.toString.call(t)}function ie(t){return t===10||t===13}function ze(t){return t===9||t===32}function V(t){return t===9||t===32||t===10||t===13}function ot(t){return t===44||t===91||t===93||t===123||t===125}function Al(t){var n;return 48<=t&&t<=57?t-48:(n=t|32,97<=n&&n<=102?n-97+10:-1)}function Hl(t){return t===120?2:t===117?4:t===85?8:0}function Ol(t){return 48<=t&&t<=57?t-48:-1}function is(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function Nl(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function ks(t,n,e){n==="__proto__"?Object.defineProperty(t,n,{configurable:!0,enumerable:!0,writable:!0,value:e}):t[n]=e}var Es=new Array(256),Ss=new Array(256);for(je=0;je<256;je++)Es[je]=is(je)?1:0,Ss[je]=is(je);var je;function Fl(t,n){this.input=t,this.filename=n.filename||null,this.schema=n.schema||ys,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function Cs(t,n){var e={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return e.snippet=ko(e),new q(n,e)}function w(t,n){throw Cs(t,n)}function br(t,n){t.onWarning&&t.onWarning.call(null,Cs(t,n))}var ns={YAML:function(n,e,r){var i,s,a;n.version!==null&&w(n,"duplication of %YAML directive"),r.length!==1&&w(n,"YAML directive accepts exactly one argument"),i=/^([0-9]+)\.([0-9]+)$/.exec(r[0]),i===null&&w(n,"ill-formed argument of the YAML directive"),s=parseInt(i[1],10),a=parseInt(i[2],10),s!==1&&w(n,"unacceptable YAML version of the document"),n.version=r[0],n.checkLineBreaks=a<2,a!==1&&a!==2&&br(n,"unsupported YAML version of the document")},TAG:function(n,e,r){var i,s;r.length!==2&&w(n,"TAG directive accepts exactly two arguments"),i=r[0],s=r[1],ws.test(i)||w(n,"ill-formed tag handle (first argument) of the TAG directive"),ke.call(n.tagMap,i)&&w(n,'there is a previously declared suffix for "'+i+'" tag handle'),$s.test(s)||w(n,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{w(n,"tag prefix is malformed: "+s)}n.tagMap[i]=s}};function $e(t,n,e,r){var i,s,a,o;if(n<e){if(o=t.input.slice(n,e),r)for(i=0,s=o.length;i<s;i+=1)a=o.charCodeAt(i),a===9||32<=a&&a<=1114111||w(t,"expected valid JSON character");else Rl.test(o)&&w(t,"the stream contains non-printable characters");t.result+=o}}function ss(t,n,e,r){var i,s,a,o;for(H.isObject(e)||w(t,"cannot merge mappings; the provided source object is unacceptable"),i=Object.keys(e),a=0,o=i.length;a<o;a+=1)s=i[a],ke.call(n,s)||(ks(n,s,e[s]),r[s]=!0)}function lt(t,n,e,r,i,s,a,o,c){var h,p;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),h=0,p=i.length;h<p;h+=1)Array.isArray(i[h])&&w(t,"nested arrays are not supported inside keys"),typeof i=="object"&&rs(i[h])==="[object Object]"&&(i[h]="[object Object]");if(typeof i=="object"&&rs(i)==="[object Object]"&&(i="[object Object]"),i=String(i),n===null&&(n={}),r==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(h=0,p=s.length;h<p;h+=1)ss(t,n,s[h],e);else ss(t,n,s,e);else!t.json&&!ke.call(e,i)&&ke.call(n,i)&&(t.line=a||t.line,t.lineStart=o||t.lineStart,t.position=c||t.position,w(t,"duplicated mapping key")),ks(n,i,s),delete e[i];return n}function yi(t){var n;n=t.input.charCodeAt(t.position),n===10?t.position++:n===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):w(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function D(t,n,e){for(var r=0,i=t.input.charCodeAt(t.position);i!==0;){for(;ze(i);)i===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),i=t.input.charCodeAt(++t.position);if(n&&i===35)do i=t.input.charCodeAt(++t.position);while(i!==10&&i!==13&&i!==0);if(ie(i))for(yi(t),i=t.input.charCodeAt(t.position),r++,t.lineIndent=0;i===32;)t.lineIndent++,i=t.input.charCodeAt(++t.position);else break}return e!==-1&&r!==0&&t.lineIndent<e&&br(t,"deficient indentation"),r}function $r(t){var n=t.position,e;return e=t.input.charCodeAt(n),!!((e===45||e===46)&&e===t.input.charCodeAt(n+1)&&e===t.input.charCodeAt(n+2)&&(n+=3,e=t.input.charCodeAt(n),e===0||V(e)))}function bi(t,n){n===1?t.result+=" ":n>1&&(t.result+=H.repeat(`
`,n-1))}function Il(t,n,e){var r,i,s,a,o,c,h,p,f=t.kind,_=t.result,y;if(y=t.input.charCodeAt(t.position),V(y)||ot(y)||y===35||y===38||y===42||y===33||y===124||y===62||y===39||y===34||y===37||y===64||y===96||(y===63||y===45)&&(i=t.input.charCodeAt(t.position+1),V(i)||e&&ot(i)))return!1;for(t.kind="scalar",t.result="",s=a=t.position,o=!1;y!==0;){if(y===58){if(i=t.input.charCodeAt(t.position+1),V(i)||e&&ot(i))break}else if(y===35){if(r=t.input.charCodeAt(t.position-1),V(r))break}else{if(t.position===t.lineStart&&$r(t)||e&&ot(y))break;if(ie(y))if(c=t.line,h=t.lineStart,p=t.lineIndent,D(t,!1,-1),t.lineIndent>=n){o=!0,y=t.input.charCodeAt(t.position);continue}else{t.position=a,t.line=c,t.lineStart=h,t.lineIndent=p;break}}o&&($e(t,s,a,!1),bi(t,t.line-c),s=a=t.position,o=!1),ze(y)||(a=t.position+1),y=t.input.charCodeAt(++t.position)}return $e(t,s,a,!1),t.result?!0:(t.kind=f,t.result=_,!1)}function Ml(t,n){var e,r,i;if(e=t.input.charCodeAt(t.position),e!==39)return!1;for(t.kind="scalar",t.result="",t.position++,r=i=t.position;(e=t.input.charCodeAt(t.position))!==0;)if(e===39)if($e(t,r,t.position,!0),e=t.input.charCodeAt(++t.position),e===39)r=t.position,t.position++,i=t.position;else return!0;else ie(e)?($e(t,r,i,!0),bi(t,D(t,!1,n)),r=i=t.position):t.position===t.lineStart&&$r(t)?w(t,"unexpected end of the document within a single quoted scalar"):(t.position++,i=t.position);w(t,"unexpected end of the stream within a single quoted scalar")}function jl(t,n){var e,r,i,s,a,o;if(o=t.input.charCodeAt(t.position),o!==34)return!1;for(t.kind="scalar",t.result="",t.position++,e=r=t.position;(o=t.input.charCodeAt(t.position))!==0;){if(o===34)return $e(t,e,t.position,!0),t.position++,!0;if(o===92){if($e(t,e,t.position,!0),o=t.input.charCodeAt(++t.position),ie(o))D(t,!1,n);else if(o<256&&Es[o])t.result+=Ss[o],t.position++;else if((a=Hl(o))>0){for(i=a,s=0;i>0;i--)o=t.input.charCodeAt(++t.position),(a=Al(o))>=0?s=(s<<4)+a:w(t,"expected hexadecimal character");t.result+=Nl(s),t.position++}else w(t,"unknown escape sequence");e=r=t.position}else ie(o)?($e(t,e,r,!0),bi(t,D(t,!1,n)),e=r=t.position):t.position===t.lineStart&&$r(t)?w(t,"unexpected end of the document within a double quoted scalar"):(t.position++,r=t.position)}w(t,"unexpected end of the stream within a double quoted scalar")}function zl(t,n){var e=!0,r,i,s,a=t.tag,o,c=t.anchor,h,p,f,_,y,k=Object.create(null),E,R,W,T;if(T=t.input.charCodeAt(t.position),T===91)p=93,y=!1,o=[];else if(T===123)p=125,y=!0,o={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=o),T=t.input.charCodeAt(++t.position);T!==0;){if(D(t,!0,n),T=t.input.charCodeAt(t.position),T===p)return t.position++,t.tag=a,t.anchor=c,t.kind=y?"mapping":"sequence",t.result=o,!0;e?T===44&&w(t,"expected the node content, but found ','"):w(t,"missed comma between flow collection entries"),R=E=W=null,f=_=!1,T===63&&(h=t.input.charCodeAt(t.position+1),V(h)&&(f=_=!0,t.position++,D(t,!0,n))),r=t.line,i=t.lineStart,s=t.position,dt(t,n,vr,!1,!0),R=t.tag,E=t.result,D(t,!0,n),T=t.input.charCodeAt(t.position),(_||t.line===r)&&T===58&&(f=!0,T=t.input.charCodeAt(++t.position),D(t,!0,n),dt(t,n,vr,!1,!0),W=t.result),y?lt(t,o,k,R,E,W,r,i,s):f?o.push(lt(t,null,k,R,E,W,r,i,s)):o.push(E),D(t,!0,n),T=t.input.charCodeAt(t.position),T===44?(e=!0,T=t.input.charCodeAt(++t.position)):e=!1}w(t,"unexpected end of the stream within a flow collection")}function Ul(t,n){var e,r,i=hi,s=!1,a=!1,o=n,c=0,h=!1,p,f;if(f=t.input.charCodeAt(t.position),f===124)r=!1;else if(f===62)r=!0;else return!1;for(t.kind="scalar",t.result="";f!==0;)if(f=t.input.charCodeAt(++t.position),f===43||f===45)hi===i?i=f===43?ts:Ll:w(t,"repeat of a chomping mode identifier");else if((p=Ol(f))>=0)p===0?w(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?w(t,"repeat of an indentation width identifier"):(o=n+p-1,a=!0);else break;if(ze(f)){do f=t.input.charCodeAt(++t.position);while(ze(f));if(f===35)do f=t.input.charCodeAt(++t.position);while(!ie(f)&&f!==0)}for(;f!==0;){for(yi(t),t.lineIndent=0,f=t.input.charCodeAt(t.position);(!a||t.lineIndent<o)&&f===32;)t.lineIndent++,f=t.input.charCodeAt(++t.position);if(!a&&t.lineIndent>o&&(o=t.lineIndent),ie(f)){c++;continue}if(t.lineIndent<o){i===ts?t.result+=H.repeat(`
...
`,c):t.result+=H.repeat(`
`,s?1+c:c),s=!0,a=!0,c=0,e=t.position;!ie(f)&&f!==0;)f=t.input.charCodeAt(++t.position);$e(t,e,t.position,!1)}return!0}function as(t,n){var e,r=t.tag,i=t.anchor,s=[],a,o=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,w(t,"tab characters must not be used in indentation")),!(c!==45||(a=t.input.charCodeAt(t.position+1),!V(a))));){if(o=!0,t.position++,D(t,!0,-1)&&t.lineIndent<=n){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,dt(t,n,xs,!1,!0),s.push(t.result),D(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>n)&&c!==0)w(t,"bad indentation of a sequence entry");else if(t.lineIndent<n)break}return o?(t.tag=r,t.anchor=i,t.kind="sequence",t.result=s,!0):!1}function Wl(t,n,e){var r,i,s,a,o,c,h=t.tag,p=t.anchor,f={},_=Object.create(null),y=null,k=null,E=null,R=!1,W=!1,T;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=f),T=t.input.charCodeAt(t.position);T!==0;){if(!R&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,w(t,"tab characters must not be used in indentation")),r=t.input.charCodeAt(t.position+1),s=t.line,(T===63||T===58)&&V(r))T===63?(R&&(lt(t,f,_,y,k,null,a,o,c),y=k=E=null),W=!0,R=!0,i=!0):R?(R=!1,i=!0):w(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,T=r;else{if(a=t.line,o=t.lineStart,c=t.position,!dt(t,e,bs,!1,!0))break;if(t.line===s){for(T=t.input.charCodeAt(t.position);ze(T);)T=t.input.charCodeAt(++t.position);if(T===58)T=t.input.charCodeAt(++t.position),V(T)||w(t,"a whitespace character is expected after the key-value separator within a block mapping"),R&&(lt(t,f,_,y,k,null,a,o,c),y=k=E=null),W=!0,R=!1,i=!1,y=t.tag,k=t.result;else if(W)w(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(W)w(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>n)&&(R&&(a=t.line,o=t.lineStart,c=t.position),dt(t,n,yr,!0,i)&&(R?k=t.result:E=t.result),R||(lt(t,f,_,y,k,E,a,o,c),y=k=E=null),D(t,!0,-1),T=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>n)&&T!==0)w(t,"bad indentation of a mapping entry");else if(t.lineIndent<n)break}return R&&lt(t,f,_,y,k,null,a,o,c),W&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=f),W}function Bl(t){var n,e=!1,r=!1,i,s,a;if(a=t.input.charCodeAt(t.position),a!==33)return!1;if(t.tag!==null&&w(t,"duplication of a tag property"),a=t.input.charCodeAt(++t.position),a===60?(e=!0,a=t.input.charCodeAt(++t.position)):a===33?(r=!0,i="!!",a=t.input.charCodeAt(++t.position)):i="!",n=t.position,e){do a=t.input.charCodeAt(++t.position);while(a!==0&&a!==62);t.position<t.length?(s=t.input.slice(n,t.position),a=t.input.charCodeAt(++t.position)):w(t,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!V(a);)a===33&&(r?w(t,"tag suffix cannot contain exclamation marks"):(i=t.input.slice(n-1,t.position+1),ws.test(i)||w(t,"named tag handle cannot contain such characters"),r=!0,n=t.position+1)),a=t.input.charCodeAt(++t.position);s=t.input.slice(n,t.position),Dl.test(s)&&w(t,"tag suffix cannot contain flow indicator characters")}s&&!$s.test(s)&&w(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{w(t,"tag name is malformed: "+s)}return e?t.tag=s:ke.call(t.tagMap,i)?t.tag=t.tagMap[i]+s:i==="!"?t.tag="!"+s:i==="!!"?t.tag="tag:yaml.org,2002:"+s:w(t,'undeclared tag handle "'+i+'"'),!0}function ql(t){var n,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&w(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),n=t.position;e!==0&&!V(e)&&!ot(e);)e=t.input.charCodeAt(++t.position);return t.position===n&&w(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(n,t.position),!0}function Vl(t){var n,e,r;if(r=t.input.charCodeAt(t.position),r!==42)return!1;for(r=t.input.charCodeAt(++t.position),n=t.position;r!==0&&!V(r)&&!ot(r);)r=t.input.charCodeAt(++t.position);return t.position===n&&w(t,"name of an alias node must contain at least one character"),e=t.input.slice(n,t.position),ke.call(t.anchorMap,e)||w(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],D(t,!0,-1),!0}function dt(t,n,e,r,i){var s,a,o,c=1,h=!1,p=!1,f,_,y,k,E,R;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=a=o=yr===e||xs===e,r&&D(t,!0,-1)&&(h=!0,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)),c===1)for(;Bl(t)||ql(t);)D(t,!0,-1)?(h=!0,o=s,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)):o=!1;if(o&&(o=h||i),(c===1||yr===e)&&(vr===e||bs===e?E=n:E=n+1,R=t.position-t.lineStart,c===1?o&&(as(t,R)||Wl(t,R,E))||zl(t,E)?p=!0:(a&&Ul(t,E)||Ml(t,E)||jl(t,E)?p=!0:Vl(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&w(t,"alias node should not have any properties")):Il(t,E,vr===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=o&&as(t,R))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&w(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),f=0,_=t.implicitTypes.length;f<_;f+=1)if(k=t.implicitTypes[f],k.resolve(t.result)){t.result=k.construct(t.result),t.tag=k.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(ke.call(t.typeMap[t.kind||"fallback"],t.tag))k=t.typeMap[t.kind||"fallback"][t.tag];else for(k=null,y=t.typeMap.multi[t.kind||"fallback"],f=0,_=y.length;f<_;f+=1)if(t.tag.slice(0,y[f].tag.length)===y[f].tag){k=y[f];break}k||w(t,"unknown tag !<"+t.tag+">"),t.result!==null&&k.kind!==t.kind&&w(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+k.kind+'", not "'+t.kind+'"'),k.resolve(t.result,t.tag)?(t.result=k.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):w(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function Kl(t){var n=t.position,e,r,i,s=!1,a;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(a=t.input.charCodeAt(t.position))!==0&&(D(t,!0,-1),a=t.input.charCodeAt(t.position),!(t.lineIndent>0||a!==37));){for(s=!0,a=t.input.charCodeAt(++t.position),e=t.position;a!==0&&!V(a);)a=t.input.charCodeAt(++t.position);for(r=t.input.slice(e,t.position),i=[],r.length<1&&w(t,"directive name must not be less than one character in length");a!==0;){for(;ze(a);)a=t.input.charCodeAt(++t.position);if(a===35){do a=t.input.charCodeAt(++t.position);while(a!==0&&!ie(a));break}if(ie(a))break;for(e=t.position;a!==0&&!V(a);)a=t.input.charCodeAt(++t.position);i.push(t.input.slice(e,t.position))}a!==0&&yi(t),ke.call(ns,r)?ns[r](t,r,i):br(t,'unknown document directive "'+r+'"')}if(D(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,D(t,!0,-1)):s&&w(t,"directives end mark is expected"),dt(t,t.lineIndent-1,yr,!1,!0),D(t,!0,-1),t.checkLineBreaks&&Pl.test(t.input.slice(n,t.position))&&br(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&$r(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,D(t,!0,-1));return}if(t.position<t.length-1)w(t,"end of the stream or a document separator is expected");else return}function Ts(t,n){t=String(t),n=n||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Fl(t,n),r=t.indexOf("\0");for(r!==-1&&(e.position=r,w(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)Kl(e);return e.documents}function Yl(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var r=Ts(t,e);if(typeof n!="function")return r;for(var i=0,s=r.length;i<s;i+=1)n(r[i])}function Gl(t,n){var e=Ts(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new q("expected a single document in the stream, but found more")}}var Ql=Yl,Jl=Gl,Ls={loadAll:Ql,load:Jl},Rs=Object.prototype.toString,Ps=Object.prototype.hasOwnProperty,xi=65279,Xl=9,Dt=10,Zl=13,ed=32,td=33,rd=34,mi=35,id=37,nd=38,sd=39,ad=42,Ds=44,od=45,xr=58,ld=61,dd=62,cd=63,ud=64,As=91,Hs=93,hd=96,Os=123,pd=124,Ns=125,j={};j[0]="\\0";j[7]="\\a";j[8]="\\b";j[9]="\\t";j[10]="\\n";j[11]="\\v";j[12]="\\f";j[13]="\\r";j[27]="\\e";j[34]='\\"';j[92]="\\\\";j[133]="\\N";j[160]="\\_";j[8232]="\\L";j[8233]="\\P";var md=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],fd=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function gd(t,n){var e,r,i,s,a,o,c;if(n===null)return{};for(e={},r=Object.keys(n),i=0,s=r.length;i<s;i+=1)a=r[i],o=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),c=t.compiledTypeMap.fallback[a],c&&Ps.call(c.styleAliases,o)&&(o=c.styleAliases[o]),e[a]=o;return e}function _d(t){var n,e,r;if(n=t.toString(16).toUpperCase(),t<=255)e="x",r=2;else if(t<=65535)e="u",r=4;else if(t<=4294967295)e="U",r=8;else throw new q("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+H.repeat("0",r-n.length)+n}var vd=1,At=2;function yd(t){this.schema=t.schema||ys,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=H.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=gd(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?At:vd,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function os(t,n){for(var e=H.repeat(" ",n),r=0,i=-1,s="",a,o=t.length;r<o;)i=t.indexOf(`
`,r),i===-1?(a=t.slice(r),r=o):(a=t.slice(r,i+1),r=i+1),a.length&&a!==`
`&&(s+=e),s+=a;return s}function fi(t,n){return`
`+H.repeat(" ",t.indent*n)}function bd(t,n){var e,r,i;for(e=0,r=t.implicitTypes.length;e<r;e+=1)if(i=t.implicitTypes[e],i.resolve(n))return!0;return!1}function wr(t){return t===ed||t===Xl}function Ht(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==xi||65536<=t&&t<=1114111}function ls(t){return Ht(t)&&t!==xi&&t!==Zl&&t!==Dt}function ds(t,n,e){var r=ls(t),i=r&&!wr(t);return(e?r:r&&t!==Ds&&t!==As&&t!==Hs&&t!==Os&&t!==Ns)&&t!==mi&&!(n===xr&&!i)||ls(n)&&!wr(n)&&t===mi||n===xr&&i}function xd(t){return Ht(t)&&t!==xi&&!wr(t)&&t!==od&&t!==cd&&t!==xr&&t!==Ds&&t!==As&&t!==Hs&&t!==Os&&t!==Ns&&t!==mi&&t!==nd&&t!==ad&&t!==td&&t!==pd&&t!==ld&&t!==dd&&t!==sd&&t!==rd&&t!==id&&t!==ud&&t!==hd}function wd(t){return!wr(t)&&t!==xr}function Rt(t,n){var e=t.charCodeAt(n),r;return e>=55296&&e<=56319&&n+1<t.length&&(r=t.charCodeAt(n+1),r>=56320&&r<=57343)?(e-55296)*1024+r-56320+65536:e}function Fs(t){var n=/^\n* /;return n.test(t)}var Is=1,gi=2,Ms=3,js=4,at=5;function $d(t,n,e,r,i,s,a,o){var c,h=0,p=null,f=!1,_=!1,y=r!==-1,k=-1,E=xd(Rt(t,0))&&wd(Rt(t,t.length-1));if(n||a)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Rt(t,c),!Ht(h))return at;E=E&&ds(h,p,o),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Rt(t,c),h===Dt)f=!0,y&&(_=_||c-k-1>r&&t[k+1]!==" ",k=c);else if(!Ht(h))return at;E=E&&ds(h,p,o),p=h}_=_||y&&c-k-1>r&&t[k+1]!==" "}return!f&&!_?E&&!a&&!i(t)?Is:s===At?at:gi:e>9&&Fs(t)?at:a?s===At?at:gi:_?js:Ms}function kd(t,n,e,r,i){t.dump=(function(){if(n.length===0)return t.quotingType===At?'""':"''";if(!t.noCompatMode&&(md.indexOf(n)!==-1||fd.test(n)))return t.quotingType===At?'"'+n+'"':"'"+n+"'";var s=t.indent*Math.max(1,e),a=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),o=r||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return bd(t,h)}switch($d(n,o,t.indent,a,c,t.quotingType,t.forceQuotes&&!r,i)){case Is:return n;case gi:return"'"+n.replace(/'/g,"''")+"'";case Ms:return"|"+cs(n,t.indent)+us(os(n,s));case js:return">"+cs(n,t.indent)+us(os(Ed(n,a),s));case at:return'"'+Sd(n)+'"';default:throw new q("impossible error: invalid scalar style")}})()}function cs(t,n){var e=Fs(t)?String(n):"",r=t[t.length-1]===`
`,i=r&&(t[t.length-2]===`
`||t===`
`),s=i?"+":r?"":"-";return e+s+`
...
`:""}var Dd=Pd,Ad={dump:Dd};function wi(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var zs=Ls.load,Nh=Ls.loadAll,kr=Ad.dump;var Fh=wi("safeLoad","load"),Ih=wi("safeLoadAll","loadAll"),Mh=wi("safeDump","dump");var ne=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>ai(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let i=this._currentFields()?.[e.name]?.description;return typeof i=="string"?i:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=kr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=kr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=kr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=zs(e)}catch(c){this._yamlError=c.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(c=>typeof c=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,L(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){return N(this.hass,e)}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.hasOwn(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,u([m({attribute:!1})],Ue.prototype,"hass",2),u([m({attribute:!1})],Ue.prototype,"value",2),Ue=u([x("ambience-time-endpoint")],Ue);function Od(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function Nd(t,n){if(t===0)return"";let e=Math.abs(t),r=t<0?"\u2212":"+";if(e%60===0){let i=e/60,s=i===1?d(n,"ui.unit_hour","hour"):d(n,"ui.unit_hours","hours");return`${r}${i} ${s}`}return`${r}${e} ${d(n,"ui.unit_min","min")}`}function ct(t){return t.scope_kind==="house"?"House":t.scope_kind==="floor"?`Floor: ${t.scope_id??""}`:t.scope_id??""}function Er(t,n){if(!t)return[];let e=Object.keys(t.builtins??{}),r=n?e.slice().sort(n):e,i=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(a=>!(a in(t.builtins??{})));return[...r.filter(a=>!i.has(a)),...s]}var se=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}static{this.styles=v`
    :host { display: block; }
  ...
  `}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){this._view=await this._list()}async _saveState(e){let r=await this._save(e,this._view.hidden);this._warnings=r.warnings,await this._reload()}_onEdit(e,r){this._modal={mode:"edit",id:e,initial:r}}async _onDelete(e){let r={...this._view.custom};delete r[e],await this._saveState(r)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:r,definition:i}=e.detail;this._modal={mode:"closed"},await this._saveState({...this._view.custom,[r]:i})}_onModalCancel(){this._modal={mode:"closed"}}_takenIds(){return new Set([...Object.keys(this._view.builtins),...Object.keys(this._view.custom)])}_renderBuiltinRow(e,r,i){return l`
    ...
    .chip-label { flex: 1; }
  `,u([m({attribute:!1})],ae.prototype,"value",2),u([m({attribute:!1})],ae.prototype,"periods",2),u([m({attribute:!1})],ae.prototype,"hass",2),u([g()],ae.prototype,"_entries",2),u([g()],ae.prototype,"_openIdx",2),ae=u([x("ambience-time-of-day-input")],ae);function We(t,n,e,r,i,s){return customElements.get("ha-form")?l`<ha-form
      class=${n}
      .hass=${t}
  ...
  `,u([m({attribute:!1})],pe.prototype,"hass",2),u([m({attribute:!1})],pe.prototype,"value",2),u([m({attribute:!1})],pe.prototype,"groups",2),u([m({attribute:!1})],pe.prototype,"weatherEntity",2),pe=u([x("ambience-weather-predicate-input")],pe);var zd=["NW","N","NE","W",null,"E","SW","S","SE"],Be=class extends b{constructor(){super(...arguments);this.value=null}_current(){let e=this.value?.azimuth?.ranges??[];return{elevation:this.value?.elevation??null,sectors:[...this.value?.azimuth?.sectors??[]],range:e.length?{...e[0]}:null}}_emit(e){let r={};e.elevation&&(e.elevation.min!=null||e.elevation.max!=null)&&(r.elevation=e.elevation);let i={};e.sectors.length&&(i.sectors=e.sectors),e.range&&(i.ranges=[e.range]),(i.sectors||i.ranges)&&(r.azimuth=i),this.value=r.elevation||r.azimuth?r:null,L(this,this.value)}_setElevation(e){this._emit({...this._current(),elevation:e})}_setSectors(e){this._emit({...this._current(),sectors:e})}_setRange(e){this._emit({...this._current(),range:e})}_mode(e){return!e||e.min==null&&e.max==null?"any":e.min!=null&&e.max!=null?"between":e.min!=null?"above":"below"}_onModeChange(e,r){let i=r?.min??0,s=r?.max??0;e==="any"?this._setElevation(null):e==="above"?this._setElevation({min:i}):e==="below"?this._setElevation({max:s}):this._setElevation({min:i,max:s})}_toggleSector(e,r,i){this._setSectors(i?[...e,r]:e.filter(s=>s!==r))}_renderSectors(e){return l`<div class="sectors">${zd.map(r=>r===null?l`<span class="spacer"></span>`:l`<label>
  ...
  `,u([m({attribute:!1})],X.prototype,"condition",2),u([m({attribute:!1})],X.prototype,"value",2),u([m({attribute:!1})],X.prototype,"periods",2),u([m({attribute:!1})],X.prototype,"luxRanges",2),u([m({attribute:!1})],X.prototype,"dayConfig",2),u([m({attribute:!1})],X.prototype,"weatherConfig",2),u([m({attribute:!1})],X.prototype,"hass",2),X=u([x("ambience-condition-input")],X);function qd(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function Vd(t){return t==="people"?{quant:"everyone",where:"home"}:null}function Zs(t,n){return!!t&&!!n&&U(t)===U(n)}var S=class extends b{constructor(){super(...arguments);this.open=!1;this.scene=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.takenNames=new Map;this.saveError="";this._draft=null;this._open=null;this._showError=!1;this._addOrder=[];this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onAddCondition=e=>{let r=e.target,i=r.value;r.value="",this._addCondition(i)};this._onAddConditionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_CONDITION_PLACEHOLDER&&this._addCondition(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onConditionInvalid(e,r){r?this._conditionError.set(e,r):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),ge(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.scene?JSON.parse(JSON.stringify(this.scene)):null,this._scope=this.scope,this._open=null,this._showError=!1,this._addOrder=[])}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let r=this.scopes[e];if(!r||!this._draft||(this._scope=r.scope,!this.hass))return;let i=new Set(cr(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(a=>i.has(a))}))}}_renderDestination(){return l`
    ...
    `}_renderActionRow(e,r){let i=this.availableActions.find(p=>p.id===e.service),s=i?.reapply_seconds??0,a=this._isOpen({kind:"action",idx:r}),o=Yn(e,{hass:this.hass,exposedActions:this.availableActions,schemas:this.schemas}),c=Xn(e,s),h=s>0&&c>0;return l`
...
`;function ea(t,n){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:n},bubbles:!0,composed:!0}))}function ta(t,n){return l`<span
    ...
    >${n}</span
  >`}function ra(t,n){return ta(n,oi(t,n))}var Yd={has_time:"Periodic time check",switch:"Switch turned on",manual:"Manual apply",startup:"Startup",reloaded:"Reloaded",reapply:"Periodic refresh",simulated:"Simulation"},Gd={clock:"Time of day",sun:"Sun position"};function ia(t){if(t.kind==="entity")return`${t.entity_id} ${t.old} \u2192 ${t.new}`;if(t.kind==="duration")return`${t.entity_id} ${t.new} for ${t.detail}`;let n=Yd[t.kind];if(n)return n;let e=Gd[t.kind]??_e(t.kind);return t.detail?`${e} ${t.detail}`:e}function Qd(t){if(!Rr(t)||!t.entity_id)return l`${ia(t)}`;let n=ta(t.entity_id,t.entity_id);return t.kind==="duration"?l`${n} ${t.new} for ${t.detail}`:l`${n} ${t.old} → ${t.new}`}function Rr(t){return t.kind==="entity"||t.kind==="duration"}function na(t,n){let e=t.entity_id?n?.states?.[t.entity_id]:void 0,r=i=>i===null?"?":Je(n,e,null,i);return{old:r(t.old),new:r(t.new)}}function Jd(t,n){if(!Rr(t))return ia(t);let e=t.entity_id?oi(n,t.entity_id):"?",r=na(t,n);return t.kind==="duration"?`${e}: ${r.new} for ${t.detail??"?"}`:`${e}: ${r.old} \u2192 ${r.new}`}function Xd(t,n){if(!Rr(t)||!t.entity_id)return l`${Jd(t,n)}`;let e=ra(n,t.entity_id),r=na(t,n);return t.kind==="duration"?l`${e}: ${r.new} for ${t.detail??"?"}`:l`${e}: ${r.old} → ${r.new}`}var Zd={acted:"applied",no_op:"blocked",debounced:"unchanged",no_match:"no match",reapplied:"refreshed",skipped_switch_off:"skipped",skipped_scope_disabled:"skipped"};function ec(t){return Zd[t]??t.replace(/_/g," ")}function sa(t){let n=t.winner_name??"The matching scene";switch(t.outcome){case"acted":{let e=Ti(t.actions.length,"action","actions"),r=aa(t.actions);return r?`Applied ${n} \u2014 ${e} on ${Ti(r,"entity","entities")}.`:`Applied ${n} \u2014 ${e}.`}case"no_op":return`${n} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.`;case"debounced":return`${n} matched, but it's already applied \u2014 nothing was re-sent.`;case"no_match":return"No scene matched \u2014 nothing applied.";case"reapplied":return`Periodic refresh re-sent ${n}'s actions.`;case"skipped_switch_off":return"Skipped \u2014 the category switch is off.";case"skipped_scope_disabled":return"Skipped \u2014 the scope is disabled.";default:return""}}function tc(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,a])=>`${Tt(s,t.service,e)}: ${we(n,a)}`).join(", "),i=yt(t.service);return r?`${i} \xB7 ${r}`:i}function aa(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function Ti(t,n,e){return`${t} ${t===1?n:e}`}function rc(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"}function ic(t,n){let e=t.index+1;return t.disabled?l`<div class="scene disabled">Scene #${e} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
    ...
    ${t.predicates.map(r=>l`
        <div class="pred ${r.passed?"pass":"fail"}" style="padding-left:1rem">
          ${r.passed?"\u2713":"\u2717"} ${Y(n,r.condition_key)}${r.detail?l` <span class="dim">[${Kd(n,r.condition_key,r.detail)}]</span>`:$}
        </div>`)}
  `:l`<div class="scene skipped">Scene #${e} ${t.name??"\u2014"}: not reached</div>`}function Pr(t,n,e,r,i){let s=t.actions.map(h=>yt(h.service)).join(", "),a=aa(t.actions),o=t.explanation!==null||t.actions.length>0||rc(t.outcome),c=h=>{(h.key==="Enter"||h.key===" ")&&!h.repeat&&(h.preventDefault(),e())};return l`
    <div class="eval">
      <div
  ...
  `}var z=class extends b{constructor(){super(...arguments);this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1}connectedCallback(){super.connectedCallback(),this._poll=setInterval(()=>this._checkNew(),5e3)}disconnectedCallback(){super.disconnectedCallback(),this._poll&&clearInterval(this._poll)}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(r=>r.scope_kind===this.scope.scope_kind&&r.scope_id===this.scope.scope_id&&r.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await Zr(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=e.message||String(e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(a=>a.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let r=await Promise.all(e.map(async s=>{try{return[s,await be(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let i={...this._schemas};for(let s of r)s&&(i[s[0]]=s[1]);this._schemas=i}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let r=this._mine(await Zr(this.hass))[0]?.timestamp??null,i=this._records[0]?.timestamp??null;r&&(!i||r>i)&&(this._hasNew=!0)}catch{}}_toggle(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}async _download(){try{await Ln(this.hass,this.scope,this.category)}catch(e){this._error=e.message||String(e)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return $;let e=this.categoryName??this.category;return l`
    ...
    `],u([m({attribute:!1})],z.prototype,"hass",2),u([m({attribute:!1})],z.prototype,"scope",2),u([m()],z.prototype,"category",2),u([m()],z.prototype,"categoryName",2),u([m({type:Boolean,reflect:!0})],z.prototype,"open",2),u([g()],z.prototype,"_records",2),u([g()],z.prototype,"_schemas",2),u([g()],z.prototype,"_expanded",2),u([g()],z.prototype,"_loading",2),u([g()],z.prototype,"_error",2),u([g()],z.prototype,"_hasNew",2),z=u([x("ambience-traces-modal")],z);var sc={time:"mdi:clock-outline",sun:"mdi:weather-sunny",reapply:"mdi:refresh"},K=class extends b{constructor(){super(...arguments);this.scopeName="";this.scenes=[];this.open=!1;this._triggers=[];this._opaque=!1;this._loading=!1;this._error=""}willUpdate(e){super.willUpdate?.(e),this.open&&(e.has("open")||e.has("scenes")||e.has("scope"))&&this._load()}get _scopeId(){return this.scope.kind==="house"?null:this.scope.id}async _load(){this._loading=!0,this._error="";try{let e=await fn(this.hass,this.scope.kind,this._scopeId);this._triggers=e.triggers,this._opaque=e.opaque}catch(e){this._error=e.message||String(e)}finally{this._loading=!1}}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_openMoreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_entityName(e){return N(this.hass,e)}get _sortedTriggers(){let e=s=>this._entityName(s.entity_id).toLowerCase(),r=this._triggers.filter(s=>s.kind==="entity").sort((s,a)=>e(s).localeCompare(e(a))),i=this._triggers.filter(s=>s.kind!=="entity");return[...r,...i]}_sunPart(e){let r=ve(this.hass,e.anchor);return e.offset===0?r:`${r} ${e.offset>0?"+":""}${e.offset} min`}_rowContent(e){switch(e.kind){case"entity":return{title:this._entityName(e.entity_id),detail:e.entity_id};case"time":{let r=e.clocks.map(i=>`${String(i.hour).padStart(2,"0")}:${String(i.minute).padStart(2,"0")}`);return e.date_rollover&&r.push(d(this.hass,"ui.auto_trigger_date_rollover","Local midnight (date rollover)")),e.has_time&&r.push(d(this.hass,"ui.auto_trigger_periodic","periodic re-check")),{title:d(this.hass,"ui.auto_trigger_group_time","Time"),detail:r.join(", ")}}case"sun":return{title:d(this.hass,"ui.auto_trigger_group_sun","Sun"),detail:e.suns.map(r=>this._sunPart(r)).join(", ")};case"reapply":return{title:d(this.hass,"ui.auto_trigger_reapply","Re-apply"),detail:`${d(this.hass,"ui.auto_trigger_every","every")} ${Zn(e.interval_seconds)}`}}}_renderRowIcon(e){return e.kind==="entity"?St(this.hass,e.entity_id):l`<ha-icon
      class="row-icon"
      icon=${sc[e.kind]??ni}
  ...
  `,u([m({attribute:!1})],K.prototype,"hass",2),u([m({attribute:!1})],K.prototype,"scope",2),u([m()],K.prototype,"scopeName",2),u([m({attribute:!1})],K.prototype,"scenes",2),u([m({type:Boolean,reflect:!0})],K.prototype,"open",2),u([g()],K.prototype,"_triggers",2),u([g()],K.prototype,"_opaque",2),u([g()],K.prototype,"_loading",2),u([g()],K.prototype,"_error",2),K=u([x("ambience-auto-triggers-modal")],K);var ac={not_home:"Away",home:"Home"};function oa(t){return ac[t]??_e(t)}function la(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(n=>[n.name,n.live_value==null?"":String(n.live_value)])),for:{h:0,m:0,s:0}}}function Dr(t){return String(t).padStart(2,"0")}function da(t){return`${t.getFullYear()}-${Dr(t.getMonth()+1)}-${Dr(t.getDate())}`}function ca(t){return`${Dr(t.getHours())}:${Dr(t.getMinutes())}`}var A=class extends b{constructor(){super(...arguments);this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=da(e),this._time=ca(e);try{let r=await Rn(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=r.knobs,this._hasTime=r.has_time;let i={},s={};for(let a of r.knobs)a.kind==="entity"?i[a.entity_id]=la(a):s[this._vkey(a)]=a.live_value;this._values=i,this._verdicts=s,this._loading=!1}catch(r){this._error=r.message||String(r),this._loading=!1}}_setState(e,r){this._values={...this._values,[e]:{...this._values[e],state:r}}}_setAttr(e,r,i){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[r]:i}}}}_setFor(e,r,i){let s=this._values[e],a=Number.isFinite(i)&&i>0?Math.trunc(i):0;this._values={...this._values,[e]:{...s,for:{...s.for,[r]:a}}}}_setVerdict(e,r){this._verdicts={...this._verdicts,[e]:r}}_resetWhen(){let e=new Date;this._date=da(e),this._time=ca(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:la(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let r of this._knobs){if(r.kind!=="entity")continue;let i=this._values[r.entity_id];if(!i)continue;let s={};for(let o of r.attributes){let c=i.attributes[o.name];if(!(c===void 0||c===""))if(o.control==="number"){let h=Number(c);Number.isNaN(h)||(s[o.name]=h)}else s[o.name]=c}let a={attributes:s};i.state!==""&&(a.state=i.state),(i.for.h||i.for.m||i.for.s)&&(a.for=i.for),(a.state!==void 0||a.for!==void 0||Object.keys(s).length>0)&&(e[r.entity_id]=a)}return e}_buildVerdicts(){let e={};for(let r of this._knobs)r.kind==="verdict"&&(e[r.condition]||(e[r.condition]={}),e[r.condition][r.key]=this._verdicts[this._vkey(r)]??r.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`).toISOString();try{this._result=await Pn(this.hass,this.scope,this.category,e,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(r){this._error=r.message||String(r)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
    ...
    </span>`}_renderVerdict(e){let r=this._vkey(e),i=this._verdicts[r]??e.live_value,s=e.entity_id?N(this.hass,e.entity_id):e.label,a=e.entity_id?St(this.hass,e.entity_id):l`<ha-icon class="row-icon" icon="mdi:code-braces"></ha-icon>`;return l`
      <div class="row">
        ${a}
        <div class="row-text">
    ...
    `],u([m({attribute:!1})],A.prototype,"hass",2),u([m({attribute:!1})],A.prototype,"scope",2),u([m()],A.prototype,"category",2),u([m()],A.prototype,"categoryName",2),u([m({type:Boolean,reflect:!0})],A.prototype,"open",2),u([g()],A.prototype,"_knobs",2),u([g()],A.prototype,"_hasTime",2),u([g()],A.prototype,"_loading",2),u([g()],A.prototype,"_error",2),u([g()],A.prototype,"_values",2),u([g()],A.prototype,"_verdicts",2),u([g()],A.prototype,"_date",2),u([g()],A.prototype,"_time",2),u([g()],A.prototype,"_result",2),u([g()],A.prototype,"_expanded",2),A=u([x("ambience-simulator-modal")],A);function oc(t){let n=Math.floor(t/3600),e=Math.floor(t%3600/60),r=t%60,i=s=>String(s).padStart(2,"0");return n>0?`${n}:${i(e)}:${i(r)}`:`${e}:${i(r)}`}function Ke(t){return t.enabled===!1?{scenes:t.scenes??[],enabled:!1}:{scenes:t.scenes??[]}}var Li=1024;function lc(t,n,e){if(t!==void 0&&n!==void 0)return Math.floor((t+n)/2);let r=e.map(i=>i.priority??0);return t===void 0&&n===void 0?Li:t===void 0?Math.max(...r)+Li:Math.min(...r)-Li}var C=class extends b{constructor(){super(...arguments);this._areas=[];this._floors=[];this._areaConfigs=new Map;this._floorConfigs=new Map;this._house={scenes:[]};this._switchEntityIds=new Map;this._conditions=[];this._actions=[];this._categories=[];this._schemas={};this._expanded=new Set(an());this._error="";this._staticLoaded=!1;this._areasLoaded=!1;this._conditionsHintDismissed=!1;this._editing=null;this._sceneEditorError="";this._savingScene=!1;this._viewingTraces=null;this._viewingSimulator=null;this._autoTriggers=null;this.filterCategory="";this._onExposedActionsChanged=async()=>{try{let e=await xt(this.hass);if(!this.isConnected)return;this._actions=e,await this._refreshSchemas(e)}catch{}};this._onCategoriesChanged=async()=>{try{let e=await Me(this.hass);if(!this.isConnected)return;this._categories=e}catch{}};this._onConditionsChanged=async()=>{try{let[e,r]=await Promise.all([wt(this.hass),$t(this.hass)]);if(!this.isConnected)return;this._dayConfig=e,this._weatherConfig=r}catch{}}}async _refreshSchemas(e){let r=await Promise.all(e.map(async s=>{try{let a=await be(this.hass,s.id);return[s.id,a]}catch{return[s.id,null]}}));if(!this.isConnected)return;let i={};for(let[s,a]of r)a&&(i[s]=a);this._schemas=i}async connectedCallback(){super.connectedCallback(),this._conditionsHintDismissed=ln(),window.addEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.addEventListener("ambience-categories-changed",this._onCategoriesChanged),window.addEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick=setInterval(()=>{for(let e of this._switchEntityIds.values())if(this.hass.states?.[e]?.state==="off"){this.requestUpdate();return}},1e3),await this._loadStatic(),await Promise.all([this._refreshAreas(),this._refreshFloors(),this._refreshHouse(),this._refreshSwitches()]),await this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),this._tick&&clearInterval(this._tick),this._tick=void 0,window.removeEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.removeEventListener("ambience-categories-changed",this._onCategoriesChanged),window.removeEventListener("ambience-conditions-changed",this._onConditionsChanged),this._unsubArea?.(),this._unsubArea=void 0,this._unsubFloor?.(),this._unsubFloor=void 0}async _loadStatic(){try{let[e,r,i,s,a,o,c]=await Promise.all([tr(this.hass),xt(this.hass),rr(this.hass),ir(this.hass),wt(this.hass),$t(this.hass),Me(this.hass)]);if(!this.isConnected)return;this._conditions=e,this._actions=r,this._periods=i,this._luxRanges=s,this._dayConfig=a,this._weatherConfig=o,this._categories=c,this._staticLoaded=!0,await this._refreshSchemas(r)}catch(e){this._error=e.message||String(e)}}async _refreshAreas(){try{let e=await cn(this.hass),r=this._areaConfigs,i=new Map;if(await Promise.all(e.map(async s=>{let a=r.get(s.area_id);if(a){i.set(s.area_id,a);return}i.set(s.area_id,Ke(await Vr(this.hass,s.area_id)))})),!this.isConnected)return;this._areas=e,this._areaConfigs=i}catch(e){this._error=e.message||String(e)}finally{this.isConnected&&(this._areasLoaded=!0)}}async _refreshFloors(){try{let e=(await hn(this.hass)).slice().sort((s,a)=>s.name.localeCompare(a.name)),r=this._floorConfigs,i=new Map;if(await Promise.all(e.map(async s=>{let a=r.get(s.floor_id);if(a){i.set(s.floor_id,a);return}i.set(s.floor_id,Ke(await Kr(this.hass,s.floor_id)))})),!this.isConnected)return;this._floors=e,this._floorConfigs=i}catch(e){this._error=e.message||String(e)}}async _refreshHouse(){try{let e=Ke(await Yr(this.hass));if(!this.isConnected)return;this._house=e}catch(e){this._error=e.message||String(e)}}async _refreshSwitches(){try{let e=await En(this.hass);if(!this.isConnected)return;this._switchEntityIds=new Map(e.map(r=>{let i=r.scope_kind==="house"?{kind:"house"}:{kind:r.scope_kind,id:r.scope_id};return[U(i),r.entity_id]}))}catch(e){this._error=e.message||String(e)}}async _subscribe(){let e=this.hass.connection.subscribeEvents(a=>{if(a.data.action==="remove"){let o=a.data.area_id,c=new Set(this._expanded);c.delete(`area:${o}`),this._setExpanded(c),this._editing?.scope.kind==="area"&&this._editing.scope.id===o&&(this._editing=null)}this._refreshAreas(),a.data.action!=="update"&&this._refreshSwitches()},"area_registry_updated"),r=this.hass.connection.subscribeEvents(a=>{if(a.data.action==="remove"){let o=a.data.floor_id,c=new Set(this._expanded);c.delete(`floor:${o}`),this._setExpanded(c),this._editing?.scope.kind==="floor"&&this._editing.scope.id===o&&(this._editing=null)}this._refreshFloors(),a.data.action!=="update"&&this._refreshSwitches()},"floor_registry_updated"),[i,s]=await Promise.all([e,r]);this.isConnected?(this._unsubArea=i,this._unsubFloor=s):(i(),s())}_getConfig(e){return e.kind==="house"?this._house:e.kind==="area"?this._areaConfigs.get(e.id):this._floorConfigs.get(e.id)}_setConfig(e,r){if(e.kind==="house")this._house=r;else if(e.kind==="area"){let i=new Map(this._areaConfigs);i.set(e.id,r),this._areaConfigs=i}else{let i=new Map(this._floorConfigs);i.set(e.id,r),this._floorConfigs=i}}async _mutate(e,r){let i=this._getConfig(e);this._setConfig(e,r),this._error="";try{let s;return e.kind==="house"?s=await mn(this.hass,r):e.kind==="area"?s=await un(this.hass,e.id,r):s=await pn(this.hass,e.id,r),this._setConfig(e,Ke(s.config)),!0}catch(s){return i&&this._setConfig(e,i),this._error=s.message||String(s),!1}}_setExpanded(e){this._expanded=e,on([...e])}_toggleExpand(e){let r=U(e),i=new Set(this._expanded);i.has(r)?i.delete(r):i.add(r),this._setExpanded(i)}_addScene(e,r){let i=this._getConfig(e);i&&(this._sceneEditorError="",this._editing={scope:e,index:i.scenes.length,isNew:!0,category:r})}_editScene(e,r){this._sceneEditorError="",this._editing={scope:e,index:r.detail.index,isNew:!1}}_duplicateScene(e,r){let i=this._getConfig(e);if(!i)return;let s=i.scenes[r.detail.index];if(!s)return;let a=kt(JSON.parse(JSON.stringify(s)));this._sceneEditorError="",this._editing={scope:e,index:i.scenes.length,isNew:!0,seed:a}}_deleteScene(e,r){let i=this._getConfig(e);if(!i)return;let s=i.scenes.filter((a,o)=>o!==r.detail.index);this._mutate(e,{...i,scenes:s})}_reorderScenes(e,r){let i=this._getConfig(e);if(!i)return;let{from:s,to:a}=r.detail,o=i.scenes[s];if(!o||i.scenes[a]?.category!==o.category)return;let c=[...i.scenes];c.splice(s,1),c.splice(a,0,o);let h=E=>c[E]&&c[E].category===o.category,p=a-1;for(;p>=0&&!h(p);)p--;let f=a+1;for(;f<c.length&&!h(f);)f++;let _=p>=0?c[p].priority:void 0,y=f<c.length?c[f].priority:void 0,k=lc(_,y,i.scenes.filter(E=>E.category===o.category));c[a]={...o,priority:k,pinned:!0},this._mutate(e,{...i,scenes:c})}_unpinScene(e,r){let i=this._getConfig(e);if(!i)return;let s=i.scenes.map((a,o)=>o===r.detail.index?{...a,pinned:!1}:a);this._mutate(e,{...i,scenes:s})}_toggleSceneEnabled(e,r){let i=this._getConfig(e);if(!i)return;let s=i.scenes.map((a,o)=>{if(o!==r.detail.index)return a;if(r.detail.enabled){let c={...a};return delete c.enabled,c}return{...a,enabled:!1}});this._mutate(e,{...i,scenes:s})}async _saveScene(e){if(this._savingScene)return;let r=this._editing;if(!r)return;let{scene:i,scope:s}=e.detail;this._savingScene=!0,this._sceneEditorError="";try{if(U(s)===U(r.scope)){let h=this._getConfig(s);if(!h)return;let p=[...h.scenes];r.isNew?p.push(i):p[r.index]=i,await this._mutate(s,{...h,scenes:p})?this._editing=null:this._sceneEditorError=this._takeError();return}let a=kt(i),o=this._getConfig(s);if(!o)return;if(!await this._mutate(s,{...o,scenes:[...o.scenes,a]})){this._sceneEditorError=this._takeError();return}if(this._editing=null,!r.isNew){let h=this._getConfig(r.scope);if(h){let p=h.scenes.filter((f,_)=>_!==r.index);await this._mutate(r.scope,{...h,scenes:p})}}}finally{this._savingScene=!1}}_takeError(){let e=this._error;return this._error="",e}async _callApi(e){this._error="";try{await e()}catch(r){this._error=r.message||String(r)}}_applyScenes(e,r){return this._callApi(()=>vn(this.hass,e,r))}_runSceneActions(e,r){return this._callApi(()=>yn(this.hass,e,r.detail.index))}_cancelScene(){this._sceneEditorError="",this._editing=null}_onScopeMenu(e,r,i,s){s==="run"?this._applyScenes(e):s==="auto"&&(this._autoTriggers={scope:e,name:r})}_showTraces(e,r){let i=this._categories.find(s=>s.id===r);this._viewingTraces={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},category:r,categoryName:i?.name??null}}_showSimulator(e,r){let i=this._categories.find(s=>s.id===r);this._viewingSimulator={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},category:r,categoryName:i?.name??null}}_defaultCategoryId(){return this.filterCategory!==""?this.filterCategory:[...this._categories].sort((r,i)=>r.name.localeCompare(i.name))[0]?.id??""}get _editingScene(){return this._editing?this._editing.seed?this._editing.seed:this._editing.isNew?{when:{},actions:[],category:this._editing.category??this._defaultCategoryId()}:this._getConfig(this._editing.scope)?.scenes[this._editing.index]??null:null}get _editorConditions(){return this._editing?this._conditions.slice().sort((e,r)=>r.priority-e.priority):[]}get _takenSceneNames(){let e=new Map,r=this._editing,i=(s,a)=>{if(!a)return;let o=!!r&&!r.isNew&&U(r.scope)===U(s);a.scenes.forEach((c,h)=>{if(o&&h===r.index)return;let p=c.name?.trim().toLowerCase();if(!p)return;let f=dr(s,c.category),_=e.get(f);_||(_=new Set,e.set(f,_)),_.add(p)})};i({kind:"house"},this._house);for(let s of this._floors)i({kind:"floor",id:s.floor_id},this._floorConfigs.get(s.floor_id));for(let s of this._areas)i({kind:"area",id:s.area_id},this._areaConfigs.get(s.area_id));return e}get _scopeOptions(){return[{scope:{kind:"house"},label:d(this.hass,"ui.scope_house","House")},...this._floors.map(e=>({scope:{kind:"floor",id:e.floor_id},label:e.name})),...this._areas.map(e=>({scope:{kind:"area",id:e.area_id},label:e.name}))]}_matchingSceneCount(e){return this.filterCategory===""?e.scenes.length:e.scenes.filter(r=>r.category===this.filterCategory).length}_summary(e){if(e.scenes.length===0)return d(this.hass,"ui.not_configured","not configured");let r=this._matchingSceneCount(e),i=r===1?d(this.hass,"ui.scene_singular","scene"):d(this.hass,"ui.scene_plural","scenes");return`${r} ${i}`}get _weatherUnconfigured(){return!this._weatherConfig||this._weatherConfig.entity==null}get _workdayUnconfigured(){let e=this._dayConfig;return!e||e.workday_sensor==null&&e.workday_calendar==null}get _conditionsUnconfigured(){return this._weatherUnconfigured||this._workdayUnconfigured}_conditionsHintText(){let e=this._weatherUnconfigured,r=this._workdayUnconfigured;return e&&r?{title:d(this.hass,"ui.conditions_hint_title","Optional: set up Workday & Weather"),body:d(this.hass,"ui.conditions_hint_body","Configure Workday and Weather in Conditions to use them in your scene conditions.")}:r?{title:d(this.hass,"ui.conditions_hint_title_workday","Optional: set up Workday"),body:d(this.hass,"ui.conditions_hint_body_workday","Configure Workday in Conditions to use it in your scene conditions.")}:{title:d(this.hass,"ui.conditions_hint_title_weather","Optional: set up Weather"),body:d(this.hass,"ui.conditions_hint_body_weather","Configure Weather in Conditions to use it in your scene conditions.")}}_openSettings(e){this.dispatchEvent(new CustomEvent("ambience-open-settings",{detail:{tab:e},bubbles:!0,composed:!0}))}_dismissConditionsHint(){this._conditionsHintDismissed=!0,dn()}_renderBanners(){if(!this._staticLoaded)return"";if(this._actions.length===0)return l`
      ...
      ${this._renderBanners()}
      <ul>
        ${Fn(this._orderedScopeRows(),e=>U(e.scope),e=>this._renderScopeRow(e.scope,e.name,e.cfg,e.rowClass))}
    ...
    >
      ...
      @click=${s}
      @change=${a}
    />`}async _reloadScope(e){try{let r;if(e.kind==="house"?r=Ke(await Yr(this.hass)):e.kind==="area"?r=Ke(await Vr(this.hass,e.id)):r=Ke(await Kr(this.hass,e.id)),!this.isConnected)return;this._setConfig(e,r)}catch(r){this._error=r.message||String(r)}}};C.styles=[v`
      :host {
        display: block;
        padding: 1rem;
  ...
  `,u([m({attribute:!1})],me.prototype,"hass",2),u([m()],me.prototype,"conditionName",2),u([m()],me.prototype,"conditionDescription",2),u([g()],me.prototype,"_expanded",2),me=u([x("ambience-condition-card")],me);var dc=/^[a-z][a-z0-9_]*$/;function cc(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var It=v`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,ee=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=It}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!dc.test(e)?d(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?d(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":d(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??cc(this._label),r=this._validateName(e)||this._validateDef();if(r){this._error=r,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return l`
    ...
    `}_validateDef(){return""}_buildDefinition(){return{from:this._def.from,to:this._def.to,label:this._label.trim()||null}}};Ye.styles=[It,v`
      .row { display: flex; align-items: center; gap: 0.5rem; }
    `],u([m({attribute:!1})],Ye.prototype,"initial",2),u([g()],Ye.prototype,"_def",2),Ye=u([x("ambience-period-edit-modal")],Ye);function ha(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=ve(n,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${d(n,"ui.unit_hour_abbr","h")}`:`${r}${d(n,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}var Ar=class extends se{_list(){return rr(this.hass)}_save(n,e){return bn(this.hass,n,e)}_label(n,e){return ye(this.hass,n,e)}_formatDef(n){return`${ha(n.from,this.hass)} \u2192 ${ha(n.to,this.hass)}`}_headingKey(){return["ui.periods_heading","Periods"]}_addKey(){return["ui.add_custom_period","+ Add custom period"]}_warningTextKey(){return["ui.period_warning_text","some scenes now reference missing periods:"]}_renderModal(){let n=this._modal;return n.mode==="edit"?l`<ambience-period-edit-modal
        .hass=${this.hass}
        .existingId=${n.id}
        .initial=${n.initial}
  ...
  `,u([m({attribute:!1})],Re.prototype,"hass",2),u([g()],Re.prototype,"_config",2),u([g()],Re.prototype,"_warnings",2),Re=u([x("ambience-day-config")],Re);var uc=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],fe=class extends b{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),this._config=await $t(this.hass)}async _persist(){let e=await $n(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[],window.dispatchEvent(new CustomEvent("ambience-conditions-changed"))}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:uc.map(e=>({value:e,label:et(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
      ...
      ></ha-form>`;let i=r.conditions.map(s=>et(this.hass,s));return l`<span class="conditions-list">${i.join(", ")}</span>`}_renderGroup(e,r){let i=this._expanded.has(r.id),s=r.conditions.map(a=>et(this.hass,a)).join(", ");return l`
      <div class="group">
    ...
    .warnings ul { margin: 0.3rem 0 0 0; padding-left: 1.2rem; }
  `,u([m({attribute:!1})],fe.prototype,"hass",2),u([g()],fe.prototype,"_config",2),u([g()],fe.prototype,"_warnings",2),u([g()],fe.prototype,"_expanded",2),fe=u([x("ambience-weather-config")],fe);var pa={time_of_day:t=>l`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>l`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>l`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>l`<ambience-weather-config .hass=${t}></ambience-weather-config>`},hc=new Set(Object.keys(pa)),Pe=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await tr(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._conditions.filter(r=>hc.has(r.name)).slice().sort((r,i)=>i.priority-r.priority);return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      ${e.map(r=>l`
  ...
  `}connectedCallback(){super.connectedCallback(),ge(this),this.addEventListener("ambience-open-settings",this._onOpenSettings),this.addEventListener("ambience-filter-changed",this._onFilterChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("ambience-open-settings",this._onOpenSettings),this.removeEventListener("ambience-filter-changed",this._onFilterChanged)}render(){let e={dark:!!this.hass.themes?.darkMode,title:d(this.hass,"ui.panel_title","Ambience")};return l`
      ...
      ></ambience-settings-modal>
    `}};u([m({attribute:!1})],Ge.prototype,"hass",2),u([g()],Ge.prototype,"_settingsOpen",2),u([g()],Ge.prototype,"_settingsTab",2),u([g()],Ge.prototype,"_filterCategory",2);Yi("ambience-frontend",Ge);export{Ge as AmbienceFrontend};
