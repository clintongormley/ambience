...
`;function Me(t,n){return l`<span class="group-swatch" style=${Et(t)}>
    ${n?l`<ha-icon icon=${n}></ha-icon>`:""}
  </span>`}function Q(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function ii(t,n){if(!n||n.entity==null)return[...t];let e=Array.isArray(n.entity)?n.entity:[n.entity];if(e.length===0)return[...t];let r=new Set,i=!1;for(let s of e){if(!s||typeof s!="object")continue;let a=s.domain;if(a==null){i=!0;continue}if(Array.isArray(a))for(let o of a)typeof o=="string"&&r.add(o);else typeof a=="string"&&r.add(a)}return i||r.size===0?[...t]:t.filter(s=>{let a=s.indexOf(".");return a<0?!1:r.has(s.slice(0,a))})}function Ct(t,n,e=[]){let r=t;if(!r?.entities)return[];let i=r.entities,s=r.devices??{},a=r.areas??{},o=n.kind==="area"?new Set([n.id]):n.kind==="floor"?new Set(Object.values(a).filter(h=>h.floor_id===n.id).map(h=>h.area_id)):null,c=h=>{let m=h.area_id??(h.device_id?s[h.device_id]?.area_id??null:null);return m==null?!1:o===null?!0:o.has(m)};return Object.values(i).filter(c).filter(h=>e.length===0||e.includes(h.entity_id.split(".")[0])).map(h=>h.entity_id).sort()}function it(t){let{priority:n,pinned:e,shadowed_by:r,...i}=t;return i}async function ni(t){return t.callWS({type:"ambience/areas/list"})}async function si(t,n){return t.callWS({type:"ambience/area/get",area_id:n})}async function ai(t,n,e){return t.callWS({type:"ambience/area/save",area_id:n,config:e})}async function oi(t){return t.callWS({type:"ambience/floors/list"})}async function li(t,n){return t.callWS({type:"ambience/floor/get",floor_id:n})}async function di(t,n,e){return t.callWS({type:"ambience/floor/save",floor_id:n,config:e})}async function ci(t){return t.callWS({type:"ambience/house/get"})}async function ui(t,n){return t.callWS({type:"ambience/house/save",config:n})}async function Tt(t){return t.callWS({type:"ambience/matchers/list"})}async function nt(t){return t.callWS({type:"ambience/exposed_actions/list"})}async function hi(t,n){return t.callWS({type:"ambience/exposed_actions/save",actions:n})}async function pi(t){return t.callWS({type:"ambience/services/list"})}async function me(t,n){return t.callWS({type:"ambience/services/get_schema",service:n})}function mi(t){return t.kind==="area"?{area_id:t.id}:t.kind==="floor"?{floor_id:t.id}:{house:!0}}async function fi(t,n,e){let r={type:"ambience/apply",...mi(n)};return e!==void 0&&(r.group_id=e),t.callWS(r)}async function gi(t,n,e){return t.callWS({type:"ambience/rule/run_actions",rule_index:e,...mi(n)})}async function Lt(t){return t.callWS({type:"ambience/time_of_day_periods/list"})}async function vi(t,n,e){return t.callWS({type:"ambience/time_of_day_periods/save",custom:n,hidden:e})}async function At(t){return t.callWS({type:"ambience/matchers/day/config/list"})}async function _i(t,n,e){return t.callWS({type:"ambience/matchers/day/config/save",workday_sensor:n,workday_calendar:e})}async function Rt(t){return t.callWS({type:"ambience/matchers/weather/config/list"})}async function yi(t,n,e){return t.callWS({type:"ambience/matchers/weather/config/save",entity:n,groups:e})}async function bi(t,n){return t.callWS({type:"ambience/state/known_states",entity_id:n})}async function $i(t){return t.callWS({type:"ambience/switch_defaults/list"})}async function xi(t){return t.callWS({type:"ambience/switches/list"})}async function dr(t,n,e){return t.callWS({type:"ambience/switch_defaults/save",name:n,auto_on_delay_seconds:e})}async function Pt(t){return(await t.callWS({type:"ambience/groups/list"})).groups}async function wi(t,n){return t.callWS({type:"ambience/groups/save",groups:n})}async function ki(t,n){return t.callWS({type:"ambience/groups/delete",group_id:n})}async function cr(t){return(await t.callWS({type:"ambience/traces/list"})).traces}async function Ei(t,n,e){return t.callWS({type:"ambience/simulate/inputs",scope_kind:n.scope_kind,scope_id:n.scope_id,group:e})}async function Si(t,n,e,r,i,s){return(await t.callWS({type:"ambience/simulate",scope_kind:n.scope_kind,scope_id:n.scope_id,group:e,now:r,overrides:i,verdicts:s})).result}var ne=class extends y{constructor(){super(...arguments);this.items=[];this._open=!1;this._onKeydown=e=>{e.key==="Escape"&&this._open&&(this._open=!1)}}_triggerLabel(){return this.label??d(this.hass,"ui.more_actions","More actions")}_select(e,r){r.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("menu-action",{detail:{id:e},bubbles:!0,composed:!0}))}_renderItems(){return this.items.map(e=>l`
...
`;function at(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return je(t)}function Ht(t,n="New rule"){return t.name&&t.name.trim()?t.name:n}function ot(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?Ot(n,e):t==="day"?Es(n,e):t==="weather"?Rs(n,e):t==="sun"?Ps(n,e):t==="state"?gr(n,e):t==="script"?ws(n,e):t==="people"?ks(n,e):t==="template"?xs(n,e):String(n)}function xs(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function ws(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=st(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(a=>`${fr(n.hass,t.script,a)}: ${fe(n.hass,r[a])}`).join(", ");return`${e} (${s})`}function fr(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:je(e)}function st(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Ti(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):st(n,t)}function ks(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=st(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${c} ${Ti(e,n)}`;return t.for&&pr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>st(n,h)).join(", ");r=`${o} (${c})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Ti(e,n)}`;return t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function Es(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>Li(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>Li(a,n)).join(", ")})`}function Li(t,n){switch(t.kind){case"weekday":return t.days.map(e=>wt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Fe(n.hass,t.month)} ${t.day}`;case"date_range":return`${Fe(n.hass,t.from.month)} ${t.from.day} \u2192 ${Fe(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Ss={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function je(t){return he(t)}function Cs(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var Ts=["entity_id","device_id","area_id","label_id","floor_id"],Ai=2;function Ls(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>Ts.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function fe(t,n){let e=Ls(n);if(!e)return Cs(n);let r=e.slice(0,Ai).map(a=>st({hass:t},a)),i=e.length-Ai;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function Dt(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function As(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function Rs(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??As(a)).join("/"),i=(t.thresholds??[]).map(a=>`${rt(n.hass,a.attribute)} ${Ss[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function Ps(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function Hi(t,n){return Y(t.hass,n)}function Di(t,n){return Hi({hass:t},n)}function gr(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):hr(t,n)}function hr(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<="){let e=K(n.hass,t.kind),i=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.join("/"),s=Hi(n,t.entity_id),o=`${t.attribute?`${s}.${t.attribute}`:s} ${e} ${i}`;return t.for&&pr(t.for)?`${o} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:o}if(t.kind==="and"||t.kind==="or"){let e=` ${K(n.hass,t.kind)} `;return t.items.map(r=>Ri(r,n)).join(e)}return t.kind==="not"?`${K(n.hass,"not")} ${Ri(t.item,n)}`:""}function Ri(t,n){return t.kind==="and"||t.kind==="or"?`(${hr(t,n)})`:hr(t,n)}function pr(t){return t.h>0||t.m>0||t.s>0}function mr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function Ot(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ie(n.hass,i.period,r):`${Pi(i.from,n)} \u2192 ${Pi(i.to,n)}`).join(", ")}function Pi(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Ne(n.hass,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${r}${d(n.hass,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}function Hs(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label&&e.label.trim()?e.label:xt(n.hass,t.service)}function Ds(t,n){let e=t.service.indexOf(".");return e>0?t.service.slice(0,e):d(n.hass,"ui.target_noun","target")}function Oi(t,n){let e=Hs(t,n),r=Ds(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,c])=>`${at(o,t.service,n.schemas)}: ${fe(n.hass,c)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var ze=class{constructor(n,e){this.host=n;this.onReorder=e;this.from=null;this.over=null;n.addController(this)}hostDisconnected(){this._reset()}start(n,e,r){this.from=n,e?.dataTransfer&&r&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setDragImage(r,16,16)),this.host.requestUpdate()}dragOver(n,e){this.from===null||e===this.from||(n.preventDefault(),this.over!==e&&(this.over=e,this.host.requestUpdate()))}drop(n){let e=this.from;this._reset(),!(e===null||e===n)&&this.onReorder(e,n)}end(){this._reset()}_reset(){let n=this.from!==null||this.over!==null;this.from=null,this.over=null,n&&this.host.requestUpdate()}};var I=class extends y{constructor(){super(...arguments);this.rules=[];this.availableActions=[];this.schemas={};this.groups=[];this.filterGroup="";this._drag=new ze(this,(e,r)=>this._emit("reorder-rules",{from:e,to:r}));this._expanded=new Set}_renderSectionHeader(e){return l`<div class="group-section-header" style=${Et(e.color)}>
  ...
  `,u([p({attribute:!1})],M.prototype,"hass",2),u([p({attribute:!1})],M.prototype,"scope",2),u([p({attribute:!1})],M.prototype,"exposed",2),u([p({attribute:!1})],M.prototype,"entityIds",2),u([p({attribute:!1})],M.prototype,"params",2),u([f()],M.prototype,"_schema",2),u([f()],M.prototype,"_schemaError",2),u([f()],M.prototype,"_exposedMissing",2),u([f()],M.prototype,"_formSchema",2),u([f()],M.prototype,"_perFieldSchemas",2),M=u([b("ambience-action-slot")],M);function tn(t){return typeof t>"u"||t===null}function Os(t){return typeof t=="object"&&t!==null}function Ns(t){return Array.isArray(t)?t:tn(t)?[]:[t]}function Fs(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function Is(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function Ms(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var js=tn,zs=Os,Ws=Ns,Us=Is,Gs=Ms,Bs=Fs,H={isNothing:js,isObject:zs,toArray:Ws,repeat:Us,isNegativeZero:Gs,extend:Bs};function rn(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`
...
`:""}var rl=tl,il={dump:rl};function Lr(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Tn=gn.load,_c=gn.loadAll,Wt=il.dump;var yc=Lr("safeLoad","load"),bc=Lr("safeLoadAll","loadAll"),$c=Lr("safeDump","dump");var Z=class extends y{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>fr(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let i=this._currentFields()?.[e.name]?.description;return typeof i=="string"?i:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Wt(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Wt(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Wt(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Tn(e)}catch(c){this._yamlError=c.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(c=>typeof c=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){return Y(this.hass,e)}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.prototype.hasOwnProperty.call(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,u([p({attribute:!1})],ye.prototype,"value",2),u([p({attribute:!1})],ye.prototype,"hass",2),u([f()],ye.prototype,"_preview",2),ye=u([b("ambience-template-predicate-input")],ye);var V=class extends y{constructor(){super(...arguments);this.value=null}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onText(e){let r=e.target.value;this._emit(r.trim()===""?null:r)}render(){return this.matcher.input==="time_of_day"?l`
  ...
  `,u([p({attribute:!1})],V.prototype,"matcher",2),u([p({attribute:!1})],V.prototype,"value",2),u([p({attribute:!1})],V.prototype,"periods",2),u([p({attribute:!1})],V.prototype,"dayConfig",2),u([p({attribute:!1})],V.prototype,"weatherConfig",2),u([p({attribute:!1})],V.prototype,"hass",2),V=u([b("ambience-matcher-input")],V);function hl(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function pl(t){return t==="people"?{quant:"everyone",where:"home"}:null}function Fn(t,n){return!!t&&!!n&&Q(t)===Q(n)}var S=class extends y{constructor(){super(...arguments);this.open=!1;this.rule=null;this.matchers=[];this.availableActions=[];this.groups=[];this.schemas={};this.scopes=[];this.autoEditScope=!1;this._draft=null;this._open=null;this._showError=!1;this._serviceHasTarget=new Map;this._matcherError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onDestinationChange=e=>{this._setDestination(Number(e.target.value))};this._onDestinationChangeHaForm=e=>{e.stopPropagation(),this._setDestination(Number(e.detail.value.destination))};this._onAddMatcher=e=>{let r=e.target,i=r.value;r.value="",this._addMatcher(i)};this._onAddMatcherHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_MATCHER_PLACEHOLDER&&this._addMatcher(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onMatcherInvalid(e,r){r?this._matcherError.set(e,r):this._matcherError.delete(e)}connectedCallback(){super.connectedCallback(),pe(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._scope=this.scope,this._open=this.autoEditScope&&this.scopes.length>0?{kind:"destination"}:null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let r=this.scopes[e];if(!r||!this._draft||(this._scope=r.scope,!this.hass))return;let i=new Set(Ct(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(a=>i.has(a))}))}}_renderDestination(){if(this.scopes.length===0)return"";let e=Math.max(0,this.scopes.findIndex(r=>Fn(r.scope,this._scope)));return customElements.get("ha-form")?this._renderDestinationHaForm(e):l`
    ...
    `}_renderAddMatcherHaForm(e){let r=d(this.hass,"ui.add_condition","+ Add condition\u2026"),i=[{name:"add",selector:{select:{mode:"dropdown",options:[{value:S._ADD_MATCHER_PLACEHOLDER,label:r},...e.map(s=>({value:s.name,label:W(this.hass,s.name)}))]}}}];return l`
      <div class="add-matcher">
        <ha-form
          .hass=${this.hass}
          .schema=${i}
    ...
    `}_renderActionRow(e,r){let i=this.availableActions.find(m=>m.id===e.service),s=i?.reapply_seconds??0,a=this._isOpen({kind:"action",idx:r}),o=Oi(e,{hass:this.hass,exposedActions:this.availableActions,schemas:this.schemas}),c=Mi(e,s),h=s>0&&c>0;return l`
...
`;function fl(t){return t.kind==="entity"?`${t.entity_id} ${t.old} \u2192 ${t.new}`:t.detail?`${he(t.kind)} ${t.detail}`:he(t.kind)}function gl(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,a])=>`${at(s,t.service,e)}: ${fe(n,a)}`).join(", "),i=tt(t.service);return r?`${i} \xB7 ${r}`:i}function vl(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function _l(t,n){let e=t.index+1;return t.disabled?l`<div class="rule disabled">Rule #${e} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
    ...
    ${t.predicates.map(r=>l`
        <div class="pred ${r.passed?"pass":"fail"}" style="padding-left:1rem">
          ${r.passed?"\u2713":"\u2717"} ${W(n,r.matcher_key)}${r.detail?l` <span class="dim">[${ml(n,r.matcher_key,r.detail)}]</span>`:w}
        </div>`)}
  `:l`<div class="rule skipped">Rule #${e} ${t.name??"\u2014"}: not evaluated</div>`}function Gt(t,n,e,r,i){let s=t.actions.map(c=>tt(c.service)).join(", "),a=vl(t.actions),o=t.explanation!==null||t.actions.length>0;return l`
    <div class="eval">
      <div class="top">
  ...
  `}var F=class extends y{constructor(){super(...arguments);this.group="";this.groupName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1}connectedCallback(){super.connectedCallback(),this._poll=setInterval(()=>this._checkNew(),5e3)}disconnectedCallback(){super.disconnectedCallback(),this._poll&&clearInterval(this._poll)}updated(e){this.open&&(e.has("open")||e.has("group")||e.has("scope"))&&this._load()}_mine(e){return e.filter(r=>r.scope_kind===this.scope.scope_kind&&r.scope_id===this.scope.scope_id&&r.group===this.group)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await cr(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=e.message||String(e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(a=>a.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let r=await Promise.all(e.map(async s=>{try{return[s,await me(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let i={...this._schemas};for(let s of r)s&&(i[s[0]]=s[1]);this._schemas=i}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let r=this._mine(await cr(this.hass))[0]?.timestamp??null,i=this._records[0]?.timestamp??null;r&&(!i||r>i)&&(this._hasNew=!0)}catch{}}_toggle(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return w;let e=this.groupName??this.group;return l`
      <div class="modal" role="dialog" aria-modal="true">
        ...
        <div class="body">
          ${this._error?l`<p class="error">${this._error}</p>`:this._loading?l`<p class="empty">Loading…</p>`:this._records.length===0?l`<p class="empty">No traces for this group yet.</p>`:l`<div class="list">${this._records.map((r,i)=>{let s=`${r.event_id??i}|${r.timestamp??""}`;return Gt(r,this._expanded.has(s),()=>this._toggle(s),this.hass,this._schemas)})}</div>`}
        </div>
      </div>
    `}};F.styles=[Ut,v`
      :host {
    ...
    `],u([p({attribute:!1})],F.prototype,"hass",2),u([p({attribute:!1})],F.prototype,"scope",2),u([p()],F.prototype,"group",2),u([p()],F.prototype,"groupName",2),u([p({type:Boolean,reflect:!0})],F.prototype,"open",2),u([f()],F.prototype,"_records",2),u([f()],F.prototype,"_schemas",2),u([f()],F.prototype,"_expanded",2),u([f()],F.prototype,"_loading",2),u([f()],F.prototype,"_error",2),u([f()],F.prototype,"_hasNew",2),F=u([b("ambience-traces-modal")],F);var bl={not_home:"Away",home:"Home"};function In(t){return bl[t]??he(t)}function Mn(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(n=>[n.name,n.live_value==null?"":String(n.live_value)]))}}function Bt(t){return String(t).padStart(2,"0")}function $l(t){return`${t.getFullYear()}-${Bt(t.getMonth()+1)}-${Bt(t.getDate())}`}function xl(t){return`${Bt(t.getHours())}:${Bt(t.getMinutes())}`}var P=class extends y{constructor(){super(...arguments);this.group="";this.groupName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1}updated(e){this.open&&(e.has("open")||e.has("group")||e.has("scope"))&&this._load()}_vkey(e){return`${e.matcher}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=$l(e),this._time=xl(e);try{let r=await Ei(this.hass,this.scope,this.group);if(!this.isConnected)return;this._knobs=r.knobs,this._hasTime=r.has_time;let i={},s={};for(let a of r.knobs)a.kind==="entity"?i[a.entity_id]=Mn(a):s[this._vkey(a)]=a.live_value;this._values=i,this._verdicts=s,this._loading=!1}catch(r){this._error=r.message||String(r),this._loading=!1}}_setState(e,r){this._values={...this._values,[e]:{...this._values[e],state:r}}}_setAttr(e,r,i){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[r]:i}}}}_setVerdict(e,r){this._verdicts={...this._verdicts,[e]:r}}_resetEntity(e){this._values={...this._values,[e.entity_id]:Mn(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let r of this._knobs){if(r.kind!=="entity")continue;let i=this._values[r.entity_id];if(!i)continue;let s={};for(let o of r.attributes){let c=i.attributes[o.name];if(!(c===void 0||c===""))if(o.control==="number"){let h=Number(c);Number.isNaN(h)||(s[o.name]=h)}else s[o.name]=c}let a={attributes:s};i.state!==""&&(a.state=i.state),(a.state!==void 0||Object.keys(s).length>0)&&(e[r.entity_id]=a)}return e}_buildVerdicts(){let e={};for(let r of this._knobs)r.kind==="verdict"&&((e[r.matcher]??={})[r.key]=this._verdicts[this._vkey(r)]??r.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`).toISOString();try{this._result=await Si(this.hass,this.scope,this.group,e,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(r){this._error=r.message||String(r)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      <div class="modal" role="dialog" aria-modal="true">
        <div class="header">
    ...
    `],u([p({attribute:!1})],P.prototype,"hass",2),u([p({attribute:!1})],P.prototype,"scope",2),u([p()],P.prototype,"group",2),u([p()],P.prototype,"groupName",2),u([p({type:Boolean,reflect:!0})],P.prototype,"open",2),u([f()],P.prototype,"_knobs",2),u([f()],P.prototype,"_hasTime",2),u([f()],P.prototype,"_loading",2),u([f()],P.prototype,"_error",2),u([f()],P.prototype,"_values",2),u([f()],P.prototype,"_verdicts",2),u([f()],P.prototype,"_date",2),u([f()],P.prototype,"_time",2),u([f()],P.prototype,"_result",2),u([f()],P.prototype,"_expanded",2),P=u([b("ambience-simulator-modal")],P);function qt(t){return{rules:t.rules??[]}}var Or=1024;function wl(t,n,e){if(t!==void 0&&n!==void 0)return Math.floor((t+n)/2);let r=e.map(i=>i.priority??0);return t===void 0&&n===void 0?Or:t===void 0?Math.max(...r)+Or:Math.min(...r)-Or}var T=class extends y{constructor(){super(...arguments);this._areas=[];this._floors=[];this._areaConfigs=new Map;this._floorConfigs=new Map;this._house={rules:[]};this._switchEntityIds=new Map;this._matchers=[];this._actions=[];this._groups=[];this._schemas={};this._expanded=new Set;this._error="";this._editing=null;this._viewingTraces=null;this._viewingSimulator=null;this._filterGroup="";this._filterOpen=!1;this._onExposedActionsChanged=async()=>{try{let e=await nt(this.hass);if(!this.isConnected)return;this._actions=e,await this._refreshSchemas(e)}catch{}}}async _refreshSchemas(e){let r=await Promise.all(e.map(async s=>{try{let a=await me(this.hass,s.id);return[s.id,a]}catch{return[s.id,null]}}));if(!this.isConnected)return;let i={};for(let[s,a]of r)a&&(i[s]=a);this._schemas=i}async connectedCallback(){super.connectedCallback(),window.addEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),await this._loadStatic(),await Promise.all([this._refreshAreas(),this._refreshFloors(),this._refreshHouse(),this._refreshSwitches()]),await this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),this._unsubArea?.(),this._unsubArea=void 0,this._unsubFloor?.(),this._unsubFloor=void 0}async _loadStatic(){try{let[e,r,i,s,a,o]=await Promise.all([Tt(this.hass),nt(this.hass),Lt(this.hass),At(this.hass),Rt(this.hass),Pt(this.hass)]);if(!this.isConnected)return;this._matchers=e,this._actions=r,this._periods=i,this._dayConfig=s,this._weatherConfig=a,this._groups=o,await this._refreshSchemas(r)}catch(e){this._error=e.message||String(e)}}async _refreshAreas(){try{let e=await ni(this.hass),r=this._areaConfigs,i=new Map;if(await Promise.all(e.map(async s=>{let a=r.get(s.area_id);if(a){i.set(s.area_id,a);return}i.set(s.area_id,qt(await si(this.hass,s.area_id)))})),!this.isConnected)return;this._areas=e,this._areaConfigs=i}catch(e){this._error=e.message||String(e)}}async _refreshFloors(){try{let e=(await oi(this.hass)).slice().sort((s,a)=>s.name.localeCompare(a.name)),r=this._floorConfigs,i=new Map;if(await Promise.all(e.map(async s=>{let a=r.get(s.floor_id);if(a){i.set(s.floor_id,a);return}i.set(s.floor_id,qt(await li(this.hass,s.floor_id)))})),!this.isConnected)return;this._floors=e,this._floorConfigs=i}catch(e){this._error=e.message||String(e)}}async _refreshHouse(){try{let e=qt(await ci(this.hass));if(!this.isConnected)return;this._house=e}catch(e){this._error=e.message||String(e)}}async _refreshSwitches(){try{let e=await xi(this.hass);if(!this.isConnected)return;this._switchEntityIds=new Map(e.map(r=>{let i=r.scope_kind==="house"?{kind:"house"}:{kind:r.scope_kind,id:r.scope_id};return[Q(i),r.entity_id]}))}catch(e){this._error=e.message||String(e)}}async _subscribe(){let e=this.hass.connection.subscribeEvents(a=>{if(a.data.action==="remove"){let o=a.data.area_id,c=new Set(this._expanded);c.delete(`area:${o}`),this._expanded=c,this._editing?.scope.kind==="area"&&this._editing.scope.id===o&&(this._editing=null)}this._refreshAreas(),a.data.action!=="update"&&this._refreshSwitches()},"area_registry_updated"),r=this.hass.connection.subscribeEvents(a=>{if(a.data.action==="remove"){let o=a.data.floor_id,c=new Set(this._expanded);c.delete(`floor:${o}`),this._expanded=c,this._editing?.scope.kind==="floor"&&this._editing.scope.id===o&&(this._editing=null)}this._refreshFloors(),a.data.action!=="update"&&this._refreshSwitches()},"floor_registry_updated"),[i,s]=await Promise.all([e,r]);this.isConnected?(this._unsubArea=i,this._unsubFloor=s):(i(),s())}_getConfig(e){return e.kind==="house"?this._house:e.kind==="area"?this._areaConfigs.get(e.id):this._floorConfigs.get(e.id)}_setConfig(e,r){if(e.kind==="house")this._house=r;else if(e.kind==="area"){let i=new Map(this._areaConfigs);i.set(e.id,r),this._areaConfigs=i}else{let i=new Map(this._floorConfigs);i.set(e.id,r),this._floorConfigs=i}}async _mutate(e,r){let i=this._getConfig(e);this._setConfig(e,r),this._error="";try{let s;return e.kind==="house"?s=await ui(this.hass,r):e.kind==="area"?s=await ai(this.hass,e.id,r):s=await di(this.hass,e.id,r),this._setConfig(e,qt(s.config)),!0}catch(s){return i&&this._setConfig(e,i),this._error=s.message||String(s),!1}}_toggleExpand(e){let r=Q(e),i=new Set(this._expanded);i.has(r)?i.delete(r):i.add(r),this._expanded=i}_addRule(e){let r=this._getConfig(e);r&&(this._editing={scope:e,index:r.rules.length,isNew:!0})}_editRule(e,r){this._editing={scope:e,index:r.detail.index,isNew:!1}}_duplicateRule(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules[r.detail.index];if(!s)return;let a=it(JSON.parse(JSON.stringify(s)));this._editing={scope:e,index:i.rules.length,isNew:!0,seed:a}}_deleteRule(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules.filter((a,o)=>o!==r.detail.index);this._mutate(e,{...i,rules:s})}_reorderRules(e,r){let i=this._getConfig(e);if(!i)return;let{from:s,to:a}=r.detail,o=i.rules[s];if(!o||i.rules[a]?.group!==o.group)return;let c=[...i.rules];c.splice(s,1),c.splice(a,0,o);let h=E=>c[E]&&c[E].group===o.group,m=a-1;for(;m>=0&&!h(m);)m--;let g=a+1;for(;g<c.length&&!h(g);)g++;let _=m>=0?c[m].priority:void 0,$=g<c.length?c[g].priority:void 0,k=wl(_,$,i.rules.filter(E=>E.group===o.group));c[a]={...o,priority:k,pinned:!0},this._mutate(e,{...i,rules:c})}_unpinRule(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules.map((a,o)=>o===r.detail.index?{...a,pinned:!1}:a);this._mutate(e,{...i,rules:s})}_toggleRuleEnabled(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules.map((a,o)=>{if(o!==r.detail.index)return a;if(r.detail.enabled){let c={...a};return delete c.enabled,c}return{...a,enabled:!1}});this._mutate(e,{...i,rules:s})}async _saveRule(e){let r=this._editing;if(this._editing=null,!r)return;let{rule:i,scope:s}=e.detail;if(Q(s)===Q(r.scope)){let h=this._getConfig(s);if(!h)return;let m=[...h.rules];r.isNew?m.push(i):m[r.index]=i,await this._mutate(s,{...h,rules:m});return}let a=it(i),o=this._getConfig(s);if(!o)return;if(await this._mutate(s,{...o,rules:[...o.rules,a]})&&!r.isNew){let h=this._getConfig(r.scope);if(h){let m=h.rules.filter((g,_)=>_!==r.index);await this._mutate(r.scope,{...h,rules:m})}}}async _callApi(e){this._error="";try{await e()}catch(r){this._error=r.message||String(r)}}_applyRules(e,r){return this._callApi(()=>fi(this.hass,e,r))}_runRuleActions(e,r){return this._callApi(()=>gi(this.hass,e,r.detail.index))}_cancelRule(){this._editing=null}_onScopeMenu(e,r,i,s){s==="run"&&this._applyRules(e)}_showTraces(e,r){let i=this._groups.find(s=>s.id===r);this._viewingTraces={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},group:r,groupName:i?.name??null}}_showSimulator(e,r){let i=this._groups.find(s=>s.id===r);this._viewingSimulator={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},group:r,groupName:i?.name??null}}_selectFilter(e){this._filterGroup=e,this._filterOpen=!1}_renderFilterEntry(e){return e===null?l`
  ...
  `],u([p({attribute:!1})],T.prototype,"hass",2),u([f()],T.prototype,"_areas",2),u([f()],T.prototype,"_floors",2),u([f()],T.prototype,"_areaConfigs",2),u([f()],T.prototype,"_floorConfigs",2),u([f()],T.prototype,"_house",2),u([f()],T.prototype,"_switchEntityIds",2),u([f()],T.prototype,"_matchers",2),u([f()],T.prototype,"_actions",2),u([f()],T.prototype,"_groups",2),u([f()],T.prototype,"_schemas",2),u([f()],T.prototype,"_periods",2),u([f()],T.prototype,"_dayConfig",2),u([f()],T.prototype,"_weatherConfig",2),u([f()],T.prototype,"_expanded",2),u([f()],T.prototype,"_error",2),u([f()],T.prototype,"_editing",2),u([f()],T.prototype,"_viewingTraces",2),u([f()],T.prototype,"_viewingSimulator",2),u([f()],T.prototype,"_filterGroup",2),u([f()],T.prototype,"_filterOpen",2),T=u([b("ambience-scopes-view")],T);var te=class extends y{constructor(){super(...arguments);this._groups=[];this._error="";this._editing=null;this._modalError=""}async connectedCallback(){super.connectedCallback();try{this._groups=await Pt(this.hass)}catch(e){this._error=e.message||String(e)}}_sorted(){return[...this._groups].sort((e,r)=>e.name.localeCompare(r.name))}_validate(e){let r=e.name.trim();if(r==="")return d(this.hass,"ui.group_name_blank_error","Group names can't be empty.");let i=r.toLocaleLowerCase();return this._groups.some(a=>a.id!==e.id&&a.name.trim().toLocaleLowerCase()===i)?d(this.hass,"ui.group_name_duplicate_error","Two groups can't have the same name."):""}_openEditor(e){this._editing={...e},this._modalError=""}_addGroup(){let e=crypto.randomUUID().replace(/-/g,"");this._editing={id:e,name:""},this._modalError=""}_closeModal(){this._editing=null,this._modalError=""}_patchDraft(e){this._editing&&(this._editing={...this._editing,...e})}_onName(e){this._patchDraft({name:e.target.value})}_onIcon(e){this._patchDraft({icon:e||void 0})}_onColor(e){this._patchDraft({color:e})}_save(){if(!this._editing)return;let e=this._validate(this._editing);if(e){this._modalError=e;return}let r={...this._editing,name:this._editing.name.trim()},i=this._groups.some(s=>s.id===r.id);this._groups=i?this._groups.map(s=>s.id===r.id?r:s):[...this._groups,r],this._closeModal(),wi(this.hass,this._groups).catch(s=>{this._error=s.message||String(s)})}_deleteGroup(){if(!this._editing)return;let e=this._editing.id;if(this._groups.length<=1){this._modalError=d(this.hass,"ui.group_delete_blocked_last","You can't delete the last group.");return}let r=this._groups;this._groups=this._groups.filter(i=>i.id!==e),ki(this.hass,e).then(()=>this._closeModal()).catch(i=>{this._groups=r;let s=i.code;this._modalError=s==="group_in_use"?d(this.hass,"ui.group_delete_blocked_in_use","This group still has rules \u2014 move or delete them first."):i.message||String(i)})}_renderIconField(){return customElements.get("ha-icon-picker")?l`<ha-icon-picker
    ...
    `}render(){return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      <div class="list">
        ${this._sorted().map(e=>{let r=lr(e.color);return l`<button class="group-row" @click=${()=>this._openEditor(e)}>
  ...
  `,u([p({attribute:!1})],be.prototype,"hass",2),u([f()],be.prototype,"_defaults",2),u([f()],be.prototype,"_error",2),be=u([b("ambience-ambience-settings")],be);var le=class extends y{constructor(){super(...arguments);this.matcherName="";this.matcherDescription="";this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}render(){let e=W(this.hass,this.matcherName);return l`
      <div class="card">
  ...
  `,u([p({attribute:!1})],G.prototype,"hass",2),u([p({attribute:!1})],G.prototype,"existingId",2),u([p({attribute:!1})],G.prototype,"initial",2),u([p({attribute:!1})],G.prototype,"takenIds",2),u([f()],G.prototype,"_label",2),u([f()],G.prototype,"_def",2),u([f()],G.prototype,"_error",2),G=u([b("ambience-period-edit-modal")],G);function jn(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Ne(n,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${d(n,"ui.unit_hour_abbr","h")}`:`${r}${d(n,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}function zn(t,n){return`${jn(t.from,n)} \u2192 ${jn(t.to,n)}`}var de=class extends y{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){this._view=await Lt(this.hass)}async _saveState(e){let r=await vi(this.hass,e,this._view.hidden);this._warnings=r.warnings,await this._reload()}_onEdit(e,r){this._modal={mode:"edit",id:e,initial:r}}async _onDelete(e){let r={...this._view.custom};delete r[e],await this._saveState(r)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:r,definition:i}=e.detail,s={...this._view.custom,[r]:i};this._modal={mode:"closed"},await this._saveState(s)}_onModalCancel(){this._modal={mode:"closed"}}_renderBuiltinRow(e,r,i){return l`
    ...
    `}render(){let e=this._view.custom;return l`
      ...
      ${this._warnings.length?l`<div class="warnings">
            ...
            <ul>
              ${this._warnings.map(r=>l`<li>${qe(r)} / "${r.rule_name}" → ${r.missing_period}</li>`)}
            </ul>
          </div>`:""}
  ...
  `,u([p({attribute:!1})],de.prototype,"hass",2),u([f()],de.prototype,"_view",2),u([f()],de.prototype,"_modal",2),u([f()],de.prototype,"_warnings",2),de=u([b("ambience-time-of-day-config")],de);var $e=class extends y{constructor(){super(...arguments);this._config={workday_sensor:null,workday_calendar:null};this._warnings=[]}async connectedCallback(){super.connectedCallback(),this._config=await At(this.hass)}async _save(e){this._config=e;let r=await _i(this.hass,e.workday_sensor,e.workday_calendar);this._warnings=r.warnings??[]}_onSensorChange(e){this._save({...this._config,workday_sensor:e.detail.value||null})}_onCalendarChange(e){this._save({...this._config,workday_calendar:e.detail.value||null})}render(){let e=[{name:"workday_sensor",selector:{entity:{integration:"workday",domain:"binary_sensor"}}}],r=[{name:"workday_calendar",selector:{entity:{integration:"workday",domain:"calendar"}}}];return l`
      ...
      ${this._warnings.length?l`
        <div class="warnings">
          ...
          <ul>
            ${this._warnings.map(i=>l`<li>${qe(i)} / "${i.rule_name}" → ${i.reason}</li>`)}
          </ul>
        </div>
      `:""}
    `}};$e.styles=v`
  ...
  `,u([p({attribute:!1})],$e.prototype,"hass",2),u([f()],$e.prototype,"_config",2),u([f()],$e.prototype,"_warnings",2),$e=u([b("ambience-day-config")],$e);var Sl=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],ce=class extends y{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),this._config=await Rt(this.hass)}async _persist(){let e=await yi(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[]}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:Sl.map(e=>({value:e,label:Ie(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
    ...
    `}render(){let e=[{name:"entity",selector:{entity:{domain:"weather"}}}];return l`
      ...
      ${this._warnings.length?l`
        <div class="warnings">
          ...
          <ul>${this._warnings.map(r=>l`<li>${qe(r)} / "${r.rule_name}" → ${r.reason}</li>`)}</ul>
        </div>
      `:""}
    `}};ce.styles=v`
    :host { display: block; }
    ...
    .warnings ul { margin: 0.3rem 0 0 0; padding-left: 1.2rem; }
  `,u([p({attribute:!1})],ce.prototype,"hass",2),u([f()],ce.prototype,"_config",2),u([f()],ce.prototype,"_warnings",2),u([f()],ce.prototype,"_expanded",2),ce=u([b("ambience-weather-config")],ce);var Cl=new Set(["time_of_day","day","weather"]),xe=class extends y{constructor(){super(...arguments);this._matchers=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._matchers=await Tt(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._matchers.filter(r=>Cl.has(r.name)).slice().sort((r,i)=>i.priority-r.priority);return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      ${e.map(r=>l`
