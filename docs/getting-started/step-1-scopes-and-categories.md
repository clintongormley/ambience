...
Then select the **Lights** category from the **Category filter** at the top of
the page.
...
Besides the lights, maybe you also have window blinds in the Lounge. They have a
different lifecycle from the lights, although many of the conditions may be
shared. For instance, your blinds might implement the following scenes:
...
Blinds and lights are both impacted by the state of the projector and by the
time of day, but lights don't depend on blinds and blinds don't depend on
lights. They are independent of each other, although they both exist in the same
room.
...
concepts that exist in only a few rooms or even a single room. General
categories like **Lights** and **Blinds** are useful, but maybe you have
en-suite **Bathroom lights** and **Bathroom blinds** which belong to the same
bedroom areas but have different lifecycles to the bedroom lights and blinds.
And maybe in just one bathroom you have **Shower lights** which have a different
lifecycle to the other **Bathroom lights**.
