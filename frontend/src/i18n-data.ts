...
export const AMBIENCE_STRINGS_BY_LOCALE: Record<string, Record<string, unknown>> = {
  en: {
    ...
    ui: {
      ...
      problem_missing: "Missing in Home Assistant:",
  ...
  es: {
    ...
    ui: {
      ...
      problem_missing: "Faltante en Home Assistant:",
      ...
      simulate: "Simular",
      state_add_condition: "Añadir condición",
      state_add_first: "Añadir condición",
