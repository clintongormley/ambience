...
Ambience is available in HACS. Click the button below to open it directly in
your Home Assistant, then click **Download**:
...
Or open **HACS** in the sidebar, search for **Ambience**, and click
**Download**.
