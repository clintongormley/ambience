    ...
    return html`
      <section>
        <div class="section-heading">
          ...
          <ambience-help .hass=${this.hass} .text=${localize(this.hass, "ui.help_actions_tab", "Actions are the service calls a scene runs. Define them here so scenes can reuse them.")} .docPath=${"reference/actions"}></ambience-help>
        </div>
