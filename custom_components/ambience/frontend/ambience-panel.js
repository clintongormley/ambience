...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Pr=/'/g,Rr=/"/g,Or=/^(?:script|style|textarea|title)$/i,Bt=t=>(n,...e)=>({_$litType$:t,strings:n,values:e}),l=Bt(1),Xo=Bt(2),Zo=Bt(3),_e=Symbol.for("lit-noChange"),R=Symbol.for("lit-nothing"),Fr=new WeakMap,ge=ve.createTreeWalker(ve,129);function Nr(t,n){if(!Gt(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Tr!==void 0?Tr.createHTML(n):n}var An=(t,n)=>{let e=t.length-1,r=[],i,s=n===2?"<svg>":n===3?"<math>":"",a=ze;for(let o=0;o<e;o++){let u=t[o],h,p,m=-1,v=0;for(;v<u.length&&(a.lastIndex=v,p=a.exec(u),p!==null);)v=a.lastIndex,a===ze?p[1]==="!--"?a=Lr:p[1]!==void 0?a=Ar:p[2]!==void 0?(Or.test(p[2])&&(i=RegExp("</"+p[2],"g")),a=fe):p[3]!==void 0&&(a=fe):a===fe?p[0]===">"?(a=i??ze,m=-1):p[1]===void 0?m=-2:(m=a.lastIndex-p[2].length,h=p[1],a=p[3]===void 0?fe:p[3]==='"'?Rr:Pr):a===Rr||a===Pr?a=fe:a===Lr||a===Ar?a=ze:(a=fe,i=void 0);let y=a===fe&&t[o+1].startsWith("/>")?" ":"";s+=a===ze?u+Tn:m>=0?(r.push(h),u.slice(0,m)+Dr+u.slice(m)+oe+y):u+oe+(m===-2?o:y)}return[Nr(t,s+(t[e]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),r]},Ge=class t{constructor({strings:n,_$litType$:e},r){let i;this.parts=[];let s=0,a=0,o=n.length-1,u=this.parts,[h,p]=An(n,e);if(this.el=t.createElement(h,r),ge.currentNode=this.el.content,e===2||e===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(i=ge.nextNode())!==null&&u.length<o;){if(i.nodeType===1){if(i.hasAttributes())for(let m of i.getAttributeNames())if(m.endsWith(Dr)){let v=p[a++],y=i.getAttribute(m).split(oe),k=/([.?@])?(.*)/.exec(v);u.push({type:1,index:s,name:k[2],strings:y,ctor:k[1]==="."?It:k[1]==="?"?jt:k[1]==="@"?zt:Te}),i.removeAttribute(m)}else m.startsWith(oe)&&(u.push({type:6,index:s}),i.removeAttribute(m));if(Or.test(i.tagName)){let m=i.textContent.split(oe),v=m.length-1;if(v>0){i.textContent=ot?ot.emptyScript:"";for(let y=0;y<v;y++)i.append(m[y],We()),ge.nextNode(),u.push({type:2,index:++s});i.append(m[v],We())}}}else if(i.nodeType===8)if(i.data===Hr)u.push({type:2,index:s});else{let m=-1;for(;(m=i.data.indexOf(oe,m+1))!==-1;)u.push({type:7,index:s}),m+=oe.length-1}s++}}static createElement(n,e){let r=ve.createElement("template");return r.innerHTML=n,r}};function Ce(t,n,e=t,r){if(n===_e)return n;let i=r!==void 0?e._$Co?.[r]:e._$Cl,s=Ue(n)?void 0:n._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(t),i._$AT(t,e,r)),r!==void 0?(e._$Co??=[])[r]=i:e._$Cl=i),i!==void 0&&(n=Ce(t,i._$AS(t,n.values),i,r)),n}var Mt=class{constructor(n,e){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:e},parts:r}=this._$AD,i=(n?.creationScope??ve).importNode(e,!0);ge.currentNode=i;let s=ge.nextNode(),a=0,o=0,u=r[0];for(;u!==void 0;){if(a===u.index){let h;u.type===2?h=new Be(s,s.nextSibling,this,n):u.type===1?h=new u.ctor(s,u.name,u.strings,this,n):u.type===6&&(h=new Wt(s,this,n)),this._$AV.push(h),u=r[++o]}a!==u?.index&&(s=ge.nextNode(),a++)}return ge.currentNode=ve,i}p(n){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(n,r,e),e+=r.strings.length-2):r._$AI(n[e])),e++}},Be=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,e,r,i){this.type=2,this._$AH=R,this._$AN=void 0,this._$AA=n,this._$AB=e,this._$AM=r,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,e=this._$AM;return e!==void 0&&n?.nodeType===11&&(n=e.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,e=this){n=Ce(this,n,e),Ue(n)?n===R||n==null||n===""?(this._$AH!==R&&this._$AR(),this._$AH=R):n!==this._$AH&&n!==_e&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):Ln(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==R&&Ue(this._$AH)?this._$AA.nextSibling.data=n:this.T(ve.createTextNode(n)),this._$AH=n}$(n){let{values:e,_$litType$:r}=n,i=typeof r=="number"?this._$AC(n):(r.el===void 0&&(r.el=Ge.createElement(Nr(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===i)this._$AH.p(e);else{let s=new Mt(i,this),a=s.u(this.options);s.p(e),this.T(a),this._$AH=s}}_$AC(n){let e=Fr.get(n.strings);return e===void 0&&Fr.set(n.strings,e=new Ge(n)),e}k(n){Gt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,i=0;for(let s of n)i===e.length?e.push(r=new t(this.O(We()),this.O(We()),this,this.options)):r=e[i],r._$AI(s),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(n=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);n!==this._$AB;){let r=Cr(n).nextSibling;Cr(n).remove(),n=r}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},Te=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,e,r,i,s){this.type=1,this._$AH=R,this._$AN=void 0,this.element=n,this.name=e,this._$AM=i,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=R}_$AI(n,e=this,r,i){let s=this.strings,a=!1;if(s===void 0)n=Ce(this,n,e,0),a=!Ue(n)||n!==this._$AH&&n!==_e,a&&(this._$AH=n);else{let o=n,u,h;for(n=s[0],u=0;u<s.length-1;u++)h=Ce(this,o[r+u],e,u),h===_e&&(h=this._$AH[u]),a||=!Ue(h)||h!==this._$AH[u],h===R?n=R:n!==R&&(n+=(h??"")+s[u+1]),this._$AH[u]=h}a&&!i&&this.j(n)}j(n){n===R?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},It=class extends Te{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===R?void 0:n}},jt=class extends Te{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==R)}},zt=class extends Te{constructor(n,e,r,i,s){super(n,e,r,i,s),this.type=5}_$AI(n,e=this){if((n=Ce(this,n,e,0)??R)===_e)return;let r=this._$AH,i=n===R&&r!==R||n.capture!==r.capture||n.once!==r.once||n.passive!==r.passive,s=n!==R&&(r===R||i);i&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},Wt=class{constructor(n,e,r){this.element=n,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(n){Ce(this,n)}};var Pn=Ut.litHtmlPolyfillSupport;Pn?.(Ge,Be),(Ut.litHtmlVersions??=[]).push("3.3.2");var Mr=(t,n,e)=>{let r=e?.renderBefore??n,i=r._$litPart$;if(i===void 0){let s=e?.renderBefore??null;r._$litPart$=i=new Be(n.insertBefore(We(),s),s,void 0,e??{})}return i._$AI(t),i};var qt=globalThis,_=class extends Z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=Mr(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _e}};_._$litElement$=!0,_.finalized=!0,qt.litElementHydrateSupport?.({LitElement:_});var Rn=qt.litElementPolyfillSupport;Rn?.({LitElement:_});(qt.litElementVersions??=[]).push("4.2.2");var $=t=>(n,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(t,n)}):customElements.define(t,n)};var Fn={attribute:!0,type:String,converter:je,reflect:!1,hasChanged:at},Dn=(t=Fn,n,e)=>{let{kind:r,metadata:i}=e,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),r==="setter"&&((t=Object.create(t)).wrapped=!0),s.set(e.name,t),r==="accessor"){let{name:a}=e;return{set(o){let u=n.get.call(this);n.set.call(this,o),this.requestUpdate(a,u,t,!0,o)},init(o){return o!==void 0&&this.C(a,void 0,t,o),o}}}if(r==="setter"){let{name:a}=e;return function(o){let u=this[a];n.call(this,o),this.requestUpdate(a,u,t,!0,o)}}throw Error("Unsupported decorator location: "+r)};function f(t){return(n,e)=>typeof e=="object"?Dn(t,n,e):((r,i,s)=>{let a=i.hasOwnProperty(s);return i.constructor.createProperty(s,r),a?Object.getOwnPropertyDescriptor(i,s):void 0})(t,n,e)}function g(t){return f({...t,state:!0,attribute:!1})}function B(t,n,e){let r=t?.localize?.(n);return r&&r!==n?r:e}function Yt(t){let n=t.replaceAll("_"," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}function q(t,n){return B(t,`component.ambience.matcher.${n}`,Yt(n))}function dt(t,n){return B(t,`component.ambience.action.${n}`,Yt(n))}function Le(t,n){return B(t,`component.ambience.anchor.${n}`,Yt(n))}function ye(t,n,e){let r=e[n]?.label;if(r)return r;let i=n.charAt(0).toUpperCase()+n.slice(1);return B(t,`component.ambience.time_of_day_period.${n}`,i)}function d(t,n,e){return B(t,`component.ambience.${n}`,e)}var Hn=["mon","tue","wed","thu","fri","sat","sun"],On=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];function ut(t,n){return B(t,`component.ambience.weekday.${Hn[n]}`,On[n]??String(n))}var Nn={weekday:"Day of week",day_of_month:"Day of month",date:"Date (annual)",date_range:"Date range (annual)",last_day:"Last day of month",workday:"Workday",holiday:"Holiday",first_workday:"First workday of month",last_workday:"Last workday of month"};function ct(t,n){return B(t,`component.ambience.day_item.${n}`,Nn[n]??n)}var Mn=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ae(t,n){return B(t,`component.ambience.month.${n}`,Mn[n-1]??String(n))}var In={"clear-night":"Clear (night)",cloudy:"Cloudy",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning-rainy",partlycloudy:"Partly cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy-rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy (variant)",exceptional:"Exceptional"};function ht(t,n){return B(t,`component.ambience.weather_condition.${n}`,In[n]??n)}var jn={temperature:"Temperature",apparent_temperature:"Apparent temperature",humidity:"Humidity",wind_speed:"Wind speed",pressure:"Pressure"};function qe(t,n){return B(t,`component.ambience.weather_attr.${n}`,jn[n]??n)}var zn={temperature:"\xB0C",apparent_temperature:"\xB0C",humidity:"%",wind_speed:"m/s",pressure:"hPa"},Wn={temperature:"temperature",apparent_temperature:"temperature",wind_speed:"wind_speed",pressure:"pressure"},Un={temperature:"temperature_unit",apparent_temperature:"temperature_unit",wind_speed:"wind_speed_unit",pressure:"pressure_unit"};function Kt(t,n,e){if(n==="humidity")return"%";let r=Un[n];if(r){let a=e?.attributes?.[r];if(typeof a=="string"&&a)return a}let i=Wn[n],s=t?.config?.unit_system;return i&&s&&typeof s[i]=="string"?s[i]:zn[n]??""}var Gn={is:"is",is_not:"is not",">":">",">=":"\u2265","<":"<","<=":"\u2264",and:"AND",or:"OR",and_not:"AND NOT",or_not:"OR NOT",not:"NOT"};function Y(t,n){return B(t,`component.ambience.state_op.${n}`,Gn[n]??n)}var Bn=["ha-input","ha-textfield","ha-form"],qn=["ha-input","ha-textfield"];function Ir(){for(let t of qn)if(customElements.get(t))return t;return null}function le(t,n){for(let e of Bn)customElements.get(e)||customElements.whenDefined(e).then(()=>t.requestUpdate())}async function pt(t){return t.callWS({type:"ambience/areas/list"})}async function mt(t,n){return t.callWS({type:"ambience/area/get",area_id:n})}async function jr(t,n,e){return t.callWS({type:"ambience/area/save",area_id:n,config:e})}async function ft(t){return t.callWS({type:"ambience/floors/list"})}async function gt(t,n){return t.callWS({type:"ambience/floor/get",floor_id:n})}async function zr(t,n,e){return t.callWS({type:"ambience/floor/save",floor_id:n,config:e})}async function vt(t){return t.callWS({type:"ambience/house/get"})}async function Wr(t,n){return t.callWS({type:"ambience/house/save",config:n})}async function _t(t){return t.callWS({type:"ambience/matchers/list"})}async function Ye(t){return t.callWS({type:"ambience/exposed_actions/list"})}async function Ur(t,n){return t.callWS({type:"ambience/exposed_actions/save",actions:n})}async function Gr(t){return t.callWS({type:"ambience/services/list"})}async function Pe(t,n){return t.callWS({type:"ambience/services/get_schema",service:n})}async function yt(t){return t.callWS({type:"ambience/time_of_day_periods/list"})}async function Br(t,n,e){return t.callWS({type:"ambience/time_of_day_periods/save",custom:n,hidden:e})}async function bt(t){return t.callWS({type:"ambience/matchers/day/config/list"})}async function qr(t,n,e){return t.callWS({type:"ambience/matchers/day/config/save",workday_sensor:n,workday_calendar:e})}async function $t(t){return t.callWS({type:"ambience/matchers/weather/config/list"})}async function Yr(t,n,e){return t.callWS({type:"ambience/matchers/weather/config/save",entity:n,groups:e})}async function Kr(t,n){return t.callWS({type:"ambience/state/known_states",entity_id:n})}async function Vr(t){return t.callWS({type:"ambience/switch_defaults/list"})}async function Vt(t,n,e){return t.callWS({type:"ambience/switch_defaults/save",name:n,auto_on_delay_seconds:e})}async function Qr(t,n,e){return t.callWS({type:"ambience/house/switch/save",name:n,auto_on_delay_seconds:e})}async function Jr(t,n,e,r){return t.callWS({type:"ambience/floor/switch/save",floor_id:n,name:e,auto_on_delay_seconds:r})}async function Xr(t,n,e,r){return t.callWS({type:"ambience/area/switch/save",area_id:n,name:e,auto_on_delay_seconds:r})}async function Zr(t,n,e,r){let i={type:"ambience/auto_triggers/set",scope_kind:n,enabled:r};return e!=null&&(i.scope_id=e),t.callWS(i)}async function wt(t){return(await t.callWS({type:"ambience/groups/list"})).groups}async function ei(t,n){return t.callWS({type:"ambience/groups/save",groups:n})}async function ti(t,n){return t.callWS({type:"ambience/groups/delete",group_id:n})}async function ri(t,n){return t.callWS({type:"ambience/script/referenced_entities",script:n})}async function ii(t,n,e){let r={type:"ambience/auto_triggers/list",scope_kind:n};return e!=null&&(r.scope_id=e),t.callWS(r)}async function ni(t,n,e,r,i){let s={type:"ambience/auto_triggers/set_trigger",scope_kind:n,key:r,enabled:i};return e!=null&&(s.scope_id=e),t.callWS(s)}function er(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return Xn(t)}function xt(t,n="New rule"){return t.name&&t.name.trim()?t.name:n}function Ke(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?Et(n,e):t==="day"?Qn(n,e):t==="weather"?es(n,e):t==="sun"?ts(n,e):t==="state"?tr(n,e):t==="script"?Kn(n,e):t==="people"?Vn(n,e):t==="template"?Yn(n,e):String(n)}function Yn(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function Kn(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||t===null||typeof t.script!="string")return String(t);let e=t.args??{},r=Object.keys(e).sort();if(r.length===0)return t.script;let i=r.map(s=>`${s}=${e[s]}`).join(", ");return`${t.script}(${i})`}function Qt(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function si(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):Qt(n,t)}function Vn(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=Qt(n,t.who[0]),u=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${u} ${si(e,n)}`;return t.for&&Xt(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${Zt(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),u=t.who.map(h=>Qt(n,h)).join(", ");r=`${o} (${u})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${si(e,n)}`;return t.for&&Xt(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${Zt(t.for)}`:s}function Qn(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>ai(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>ai(a,n)).join(", ")})`}function ai(t,n){switch(t.kind){case"weekday":return t.days.map(e=>ut(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Ae(n.hass,t.month)} ${t.day}`;case"date_range":return`${Ae(n.hass,t.from.month)} ${t.from.day} \u2192 ${Ae(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Jn={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function Xn(t){let n=t.replaceAll("_"," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}function Ve(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}function kt(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function Zn(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function es(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??Zn(a)).join("/"),i=(t.thresholds??[]).map(a=>`${qe(n.hass,a.attribute)} ${Jn[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function ts(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function rs(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;return typeof r=="string"&&r?r:n}function tr(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):Jt(t,n)}function Jt(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<="){let e=Y(n.hass,t.kind),i=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.join("/"),s=rs(n,t.entity_id),o=`${t.attribute?`${s}.${t.attribute}`:s} ${e} ${i}`;return t.for&&Xt(t.for)?`${o} ${d(n.hass,"ui.for_prefix","for")} \u2265${Zt(t.for)}`:o}if(t.kind==="and"||t.kind==="or"){let e=` ${Y(n.hass,t.kind)} `;return t.items.map(r=>oi(r,n)).join(e)}return t.kind==="not"?`${Y(n.hass,"not")} ${oi(t.item,n)}`:""}function oi(t,n){return t.kind==="and"||t.kind==="or"?`(${Jt(t,n)})`:Jt(t,n)}function Xt(t){return t.h>0||t.m>0||t.s>0}function Zt(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function Et(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ye(n.hass,i.period,r):`${li(i.from,n)} \u2192 ${li(i.to,n)}`).join(", ")}function li(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Le(n.hass,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${r}${d(n.hass,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}function is(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label&&e.label.trim()?e.label:dt(n.hass,t.service)}function ns(t,n){let e=t.service.indexOf(".");return e>0?t.service.slice(0,e):d(n.hass,"ui.target_noun","target")}function di(t,n){let e=is(t,n),r=ns(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,u])=>`${er(o,t.service,n.schemas)}: ${Ve(u)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var rr=[{id:"red",label:"Red",hex:"#f44336"},{id:"pink",label:"Pink",hex:"#e91e63"},{id:"purple",label:"Purple",hex:"#9c27b0"},{id:"deep-purple",label:"Deep purple",hex:"#673ab7"},{id:"indigo",label:"Indigo",hex:"#3f51b5"},{id:"blue",label:"Blue",hex:"#2196f3"},{id:"light-blue",label:"Light blue",hex:"#03a9f4"},{id:"cyan",label:"Cyan",hex:"#00bcd4"},{id:"teal",label:"Teal",hex:"#009688"},{id:"green",label:"Green",hex:"#4caf50"},{id:"light-green",label:"Light green",hex:"#8bc34a"},{id:"lime",label:"Lime",hex:"#cddc39"},{id:"yellow",label:"Yellow",hex:"#ffeb3b"},{id:"amber",label:"Amber",hex:"#ffc107"},{id:"orange",label:"Orange",hex:"#ff9800"},{id:"deep-orange",label:"Deep orange",hex:"#ff5722"},{id:"brown",label:"Brown",hex:"#795548"},{id:"grey",label:"Grey",hex:"#9e9e9e"},{id:"blue-grey",label:"Blue grey",hex:"#607d8b"}];function St(t){if(t)return rr.find(n=>n.id===t)?.hex}function ui(t){let n=t.replace("#",""),e=parseInt(n.slice(0,2),16)/255,r=parseInt(n.slice(2,4),16)/255,i=parseInt(n.slice(4,6),16)/255,s=o=>o<=.03928?o/12.92:((o+.055)/1.055)**2.4;return .2126*s(e)+.7152*s(r)+.0722*s(i)>.5?"#000000":"#ffffff"}var Re=class extends _{render(){let n=St(this.group?.color),e=n?`background: ${n}; color: ${ui(n)}`:"";return l`
      ...
      >
        <span class="lead">
          ${r.pinned?l`<button
                ...
                title=${s}
                aria-label=${s}
                @click=${o=>{o.stopPropagation(),this._emit("unpin-rule",{index:e})}}
        ...
        <div class="body" @click=${()=>this._toggleRule(e)}>
          <div class="name">
            ${xt(r,d(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(i)))}${a?l`<ambience-group-chip .group=${a}></ambience-group-chip>`:""}
          </div>
          <div class="summary">
          ...
          ${this._expanded.has(e)?l`
                <div class="rule-detail">
                  ...
                  ${r.actions.length===0?"":l`<div class="actions-detail">
                        ${r.actions.map(o=>{let u=this._actionParamsString(o),h=this._actionLabel(o),p=u?`${h} \xB7 ${u}`:h;return l`
                            <div class="actions-detail-item">
                              <div class="action-header">${p}</div>
                              ${o.entity_ids.length===0?l`<div class="no-targets">${d(this.hass,"ui.no_targets","(no targets)")}</div>`:l`<ul class="entity-list">
                                    ${o.entity_ids.map(m=>l`<li>${this._entityName(m)}</li>`)}
                                  </ul>`}
                            </div>
                          `})}
                      </div>`}
        ...
        <button
          @click=${o=>{o.stopPropagation(),this._emit("edit-rule",{index:e})}}
          title=${d(this.hass,"ui.edit","Edit")}
        >
          ✎
        </button>
        <button
          @click=${o=>{o.stopPropagation(),this._emit("duplicate-rule",{index:e})}}
          title=${d(this.hass,"ui.duplicate","Duplicate")}
        >
          ⧉
        </button>
        <button
          @click=${o=>{o.stopPropagation(),this._confirmDelete(e,r,i)}}
    ...
    `}render(){if(this.rules.length===0)return l`
      ...
      ${e.map(i=>l`
          <div class="group-section">
            ${r&&i.group?l`<div class="group-section-header">
                  <ambience-group-chip .group=${i.group}></ambience-group-chip>
  ...
  `,c([f({attribute:!1})],F.prototype,"rules",2),c([f({attribute:!1})],F.prototype,"periods",2),c([f({attribute:!1})],F.prototype,"weatherConfig",2),c([f({attribute:!1})],F.prototype,"hass",2),c([f({attribute:!1})],F.prototype,"matchers",2),c([f({attribute:!1})],F.prototype,"availableActions",2),c([f({attribute:!1})],F.prototype,"schemas",2),c([f({attribute:!1})],F.prototype,"groups",2),c([f({attribute:!1})],F.prototype,"filterGroup",2),c([g()],F.prototype,"_dragFrom",2),c([g()],F.prototype,"_dragOver",2),c([g()],F.prototype,"_expanded",2),F=c([$("ambience-rules-list")],F);function ci(t,n){let e=t.trim();if(e==="")return null;let r=Number(e);return isNaN(r)?null:r<=0?n?0:null:Math.max(10,Math.round(r))}function hi(t){return ci(t,!1)}function pi(t){return ci(t,!0)}function mi(t,n){return"reapply_seconds"in t?t.reapply_seconds??0:n}function fi(t){return t%60===0?`${t/60} min`:t<60?`${t} sec`:`${Math.floor(t/60)} min ${t%60} sec`}function gi(t,n){if(!n||n.entity==null)return[...t];let e=Array.isArray(n.entity)?n.entity:[n.entity];if(e.length===0)return[...t];let r=new Set,i=!1;for(let s of e){if(!s||typeof s!="object")continue;let a=s.domain;if(a==null){i=!0;continue}if(Array.isArray(a))for(let o of a)typeof o=="string"&&r.add(o);else typeof a=="string"&&r.add(a)}return i||r.size===0?[...t]:t.filter(s=>{let a=s.indexOf(".");return a<0?!1:r.has(s.slice(0,a))})}function vi(t,n,e=[]){let r=t;if(!r?.entities)return[];let i=r.entities,s=r.devices??{},a=r.areas??{},o=n.kind==="area"?new Set([n.id]):n.kind==="floor"?new Set(Object.values(a).filter(h=>h.floor_id===n.id).map(h=>h.area_id)):null,u=h=>{let p=h.area_id??(h.device_id?s[h.device_id]?.area_id??null:null);return p==null?!1:o===null?!0:o.has(p)};return Object.values(i).filter(u).filter(h=>e.length===0||e.includes(h.entity_id.split(".")[0])).map(h=>h.entity_id).sort()}var V=class extends _{constructor(){super(...arguments);this.entities=[];this.value=[];this.target=null;this.label=" "}_filteredEntities(){return gi(this.entities,this.target)}connectedCallback(){super.connectedCallback(),le(this,this.hass)}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let r=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this._filteredEntities()}}}],i=this.label;return l`
      <ha-form
        .hass=${this.hass}
        .schema=${r}
  ...
  `,c([f({attribute:!1})],V.prototype,"hass",2),c([f({attribute:!1})],V.prototype,"entities",2),c([f({attribute:!1})],V.prototype,"value",2),c([f({attribute:!1})],V.prototype,"target",2),c([f()],V.prototype,"label",2),V=c([$("ambience-target-picker")],V);var N=class extends _{constructor(){super(...arguments);this.entityIds=[];this.params={};this._schema=void 0;this._schemaError=null;this._exposedMissing=!1;this._formSchema=[];this._perFieldSchemas={};this._schemaServiceId=null;this._onTargetChanged=e=>{e.stopPropagation(),this._emit("entity-ids-changed",{entityIds:e.detail.value})};this._onFieldInput=e=>r=>{r.stopPropagation();let i=r.target,s={...this.params,[e]:i.value};this._emit("params-changed",{params:s})};this._onHaFormChanged=e=>{e.stopPropagation(),this._emit("params-changed",{params:{...this.params,...e.detail.value}})}}connectedCallback(){super.connectedCallback(),le(this,this.hass)}willUpdate(e){if((e.has("exposed")&&e.get("exposed")?.id!==this.exposed?.id||e.has("hass")&&this._schema===void 0)&&this._loadSchema(),(e.has("exposed")||e.has("_schema"))&&(this._formSchema=this._buildFormSchema()),e.has("_formSchema")||e.has("_schema")||e.has("exposed")){let r={};for(let i of this._formSchema)r[i.name]=[i];this._perFieldSchemas=r}}async _loadSchema(){if(this.exposed===void 0&&this.hass){this._exposedMissing=!0,this._schema=null,this._schemaServiceId=null;return}let e=this.exposed?.id;if(!e||!this.hass){this._exposedMissing=!1,this._schema=void 0,this._schemaServiceId=null;return}this._exposedMissing=!1,this._schemaServiceId=e,this._schemaError=null,this._schema=void 0;try{let r=await Pe(this.hass,e);if(this._schemaServiceId!==e)return;this._schema=r}catch(r){if(this._schemaServiceId!==e)return;this._schema=null,this._schemaError=r instanceof Error?r.message:String(r)}}_buildFormSchema(){let e=this._schema,r=this.exposed;if(!e||!r)return[];let i=new Set(r.visible_fields??[]),s=[];for(let[a,o]of Object.entries(e.fields))i.has(a)&&s.push({name:a,selector:o.selector??{text:{}},required:!!o.required,description:typeof o.description=="string"&&o.description?o.description:void 0});return s}updated(e){super.updated?.(e),e.has("_schema")&&this.dispatchEvent(new CustomEvent("target-mode-changed",{detail:{hasTarget:this.hasTarget()},bubbles:!0,composed:!0}))}_hasTarget(){let e=this._schema?.target??null;return!e||typeof e!="object"?!1:Object.keys(e).length>0}hasTarget(){return this._schema===void 0?!1:this._hasTarget()}_scopeEntities(){return!this.scope||!this.hass?[]:vi(this.hass,this.scope,[])}_renderTargetPicker(){if(!this._hasTarget())return"";let e=this._scopeEntities(),r=this._schema?.target??null,i=d(this.hass,"ui.target","Target");return l`
...
`:""}var So=Eo,Co={dump:So};function fr(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var an=Yi.load,wd=Yi.loadAll,Ft=Co.dump;var xd=fr("safeLoad","load"),kd=fr("safeLoadAll","loadAll"),Ed=fr("safeDump","dump");var z=class extends _{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._suggested=[];this._suggestedFor=null}willUpdate(e){if(super.willUpdate?.(e),e.has("value")){this._mode==="form"&&(this._yamlText=Ft(this.value??{}));let r=this.value&&typeof this.value=="object"?this.value.script:null;this._loadSuggestions(r)}}connectedCallback(){super.connectedCallback(),this._yamlText=Ft(this.value??{});let e=this.value&&typeof this.value=="object"?this.value.script:null,r=this._fieldsFor(e);e&&(!r||Object.keys(r).length===0)&&(this._mode="yaml");let i=this.value&&typeof this.value=="object"?this.value.script:null;this._loadSuggestions(i)}async _loadSuggestions(e){if(e!==this._suggestedFor&&(this._suggestedFor=e,this._suggested=[],!(!e||!this.hass)))try{let{entities:r}=await ri(this.hass,e);this._suggestedFor===e&&(this._suggested=r)}catch{}}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Ft(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=an(e)}catch(u){this._yamlError=u.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(u=>typeof u=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){let i=this.hass?.states?.[e]?.attributes?.friendly_name;return typeof i=="string"&&i?i:e}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.prototype.hasOwnProperty.call(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._fieldsFor(this.value&&typeof this.value=="object"?this.value.script:null);return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,description:i.description?{suffix:i.description}:void 0,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}render(){let e=this.value&&typeof this.value=="object"?this.value.script:null,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,c([f({attribute:!1})],te.prototype,"hass",2),c([f({attribute:!1})],te.prototype,"value",2),c([f({attribute:!1})],te.prototype,"groups",2),c([f({attribute:!1})],te.prototype,"weatherEntity",2),te=c([$("ambience-weather-predicate-input")],te);var Fo=["NW","N","NE","W",null,"E","SW","S","SE"],xe=class extends _{constructor(){super(...arguments);this.value=null}_current(){let e=this.value?.azimuth?.ranges??[];return{elevation:this.value?.elevation??null,sectors:[...this.value?.azimuth?.sectors??[]],range:e.length?{...e[0]}:null}}_emit(e){let r={};e.elevation&&(e.elevation.min!=null||e.elevation.max!=null)&&(r.elevation=e.elevation);let i={};e.sectors.length&&(i.sectors=e.sectors),e.range&&(i.ranges=[e.range]),(i.sectors||i.ranges)&&(r.azimuth=i),this.value=r.elevation||r.azimuth?r:null,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_setElevation(e){this._emit({...this._current(),elevation:e})}_setSectors(e){this._emit({...this._current(),sectors:e})}_setRange(e){this._emit({...this._current(),range:e})}_mode(e){return!e||e.min==null&&e.max==null?"any":e.min!=null&&e.max!=null?"between":e.min!=null?"above":"below"}_onModeChange(e,r){let i=r?.min??0,s=r?.max??0;e==="any"?this._setElevation(null):e==="above"?this._setElevation({min:i}):e==="below"?this._setElevation({max:s}):this._setElevation({min:i,max:s})}_toggleSector(e,r,i){this._setSectors(i?[...e,r]:e.filter(s=>s!==r))}_renderSectors(e){return l`<div class="sectors">${Fo.map(r=>r===null?l`<span class="spacer"></span>`:l`<label>
  ...
  `,c([f({attribute:!1})],he.prototype,"value",2),c([f({attribute:!1})],he.prototype,"hass",2),c([g()],he.prototype,"_preview",2),he=c([$("ambience-template-predicate-input")],he);var K=class extends _{constructor(){super(...arguments);this.value=null}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onText(e){let r=e.target.value;this._emit(r.trim()===""?null:r)}render(){return this.matcher.input==="time_of_day"?l`
  ...
  `,c([f({attribute:!1})],K.prototype,"matcher",2),c([f({attribute:!1})],K.prototype,"value",2),c([f({attribute:!1})],K.prototype,"periods",2),c([f({attribute:!1})],K.prototype,"dayConfig",2),c([f({attribute:!1})],K.prototype,"weatherConfig",2),c([f({attribute:!1})],K.prototype,"hass",2),K=c([$("ambience-matcher-input")],K);function Oo(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function No(t){return t==="people"?{quant:"everyone",where:"home"}:null}var C=class extends _{constructor(){super(...arguments);this.open=!1;this.rule=null;this.matchers=[];this.availableActions=[];this.groups=[];this.schemas={};this._draft=null;this._open=null;this._showError=!1;this._serviceHasTarget=new Map;this._matcherError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onGroupChange=e=>{this._setGroup(e.target.value)};this._onGroupChangeHaForm=e=>{e.stopPropagation(),this._setGroup(e.detail.value.group)};this._onAddMatcher=e=>{let r=e.target,i=r.value;r.value="",this._addMatcher(i)};this._onAddMatcherHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==C._ADD_MATCHER_PLACEHOLDER&&this._addMatcher(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==C._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onMatcherInvalid(e,r){r?this._matcherError.set(e,r):this._matcherError.delete(e)}connectedCallback(){super.connectedCallback(),le(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._open=null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_renderNameSlot(){let e=this._draft.name??"";if(this._isOpen({kind:"name"}))return l`
    ...
    `}_renderGroupSelectorHaForm(e){let r=[{name:"group",selector:{select:{mode:"dropdown",options:this.groups.map(i=>({value:i.id,label:i.name}))}}}];return l`
    ...
    `}_renderActionRow(e,r){let i=this.availableActions.find(p=>p.id===e.service),s=i?.reapply_seconds??0,a=this._isOpen({kind:"action",idx:r}),o=di(e,{hass:this.hass,exposedActions:this.availableActions,schemas:this.schemas}),u=mi(e,s),h=s>0&&u>0;return l`
  ...
  `,c([f({attribute:!1})],ie.prototype,"hass",2),c([g()],ie.prototype,"_defaults",2),c([g()],ie.prototype,"_rows",2),c([g()],ie.prototype,"_error",2),ie=c([$("ambience-ambience-settings")],ie);var ne=class extends _{constructor(){super(...arguments);this.matcherName="";this.matcherDescription="";this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}render(){let e=q(this.hass,this.matcherName);return l`
      <div class="card">
  ...
  `,c([f({attribute:!1})],pe.prototype,"hass",2),c([g()],pe.prototype,"_config",2),c([g()],pe.prototype,"_warnings",2),pe=c([$("ambience-day-config")],pe);var Uo=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],ae=class extends _{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),this._config=await $t(this.hass)}async _persist(){let e=await Yr(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[]}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:Uo.map(e=>({value:e,label:ht(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
    ...
    .warnings ul { margin: 0.3rem 0 0 0; padding-left: 1.2rem; }
  `,c([f({attribute:!1})],ae.prototype,"hass",2),c([g()],ae.prototype,"_config",2),c([g()],ae.prototype,"_warnings",2),c([g()],ae.prototype,"_expanded",2),ae=c([$("ambience-weather-config")],ae);var Go=new Set(["time_of_day","day","weather"]),me=class extends _{constructor(){super(...arguments);this._matchers=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._matchers=await _t(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._matchers.filter(r=>Go.has(r.name)).slice().sort((r,i)=>i.priority-r.priority);return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      ${e.map(r=>l`
  ...
  `,c([f({attribute:!1})],Ee.prototype,"hass",2),c([g()],Ee.prototype,"_tab",2),Ee=c([$("ambience-settings-view")],Ee);var Se=class extends _{constructor(){super(...arguments);this._view="areas"}connectedCallback(){super.connectedCallback(),le(this)}render(){return l`
      <header>
        <h1>
