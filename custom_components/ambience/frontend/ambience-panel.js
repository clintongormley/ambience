...
`;function rl(t){return t.kind==="entity"?`${t.entity_id} ${t.old} \u2192 ${t.new}`:t.detail?`${Re(t.kind)} ${t.detail}`:Re(t.kind)}function il(t){let n=t.params&&Object.keys(t.params).length?` ${JSON.stringify(t.params)}`:"";return`${t.service}${n}`}function nl(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function sl(t){return t.evaluated?l`
  ...
  `,u([m({attribute:!1})],Ce.prototype,"hass",2),u([g()],Ce.prototype,"_tab",2),Ce=u([$("ambience-settings-view")],Ce);var Te=class extends _{constructor(){super(...arguments);this._view="areas"}connectedCallback(){super.connectedCallback(),ce(this)}render(){return l`
      <header>
        <h1>
          ${Qr({dark:!!this.hass.themes?.darkMode,title:d(this.hass,"ui.panel_title","Ambience")})}
        </h1>
        <nav>
          <button
