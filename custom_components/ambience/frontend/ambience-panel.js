...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Sr=/'/g,Cr=/"/g,Pr=/^(?:script|style|textarea|title)$/i,Wt=t=>(n,...e)=>({_$litType$:t,strings:n,values:e}),l=Wt(1),No=Wt(2),Ro=Wt(3),_e=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),Tr=new WeakMap,ge=ve.createTreeWalker(ve,129);function Fr(t,n){if(!zt(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return xr!==void 0?xr.createHTML(n):n}var vn=(t,n)=>{let e=t.length-1,r=[],i,s=n===2?"<svg>":n===3?"<math>":"",a=je;for(let o=0;o<e;o++){let u=t[o],h,g,m=-1,v=0;for(;v<u.length&&(a.lastIndex=v,g=a.exec(u),g!==null);)v=a.lastIndex,a===je?g[1]==="!--"?a=kr:g[1]!==void 0?a=Er:g[2]!==void 0?(Pr.test(g[2])&&(i=RegExp("</"+g[2],"g")),a=fe):g[3]!==void 0&&(a=fe):a===fe?g[0]===">"?(a=i??je,m=-1):g[1]===void 0?m=-2:(m=a.lastIndex-g[2].length,h=g[1],a=g[3]===void 0?fe:g[3]==='"'?Cr:Sr):a===Cr||a===Sr?a=fe:a===kr||a===Er?a=je:(a=fe,i=void 0);let y=a===fe&&t[o+1].startsWith("/>")?" ":"";s+=a===je?u+fn:m>=0?(r.push(h),u.slice(0,m)+Lr+u.slice(m)+le+y):u+le+(m===-2?o:y)}return[Fr(t,s+(t[e]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),r]},Ue=class t{constructor({strings:n,_$litType$:e},r){let i;this.parts=[];let s=0,a=0,o=n.length-1,u=this.parts,[h,g]=vn(n,e);if(this.el=t.createElement(h,r),ge.currentNode=this.el.content,e===2||e===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(i=ge.nextNode())!==null&&u.length<o;){if(i.nodeType===1){if(i.hasAttributes())for(let m of i.getAttributeNames())if(m.endsWith(Lr)){let v=g[a++],y=i.getAttribute(m).split(le),k=/([.?@])?(.*)/.exec(v);u.push({type:1,index:s,name:k[2],strings:y,ctor:k[1]==="."?Mt:k[1]==="?"?Nt:k[1]==="@"?Rt:Te}),i.removeAttribute(m)}else m.startsWith(le)&&(u.push({type:6,index:s}),i.removeAttribute(m));if(Pr.test(i.tagName)){let m=i.textContent.split(le),v=m.length-1;if(v>0){i.textContent=at?at.emptyScript:"";for(let y=0;y<v;y++)i.append(m[y],ze()),ge.nextNode(),u.push({type:2,index:++s});i.append(m[v],ze())}}}else if(i.nodeType===8)if(i.data===Ar)u.push({type:2,index:s});else{let m=-1;for(;(m=i.data.indexOf(le,m+1))!==-1;)u.push({type:7,index:s}),m+=le.length-1}s++}}static createElement(n,e){let r=ve.createElement("template");return r.innerHTML=n,r}};function Ce(t,n,e=t,r){if(n===_e)return n;let i=r!==void 0?e._$Co?.[r]:e._$Cl,s=We(n)?void 0:n._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(t),i._$AT(t,e,r)),r!==void 0?(e._$Co??=[])[r]=i:e._$Cl=i),i!==void 0&&(n=Ce(t,i._$AS(t,n.values),i,r)),n}var Ot=class{constructor(n,e){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:e},parts:r}=this._$AD,i=(n?.creationScope??ve).importNode(e,!0);ge.currentNode=i;let s=ge.nextNode(),a=0,o=0,u=r[0];for(;u!==void 0;){if(a===u.index){let h;u.type===2?h=new Be(s,s.nextSibling,this,n):u.type===1?h=new u.ctor(s,u.name,u.strings,this,n):u.type===6&&(h=new It(s,this,n)),this._$AV.push(h),u=r[++o]}a!==u?.index&&(s=ge.nextNode(),a++)}return ge.currentNode=ve,i}p(n){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(n,r,e),e+=r.strings.length-2):r._$AI(n[e])),e++}},Be=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,e,r,i){this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=n,this._$AB=e,this._$AM=r,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,e=this._$AM;return e!==void 0&&n?.nodeType===11&&(n=e.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,e=this){n=Ce(this,n,e),We(n)?n===F||n==null||n===""?(this._$AH!==F&&this._$AR(),this._$AH=F):n!==this._$AH&&n!==_e&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):gn(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==F&&We(this._$AH)?this._$AA.nextSibling.data=n:this.T(ve.createTextNode(n)),this._$AH=n}$(n){let{values:e,_$litType$:r}=n,i=typeof r=="number"?this._$AC(n):(r.el===void 0&&(r.el=Ue.createElement(Fr(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===i)this._$AH.p(e);else{let s=new Ot(i,this),a=s.u(this.options);s.p(e),this.T(a),this._$AH=s}}_$AC(n){let e=Tr.get(n.strings);return e===void 0&&Tr.set(n.strings,e=new Ue(n)),e}k(n){zt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,i=0;for(let s of n)i===e.length?e.push(r=new t(this.O(ze()),this.O(ze()),this,this.options)):r=e[i],r._$AI(s),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(n=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);n!==this._$AB;){let r=wr(n).nextSibling;wr(n).remove(),n=r}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},Te=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,e,r,i,s){this.type=1,this._$AH=F,this._$AN=void 0,this.element=n,this.name=e,this._$AM=i,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=F}_$AI(n,e=this,r,i){let s=this.strings,a=!1;if(s===void 0)n=Ce(this,n,e,0),a=!We(n)||n!==this._$AH&&n!==_e,a&&(this._$AH=n);else{let o=n,u,h;for(n=s[0],u=0;u<s.length-1;u++)h=Ce(this,o[r+u],e,u),h===_e&&(h=this._$AH[u]),a||=!We(h)||h!==this._$AH[u],h===F?n=F:n!==F&&(n+=(h??"")+s[u+1]),this._$AH[u]=h}a&&!i&&this.j(n)}j(n){n===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},Mt=class extends Te{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===F?void 0:n}},Nt=class extends Te{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==F)}},Rt=class extends Te{constructor(n,e,r,i,s){super(n,e,r,i,s),this.type=5}_$AI(n,e=this){if((n=Ce(this,n,e,0)??F)===_e)return;let r=this._$AH,i=n===F&&r!==F||n.capture!==r.capture||n.once!==r.once||n.passive!==r.passive,s=n!==F&&(r===F||i);i&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},It=class{constructor(n,e,r){this.element=n,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(n){Ce(this,n)}};var _n=jt.litHtmlPolyfillSupport;_n?.(Ue,Be),(jt.litHtmlVersions??=[]).push("3.3.2");var Dr=(t,n,e)=>{let r=e?.renderBefore??n,i=r._$litPart$;if(i===void 0){let s=e?.renderBefore??null;r._$litPart$=i=new Be(n.insertBefore(ze(),s),s,void 0,e??{})}return i._$AI(t),i};var Ut=globalThis,_=class extends ee{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=Dr(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _e}};_._$litElement$=!0,_.finalized=!0,Ut.litElementHydrateSupport?.({LitElement:_});var yn=Ut.litElementPolyfillSupport;yn?.({LitElement:_});(Ut.litElementVersions??=[]).push("4.2.2");var $=t=>(n,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(t,n)}):customElements.define(t,n)};var bn={attribute:!0,type:String,converter:Ie,reflect:!1,hasChanged:st},$n=(t=bn,n,e)=>{let{kind:r,metadata:i}=e,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),r==="setter"&&((t=Object.create(t)).wrapped=!0),s.set(e.name,t),r==="accessor"){let{name:a}=e;return{set(o){let u=n.get.call(this);n.set.call(this,o),this.requestUpdate(a,u,t,!0,o)},init(o){return o!==void 0&&this.C(a,void 0,t,o),o}}}if(r==="setter"){let{name:a}=e;return function(o){let u=this[a];n.call(this,o),this.requestUpdate(a,u,t,!0,o)}}throw Error("Unsupported decorator location: "+r)};function p(t){return(n,e)=>typeof e=="object"?$n(t,n,e):((r,i,s)=>{let a=i.hasOwnProperty(s);return i.constructor.createProperty(s,r),a?Object.getOwnPropertyDescriptor(i,s):void 0})(t,n,e)}function f(t){return p({...t,state:!0,attribute:!1})}function G(t,n,e){let r=t?.localize?.(n);return r&&r!==n?r:e}function Bt(t){let n=t.replaceAll("_"," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}function Y(t,n){return G(t,`component.ambience.matcher.${n}`,Bt(n))}function lt(t,n){return G(t,`component.ambience.action.${n}`,Bt(n))}function Le(t,n){return G(t,`component.ambience.anchor.${n}`,Bt(n))}function ye(t,n,e){let r=e[n]?.label;if(r)return r;let i=n.charAt(0).toUpperCase()+n.slice(1);return G(t,`component.ambience.time_of_day_period.${n}`,i)}function d(t,n,e){return G(t,`component.ambience.${n}`,e)}var wn=["mon","tue","wed","thu","fri","sat","sun"],xn=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];function dt(t,n){return G(t,`component.ambience.weekday.${wn[n]}`,xn[n]??String(n))}var kn={weekday:"Day of week",day_of_month:"Day of month",date:"Date (annual)",date_range:"Date range (annual)",last_day:"Last day of month",workday:"Workday",holiday:"Holiday",first_workday:"First workday of month",last_workday:"Last workday of month"};function ut(t,n){return G(t,`component.ambience.day_item.${n}`,kn[n]??n)}var En=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ae(t,n){return G(t,`component.ambience.month.${n}`,En[n-1]??String(n))}var Sn={"clear-night":"Clear (night)",cloudy:"Cloudy",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning-rainy",partlycloudy:"Partly cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy-rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy (variant)",exceptional:"Exceptional"};function ct(t,n){return G(t,`component.ambience.weather_condition.${n}`,Sn[n]??n)}var Cn={temperature:"Temperature",apparent_temperature:"Apparent temperature",humidity:"Humidity",wind_speed:"Wind speed",pressure:"Pressure"};function qe(t,n){return G(t,`component.ambience.weather_attr.${n}`,Cn[n]??n)}var Tn={temperature:"\xB0C",apparent_temperature:"\xB0C",humidity:"%",wind_speed:"m/s",pressure:"hPa"},Ln={temperature:"temperature",apparent_temperature:"temperature",wind_speed:"wind_speed",pressure:"pressure"},An={temperature:"temperature_unit",apparent_temperature:"temperature_unit",wind_speed:"wind_speed_unit",pressure:"pressure_unit"};function qt(t,n,e){if(n==="humidity")return"%";let r=An[n];if(r){let a=e?.attributes?.[r];if(typeof a=="string"&&a)return a}let i=Ln[n],s=t?.config?.unit_system;return i&&s&&typeof s[i]=="string"?s[i]:Tn[n]??""}var Pn={is:"is",is_not:"is not",">":">",">=":"\u2265","<":"<","<=":"\u2264",and:"AND",or:"OR",and_not:"AND NOT",or_not:"OR NOT",not:"NOT"};function K(t,n){return G(t,`component.ambience.state_op.${n}`,Pn[n]??n)}var Fn=["ha-input","ha-textfield","ha-form"],Dn=["ha-input","ha-textfield"];function Hr(){for(let t of Dn)if(customElements.get(t))return t;return null}function V(t,n){for(let e of Fn)customElements.get(e)||customElements.whenDefined(e).then(()=>t.requestUpdate())}async function ht(t){return t.callWS({type:"ambience/areas/list"})}async function pt(t,n){return t.callWS({type:"ambience/area/get",area_id:n})}async function Or(t,n,e){return t.callWS({type:"ambience/area/save",area_id:n,config:e})}async function mt(t){return t.callWS({type:"ambience/floors/list"})}async function ft(t,n){return t.callWS({type:"ambience/floor/get",floor_id:n})}async function Mr(t,n,e){return t.callWS({type:"ambience/floor/save",floor_id:n,config:e})}async function gt(t){return t.callWS({type:"ambience/house/get"})}async function Nr(t,n){return t.callWS({type:"ambience/house/save",config:n})}async function vt(t){return t.callWS({type:"ambience/matchers/list"})}async function Ge(t){return t.callWS({type:"ambience/exposed_actions/list"})}async function Rr(t,n){return t.callWS({type:"ambience/exposed_actions/save",actions:n})}async function Ir(t){return t.callWS({type:"ambience/services/list"})}async function Pe(t,n){return t.callWS({type:"ambience/services/get_schema",service:n})}async function _t(t){return t.callWS({type:"ambience/time_of_day_periods/list"})}async function jr(t,n,e){return t.callWS({type:"ambience/time_of_day_periods/save",custom:n,hidden:e})}async function yt(t){return t.callWS({type:"ambience/matchers/day/config/list"})}async function zr(t,n,e){return t.callWS({type:"ambience/matchers/day/config/save",workday_sensor:n,workday_calendar:e})}async function bt(t){return t.callWS({type:"ambience/matchers/weather/config/list"})}async function Wr(t,n,e){return t.callWS({type:"ambience/matchers/weather/config/save",entity:n,groups:e})}async function Ur(t,n){return t.callWS({type:"ambience/state/known_states",entity_id:n})}async function Br(t){return t.callWS({type:"ambience/switch_defaults/list"})}async function Gt(t,n,e){return t.callWS({type:"ambience/switch_defaults/save",name:n,auto_on_delay_seconds:e})}async function qr(t,n,e){return t.callWS({type:"ambience/house/switch/save",name:n,auto_on_delay_seconds:e})}async function Gr(t,n,e,r){return t.callWS({type:"ambience/floor/switch/save",floor_id:n,name:e,auto_on_delay_seconds:r})}async function Yr(t,n,e,r){return t.callWS({type:"ambience/area/switch/save",area_id:n,name:e,auto_on_delay_seconds:r})}async function Kr(t,n,e,r){let i={type:"ambience/auto_triggers/set",scope_kind:n,enabled:r};return e!=null&&(i.scope_id=e),t.callWS(i)}async function Vr(t,n){return t.callWS({type:"ambience/script/referenced_entities",script:n})}async function Qr(t,n,e){let r={type:"ambience/auto_triggers/list",scope_kind:n};return e!=null&&(r.scope_id=e),t.callWS(r)}async function Jr(t,n,e,r,i){let s={type:"ambience/auto_triggers/set_trigger",scope_kind:n,key:r,enabled:i};return e!=null&&(s.scope_id=e),t.callWS(s)}function Jt(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return In(t)}function $t(t,n="New rule"){return t.name&&t.name.trim()?t.name:n}function Ye(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?xt(n,e):t==="day"?Nn(n,e):t==="weather"?zn(n,e):t==="sun"?Wn(n,e):t==="state"?Xt(n,e):t==="script"?On(n,e):t==="people"?Mn(n,e):t==="template"?Hn(n,e):String(n)}function Hn(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function On(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||t===null||typeof t.script!="string")return String(t);let e=t.args??{},r=Object.keys(e).sort();if(r.length===0)return t.script;let i=r.map(s=>`${s}=${e[s]}`).join(", ");return`${t.script}(${i})`}function Yt(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Xr(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):Yt(n,t)}function Mn(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=Yt(n,t.who[0]),u=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${u} ${Xr(e,n)}`;return t.for&&Vt(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${Qt(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),u=t.who.map(h=>Yt(n,h)).join(", ");r=`${o} (${u})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Xr(e,n)}`;return t.for&&Vt(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${Qt(t.for)}`:s}function Nn(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>Zr(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>Zr(a,n)).join(", ")})`}function Zr(t,n){switch(t.kind){case"weekday":return t.days.map(e=>dt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Ae(n.hass,t.month)} ${t.day}`;case"date_range":return`${Ae(n.hass,t.from.month)} ${t.from.day} \u2192 ${Ae(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Rn={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function In(t){let n=t.replaceAll("_"," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}function Ke(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}function wt(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function jn(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function zn(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??jn(a)).join("/"),i=(t.thresholds??[]).map(a=>`${qe(n.hass,a.attribute)} ${Rn[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function Wn(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function Un(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;return typeof r=="string"&&r?r:n}function Xt(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):Kt(t,n)}function Kt(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<="){let e=K(n.hass,t.kind),i=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.join("/"),s=Un(n,t.entity_id),o=`${t.attribute?`${s}.${t.attribute}`:s} ${e} ${i}`;return t.for&&Vt(t.for)?`${o} ${d(n.hass,"ui.for_prefix","for")} \u2265${Qt(t.for)}`:o}if(t.kind==="and"||t.kind==="or"){let e=` ${K(n.hass,t.kind)} `;return t.items.map(r=>ei(r,n)).join(e)}return t.kind==="not"?`${K(n.hass,"not")} ${ei(t.item,n)}`:""}function ei(t,n){return t.kind==="and"||t.kind==="or"?`(${Kt(t,n)})`:Kt(t,n)}function Vt(t){return t.h>0||t.m>0||t.s>0}function Qt(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function xt(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ye(n.hass,i.period,r):`${ti(i.from,n)} \u2192 ${ti(i.to,n)}`).join(", ")}function ti(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Le(n.hass,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${r}${d(n.hass,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}function Bn(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label&&e.label.trim()?e.label:lt(n.hass,t.service)}function qn(t,n){let e=t.service.indexOf(".");return e>0?t.service.slice(0,e):d(n.hass,"ui.target_noun","target")}function ri(t,n){let e=Bn(t,n),r=qn(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,u])=>`${Jt(o,t.service,n.schemas)}: ${Ke(u)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var H=class extends _{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this.availableActions=[];this.schemas={};this._dragFrom=null;this._dragOver=null;this._expanded=new Set}_emit(e,r){this.dispatchEvent(new CustomEvent(e,{detail:r,bubbles:!0,composed:!0}))}_whenKeys(e){let r=new Map((this.matchers??[]).map(i=>[i.name,i.priority]));return Object.keys(e.when).filter(i=>e.when[i]!=null).sort((i,s)=>(r.get(i)??1/0)-(r.get(s)??1/0))}_whenSummary(e){let r=this._whenKeys(e);return r.length===0?d(this.hass,"ui.summary_any","any"):r.map((i,s)=>{let a=Y(this.hass,i),o=Ye(i,e.when[i],{hass:this.hass,periods:this.periods,weatherGroups:this.weatherConfig?.groups});return l`${s===0?"":", "}<strong>${a}:</strong> ${o}`})}_whenStacked(e){let r=this._whenKeys(e);return r.length===0?l`<div class="matcher-line">${d(this.hass,"ui.summary_any","any")}</div>`:r.map(i=>{let s=Y(this.hass,i),a=Ye(i,e.when[i],{hass:this.hass,periods:this.periods,weatherGroups:this.weatherConfig?.groups});return l`<div class="matcher-line"><strong>${s}:</strong> ${a}</div>`})}_actionCountLabel(e){let r=e.actions.length,i=r===1?d(this.hass,"ui.action_singular","action"):d(this.hass,"ui.action_plural","actions");return`${r} ${i}`}_toggleRule(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_entityName(e){let i=this.hass?.states?.[e]?.attributes?.friendly_name;return typeof i=="string"&&i?i:e}_actionParamsString(e){return Object.entries(e.params).filter(([,r])=>r!=null&&r!=="").map(([r,i])=>`${Jt(r,e.service,this.schemas)}: ${Ke(i)}`).join(", ")}_actionLabel(e){let r=this.availableActions.find(i=>i.id===e.service);return r?.label&&r.label.trim()?r.label:lt(this.hass,e.service)}_onDragStart(e){this._dragFrom=e}_onDragOver(e,r){this._dragFrom===null||r===this._dragFrom||(e.preventDefault(),this._dragOver=r)}_onDrop(e){let r=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(r===null||r===e)&&this._emit("reorder-rules",{from:r,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,r){let i=r.name||d(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(e+1));window.confirm(d(this.hass,"ui.confirm_delete",'Delete "{name}"?').replace("{name}",i))&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
  ...
  `,c([p({attribute:!1})],N.prototype,"hass",2),c([p({attribute:!1})],N.prototype,"scope",2),c([p({attribute:!1})],N.prototype,"exposed",2),c([p({attribute:!1})],N.prototype,"entityIds",2),c([p({attribute:!1})],N.prototype,"params",2),c([f()],N.prototype,"_schema",2),c([f()],N.prototype,"_schemaError",2),c([f()],N.prototype,"_exposedMissing",2),c([f()],N.prototype,"_formSchema",2),c([f()],N.prototype,"_perFieldSchemas",2),N=c([$("ambience-action-slot")],N);var J=class extends _{constructor(){super(...arguments);this.value=null;this.suggestions=[];this._schema=[];this._open=!1;this._onDocMousedown=e=>{this._open&&(e.composedPath().includes(this)||(this._open=!1))};this._onHaFormValueChanged=e=>{e.stopPropagation();let r=e.detail.value?.scene??"";this._emit(r.trim()===""?null:r)};this._sceneComputeLabel=e=>e.name==="scene"?d(this.hass,"ui.scene_name","Scene name"):e.name}connectedCallback(){super.connectedCallback(),V(this,this.hass),document.addEventListener("mousedown",this._onDocMousedown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onDocMousedown)}willUpdate(e){e.has("suggestions")&&(this._schema=[{name:"scene",selector:{select:{options:this.suggestions.map(r=>({value:r,label:r})),custom_value:!0,mode:"dropdown"}}}])}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onInput(e){let r=e.target.value;this._emit(r.trim()===""?null:r),this._open=!0}_onFocus(){this._open=!0}_onKeyDown(e){e.key==="Escape"&&this._open&&(this._open=!1,e.stopPropagation())}_toggle(e){e.preventDefault(),this._open=!this._open}_select(e,r){r.preventDefault(),this._emit(e),this._open=!1}render(){if(customElements.get("ha-form")){let e={scene:this.value??""};return l`
        <ha-form
          .hass=${this.hass}
          .schema=${this._schema}
          .data=${e}
...
`:""}var po=ho,mo={dump:po};function cr(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Gi=Hi.load,sd=Hi.loadAll,At=mo.dump;var ad=cr("safeLoad","load"),od=cr("safeLoadAll","loadAll"),ld=cr("safeDump","dump");var z=class extends _{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._suggested=[];this._suggestedFor=null}willUpdate(e){if(super.willUpdate?.(e),e.has("value")){this._mode==="form"&&(this._yamlText=At(this.value??{}));let r=this.value&&typeof this.value=="object"?this.value.script:null;this._loadSuggestions(r)}}connectedCallback(){super.connectedCallback(),this._yamlText=At(this.value??{});let e=this.value&&typeof this.value=="object"?this.value.script:null,r=this._fieldsFor(e);e&&(!r||Object.keys(r).length===0)&&(this._mode="yaml");let i=this.value&&typeof this.value=="object"?this.value.script:null;this._loadSuggestions(i)}async _loadSuggestions(e){if(e!==this._suggestedFor&&(this._suggestedFor=e,this._suggested=[],!(!e||!this.hass)))try{let{entities:r}=await Vr(this.hass,e);this._suggestedFor===e&&(this._suggested=r)}catch{}}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=At(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Gi(e)}catch(u){this._yamlError=u.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(u=>typeof u=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){let i=this.hass?.states?.[e]?.attributes?.friendly_name;return typeof i=="string"&&i?i:e}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.prototype.hasOwnProperty.call(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._fieldsFor(this.value&&typeof this.value=="object"?this.value.script:null);return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,description:i.description?{suffix:i.description}:void 0,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}render(){let e=this.value&&typeof this.value=="object"?this.value.script:null,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,c([p({attribute:!1})],U.prototype,"matcher",2),c([p({attribute:!1})],U.prototype,"value",2),c([p({attribute:!1})],U.prototype,"sceneSuggestions",2),c([p({attribute:!1})],U.prototype,"periods",2),c([p({attribute:!1})],U.prototype,"dayConfig",2),c([p({attribute:!1})],U.prototype,"weatherConfig",2),c([p({attribute:!1})],U.prototype,"hass",2),U=c([$("ambience-matcher-input")],U);function xo(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function ko(t){return t==="people"?{quant:"everyone",where:"home"}:null}var C=class extends _{constructor(){super(...arguments);this.open=!1;this.rule=null;this.matchers=[];this.sceneSuggestions=[];this.availableActions=[];this.schemas={};this._draft=null;this._open=null;this._showError=!1;this._serviceHasTarget=new Map;this._matcherError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onAddMatcher=e=>{let r=e.target,i=r.value;r.value="",this._addMatcher(i)};this._onAddMatcherHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==C._ADD_MATCHER_PLACEHOLDER&&this._addMatcher(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==C._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onMatcherInvalid(e,r){r?this._matcherError.set(e,r):this._matcherError.delete(e)}connectedCallback(){super.connectedCallback(),V(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._open=null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_renderNameSlot(){let e=this._draft.name??"";if(this._isOpen({kind:"name"}))return l`
    ...
    `}_updateActionAt(e,r){if(!this._draft)return;let i=this._draft.actions.map((s,a)=>a===e?r(s):s);this._draft={...this._draft,actions:i}}_deleteAction(e){this._draft&&(this._draft={...this._draft,actions:this._draft.actions.filter((r,i)=>i!==e)},this._open?.kind==="action"&&this._open.idx===e&&(this._open=null))}_setActionTargets(e,r){this._updateActionAt(e,i=>({...i,entity_ids:r}))}_setActionParams(e,r){this._updateActionAt(e,i=>({...i,params:r}))}_onTargetModeChanged(e,r){this._serviceHasTarget.get(e)!==r&&(this._serviceHasTarget=new Map(this._serviceHasTarget).set(e,r))}_reapplyMode(e){return"reapply_seconds"in e?e.reapply_seconds===0?"off":"custom":"inherit"}_effectiveReapplySeconds(e){return"reapply_seconds"in e?e.reapply_seconds??0:this.availableActions.find(i=>i.id===e.service)?.reapply_seconds??0}_setReapplyMode(e,r){this._updateActionAt(e,i=>{if(r==="inherit"){let{reapply_seconds:a,...o}=i;return o}if(r==="off")return{...i,reapply_seconds:0};let s=typeof i.reapply_seconds=="number"&&i.reapply_seconds>0?i.reapply_seconds:60;return{...i,reapply_seconds:s}})}_setReapplyMinutes(e,r){let i=Number(r);!r.trim()||isNaN(i)||i<1||this._updateActionAt(e,s=>({...s,reapply_seconds:Math.round(i)*60}))}_renderReapplyOverride(e,r){let i=this._reapplyMode(e),a=this.availableActions.find(u=>u.id===e.service)?.reapply_seconds??0,o=i==="custom"&&e.reapply_seconds?String(Math.round(e.reapply_seconds/60)):"1";return l`
      <div class="reapply-override">
        <label>${d(this.hass,"ui.reapply_override_label","Re-apply:")}</label>
        <select
          data-reapply-mode
          .value=${i}
        ...
        ${i==="inherit"&&a>0?l`
          <span class="reapply-inherit-hint" data-reapply-inherit-hint>
            ${d(this.hass,"ui.reapply_inherit_hint",`Inherits: every ${Math.round(a/60)} min`)}
          </span>
        `:""}
      </div>
    `}_renderActionRow(e,r){let i=this.availableActions.find(h=>h.id===e.service),s=this._isOpen({kind:"action",idx:r}),a=ri(e,{hass:this.hass,exposedActions:this.availableActions,schemas:this.schemas}),o=this._effectiveReapplySeconds(e),u=o>0;return l`
      <div class="slot ${s?"expanded":"collapsed"}" data-slot-id="action-${r}">
        <div class="summary" @click=${()=>this._toggleSlot({kind:"action",idx:r})}>
          ...
          ${u?l`<span class="reapply-badge" data-reapply-badge>↺ ${Math.round(o/60)} min</span>`:""}
  ...
  `,c([p({attribute:!1})],me.prototype,"hass",2),c([f()],me.prototype,"_matchers",2),c([f()],me.prototype,"_error",2),me=c([$("ambience-matchers-settings")],me);function Po(t){let n=t.indexOf("."),e=n===-1?"":t.slice(0,n),i=(n===-1?t:t.slice(n+1)).replaceAll("_"," ").trim().toLowerCase(),s=e.replaceAll("_"," ").trim().toLowerCase(),a=i?i.split(" "):[],o=s?s.split(" "):[],u=o.length>0&&o.every(g=>a.includes(g)),h=!s||u?i:`${i} ${s}`;return h.charAt(0).toUpperCase()+h.slice(1)}var T=class extends _{constructor(){super(...arguments);this._actions=[];this._services=[];this._schemas={};this._fieldSchemas={};this._addSchema=[];this._serviceById=new Map;this._availableServices=[];this._expanded=new Set;this._adding=!1;this._warnings=[];this._loadError=null;this._saveError=null;this._loaded=!1;this._editingDefault=null;this._editingOriginalValue=void 0;this._editingOriginalHad=!1;this._dragFrom=null;this._dragOver=null;this._onDocPointerDown=e=>{let r=e.composedPath();this._collapseAddFormOnClickAway(r),this._cancelEditingDefaultOnClickAway(r)}}_collapseAddFormOnClickAway(e){if(!this._adding)return;let r=this.shadowRoot?.querySelector(".add-row"),i=!!r&&e.includes(r),s=e.some(a=>a instanceof Element&&T._OVERLAY_TAG_RE.test(a.localName));!i&&!s&&(this._adding=!1)}_cancelEditingDefaultOnClickAway(e){if(this._editingDefault===null)return;let r=this.shadowRoot?.querySelector(`.field-row-editor[data-editing-key="${this._editingDefault}"]`);(!r||!e.includes(r))&&this._cancelEditingDefault()}connectedCallback(){super.connectedCallback(),document.addEventListener("pointerdown",this._onDocPointerDown),customElements.get("ha-service-picker")||customElements.whenDefined("ha-service-picker").then(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerdown",this._onDocPointerDown)}_startEditingDefault(e,r){let s=this._actions.find(a=>a.id===e)?.defaults??{};this._editingOriginalHad=r in s,this._editingOriginalValue=s[r],this._editingDefault=`${e}:${r}`}_saveEditingDefault(){this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1,this._autoSave()}_cancelEditingDefault(){let e=this._editingDefault;if(e){let r=e.indexOf(":"),i=e.slice(0,r),s=e.slice(r+1);this._actions=this._actions.map(a=>{if(a.id!==i)return a;let o={...a.defaults??{}};return this._editingOriginalHad?o[s]=this._editingOriginalValue:delete o[s],{...a,defaults:o}})}this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}async firstUpdated(){await this._reload()}willUpdate(e){if(e.has("_actions")||e.has("_schemas")){let r={};for(let i of this._actions){let s=this._schemas[i.id];if(s)for(let[a,o]of Object.entries(s.fields))r[`${i.id}:${a}`]=[{name:a,selector:o.selector??{text:{}},required:!1}]}this._fieldSchemas=r}if(e.has("_services")&&(this._serviceById=new Map(this._services.map(r=>[r.id,r]))),e.has("_actions")||e.has("_services")){let r=new Set(this._actions.map(i=>i.id));this._availableServices=this._services.filter(i=>!r.has(i.id)),this._addSchema=[{name:"service",selector:{select:{options:this._availableServices.map(i=>({value:i.id,label:this._addOptionLabel(i.id)})),custom_value:!0,mode:"dropdown",sort:!0}}}]}}async _reload(){this._loadError=null;try{let[e,r]=await Promise.all([Ge(this.hass),Ir(this.hass)]);this._actions=e,this._services=r}catch(e){this._loadError=e instanceof Error?e.message:String(e);return}await Promise.all(this._actions.map(e=>this._ensureSchema(e.id))),this._loaded=!0}async _ensureSchema(e){if(!(e in this._schemas))try{let r=await Pe(this.hass,e);this._schemas={...this._schemas,[e]:r}}catch{this._schemas={...this._schemas,[e]:null}}}_setShowInEditor(e,r,i){this._actions=this._actions.map(s=>{if(s.id!==e)return s;let a=new Set(s.visible_fields??[]);return i?a.add(r):a.delete(r),{...s,visible_fields:[...a]}}),this._autoSave()}_setDefault(e,r,i){this._actions=this._actions.map(s=>s.id!==e?s:{...s,defaults:{...s.defaults??{},[r]:i}})}_clearDefault(e,r){this._actions=this._actions.map(i=>{if(i.id!==e)return i;let s={...i.defaults??{}};return delete s[r],{...i,defaults:s}})}_setLabel(e,r){this._actions=this._actions.map(i=>i.id===e?{...i,label:r}:i)}_setReapplyMinutes(e,r){let i=r.trim()===""?NaN:Number(r);this._actions=this._actions.map(s=>{if(s.id!==e)return s;if(isNaN(i)||r.trim()===""){let{reapply_seconds:a,...o}=s;return o}return{...s,reapply_seconds:Math.max(1,Math.round(i))*60}}),this._autoSave()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):(r.add(e),this._ensureSchema(e)),this._expanded=r}async _addService(e){e&&this._services.some(r=>r.id===e)&&(this._actions.some(r=>r.id===e)||(await this._ensureSchema(e),this._actions=[...this._actions,{id:e,label:this._labelForService(e),visible_fields:[],defaults:{}}],this._expanded=new Set([...this._expanded,e]),this._adding=!1,this._autoSave()))}_onDragStart(e,r){this._dragFrom=r;let s=e.currentTarget.closest(".card");s&&e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setDragImage(s,16,16))}_onDragOver(e,r){this._dragFrom===null||r===this._dragFrom||(e.preventDefault(),this._dragOver=r)}_onDrop(e){let r=this._dragFrom;if(this._dragFrom=null,this._dragOver=null,r===null||r===e)return;let i=[...this._actions],[s]=i.splice(r,1);i.splice(e,0,s),this._actions=i,this._autoSave()}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_removeService(e){this._actions=this._actions.filter(i=>i.id!==e);let r=new Set(this._expanded);r.delete(e),this._expanded=r,this._autoSave()}async _autoSave(){this._saveError=null,this._warnings=[];try{let e=await Rr(this.hass,this._actions);this._warnings=e.warnings??[],window.dispatchEvent(new CustomEvent("ambience-exposed-actions-changed"))}catch(e){this._saveError=e instanceof Error?e.message:String(e)}}render(){return this._loadError!==null?l`
    ...
    />`}_renderReapplyRow(e){let r=typeof e.reapply_seconds=="number"&&e.reapply_seconds>0?String(Math.round(e.reapply_seconds/60)):"";return l`
