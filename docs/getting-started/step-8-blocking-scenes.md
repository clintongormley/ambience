...
![Blocking scene.](../images/getting-started/step-8/blocking_scene.png "Blocking scene.")
...
![Blocking order.](../images/getting-started/step-8/blocking_order.png "Blocking order.")
...
![Grey dot shows last-applied actions.](../images/getting-started/step-8/grey_dot.png "Grey dot shows last-applied actions.")
...
![Trace of blocking scenes.](../images/getting-started/step-8/traces.png "Trace of blocking scenes.")
