...
`;function Tt(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return st(t)}function fr(t,n="New scene"){return t.name?.trim()?t.name:n}function Lt(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?_r(n,e):t==="day"?Va(n,e):t==="weather"?Xa(n,e):t==="sun"?Za(n,e):t==="state"?li(n,e):t==="script"?Ba(n,e):t==="people"?qa(n,e):t==="occupancy"?eo(n,e):t==="lux"?to(n,e):t==="template"?Ua(n,e):String(n)}function Ua(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function Ba(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=Ct(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(a=>`${si(n.hass,t.script,a)}: ${we(n.hass,r[a])}`).join(", ");return`${e} (${s})`}function si(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:st(e)}function Ct(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Mn(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):Ct(n,t)}function qa(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=Ct(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${c} ${Mn(e,n)}`;return t.for&&pr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>Ct(n,h)).join(", ");r=`${o} (${c})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Mn(e,n)}`;return t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function Va(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>jn(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>jn(a,n)).join(", ")})`}function jn(t,n){switch(t.kind){case"weekday":return t.days.map(e=>Xt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Ze(n.hass,t.month)} ${t.day}`;case"date_range":return`${Ze(n.hass,t.from.month)} ${t.from.day} \u2192 ${Ze(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Ka={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function st(t){return _e(t)}function Ya(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var Ga=["entity_id","device_id","area_id","label_id","floor_id"],zn=2;function Qa(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>Ga.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function we(t,n){let e=Qa(n);if(!e)return Ya(n);let r=e.slice(0,zn).map(a=>Ct({hass:t},a)),i=e.length-zn;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function gr(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function Ja(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function Xa(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??Ja(a)).join("/"),i=(t.thresholds??[]).map(a=>`${bt(n.hass,a.attribute)} ${Ka[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function Za(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function qn(t,n){return N(t.hass,n)}function ai(t,n){return qn({hass:t},n)}function eo(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(a=>N(n.hass,a)),r=t.occupied===!1?d(n.hass,"occupancy_summary.clear","clear"):d(n.hass,"occupancy_summary.detected","detected"),i=t.negate?`${d(n.hass,"occupancy_summary.not","not")} `:"",s;return e.length===1?s=`${e[0]} is ${i}${r}`:s=`${t.quant==="all"?d(n.hass,"occupancy_summary.all_of","all of"):d(n.hass,"occupancy_summary.any_of","any of")} (${e.join(", ")}) ${i}${r}`,t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function oi(t,n,e="any lux"){return t!=null&&n!=null?`${t}\u2013${n} lx`:n!=null?`<${n} lx`:t!=null?`\u2265${t} lx`:e}function to(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(s=>N(n.hass,s)),r=t.range!=null?Xe(n.hass,t.range,n.luxRanges?.custom??{}):oi(t.min,t.max);return e.length===1?`${e[0]} ${r}`:`${t.quant==="all"?d(n.hass,"lux_summary.all_of","all of"):d(n.hass,"lux_summary.any_of","any of")} (${e.join(", ")}) ${r}`}function li(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):ni(t,n)}function Wn(t,n,e){let r=J(n.hass,t.kind),i=qn(n,t.entity_id),s=n.hass?.states?.[t.entity_id],o=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.map(f=>Je(n.hass,s,t.attribute,f)).join("/"),c=t.attribute?`${i}.${Qt(n.hass,s,t.attribute)}`:i,h=e?`${J(n.hass,"not")} `:"",p=`${c} ${r} ${h}${o}`;return t.for&&pr(t.for)?`${p} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:p}function ni(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return Wn(t,n,!1);if(t.kind==="and"||t.kind==="or"){let e=` ${J(n.hass,t.kind)} `;return t.items.map(r=>Un(r,n)).join(e)}if(t.kind==="not"){let e=t.item;return e.kind==="is"?Wn(e,n,!0):`${J(n.hass,"not")} ${Un(e,n)}`}return""}function Un(t,n){return t.kind==="and"||t.kind==="or"?`(${ni(t,n)})`:ni(t,n)}function pr(t){return t.h>0||t.m>0||t.s>0}function mr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function _r(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ye(n.hass,i.period,r):`${Bn(i.from,n)} \u2192 ${Bn(i.to,n)}`).join(", ")}function Bn(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=ve(n.hass,t.anchor),r=e;if(t.offset_min!==0){let i=Math.abs(t.offset_min),s=i%60===0?`${i/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${i}${d(n.hass,"ui.unit_min_abbr","m")}`;r=`${e}${t.offset_min<0?"-":"+"}${s}`}if(t.clamp){let i=t.clamp.dir==="not_before"?d(n.hass,"ui.clamp_not_before","not before"):d(n.hass,"ui.clamp_not_after","not after"),s=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;r=`${r} (${i} ${s})`}return r}function ro(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label?.trim()?e.label:Jt(n.hass,t.service)}function io(t,n){let e=new Set;for(let r of t.entity_ids){let i=r.indexOf(".");i>0&&e.add(r.slice(0,i))}return e.size===1?[...e][0]:d(n.hass,"ui.target_noun","target")}function Vn(t,n){let e=ro(t,n),r=io(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,c])=>`${Tt(o,t.service,n.schemas)}: ${we(n.hass,c)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var F=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this._drag=new nt(this,(e,r)=>this._emit("reorder-scenes",{from:e,to:r}));this._expanded=new Set}_renderSectionHeader(e){return l`<div
  ...
  `,u([m({attribute:!1})],I.prototype,"hass",2),u([m({attribute:!1})],I.prototype,"scope",2),u([m({attribute:!1})],I.prototype,"exposed",2),u([m({attribute:!1})],I.prototype,"entityIds",2),u([m({attribute:!1})],I.prototype,"params",2),u([m({attribute:!1})],I.prototype,"excludeEntities",2),u([g()],I.prototype,"_schema",2),u([g()],I.prototype,"_schemaError",2),u([g()],I.prototype,"_exposedMissing",2),u([g()],I.prototype,"_formSchema",2),u([g()],I.prototype,"_perFieldSchemas",2),I=u([x("ambience-action-slot")],I);function ps(t){return typeof t>"u"||t===null}function no(t){return typeof t=="object"&&t!==null}function so(t){return Array.isArray(t)?t:ps(t)?[]:[t]}function ao(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function oo(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function lo(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var co=ps,uo=no,ho=so,po=oo,mo=lo,fo=ao,H={isNothing:co,isObject:uo,toArray:ho,repeat:po,isNegativeZero:mo,extend:fo};function ms(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`

`+t.mark.snippet),r+" "+e):r}function Pt(t,n){Error.call(this),this.name="YAMLException",this.reason=t,this.mark=n,this.message=ms(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Pt.prototype=Object.create(Error.prototype);Pt.prototype.constructor=Pt;Pt.prototype.toString=function(n){return this.name+": "+ms(this,n)};var q=Pt;function di(t,n,e,r,i){var s="",a="",o=Math.floor(i/2)-1;return r-n>o&&(s=" ... ",n=r-o+s.length),e-r>o&&(a=" ...",e=r+o-a.length),{str:s+t.slice(n,e).replace(/\t/g,"\u2192")+a,pos:r-n+s.length}}function ci(t,n){return H.repeat(" ",n-t.length)+t}function go(t,n){if(n=Object.create(n||null),!t.buffer)return null;n.maxLength||(n.maxLength=79),typeof n.indent!="number"&&(n.indent=1),typeof n.linesBefore!="number"&&(n.linesBefore=3),typeof n.linesAfter!="number"&&(n.linesAfter=2);for(var e=/\r?\n|\r|\0/g,r=[0],i=[],s,a=-1;s=e.exec(t.buffer);)i.push(s.index),r.push(s.index+s[0].length),t.position<=s.index&&a<0&&(a=r.length-2);a<0&&(a=r.length-1);var o="",c,h,p=Math.min(t.line+n.linesAfter,i.length).toString().length,f=n.maxLength-(n.indent+p+3);for(c=1;c<=n.linesBefore&&!(a-c<0);c++)h=di(t.buffer,r[a-c],i[a-c],t.position-(r[a]-r[a-c]),f),o=H.repeat(" ",n.indent)+ci((t.line-c+1).toString(),p)+" | "+h.str+`
...
`;return o.replace(/\n$/,"")}var _o=go,vo=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],yo=["scalar","sequence","mapping"];function bo(t){var n={};return t!==null&&Object.keys(t).forEach(function(e){t[e].forEach(function(r){n[String(r)]=e})}),n}function xo(t,n){if(n=n||{},Object.keys(n).forEach(function(e){if(vo.indexOf(e)===-1)throw new q('Unknown option "'+e+'" is met in definition of "'+t+'" YAML type.')}),this.options=n,this.tag=t,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(e){return e},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.representName=n.representName||null,this.defaultStyle=n.defaultStyle||null,this.multi=n.multi||!1,this.styleAliases=bo(n.styleAliases||null),yo.indexOf(this.kind)===-1)throw new q('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var M=xo;function Xn(t,n){var e=[];return t[n].forEach(function(r){var i=e.length;e.forEach(function(s,a){s.tag===r.tag&&s.kind===r.kind&&s.multi===r.multi&&(i=a)}),e[i]=r}),e}function wo(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},n,e;function r(i){i.multi?(t.multi[i.kind].push(i),t.multi.fallback.push(i)):t[i.kind][i.tag]=t.fallback[i.tag]=i}for(n=0,e=arguments.length;n<e;n+=1)arguments[n].forEach(r);return t}function hi(t){return this.extend(t)}hi.prototype.extend=function(n){var e=[],r=[];if(n instanceof M)r.push(n);else if(Array.isArray(n))r=r.concat(n);else if(n&&(Array.isArray(n.implicit)||Array.isArray(n.explicit)))n.implicit&&(e=e.concat(n.implicit)),n.explicit&&(r=r.concat(n.explicit));else throw new q("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.forEach(function(s){if(!(s instanceof M))throw new q("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new q("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new q("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),r.forEach(function(s){if(!(s instanceof M))throw new q("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var i=Object.create(hi.prototype);return i.implicit=(this.implicit||[]).concat(e),i.explicit=(this.explicit||[]).concat(r),i.compiledImplicit=Xn(i,"implicit"),i.compiledExplicit=Xn(i,"explicit"),i.compiledTypeMap=wo(i.compiledImplicit,i.compiledExplicit),i};var $o=hi,ko=new M("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),Eo=new M("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),So=new M("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),Co=new $o({explicit:[ko,Eo,So]});function To(t){if(t===null)return!0;var n=t.length;return n===1&&t==="~"||n===4&&(t==="null"||t==="Null"||t==="NULL")}function Lo(){return null}function Ro(t){return t===null}var Po=new M("tag:yaml.org,2002:null",{kind:"scalar",resolve:To,construct:Lo,predicate:Ro,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Do(t){if(t===null)return!1;var n=t.length;return n===4&&(t==="true"||t==="True"||t==="TRUE")||n===5&&(t==="false"||t==="False"||t==="FALSE")}function Ao(t){return t==="true"||t==="True"||t==="TRUE"}function Ho(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var Oo=new M("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Do,construct:Ao,predicate:Ho,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function No(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function Fo(t){return 48<=t&&t<=55}function Io(t){return 48<=t&&t<=57}function Mo(t){if(t===null)return!1;var n=t.length,e=0,r=!1,i;if(!n)return!1;if(i=t[e],(i==="-"||i==="+")&&(i=t[++e]),i==="0"){if(e+1===n)return!0;if(i=t[++e],i==="b"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(i!=="0"&&i!=="1")return!1;r=!0}return r&&i!=="_"}if(i==="x"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(!No(t.charCodeAt(e)))return!1;r=!0}return r&&i!=="_"}if(i==="o"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(!Fo(t.charCodeAt(e)))return!1;r=!0}return r&&i!=="_"}}if(i==="_")return!1;for(;e<n;e++)if(i=t[e],i!=="_"){if(!Io(t.charCodeAt(e)))return!1;r=!0}return!(!r||i==="_")}function jo(t){var n=t,e=1,r;if(n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),r=n[0],(r==="-"||r==="+")&&(r==="-"&&(e=-1),n=n.slice(1),r=n[0]),n==="0")return 0;if(r==="0"){if(n[1]==="b")return e*parseInt(n.slice(2),2);if(n[1]==="x")return e*parseInt(n.slice(2),16);if(n[1]==="o")return e*parseInt(n.slice(2),8)}return e*parseInt(n,10)}function zo(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!H.isNegativeZero(t)}var Wo=new M("tag:yaml.org,2002:int",{kind:"scalar",resolve:Mo,construct:jo,predicate:zo,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Uo=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Bo(t){return!(t===null||!Uo.test(t)||t[t.length-1]==="_")}function qo(t){var n,e;return n=t.replace(/_/g,"").toLowerCase(),e=n[0]==="-"?-1:1,"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?e===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:e*parseFloat(n,10)}var Vo=/^[-+]?[0-9]+e/;function Ko(t,n){var e;if(isNaN(t))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(H.isNegativeZero(t))return"-0.0";return e=t.toString(10),Vo.test(e)?e.replace("e",".e"):e}function Yo(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||H.isNegativeZero(t))}var Go=new M("tag:yaml.org,2002:float",{kind:"scalar",resolve:Bo,construct:qo,predicate:Yo,represent:Ko,defaultStyle:"lowercase"}),Qo=Co.extend({implicit:[Po,Oo,Wo,Go]}),Jo=Qo,fs=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),gs=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Xo(t){return t===null?!1:fs.exec(t)!==null||gs.exec(t)!==null}function Zo(t){var n,e,r,i,s,a,o,c=0,h=null,p,f,_;if(n=fs.exec(t),n===null&&(n=gs.exec(t)),n===null)throw new Error("Date resolve error");if(e=+n[1],r=+n[2]-1,i=+n[3],!n[4])return new Date(Date.UTC(e,r,i));if(s=+n[4],a=+n[5],o=+n[6],n[7]){for(c=n[7].slice(0,3);c.length<3;)c+="0";c=+c}return n[9]&&(p=+n[10],f=+(n[11]||0),h=(p*60+f)*6e4,n[9]==="-"&&(h=-h)),_=new Date(Date.UTC(e,r,i,s,a,o,c)),h&&_.setTime(_.getTime()-h),_}function el(t){return t.toISOString()}var tl=new M("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Xo,construct:Zo,instanceOf:Date,represent:el});function rl(t){return t==="<<"||t===null}var il=new M("tag:yaml.org,2002:merge",{kind:"scalar",resolve:rl}),_i=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function nl(t){if(t===null)return!1;var n,e,r=0,i=t.length,s=_i;for(e=0;e<i;e++)if(n=s.indexOf(t.charAt(e)),!(n>64)){if(n<0)return!1;r+=6}return r%8===0}function sl(t){var n,e,r=t.replace(/[\r\n=]/g,""),i=r.length,s=_i,a=0,o=[];for(n=0;n<i;n++)n%4===0&&n&&(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)),a=a<<6|s.indexOf(r.charAt(n));return e=i%4*6,e===0?(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)):e===18?(o.push(a>>10&255),o.push(a>>2&255)):e===12&&o.push(a>>4&255),new Uint8Array(o)}function al(t){var n="",e=0,r,i,s=t.length,a=_i;for(r=0;r<s;r++)r%3===0&&r&&(n+=a[e>>18&63],n+=a[e>>12&63],n+=a[e>>6&63],n+=a[e&63]),e=(e<<8)+t[r];return i=s%3,i===0?(n+=a[e>>18&63],n+=a[e>>12&63],n+=a[e>>6&63],n+=a[e&63]):i===2?(n+=a[e>>10&63],n+=a[e>>4&63],n+=a[e<<2&63],n+=a[64]):i===1&&(n+=a[e>>2&63],n+=a[e<<4&63],n+=a[64],n+=a[64]),n}function ol(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var ll=new M("tag:yaml.org,2002:binary",{kind:"scalar",resolve:nl,construct:sl,predicate:ol,represent:al}),dl=Object.prototype.hasOwnProperty,cl=Object.prototype.toString;function ul(t){if(t===null)return!0;var n=[],e,r,i,s,a,o=t;for(e=0,r=o.length;e<r;e+=1){if(i=o[e],a=!1,cl.call(i)!=="[object Object]")return!1;for(s in i)if(dl.call(i,s))if(!a)a=!0;else return!1;if(!a)return!1;if(n.indexOf(s)===-1)n.push(s);else return!1}return!0}function hl(t){return t!==null?t:[]}var pl=new M("tag:yaml.org,2002:omap",{kind:"sequence",resolve:ul,construct:hl}),ml=Object.prototype.toString;function fl(t){if(t===null)return!0;var n,e,r,i,s,a=t;for(s=new Array(a.length),n=0,e=a.length;n<e;n+=1){if(r=a[n],ml.call(r)!=="[object Object]"||(i=Object.keys(r),i.length!==1))return!1;s[n]=[i[0],r[i[0]]]}return!0}function gl(t){if(t===null)return[];var n,e,r,i,s,a=t;for(s=new Array(a.length),n=0,e=a.length;n<e;n+=1)r=a[n],i=Object.keys(r),s[n]=[i[0],r[i[0]]];return s}var _l=new M("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:fl,construct:gl}),vl=Object.prototype.hasOwnProperty;function yl(t){if(t===null)return!0;var n,e=t;for(n in e)if(vl.call(e,n)&&e[n]!==null)return!1;return!0}function bl(t){return t!==null?t:{}}var xl=new M("tag:yaml.org,2002:set",{kind:"mapping",resolve:yl,construct:bl}),_s=Jo.extend({implicit:[tl,il],explicit:[ll,pl,_l,xl]}),ke=Object.prototype.hasOwnProperty,vr=1,vs=2,ys=3,yr=4,ui=1,wl=2,Zn=3,$l=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,kl=/[\x85\u2028\u2029]/,El=/[,\[\]\{\}]/,bs=/^(?:!|!!|![a-z\-]+!)$/i,xs=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function es(t){return Object.prototype.toString.call(t)}function ie(t){return t===10||t===13}function ze(t){return t===9||t===32}function V(t){return t===9||t===32||t===10||t===13}function ot(t){return t===44||t===91||t===93||t===123||t===125}function Sl(t){var n;return 48<=t&&t<=57?t-48:(n=t|32,97<=n&&n<=102?n-97+10:-1)}function Cl(t){return t===120?2:t===117?4:t===85?8:0}function Tl(t){return 48<=t&&t<=57?t-48:-1}function ts(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function Ll(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function ws(t,n,e){n==="__proto__"?Object.defineProperty(t,n,{configurable:!0,enumerable:!0,writable:!0,value:e}):t[n]=e}var $s=new Array(256),ks=new Array(256);for(je=0;je<256;je++)$s[je]=ts(je)?1:0,ks[je]=ts(je);var je;function Rl(t,n){this.input=t,this.filename=n.filename||null,this.schema=n.schema||_s,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function Es(t,n){var e={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return e.snippet=_o(e),new q(n,e)}function $(t,n){throw Es(t,n)}function br(t,n){t.onWarning&&t.onWarning.call(null,Es(t,n))}var rs={YAML:function(n,e,r){var i,s,a;n.version!==null&&$(n,"duplication of %YAML directive"),r.length!==1&&$(n,"YAML directive accepts exactly one argument"),i=/^([0-9]+)\.([0-9]+)$/.exec(r[0]),i===null&&$(n,"ill-formed argument of the YAML directive"),s=parseInt(i[1],10),a=parseInt(i[2],10),s!==1&&$(n,"unacceptable YAML version of the document"),n.version=r[0],n.checkLineBreaks=a<2,a!==1&&a!==2&&br(n,"unsupported YAML version of the document")},TAG:function(n,e,r){var i,s;r.length!==2&&$(n,"TAG directive accepts exactly two arguments"),i=r[0],s=r[1],bs.test(i)||$(n,"ill-formed tag handle (first argument) of the TAG directive"),ke.call(n.tagMap,i)&&$(n,'there is a previously declared suffix for "'+i+'" tag handle'),xs.test(s)||$(n,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{$(n,"tag prefix is malformed: "+s)}n.tagMap[i]=s}};function $e(t,n,e,r){var i,s,a,o;if(n<e){if(o=t.input.slice(n,e),r)for(i=0,s=o.length;i<s;i+=1)a=o.charCodeAt(i),a===9||32<=a&&a<=1114111||$(t,"expected valid JSON character");else $l.test(o)&&$(t,"the stream contains non-printable characters");t.result+=o}}function is(t,n,e,r){var i,s,a,o;for(H.isObject(e)||$(t,"cannot merge mappings; the provided source object is unacceptable"),i=Object.keys(e),a=0,o=i.length;a<o;a+=1)s=i[a],ke.call(n,s)||(ws(n,s,e[s]),r[s]=!0)}function lt(t,n,e,r,i,s,a,o,c){var h,p;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),h=0,p=i.length;h<p;h+=1)Array.isArray(i[h])&&$(t,"nested arrays are not supported inside keys"),typeof i=="object"&&es(i[h])==="[object Object]"&&(i[h]="[object Object]");if(typeof i=="object"&&es(i)==="[object Object]"&&(i="[object Object]"),i=String(i),n===null&&(n={}),r==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(h=0,p=s.length;h<p;h+=1)is(t,n,s[h],e);else is(t,n,s,e);else!t.json&&!ke.call(e,i)&&ke.call(n,i)&&(t.line=a||t.line,t.lineStart=o||t.lineStart,t.position=c||t.position,$(t,"duplicated mapping key")),ws(n,i,s),delete e[i];return n}function vi(t){var n;n=t.input.charCodeAt(t.position),n===10?t.position++:n===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):$(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function D(t,n,e){for(var r=0,i=t.input.charCodeAt(t.position);i!==0;){for(;ze(i);)i===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),i=t.input.charCodeAt(++t.position);if(n&&i===35)do i=t.input.charCodeAt(++t.position);while(i!==10&&i!==13&&i!==0);if(ie(i))for(vi(t),i=t.input.charCodeAt(t.position),r++,t.lineIndent=0;i===32;)t.lineIndent++,i=t.input.charCodeAt(++t.position);else break}return e!==-1&&r!==0&&t.lineIndent<e&&br(t,"deficient indentation"),r}function $r(t){var n=t.position,e;return e=t.input.charCodeAt(n),!!((e===45||e===46)&&e===t.input.charCodeAt(n+1)&&e===t.input.charCodeAt(n+2)&&(n+=3,e=t.input.charCodeAt(n),e===0||V(e)))}function yi(t,n){n===1?t.result+=" ":n>1&&(t.result+=H.repeat(`
`,n-1))}function Pl(t,n,e){var r,i,s,a,o,c,h,p,f=t.kind,_=t.result,y;if(y=t.input.charCodeAt(t.position),V(y)||ot(y)||y===35||y===38||y===42||y===33||y===124||y===62||y===39||y===34||y===37||y===64||y===96||(y===63||y===45)&&(i=t.input.charCodeAt(t.position+1),V(i)||e&&ot(i)))return!1;for(t.kind="scalar",t.result="",s=a=t.position,o=!1;y!==0;){if(y===58){if(i=t.input.charCodeAt(t.position+1),V(i)||e&&ot(i))break}else if(y===35){if(r=t.input.charCodeAt(t.position-1),V(r))break}else{if(t.position===t.lineStart&&$r(t)||e&&ot(y))break;if(ie(y))if(c=t.line,h=t.lineStart,p=t.lineIndent,D(t,!1,-1),t.lineIndent>=n){o=!0,y=t.input.charCodeAt(t.position);continue}else{t.position=a,t.line=c,t.lineStart=h,t.lineIndent=p;break}}o&&($e(t,s,a,!1),yi(t,t.line-c),s=a=t.position,o=!1),ze(y)||(a=t.position+1),y=t.input.charCodeAt(++t.position)}return $e(t,s,a,!1),t.result?!0:(t.kind=f,t.result=_,!1)}function Dl(t,n){var e,r,i;if(e=t.input.charCodeAt(t.position),e!==39)return!1;for(t.kind="scalar",t.result="",t.position++,r=i=t.position;(e=t.input.charCodeAt(t.position))!==0;)if(e===39)if($e(t,r,t.position,!0),e=t.input.charCodeAt(++t.position),e===39)r=t.position,t.position++,i=t.position;else return!0;else ie(e)?($e(t,r,i,!0),yi(t,D(t,!1,n)),r=i=t.position):t.position===t.lineStart&&$r(t)?$(t,"unexpected end of the document within a single quoted scalar"):(t.position++,i=t.position);$(t,"unexpected end of the stream within a single quoted scalar")}function Al(t,n){var e,r,i,s,a,o;if(o=t.input.charCodeAt(t.position),o!==34)return!1;for(t.kind="scalar",t.result="",t.position++,e=r=t.position;(o=t.input.charCodeAt(t.position))!==0;){if(o===34)return $e(t,e,t.position,!0),t.position++,!0;if(o===92){if($e(t,e,t.position,!0),o=t.input.charCodeAt(++t.position),ie(o))D(t,!1,n);else if(o<256&&$s[o])t.result+=ks[o],t.position++;else if((a=Cl(o))>0){for(i=a,s=0;i>0;i--)o=t.input.charCodeAt(++t.position),(a=Sl(o))>=0?s=(s<<4)+a:$(t,"expected hexadecimal character");t.result+=Ll(s),t.position++}else $(t,"unknown escape sequence");e=r=t.position}else ie(o)?($e(t,e,r,!0),yi(t,D(t,!1,n)),e=r=t.position):t.position===t.lineStart&&$r(t)?$(t,"unexpected end of the document within a double quoted scalar"):(t.position++,r=t.position)}$(t,"unexpected end of the stream within a double quoted scalar")}function Hl(t,n){var e=!0,r,i,s,a=t.tag,o,c=t.anchor,h,p,f,_,y,k=Object.create(null),E,R,U,T;if(T=t.input.charCodeAt(t.position),T===91)p=93,y=!1,o=[];else if(T===123)p=125,y=!0,o={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=o),T=t.input.charCodeAt(++t.position);T!==0;){if(D(t,!0,n),T=t.input.charCodeAt(t.position),T===p)return t.position++,t.tag=a,t.anchor=c,t.kind=y?"mapping":"sequence",t.result=o,!0;e?T===44&&$(t,"expected the node content, but found ','"):$(t,"missed comma between flow collection entries"),R=E=U=null,f=_=!1,T===63&&(h=t.input.charCodeAt(t.position+1),V(h)&&(f=_=!0,t.position++,D(t,!0,n))),r=t.line,i=t.lineStart,s=t.position,dt(t,n,vr,!1,!0),R=t.tag,E=t.result,D(t,!0,n),T=t.input.charCodeAt(t.position),(_||t.line===r)&&T===58&&(f=!0,T=t.input.charCodeAt(++t.position),D(t,!0,n),dt(t,n,vr,!1,!0),U=t.result),y?lt(t,o,k,R,E,U,r,i,s):f?o.push(lt(t,null,k,R,E,U,r,i,s)):o.push(E),D(t,!0,n),T=t.input.charCodeAt(t.position),T===44?(e=!0,T=t.input.charCodeAt(++t.position)):e=!1}$(t,"unexpected end of the stream within a flow collection")}function Ol(t,n){var e,r,i=ui,s=!1,a=!1,o=n,c=0,h=!1,p,f;if(f=t.input.charCodeAt(t.position),f===124)r=!1;else if(f===62)r=!0;else return!1;for(t.kind="scalar",t.result="";f!==0;)if(f=t.input.charCodeAt(++t.position),f===43||f===45)ui===i?i=f===43?Zn:wl:$(t,"repeat of a chomping mode identifier");else if((p=Tl(f))>=0)p===0?$(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?$(t,"repeat of an indentation width identifier"):(o=n+p-1,a=!0);else break;if(ze(f)){do f=t.input.charCodeAt(++t.position);while(ze(f));if(f===35)do f=t.input.charCodeAt(++t.position);while(!ie(f)&&f!==0)}for(;f!==0;){for(vi(t),t.lineIndent=0,f=t.input.charCodeAt(t.position);(!a||t.lineIndent<o)&&f===32;)t.lineIndent++,f=t.input.charCodeAt(++t.position);if(!a&&t.lineIndent>o&&(o=t.lineIndent),ie(f)){c++;continue}if(t.lineIndent<o){i===Zn?t.result+=H.repeat(`
...
`,c):t.result+=H.repeat(`
`,s?1+c:c),s=!0,a=!0,c=0,e=t.position;!ie(f)&&f!==0;)f=t.input.charCodeAt(++t.position);$e(t,e,t.position,!1)}return!0}function ns(t,n){var e,r=t.tag,i=t.anchor,s=[],a,o=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,$(t,"tab characters must not be used in indentation")),!(c!==45||(a=t.input.charCodeAt(t.position+1),!V(a))));){if(o=!0,t.position++,D(t,!0,-1)&&t.lineIndent<=n){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,dt(t,n,ys,!1,!0),s.push(t.result),D(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>n)&&c!==0)$(t,"bad indentation of a sequence entry");else if(t.lineIndent<n)break}return o?(t.tag=r,t.anchor=i,t.kind="sequence",t.result=s,!0):!1}function Nl(t,n,e){var r,i,s,a,o,c,h=t.tag,p=t.anchor,f={},_=Object.create(null),y=null,k=null,E=null,R=!1,U=!1,T;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=f),T=t.input.charCodeAt(t.position);T!==0;){if(!R&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,$(t,"tab characters must not be used in indentation")),r=t.input.charCodeAt(t.position+1),s=t.line,(T===63||T===58)&&V(r))T===63?(R&&(lt(t,f,_,y,k,null,a,o,c),y=k=E=null),U=!0,R=!0,i=!0):R?(R=!1,i=!0):$(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,T=r;else{if(a=t.line,o=t.lineStart,c=t.position,!dt(t,e,vs,!1,!0))break;if(t.line===s){for(T=t.input.charCodeAt(t.position);ze(T);)T=t.input.charCodeAt(++t.position);if(T===58)T=t.input.charCodeAt(++t.position),V(T)||$(t,"a whitespace character is expected after the key-value separator within a block mapping"),R&&(lt(t,f,_,y,k,null,a,o,c),y=k=E=null),U=!0,R=!1,i=!1,y=t.tag,k=t.result;else if(U)$(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(U)$(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>n)&&(R&&(a=t.line,o=t.lineStart,c=t.position),dt(t,n,yr,!0,i)&&(R?k=t.result:E=t.result),R||(lt(t,f,_,y,k,E,a,o,c),y=k=E=null),D(t,!0,-1),T=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>n)&&T!==0)$(t,"bad indentation of a mapping entry");else if(t.lineIndent<n)break}return R&&lt(t,f,_,y,k,null,a,o,c),U&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=f),U}function Fl(t){var n,e=!1,r=!1,i,s,a;if(a=t.input.charCodeAt(t.position),a!==33)return!1;if(t.tag!==null&&$(t,"duplication of a tag property"),a=t.input.charCodeAt(++t.position),a===60?(e=!0,a=t.input.charCodeAt(++t.position)):a===33?(r=!0,i="!!",a=t.input.charCodeAt(++t.position)):i="!",n=t.position,e){do a=t.input.charCodeAt(++t.position);while(a!==0&&a!==62);t.position<t.length?(s=t.input.slice(n,t.position),a=t.input.charCodeAt(++t.position)):$(t,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!V(a);)a===33&&(r?$(t,"tag suffix cannot contain exclamation marks"):(i=t.input.slice(n-1,t.position+1),bs.test(i)||$(t,"named tag handle cannot contain such characters"),r=!0,n=t.position+1)),a=t.input.charCodeAt(++t.position);s=t.input.slice(n,t.position),El.test(s)&&$(t,"tag suffix cannot contain flow indicator characters")}s&&!xs.test(s)&&$(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{$(t,"tag name is malformed: "+s)}return e?t.tag=s:ke.call(t.tagMap,i)?t.tag=t.tagMap[i]+s:i==="!"?t.tag="!"+s:i==="!!"?t.tag="tag:yaml.org,2002:"+s:$(t,'undeclared tag handle "'+i+'"'),!0}function Il(t){var n,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&$(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),n=t.position;e!==0&&!V(e)&&!ot(e);)e=t.input.charCodeAt(++t.position);return t.position===n&&$(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(n,t.position),!0}function Ml(t){var n,e,r;if(r=t.input.charCodeAt(t.position),r!==42)return!1;for(r=t.input.charCodeAt(++t.position),n=t.position;r!==0&&!V(r)&&!ot(r);)r=t.input.charCodeAt(++t.position);return t.position===n&&$(t,"name of an alias node must contain at least one character"),e=t.input.slice(n,t.position),ke.call(t.anchorMap,e)||$(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],D(t,!0,-1),!0}function dt(t,n,e,r,i){var s,a,o,c=1,h=!1,p=!1,f,_,y,k,E,R;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=a=o=yr===e||ys===e,r&&D(t,!0,-1)&&(h=!0,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)),c===1)for(;Fl(t)||Il(t);)D(t,!0,-1)?(h=!0,o=s,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)):o=!1;if(o&&(o=h||i),(c===1||yr===e)&&(vr===e||vs===e?E=n:E=n+1,R=t.position-t.lineStart,c===1?o&&(ns(t,R)||Nl(t,R,E))||Hl(t,E)?p=!0:(a&&Ol(t,E)||Dl(t,E)||Al(t,E)?p=!0:Ml(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&$(t,"alias node should not have any properties")):Pl(t,E,vr===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=o&&ns(t,R))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&$(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),f=0,_=t.implicitTypes.length;f<_;f+=1)if(k=t.implicitTypes[f],k.resolve(t.result)){t.result=k.construct(t.result),t.tag=k.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(ke.call(t.typeMap[t.kind||"fallback"],t.tag))k=t.typeMap[t.kind||"fallback"][t.tag];else for(k=null,y=t.typeMap.multi[t.kind||"fallback"],f=0,_=y.length;f<_;f+=1)if(t.tag.slice(0,y[f].tag.length)===y[f].tag){k=y[f];break}k||$(t,"unknown tag !<"+t.tag+">"),t.result!==null&&k.kind!==t.kind&&$(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+k.kind+'", not "'+t.kind+'"'),k.resolve(t.result,t.tag)?(t.result=k.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):$(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function jl(t){var n=t.position,e,r,i,s=!1,a;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(a=t.input.charCodeAt(t.position))!==0&&(D(t,!0,-1),a=t.input.charCodeAt(t.position),!(t.lineIndent>0||a!==37));){for(s=!0,a=t.input.charCodeAt(++t.position),e=t.position;a!==0&&!V(a);)a=t.input.charCodeAt(++t.position);for(r=t.input.slice(e,t.position),i=[],r.length<1&&$(t,"directive name must not be less than one character in length");a!==0;){for(;ze(a);)a=t.input.charCodeAt(++t.position);if(a===35){do a=t.input.charCodeAt(++t.position);while(a!==0&&!ie(a));break}if(ie(a))break;for(e=t.position;a!==0&&!V(a);)a=t.input.charCodeAt(++t.position);i.push(t.input.slice(e,t.position))}a!==0&&vi(t),ke.call(rs,r)?rs[r](t,r,i):br(t,'unknown document directive "'+r+'"')}if(D(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,D(t,!0,-1)):s&&$(t,"directives end mark is expected"),dt(t,t.lineIndent-1,yr,!1,!0),D(t,!0,-1),t.checkLineBreaks&&kl.test(t.input.slice(n,t.position))&&br(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&$r(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,D(t,!0,-1));return}if(t.position<t.length-1)$(t,"end of the stream or a document separator is expected");else return}function Ss(t,n){t=String(t),n=n||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Rl(t,n),r=t.indexOf("\0");for(r!==-1&&(e.position=r,$(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)jl(e);return e.documents}function zl(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var r=Ss(t,e);if(typeof n!="function")return r;for(var i=0,s=r.length;i<s;i+=1)n(r[i])}function Wl(t,n){var e=Ss(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new q("expected a single document in the stream, but found more")}}var Ul=zl,Bl=Wl,Cs={loadAll:Ul,load:Bl},Ts=Object.prototype.toString,Ls=Object.prototype.hasOwnProperty,bi=65279,ql=9,Dt=10,Vl=13,Kl=32,Yl=33,Gl=34,pi=35,Ql=37,Jl=38,Xl=39,Zl=42,Rs=44,ed=45,xr=58,td=61,rd=62,id=63,nd=64,Ps=91,Ds=93,sd=96,As=123,ad=124,Hs=125,j={};j[0]="\\0";j[7]="\\a";j[8]="\\b";j[9]="\\t";j[10]="\\n";j[11]="\\v";j[12]="\\f";j[13]="\\r";j[27]="\\e";j[34]='\\"';j[92]="\\\\";j[133]="\\N";j[160]="\\_";j[8232]="\\L";j[8233]="\\P";var od=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],ld=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function dd(t,n){var e,r,i,s,a,o,c;if(n===null)return{};for(e={},r=Object.keys(n),i=0,s=r.length;i<s;i+=1)a=r[i],o=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),c=t.compiledTypeMap.fallback[a],c&&Ls.call(c.styleAliases,o)&&(o=c.styleAliases[o]),e[a]=o;return e}function cd(t){var n,e,r;if(n=t.toString(16).toUpperCase(),t<=255)e="x",r=2;else if(t<=65535)e="u",r=4;else if(t<=4294967295)e="U",r=8;else throw new q("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+H.repeat("0",r-n.length)+n}var ud=1,At=2;function hd(t){this.schema=t.schema||_s,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=H.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=dd(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?At:ud,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function ss(t,n){for(var e=H.repeat(" ",n),r=0,i=-1,s="",a,o=t.length;r<o;)i=t.indexOf(`
`,r),i===-1?(a=t.slice(r),r=o):(a=t.slice(r,i+1),r=i+1),a.length&&a!==`
`&&(s+=e),s+=a;return s}function mi(t,n){return`
`+H.repeat(" ",t.indent*n)}function pd(t,n){var e,r,i;for(e=0,r=t.implicitTypes.length;e<r;e+=1)if(i=t.implicitTypes[e],i.resolve(n))return!0;return!1}function wr(t){return t===Kl||t===ql}function Ht(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==bi||65536<=t&&t<=1114111}function as(t){return Ht(t)&&t!==bi&&t!==Vl&&t!==Dt}function os(t,n,e){var r=as(t),i=r&&!wr(t);return(e?r:r&&t!==Rs&&t!==Ps&&t!==Ds&&t!==As&&t!==Hs)&&t!==pi&&!(n===xr&&!i)||as(n)&&!wr(n)&&t===pi||n===xr&&i}function md(t){return Ht(t)&&t!==bi&&!wr(t)&&t!==ed&&t!==id&&t!==xr&&t!==Rs&&t!==Ps&&t!==Ds&&t!==As&&t!==Hs&&t!==pi&&t!==Jl&&t!==Zl&&t!==Yl&&t!==ad&&t!==td&&t!==rd&&t!==Xl&&t!==Gl&&t!==Ql&&t!==nd&&t!==sd}function fd(t){return!wr(t)&&t!==xr}function Rt(t,n){var e=t.charCodeAt(n),r;return e>=55296&&e<=56319&&n+1<t.length&&(r=t.charCodeAt(n+1),r>=56320&&r<=57343)?(e-55296)*1024+r-56320+65536:e}function Os(t){var n=/^\n* /;return n.test(t)}var Ns=1,fi=2,Fs=3,Is=4,at=5;function gd(t,n,e,r,i,s,a,o){var c,h=0,p=null,f=!1,_=!1,y=r!==-1,k=-1,E=md(Rt(t,0))&&fd(Rt(t,t.length-1));if(n||a)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Rt(t,c),!Ht(h))return at;E=E&&os(h,p,o),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Rt(t,c),h===Dt)f=!0,y&&(_=_||c-k-1>r&&t[k+1]!==" ",k=c);else if(!Ht(h))return at;E=E&&os(h,p,o),p=h}_=_||y&&c-k-1>r&&t[k+1]!==" "}return!f&&!_?E&&!a&&!i(t)?Ns:s===At?at:fi:e>9&&Os(t)?at:a?s===At?at:fi:_?Is:Fs}function _d(t,n,e,r,i){t.dump=(function(){if(n.length===0)return t.quotingType===At?'""':"''";if(!t.noCompatMode&&(od.indexOf(n)!==-1||ld.test(n)))return t.quotingType===At?'"'+n+'"':"'"+n+"'";var s=t.indent*Math.max(1,e),a=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),o=r||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return pd(t,h)}switch(gd(n,o,t.indent,a,c,t.quotingType,t.forceQuotes&&!r,i)){case Ns:return n;case fi:return"'"+n.replace(/'/g,"''")+"'";case Fs:return"|"+ls(n,t.indent)+ds(ss(n,s));case Is:return">"+ls(n,t.indent)+ds(ss(vd(n,a),s));case at:return'"'+yd(n)+'"';default:throw new q("impossible error: invalid scalar style")}})()}function ls(t,n){var e=Os(t)?String(n):"",r=t[t.length-1]===`
`,i=r&&(t[t.length-2]===`
`||t===`
`),s=i?"+":r?"":"-";return e+s+`
...
`:""}var Ed=kd,Sd={dump:Ed};function xi(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Ms=Cs.load,Th=Cs.loadAll,kr=Sd.dump;var Lh=xi("safeLoad","load"),Rh=xi("safeLoadAll","loadAll"),Ph=xi("safeDump","dump");var ne=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>si(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let i=this._currentFields()?.[e.name]?.description;return typeof i=="string"?i:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=kr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=kr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=kr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Ms(e)}catch(c){this._yamlError=c.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(c=>typeof c=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,L(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){return N(this.hass,e)}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.hasOwn(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,u([m({attribute:!1})],We.prototype,"hass",2),u([m({attribute:!1})],We.prototype,"value",2),We=u([x("ambience-time-endpoint")],We);function Td(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function Ld(t,n){if(t===0)return"";let e=Math.abs(t),r=t<0?"\u2212":"+";if(e%60===0){let i=e/60,s=i===1?d(n,"ui.unit_hour","hour"):d(n,"ui.unit_hours","hours");return`${r}${i} ${s}`}return`${r}${e} ${d(n,"ui.unit_min","min")}`}function ct(t){return t.scope_kind==="house"?"House":t.scope_kind==="floor"?`Floor: ${t.scope_id??""}`:t.scope_id??""}function Er(t,n){if(!t)return[];let e=Object.keys(t.builtins??{}),r=n?e.slice().sort(n):e,i=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(a=>!(a in(t.builtins??{})));return[...r.filter(a=>!i.has(a)),...s]}var se=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}static{this.styles=v`
    :host { display: block; }
  ...
  `,u([m({attribute:!1})],Se.prototype,"hass",2),u([m({attribute:!1})],Se.prototype,"value",2),u([m({attribute:!1})],Se.prototype,"dayConfig",2),Se=u([x("ambience-day-predicate-input")],Se);var Us=["temperature","apparent_temperature","humidity","wind_speed","pressure"],Bs=["<","<=",">",">="],qs={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},pe=class extends b{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let r=e.groups.length===0&&e.thresholds.length===0;this.value=r?null:e,L(this,this.value)}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,r){let i=this._current();i.thresholds=i.thresholds.map((s,a)=>a===e?r:s),this._emit(i)}_removeThreshold(e){let r=this._current();r.thresholds=r.thresholds.filter((i,s)=>s!==e),this._emit(r)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:Us.map(r=>({value:r,label:bt(this.hass,r)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:Bs.map(r=>({value:r,label:qs[r]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,r){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Br(this.hass,r,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
      ...
      ${Us.map(i=>l`<option value=${i} ?selected=${i===r.attribute}>${bt(this.hass,i)}</option>`)}
  ...
  `,u([m({attribute:!1})],X.prototype,"condition",2),u([m({attribute:!1})],X.prototype,"value",2),u([m({attribute:!1})],X.prototype,"periods",2),u([m({attribute:!1})],X.prototype,"luxRanges",2),u([m({attribute:!1})],X.prototype,"dayConfig",2),u([m({attribute:!1})],X.prototype,"weatherConfig",2),u([m({attribute:!1})],X.prototype,"hass",2),X=u([x("ambience-condition-input")],X);function Id(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function Md(t){return t==="people"?{quant:"everyone",where:"home"}:null}function Js(t,n){return!!t&&!!n&&W(t)===W(n)}var S=class extends b{constructor(){super(...arguments);this.open=!1;this.scene=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.takenNames=new Map;this.saveError="";this._draft=null;this._open=null;this._showError=!1;this._addOrder=[];this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onAddCondition=e=>{let r=e.target,i=r.value;r.value="",this._addCondition(i)};this._onAddConditionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_CONDITION_PLACEHOLDER&&this._addCondition(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onConditionInvalid(e,r){r?this._conditionError.set(e,r):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),ge(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.scene?JSON.parse(JSON.stringify(this.scene)):null,this._scope=this.scope,this._open=null,this._showError=!1,this._addOrder=[])}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let r=this.scopes[e];if(!r||!this._draft||(this._scope=r.scope,!this.hass))return;let i=new Set(cr(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(a=>i.has(a))}))}}_renderDestination(){return l`
    ...
    `}_renderDestinationSlot(){if(this.scopes.length===0)return"";if(this._isOpen({kind:"destination"}))return l`
      ...
      `;let e=this.scopes.find(r=>Js(r.scope,this._scope))??this.scopes[0];return l`
...
`,zd={has_time:"Periodic time check",switch:"Switch turned on",manual:"Manual apply",startup:"Startup",reapply:"Periodic refresh",simulated:"Simulation"},Wd={clock:"Time of day",sun:"Sun position"};function Xs(t){if(t.kind==="entity")return`${t.entity_id} ${t.old} \u2192 ${t.new}`;if(t.kind==="duration")return`${t.entity_id} ${t.new} for ${t.detail}`;let n=zd[t.kind];if(n)return n;let e=Wd[t.kind]??_e(t.kind);return t.detail?`${e} ${t.detail}`:e}function Zs(t){return t.kind==="entity"||t.kind==="duration"}function Ud(t,n){if(!Zs(t))return Xs(t);let e=t.entity_id?ai(n,t.entity_id):"?",r=t.entity_id?n?.states?.[t.entity_id]:void 0,i=s=>s===null?"?":Je(n,r,null,s);return t.kind==="duration"?`${e}: ${i(t.new)} for ${t.detail??"?"}`:`${e}: ${i(t.old)} \u2192 ${i(t.new)}`}var Bd={acted:"applied",no_op:"blocked",debounced:"unchanged",no_match:"no match",reapplied:"refreshed",skipped_switch_off:"skipped",skipped_scope_disabled:"skipped"};function qd(t){return Bd[t]??t.replace(/_/g," ")}function Vd(t){let n=t.winner_name??"The matching scene";switch(t.outcome){case"acted":{let e=Ci(t.actions.length,"action","actions"),r=ea(t.actions);return r?`Applied ${n} \u2014 ${e} on ${Ci(r,"entity","entities")}.`:`Applied ${n} \u2014 ${e}.`}case"no_op":return`${n} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.`;case"debounced":return`${n} matched, but it's already applied \u2014 nothing was re-sent.`;case"no_match":return"No scene matched \u2014 nothing applied.";case"reapplied":return`Periodic refresh re-sent ${n}'s actions.`;case"skipped_switch_off":return"Skipped \u2014 the category switch is off.";case"skipped_scope_disabled":return"Skipped \u2014 the scope is disabled.";default:return""}}function Kd(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,a])=>`${Tt(s,t.service,e)}: ${we(n,a)}`).join(", "),i=yt(t.service);return r?`${i} \xB7 ${r}`:i}function ea(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function Ci(t,n,e){return`${t} ${t===1?n:e}`}function Yd(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"}function Gd(t,n){let e=t.index+1;return t.disabled?l`<div class="scene disabled">Scene #${e} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
  ...
  `}var z=class extends b{constructor(){super(...arguments);this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1}connectedCallback(){super.connectedCallback(),this._poll=setInterval(()=>this._checkNew(),5e3)}disconnectedCallback(){super.disconnectedCallback(),this._poll&&clearInterval(this._poll)}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(r=>r.scope_kind===this.scope.scope_kind&&r.scope_id===this.scope.scope_id&&r.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await Xr(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=e.message||String(e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(a=>a.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let r=await Promise.all(e.map(async s=>{try{return[s,await be(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let i={...this._schemas};for(let s of r)s&&(i[s[0]]=s[1]);this._schemas=i}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let r=this._mine(await Xr(this.hass))[0]?.timestamp??null,i=this._records[0]?.timestamp??null;r&&(!i||r>i)&&(this._hasNew=!0)}catch{}}_toggle(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return w;let e=this.categoryName??this.category;return l`
    ...
    ></ha-icon>`}_moreInfoEntity(e){return e.kind==="entity"?e.entity_id:e.kind==="sun"&&this.hass?.states?.["sun.sun"]?"sun.sun":null}_renderRow(e){let{title:r,detail:i}=this._rowContent(e),s=this._moreInfoEntity(e);return l`
      <li
        ...
        @keydown=${s?a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),this._openMoreInfo(s))}:w}
      >
  ...
  `,u([m({attribute:!1})],K.prototype,"hass",2),u([m({attribute:!1})],K.prototype,"scope",2),u([m()],K.prototype,"scopeName",2),u([m({attribute:!1})],K.prototype,"scenes",2),u([m({type:Boolean,reflect:!0})],K.prototype,"open",2),u([g()],K.prototype,"_triggers",2),u([g()],K.prototype,"_opaque",2),u([g()],K.prototype,"_loading",2),u([g()],K.prototype,"_error",2),K=u([x("ambience-auto-triggers-modal")],K);var Xd={not_home:"Away",home:"Home"};function ta(t){return Xd[t]??_e(t)}function ra(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(n=>[n.name,n.live_value==null?"":String(n.live_value)])),for:{h:0,m:0,s:0}}}function Pr(t){return String(t).padStart(2,"0")}function ia(t){return`${t.getFullYear()}-${Pr(t.getMonth()+1)}-${Pr(t.getDate())}`}function na(t){return`${Pr(t.getHours())}:${Pr(t.getMinutes())}`}var A=class extends b{constructor(){super(...arguments);this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=ia(e),this._time=na(e);try{let r=await Tn(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=r.knobs,this._hasTime=r.has_time;let i={},s={};for(let a of r.knobs)a.kind==="entity"?i[a.entity_id]=ra(a):s[this._vkey(a)]=a.live_value;this._values=i,this._verdicts=s,this._loading=!1}catch(r){this._error=r.message||String(r),this._loading=!1}}_setState(e,r){this._values={...this._values,[e]:{...this._values[e],state:r}}}_setAttr(e,r,i){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[r]:i}}}}_setFor(e,r,i){let s=this._values[e],a=Number.isFinite(i)&&i>0?Math.trunc(i):0;this._values={...this._values,[e]:{...s,for:{...s.for,[r]:a}}}}_setVerdict(e,r){this._verdicts={...this._verdicts,[e]:r}}_resetWhen(){let e=new Date;this._date=ia(e),this._time=na(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:ra(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let r of this._knobs){if(r.kind!=="entity")continue;let i=this._values[r.entity_id];if(!i)continue;let s={};for(let o of r.attributes){let c=i.attributes[o.name];if(!(c===void 0||c===""))if(o.control==="number"){let h=Number(c);Number.isNaN(h)||(s[o.name]=h)}else s[o.name]=c}let a={attributes:s};i.state!==""&&(a.state=i.state),(i.for.h||i.for.m||i.for.s)&&(a.for=i.for),(a.state!==void 0||a.for!==void 0||Object.keys(s).length>0)&&(e[r.entity_id]=a)}return e}_buildVerdicts(){let e={};for(let r of this._knobs)r.kind==="verdict"&&(e[r.condition]||(e[r.condition]={}),e[r.condition][r.key]=this._verdicts[this._vkey(r)]??r.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`).toISOString();try{this._result=await Ln(this.hass,this.scope,this.category,e,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(r){this._error=r.message||String(r)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      <div class="modal" role="dialog" aria-modal="true">
        <div class="header">
        ...
        <div class="body">
          ...
          ${this._loading?l`<p>Loading…</p>`:l`
            ...
            ${this._result?l`<div class="result">${Rr(this._result,this._expanded,()=>this._expanded=!this._expanded)}</div>`:w}
          `}
        </div>
      ...
      ${e.attributes.map((s,a)=>l`
        <div class="row attr ${a===e.attributes.length-1?"last-attr":""}">
          <div class="row-text"><div class="row-title">${ta(s.name)}</div></div>
          <div class="row-ctrl">
    ...
    `}_renderControl(e,r){if(e.control==="select")return l`<select data-entity=${e.entity_id} .value=${r}
        ...
        ${(e.options??[r]).map(s=>l`<option value=${s} ?selected=${s===r}>${ta(s)}</option>`)}
    ...
    >
      ...
      <span class="countdown">${Zd(o)}</span>
  ...
  `,u([m({attribute:!1})],me.prototype,"hass",2),u([m()],me.prototype,"conditionName",2),u([m()],me.prototype,"conditionDescription",2),u([g()],me.prototype,"_expanded",2),me=u([x("ambience-condition-card")],me);var tc=/^[a-z][a-z0-9_]*$/;function rc(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var It=v`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
