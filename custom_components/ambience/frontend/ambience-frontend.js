...
`;function Tt(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return st(t)}function fr(t,n="New scene"){return t.name?.trim()?t.name:n}function Lt(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?_r(n,e):t==="day"?Ka(n,e):t==="weather"?Za(n,e):t==="sun"?eo(n,e):t==="state"?li(n,e):t==="script"?qa(n,e):t==="people"?Va(n,e):t==="occupancy"?to(n,e):t==="lux"?ro(n,e):t==="template"?Ba(n,e):String(n)}function Ba(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function qa(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=Ct(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(a=>`${si(n.hass,t.script,a)}: ${we(n.hass,r[a])}`).join(", ");return`${e} (${s})`}function si(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:st(e)}function Ct(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Mn(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):Ct(n,t)}function Va(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=Ct(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${c} ${Mn(e,n)}`;return t.for&&pr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>Ct(n,h)).join(", ");r=`${o} (${c})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Mn(e,n)}`;return t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function Ka(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>jn(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>jn(a,n)).join(", ")})`}function jn(t,n){switch(t.kind){case"weekday":return t.days.map(e=>Xt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Ze(n.hass,t.month)} ${t.day}`;case"date_range":return`${Ze(n.hass,t.from.month)} ${t.from.day} \u2192 ${Ze(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Ya={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function st(t){return _e(t)}function Ga(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var Qa=["entity_id","device_id","area_id","label_id","floor_id"],zn=2;function Ja(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>Qa.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function we(t,n){let e=Ja(n);if(!e)return Ga(n);let r=e.slice(0,zn).map(a=>Ct({hass:t},a)),i=e.length-zn;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function gr(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function Xa(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function Za(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??Xa(a)).join("/"),i=(t.thresholds??[]).map(a=>`${bt(n.hass,a.attribute)} ${Ya[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function eo(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function qn(t,n){return N(t.hass,n)}function ai(t,n){return qn({hass:t},n)}function to(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(a=>N(n.hass,a)),r=t.occupied===!1?d(n.hass,"occupancy_summary.clear","clear"):d(n.hass,"occupancy_summary.detected","detected"),i=t.negate?`${d(n.hass,"occupancy_summary.not","not")} `:"",s;return e.length===1?s=`${e[0]} is ${i}${r}`:s=`${t.quant==="all"?d(n.hass,"occupancy_summary.all_of","all of"):d(n.hass,"occupancy_summary.any_of","any of")} (${e.join(", ")}) ${i}${r}`,t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function oi(t,n,e="any lux"){return t!=null&&n!=null?`${t}\u2013${n} lx`:n!=null?`<${n} lx`:t!=null?`\u2265${t} lx`:e}function ro(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(s=>N(n.hass,s)),r=t.range!=null?Xe(n.hass,t.range,n.luxRanges?.custom??{}):oi(t.min,t.max);return e.length===1?`${e[0]} ${r}`:`${t.quant==="all"?d(n.hass,"lux_summary.all_of","all of"):d(n.hass,"lux_summary.any_of","any of")} (${e.join(", ")}) ${r}`}function li(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):ni(t,n)}function Wn(t,n,e){let r=J(n.hass,t.kind),i=qn(n,t.entity_id),s=n.hass?.states?.[t.entity_id],o=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.map(f=>Je(n.hass,s,t.attribute,f)).join("/"),c=t.attribute?`${i}.${Qt(n.hass,s,t.attribute)}`:i,h=e?`${J(n.hass,"not")} `:"",p=`${c} ${r} ${h}${o}`;return t.for&&pr(t.for)?`${p} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:p}function ni(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return Wn(t,n,!1);if(t.kind==="and"||t.kind==="or"){let e=` ${J(n.hass,t.kind)} `;return t.items.map(r=>Un(r,n)).join(e)}if(t.kind==="not"){let e=t.item;return e.kind==="is"?Wn(e,n,!0):`${J(n.hass,"not")} ${Un(e,n)}`}return""}function Un(t,n){return t.kind==="and"||t.kind==="or"?`(${ni(t,n)})`:ni(t,n)}function pr(t){return t.h>0||t.m>0||t.s>0}function mr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function _r(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ye(n.hass,i.period,r):`${Bn(i.from,n)} \u2192 ${Bn(i.to,n)}`).join(", ")}function Bn(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=ve(n.hass,t.anchor),r=e;if(t.offset_min!==0){let i=Math.abs(t.offset_min),s=i%60===0?`${i/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${i}${d(n.hass,"ui.unit_min_abbr","m")}`;r=`${e}${t.offset_min<0?"-":"+"}${s}`}if(t.clamp){let i=t.clamp.dir==="not_before"?d(n.hass,"ui.clamp_not_before","not before"):d(n.hass,"ui.clamp_not_after","not after"),s=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;r=`${r} (${i} ${s})`}return r}function io(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label?.trim()?e.label:Jt(n.hass,t.service)}function no(t,n){let e=new Set;for(let r of t.entity_ids){let i=r.indexOf(".");i>0&&e.add(r.slice(0,i))}return e.size===1?[...e][0]:d(n.hass,"ui.target_noun","target")}function Vn(t,n){let e=io(t,n),r=no(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,c])=>`${Tt(o,t.service,n.schemas)}: ${we(n.hass,c)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var F=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this._drag=new nt(this,(e,r)=>this._emit("reorder-scenes",{from:e,to:r}));this._expanded=new Set}_renderSectionHeader(e){return l`<div
  ...
  `,u([m({attribute:!1})],I.prototype,"hass",2),u([m({attribute:!1})],I.prototype,"scope",2),u([m({attribute:!1})],I.prototype,"exposed",2),u([m({attribute:!1})],I.prototype,"entityIds",2),u([m({attribute:!1})],I.prototype,"params",2),u([m({attribute:!1})],I.prototype,"excludeEntities",2),u([g()],I.prototype,"_schema",2),u([g()],I.prototype,"_schemaError",2),u([g()],I.prototype,"_exposedMissing",2),u([g()],I.prototype,"_formSchema",2),u([g()],I.prototype,"_perFieldSchemas",2),I=u([x("ambience-action-slot")],I);function ps(t){return typeof t>"u"||t===null}function so(t){return typeof t=="object"&&t!==null}function ao(t){return Array.isArray(t)?t:ps(t)?[]:[t]}function oo(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function lo(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function co(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var uo=ps,ho=so,po=ao,mo=lo,fo=co,go=oo,H={isNothing:uo,isObject:ho,toArray:po,repeat:mo,isNegativeZero:fo,extend:go};function ms(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`
...
`,c):t.result+=H.repeat(`
`,s?1+c:c),s=!0,a=!0,c=0,e=t.position;!ie(f)&&f!==0;)f=t.input.charCodeAt(++t.position);$e(t,e,t.position,!1)}return!0}function ns(t,n){var e,r=t.tag,i=t.anchor,s=[],a,o=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,w(t,"tab characters must not be used in indentation")),!(c!==45||(a=t.input.charCodeAt(t.position+1),!V(a))));){if(o=!0,t.position++,D(t,!0,-1)&&t.lineIndent<=n){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,dt(t,n,ys,!1,!0),s.push(t.result),D(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>n)&&c!==0)w(t,"bad indentation of a sequence entry");else if(t.lineIndent<n)break}return o?(t.tag=r,t.anchor=i,t.kind="sequence",t.result=s,!0):!1}function Fl(t,n,e){var r,i,s,a,o,c,h=t.tag,p=t.anchor,f={},_=Object.create(null),y=null,k=null,E=null,R=!1,U=!1,T;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=f),T=t.input.charCodeAt(t.position);T!==0;){if(!R&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,w(t,"tab characters must not be used in indentation")),r=t.input.charCodeAt(t.position+1),s=t.line,(T===63||T===58)&&V(r))T===63?(R&&(lt(t,f,_,y,k,null,a,o,c),y=k=E=null),U=!0,R=!0,i=!0):R?(R=!1,i=!0):w(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,T=r;else{if(a=t.line,o=t.lineStart,c=t.position,!dt(t,e,vs,!1,!0))break;if(t.line===s){for(T=t.input.charCodeAt(t.position);ze(T);)T=t.input.charCodeAt(++t.position);if(T===58)T=t.input.charCodeAt(++t.position),V(T)||w(t,"a whitespace character is expected after the key-value separator within a block mapping"),R&&(lt(t,f,_,y,k,null,a,o,c),y=k=E=null),U=!0,R=!1,i=!1,y=t.tag,k=t.result;else if(U)w(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(U)w(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>n)&&(R&&(a=t.line,o=t.lineStart,c=t.position),dt(t,n,yr,!0,i)&&(R?k=t.result:E=t.result),R||(lt(t,f,_,y,k,E,a,o,c),y=k=E=null),D(t,!0,-1),T=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>n)&&T!==0)w(t,"bad indentation of a mapping entry");else if(t.lineIndent<n)break}return R&&lt(t,f,_,y,k,null,a,o,c),U&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=f),U}function Il(t){var n,e=!1,r=!1,i,s,a;if(a=t.input.charCodeAt(t.position),a!==33)return!1;if(t.tag!==null&&w(t,"duplication of a tag property"),a=t.input.charCodeAt(++t.position),a===60?(e=!0,a=t.input.charCodeAt(++t.position)):a===33?(r=!0,i="!!",a=t.input.charCodeAt(++t.position)):i="!",n=t.position,e){do a=t.input.charCodeAt(++t.position);while(a!==0&&a!==62);t.position<t.length?(s=t.input.slice(n,t.position),a=t.input.charCodeAt(++t.position)):w(t,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!V(a);)a===33&&(r?w(t,"tag suffix cannot contain exclamation marks"):(i=t.input.slice(n-1,t.position+1),bs.test(i)||w(t,"named tag handle cannot contain such characters"),r=!0,n=t.position+1)),a=t.input.charCodeAt(++t.position);s=t.input.slice(n,t.position),Sl.test(s)&&w(t,"tag suffix cannot contain flow indicator characters")}s&&!xs.test(s)&&w(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{w(t,"tag name is malformed: "+s)}return e?t.tag=s:ke.call(t.tagMap,i)?t.tag=t.tagMap[i]+s:i==="!"?t.tag="!"+s:i==="!!"?t.tag="tag:yaml.org,2002:"+s:w(t,'undeclared tag handle "'+i+'"'),!0}function Ml(t){var n,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&w(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),n=t.position;e!==0&&!V(e)&&!ot(e);)e=t.input.charCodeAt(++t.position);return t.position===n&&w(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(n,t.position),!0}function jl(t){var n,e,r;if(r=t.input.charCodeAt(t.position),r!==42)return!1;for(r=t.input.charCodeAt(++t.position),n=t.position;r!==0&&!V(r)&&!ot(r);)r=t.input.charCodeAt(++t.position);return t.position===n&&w(t,"name of an alias node must contain at least one character"),e=t.input.slice(n,t.position),ke.call(t.anchorMap,e)||w(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],D(t,!0,-1),!0}function dt(t,n,e,r,i){var s,a,o,c=1,h=!1,p=!1,f,_,y,k,E,R;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=a=o=yr===e||ys===e,r&&D(t,!0,-1)&&(h=!0,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)),c===1)for(;Il(t)||Ml(t);)D(t,!0,-1)?(h=!0,o=s,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)):o=!1;if(o&&(o=h||i),(c===1||yr===e)&&(vr===e||vs===e?E=n:E=n+1,R=t.position-t.lineStart,c===1?o&&(ns(t,R)||Fl(t,R,E))||Ol(t,E)?p=!0:(a&&Nl(t,E)||Al(t,E)||Hl(t,E)?p=!0:jl(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&w(t,"alias node should not have any properties")):Dl(t,E,vr===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=o&&ns(t,R))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&w(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),f=0,_=t.implicitTypes.length;f<_;f+=1)if(k=t.implicitTypes[f],k.resolve(t.result)){t.result=k.construct(t.result),t.tag=k.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(ke.call(t.typeMap[t.kind||"fallback"],t.tag))k=t.typeMap[t.kind||"fallback"][t.tag];else for(k=null,y=t.typeMap.multi[t.kind||"fallback"],f=0,_=y.length;f<_;f+=1)if(t.tag.slice(0,y[f].tag.length)===y[f].tag){k=y[f];break}k||w(t,"unknown tag !<"+t.tag+">"),t.result!==null&&k.kind!==t.kind&&w(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+k.kind+'", not "'+t.kind+'"'),k.resolve(t.result,t.tag)?(t.result=k.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):w(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function zl(t){var n=t.position,e,r,i,s=!1,a;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(a=t.input.charCodeAt(t.position))!==0&&(D(t,!0,-1),a=t.input.charCodeAt(t.position),!(t.lineIndent>0||a!==37));){for(s=!0,a=t.input.charCodeAt(++t.position),e=t.position;a!==0&&!V(a);)a=t.input.charCodeAt(++t.position);for(r=t.input.slice(e,t.position),i=[],r.length<1&&w(t,"directive name must not be less than one character in length");a!==0;){for(;ze(a);)a=t.input.charCodeAt(++t.position);if(a===35){do a=t.input.charCodeAt(++t.position);while(a!==0&&!ie(a));break}if(ie(a))break;for(e=t.position;a!==0&&!V(a);)a=t.input.charCodeAt(++t.position);i.push(t.input.slice(e,t.position))}a!==0&&vi(t),ke.call(rs,r)?rs[r](t,r,i):br(t,'unknown document directive "'+r+'"')}if(D(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,D(t,!0,-1)):s&&w(t,"directives end mark is expected"),dt(t,t.lineIndent-1,yr,!1,!0),D(t,!0,-1),t.checkLineBreaks&&El.test(t.input.slice(n,t.position))&&br(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&$r(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,D(t,!0,-1));return}if(t.position<t.length-1)w(t,"end of the stream or a document separator is expected");else return}function Ss(t,n){t=String(t),n=n||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Pl(t,n),r=t.indexOf("\0");for(r!==-1&&(e.position=r,w(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)zl(e);return e.documents}function Wl(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var r=Ss(t,e);if(typeof n!="function")return r;for(var i=0,s=r.length;i<s;i+=1)n(r[i])}function Ul(t,n){var e=Ss(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new q("expected a single document in the stream, but found more")}}var Bl=Wl,ql=Ul,Cs={loadAll:Bl,load:ql},Ts=Object.prototype.toString,Ls=Object.prototype.hasOwnProperty,bi=65279,Vl=9,Dt=10,Kl=13,Yl=32,Gl=33,Ql=34,pi=35,Jl=37,Xl=38,Zl=39,ed=42,Rs=44,td=45,xr=58,rd=61,id=62,nd=63,sd=64,Ps=91,Ds=93,ad=96,As=123,od=124,Hs=125,j={};j[0]="\\0";j[7]="\\a";j[8]="\\b";j[9]="\\t";j[10]="\\n";j[11]="\\v";j[12]="\\f";j[13]="\\r";j[27]="\\e";j[34]='\\"';j[92]="\\\\";j[133]="\\N";j[160]="\\_";j[8232]="\\L";j[8233]="\\P";var ld=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],dd=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function cd(t,n){var e,r,i,s,a,o,c;if(n===null)return{};for(e={},r=Object.keys(n),i=0,s=r.length;i<s;i+=1)a=r[i],o=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),c=t.compiledTypeMap.fallback[a],c&&Ls.call(c.styleAliases,o)&&(o=c.styleAliases[o]),e[a]=o;return e}function ud(t){var n,e,r;if(n=t.toString(16).toUpperCase(),t<=255)e="x",r=2;else if(t<=65535)e="u",r=4;else if(t<=4294967295)e="U",r=8;else throw new q("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+H.repeat("0",r-n.length)+n}var hd=1,At=2;function pd(t){this.schema=t.schema||_s,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=H.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=cd(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?At:hd,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function ss(t,n){for(var e=H.repeat(" ",n),r=0,i=-1,s="",a,o=t.length;r<o;)i=t.indexOf(`
`,r),i===-1?(a=t.slice(r),r=o):(a=t.slice(r,i+1),r=i+1),a.length&&a!==`
`&&(s+=e),s+=a;return s}function mi(t,n){return`
`+H.repeat(" ",t.indent*n)}function md(t,n){var e,r,i;for(e=0,r=t.implicitTypes.length;e<r;e+=1)if(i=t.implicitTypes[e],i.resolve(n))return!0;return!1}function wr(t){return t===Yl||t===Vl}function Ht(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==bi||65536<=t&&t<=1114111}function as(t){return Ht(t)&&t!==bi&&t!==Kl&&t!==Dt}function os(t,n,e){var r=as(t),i=r&&!wr(t);return(e?r:r&&t!==Rs&&t!==Ps&&t!==Ds&&t!==As&&t!==Hs)&&t!==pi&&!(n===xr&&!i)||as(n)&&!wr(n)&&t===pi||n===xr&&i}function fd(t){return Ht(t)&&t!==bi&&!wr(t)&&t!==td&&t!==nd&&t!==xr&&t!==Rs&&t!==Ps&&t!==Ds&&t!==As&&t!==Hs&&t!==pi&&t!==Xl&&t!==ed&&t!==Gl&&t!==od&&t!==rd&&t!==id&&t!==Zl&&t!==Ql&&t!==Jl&&t!==sd&&t!==ad}function gd(t){return!wr(t)&&t!==xr}function Rt(t,n){var e=t.charCodeAt(n),r;return e>=55296&&e<=56319&&n+1<t.length&&(r=t.charCodeAt(n+1),r>=56320&&r<=57343)?(e-55296)*1024+r-56320+65536:e}function Os(t){var n=/^\n* /;return n.test(t)}var Ns=1,fi=2,Fs=3,Is=4,at=5;function _d(t,n,e,r,i,s,a,o){var c,h=0,p=null,f=!1,_=!1,y=r!==-1,k=-1,E=fd(Rt(t,0))&&gd(Rt(t,t.length-1));if(n||a)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Rt(t,c),!Ht(h))return at;E=E&&os(h,p,o),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Rt(t,c),h===Dt)f=!0,y&&(_=_||c-k-1>r&&t[k+1]!==" ",k=c);else if(!Ht(h))return at;E=E&&os(h,p,o),p=h}_=_||y&&c-k-1>r&&t[k+1]!==" "}return!f&&!_?E&&!a&&!i(t)?Ns:s===At?at:fi:e>9&&Os(t)?at:a?s===At?at:fi:_?Is:Fs}function vd(t,n,e,r,i){t.dump=(function(){if(n.length===0)return t.quotingType===At?'""':"''";if(!t.noCompatMode&&(ld.indexOf(n)!==-1||dd.test(n)))return t.quotingType===At?'"'+n+'"':"'"+n+"'";var s=t.indent*Math.max(1,e),a=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),o=r||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return md(t,h)}switch(_d(n,o,t.indent,a,c,t.quotingType,t.forceQuotes&&!r,i)){case Ns:return n;case fi:return"'"+n.replace(/'/g,"''")+"'";case Fs:return"|"+ls(n,t.indent)+ds(ss(n,s));case Is:return">"+ls(n,t.indent)+ds(ss(yd(n,a),s));case at:return'"'+bd(n)+'"';default:throw new q("impossible error: invalid scalar style")}})()}function ls(t,n){var e=Os(t)?String(n):"",r=t[t.length-1]===`
`,i=r&&(t[t.length-2]===`
`||t===`
`),s=i?"+":r?"":"-";return e+s+`
...
`:""}var Sd=Ed,Cd={dump:Sd};function xi(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Ms=Cs.load,Th=Cs.loadAll,kr=Cd.dump;var Lh=xi("safeLoad","load"),Rh=xi("safeLoadAll","loadAll"),Ph=xi("safeDump","dump");var ne=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>si(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let i=this._currentFields()?.[e.name]?.description;return typeof i=="string"?i:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=kr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=kr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=kr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Ms(e)}catch(c){this._yamlError=c.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(c=>typeof c=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,L(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){return N(this.hass,e)}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.hasOwn(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,u([m({attribute:!1})],We.prototype,"hass",2),u([m({attribute:!1})],We.prototype,"value",2),We=u([x("ambience-time-endpoint")],We);function Ld(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function Rd(t,n){if(t===0)return"";let e=Math.abs(t),r=t<0?"\u2212":"+";if(e%60===0){let i=e/60,s=i===1?d(n,"ui.unit_hour","hour"):d(n,"ui.unit_hours","hours");return`${r}${i} ${s}`}return`${r}${e} ${d(n,"ui.unit_min","min")}`}function ct(t){return t.scope_kind==="house"?"House":t.scope_kind==="floor"?`Floor: ${t.scope_id??""}`:t.scope_id??""}function Er(t,n){if(!t)return[];let e=Object.keys(t.builtins??{}),r=n?e.slice().sort(n):e,i=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(a=>!(a in(t.builtins??{})));return[...r.filter(a=>!i.has(a)),...s]}var se=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}static{this.styles=v`
    :host { display: block; }
...
`,Wd={has_time:"Periodic time check",switch:"Switch turned on",manual:"Manual apply",startup:"Startup",reapply:"Periodic refresh",simulated:"Simulation"},Ud={clock:"Time of day",sun:"Sun position"};function Xs(t){if(t.kind==="entity")return`${t.entity_id} ${t.old} \u2192 ${t.new}`;if(t.kind==="duration")return`${t.entity_id} ${t.new} for ${t.detail}`;let n=Wd[t.kind];if(n)return n;let e=Ud[t.kind]??_e(t.kind);return t.detail?`${e} ${t.detail}`:e}function Zs(t){return t.kind==="entity"||t.kind==="duration"}function Bd(t,n){if(!Zs(t))return Xs(t);let e=t.entity_id?ai(n,t.entity_id):"?",r=t.entity_id?n?.states?.[t.entity_id]:void 0,i=s=>s===null?"?":Je(n,r,null,s);return t.kind==="duration"?`${e}: ${i(t.new)} for ${t.detail??"?"}`:`${e}: ${i(t.old)} \u2192 ${i(t.new)}`}var qd={acted:"applied",no_op:"blocked",debounced:"unchanged",no_match:"no match",reapplied:"refreshed",skipped_switch_off:"skipped",skipped_scope_disabled:"skipped"};function Vd(t){return qd[t]??t.replace(/_/g," ")}function ea(t){let n=t.winner_name??"The matching scene";switch(t.outcome){case"acted":{let e=Ci(t.actions.length,"action","actions"),r=ta(t.actions);return r?`Applied ${n} \u2014 ${e} on ${Ci(r,"entity","entities")}.`:`Applied ${n} \u2014 ${e}.`}case"no_op":return`${n} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.`;case"debounced":return`${n} matched, but it's already applied \u2014 nothing was re-sent.`;case"no_match":return"No scene matched \u2014 nothing applied.";case"reapplied":return`Periodic refresh re-sent ${n}'s actions.`;case"skipped_switch_off":return"Skipped \u2014 the category switch is off.";case"skipped_scope_disabled":return"Skipped \u2014 the scope is disabled.";default:return""}}function Kd(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,a])=>`${Tt(s,t.service,e)}: ${we(n,a)}`).join(", "),i=yt(t.service);return r?`${i} \xB7 ${r}`:i}function ta(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function Ci(t,n,e){return`${t} ${t===1?n:e}`}function Yd(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"}function Gd(t,n){let e=t.index+1;return t.disabled?l`<div class="scene disabled">Scene #${e} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
    ...
    ${t.predicates.map(r=>l`
        <div class="pred ${r.passed?"pass":"fail"}" style="padding-left:1rem">
          ${r.passed?"\u2713":"\u2717"} ${Y(n,r.condition_key)}${r.detail?l` <span class="dim">[${zd(n,r.condition_key,r.detail)}]</span>`:$}
        </div>`)}
  `:l`<div class="scene skipped">Scene #${e} ${t.name??"\u2014"}: not reached</div>`}function Rr(t,n,e,r,i){let s=t.actions.map(h=>yt(h.service)).join(", "),a=ta(t.actions),o=t.explanation!==null||t.actions.length>0||Yd(t.outcome),c=h=>{(h.key==="Enter"||h.key===" ")&&!h.repeat&&(h.preventDefault(),e())};return l`
    <div class="eval">
      <div
        ...
        @keydown=${o?c:void 0}
      >
        <span class="label">${Vd(t.outcome)}</span>
        <span class="ts">${t.timestamp?new Date(t.timestamp).toLocaleTimeString():""}</span>
      </div>
      <div class="eval-body">
        <div class="cause-line">Trigger: ${Bd(t.cause,r)}</div>
        ${t.winner_name?l`<div class="won">Won: <span class="name">${t.winner_name}</span></div>`:$}
        ${t.actions.length?l`<div class="action-summary">→ ${s}
              ${a?l`<span class="n">· ${Ci(a,"entity","entities")}</span>`:$}</div>`:n?$:l`<div class="action-summary">${ea(t)}</div>`}
      </div>
      ${n?Qd(t,r,i):$}
    </div>
  `}function Qd(t,n,e){let r=ea(t),i=Zs(t.cause);return l`
    <div class="why">
      ${i?l`<div class="raw-trigger">Trigger: ${Xs(t.cause)}</div>`:$}
...
`,ee=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=It}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!tc.test(e)?d(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?d(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":d(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??rc(this._label),r=this._validateName(e)||this._validateDef();if(r){this._error=r,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return l`
  ...
  `,u([m({attribute:!1})],Re.prototype,"hass",2),u([g()],Re.prototype,"_config",2),u([g()],Re.prototype,"_warnings",2),Re=u([x("ambience-day-config")],Re);var ic=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],fe=class extends b{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),this._config=await $t(this.hass)}async _persist(){let e=await wn(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[],window.dispatchEvent(new CustomEvent("ambience-conditions-changed"))}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:ic.map(e=>({value:e,label:et(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
    ...
    .warnings ul { margin: 0.3rem 0 0 0; padding-left: 1.2rem; }
  `,u([m({attribute:!1})],fe.prototype,"hass",2),u([g()],fe.prototype,"_config",2),u([g()],fe.prototype,"_warnings",2),u([g()],fe.prototype,"_expanded",2),fe=u([x("ambience-weather-config")],fe);var oa={time_of_day:t=>l`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>l`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>l`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>l`<ambience-weather-config .hass=${t}></ambience-weather-config>`},nc=new Set(Object.keys(oa)),Pe=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await tr(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._conditions.filter(r=>nc.has(r.name)).slice().sort((r,i)=>i.priority-r.priority);return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      ${e.map(r=>l`
        <ambience-condition-card .hass=${this.hass} .conditionName=${r.name} .conditionDescription=${r.description}>
          ${oa[r.name]?.(this.hass)??l``}
