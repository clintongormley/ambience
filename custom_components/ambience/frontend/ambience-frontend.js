...
`;function bt(t,r){return l`<span class="category-swatch" style=${zi(t)}>
    ...
    `],c([m({attribute:!1})],pe.prototype,"hass",2),c([_()],pe.prototype,"_categories",2),c([_()],pe.prototype,"_filterCategory",2),c([_()],pe.prototype,"_open",2),c([_()],pe.prototype,"_loaded",2),pe=c([w("ambience-category-filter")],pe);var Ee={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ui=t=>(...r)=>({_$litDirective$:t,values:r}),wt=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,i){this._$Ct=r,this._$AM=e,this._$Ci=i}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var{I:Tl}=Jn,uo=t=>t;var po=t=>t.strings===void 0,ho=()=>document.createComment(""),xt=(t,r,e)=>{let i=t._$AA.parentNode,n=r===void 0?t._$AB:r._$AA;if(e===void 0){let s=i.insertBefore(ho(),n),o=i.insertBefore(ho(),n);e=new Tl(s,o,t,t.options)}else{let s=e._$AB.nextSibling,o=e._$AM,d=o!==t;if(d){let u;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(u=t._$AU)!==o._$AU&&e._$AP(u)}if(s!==n||d){let u=e._$AA;for(;u!==s;){let h=uo(u).nextSibling;uo(i).insertBefore(u,n),u=h}}}return e},Ie=(t,r,e=t)=>(t._$AI(r,e),t),Pl={},qi=(t,r=Pl)=>t._$AH=r,mo=t=>t._$AH,Wi=t=>{t._$AR(),t._$AA.remove()};var fo=(t,r,e)=>{let i=new Map;for(let n=r;n<=e;n++)i.set(t[n],n);return i},_o=Ui(class extends wt{constructor(t){if(super(t),t.type!==Ee.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,r,e){let i;e===void 0?e=r:r!==void 0&&(i=r);let n=[],s=[],o=0;for(let d of t)n[o]=i?i(d,o):o,s[o]=e(d,o),o++;return{values:s,keys:n}}render(t,r,e){return this.dt(t,r,e).values}update(t,[r,e,i]){let n=mo(t),{values:s,keys:o}=this.dt(r,e,i);if(!Array.isArray(n))return this.ut=o,s;let d=this.ut??=[],u=[],h,p,f=0,g=n.length-1,v=0,x=s.length-1;for(;f<=g&&v<=x;)if(n[f]===null)f++;else if(n[g]===null)g--;else if(d[f]===o[v])u[v]=Ie(n[f],s[v]),f++,v++;else if(d[g]===o[x])u[x]=Ie(n[g],s[x]),g--,x--;else if(d[f]===o[x])u[x]=Ie(n[f],s[x]),xt(t,u[x+1],n[f]),f++,x--;else if(d[g]===o[v])u[v]=Ie(n[g],s[v]),xt(t,n[f],n[g]),g--,v++;else if(h===void 0&&(h=fo(o,v,x),p=fo(d,f,g)),h.has(d[f]))if(h.has(d[g])){let C=p.get(o[v]),P=C!==void 0?n[C]:null;if(P===null){let Q=xt(t,n[f]);Ie(Q,s[v]),u[v]=Q}else u[v]=Ie(P,s[v]),xt(t,n[f],P),n[C]=null;v++}else Wi(n[g]),g--;else Wi(n[f]),f++;for(;v<=x;){let C=xt(t,u[x+1]);Ie(C,s[v]),u[v++]=C}for(;f<=g;){let C=n[f++];C!==null&&Wi(C)}return this.ut=o,qi(t,u),J}});function Vi(t,r){let e=t.entities?.[r];return e?e.area_id!=null?e.area_id:e.device_id?t.devices?.[e.device_id]?.area_id??null:null:null}function D(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function Bi(t,r){return r==null?{kind:"house"}:{kind:t,id:r}}function go(t,r){return`${D(t)}\0${r}`}function Se(t,r){return go(t,r)}function Gi(t,r){return go(t,r)}function vo(t,r){if(!r||r.entity==null)return[...t];let e=Array.isArray(r.entity)?r.entity:[r.entity];if(e.length===0)return[...t];let i=new Set,n=!1;for(let s of e){if(!s||typeof s!="object")continue;let o=s.domain;if(o==null){n=!0;continue}if(Array.isArray(o))for(let d of o)typeof d=="string"&&i.add(d);else typeof o=="string"&&i.add(o)}return n||i.size===0?[...t]:t.filter(s=>{let o=s.indexOf(".");return o<0?!1:i.has(s.slice(0,o))})}function Ki(t,r,e=[]){let i=t;if(!i?.entities)return[];let n=i.entities,s=i.areas??{},o=r.kind==="area"?new Set([r.id]):r.kind==="floor"?new Set(Object.values(s).filter(u=>u.floor_id===r.id).map(u=>u.area_id)):null,d=u=>{let h=Vi(i,u.entity_id);return h==null?!1:o===null?!0:o.has(h)};return Object.values(n).filter(d).filter(u=>u.platform!=="ambience").filter(u=>e.length===0||e.includes(u.entity_id.split(".")[0])).map(u=>u.entity_id).sort()}var Qr=Ui(class extends wt{constructor(t){if(super(t),t.type!==Ee.PROPERTY&&t.type!==Ee.ATTRIBUTE&&t.type!==Ee.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!po(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[r]){if(r===J||r===$)return r;let e=t.element,i=t.name;if(t.type===Ee.PROPERTY){if(r===e[i])return J}else if(t.type===Ee.BOOLEAN_ATTRIBUTE){if(!!r===e.hasAttribute(i))return J}else if(t.type===Ee.ATTRIBUTE&&e.getAttribute(i)===r+"")return J;return qi(t),r}});function $t(t){let{checked:r,dataTest:e,onChange:i,className:n,onClick:s,disabled:o}=t;return customElements.get("ha-switch")?l`<ha-switch
      class=${n??$}
      data-test=${e}
      ?disabled=${o??!1}
      .checked=${Qr(r)}
    ...
    @click=${s}
    @change=${i}
  />`}function Yt(t){let{priority:r,pinned:e,shadowed_by:i,...n}=t;return n}function yo(t,r){if(r<0||r>=t.length)return[];let e=new Set(t[r].entity_ids??[]),i=new Set;return t.forEach((n,s)=>{if(s!==r)for(let o of n.entity_ids??[])e.has(o)||i.add(o)}),[...i]}var Jr={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Qt(t,r){return t.kind==="house"?Jr.house:t.kind==="floor"?r?.floors?.[t.id]?.icon||Jr.floor:r?.areas?.[t.id]?.icon||Jr.area}var bo=y`
  .banner {
    display: flex;
...
`)});return`${Xr}/issues/new?${e.toString()}`}var Rl="Ambience",nt=class extends b{constructor(){super(...arguments);this._visible=!1;this._href="";this._message="";this._actionLabel="";this._dismissLabel="";this._code="";this._dismissedCodes=new Set}willUpdate(e){if(!e.has("hass"))return;let i=is(this.hass);if(i.available||this._dismissedCodes.has(i.code)||Ss(i.code)){this._visible=!1;return}this._code=i.code;let n=rs(i.code);this._href=wo(i.code,n),this._message=this._buildMessage(n),this._actionLabel=a(this.hass,"ui.language_request.action","Request a translation \u2192"),this._dismissLabel=a(this.hass,"ui.language_request.dismiss","Dismiss"),this._visible=!0}_dismiss(){this._dismissedCodes.add(this._code),As(this._code),this._visible=!1}_buildMessage(e){let n=a(this.hass,"ui.language_request.message","Your Home Assistant language is {language}, but {product} isn't translated into it yet.").split(/\{(language|product)\}/).map((s,o)=>o%2===0?s:l`<strong>${s==="language"?e:Rl}</strong>`);return l`<span class="message">${n}</span>`}render(){return this._visible?l`
      <ambience-banner
  ...
  `,c([m({attribute:!1})],nt.prototype,"hass",2),c([_()],nt.prototype,"_visible",2),nt=c([w("ambience-language-banner")],nt);function Yi(t){if(t.enabled===!1)return{severity:null,missing:[],overlap:[],shadowed:!1,configIssues:[]};let r=t.missing_entities??[],e=t.overlap_entities??[],i=t.config_issues??[],n=t.shadowed_by!=null;return{severity:r.length>0||i.length>0?"error":e.length>0||n?"warning":null,missing:r,overlap:e,shadowed:n,configIssues:i}}function xo(t){let r=null;for(let e of t){let i=Yi(e).severity;if(i==="error")return"error";i==="warning"&&(r="warning")}return r}function $o(t){return t.filter(r=>Yi(r).severity!=null).length}var Dl={missing_workday_sensor:["ui.badge_needs_workday_sensor","needs a workday sensor"],missing_workday_calendar:["ui.badge_needs_workday_calendar","needs a workday calendar"],missing_weather_entity:["ui.badge_needs_weather_entity","needs a weather entity"],missing_weather_group:["ui.badge_missing_weather_group","missing weather group {id}"],missing_period:["ui.badge_missing_period","missing period {id}"],missing_lux_range:["ui.badge_missing_lux_range","missing lux range {id}"],unexposed_action:["ui.badge_unexposed_action","action {id} not exposed"]};function ko(t,r){let e=Dl[r.kind];return(e?a(t,e[0],e[1]):r.kind).replace("{id}",r.ref)}var kt=null;function Qi(t,r){let e=xo(r);if(!e)return"";let i=$o(r),n=a(t,"ui.problems_count","{n} scene(s) have problems").replace("{n}",String(i));return l`<ambience-problem-flag
    .severity=${e}
    .details=${[n]}
    .summary=${n}
...
`)}
  ...
  `,c([m({attribute:!1})],N.prototype,"scenes",2),c([m({attribute:!1})],N.prototype,"periods",2),c([m({attribute:!1})],N.prototype,"luxRanges",2),c([m({attribute:!1})],N.prototype,"weatherConfig",2),c([m({attribute:!1})],N.prototype,"hass",2),c([m({attribute:!1})],N.prototype,"conditions",2),c([m({attribute:!1})],N.prototype,"availableActions",2),c([m({attribute:!1})],N.prototype,"schemas",2),c([m({attribute:!1})],N.prototype,"categories",2),c([m({attribute:!1})],N.prototype,"filterCategory",2),c([m({attribute:!1})],N.prototype,"collapsedCategories",2),c([m({attribute:!1})],N.prototype,"scope",2),c([m({attribute:!1})],N.prototype,"live",2),c([m({attribute:!1})],N.prototype,"liveSuppressed",2),c([_()],N.prototype,"_expanded",2),N=c([w("ambience-scenes-list")],N);var fe=class extends b{constructor(){super(...arguments);this.entities=[];this.value=[];this.target=null;this.label=" "}_filteredEntities(){return vo(this.entities,this.target)}connectedCallback(){super.connectedCallback(),ie(this)}_emit(e){A(this,e)}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let i=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this._filteredEntities()}}}],n=this.label;return l`
      <ha-form
        .hass=${this.hass}
        .schema=${i}
  ...
  `,c([m({attribute:!1})],U.prototype,"hass",2),c([m({attribute:!1})],U.prototype,"scope",2),c([m({attribute:!1})],U.prototype,"exposed",2),c([m({attribute:!1})],U.prototype,"service",2),c([m({attribute:!1})],U.prototype,"entityIds",2),c([m({attribute:!1})],U.prototype,"params",2),c([m({attribute:!1})],U.prototype,"excludeEntities",2),c([_()],U.prototype,"_schema",2),c([_()],U.prototype,"_schemaError",2),c([_()],U.prototype,"_exposedMissing",2),c([_()],U.prototype,"_formSchema",2),c([_()],U.prototype,"_perFieldSchemas",2),U=c([w("ambience-action-slot")],U);function Jo(t){return typeof t>"u"||t===null}function rd(t){return typeof t=="object"&&t!==null}function nd(t){return Array.isArray(t)?t:Jo(t)?[]:[t]}function sd(t,r){var e,i,n,s;if(r)for(s=Object.keys(r),e=0,i=s.length;e<i;e+=1)n=s[e],t[n]=r[n];return t}function od(t,r){var e="",i;for(i=0;i<r;i+=1)e+=t;return e}function ad(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var ld=Jo,dd=rd,cd=nd,ud=od,hd=ad,pd=sd,M={isNothing:ld,isObject:dd,toArray:cd,repeat:ud,isNegativeZero:hd,extend:pd};function Xo(t,r){var e="",i=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!r&&t.mark.snippet&&(e+=`
...
`;var ge=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>rn(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let n=this._currentFields()?.[e.name]?.description;return typeof n=="string"?n:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=fr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=fr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=fr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=mr(e)}catch(u){this._yamlError=u.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=a(this.hass,"ui.yaml_expect_object","Expected an object");return}let n=i,s=n.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=a(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=n.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=a(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let d=n.triggers;if(d!==void 0&&(!Array.isArray(d)||!d.every(u=>typeof u=="string"))){this._yamlError=a(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:d})}_emit(e){this.value=e,A(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(n=>`script.${n}`)}_label(e){return je(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},n={};for(let[s,o]of Object.entries(i))o&&Object.hasOwn(o,"default")&&(n[s]=o.default);return n}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,n])=>({name:i,required:n.required,selector:n.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),n=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return l`
  ...
  `,c([m({attribute:!1})],qe.prototype,"hass",2),c([m({attribute:!1})],qe.prototype,"value",2),c([m({attribute:!1})],qe.prototype,"dayConfig",2),qe=c([w("ambience-day-predicate-input")],qe);var Aa=["temperature","apparent_temperature","humidity","wind_speed","pressure"],La=["<","<=",">",">="],Ta={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},Te=class extends b{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let i=e.groups.length===0&&e.thresholds.length===0;this.value=i?null:e,A(this,this.value)}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,i){let n=this._current();n.thresholds=n.thresholds.map((s,o)=>o===e?i:s),this._emit(n)}_removeThreshold(e){let i=this._current();i.thresholds=i.thresholds.filter((n,s)=>s!==e),this._emit(i)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:Aa.map(i=>({value:i,label:Ut(this.hass,i)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:La.map(i=>({value:i,label:Ta[i]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,i){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Fr(this.hass,i,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
        .hass=${this.hass}
      ...
      ${Aa.map(n=>l`<option value=${n} ?selected=${n===i.attribute}>${Ut(this.hass,n)}</option>`)}
      ...
      ${La.map(n=>l`<option value=${n} ?selected=${n===i.op}>${Ta[n]}</option>`)}
  ...
  `,c([m({attribute:!1})],Te.prototype,"hass",2),c([m({attribute:!1})],Te.prototype,"value",2),c([m({attribute:!1})],Te.prototype,"groups",2),c([m({attribute:!1})],Te.prototype,"weatherEntity",2),Te=c([w("ambience-weather-predicate-input")],Te);var Ru=["NW","N","NE","W",null,"E","SW","S","SE"],dt=class extends b{constructor(){super(...arguments);this.value=null}_current(){let e=this.value?.azimuth?.ranges??[];return{elevation:this.value?.elevation??null,sectors:[...this.value?.azimuth?.sectors??[]],range:e.length?{...e[0]}:null}}_emit(e){let i={};e.elevation&&(e.elevation.min!=null||e.elevation.max!=null)&&(i.elevation=e.elevation);let n={};e.sectors.length&&(n.sectors=e.sectors),e.range&&(n.ranges=[e.range]),(n.sectors||n.ranges)&&(i.azimuth=n),this.value=i.elevation||i.azimuth?i:null,A(this,this.value)}_setElevation(e){this._emit({...this._current(),elevation:e})}_setSectors(e){this._emit({...this._current(),sectors:e})}_setRange(e){this._emit({...this._current(),range:e})}_mode(e){return!e||e.min==null&&e.max==null?"any":e.min!=null&&e.max!=null?"between":e.min!=null?"above":"below"}_onModeChange(e,i){let n=i?.min??0,s=i?.max??0;e==="any"?this._setElevation(null):e==="above"?this._setElevation({min:n}):e==="below"?this._setElevation({max:s}):this._setElevation({min:n,max:s})}_toggleSector(e,i,n){this._setSectors(n?[...e,i]:e.filter(s=>s!==i))}_renderSectors(e){return l`<div class="sectors">${Ru.map(i=>i===null?l`<span class="spacer"></span>`:l`<label>
  ...
  `,c([m({attribute:!1})],ct.prototype,"hass",2),c([m({attribute:!1})],ct.prototype,"value",2),ct=c([w("ambience-people-predicate-input")],ct);var ut=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[]}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_build(e){let i={...this._cur(),...e},n={sensors:i.sensors??[]};if(i.occupied===!1&&(n.occupied=!1),i.quant==="all"&&(n.quant="all"),Jt(i.for)){n.for=i.for;let s=St(i.for,i.for_mode);s&&(n.for_mode=s)}return i.negate===!0&&(n.negate=!0),n}_emit(e){this.value=e,A(this,e)}_setSensors(e){this._emit(e.length?this._build({sensors:e}):null)}_setOccupied(e){this._emit(this._build({occupied:e}))}_setNegate(e){this._emit(this._build({negate:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setFor(e){let{mode:i,...n}=e;this._emit(this._build({for:n,for_mode:i??"at_least"}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"binary_sensor",device_class:["occupancy","presence","motion"],multiple:!0}}}]}_renderSensors(){return Ht(this.hass,this._sensorSchema(),this._sensors(),"binary_sensor.a, binary_sensor.b",e=>this._setSensors(e))}_renderNegate(e){return ne(this.hass,"negate",e?"is_not":"is",[{value:"is",label:a(this.hass,"ui.occupancy_is","is")},{value:"is_not",label:a(this.hass,"ui.occupancy_is_not","is not")}],i=>this._setNegate(i==="is_not"))}_renderOccupied(e){return ne(this.hass,"state",e?"occupied":"vacant",[{value:"occupied",label:a(this.hass,"ui.occupancy_detected","Detected")},{value:"vacant",label:a(this.hass,"ui.occupancy_clear","Clear")}],i=>this._setOccupied(i==="occupied"))}_renderQuant(e){return ne(this.hass,"quant",e,[{value:"any",label:a(this.hass,"ui.occupancy_any","Any of")},{value:"all",label:a(this.hass,"ui.occupancy_all","All of")}],i=>this._setQuant(i))}_renderFor(){return l`<ambience-for-duration
    ...
    .for-row { display: flex; gap: 0.25rem; align-items: center; }
    .for-row input[type='number'] { width: 3.5rem; }
  `,c([m({attribute:!1})],ut.prototype,"hass",2),c([m({attribute:!1})],ut.prototype,"value",2),ut=c([w("ambience-occupancy-predicate-input")],ut);function Ha(t,r){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?a(r,"ui.unavailable_select_one","Select at least one entity"):null}var Iu=[{name:"sensors",selector:{entity:{multiple:!0}}}],ht=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,A(this,i)}render(){return l`
      <div class="row">
        ${Ht(this.hass,Iu,this._entities(),"binary_sensor.a, light.b",e=>this._setEntities(e))}
      </div>
    `}};ht.styles=y`
    :host {
      display: block;
  ...
  `,c([m({attribute:!1})],Ve.prototype,"value",2),c([m({attribute:!1})],Ve.prototype,"hass",2),c([_()],Ve.prototype,"_preview",2),Ve=c([w("ambience-template-predicate-input")],Ve);var oe=class extends b{constructor(){super(...arguments);this.value=null;this._onChild=e=>{e.stopPropagation(),this._emit(e.detail.value)}}_emit(e){A(this,e)}_onText(e){let i=e.target.value;this._emit(i.trim()===""?null:i)}render(){return this.condition.input==="time_of_day"?l`
...
`;function Oa(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function Rn(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Oa(n,r))};return l`<span
    class="entity-link"
    role="button"
    tabindex="0"
    ...
    @keydown=${i}
    >${e}</span
  >`}function Ma(t,r){return Rn(t,r,je(t,r))}var Uu=new Set(["occupancy","people","lux","state"]);function qu(t,r,e,i,n){let s=ju(t,r,e,i);if(!n?.length||!Uu.has(r))return s;let o=[],d=n.map(p=>({id:p,name:je(t,p)})).sort((p,f)=>f.name.length-p.name.length);for(let{id:p,name:f}of d)for(let g=0;g<=s.length;){let v=s.indexOf(f,g);if(v===-1)break;let x=v+f.length;if(!o.some(C=>v<C.end&&C.start<x)){o.push({start:v,end:x,id:p,name:f});break}g=v+1}if(o.length===0)return s;o.sort((p,f)=>p.start-f.start);let u=[],h=0;for(let p of o)p.start>h&&u.push(s.slice(h,p.start)),u.push(Rn(t,p.id,p.name)),h=p.end;return h<s.length&&u.push(s.slice(h)),l`${u}`}var Wu={has_time:["ui.cause_has_time","Periodic time check"],switch:["ui.cause_switch","Switch turned on"],manual:["ui.cause_manual","Manual apply"],startup:["ui.cause_startup","Startup"],reloaded:["ui.cause_reloaded","Reloaded"],simulated:["ui.cause_simulated","Simulation"]},Vu={clock:["ui.cause_clock","Time of day"],sun:["ui.cause_sun","Sun position"],reapply:["ui.cause_reapply","Re-run"]};function be(t){return t??"?"}function Fa(t,r){if(r.kind==="entity")return`${r.entity_id} ${be(r.old)} \u2192 ${be(r.new)}`;if(r.kind==="duration"){let s=a(t,"ui.cause_duration_for","for");return r.entity_id?`${r.entity_id} ${be(r.new)} ${s} ${be(r.detail)}`:`${be(r.new)} ${s} ${be(r.detail)}`}let e=Wu[r.kind];if(e)return a(t,e[0],e[1]);let i=Vu[r.kind],n=i?a(t,i[0],i[1]):z(r.kind);return r.detail?`${n} ${r.detail}`:n}function Bu(t,r){if(!wr(r)||!r.entity_id)return l`${Fa(t,r)}`;let e=Rn(t,r.entity_id,r.entity_id);return r.kind==="duration"?l`${e} ${be(r.new)} ${a(t,"ui.cause_duration_for","for")} ${be(r.detail)}`:l`${e} ${be(r.old)} → ${be(r.new)}`}function wr(t){return t.kind==="entity"||t.kind==="duration"&&!!t.entity_id}function za(t,r){let e=t.entity_id?r?.states?.[t.entity_id]:void 0,i=n=>n===null?"?":Re(r,e,null,n);return{old:i(t.old),new:i(t.new)}}function Gu(t,r){if(!wr(t))return Fa(r,t);let e=t.entity_id?je(r,t.entity_id):"?",i=za(t,r);return t.kind==="duration"?`${e}: ${i.new} ${a(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:`${e}: ${i.old} \u2192 ${i.new}`}function Ku(t,r){if(!wr(t)||!t.entity_id)return l`${Gu(t,r)}`;let e=Ma(r,t.entity_id),i=za(t,r);return t.kind==="duration"?l`${e}: ${i.new} ${a(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:l`${e}: ${i.old} → ${i.new}`}var Yu={acted:["ui.outcome_label_acted","applied"],no_op:["ui.outcome_label_no_op","blocked"],debounced:["ui.outcome_label_debounced","unchanged"],no_match:["ui.outcome_label_no_match","no match"],skipped_switch_off:["ui.outcome_label_skipped","skipped"],skipped_scope_disabled:["ui.outcome_label_skipped","skipped"],skipped_unavailable:["ui.outcome_label_skipped","skipped"]};function Qu(t,r){let e=Yu[r];return e?a(t,e[0],e[1]):r.replace(/_/g," ")}function yr(t,r,e,i,n,s){return r===1?a(t,e,n,{n:String(r)}):a(t,i,s,{n:String(r)})}function ja(t,r){let e=r.winner_name??a(t,"ui.winner_default","The matching scene");switch(r.outcome){case"acted":{let i=r.actions.filter(h=>!h.unexposed),n=r.actions.length-i.length;if(i.length===0&&n){let h=yr(t,n,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions");return a(t,"ui.outcome_summary_acted_all_skipped","{winner} matched \u2014 {skipped_phrase} skipped (not exposed); nothing applied.",{winner:e,skipped_phrase:h})}let s=yr(t,i.length,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions"),o=qa(i),d=n?a(t,"ui.outcome_summary_skipped_tail"," ({skipped} skipped \u2014 not exposed)",{skipped:String(n)}):"",u=yr(t,o,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities");return o?a(t,"ui.outcome_summary_acted_entities","Applied {winner} \u2014 {acts} on {entities}.{tail}",{winner:e,acts:s,entities:u,tail:d}):a(t,"ui.outcome_summary_acted","Applied {winner} \u2014 {acts}.{tail}",{winner:e,acts:s,tail:d})}case"no_op":return a(t,"ui.outcome_summary_no_op","{winner} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.",{winner:e});case"debounced":return a(t,"ui.outcome_summary_debounced","{winner} matched, but it's already applied \u2014 nothing was re-sent.",{winner:e});case"no_match":return a(t,"ui.outcome_summary_no_match","No scene matched \u2014 nothing applied.");case"skipped_switch_off":return a(t,"ui.outcome_summary_skipped_switch_off","Skipped \u2014 the scope's pause switch is off.");case"skipped_scope_disabled":return a(t,"ui.outcome_summary_skipped_scope_disabled","Skipped \u2014 the scope is disabled.");case"skipped_unavailable":return a(t,"ui.outcome_summary_skipped_unavailable","Skipped \u2014 the triggering entity went unavailable; devices left as they are.");default:return""}}function Ua(t,r,e){return gt(t,r,()=>e?.[t]?.name?.trim()||Li(t))}function Ju(t,r,e,i){let n=Object.entries(t.params??{}).filter(([,o])=>o!=null&&o!=="").map(([o,d])=>`${ii(o,t.service,e)}: ${Me(r,d)}`).join(", "),s=Ua(t.service,i,e);return n?`${s} \xB7 ${n}`:s}function qa(t){return t.reduce((r,e)=>r+(e.entity_ids?.length??0),0)}function Xu(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"||t==="skipped_unavailable"}function Zu(t,r,e){let i=t.index+1,n=a(r,"ui.trace_scene_prefix","Scene #");return t.disabled?l`<div class="scene disabled">${n}${i} ${t.name??"\u2014"}: ${a(r,"ui.trace_scene_disabled","disabled")}</div>`:t.evaluated?l`
  ...
  `:l`<div class="scene skipped">${n}${i} ${t.name??"\u2014"}: ${a(r,"ui.trace_scene_not_reached","not reached")}</div>`}function xr(t,r,e,i,n,s={},o){let d=t.actions.filter(g=>!g.unexposed),u=d.map(g=>Ua(g.service,o,n)).join(", "),h=qa(d),p=t.explanation!==null||t.actions.length>0||Xu(t.outcome),f=g=>{(g.key==="Enter"||g.key===" ")&&!g.repeat&&(g.preventDefault(),e())};return l`
    <div class="eval">
      <div
      ...
      <div class="eval-body">
        ...
        ${d.length?l`<div class="action-summary">→ ${u}
              ${h?l`<span class="n">· ${yr(i,h,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities")}</span>`:$}</div>`:r?$:l`<div class="action-summary">${ja(i,t)}</div>`}
      </div>
      ${r?eh(t,i,n,s,o):$}
    </div>
  `}function eh(t,r,e,i,n){let s=ja(r,t),o=wr(t.cause);return l`
    <div class="why">
  ...
  `}var Be=class{constructor(r,e){this._onKeydown=r=>{this._host.open&&r.key==="Escape"&&this._close()};this._onBackdrop=()=>{this._host.open&&this._close()};this._host=r,this._close=e,r.addController(this)}hostConnected(){document.addEventListener("keydown",this._onKeydown),this._host.addEventListener("click",this._onBackdrop)}hostDisconnected(){document.removeEventListener("keydown",this._onKeydown),this._host.removeEventListener("click",this._onBackdrop)}};var F=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1;new Be(this,()=>this._onClose())}disconnectedCallback(){super.disconnectedCallback(),this._stopPoll()}_startPoll(){this._poll||(this._poll=setInterval(()=>this._checkNew(),5e3))}_stopPoll(){this._poll&&(clearInterval(this._poll),this._poll=void 0)}_reloadTriggered(e){return this.open&&(e.has("open")||e.has("category")||e.has("scope"))}willUpdate(e){this._reloadTriggered(e)&&this._beginLoad()}updated(e){e.has("open")&&(this.open?this._startPoll():this._stopPoll()),this._reloadTriggered(e)&&this._fetch()}_mine(e){return e.filter(i=>i.scope_kind===this.scope.scope_kind&&i.scope_id===this.scope.scope_id&&i.category===this.category)}_beginLoad(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set}async _fetch(){try{let e=await Gr(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=E(this.hass,e),this._loading=!1}}_load(){return this._beginLoad(),this._fetch()}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(o=>o.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let i=await Promise.all(e.map(async s=>{try{return[s,await He(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let n={...this._schemas};for(let s of i)s&&(n[s[0]]=s[1]);this._schemas=n}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let i=this._mine(await Gr(this.hass))[0]?.timestamp??null,n=this._records[0]?.timestamp??null;i&&(!n||i>n)&&(this._hasNew=!0)}catch{}}_toggle(e){let i=new Set(this._expanded);i.has(e)?i.delete(e):i.add(e),this._expanded=i}async _clear(){try{await Qs(this.hass),await this._load()}catch(e){this._error=E(this.hass,e)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return $;let e=this.categoryName??this.category;return l`
    ...
    `],c([m({attribute:!1})],F.prototype,"hass",2),c([m({attribute:!1})],F.prototype,"periods",2),c([m({attribute:!1})],F.prototype,"exposedActions",2),c([m({attribute:!1})],F.prototype,"scope",2),c([m()],F.prototype,"category",2),c([m()],F.prototype,"categoryName",2),c([m({type:Boolean,reflect:!0})],F.prototype,"open",2),c([_()],F.prototype,"_records",2),c([_()],F.prototype,"_schemas",2),c([_()],F.prototype,"_expanded",2),c([_()],F.prototype,"_loading",2),c([_()],F.prototype,"_error",2),c([_()],F.prototype,"_hasNew",2),F=c([w("ambience-traces-modal")],F);var th={time:"mdi:clock-outline",sun:"mdi:weather-sunny"},K=class extends b{constructor(){super(...arguments);this.categoryName="";this.scenes=[];this.open=!1;this._triggers=[];this._opaque=!1;this._loading=!1;this._error="";this._loadSeq=0}willUpdate(e){super.willUpdate?.(e);let i=e.has("open")||e.has("scope")||e.has("category");this.open&&(i||e.has("scenes"))&&(i&&(this._triggers=[],this._opaque=!1),this._load())}get _scopeId(){return this.scope.kind==="house"?null:this.scope.id}async _load(){let e=++this._loadSeq;this._loading=!0,this._error="";try{let i=await Rs(this.hass,this.scope.kind,this._scopeId,this.category);if(e!==this._loadSeq)return;this._triggers=i.triggers,this._opaque=i.opaque}catch(i){if(e!==this._loadSeq)return;this._error=E(this.hass,i)}finally{e===this._loadSeq&&(this._loading=!1)}}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_openMoreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_entityName(e){return st(this.hass,e)}get _sortedTriggers(){let e=s=>this._entityName(s.entity_id).toLowerCase(),i=this._triggers.filter(s=>s.kind==="entity").sort((s,o)=>e(s).localeCompare(e(o))),n=this._triggers.filter(s=>s.kind!=="entity");return[...i,...n]}_sunPart(e){let i=re(this.hass,e.anchor);if(e.offset===0)return i;let n=a(this.hass,"ui.unit_min","min");return`${i} ${e.offset>0?"+":""}${e.offset} ${n}`}_rowContent(e){switch(e.kind){case"entity":return{title:this._entityName(e.entity_id),detail:e.entity_id};case"time":{let i=e.clocks.map(n=>`${String(n.hour).padStart(2,"0")}:${String(n.minute).padStart(2,"0")}`);return e.date_rollover&&i.push(a(this.hass,"ui.auto_trigger_date_rollover","Local midnight (date rollover)")),e.has_time&&i.push(a(this.hass,"ui.auto_trigger_periodic","periodic re-check")),{title:a(this.hass,"ui.auto_trigger_group_time","Time"),detail:i.join(", ")}}case"sun":return{title:a(this.hass,"ui.auto_trigger_group_sun","Sun"),detail:e.suns.map(i=>this._sunPart(i)).join(", ")}}}_renderRowIcon(e){return e.kind==="entity"?li(this.hass,e.entity_id):l`<ha-icon
      class="row-icon"
      icon=${th[e.kind]??wn}
  ...
  `,c([m({attribute:!1})],K.prototype,"hass",2),c([m({attribute:!1})],K.prototype,"scope",2),c([m()],K.prototype,"category",2),c([m()],K.prototype,"categoryName",2),c([m({attribute:!1})],K.prototype,"scenes",2),c([m({type:Boolean,reflect:!0})],K.prototype,"open",2),c([_()],K.prototype,"_triggers",2),c([_()],K.prototype,"_opaque",2),c([_()],K.prototype,"_loading",2),c([_()],K.prototype,"_error",2),K=c([w("ambience-auto-triggers-modal")],K);function Wa(t,r){return r==="not_home"?a(t,"ui.away","Away"):r==="home"?a(t,"ui.home","Home"):z(r)}function Va(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(r=>[r.name,r.live_value==null?"":String(r.live_value)])),for:{h:0,m:0,s:0}}}function kr(t){return String(t).padStart(2,"0")}function $r(t){return`${t.getFullYear()}-${kr(t.getMonth()+1)}-${kr(t.getDate())}`}function mi(t){return`${kr(t.getHours())}:${kr(t.getMinutes())}`}var T=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._whenMode="time";this._anchor="sunset";this._offset=0;this._anchors=null;this._anchorsDate="";this._anchorsError="";this._results=[];this._appliedIndex=null;this._expanded=new Set;this._running=!1;this._runToken=0;new Be(this,()=>this._onClose())}_reloadTriggered(e){return this.open&&(e.has("open")||e.has("category")||e.has("scope"))}willUpdate(e){this._reloadTriggered(e)&&this._beginLoad()}updated(e){this._reloadTriggered(e)&&this._fetch()}_vkey(e){return`${e.condition}:${e.key}`}_beginLoad(){this._error="",this._loading=!0,this._resetResults();let e=new Date;this._date=$r(e),this._time=mi(e),this._whenMode="time",this._anchor="sunset",this._offset=0,this._anchors=null,this._anchorsDate="",this._anchorsError=""}async _fetch(){try{let e=await ao(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=e.knobs,this._hasTime=e.has_time;let i={},n={};for(let s of e.knobs)s.kind==="entity"?i[s.entity_id]=Va(s):n[this._vkey(s)]=s.live_value;this._values=i,this._verdicts=n,this._loading=!1}catch(e){this._error=E(this.hass,e),this._loading=!1}}_setState(e,i){this._values={...this._values,[e]:{...this._values[e],state:i}}}_setAttr(e,i,n){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[i]:n}}}}_setFor(e,i,n){let s=this._values[e],o=Number.isFinite(n)&&n>0?Math.trunc(n):0;this._values={...this._values,[e]:{...s,for:{...s.for,[i]:o}}}}_setVerdict(e,i){this._verdicts={...this._verdicts,[e]:i}}_resetWhen(){let e=new Date;this._date=$r(e),this._time=mi(e),this._whenMode="time"}_setWhenMode(e){e!==this._whenMode&&(this._whenMode=e,e==="sun"&&this._fetchAnchors(this._date))}_setDate(e){this._date=e,this._whenMode==="sun"&&this._fetchAnchors(e)}_onOffsetInput(e){let i=$n(e);i!==null&&(this._offset=i)}async _fetchAnchors(e){if(e&&!(this._anchorsDate===e&&this._anchors)){this._anchorsError="";try{let i=await lo(this.hass,e);if(!this.isConnected||this._date!==e)return;this._anchors=i,this._anchorsDate=e}catch(i){if(!this.isConnected||this._date!==e)return;this._anchors=null,this._anchorsError=E(this.hass,i)}}}_resolvedInstant(){if(this._anchorsDate!==this._date)return null;let e=this._anchors?.[this._anchor];return e?new Date(e).getTime()+this._offset*6e4:null}_renderSunReadout(){if(this._anchorsError)return l`<span class="hint err">${this._anchorsError}</span>`;if(!this._anchors||this._anchorsDate!==this._date)return $;if(this._anchors[this._anchor]===null)return l`<span class="hint">${a(this.hass,"ui.simulate_sun_undefined","no {anchor} on this date",{anchor:re(this.hass,this._anchor)})}</span>`;let e=this._resolvedInstant();if(e===null||Number.isNaN(new Date(e).getTime()))return $;let i=this._anchors[this._anchor],n=new Date(e),s=$r(n)===this._date?mi(n):`${$r(n)} ${mi(n)}`,o=kn(this._offset,this.hass);return l`<span class="hint">${re(this.hass,this._anchor)} ${mi(new Date(i))}${o?l` ${o}`:""} ${a(this.hass,"ui.simulate_sun_resolved","\u2192 {time}",{time:s})}</span>`}_resetEntity(e){this._values={...this._values,[e.entity_id]:Va(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let i of this._knobs){if(i.kind!=="entity")continue;let n=this._values[i.entity_id];if(!n)continue;let s={};for(let d of i.attributes){let u=n.attributes[d.name];if(!(u===void 0||u===""))if(d.control==="number"){let h=Number(u);Number.isNaN(h)||(s[d.name]=h)}else s[d.name]=u}let o={attributes:s};n.state!==""&&(o.state=n.state),(n.for.h||n.for.m||n.for.s)&&(o.for=n.for),(o.state!==void 0||o.for!==void 0||Object.keys(s).length>0)&&(e[i.entity_id]=o)}return e}_buildVerdicts(){let e={};for(let i of this._knobs)i.kind==="verdict"&&(e[i.condition]||(e[i.condition]={}),e[i.condition][i.key]=this._verdicts[this._vkey(i)]??i.live_value);return e}_resolveNow(){if(this._whenMode==="sun"){let i=this._resolvedInstant();return i===null||Number.isNaN(new Date(i).getTime())?null:new Date(i).toISOString()}let e=new Date(`${this._date}T${this._time}`);return!this._date||!this._time||Number.isNaN(e.getTime())?null:e.toISOString()}async _run(){if(this._running)return;this._error="";let e=this._resolveNow();if(e===null){this._error=this._whenMode==="sun"?a(this.hass,"ui.simulate_sun_unresolved","This sun time can't be resolved for the selected date."):a(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}this._running=!0;let i=this._runToken;try{let n=await co(this.hass,this.scope,this.category,e,this._buildOverrides(),this._buildVerdicts(),this._appliedIndex);if(i!==this._runToken)return;this._results=[...this._results,n.result],this._appliedIndex=n.applied_index}catch(n){if(i!==this._runToken)return;this._error=E(this.hass,n)}finally{i===this._runToken&&(this._running=!1)}}_clearHistory(){this._resetResults()}_resetResults(){this._results=[],this._appliedIndex=null,this._expanded=new Set,this._runToken++,this._running=!1}_toggle(e){let i=new Set(this._expanded);i.has(e)?i.delete(e):i.add(e),this._expanded=i}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      ...
      ${e.attributes.map((o,d)=>l`
        <div class="row attr ${d===e.attributes.length-1?"last-attr":""}">
          <div class="row-text"><div class="row-title">${Wa(this.hass,o.name)}</div></div>
          <div class="row-ctrl">
    ...
    `}_renderAttrControl(e,i,n){let s=o=>this._setAttr(e.entity_id,i.name,o.target.value);if(i.control==="select"){let o=We(this.hass)[e.entity_id];return l`<select data-attr=${`${e.entity_id}:${i.name}`} .value=${n} @change=${s}>
      ...
      @input=${s} />`}_renderControl(e,i){if(e.control==="select")return l`<select data-entity=${e.entity_id} .value=${i}
        ...
        ${(e.options??[i]).map(s=>l`<option value=${s} ?selected=${s===i}>${Wa(this.hass,s)}</option>`)}
    ...
    `}_historyCaption(){return this._store.canUndo?this._historyButtonLabel("undo"):this._store.canRedo?this._historyButtonLabel("redo"):""}_editingScopeIsStale(){return this._editing!==null&&this._store.isScopeStale(this._editing.scope)}render(){let e=this._historyCaption();return l`
      ...
      ${this._renderBanners()}
      <ul>
        ${_o(this._orderedScopeRows(),i=>D(i.scope),i=>this._renderScopeRow(i.scope,i.name,i.cfg,i.rowClass))}
    ...
    </button>`}_renderScopeSwitch(e,i){let n=i.enabled!==!1;return $t({checked:n,dataTest:"scope-switch",onChange:async d=>{d.stopPropagation();try{await qs(this.hass,e,!n),await Promise.all([this._store.reloadScope(e),this._store.refreshSwitches()])}catch(u){this._store.error=E(this.hass,u)}},className:"scope-switch",onClick:d=>d.stopPropagation()})}};Y.styles=[y`
      :host {
        display: block;
        padding: 1rem;
  ...
  `,c([m({attribute:!1})],Pe.prototype,"hass",2),c([m()],Pe.prototype,"conditionName",2),c([m()],Pe.prototype,"conditionDescription",2),c([_()],Pe.prototype,"_expanded",2),Pe=c([w("ambience-condition-card")],Pe);var sh=/^[a-z][a-z0-9_]*$/;function oh(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var fi=y`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,ue=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=fi}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!sh.test(e)?a(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?a(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":a(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??oh(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return l`
    ...
    `}_validateDef(){return this._min==null&&this._max==null?a(this.hass,"ui.lux_error_need_bound","Enter a min, a max, or both."):En(this._min,this._max,this.hass)??""}_buildDefinition(){let e={label:this._label.trim()||null};return this._min!=null&&(e.min=this._min),this._max!=null&&(e.max=this._max),e}};Ge.styles=[fi,y`
      .row { display: flex; gap: 1rem; }
      .row .field { flex: 1; }
    `],c([m({attribute:!1})],Ge.prototype,"initial",2),c([_()],Ge.prototype,"_min",2),c([_()],Ge.prototype,"_max",2),Ge=c([w("ambience-lux-edit-modal")],Ge);var Er=class extends ve{_list(){return Mi(this.hass)}async _save(r,e){await Ms(this.hass,r,e)}_label(r,e){return De(this.hass,r,e)}_formatDef(r){return on(r.min,r.max,"any")}_headingKey(){return["ui.lux_heading","Lux ranges"]}_addKey(){return["ui.add_custom_lux_range","+ Add custom lux range"]}_renderModal(){let r=this._modal;return r.mode==="edit"?l`<ambience-lux-edit-modal
        .hass=${this.hass}
        .existingId=${r.id}
        .initial=${r.initial}
        .takenIds=${this._takenIds()}
  ...
  `,c([m({attribute:!1})],Ye.prototype,"hass",2),c([_()],Ye.prototype,"_config",2),c([_()],Ye.prototype,"_expanded",2),Ye=c([w("ambience-weather-config")],Ye);var Ka={time_of_day:t=>l`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>l`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>l`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>l`<ambience-weather-config .hass=${t}></ambience-weather-config>`},lh=new Set(Object.keys(Ka)),Qe=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await Ii(this.hass)}catch(e){this._error=E(this.hass,e)}}render(){let e=this._conditions.filter(i=>lh.has(i.name)).slice().sort((i,n)=>n.priority-i.priority);return l`
  ...
  `,c([m({attribute:!1})],Qe.prototype,"hass",2),c([_()],Qe.prototype,"_conditions",2),c([_()],Qe.prototype,"_error",2),Qe=c([w("ambience-conditions-settings")],Qe);function Ya(t,r){let e=t?.config?.components;return Array.isArray(e)&&e.includes(r)}var dh="fado",ch="https://my.home-assistant.io/redirect/hacs_repository/?owner=clintongormley&repository=ha-fado",I=class extends b{constructor(){super(...arguments);this._actions=[];this._services=[];this._schemas={};this._fieldSchemas={};this._addSchema=[];this._serviceById=new Map;this._availableServices=[];this._expanded=new Set;this._adding=!1;this._loadError=null;this._saveError=null;this._loaded=!1;this._fadoNoticeDismissed=!1;this._installId=null;this._editingDefault=null;this._editingOriginalValue=void 0;this._editingOriginalHad=!1;this._drag=new Et(this,(e,i)=>{let n=[...this._actions],[s]=n.splice(e,1);n.splice(i,0,s),this._actions=n,this._autoSave()});this._onDocPointerDown=e=>{if(!this._adding&&this._editingDefault===null)return;let i=e.composedPath(),n=i.some(s=>s instanceof Element&&I._OVERLAY_TAG_RE.test(s.localName));this._collapseAddFormOnClickAway(i,n),this._cancelEditingDefaultOnClickAway(i,n)}}_collapseAddFormOnClickAway(e,i){if(!this._adding)return;let n=this.shadowRoot?.querySelector(".add-row");!(!!n&&e.includes(n))&&!i&&(this._adding=!1)}_cancelEditingDefaultOnClickAway(e,i){if(this._editingDefault===null)return;let n=this.shadowRoot?.querySelector(`.field-row-editor[data-editing-key="${this._editingDefault}"]`);(!n||!e.includes(n))&&!i&&this._cancelEditingDefault()}connectedCallback(){super.connectedCallback(),document.addEventListener("pointerdown",this._onDocPointerDown),customElements.get("ha-service-picker")||customElements.whenDefined("ha-service-picker").then(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerdown",this._onDocPointerDown)}_startEditingDefault(e,i){let s=this._actions.find(o=>o.id===e)?.defaults??{};this._editingOriginalHad=i in s,this._editingOriginalValue=s[i],this._editingDefault=`${e}:${i}`}_saveEditingDefault(){this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1,this._autoSave()}_cancelEditingDefault(){let e=this._editingDefault;if(e){let i=e.indexOf(":"),n=e.slice(0,i),s=e.slice(i+1);this._actions=this._actions.map(o=>{if(o.id!==n)return o;let d={...o.defaults??{}};return this._editingOriginalHad?d[s]=this._editingOriginalValue:delete d[s],{...o,defaults:d}})}this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}async firstUpdated(){await this._reload()}willUpdate(e){if(e.has("_actions")||e.has("_schemas")){let i={};for(let n of this._actions){let s=this._schemas[n.id];if(s)for(let[o,d]of Object.entries(s.fields))i[`${n.id}:${o}`]=[{name:o,selector:d.selector??{text:{}},required:!1}]}this._fieldSchemas=i}if(e.has("_services")&&(this._serviceById=new Map(this._services.map(i=>[i.id,i]))),e.has("_actions")||e.has("_services")){let i=new Set(this._actions.map(n=>n.id));this._availableServices=this._services.filter(n=>!i.has(n.id)),this._addSchema=[{name:"service",selector:{select:{options:this._availableServices.map(n=>({value:n.id,label:this._addOptionLabel(n.id)})),custom_value:!0,mode:"dropdown",sort:!0}}}]}}async _reload(){this._loadError=null;try{let[e,i,n]=await Promise.all([Bt(this.hass),Hs(this.hass),Ni(this.hass)]);this._actions=e,this._services=i,this._installId=n,this._fadoNoticeDismissed=$s(n)}catch(e){this._loadError=E(this.hass,e);return}await Promise.all(this._actions.map(e=>this._ensureSchema(e.id))),this._loaded=!0}async _ensureSchema(e){if(!(e in this._schemas))try{let i=await He(this.hass,e);this._schemas={...this._schemas,[e]:i}}catch{this._schemas={...this._schemas,[e]:null}}}_setShowInEditor(e,i,n){this._actions=this._actions.map(s=>{if(s.id!==e)return s;let o=new Set(s.visible_fields??[]);return n?o.add(i):o.delete(i),{...s,visible_fields:[...o]}}),this._autoSave()}_setDefault(e,i,n){this._actions=this._actions.map(s=>s.id!==e?s:{...s,defaults:{...s.defaults??{},[i]:n}})}_clearDefault(e,i){this._actions=this._actions.map(n=>{if(n.id!==e)return n;let s={...n.defaults??{}};return delete s[i],{...n,defaults:s}})}_setLabel(e,i){this._actions=this._actions.map(n=>n.id===e?{...n,label:i}:n)}_toggleExpand(e){this._expanded.has(e)?this._expanded=new Set:(this._expanded=new Set([e]),this._ensureSchema(e))}async _addService(e){if(e&&this._services.some(i=>i.id===e)){if(this._actions.some(i=>i.id===e)){this._expanded=new Set([e]),this._adding=!1;return}await this._ensureSchema(e),this._actions=[...this._actions,{id:e,label:this._labelForService(e),visible_fields:[],defaults:{}}],this._expanded=new Set([e]),this._adding=!1,this._autoSave()}}_removeService(e){this._actions=this._actions.filter(n=>n.id!==e);let i=new Set(this._expanded);i.delete(e),this._expanded=i,this._autoSave()}async _autoSave(){this._saveError=null;try{await Ds(this.hass,this._actions),window.dispatchEvent(new CustomEvent("ambience-exposed-actions-changed"))}catch(e){this._saveError=E(this.hass,e)}}render(){return this._loadError!==null?l`
    ...
    `:l`<div>${a(this.hass,"ui.loading","Loading\u2026")}</div>`}_renderFadoNotice(){return this._fadoNoticeDismissed||Ya(this.hass,dh)?"":l`
      <ambience-banner
  ...
  `,c([m({attribute:!1})],Je.prototype,"hass",2),c([m({attribute:!1})],Je.prototype,"initialTab",2),c([_()],Je.prototype,"_tab",2),Je=c([w("ambience-settings-view")],Je);var Xe=class extends b{constructor(){super();this.open=!1;new Be(this,()=>this._close())}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      <div
        class="modal"
        role="dialog"
        aria-modal="true"
