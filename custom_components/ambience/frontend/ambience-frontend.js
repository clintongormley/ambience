...
`;function ct(t,n){return d`<span class="category-swatch" style=${vi(t)}>
    ...
    @click=${s}
    @change=${i}
  />`}function Dt(t){let{priority:n,pinned:e,shadowed_by:i,...r}=t;return r}function ds(t,n){if(n<0||n>=t.length)return[];let e=new Set(t[n].entity_ids??[]),i=new Set;return t.forEach((r,s)=>{if(s!==n)for(let o of r.entity_ids??[])e.has(o)||i.add(o)}),[...i]}var _r={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Ht(t,n){return t.kind==="house"?_r.house:t.kind==="floor"?n?.floors?.[t.id]?.icon||_r.floor:n?.areas?.[t.id]?.icon||_r.area}function Ci(t){if(t.enabled===!1)return{severity:null,missing:[],overlap:[],shadowed:!1,configIssues:[]};let n=t.missing_entities??[],e=t.overlap_entities??[],i=t.config_issues??[],r=t.shadowed_by!=null;return{severity:n.length>0||i.length>0?"error":e.length>0||r?"warning":null,missing:n,overlap:e,shadowed:r,configIssues:i}}function cs(t){let n=null;for(let e of t){let i=Ci(e).severity;if(i==="error")return"error";i==="warning"&&(n="warning")}return n}function us(t){return t.filter(n=>Ci(n).severity!=null).length}var ha={missing_workday_sensor:["ui.badge_needs_workday_sensor","needs a workday sensor"],missing_workday_calendar:["ui.badge_needs_workday_calendar","needs a workday calendar"],missing_weather_entity:["ui.badge_needs_weather_entity","needs a weather entity"],missing_weather_group:["ui.badge_missing_weather_group","missing weather group {id}"],missing_period:["ui.badge_missing_period","missing period {id}"],missing_lux_range:["ui.badge_missing_lux_range","missing lux range {id}"],unexposed_action:["ui.badge_unexposed_action","action {id} not exposed"]};function hs(t,n){let e=ha[n.kind];return(e?l(t,e[0],e[1]):n.kind).replace("{id}",n.ref)}var pt=null;function Si(t,n){let e=cs(n);if(!e)return"";let i=us(n),r=l(t,"ui.problems_count","{n} scene(s) have problems").replace("{n}",String(i));return d`<ambience-problem-flag
    .severity=${e}
    .details=${[r]}
    .summary=${r}
  ...
  `,u([m()],ye.prototype,"severity",2),u([m({attribute:!1})],ye.prototype,"details",2),u([m()],ye.prototype,"summary",2),u([g()],ye.prototype,"_open",2),ye=u([x("ambience-problem-flag")],ye);function oe(t){return t.enabled===!1?{scenes:t.scenes??[],enabled:!1}:{scenes:t.scenes??[]}}function F(){return(t,n)=>{let e=Symbol(String(n));Object.defineProperty(t,n,{get(){return this[e]},set(i){Object.is(this[e],i)||(this[e]=i,this._host?.requestUpdate())},configurable:!0,enumerable:!0})}}var A=class{constructor(n){this._host=n;this.areas=[];this.floors=[];this.areaConfigs=new Map;this.floorConfigs=new Map;this.house={scenes:[]};this.switchEntityIds=new Map;this.areasLoaded=!1;this.conditions=[];this.actions=[];this.categories=[];this.schemas={};this.staticLoaded=!1;this.error="";this._onExposedActionsChanged=async()=>{try{let n=await Lt(this._hass);if(!this._host.isConnected)return;this.actions=n,await this._refreshSchemas(n),await this.reloadConfigs()}catch{}};this._onCategoriesChanged=async()=>{try{let n=await Ve(this._hass);if(!this._host.isConnected)return;this.categories=n}catch{}};this._onConditionsChanged=async()=>{try{let[n,e]=await Promise.all([Pt(this._hass),Rt(this._hass)]);if(!this._host.isConnected)return;this.dayConfig=n,this.weatherConfig=e}catch{}};n.addController(this)}get _hass(){return this._host.hass}hostConnected(){window.addEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.addEventListener("ambience-categories-changed",this._onCategoriesChanged),window.addEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick=setInterval(()=>{for(let n of this.switchEntityIds.values())if(this._hass.states?.[n]?.state==="off"){this._host.requestUpdate();return}},1e3)}hostDisconnected(){window.removeEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.removeEventListener("ambience-categories-changed",this._onCategoriesChanged),window.removeEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick&&clearInterval(this._tick),this._tick=void 0,this._unsubArea?.(),this._unsubArea=void 0,this._unsubFloor?.(),this._unsubFloor=void 0,this._unsubEntity?.(),this._unsubEntity=void 0}async subscribe(n){let e=this._hass.connection.subscribeEvents(c=>{c.data.action==="remove"&&n({kind:"area",id:c.data.area_id}),this.refreshAreas(),c.data.action!=="update"&&this.refreshSwitches()},"area_registry_updated"),i=this._hass.connection.subscribeEvents(c=>{c.data.action==="remove"&&n({kind:"floor",id:c.data.floor_id}),this.refreshFloors(),c.data.action!=="update"&&this.refreshSwitches()},"floor_registry_updated"),r=this._hass.connection.subscribeEvents(c=>{c.data.action!=="update"&&c.data.entity_id.startsWith("switch.")&&this.refreshSwitches()},"entity_registry_updated"),[s,o,a]=await Promise.all([e,i,r]);this._host.isConnected?(this._unsubArea=s,this._unsubFloor=o,this._unsubEntity=a):(s(),o(),a())}async loadStatic(){try{let[n,e,i,r,s,o,a]=await Promise.all([fi(this._hass),Lt(this._hass),gi(this._hass),_i(this._hass),Pt(this._hass),Rt(this._hass),Ve(this._hass)]);if(!this._host.isConnected)return;this.conditions=n,this.actions=e,this.periods=i,this.luxRanges=r,this.dayConfig=s,this.weatherConfig=o,this.categories=a,this.staticLoaded=!0,await this._refreshSchemas(e)}catch(n){this.error=n.message||String(n)}}async _refreshSchemas(n){let e=await Promise.all(n.map(async r=>{try{let s=await Ee(this._hass,r.id);return[r.id,s]}catch{return[r.id,null]}}));if(!this._host.isConnected)return;let i={};for(let[r,s]of e)s&&(i[r]=s);this.schemas=i}async refreshAreas(){try{let n=await Sn(this._hass),e=this.areaConfigs,i=new Map;if(await Promise.all(n.map(async r=>{let s=e.get(r.area_id);if(s){i.set(r.area_id,s);return}i.set(r.area_id,oe(await hi(this._hass,r.area_id)))})),!this._host.isConnected)return;this.areas=n,this.areaConfigs=i}catch(n){this.error=n.message||String(n)}finally{this._host.isConnected&&(this.areasLoaded=!0)}}async refreshFloors(){try{let n=(await Ln(this._hass)).slice().sort((r,s)=>r.name.localeCompare(s.name)),e=this.floorConfigs,i=new Map;if(await Promise.all(n.map(async r=>{let s=e.get(r.floor_id);if(s){i.set(r.floor_id,s);return}i.set(r.floor_id,oe(await pi(this._hass,r.floor_id)))})),!this._host.isConnected)return;this.floors=n,this.floorConfigs=i}catch(n){this.error=n.message||String(n)}}async refreshHouse(){try{let n=oe(await mi(this._hass));if(!this._host.isConnected)return;this.house=n}catch(n){this.error=n.message||String(n)}}async reloadConfigs(){let[n,e,i]=await Promise.all([Promise.all(this.areas.map(async r=>[r.area_id,oe(await hi(this._hass,r.area_id))])),Promise.all(this.floors.map(async r=>[r.floor_id,oe(await pi(this._hass,r.floor_id))])),mi(this._hass)]);this._host.isConnected&&(this.areaConfigs=new Map(n),this.floorConfigs=new Map(e),this.house=oe(i))}async refreshSwitches(){try{let n=await Un(this._hass);if(!this._host.isConnected)return;this.switchEntityIds=new Map(n.map(e=>{let i=e.scope_kind==="house"?{kind:"house"}:{kind:e.scope_kind,id:e.scope_id};return[H(i),e.entity_id]}))}catch(n){this.error=n.message||String(n)}}getConfig(n){return n.kind==="house"?this.house:n.kind==="area"?this.areaConfigs.get(n.id):this.floorConfigs.get(n.id)}setConfig(n,e){if(n.kind==="house")this.house=e;else if(n.kind==="area"){let i=new Map(this.areaConfigs);i.set(n.id,e),this.areaConfigs=i}else{let i=new Map(this.floorConfigs);i.set(n.id,e),this.floorConfigs=i}}async mutate(n,e){let i=this.getConfig(n);this.setConfig(n,e),this.error="";try{let r;return n.kind==="house"?r=await Rn(this._hass,e):n.kind==="area"?r=await Tn(this._hass,n.id,e):r=await Pn(this._hass,n.id,e),this.setConfig(n,oe(r.config)),!0}catch(r){return i&&this.setConfig(n,i),this.error=r.message||String(r),!1}}async reloadScope(n){try{let e;if(n.kind==="house"?e=oe(await mi(this._hass)):n.kind==="area"?e=oe(await hi(this._hass,n.id)):e=oe(await pi(this._hass,n.id)),!this._host.isConnected)return;this.setConfig(n,e)}catch(e){this.error=e.message||String(e)}}};u([F()],A.prototype,"areas",2),u([F()],A.prototype,"floors",2),u([F()],A.prototype,"areaConfigs",2),u([F()],A.prototype,"floorConfigs",2),u([F()],A.prototype,"house",2),u([F()],A.prototype,"switchEntityIds",2),u([F()],A.prototype,"areasLoaded",2),u([F()],A.prototype,"conditions",2),u([F()],A.prototype,"actions",2),u([F()],A.prototype,"categories",2),u([F()],A.prototype,"schemas",2),u([F()],A.prototype,"periods",2),u([F()],A.prototype,"luxRanges",2),u([F()],A.prototype,"dayConfig",2),u([F()],A.prototype,"weatherConfig",2),u([F()],A.prototype,"staticLoaded",2),u([F()],A.prototype,"error",2);var ae=class extends b{constructor(){super(...arguments);this.items=[];this.muted=!1;this._open=!1;this._onKeydown=e=>{e.key==="Escape"&&this._open&&(this._open=!1)}}_triggerLabel(){return this.label??l(this.hass,"ui.more_actions","More actions")}_select(e,i){i.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("menu-action",{detail:{id:e},bubbles:!0,composed:!0}))}_renderItems(){return this.items.map(e=>d`
        ${e.dividerBefore?d`<div class="kebab-divider" role="separator"></div>`:w}
        <button
  ...
  `,u([m({attribute:!1})],ae.prototype,"items",2),u([m({attribute:!1})],ae.prototype,"hass",2),u([m()],ae.prototype,"label",2),u([m({type:Boolean,reflect:!0})],ae.prototype,"muted",2),u([g()],ae.prototype,"_open",2),ae=u([x("ambience-kebab-menu")],ae);function pa(t){return t.style.pointerEvents="none",t.style.willChange="transform",()=>{t.style.pointerEvents="",t.style.willChange="",t.style.transform=""}}function Ti(t,n,e={}){let i=t.pointerId;try{t.target?.setPointerCapture?.(i)}catch{}let r=e.follow??null,s=t.clientX,o=t.clientY,a=r?pa(r):null,c=_=>{_.pointerId===i&&(n.onMove(_.clientX,_.clientY),r&&(r.style.transform=`translate(${_.clientX-s}px, ${_.clientY-o}px)`))},h=_=>{_.pointerId===i&&(f(),n.onEnd(_.clientX,_.clientY))},p=_=>{_.pointerId===i&&(f(),n.onCancel())},f=()=>{window.removeEventListener("pointermove",c,!0),window.removeEventListener("pointerup",h,!0),window.removeEventListener("pointercancel",p,!0),a?.()};return window.addEventListener("pointermove",c,!0),window.addEventListener("pointerup",h,!0),window.addEventListener("pointercancel",p,!0),f}function Li(t,n){let e=document.elementFromPoint?.(t,n)??null;if(!e)return null;for(;e.shadowRoot;){let i=e.shadowRoot.elementFromPoint?.(t,n);if(!i||i===e)break;e=i}return e}var mt=class{constructor(n,e,i={}){this.host=n;this.onReorder=e;this.from=null;this.over=null;this.moved=!1;this._cancelDrag=null;this._locate=i.locate??((r,s)=>this._domLocate(r,s)),n.addController(this)}hostDisconnected(){this._reset()}start(n,e){if(!e.isPrimary||e.button>0)return;this._reset(),this.from=n,this.moved=!1,this.host.requestUpdate();let i=e.target?.closest("[data-drag-index]");this._cancelDrag=Ti(e,{onMove:(r,s)=>this._hover(this._locate(r,s)),onEnd:(r,s)=>this.drop(this._locate(r,s)),onCancel:()=>this.end()},{follow:i})}_hover(n){if(this.from===null)return;let e=n===null||n===this.from?null:n;e!==null&&(this.moved=!0),this.over!==e&&(this.over=e,this.host.requestUpdate())}drop(n){let e=this.from;this._reset(),!(e===null||n===null||e===n)&&this.onReorder(e,n)}end(){this._reset()}_domLocate(n,e){let i=this.host.renderRoot,s=(i?.elementFromPoint?i.elementFromPoint(n,e):Li(n,e))?.closest?.("[data-drag-index]");if(!s)return null;let o=Number(s.getAttribute("data-drag-index"));return Number.isNaN(o)?null:o}_reset(){this._cancelDrag?.(),this._cancelDrag=null;let n=this.from!==null||this.over!==null;this.from=null,this.over=null,n&&this.host.requestUpdate()}};var ma={light:"mdi:lightbulb",switch:"mdi:toggle-switch-variant",binary_sensor:"mdi:motion-sensor",sensor:"mdi:eye",person:"mdi:account",device_tracker:"mdi:account",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:cast",lock:"mdi:lock",fan:"mdi:fan",weather:"mdi:weather-partly-cloudy",input_boolean:"mdi:toggle-switch",event:"mdi:eye-check",script:"mdi:script-text",template:"mdi:code-braces"},vr="mdi:eye";function M(t,n){let e=t?.states?.[n]?.attributes?.friendly_name;return typeof e=="string"&&e?e:n}function fa(t,n){let e=t?.states?.[n]?.attributes?.icon;if(typeof e=="string"&&e)return e;let i=n.split(".")[0];return ma[i]??vr}function Ot(t,n){let e=t?.states?.[n];return e&&customElements.get("ha-state-icon")?d`<ha-state-icon class="row-icon" .hass=${t} .stateObj=${e}></ha-state-icon>`:d`<ha-icon class="row-icon" icon=${fa(t,n)}></ha-icon>`}var ps=v`
  .row-icon {
    flex: 0 0 auto;
    color: var(--secondary-text-color, #888);
    --mdc-icon-size: 22px;
    ...
    ></ambience-problem-flag>`}_renderRow(e,i,r){let s=l(this.hass,"ui.unpin","Unpin (return to automatic order)"),o=i.enabled===!1,a=o?l(this.hass,"ui.enable_scene","Enable scene"):l(this.hass,"ui.disable_scene","Disable scene");return d`
      ...
      >
        ...
        <div class="body" @click=${()=>this._toggleScene(e)}>
          ...
          <div class="summary">
            ${this._expanded.has(e)?"":d`${this._whenSummary(i)} ·
...
`;return a.replace(/\n$/,"")}var Wa=Ua,Ba=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Va=["scalar","sequence","mapping"];function qa(t){var n={};return t!==null&&Object.keys(t).forEach(function(e){t[e].forEach(function(i){n[String(i)]=e})}),n}function Ka(t,n){if(n=n||{},Object.keys(n).forEach(function(e){if(Ba.indexOf(e)===-1)throw new G('Unknown option "'+e+'" is met in definition of "'+t+'" YAML type.')}),this.options=n,this.tag=t,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(e){return e},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.representName=n.representName||null,this.defaultStyle=n.defaultStyle||null,this.multi=n.multi||!1,this.styleAliases=qa(n.styleAliases||null),Va.indexOf(this.kind)===-1)throw new G('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var W=Ka;function ws(t,n){var e=[];return t[n].forEach(function(i){var r=e.length;e.forEach(function(s,o){s.tag===i.tag&&s.kind===i.kind&&s.multi===i.multi&&(r=o)}),e[r]=i}),e}function Ga(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},n,e;function i(r){r.multi?(t.multi[r.kind].push(r),t.multi.fallback.push(r)):t[r.kind][r.tag]=t.fallback[r.tag]=r}for(n=0,e=arguments.length;n<e;n+=1)arguments[n].forEach(i);return t}function Cr(t){return this.extend(t)}Cr.prototype.extend=function(n){var e=[],i=[];if(n instanceof W)i.push(n);else if(Array.isArray(n))i=i.concat(n);else if(n&&(Array.isArray(n.implicit)||Array.isArray(n.explicit)))n.implicit&&(e=e.concat(n.implicit)),n.explicit&&(i=i.concat(n.explicit));else throw new G("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.forEach(function(s){if(!(s instanceof W))throw new G("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new G("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new G("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(s){if(!(s instanceof W))throw new G("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var r=Object.create(Cr.prototype);return r.implicit=(this.implicit||[]).concat(e),r.explicit=(this.explicit||[]).concat(i),r.compiledImplicit=ws(r,"implicit"),r.compiledExplicit=ws(r,"explicit"),r.compiledTypeMap=Ga(r.compiledImplicit,r.compiledExplicit),r};var Ya=Cr,Qa=new W("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),Ja=new W("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),Xa=new W("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),Za=new Ya({explicit:[Qa,Ja,Xa]});function el(t){if(t===null)return!0;var n=t.length;return n===1&&t==="~"||n===4&&(t==="null"||t==="Null"||t==="NULL")}function tl(){return null}function il(t){return t===null}var rl=new W("tag:yaml.org,2002:null",{kind:"scalar",resolve:el,construct:tl,predicate:il,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function nl(t){if(t===null)return!1;var n=t.length;return n===4&&(t==="true"||t==="True"||t==="TRUE")||n===5&&(t==="false"||t==="False"||t==="FALSE")}function sl(t){return t==="true"||t==="True"||t==="TRUE"}function ol(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var al=new W("tag:yaml.org,2002:bool",{kind:"scalar",resolve:nl,construct:sl,predicate:ol,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function ll(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function dl(t){return 48<=t&&t<=55}function cl(t){return 48<=t&&t<=57}function ul(t){if(t===null)return!1;var n=t.length,e=0,i=!1,r;if(!n)return!1;if(r=t[e],(r==="-"||r==="+")&&(r=t[++e]),r==="0"){if(e+1===n)return!0;if(r=t[++e],r==="b"){for(e++;e<n;e++)if(r=t[e],r!=="_"){if(r!=="0"&&r!=="1")return!1;i=!0}return i&&r!=="_"}if(r==="x"){for(e++;e<n;e++)if(r=t[e],r!=="_"){if(!ll(t.charCodeAt(e)))return!1;i=!0}return i&&r!=="_"}if(r==="o"){for(e++;e<n;e++)if(r=t[e],r!=="_"){if(!dl(t.charCodeAt(e)))return!1;i=!0}return i&&r!=="_"}}if(r==="_")return!1;for(;e<n;e++)if(r=t[e],r!=="_"){if(!cl(t.charCodeAt(e)))return!1;i=!0}return!(!i||r==="_")}function hl(t){var n=t,e=1,i;if(n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),i=n[0],(i==="-"||i==="+")&&(i==="-"&&(e=-1),n=n.slice(1),i=n[0]),n==="0")return 0;if(i==="0"){if(n[1]==="b")return e*parseInt(n.slice(2),2);if(n[1]==="x")return e*parseInt(n.slice(2),16);if(n[1]==="o")return e*parseInt(n.slice(2),8)}return e*parseInt(n,10)}function pl(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!O.isNegativeZero(t)}var ml=new W("tag:yaml.org,2002:int",{kind:"scalar",resolve:ul,construct:hl,predicate:pl,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),fl=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function gl(t){return!(t===null||!fl.test(t)||t[t.length-1]==="_")}function _l(t){var n,e;return n=t.replace(/_/g,"").toLowerCase(),e=n[0]==="-"?-1:1,"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?e===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:e*parseFloat(n,10)}var vl=/^[-+]?[0-9]+e/;function yl(t,n){var e;if(isNaN(t))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(O.isNegativeZero(t))return"-0.0";return e=t.toString(10),vl.test(e)?e.replace("e",".e"):e}function bl(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||O.isNegativeZero(t))}var xl=new W("tag:yaml.org,2002:float",{kind:"scalar",resolve:gl,construct:_l,predicate:bl,represent:yl,defaultStyle:"lowercase"}),wl=Za.extend({implicit:[rl,al,ml,xl]}),$l=wl,Ms=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),js=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function kl(t){return t===null?!1:Ms.exec(t)!==null||js.exec(t)!==null}function El(t){var n,e,i,r,s,o,a,c=0,h=null,p,f,_;if(n=Ms.exec(t),n===null&&(n=js.exec(t)),n===null)throw new Error("Date resolve error");if(e=+n[1],i=+n[2]-1,r=+n[3],!n[4])return new Date(Date.UTC(e,i,r));if(s=+n[4],o=+n[5],a=+n[6],n[7]){for(c=n[7].slice(0,3);c.length<3;)c+="0";c=+c}return n[9]&&(p=+n[10],f=+(n[11]||0),h=(p*60+f)*6e4,n[9]==="-"&&(h=-h)),_=new Date(Date.UTC(e,i,r,s,o,a,c)),h&&_.setTime(_.getTime()-h),_}function Cl(t){return t.toISOString()}var Sl=new W("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:kl,construct:El,instanceOf:Date,represent:Cl});function Tl(t){return t==="<<"||t===null}var Ll=new W("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Tl}),Rr=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Pl(t){if(t===null)return!1;var n,e,i=0,r=t.length,s=Rr;for(e=0;e<r;e++)if(n=s.indexOf(t.charAt(e)),!(n>64)){if(n<0)return!1;i+=6}return i%8===0}function Rl(t){var n,e,i=t.replace(/[\r\n=]/g,""),r=i.length,s=Rr,o=0,a=[];for(n=0;n<r;n++)n%4===0&&n&&(a.push(o>>16&255),a.push(o>>8&255),a.push(o&255)),o=o<<6|s.indexOf(i.charAt(n));return e=r%4*6,e===0?(a.push(o>>16&255),a.push(o>>8&255),a.push(o&255)):e===18?(a.push(o>>10&255),a.push(o>>2&255)):e===12&&a.push(o>>4&255),new Uint8Array(a)}function Al(t){var n="",e=0,i,r,s=t.length,o=Rr;for(i=0;i<s;i++)i%3===0&&i&&(n+=o[e>>18&63],n+=o[e>>12&63],n+=o[e>>6&63],n+=o[e&63]),e=(e<<8)+t[i];return r=s%3,r===0?(n+=o[e>>18&63],n+=o[e>>12&63],n+=o[e>>6&63],n+=o[e&63]):r===2?(n+=o[e>>10&63],n+=o[e>>4&63],n+=o[e<<2&63],n+=o[64]):r===1&&(n+=o[e>>2&63],n+=o[e<<4&63],n+=o[64],n+=o[64]),n}function Dl(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var Hl=new W("tag:yaml.org,2002:binary",{kind:"scalar",resolve:Pl,construct:Rl,predicate:Dl,represent:Al}),Ol=Object.prototype.hasOwnProperty,Nl=Object.prototype.toString;function Il(t){if(t===null)return!0;var n=[],e,i,r,s,o,a=t;for(e=0,i=a.length;e<i;e+=1){if(r=a[e],o=!1,Nl.call(r)!=="[object Object]")return!1;for(s in r)if(Ol.call(r,s))if(!o)o=!0;else return!1;if(!o)return!1;if(n.indexOf(s)===-1)n.push(s);else return!1}return!0}function Fl(t){return t!==null?t:[]}var Ml=new W("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Il,construct:Fl}),jl=Object.prototype.toString;function zl(t){if(t===null)return!0;var n,e,i,r,s,o=t;for(s=new Array(o.length),n=0,e=o.length;n<e;n+=1){if(i=o[n],jl.call(i)!=="[object Object]"||(r=Object.keys(i),r.length!==1))return!1;s[n]=[r[0],i[r[0]]]}return!0}function Ul(t){if(t===null)return[];var n,e,i,r,s,o=t;for(s=new Array(o.length),n=0,e=o.length;n<e;n+=1)i=o[n],r=Object.keys(i),s[n]=[r[0],i[r[0]]];return s}var Wl=new W("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:zl,construct:Ul}),Bl=Object.prototype.hasOwnProperty;function Vl(t){if(t===null)return!0;var n,e=t;for(n in e)if(Bl.call(e,n)&&e[n]!==null)return!1;return!0}function ql(t){return t!==null?t:{}}var Kl=new W("tag:yaml.org,2002:set",{kind:"mapping",resolve:Vl,construct:ql}),zs=$l.extend({implicit:[Sl,Ll],explicit:[Hl,Ml,Wl,Kl]}),Le=Object.prototype.hasOwnProperty,Ni=1,Us=2,Ws=3,Ii=4,Er=1,Gl=2,$s=3,Yl=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Ql=/[\x85\u2028\u2029]/,Jl=/[,\[\]\{\}]/,Bs=/^(?:!|!!|![a-z\-]+!)$/i,Vs=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function ks(t){return Object.prototype.toString.call(t)}function de(t){return t===10||t===13}function Ke(t){return t===9||t===32}function Y(t){return t===9||t===32||t===10||t===13}function gt(t){return t===44||t===91||t===93||t===123||t===125}function Xl(t){var n;return 48<=t&&t<=57?t-48:(n=t|32,97<=n&&n<=102?n-97+10:-1)}function Zl(t){return t===120?2:t===117?4:t===85?8:0}function ed(t){return 48<=t&&t<=57?t-48:-1}function Es(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function td(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function qs(t,n,e){n==="__proto__"?Object.defineProperty(t,n,{configurable:!0,enumerable:!0,writable:!0,value:e}):t[n]=e}var Ks=new Array(256),Gs=new Array(256);for(qe=0;qe<256;qe++)Ks[qe]=Es(qe)?1:0,Gs[qe]=Es(qe);var qe;function id(t,n){this.input=t,this.filename=n.filename||null,this.schema=n.schema||zs,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function Ys(t,n){var e={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return e.snippet=Wa(e),new G(n,e)}function k(t,n){throw Ys(t,n)}function Fi(t,n){t.onWarning&&t.onWarning.call(null,Ys(t,n))}var Cs={YAML:function(n,e,i){var r,s,o;n.version!==null&&k(n,"duplication of %YAML directive"),i.length!==1&&k(n,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),r===null&&k(n,"ill-formed argument of the YAML directive"),s=parseInt(r[1],10),o=parseInt(r[2],10),s!==1&&k(n,"unacceptable YAML version of the document"),n.version=i[0],n.checkLineBreaks=o<2,o!==1&&o!==2&&Fi(n,"unsupported YAML version of the document")},TAG:function(n,e,i){var r,s;i.length!==2&&k(n,"TAG directive accepts exactly two arguments"),r=i[0],s=i[1],Bs.test(r)||k(n,"ill-formed tag handle (first argument) of the TAG directive"),Le.call(n.tagMap,r)&&k(n,'there is a previously declared suffix for "'+r+'" tag handle'),Vs.test(s)||k(n,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{k(n,"tag prefix is malformed: "+s)}n.tagMap[r]=s}};function Te(t,n,e,i){var r,s,o,a;if(n<e){if(a=t.input.slice(n,e),i)for(r=0,s=a.length;r<s;r+=1)o=a.charCodeAt(r),o===9||32<=o&&o<=1114111||k(t,"expected valid JSON character");else Yl.test(a)&&k(t,"the stream contains non-printable characters");t.result+=a}}function Ss(t,n,e,i){var r,s,o,a;for(O.isObject(e)||k(t,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(e),o=0,a=r.length;o<a;o+=1)s=r[o],Le.call(n,s)||(qs(n,s,e[s]),i[s]=!0)}function _t(t,n,e,i,r,s,o,a,c){var h,p;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),h=0,p=r.length;h<p;h+=1)Array.isArray(r[h])&&k(t,"nested arrays are not supported inside keys"),typeof r=="object"&&ks(r[h])==="[object Object]"&&(r[h]="[object Object]");if(typeof r=="object"&&ks(r)==="[object Object]"&&(r="[object Object]"),r=String(r),n===null&&(n={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(h=0,p=s.length;h<p;h+=1)Ss(t,n,s[h],e);else Ss(t,n,s,e);else!t.json&&!Le.call(e,r)&&Le.call(n,r)&&(t.line=o||t.line,t.lineStart=a||t.lineStart,t.position=c||t.position,k(t,"duplicated mapping key")),qs(n,r,s),delete e[r];return n}function Ar(t){var n;n=t.input.charCodeAt(t.position),n===10?t.position++:n===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):k(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function D(t,n,e){for(var i=0,r=t.input.charCodeAt(t.position);r!==0;){for(;Ke(r);)r===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),r=t.input.charCodeAt(++t.position);if(n&&r===35)do r=t.input.charCodeAt(++t.position);while(r!==10&&r!==13&&r!==0);if(de(r))for(Ar(t),r=t.input.charCodeAt(t.position),i++,t.lineIndent=0;r===32;)t.lineIndent++,r=t.input.charCodeAt(++t.position);else break}return e!==-1&&i!==0&&t.lineIndent<e&&Fi(t,"deficient indentation"),i}function zi(t){var n=t.position,e;return e=t.input.charCodeAt(n),!!((e===45||e===46)&&e===t.input.charCodeAt(n+1)&&e===t.input.charCodeAt(n+2)&&(n+=3,e=t.input.charCodeAt(n),e===0||Y(e)))}function Dr(t,n){n===1?t.result+=" ":n>1&&(t.result+=O.repeat(`
`,n-1))}function rd(t,n,e){var i,r,s,o,a,c,h,p,f=t.kind,_=t.result,y;if(y=t.input.charCodeAt(t.position),Y(y)||gt(y)||y===35||y===38||y===42||y===33||y===124||y===62||y===39||y===34||y===37||y===64||y===96||(y===63||y===45)&&(r=t.input.charCodeAt(t.position+1),Y(r)||e&&gt(r)))return!1;for(t.kind="scalar",t.result="",s=o=t.position,a=!1;y!==0;){if(y===58){if(r=t.input.charCodeAt(t.position+1),Y(r)||e&&gt(r))break}else if(y===35){if(i=t.input.charCodeAt(t.position-1),Y(i))break}else{if(t.position===t.lineStart&&zi(t)||e&&gt(y))break;if(de(y))if(c=t.line,h=t.lineStart,p=t.lineIndent,D(t,!1,-1),t.lineIndent>=n){a=!0,y=t.input.charCodeAt(t.position);continue}else{t.position=o,t.line=c,t.lineStart=h,t.lineIndent=p;break}}a&&(Te(t,s,o,!1),Dr(t,t.line-c),s=o=t.position,a=!1),Ke(y)||(o=t.position+1),y=t.input.charCodeAt(++t.position)}return Te(t,s,o,!1),t.result?!0:(t.kind=f,t.result=_,!1)}function nd(t,n){var e,i,r;if(e=t.input.charCodeAt(t.position),e!==39)return!1;for(t.kind="scalar",t.result="",t.position++,i=r=t.position;(e=t.input.charCodeAt(t.position))!==0;)if(e===39)if(Te(t,i,t.position,!0),e=t.input.charCodeAt(++t.position),e===39)i=t.position,t.position++,r=t.position;else return!0;else de(e)?(Te(t,i,r,!0),Dr(t,D(t,!1,n)),i=r=t.position):t.position===t.lineStart&&zi(t)?k(t,"unexpected end of the document within a single quoted scalar"):(t.position++,r=t.position);k(t,"unexpected end of the stream within a single quoted scalar")}function sd(t,n){var e,i,r,s,o,a;if(a=t.input.charCodeAt(t.position),a!==34)return!1;for(t.kind="scalar",t.result="",t.position++,e=i=t.position;(a=t.input.charCodeAt(t.position))!==0;){if(a===34)return Te(t,e,t.position,!0),t.position++,!0;if(a===92){if(Te(t,e,t.position,!0),a=t.input.charCodeAt(++t.position),de(a))D(t,!1,n);else if(a<256&&Ks[a])t.result+=Gs[a],t.position++;else if((o=Zl(a))>0){for(r=o,s=0;r>0;r--)a=t.input.charCodeAt(++t.position),(o=Xl(a))>=0?s=(s<<4)+o:k(t,"expected hexadecimal character");t.result+=td(s),t.position++}else k(t,"unknown escape sequence");e=i=t.position}else de(a)?(Te(t,e,i,!0),Dr(t,D(t,!1,n)),e=i=t.position):t.position===t.lineStart&&zi(t)?k(t,"unexpected end of the document within a double quoted scalar"):(t.position++,i=t.position)}k(t,"unexpected end of the stream within a double quoted scalar")}function od(t,n){var e=!0,i,r,s,o=t.tag,a,c=t.anchor,h,p,f,_,y,$=Object.create(null),E,L,q,T;if(T=t.input.charCodeAt(t.position),T===91)p=93,y=!1,a=[];else if(T===123)p=125,y=!0,a={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=a),T=t.input.charCodeAt(++t.position);T!==0;){if(D(t,!0,n),T=t.input.charCodeAt(t.position),T===p)return t.position++,t.tag=o,t.anchor=c,t.kind=y?"mapping":"sequence",t.result=a,!0;e?T===44&&k(t,"expected the node content, but found ','"):k(t,"missed comma between flow collection entries"),L=E=q=null,f=_=!1,T===63&&(h=t.input.charCodeAt(t.position+1),Y(h)&&(f=_=!0,t.position++,D(t,!0,n))),i=t.line,r=t.lineStart,s=t.position,vt(t,n,Ni,!1,!0),L=t.tag,E=t.result,D(t,!0,n),T=t.input.charCodeAt(t.position),(_||t.line===i)&&T===58&&(f=!0,T=t.input.charCodeAt(++t.position),D(t,!0,n),vt(t,n,Ni,!1,!0),q=t.result),y?_t(t,a,$,L,E,q,i,r,s):f?a.push(_t(t,null,$,L,E,q,i,r,s)):a.push(E),D(t,!0,n),T=t.input.charCodeAt(t.position),T===44?(e=!0,T=t.input.charCodeAt(++t.position)):e=!1}k(t,"unexpected end of the stream within a flow collection")}function ad(t,n){var e,i,r=Er,s=!1,o=!1,a=n,c=0,h=!1,p,f;if(f=t.input.charCodeAt(t.position),f===124)i=!1;else if(f===62)i=!0;else return!1;for(t.kind="scalar",t.result="";f!==0;)if(f=t.input.charCodeAt(++t.position),f===43||f===45)Er===r?r=f===43?$s:Gl:k(t,"repeat of a chomping mode identifier");else if((p=ed(f))>=0)p===0?k(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):o?k(t,"repeat of an indentation width identifier"):(a=n+p-1,o=!0);else break;if(Ke(f)){do f=t.input.charCodeAt(++t.position);while(Ke(f));if(f===35)do f=t.input.charCodeAt(++t.position);while(!de(f)&&f!==0)}for(;f!==0;){for(Ar(t),t.lineIndent=0,f=t.input.charCodeAt(t.position);(!o||t.lineIndent<a)&&f===32;)t.lineIndent++,f=t.input.charCodeAt(++t.position);if(!o&&t.lineIndent>a&&(a=t.lineIndent),de(f)){c++;continue}if(t.lineIndent<a){r===$s?t.result+=O.repeat(`
...
`,c):t.result+=O.repeat(`
`,s?1+c:c),s=!0,o=!0,c=0,e=t.position;!de(f)&&f!==0;)f=t.input.charCodeAt(++t.position);Te(t,e,t.position,!1)}return!0}function Ts(t,n){var e,i=t.tag,r=t.anchor,s=[],o,a=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),!(c!==45||(o=t.input.charCodeAt(t.position+1),!Y(o))));){if(a=!0,t.position++,D(t,!0,-1)&&t.lineIndent<=n){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,vt(t,n,Ws,!1,!0),s.push(t.result),D(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>n)&&c!==0)k(t,"bad indentation of a sequence entry");else if(t.lineIndent<n)break}return a?(t.tag=i,t.anchor=r,t.kind="sequence",t.result=s,!0):!1}function ld(t,n,e){var i,r,s,o,a,c,h=t.tag,p=t.anchor,f={},_=Object.create(null),y=null,$=null,E=null,L=!1,q=!1,T;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=f),T=t.input.charCodeAt(t.position);T!==0;){if(!L&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),i=t.input.charCodeAt(t.position+1),s=t.line,(T===63||T===58)&&Y(i))T===63?(L&&(_t(t,f,_,y,$,null,o,a,c),y=$=E=null),q=!0,L=!0,r=!0):L?(L=!1,r=!0):k(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,T=i;else{if(o=t.line,a=t.lineStart,c=t.position,!vt(t,e,Us,!1,!0))break;if(t.line===s){for(T=t.input.charCodeAt(t.position);Ke(T);)T=t.input.charCodeAt(++t.position);if(T===58)T=t.input.charCodeAt(++t.position),Y(T)||k(t,"a whitespace character is expected after the key-value separator within a block mapping"),L&&(_t(t,f,_,y,$,null,o,a,c),y=$=E=null),q=!0,L=!1,r=!1,y=t.tag,$=t.result;else if(q)k(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(q)k(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>n)&&(L&&(o=t.line,a=t.lineStart,c=t.position),vt(t,n,Ii,!0,r)&&(L?$=t.result:E=t.result),L||(_t(t,f,_,y,$,E,o,a,c),y=$=E=null),D(t,!0,-1),T=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>n)&&T!==0)k(t,"bad indentation of a mapping entry");else if(t.lineIndent<n)break}return L&&_t(t,f,_,y,$,null,o,a,c),q&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=f),q}function dd(t){var n,e=!1,i=!1,r,s,o;if(o=t.input.charCodeAt(t.position),o!==33)return!1;if(t.tag!==null&&k(t,"duplication of a tag property"),o=t.input.charCodeAt(++t.position),o===60?(e=!0,o=t.input.charCodeAt(++t.position)):o===33?(i=!0,r="!!",o=t.input.charCodeAt(++t.position)):r="!",n=t.position,e){do o=t.input.charCodeAt(++t.position);while(o!==0&&o!==62);t.position<t.length?(s=t.input.slice(n,t.position),o=t.input.charCodeAt(++t.position)):k(t,"unexpected end of the stream within a verbatim tag")}else{for(;o!==0&&!Y(o);)o===33&&(i?k(t,"tag suffix cannot contain exclamation marks"):(r=t.input.slice(n-1,t.position+1),Bs.test(r)||k(t,"named tag handle cannot contain such characters"),i=!0,n=t.position+1)),o=t.input.charCodeAt(++t.position);s=t.input.slice(n,t.position),Jl.test(s)&&k(t,"tag suffix cannot contain flow indicator characters")}s&&!Vs.test(s)&&k(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{k(t,"tag name is malformed: "+s)}return e?t.tag=s:Le.call(t.tagMap,r)?t.tag=t.tagMap[r]+s:r==="!"?t.tag="!"+s:r==="!!"?t.tag="tag:yaml.org,2002:"+s:k(t,'undeclared tag handle "'+r+'"'),!0}function cd(t){var n,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&k(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),n=t.position;e!==0&&!Y(e)&&!gt(e);)e=t.input.charCodeAt(++t.position);return t.position===n&&k(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(n,t.position),!0}function ud(t){var n,e,i;if(i=t.input.charCodeAt(t.position),i!==42)return!1;for(i=t.input.charCodeAt(++t.position),n=t.position;i!==0&&!Y(i)&&!gt(i);)i=t.input.charCodeAt(++t.position);return t.position===n&&k(t,"name of an alias node must contain at least one character"),e=t.input.slice(n,t.position),Le.call(t.anchorMap,e)||k(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],D(t,!0,-1),!0}function vt(t,n,e,i,r){var s,o,a,c=1,h=!1,p=!1,f,_,y,$,E,L;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=o=a=Ii===e||Ws===e,i&&D(t,!0,-1)&&(h=!0,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)),c===1)for(;dd(t)||cd(t);)D(t,!0,-1)?(h=!0,a=s,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)):a=!1;if(a&&(a=h||r),(c===1||Ii===e)&&(Ni===e||Us===e?E=n:E=n+1,L=t.position-t.lineStart,c===1?a&&(Ts(t,L)||ld(t,L,E))||od(t,E)?p=!0:(o&&ad(t,E)||nd(t,E)||sd(t,E)?p=!0:ud(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&k(t,"alias node should not have any properties")):rd(t,E,Ni===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=a&&Ts(t,L))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&k(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),f=0,_=t.implicitTypes.length;f<_;f+=1)if($=t.implicitTypes[f],$.resolve(t.result)){t.result=$.construct(t.result),t.tag=$.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(Le.call(t.typeMap[t.kind||"fallback"],t.tag))$=t.typeMap[t.kind||"fallback"][t.tag];else for($=null,y=t.typeMap.multi[t.kind||"fallback"],f=0,_=y.length;f<_;f+=1)if(t.tag.slice(0,y[f].tag.length)===y[f].tag){$=y[f];break}$||k(t,"unknown tag !<"+t.tag+">"),t.result!==null&&$.kind!==t.kind&&k(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+$.kind+'", not "'+t.kind+'"'),$.resolve(t.result,t.tag)?(t.result=$.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):k(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function hd(t){var n=t.position,e,i,r,s=!1,o;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(o=t.input.charCodeAt(t.position))!==0&&(D(t,!0,-1),o=t.input.charCodeAt(t.position),!(t.lineIndent>0||o!==37));){for(s=!0,o=t.input.charCodeAt(++t.position),e=t.position;o!==0&&!Y(o);)o=t.input.charCodeAt(++t.position);for(i=t.input.slice(e,t.position),r=[],i.length<1&&k(t,"directive name must not be less than one character in length");o!==0;){for(;Ke(o);)o=t.input.charCodeAt(++t.position);if(o===35){do o=t.input.charCodeAt(++t.position);while(o!==0&&!de(o));break}if(de(o))break;for(e=t.position;o!==0&&!Y(o);)o=t.input.charCodeAt(++t.position);r.push(t.input.slice(e,t.position))}o!==0&&Ar(t),Le.call(Cs,i)?Cs[i](t,i,r):Fi(t,'unknown document directive "'+i+'"')}if(D(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,D(t,!0,-1)):s&&k(t,"directives end mark is expected"),vt(t,t.lineIndent-1,Ii,!1,!0),D(t,!0,-1),t.checkLineBreaks&&Ql.test(t.input.slice(n,t.position))&&Fi(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&zi(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,D(t,!0,-1));return}if(t.position<t.length-1)k(t,"end of the stream or a document separator is expected");else return}function Qs(t,n){t=String(t),n=n||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new id(t,n),i=t.indexOf("\0");for(i!==-1&&(e.position=i,k(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)hd(e);return e.documents}function pd(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var i=Qs(t,e);if(typeof n!="function")return i;for(var r=0,s=i.length;r<s;r+=1)n(i[r])}function md(t,n){var e=Qs(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new G("expected a single document in the stream, but found more")}}var fd=pd,gd=md,Js={loadAll:fd,load:gd},Xs=Object.prototype.toString,Zs=Object.prototype.hasOwnProperty,Hr=65279,_d=9,zt=10,vd=13,yd=32,bd=33,xd=34,Sr=35,wd=37,$d=38,kd=39,Ed=42,eo=44,Cd=45,Mi=58,Sd=61,Td=62,Ld=63,Pd=64,to=91,io=93,Rd=96,ro=123,Ad=124,no=125,B={};B[0]="\\0";B[7]="\\a";B[8]="\\b";B[9]="\\t";B[10]="\\n";B[11]="\\v";B[12]="\\f";B[13]="\\r";B[27]="\\e";B[34]='\\"';B[92]="\\\\";B[133]="\\N";B[160]="\\_";B[8232]="\\L";B[8233]="\\P";var Dd=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],Hd=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function Od(t,n){var e,i,r,s,o,a,c;if(n===null)return{};for(e={},i=Object.keys(n),r=0,s=i.length;r<s;r+=1)o=i[r],a=String(n[o]),o.slice(0,2)==="!!"&&(o="tag:yaml.org,2002:"+o.slice(2)),c=t.compiledTypeMap.fallback[o],c&&Zs.call(c.styleAliases,a)&&(a=c.styleAliases[a]),e[o]=a;return e}function Nd(t){var n,e,i;if(n=t.toString(16).toUpperCase(),t<=255)e="x",i=2;else if(t<=65535)e="u",i=4;else if(t<=4294967295)e="U",i=8;else throw new G("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+O.repeat("0",i-n.length)+n}var Id=1,Ut=2;function Fd(t){this.schema=t.schema||zs,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=O.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=Od(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?Ut:Id,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Ls(t,n){for(var e=O.repeat(" ",n),i=0,r=-1,s="",o,a=t.length;i<a;)r=t.indexOf(`
`,i),r===-1?(o=t.slice(i),i=a):(o=t.slice(i,r+1),i=r+1),o.length&&o!==`
`&&(s+=e),s+=o;return s}function Tr(t,n){return`
`+O.repeat(" ",t.indent*n)}function Md(t,n){var e,i,r;for(e=0,i=t.implicitTypes.length;e<i;e+=1)if(r=t.implicitTypes[e],r.resolve(n))return!0;return!1}function ji(t){return t===yd||t===_d}function Wt(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==Hr||65536<=t&&t<=1114111}function Ps(t){return Wt(t)&&t!==Hr&&t!==vd&&t!==zt}function Rs(t,n,e){var i=Ps(t),r=i&&!ji(t);return(e?i:i&&t!==eo&&t!==to&&t!==io&&t!==ro&&t!==no)&&t!==Sr&&!(n===Mi&&!r)||Ps(n)&&!ji(n)&&t===Sr||n===Mi&&r}function jd(t){return Wt(t)&&t!==Hr&&!ji(t)&&t!==Cd&&t!==Ld&&t!==Mi&&t!==eo&&t!==to&&t!==io&&t!==ro&&t!==no&&t!==Sr&&t!==$d&&t!==Ed&&t!==bd&&t!==Ad&&t!==Sd&&t!==Td&&t!==kd&&t!==xd&&t!==wd&&t!==Pd&&t!==Rd}function zd(t){return!ji(t)&&t!==Mi}function Mt(t,n){var e=t.charCodeAt(n),i;return e>=55296&&e<=56319&&n+1<t.length&&(i=t.charCodeAt(n+1),i>=56320&&i<=57343)?(e-55296)*1024+i-56320+65536:e}function so(t){var n=/^\n* /;return n.test(t)}var oo=1,Lr=2,ao=3,lo=4,ft=5;function Ud(t,n,e,i,r,s,o,a){var c,h=0,p=null,f=!1,_=!1,y=i!==-1,$=-1,E=jd(Mt(t,0))&&zd(Mt(t,t.length-1));if(n||o)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Mt(t,c),!Wt(h))return ft;E=E&&Rs(h,p,a),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Mt(t,c),h===zt)f=!0,y&&(_=_||c-$-1>i&&t[$+1]!==" ",$=c);else if(!Wt(h))return ft;E=E&&Rs(h,p,a),p=h}_=_||y&&c-$-1>i&&t[$+1]!==" "}return!f&&!_?E&&!o&&!r(t)?oo:s===Ut?ft:Lr:e>9&&so(t)?ft:o?s===Ut?ft:Lr:_?lo:ao}function Wd(t,n,e,i,r){t.dump=(function(){if(n.length===0)return t.quotingType===Ut?'""':"''";if(!t.noCompatMode&&(Dd.indexOf(n)!==-1||Hd.test(n)))return t.quotingType===Ut?'"'+n+'"':"'"+n+"'";var s=t.indent*Math.max(1,e),o=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),a=i||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return Md(t,h)}switch(Ud(n,a,t.indent,o,c,t.quotingType,t.forceQuotes&&!i,r)){case oo:return n;case Lr:return"'"+n.replace(/'/g,"''")+"'";case ao:return"|"+As(n,t.indent)+Ds(Ls(n,s));case lo:return">"+As(n,t.indent)+Ds(Ls(Bd(n,o),s));case ft:return'"'+Vd(n)+'"';default:throw new G("impossible error: invalid scalar style")}})()}function As(t,n){var e=so(t)?String(n):"",i=t[t.length-1]===`
`,r=i&&(t[t.length-2]===`
`||t===`
`),s=r?"+":i?"":"-";return e+s+`
...
`:""}var Jd=Qd,Xd={dump:Jd};function Or(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var co=Js.load,xp=Js.loadAll,Ui=Xd.dump;var wp=Or("safeLoad","load"),$p=Or("safeLoadAll","loadAll"),kp=Or("safeDump","dump");var ce=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>br(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let r=this._currentFields()?.[e.name]?.description;return typeof r=="string"?r:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Ui(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Ui(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Ui(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=co(e)}catch(c){this._yamlError=c.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=l(this.hass,"ui.yaml_expect_object","Expected an object");return}let r=i,s=r.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=l(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=r.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=l(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let a=r.triggers;if(a!==void 0&&(!Array.isArray(a)||!a.every(c=>typeof c=="string"))){this._yamlError=l(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:a})}_emit(e){this.value=e,S(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(r=>`script.${r}`)}_label(e){return M(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},r={};for(let[s,o]of Object.entries(i))o&&Object.hasOwn(o,"default")&&(r[s]=o.default);return r}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,r])=>({name:i,required:r.required,selector:r.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),r=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return d`
  ...
  `,u([m({attribute:!1})],ce.prototype,"hass",2),u([m({attribute:!1})],ce.prototype,"value",2),u([g()],ce.prototype,"_mode",2),u([g()],ce.prototype,"_yamlText",2),u([g()],ce.prototype,"_yamlError",2),ce=u([x("ambience-script-predicate-input")],ce);var Zd=["dawn","sunrise","noon","sunset","dusk","midnight"],Ge=class extends b{constructor(){super(...arguments);this.value={kind:"time",hh:12,mm:0}}_emit(e){S(this,e)}_onKindChange(e){let i=e.target.value;i!==this.value.kind&&(i==="time"?this._emit({kind:"time",hh:12,mm:0}):this._emit({kind:"sun",anchor:"sunset",offset_min:0}))}_onTimeChange(e){if(this.value.kind!=="time")return;let i=e.target.value,[r,s]=i.split(":").map(o=>parseInt(o,10));Number.isNaN(r)||Number.isNaN(s)||this._emit({kind:"time",hh:r,mm:s})}_onAnchorChange(e){if(this.value.kind!=="sun")return;let i=e.target.value;this._emit({...this.value,anchor:i})}_onOffsetChange(e){if(this.value.kind!=="sun")return;let i=e.target.value.trim(),r=i===""?0:parseInt(i,10);Number.isNaN(r)||this._emit({...this.value,offset_min:r})}_onClampDirChange(e){if(this.value.kind!=="sun")return;let i=e.target.value;if(i===""){this._emit({kind:"sun",anchor:this.value.anchor,offset_min:this.value.offset_min});return}let r=this.value.clamp??ec();this._emit({...this.value,clamp:{dir:i,hh:r.hh,mm:r.mm}})}_onClampTimeChange(e){if(this.value.kind!=="sun"||!this.value.clamp)return;let i=e.target.value,[r,s]=i.split(":").map(o=>parseInt(o,10));Number.isNaN(r)||Number.isNaN(s)||this._emit({...this.value,clamp:{dir:this.value.clamp.dir,hh:r,mm:s}})}_renderTime(e){let i=`${String(e.hh).padStart(2,"0")}:${String(e.mm).padStart(2,"0")}`;return d`<input type="time" .value=${i} @input=${this._onTimeChange} />`}_renderSun(e){let i=tc(e.offset_min,this.hass),r=e.clamp?.dir??"",s=e.clamp?`${String(e.clamp.hh).padStart(2,"0")}:${String(e.clamp.mm).padStart(2,"0")}`:"";return d`
      <div class="sun">
        <div class="row">
          <select @change=${this._onAnchorChange}>
            ${Zd.map(o=>d`<option value=${o} ?selected=${o===e.anchor}>${$e(this.hass,o)}</option>`)}
          </select>
          <input
            type="number"
            step="1"
  ...
  `,u([m({attribute:!1})],Ge.prototype,"hass",2),u([m({attribute:!1})],Ge.prototype,"value",2),Ge=u([x("ambience-time-endpoint")],Ge);function ec(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function tc(t,n){if(t===0)return"";let e=Math.abs(t),i=t<0?"\u2212":"+";if(e%60===0){let r=e/60,s=r===1?l(n,"ui.unit_hour","hour"):l(n,"ui.unit_hours","hours");return`${i}${r} ${s}`}return`${i}${e} ${l(n,"ui.unit_min","min")}`}function Wi(t,n){if(!t)return[];let e=Object.keys(t.builtins??{}),i=n?e.slice().sort(n):e,r=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(o=>!(o in(t.builtins??{})));return[...i.filter(o=>!r.has(o)),...s]}var ue=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._error=""}static{this.styles=v`
    :host { display: block; }
  ...
  `}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){try{this._view=await this._list(),this._error=""}catch(e){this._error=e.message||String(e)}}async _saveState(e){try{await this._save(e,this._view.hidden),this._error=""}catch(i){return this._error=i.message||String(i),!1}return await this._reload(),!0}_onEdit(e,i){this._modal={mode:"edit",id:e,initial:i}}async _onDelete(e){let i={...this._view.custom};delete i[e],await this._saveState(i)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:i,definition:r}=e.detail;await this._saveState({...this._view.custom,[i]:r})&&(this._modal={mode:"closed"})}_onModalCancel(){this._modal={mode:"closed"}}_takenIds(){return new Set([...Object.keys(this._view.builtins),...Object.keys(this._view.custom)])}_renderBuiltinRow(e,i,r){return d`
    ...
    .chip-label { flex: 1; }
  `,u([m({attribute:!1})],he.prototype,"value",2),u([m({attribute:!1})],he.prototype,"periods",2),u([m({attribute:!1})],he.prototype,"hass",2),u([g()],he.prototype,"_entries",2),u([g()],he.prototype,"_openIdx",2),he=u([x("ambience-time-of-day-input")],he);function Ye(t,n,e,i,r,s){return customElements.get("ha-form")?d`<ha-form
      class=${n}
      .hass=${t}
  ...
  </select>`}function yt(t,n,e,i,r){return customElements.get("ha-form")?d`<ha-form
      class="field"
      data-field="sensors"
      .hass=${t}
      .schema=${n}
  ...
  `,u([m({attribute:!1})],Re.prototype,"hass",2),u([m({attribute:!1})],Re.prototype,"value",2),u([m({attribute:!1})],Re.prototype,"dayConfig",2),Re=u([x("ambience-day-predicate-input")],Re);var fo=["temperature","apparent_temperature","humidity","wind_speed","pressure"],go=["<","<=",">",">="],_o={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},xe=class extends b{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let i=e.groups.length===0&&e.thresholds.length===0;this.value=i?null:e,S(this,this.value)}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,i){let r=this._current();r.thresholds=r.thresholds.map((s,o)=>o===e?i:s),this._emit(r)}_removeThreshold(e){let i=this._current();i.thresholds=i.thresholds.filter((r,s)=>s!==e),this._emit(i)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:fo.map(i=>({value:i,label:Tt(this.hass,i)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:go.map(i=>({value:i,label:_o[i]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,i){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:dr(this.hass,i,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?d`<ha-form
      ...
      ${fo.map(r=>d`<option value=${r} ?selected=${r===i.attribute}>${Tt(this.hass,r)}</option>`)}
      ...
      ${go.map(r=>d`<option value=${r} ?selected=${r===i.op}>${_o[r]}</option>`)}
  ...
  `,u([m({attribute:!1})],xe.prototype,"hass",2),u([m({attribute:!1})],xe.prototype,"value",2),u([m({attribute:!1})],xe.prototype,"groups",2),u([m({attribute:!1})],xe.prototype,"weatherEntity",2),xe=u([x("ambience-weather-predicate-input")],xe);var oc=["NW","N","NE","W",null,"E","SW","S","SE"],Qe=class extends b{constructor(){super(...arguments);this.value=null}_current(){let e=this.value?.azimuth?.ranges??[];return{elevation:this.value?.elevation??null,sectors:[...this.value?.azimuth?.sectors??[]],range:e.length?{...e[0]}:null}}_emit(e){let i={};e.elevation&&(e.elevation.min!=null||e.elevation.max!=null)&&(i.elevation=e.elevation);let r={};e.sectors.length&&(r.sectors=e.sectors),e.range&&(r.ranges=[e.range]),(r.sectors||r.ranges)&&(i.azimuth=r),this.value=i.elevation||i.azimuth?i:null,S(this,this.value)}_setElevation(e){this._emit({...this._current(),elevation:e})}_setSectors(e){this._emit({...this._current(),sectors:e})}_setRange(e){this._emit({...this._current(),range:e})}_mode(e){return!e||e.min==null&&e.max==null?"any":e.min!=null&&e.max!=null?"between":e.min!=null?"above":"below"}_onModeChange(e,i){let r=i?.min??0,s=i?.max??0;e==="any"?this._setElevation(null):e==="above"?this._setElevation({min:r}):e==="below"?this._setElevation({max:s}):this._setElevation({min:r,max:s})}_toggleSector(e,i,r){this._setSectors(r?[...e,i]:e.filter(s=>s!==i))}_renderSectors(e){return d`<div class="sectors">${oc.map(i=>i===null?d`<span class="spacer"></span>`:d`<label>
  ...
  `,u([m({attribute:!1})],Xe.prototype,"hass",2),u([m({attribute:!1})],Xe.prototype,"value",2),Xe=u([x("ambience-people-predicate-input")],Xe);var Ze=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[]}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_hasFor(e){return!!e&&(e.h!==0||e.m!==0||e.s!==0)}_build(e){let i={...this._cur(),...e},r={sensors:i.sensors??[]};return i.occupied===!1&&(r.occupied=!1),i.quant==="all"&&(r.quant="all"),this._hasFor(i.for)&&(r.for=i.for),i.negate===!0&&(r.negate=!0),r}_emit(e){this.value=e,S(this,e)}_setSensors(e){this._emit(this._build({sensors:e}))}_setOccupied(e){this._emit(this._build({occupied:e}))}_setNegate(e){this._emit(this._build({negate:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setFor(e){this._emit(this._build({for:e}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"binary_sensor",device_class:["occupancy","presence","motion"],multiple:!0}}}]}_renderSensors(){return yt(this.hass,this._sensorSchema(),this._sensors(),"binary_sensor.a, binary_sensor.b",e=>this._setSensors(e))}_renderNegate(e){return Ye(this.hass,"negate","negate",e?"is_not":"is",[{value:"is",label:l(this.hass,"ui.occupancy_is","is")},{value:"is_not",label:l(this.hass,"ui.occupancy_is_not","is not")}],i=>this._setNegate(i==="is_not"))}_renderOccupied(e){return Ye(this.hass,"state","state",e?"occupied":"vacant",[{value:"occupied",label:l(this.hass,"ui.occupancy_detected","Detected")},{value:"vacant",label:l(this.hass,"ui.occupancy_clear","Clear")}],i=>this._setOccupied(i==="occupied"))}_renderQuant(e){return Ye(this.hass,"quant","quant",e,[{value:"any",label:l(this.hass,"ui.occupancy_any","Any of")},{value:"all",label:l(this.hass,"ui.occupancy_all","All of")}],i=>this._setQuant(i))}_renderFor(){return d`<ambience-for-duration
    ...
    .for-row { display: flex; gap: 0.25rem; align-items: center; }
    .for-row input[type='number'] { width: 3.5rem; }
  `,u([m({attribute:!1})],Ze.prototype,"hass",2),u([m({attribute:!1})],Ze.prototype,"value",2),Ze=u([x("ambience-occupancy-predicate-input")],Ze);function wo(t,n){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?l(n,"ui.unavailable_select_one","Select at least one entity"):null}var dc=[{name:"sensors",selector:{entity:{multiple:!0}}}],et=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,S(this,i)}render(){return d`
      <div class="row">
        ${yt(this.hass,dc,this._entities(),"binary_sensor.a, light.b",e=>this._setEntities(e))}
      </div>
    `}};et.styles=v`
    :host {
      display: block;
  ...
  `,u([m({attribute:!1})],ie.prototype,"condition",2),u([m({attribute:!1})],ie.prototype,"value",2),u([m({attribute:!1})],ie.prototype,"periods",2),u([m({attribute:!1})],ie.prototype,"luxRanges",2),u([m({attribute:!1})],ie.prototype,"dayConfig",2),u([m({attribute:!1})],ie.prototype,"weatherConfig",2),u([m({attribute:!1})],ie.prototype,"hass",2),ie=u([x("ambience-condition-input")],ie);function hc(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function pc(t){return t==="people"?{quant:"everyone",where:"home"}:null}function ko(t,n){return!!t&&!!n&&H(t)===H(n)}var mc={state:yo,day:mo,lux:po,unavailable:wo},C=class extends b{constructor(){super(...arguments);this.open=!1;this.scene=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.takenNames=new Map;this.saveError="";this._draft=null;this._open=null;this._showError=!1;this._addOrder=[];this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onAddCondition=e=>{let i=e.target,r=i.value;i.value="",this._addCondition(r)};this._onAddConditionHaForm=e=>{e.stopPropagation();let i=e.detail.value.add;i!==C._ADD_CONDITION_PLACEHOLDER&&this._addCondition(i)};this._onAddAction=e=>{let i=e.target,r=i.value;i.value="",this._addActionSlot(r)};this._onAddActionHaForm=e=>{e.stopPropagation();let i=e.detail.value.add;i!==C._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(i)}}_onConditionInvalid(e,i){i?this._conditionError.set(e,i):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),ee(this)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.scene?JSON.parse(JSON.stringify(this.scene)):null,this._scope=this.scope,this._open=null,this._showError=!1,this._addOrder=[],this._conditionError=new Map)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let i=this.scopes[e];if(!i||!this._draft||(this._scope=i.scope,!this.hass))return;let r=new Set(ki(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(o=>r.has(o))}))}}_renderDestination(){return d`
    ...
    `}_renderDestinationSlot(){if(this.scopes.length===0)return"";if(this._isOpen({kind:"destination"}))return d`
      ...
      `;let e=this.scopes.find(i=>ko(i.scope,this._scope))??this.scopes[0];return d`
...
`;function Eo(t,n){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:n},bubbles:!0,composed:!0}))}function Ur(t,n){return d`<span
    class="entity-link"
    role="button"
    tabindex="0"
    ...
    >${n}</span
  >`}function Co(t,n){return Ur(n,Hi(t,n))}var gc=new Set(["occupancy","people","lux","state"]);function _c(t,n,e,i,r){let s=fc(t,n,e,i);if(!r?.length||!gc.has(n))return s;let o=[],a=r.map(p=>({id:p,name:Hi(t,p)})).sort((p,f)=>f.name.length-p.name.length);for(let{id:p,name:f}of a)for(let _=0;_<=s.length;){let y=s.indexOf(f,_);if(y===-1)break;let $=y+f.length;if(!o.some(E=>y<E.end&&E.start<$)){o.push({start:y,end:$,id:p,name:f});break}_=y+1}if(o.length===0)return s;o.sort((p,f)=>p.start-f.start);let c=[],h=0;for(let p of o)p.start>h&&c.push(s.slice(h,p.start)),c.push(Ur(p.id,p.name)),h=p.end;return h<s.length&&c.push(s.slice(h)),d`${c}`}var vc={has_time:"Periodic time check",switch:"Switch turned on",manual:"Manual apply",startup:"Startup",reloaded:"Reloaded",simulated:"Simulation"},yc={clock:"Time of day",sun:"Sun position",reapply:"Reapply"};function pe(t){return t??"?"}function So(t){if(t.kind==="entity")return`${t.entity_id} ${pe(t.old)} \u2192 ${pe(t.new)}`;if(t.kind==="duration")return t.entity_id?`${t.entity_id} ${pe(t.new)} for ${pe(t.detail)}`:`${pe(t.new)} for ${pe(t.detail)}`;let n=vc[t.kind];if(n)return n;let e=yc[t.kind]??I(t.kind);return t.detail?`${e} ${t.detail}`:e}function bc(t){if(!Gi(t)||!t.entity_id)return d`${So(t)}`;let n=Ur(t.entity_id,t.entity_id);return t.kind==="duration"?d`${n} ${pe(t.new)} for ${pe(t.detail)}`:d`${n} ${pe(t.old)} → ${pe(t.new)}`}function Gi(t){return t.kind==="entity"||t.kind==="duration"&&!!t.entity_id}function To(t,n){let e=t.entity_id?n?.states?.[t.entity_id]:void 0,i=r=>r===null?"?":ot(n,e,null,r);return{old:i(t.old),new:i(t.new)}}function xc(t,n){if(!Gi(t))return So(t);let e=t.entity_id?Hi(n,t.entity_id):"?",i=To(t,n);return t.kind==="duration"?`${e}: ${i.new} for ${t.detail??"?"}`:`${e}: ${i.old} \u2192 ${i.new}`}function wc(t,n){if(!Gi(t)||!t.entity_id)return d`${xc(t,n)}`;let e=Co(n,t.entity_id),i=To(t,n);return t.kind==="duration"?d`${e}: ${i.new} for ${t.detail??"?"}`:d`${e}: ${i.old} → ${i.new}`}var $c={acted:"applied",no_op:"blocked",debounced:"unchanged",no_match:"no match",skipped_switch_off:"skipped",skipped_scope_disabled:"skipped",skipped_unavailable:"skipped"};function kc(t){return $c[t]??t.replace(/_/g," ")}function Lo(t){let n=t.winner_name??"The matching scene";switch(t.outcome){case"acted":{let e=t.actions.filter(a=>!a.unexposed),i=t.actions.length-e.length;if(e.length===0&&i)return`${n} matched \u2014 ${qi(i,"action","actions")} skipped (not exposed); nothing applied.`;let r=qi(e.length,"action","actions"),s=Ro(e),o=i?` (${i} skipped \u2014 not exposed)`:"";return s?`Applied ${n} \u2014 ${r} on ${qi(s,"entity","entities")}.${o}`:`Applied ${n} \u2014 ${r}.${o}`}case"no_op":return`${n} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.`;case"debounced":return`${n} matched, but it's already applied \u2014 nothing was re-sent.`;case"no_match":return"No scene matched \u2014 nothing applied.";case"skipped_switch_off":return"Skipped \u2014 the category switch is off.";case"skipped_scope_disabled":return"Skipped \u2014 the scope is disabled.";case"skipped_unavailable":return"Skipped \u2014 the triggering entity went unavailable; devices left as they are.";default:return""}}function Po(t,n){return st(t,n,()=>oi(t))}function Ec(t,n,e,i){let r=Object.entries(t.params??{}).filter(([,o])=>o!=null&&o!=="").map(([o,a])=>`${It(o,t.service,e)}: ${Se(n,a)}`).join(", "),s=Po(t.service,i);return r?`${s} \xB7 ${r}`:s}function Ro(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function qi(t,n,e){return`${t} ${t===1?n:e}`}function Cc(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"||t==="skipped_unavailable"}function Sc(t,n,e){let i=t.index+1;return t.disabled?d`<div class="scene disabled">Scene #${i} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?d`
    ...
    ${t.predicates.map(r=>d`
        <div class="pred ${r.passed?"pass":"fail"}" style="padding-left:1rem">
          ${r.passed?"\u2713":"\u2717"} ${J(n,r.condition_key)}${r.detail?d` <span class="dim">[${_c(n,r.condition_key,r.detail,e,r.entity_ids)}]</span>`:w}
        </div>`)}
  `:d`<div class="scene skipped">Scene #${i} ${t.name??"\u2014"}: not reached</div>`}function Yi(t,n,e,i,r,s={},o){let a=t.actions.filter(_=>!_.unexposed),c=a.map(_=>Po(_.service,o)).join(", "),h=Ro(a),p=t.explanation!==null||t.actions.length>0||Cc(t.outcome),f=_=>{(_.key==="Enter"||_.key===" ")&&!_.repeat&&(_.preventDefault(),e())};return d`
    <div class="eval">
      <div
        ...
        @keydown=${p?f:void 0}
      >
        <span class="label">${kc(t.outcome)}</span>
        <span class="ts">${t.timestamp?new Date(t.timestamp).toLocaleTimeString():""}</span>
      </div>
      <div class="eval-body">
        <div class="cause-line">Trigger: ${wc(t.cause,i)}</div>
        ${t.winner_name?d`<div class="won">Won: <span class="name">${t.winner_name}</span></div>`:w}
        ${a.length?d`<div class="action-summary">→ ${c}
              ${h?d`<span class="n">· ${qi(h,"entity","entities")}</span>`:w}</div>`:n?w:d`<div class="action-summary">${Lo(t)}</div>`}
      </div>
      ${n?Tc(t,i,r,s,o):w}
    </div>
  `}function Tc(t,n,e,i,r){let s=Lo(t),o=Gi(t.cause);return d`
    <div class="why">
      ${o?d`<div class="raw-trigger">Trigger: ${bc(t.cause)}</div>`:w}
      ${s?d`<div class="outcome-summary">${s}</div>`:w}
      ${t.explanation?d`<div class="section">
            <div class="section-title">Scene evaluation</div>
            <div class="scenes">${t.explanation.scenes.map(a=>Sc(a,n,i))}</div>
          </div>`:w}
  ...
  `}var De=class{constructor(n,e){this._onKeydown=n=>{this._host.open&&n.key==="Escape"&&this._close()};this._onBackdrop=()=>{this._host.open&&this._close()};this._host=n,this._close=e,n.addController(this)}hostConnected(){document.addEventListener("keydown",this._onKeydown),this._host.addEventListener("click",this._onBackdrop)}hostDisconnected(){document.removeEventListener("keydown",this._onKeydown),this._host.removeEventListener("click",this._onBackdrop)}};var N=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1;new De(this,()=>this._onClose())}disconnectedCallback(){super.disconnectedCallback(),this._stopPoll()}_startPoll(){this._poll||(this._poll=setInterval(()=>this._checkNew(),5e3))}_stopPoll(){this._poll&&(clearInterval(this._poll),this._poll=void 0)}updated(e){e.has("open")&&(this.open?this._startPoll():this._stopPoll()),this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(i=>i.scope_kind===this.scope.scope_kind&&i.scope_id===this.scope.scope_id&&i.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await pr(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=e.message||String(e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(o=>o.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let i=await Promise.all(e.map(async s=>{try{return[s,await Ee(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let r={...this._schemas};for(let s of i)s&&(r[s[0]]=s[1]);this._schemas=r}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let i=this._mine(await pr(this.hass))[0]?.timestamp??null,r=this._records[0]?.timestamp??null;i&&(!r||i>r)&&(this._hasNew=!0)}catch{}}_toggle(e){let i=new Set(this._expanded);i.has(e)?i.delete(e):i.add(e),this._expanded=i}async _download(){try{await Xn(this.hass,this.scope,this.category)}catch(e){this._error=e.message||String(e)}}async _clear(){try{await Jn(this.hass),await this._load()}catch(e){this._error=e.message||String(e)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return w;let e=this.categoryName??this.category;return d`
    ...
    `}render(){if(!this.open)return w;let e=l(this.hass,"ui.auto_triggers_section","Auto-triggers");return d`
  ...
  `,u([m({attribute:!1})],Q.prototype,"hass",2),u([m({attribute:!1})],Q.prototype,"scope",2),u([m()],Q.prototype,"scopeName",2),u([m({attribute:!1})],Q.prototype,"scenes",2),u([m({type:Boolean,reflect:!0})],Q.prototype,"open",2),u([g()],Q.prototype,"_triggers",2),u([g()],Q.prototype,"_opaque",2),u([g()],Q.prototype,"_loading",2),u([g()],Q.prototype,"_error",2),Q=u([x("ambience-auto-triggers-modal")],Q);function Ao(t,n){return n==="not_home"?l(t,"ui.away","Away"):n==="home"?l(t,"ui.home","Home"):I(n)}function Do(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(n=>[n.name,n.live_value==null?"":String(n.live_value)])),for:{h:0,m:0,s:0}}}function Qi(t){return String(t).padStart(2,"0")}function Ho(t){return`${t.getFullYear()}-${Qi(t.getMonth()+1)}-${Qi(t.getDate())}`}function Oo(t){return`${Qi(t.getHours())}:${Qi(t.getMinutes())}`}var P=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1;new De(this,()=>this._onClose())}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=Ho(e),this._time=Oo(e);try{let i=await Zn(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=i.knobs,this._hasTime=i.has_time;let r={},s={};for(let o of i.knobs)o.kind==="entity"?r[o.entity_id]=Do(o):s[this._vkey(o)]=o.live_value;this._values=r,this._verdicts=s,this._loading=!1}catch(i){this._error=i.message||String(i),this._loading=!1}}_setState(e,i){this._values={...this._values,[e]:{...this._values[e],state:i}}}_setAttr(e,i,r){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[i]:r}}}}_setFor(e,i,r){let s=this._values[e],o=Number.isFinite(r)&&r>0?Math.trunc(r):0;this._values={...this._values,[e]:{...s,for:{...s.for,[i]:o}}}}_setVerdict(e,i){this._verdicts={...this._verdicts,[e]:i}}_resetWhen(){let e=new Date;this._date=Ho(e),this._time=Oo(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:Do(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let i of this._knobs){if(i.kind!=="entity")continue;let r=this._values[i.entity_id];if(!r)continue;let s={};for(let a of i.attributes){let c=r.attributes[a.name];if(!(c===void 0||c===""))if(a.control==="number"){let h=Number(c);Number.isNaN(h)||(s[a.name]=h)}else s[a.name]=c}let o={attributes:s};r.state!==""&&(o.state=r.state),(r.for.h||r.for.m||r.for.s)&&(o.for=r.for),(o.state!==void 0||o.for!==void 0||Object.keys(s).length>0)&&(e[i.entity_id]=o)}return e}_buildVerdicts(){let e={};for(let i of this._knobs)i.kind==="verdict"&&(e[i.condition]||(e[i.condition]={}),e[i.condition][i.key]=this._verdicts[this._vkey(i)]??i.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`);if(!this._date||!this._time||Number.isNaN(e.getTime())){this._error=l(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}let i=e.toISOString();try{this._result=await es(this.hass,this.scope,this.category,i,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(r){this._error=r.message||String(r)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?d`
      <div class="modal" role="dialog" aria-modal="true" @click=${e=>e.stopPropagation()}>
        ...
        <div class="body">
          ${this._error?d`<p class="error">${this._error}</p>`:w}
          ${this._loading?d`<p>${l(this.hass,"ui.loading","Loading\u2026")}</p>`:d`
            ...
            ${this._result?d`<div class="result">${Yi(this._result,this._expanded,()=>this._expanded=!this._expanded,this.hass,void 0,this.periods?.custom??{},this.exposedActions)}</div>`:w}
          `}
        </div>
      </div>`:w}_renderEntity(e){let i=this._values[e.entity_id],r=e.attributes.length>0;return d`
    ...
    `}_renderControl(e,i){if(e.control==="select")return d`<select data-entity=${e.entity_id} .value=${i}
        ...
        ${(e.options??[i]).map(s=>d`<option value=${s} ?selected=${s===i}>${Ao(this.hass,s)}</option>`)}
    ...
    </span>`}_renderVerdict(e){let i=this._vkey(e),r=this._verdicts[i]??e.live_value,s=e.entity_id?M(this.hass,e.entity_id):e.label,o=e.entity_id?Ot(this.hass,e.entity_id):d`<ha-icon class="row-icon" icon="mdi:code-braces"></ha-icon>`;return d`
      <div class="row">
        ${o}
        <div class="row-text">
          <div class="row-title">${s}</div>
          ${e.entity_id?d`<div class="row-detail">${e.entity_id}</div>`:w}
        </div>
        <div class="row-ctrl">
  ...
  `,u([m({attribute:!1})],fe.prototype,"hass",2),u([g()],fe.prototype,"_categories",2),u([g()],fe.prototype,"_error",2),u([g()],fe.prototype,"_editing",2),u([g()],fe.prototype,"_modalError",2),fe=u([x("ambience-categories-settings")],fe);var we=class extends b{constructor(){super(...arguments);this.conditionName="";this.conditionDescription="";this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}render(){let e=J(this.hass,this.conditionName);return d`
      <div class="card">
  ...
  `,u([m({attribute:!1})],we.prototype,"hass",2),u([m()],we.prototype,"conditionName",2),u([m()],we.prototype,"conditionDescription",2),u([g()],we.prototype,"_expanded",2),we=u([x("ambience-condition-card")],we);var Dc=/^[a-z][a-z0-9_]*$/;function Hc(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var Gt=v`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,ne=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=Gt}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!Dc.test(e)?l(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?l(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":l(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??Hc(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return d`
    ...
    `}_validateDef(){return this._min==null&&this._max==null?l(this.hass,"ui.lux_error_need_bound","Enter a min, a max, or both."):this._min!=null&&this._min<0||this._max!=null&&this._max<0?l(this.hass,"ui.lux_error_negative","Bounds must be 0 or greater."):this._min!=null&&this._max!=null&&this._min>=this._max?l(this.hass,"ui.lux_error_order","Min must be less than max."):""}_buildDefinition(){let e={label:this._label.trim()||null};return this._min!=null&&(e.min=this._min),this._max!=null&&(e.max=this._max),e}};He.styles=[Gt,v`
      ...
      .row .field { flex: 1; }
    `],u([m({attribute:!1})],He.prototype,"initial",2),u([g()],He.prototype,"_min",2),u([g()],He.prototype,"_max",2),He=u([x("ambience-lux-edit-modal")],He);var Xi=class extends ue{_list(){return _i(this.hass)}async _save(n,e){await Fn(this.hass,n,e)}_label(n,e){return at(this.hass,n,e)}_formatDef(n){return xr(n.min,n.max,"any")}_headingKey(){return["ui.lux_heading","Lux ranges"]}_addKey(){return["ui.add_custom_lux_range","+ Add custom lux range"]}_renderModal(){let n=this._modal;return n.mode==="edit"?d`<ambience-lux-edit-modal
        .hass=${this.hass}
        .existingId=${n.id}
        .initial=${n.initial}
        .takenIds=${this._takenIds()}
  ...
  `,u([m({attribute:!1})],Ne.prototype,"hass",2),u([g()],Ne.prototype,"_config",2),u([g()],Ne.prototype,"_expanded",2),Ne=u([x("ambience-weather-config")],Ne);var Fo={time_of_day:t=>d`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>d`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>d`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>d`<ambience-weather-config .hass=${t}></ambience-weather-config>`},Nc=new Set(Object.keys(Fo)),Ie=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await fi(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._conditions.filter(i=>Nc.has(i.name)).slice().sort((i,r)=>r.priority-i.priority);return d`
  ...
  `,u([m({attribute:!1})],Fe.prototype,"hass",2),u([m({attribute:!1})],Fe.prototype,"initialTab",2),u([g()],Fe.prototype,"_tab",2),Fe=u([x("ambience-settings-view")],Fe);var Me=class extends b{constructor(){super();this.open=!1;new De(this,()=>this._close())}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?d`
      <div
        class="modal"
        role="dialog"
        aria-modal="true"
