...
`;function Na(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function Qr(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Na(n,r))};return d`<span
  ...
  `:d`<div class="scene skipped">${n}${i} ${t.name??"\u2014"}: ${l(r,"ui.trace_scene_not_reached","not reached")}</div>`}function ir(t,r,e,i,n,s={},a){let o=t.actions.filter(g=>!g.unexposed),c=o.map(g=>za(g.service,a)).join(", "),h=Ua(o),p=t.explanation!==null||t.actions.length>0||Wc(t.outcome),f=g=>{(g.key==="Enter"||g.key===" ")&&!g.repeat&&(g.preventDefault(),e())};return d`
    <div class="eval">
      <div
