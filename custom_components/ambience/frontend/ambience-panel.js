...
\f\r"'\`<>=]|("|')|))|$)`,"g"),fr=/'/g,gr=/"/g,br=/^(?:script|style|textarea|title)$/i,Nt=t=>(n,...e)=>({_$litType$:t,strings:n,values:e}),l=Nt(1),co=Nt(2),uo=Nt(3),ge=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),_r=new WeakMap,me=fe.createTreeWalker(fe,129);function $r(t,n){if(!Pt(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return hr!==void 0?hr.createHTML(n):n}var Qi=(t,n)=>{let e=t.length-1,r=[],i,s=n===2?"<svg>":n===3?"<math>":"",a=Pe;for(let o=0;o<e;o++){let d=t[o],h,f,p=-1,_=0;for(;_<d.length&&(a.lastIndex=_,f=a.exec(d),f!==null);)_=a.lastIndex,a===Pe?f[1]==="!--"?a=pr:f[1]!==void 0?a=mr:f[2]!==void 0?(br.test(f[2])&&(i=RegExp("</"+f[2],"g")),a=pe):f[3]!==void 0&&(a=pe):a===pe?f[0]===">"?(a=i??Pe,p=-1):f[1]===void 0?p=-2:(p=a.lastIndex-f[2].length,h=f[1],a=f[3]===void 0?pe:f[3]==='"'?gr:fr):a===gr||a===fr?a=pe:a===pr||a===mr?a=Pe:(a=pe,i=void 0);let v=a===pe&&t[o+1].startsWith("/>")?" ":"";s+=a===Pe?d+Vi:p>=0?(r.push(h),d.slice(0,p)+vr+d.slice(p)+ae+v):d+ae+(p===-2?o:v)}return[$r(t,s+(t[e]||"<?>")+(n===2?"</svg>":n===3?"</math>":"")),r]},Re=class t{constructor({strings:n,_$litType$:e},r){let i;this.parts=[];let s=0,a=0,o=n.length-1,d=this.parts,[h,f]=Qi(n,e);if(this.el=t.createElement(h,r),me.currentNode=this.el.content,e===2||e===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=me.nextNode())!==null&&d.length<o;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(vr)){let _=f[a++],v=i.getAttribute(p).split(ae),k=/([.?@])?(.*)/.exec(_);d.push({type:1,index:s,name:k[2],strings:v,ctor:k[1]==="."?Tt:k[1]==="?"?Dt:k[1]==="@"?Ft:ke}),i.removeAttribute(p)}else p.startsWith(ae)&&(d.push({type:6,index:s}),i.removeAttribute(p));if(br.test(i.tagName)){let p=i.textContent.split(ae),_=p.length-1;if(_>0){i.textContent=Ze?Ze.emptyScript:"";for(let v=0;v<_;v++)i.append(p[v],Ne()),me.nextNode(),d.push({type:2,index:++s});i.append(p[_],Ne())}}}else if(i.nodeType===8)if(i.data===yr)d.push({type:2,index:s});else{let p=-1;for(;(p=i.data.indexOf(ae,p+1))!==-1;)d.push({type:7,index:s}),p+=ae.length-1}s++}}static createElement(n,e){let r=fe.createElement("template");return r.innerHTML=n,r}};function we(t,n,e=t,r){if(n===ge)return n;let i=r!==void 0?e._$Co?.[r]:e._$Cl,s=Ie(n)?void 0:n._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(t),i._$AT(t,e,r)),r!==void 0?(e._$Co??=[])[r]=i:e._$Cl=i),i!==void 0&&(n=we(t,i._$AS(t,n.values),i,r)),n}var Lt=class{constructor(n,e){this._$AV=[],this._$AN=void 0,this._$AD=n,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(n){let{el:{content:e},parts:r}=this._$AD,i=(n?.creationScope??fe).importNode(e,!0);me.currentNode=i;let s=me.nextNode(),a=0,o=0,d=r[0];for(;d!==void 0;){if(a===d.index){let h;d.type===2?h=new Me(s,s.nextSibling,this,n):d.type===1?h=new d.ctor(s,d.name,d.strings,this,n):d.type===6&&(h=new Ht(s,this,n)),this._$AV.push(h),d=r[++o]}a!==d?.index&&(s=me.nextNode(),a++)}return me.currentNode=fe,i}p(n){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(n,r,e),e+=r.strings.length-2):r._$AI(n[e])),e++}},Me=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(n,e,r,i){this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=n,this._$AB=e,this._$AM=r,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let n=this._$AA.parentNode,e=this._$AM;return e!==void 0&&n?.nodeType===11&&(n=e.parentNode),n}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(n,e=this){n=we(this,n,e),Ie(n)?n===F||n==null||n===""?(this._$AH!==F&&this._$AR(),this._$AH=F):n!==this._$AH&&n!==ge&&this._(n):n._$litType$!==void 0?this.$(n):n.nodeType!==void 0?this.T(n):Ji(n)?this.k(n):this._(n)}O(n){return this._$AA.parentNode.insertBefore(n,this._$AB)}T(n){this._$AH!==n&&(this._$AR(),this._$AH=this.O(n))}_(n){this._$AH!==F&&Ie(this._$AH)?this._$AA.nextSibling.data=n:this.T(fe.createTextNode(n)),this._$AH=n}$(n){let{values:e,_$litType$:r}=n,i=typeof r=="number"?this._$AC(n):(r.el===void 0&&(r.el=Re.createElement($r(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===i)this._$AH.p(e);else{let s=new Lt(i,this),a=s.u(this.options);s.p(e),this.T(a),this._$AH=s}}_$AC(n){let e=_r.get(n.strings);return e===void 0&&_r.set(n.strings,e=new Re(n)),e}k(n){Pt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,i=0;for(let s of n)i===e.length?e.push(r=new t(this.O(Ne()),this.O(Ne()),this,this.options)):r=e[i],r._$AI(s),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(n=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);n!==this._$AB;){let r=ur(n).nextSibling;ur(n).remove(),n=r}}setConnected(n){this._$AM===void 0&&(this._$Cv=n,this._$AP?.(n))}},ke=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(n,e,r,i,s){this.type=1,this._$AH=F,this._$AN=void 0,this.element=n,this.name=e,this._$AM=i,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=F}_$AI(n,e=this,r,i){let s=this.strings,a=!1;if(s===void 0)n=we(this,n,e,0),a=!Ie(n)||n!==this._$AH&&n!==ge,a&&(this._$AH=n);else{let o=n,d,h;for(n=s[0],d=0;d<s.length-1;d++)h=we(this,o[r+d],e,d),h===ge&&(h=this._$AH[d]),a||=!Ie(h)||h!==this._$AH[d],h===F?n=F:n!==F&&(n+=(h??"")+s[d+1]),this._$AH[d]=h}a&&!i&&this.j(n)}j(n){n===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,n??"")}},Tt=class extends ke{constructor(){super(...arguments),this.type=3}j(n){this.element[this.name]=n===F?void 0:n}},Dt=class extends ke{constructor(){super(...arguments),this.type=4}j(n){this.element.toggleAttribute(this.name,!!n&&n!==F)}},Ft=class extends ke{constructor(n,e,r,i,s){super(n,e,r,i,s),this.type=5}_$AI(n,e=this){if((n=we(this,n,e,0)??F)===ge)return;let r=this._$AH,i=n===F&&r!==F||n.capture!==r.capture||n.once!==r.once||n.passive!==r.passive,s=n!==F&&(r===F||i);i&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,n),this._$AH=n}handleEvent(n){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,n):this._$AH.handleEvent(n)}},Ht=class{constructor(n,e,r){this.element=n,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(n){we(this,n)}};var Xi=Ot.litHtmlPolyfillSupport;Xi?.(Re,Me),(Ot.litHtmlVersions??=[]).push("3.3.2");var xr=(t,n,e)=>{let r=e?.renderBefore??n,i=r._$litPart$;if(i===void 0){let s=e?.renderBefore??null;r._$litPart$=i=new Me(n.insertBefore(Ne(),s),s,void 0,e??{})}return i._$AI(t),i};var It=globalThis,y=class extends X{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let n=super.createRenderRoot();return this.renderOptions.renderBefore??=n.firstChild,n}update(n){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(n),this._$Do=xr(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ge}};y._$litElement$=!0,y.finalized=!0,It.litElementHydrateSupport?.({LitElement:y});var Zi=It.litElementPolyfillSupport;Zi?.({LitElement:y});(It.litElementVersions??=[]).push("4.2.2");var x=t=>(n,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(t,n)}):customElements.define(t,n)};var en={attribute:!0,type:String,converter:Oe,reflect:!1,hasChanged:Xe},tn=(t=en,n,e)=>{let{kind:r,metadata:i}=e,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),r==="setter"&&((t=Object.create(t)).wrapped=!0),s.set(e.name,t),r==="accessor"){let{name:a}=e;return{set(o){let d=n.get.call(this);n.set.call(this,o),this.requestUpdate(a,d,t,!0,o)},init(o){return o!==void 0&&this.C(a,void 0,t,o),o}}}if(r==="setter"){let{name:a}=e;return function(o){let d=this[a];n.call(this,o),this.requestUpdate(a,d,t,!0,o)}}throw Error("Unsupported decorator location: "+r)};function m(t){return(n,e)=>typeof e=="object"?tn(t,n,e):((r,i,s)=>{let a=i.hasOwnProperty(s);return i.constructor.createProperty(s,r),a?Object.getOwnPropertyDescriptor(i,s):void 0})(t,n,e)}function g(t){return m({...t,state:!0,attribute:!1})}function B(t,n,e){let r=t?.localize?.(n);return r&&r!==n?r:e}function Rt(t){let n=t.replaceAll("_"," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}function oe(t,n){return B(t,`component.ambience.matcher.${n}`,Rt(n))}function tt(t,n){return B(t,`component.ambience.action.${n}`,Rt(n))}function Ee(t,n){return B(t,`component.ambience.anchor.${n}`,Rt(n))}function _e(t,n,e){let r=e[n]?.label;if(r)return r;let i=n.charAt(0).toUpperCase()+n.slice(1);return B(t,`component.ambience.time_of_day_period.${n}`,i)}function c(t,n,e){return B(t,`component.ambience.${n}`,e)}var rn=["mon","tue","wed","thu","fri","sat","sun"],nn=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];function rt(t,n){return B(t,`component.ambience.weekday.${rn[n]}`,nn[n]??String(n))}var sn={weekday:"Day of week",day_of_month:"Day of month",date:"Date (annual)",date_range:"Date range (annual)",last_day:"Last day of month",workday:"Workday",holiday:"Holiday",first_workday:"First workday of month",last_workday:"Last workday of month"};function it(t,n){return B(t,`component.ambience.day_item.${n}`,sn[n]??n)}var an=["January","February","March","April","May","June","July","August","September","October","November","December"];function Se(t,n){return B(t,`component.ambience.month.${n}`,an[n-1]??String(n))}var on={"clear-night":"Clear (night)",cloudy:"Cloudy",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning-rainy",partlycloudy:"Partly cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy-rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy (variant)",exceptional:"Exceptional"};function nt(t,n){return B(t,`component.ambience.weather_condition.${n}`,on[n]??n)}var ln={temperature:"Temperature",apparent_temperature:"Apparent temperature",humidity:"Humidity",wind_speed:"Wind speed",pressure:"Pressure"};function je(t,n){return B(t,`component.ambience.weather_attr.${n}`,ln[n]??n)}var dn={temperature:"\xB0C",apparent_temperature:"\xB0C",humidity:"%",wind_speed:"m/s",pressure:"hPa"},cn={temperature:"temperature",apparent_temperature:"temperature",wind_speed:"wind_speed",pressure:"pressure"},un={temperature:"temperature_unit",apparent_temperature:"temperature_unit",wind_speed:"wind_speed_unit",pressure:"pressure_unit"};function Mt(t,n,e){if(n==="humidity")return"%";let r=un[n];if(r){let a=e?.attributes?.[r];if(typeof a=="string"&&a)return a}let i=cn[n],s=t?.config?.unit_system;return i&&s&&typeof s[i]=="string"?s[i]:dn[n]??""}var hn={is:"is",is_not:"is not",">":">",">=":"\u2265","<":"<","<=":"\u2264",and:"AND",or:"OR",and_not:"AND NOT",or_not:"OR NOT",not:"NOT"};function G(t,n){return B(t,`component.ambience.state_op.${n}`,hn[n]??n)}var pn=["ha-input","ha-textfield","ha-form"],mn=["ha-input","ha-textfield"];function wr(){for(let t of mn)if(customElements.get(t))return t;return null}function Y(t,n){for(let e of pn)customElements.get(e)||customElements.whenDefined(e).then(()=>t.requestUpdate())}async function st(t){return t.callWS({type:"ambience/areas/list"})}async function at(t,n){return t.callWS({type:"ambience/area/get",area_id:n})}async function kr(t,n,e){return t.callWS({type:"ambience/area/save",area_id:n,config:e})}async function ot(t){return t.callWS({type:"ambience/floors/list"})}async function lt(t,n){return t.callWS({type:"ambience/floor/get",floor_id:n})}async function Er(t,n,e){return t.callWS({type:"ambience/floor/save",floor_id:n,config:e})}async function dt(t){return t.callWS({type:"ambience/house/get"})}async function Sr(t,n){return t.callWS({type:"ambience/house/save",config:n})}async function ct(t){return t.callWS({type:"ambience/matchers/list"})}async function ze(t){return t.callWS({type:"ambience/exposed_actions/list"})}async function Cr(t,n){return t.callWS({type:"ambience/exposed_actions/save",actions:n})}async function Ar(t){return t.callWS({type:"ambience/services/list"})}async function ut(t,n){return t.callWS({type:"ambience/services/get_schema",service:n})}async function ht(t){return t.callWS({type:"ambience/time_of_day_periods/list"})}async function Lr(t,n,e){return t.callWS({type:"ambience/time_of_day_periods/save",custom:n,hidden:e})}async function pt(t){return t.callWS({type:"ambience/matchers/day/config/list"})}async function Tr(t,n,e){return t.callWS({type:"ambience/matchers/day/config/save",workday_sensor:n,workday_calendar:e})}async function mt(t){return t.callWS({type:"ambience/matchers/weather/config/list"})}async function Dr(t,n,e){return t.callWS({type:"ambience/matchers/weather/config/save",entity:n,groups:e})}async function Fr(t,n){return t.callWS({type:"ambience/state/known_states",entity_id:n})}async function Hr(t){return t.callWS({type:"ambience/switch_defaults/list"})}async function jt(t,n,e){return t.callWS({type:"ambience/switch_defaults/save",name:n,auto_on_delay_seconds:e})}async function Or(t,n,e){return t.callWS({type:"ambience/house/switch/save",name:n,auto_on_delay_seconds:e})}async function Pr(t,n,e,r){return t.callWS({type:"ambience/floor/switch/save",floor_id:n,name:e,auto_on_delay_seconds:r})}async function Nr(t,n,e,r){return t.callWS({type:"ambience/area/switch/save",area_id:n,name:e,auto_on_delay_seconds:r})}function ft(t,n="New rule"){return t.name&&t.name.trim()?t.name:n}function gt(t,n,e){return n==null?c(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?_t(n,e):t==="day"?gn(n,e):t==="weather"?bn(n,e):t==="state"?Ut(n,e):t==="script"?fn(n,e):String(n)}function fn(t,n={}){if(t===null)return c(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||t===null||typeof t.script!="string")return String(t);let e=t.args??{},r=Object.keys(e).sort();if(r.length===0)return t.script;let i=r.map(s=>`${s}=${e[s]}`).join(", ");return`${t.script}(${i})`}function gn(t,n={}){if(t===null)return c(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?c(n.hass,"day_summary.any_day","any day"):e.map(a=>Ir(a,n)).join(", ");if(r.length===0)return i;let s=c(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>Ir(a,n)).join(", ")})`}function Ir(t,n){switch(t.kind){case"weekday":return t.days.map(e=>rt(n.hass,e)).join("/");case"day_of_month":return`${c(n.hass,"day_summary.day_prefix","day")} ${t.days}`;case"date":return`${Se(n.hass,t.month)} ${t.day}`;case"date_range":return`${Se(n.hass,t.from.month)} ${t.from.day} \u2192 ${Se(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return c(n.hass,"day_summary.last_day","last day");case"workday":return c(n.hass,"day_summary.workday","workday");case"holiday":return c(n.hass,"day_summary.holiday","holiday");case"first_workday":return c(n.hass,"day_summary.first_workday","first workday");case"last_workday":return c(n.hass,"day_summary.last_workday","last workday")}}var _n={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function vn(t){let n=t.replaceAll("_"," ").toLowerCase();return n.charAt(0).toUpperCase()+n.slice(1)}function yn(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function bn(t,n={}){if(t===null)return c(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??yn(a)).join("/"),i=(t.thresholds??[]).map(a=>`${je(n.hass,a.attribute)} ${_n[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?c(n.hass,"ui.summary_any","any"):s.join(", ")}function $n(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;return typeof r=="string"&&r?r:n}function Ut(t,n={}){return t==null?c(n.hass,"ui.summary_any","any"):zt(t,n)}function zt(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<="){let e=G(n.hass,t.kind),i=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.join("/"),s=$n(n,t.entity_id),o=`${t.attribute?`${s}.${t.attribute}`:s} ${e} ${i}`;return t.for&&xn(t.for)?`${o} ${c(n.hass,"ui.for_prefix","for")} \u2265${wn(t.for)}`:o}if(t.kind==="and"||t.kind==="or"){let e=` ${G(n.hass,t.kind)} `;return t.items.map(r=>Rr(r,n)).join(e)}return t.kind==="not"?`${G(n.hass,"not")} ${Rr(t.item,n)}`:""}function Rr(t,n){return t.kind==="and"||t.kind==="or"?`(${zt(t,n)})`:zt(t,n)}function xn(t){return t.h>0||t.m>0||t.s>0}function wn(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function _t(t,n){if(t===null)return c(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?_e(n.hass,i.period,r):`${Mr(i.from,n)} \u2192 ${Mr(i.to,n)}`).join(", ")}function Mr(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Ee(n.hass,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${c(n.hass,"ui.unit_hour_abbr","h")}`:`${r}${c(n.hass,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}function kn(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label&&e.label.trim()?e.label:tt(n.hass,t.service)}function En(t,n){let e=t.service.indexOf(".");return e>0?t.service.slice(0,e):c(n.hass,"ui.target_noun","target")}function jr(t,n){let e=kn(t,n),r=En(t,n),i=t.entity_ids.length,s;i===0?s=c(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,d])=>`${vn(o)}: ${d}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var N=class extends y{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this.availableActions=[];this._dragFrom=null;this._dragOver=null;this._expandedActions=new Set}_emit(e,r){this.dispatchEvent(new CustomEvent(e,{detail:r,bubbles:!0,composed:!0}))}_whenSummary(e){let r=new Map((this.matchers??[]).map(s=>[s.name,s.priority])),i=Object.keys(e.when).filter(s=>e.when[s]!=null).sort((s,a)=>(r.get(s)??1/0)-(r.get(a)??1/0));return i.length===0?c(this.hass,"ui.summary_any","any"):i.map(s=>`${oe(this.hass,s)}: ${gt(s,e.when[s],{hass:this.hass,periods:this.periods,weatherGroups:this.weatherConfig?.groups})}`).join(", ")}_actionCountLabel(e){let r=e.actions.length,i=r===1?c(this.hass,"ui.action_singular","action"):c(this.hass,"ui.action_plural","actions");return`${r} ${i}`}_toggleActions(e){let r=new Set(this._expandedActions);r.has(e)?r.delete(e):r.add(e),this._expandedActions=r}_entityName(e){let i=this.hass?.states?.[e]?.attributes?.friendly_name;return typeof i=="string"&&i?i:e}_actionParamsString(e){return Object.entries(e.params).filter(([,r])=>r!=null&&r!=="").map(([r,i])=>`${r} ${i}`).join(", ")}_actionLabel(e){let r=this.availableActions.find(i=>i.id===e.service);return r?.label&&r.label.trim()?r.label:tt(this.hass,e.service)}_onDragStart(e){this._dragFrom=e}_onDragOver(e,r){this._dragFrom===null||r===this._dragFrom||(e.preventDefault(),this._dragOver=r)}_onDrop(e){let r=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(r===null||r===e)&&this._emit("reorder-rules",{from:r,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,r){let i=r.name||c(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(e+1));window.confirm(c(this.hass,"ui.confirm_delete",'Delete "{name}"?').replace("{name}",i))&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
  ...
  `,u([m({attribute:!1})],K.prototype,"hass",2),u([m()],K.prototype,"value",2),u([m({attribute:!1})],K.prototype,"suggestions",2),u([g()],K.prototype,"_schema",2),u([g()],K.prototype,"_open",2),K=u([x("ambience-scene-combobox")],K);function ni(t){return typeof t>"u"||t===null}function Sn(t){return typeof t=="object"&&t!==null}function Cn(t){return Array.isArray(t)?t:ni(t)?[]:[t]}function An(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function Ln(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function Tn(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var Dn=ni,Fn=Sn,Hn=Cn,On=Ln,Pn=Tn,Nn=An,T={isNothing:Dn,isObject:Fn,toArray:Hn,repeat:On,isNegativeZero:Pn,extend:Nn};function si(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`
...
`:""}var Ya=Ga,qa={dump:Ya};function tr(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Ti=vi.load,Dl=vi.loadAll,kt=qa.dump;var Fl=tr("safeLoad","load"),Hl=tr("safeLoadAll","loadAll"),Ol=tr("safeDump","dump");var J=class extends y{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=kt(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=kt(this.value??{});let e=this.value&&typeof this.value=="object"?this.value.script:null,r=this._fieldsFor(e);e&&(!r||Object.keys(r).length===0)&&(this._mode="yaml")}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=kt(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Ti(e)}catch(o){this._yamlError=o.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}this._yamlError=null,this._emit({script:s,args:a??{}})}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){let i=this.hass?.states?.[e]?.attributes?.friendly_name;return typeof i=="string"&&i?i:e}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.prototype.hasOwnProperty.call(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._fieldsFor(this.value&&typeof this.value=="object"?this.value.script:null);return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,description:i.description?{suffix:i.description}:void 0,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e})}render(){let e=this.value&&typeof this.value=="object"?this.value.script:null,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
  ...
  `,u([m({attribute:!1})],ce.prototype,"hass",2),u([m({attribute:!1})],ce.prototype,"value",2),u([m({attribute:!1})],ce.prototype,"dayConfig",2),ce=u([x("ambience-day-predicate-input")],ce);var Hi=["temperature","apparent_temperature","humidity","wind_speed","pressure"],Oi=["<","<=",">",">="],Pi={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},ee=class extends y{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let r=e.groups.length===0&&e.thresholds.length===0;this.value=r?null:e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,r){let i=this._current();i.thresholds=i.thresholds.map((s,a)=>a===e?r:s),this._emit(i)}_removeThreshold(e){let r=this._current();r.thresholds=r.thresholds.filter((i,s)=>s!==e),this._emit(r)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:Hi.map(r=>({value:r,label:je(this.hass,r)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:Oi.map(r=>({value:r,label:Pi[r]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,r){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Mt(this.hass,r,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
      ...
      ${Hi.map(i=>l`<option value=${i} ?selected=${i===r.attribute}>${je(this.hass,i)}</option>`)}
      ...
      ${Oi.map(i=>l`<option value=${i} ?selected=${i===r.op}>${Pi[i]}</option>`)}
  ...
  `,u([m({attribute:!1})],he.prototype,"hass",2),u([g()],he.prototype,"_matchers",2),u([g()],he.prototype,"_error",2),he=u([x("ambience-matchers-settings")],he);var L=class extends y{constructor(){super(...arguments);this._actions=[];this._services=[];this._schemas={};this._fieldSchemas={};this._expanded=new Set;this._adding=!1;this._warnings=[];this._loadError=null;this._saveError=null;this._saving=!1;this._loaded=!1;this._editingDefault=null;this._editingOriginalValue=void 0;this._editingOriginalHad=!1;this._onDocPointerDown=e=>{if(this._editingDefault===null)return;let r=this.shadowRoot?.querySelector(`.field-row-editor[data-editing-key="${this._editingDefault}"]`);if(!r){this._cancelEditingDefault();return}e.composedPath().includes(r)||this._cancelEditingDefault()}}connectedCallback(){super.connectedCallback(),document.addEventListener("pointerdown",this._onDocPointerDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerdown",this._onDocPointerDown)}_startEditingDefault(e,r){let s=this._actions.find(a=>a.id===e)?.defaults??{};this._editingOriginalHad=r in s,this._editingOriginalValue=s[r],this._editingDefault=`${e}:${r}`}_saveEditingDefault(){this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}_cancelEditingDefault(){let e=this._editingDefault;if(e){let r=e.indexOf(":"),i=e.slice(0,r),s=e.slice(r+1);this._actions=this._actions.map(a=>{if(a.id!==i)return a;let o={...a.defaults??{}};return this._editingOriginalHad?o[s]=this._editingOriginalValue:delete o[s],{...a,defaults:o}})}this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}async firstUpdated(){await this._reload()}willUpdate(e){if(e.has("_actions")||e.has("_schemas")){let r={};for(let i of this._actions){let s=this._schemas[i.id];if(s)for(let[a,o]of Object.entries(s.fields))r[`${i.id}:${a}`]=[{name:a,selector:o.selector??{text:{}},required:!1}]}this._fieldSchemas=r}}async _reload(){this._loadError=null;try{let[e,r]=await Promise.all([ze(this.hass),Ar(this.hass)]);this._actions=e,this._services=r}catch(e){this._loadError=e instanceof Error?e.message:String(e);return}await Promise.all(this._actions.map(e=>this._ensureSchema(e.id))),this._loaded=!0}async _ensureSchema(e){if(!(e in this._schemas))try{let r=await ut(this.hass,e);this._schemas={...this._schemas,[e]:r}}catch{this._schemas={...this._schemas,[e]:null}}}_setShowInEditor(e,r,i){this._actions=this._actions.map(s=>{if(s.id!==e)return s;let a=new Set(s.visible_fields??[]);return i?a.add(r):a.delete(r),{...s,visible_fields:[...a]}})}_setDefault(e,r,i){this._actions=this._actions.map(s=>s.id!==e?s:{...s,defaults:{...s.defaults??{},[r]:i}})}_clearDefault(e,r){this._actions=this._actions.map(i=>{if(i.id!==e)return i;let s={...i.defaults??{}};return delete s[r],{...i,defaults:s}})}_setLabel(e,r){this._actions=this._actions.map(i=>i.id===e?{...i,label:r}:i)}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):(r.add(e),this._ensureSchema(e)),this._expanded=r}async _addService(e){e&&(this._actions.some(r=>r.id===e)||(await this._ensureSchema(e),this._actions=[...this._actions,{id:e,label:"",visible_fields:[],defaults:{}}],this._expanded=new Set([...this._expanded,e]),this._adding=!1))}_removeService(e){this._actions=this._actions.filter(i=>i.id!==e);let r=new Set(this._expanded);r.delete(e),this._expanded=r}async _save(){this._saving=!0,this._saveError=null,this._warnings=[];try{let e=await Cr(this.hass,this._actions);this._warnings=e.warnings??[],window.dispatchEvent(new CustomEvent("ambience-exposed-actions-changed"))}catch(e){this._saveError=e instanceof Error?e.message:String(e),this._warnings=[]}finally{this._saving=!1}}render(){return this._loadError!==null?l`
    ...
    `}_renderBody(e,r){if(r===null)return l`<div class="body warning">${c(this.hass,"ui.service_unavailable","Service not available in this HA instance.")}</div>`;if(r===void 0)return l`<div class="body">${c(this.hass,"ui.loading","Loading\u2026")}</div>`;let i=Object.entries(r.fields).slice().sort(([s],[a])=>s.localeCompare(a));return i.length===0?l`<div class="body">${c(this.hass,"ui.service_has_no_fields","This service has no fields.")}</div>`:l`
      <div class="body">
        <p class="body-help">
          ${c(this.hass,"ui.actions_field_help","Show in editor: tick fields you want to set per rule. Default value: optional pre-fill the rule editor; applied at execution when the rule doesn't override it.")}
        </p>
      ...
      <div class="field-row">
        ...
        <div class="field-row-main">
          ...
          <label class="show-cell">
            ...
            />
            ${c(this.hass,"ui.show_in_editor","Show in editor")}
          </label>
