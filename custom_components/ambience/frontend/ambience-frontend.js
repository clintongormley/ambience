...
`;function He(t,n){return l`<span class="group-swatch" style=${bt(t)}>
  ...
  `,u([m({attribute:!1})],Q.prototype,"hass",2),u([m({attribute:!1})],Q.prototype,"entities",2),u([m({attribute:!1})],Q.prototype,"value",2),u([m({attribute:!1})],Q.prototype,"target",2),u([m()],Q.prototype,"label",2),Q=u([$("ambience-target-picker")],Q);var N=class extends _{constructor(){super(...arguments);this.entityIds=[];this.params={};this._schema=void 0;this._schemaError=null;this._exposedMissing=!1;this._formSchema=[];this._perFieldSchemas={};this._schemaServiceId=null;this._onTargetChanged=e=>{e.stopPropagation(),this._emit("entity-ids-changed",{entityIds:e.detail.value})};this._onFieldInput=e=>r=>{r.stopPropagation();let i=r.target,s={...this.params,[e]:i.value};this._emit("params-changed",{params:s})};this._onHaFormChanged=e=>{e.stopPropagation(),this._emit("params-changed",{params:{...this.params,...e.detail.value}})}}connectedCallback(){super.connectedCallback(),ce(this,this.hass)}willUpdate(e){if((e.has("exposed")&&e.get("exposed")?.id!==this.exposed?.id||e.has("hass")&&this._schema===void 0)&&this._loadSchema(),(e.has("exposed")||e.has("_schema"))&&(this._formSchema=this._buildFormSchema()),e.has("_formSchema")||e.has("_schema")||e.has("exposed")){let r={};for(let i of this._formSchema)r[i.name]=[i];this._perFieldSchemas=r}}async _loadSchema(){if(this.exposed===void 0&&this.hass){this._exposedMissing=!0,this._schema=null,this._schemaServiceId=null;return}let e=this.exposed?.id;if(!e||!this.hass){this._exposedMissing=!1,this._schema=void 0,this._schemaServiceId=null;return}this._exposedMissing=!1,this._schemaServiceId=e,this._schemaError=null,this._schema=void 0;try{let r=await Fe(this.hass,e);if(this._schemaServiceId!==e)return;this._schema=r}catch(r){if(this._schemaServiceId!==e)return;this._schema=null,this._schemaError=r instanceof Error?r.message:String(r)}}_buildFormSchema(){let e=this._schema,r=this.exposed;if(!e||!r)return[];let i=new Set(r.visible_fields??[]),s=[];for(let[a,o]of Object.entries(e.fields))i.has(a)&&s.push({name:a,selector:o.selector??{text:{}},required:!!o.required,description:typeof o.description=="string"&&o.description?o.description:void 0});return s}updated(e){super.updated?.(e),e.has("_schema")&&this.dispatchEvent(new CustomEvent("target-mode-changed",{detail:{hasTarget:this.hasTarget()},bubbles:!0,composed:!0}))}_hasTarget(){let e=this._schema?.target??null;return!e||typeof e!="object"?!1:Object.keys(e).length>0}hasTarget(){return this._schema===void 0?!1:this._hasTarget()}_scopeEntities(){return!this.scope||!this.hass?[]:wt(this.hass,this.scope,[])}_renderTargetPicker(){if(!this._hasTarget())return"";let e=this._scopeEntities(),r=this._schema?.target??null,i=d(this.hass,"ui.target","Target");return l`
    ...
    `}_humanizeFieldLabel(e){let r=this._schema?.fields[e];return r?.name?r.name:De(e)}_clearField(e){if(!(e in this.params))return;let r={...this.params};delete r[e],this._emit("params-changed",{params:r})}_extraParamKeys(){let e=new Set;for(let r of this._formSchema)e.add(r.name);for(let r of Object.keys(this.exposed?.defaults??{}))e.add(r);return Object.keys(this.params).filter(r=>!e.has(r))}_clearExtraParams(){let e=new Set(this._extraParamKeys());if(e.size===0)return;let r={};for(let[i,s]of Object.entries(this.params))e.has(i)||(r[i]=s);this._emit("params-changed",{params:r})}_fieldData(e){return e in this.params?{[e]:this.params[e]}:{}}_defaultHintSuffix(e){let r=this.exposed?.defaults??{};if(!(e.name in r))return"";let i=Ft(e.selector);return` (Default: ${Oe(this.hass,r[e.name])}${i?` ${i}`:""})`}_hasUserOverride(e){return e in this.params}_renderExtraParamsNotice(){let e=this._extraParamKeys();if(e.length===0)return"";let r=e.join(", ");return l`
  ...
  `,u([m({attribute:!1})],N.prototype,"hass",2),u([m({attribute:!1})],N.prototype,"scope",2),u([m({attribute:!1})],N.prototype,"exposed",2),u([m({attribute:!1})],N.prototype,"entityIds",2),u([m({attribute:!1})],N.prototype,"params",2),u([g()],N.prototype,"_schema",2),u([g()],N.prototype,"_schemaError",2),u([g()],N.prototype,"_exposedMissing",2),u([g()],N.prototype,"_formSchema",2),u([g()],N.prototype,"_perFieldSchemas",2),N=u([$("ambience-action-slot")],N);function Vi(t){return typeof t>"u"||t===null}function Cs(t){return typeof t=="object"&&t!==null}function Ts(t){return Array.isArray(t)?t:Vi(t)?[]:[t]}function Ls(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function As(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function Ps(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var Rs=Vi,Hs=Cs,Fs=Ts,Ds=As,Os=Ps,Ns=Ls,R={isNothing:Rs,isObject:Hs,toArray:Fs,repeat:Ds,isNegativeZero:Os,extend:Ns};function Qi(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`
...
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Xa(t,n),r=t.indexOf("\0");for(r!==-1&&(e.position=r,w(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)lo(e);return e.documents}function co(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var r=dn(t,e);if(typeof n!="function")return r;for(var i=0,s=r.length;i<s;i+=1)n(r[i])}function uo(t,n){var e=dn(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new I("expected a single document in the stream, but found more")}}var ho=co,po=uo,cn={loadAll:ho,load:po},un=Object.prototype.toString,hn=Object.prototype.hasOwnProperty,Er=65279,mo=9,nt=10,fo=13,go=32,vo=33,_o=34,_r=35,yo=37,bo=38,$o=39,wo=42,pn=44,xo=45,It=58,ko=61,Eo=62,So=63,Co=64,mn=91,fn=93,To=96,gn=123,Lo=124,vn=125,D={};D[0]="\\0";D[7]="\\a";D[8]="\\b";D[9]="\\t";D[10]="\\n";D[11]="\\v";D[12]="\\f";D[13]="\\r";D[27]="\\e";D[34]='\\"';D[92]="\\\\";D[133]="\\N";D[160]="\\_";D[8232]="\\L";D[8233]="\\P";var Ao=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],Po=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function Ro(t,n){var e,r,i,s,a,o,c;if(n===null)return{};for(e={},r=Object.keys(n),i=0,s=r.length;i<s;i+=1)a=r[i],o=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),c=t.compiledTypeMap.fallback[a],c&&hn.call(c.styleAliases,o)&&(o=c.styleAliases[o]),e[a]=o;return e}function Ho(t){var n,e,r;if(n=t.toString(16).toUpperCase(),t<=255)e="x",r=2;else if(t<=65535)e="u",r=4;else if(t<=4294967295)e="U",r=8;else throw new I("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+R.repeat("0",r-n.length)+n}var Fo=1,st=2;function Do(t){this.schema=t.schema||Zi,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=R.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=Ro(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?st:Fo,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function zi(t,n){for(var e=R.repeat(" ",n),r=0,i=-1,s="",a,o=t.length;r<o;)i=t.indexOf(`
...
`;function ol(t){return t.kind==="entity"?`${t.entity_id} ${t.old} \u2192 ${t.new}`:t.detail?`${Ae(t.kind)} ${t.detail}`:Ae(t.kind)}function ll(t){let n=t.params&&Object.keys(t.params).length?` ${JSON.stringify(t.params)}`:"";return`${t.service}${n}`}function dl(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function cl(t){return t.evaluated?l`
