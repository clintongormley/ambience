...
`;function _t(t,r){return d`<span class="category-swatch" style=${Di(t)}>
    ...
    `],u([f({attribute:!1})],le.prototype,"hass",2),u([_()],le.prototype,"_categories",2),u([_()],le.prototype,"_filterCategory",2),u([_()],le.prototype,"_open",2),u([_()],le.prototype,"_loaded",2),le=u([w("ambience-category-filter")],le);var ne={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},vt=t=>(...r)=>({_$litDirective$:t,values:r}),Pe=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,i){this._$Ct=r,this._$AM=e,this._$Ci=i}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var{I:Wa}=Sn,As=t=>t;var Rs=t=>t.strings===void 0,Ps=()=>document.createComment(""),yt=(t,r,e)=>{let i=t._$AA.parentNode,n=r===void 0?t._$AB:r._$AA;if(e===void 0){let s=i.insertBefore(Ps(),n),o=i.insertBefore(Ps(),n);e=new Wa(s,o,t,t.options)}else{let s=e._$AB.nextSibling,o=e._$AM,l=o!==t;if(l){let c;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(c=t._$AU)!==o._$AU&&e._$AP(c)}if(s!==n||l){let c=e._$AA;for(;c!==s;){let h=As(c).nextSibling;As(i).insertBefore(c,n),c=h}}}return e},Re=(t,r,e=t)=>(t._$AI(r,e),t),Ba={},Ni=(t,r=Ba)=>t._$AH=r,Ds=t=>t._$AH,Oi=t=>{t._$AR(),t._$AA.remove()};var Hs=(t,r,e)=>{let i=new Map;for(let n=r;n<=e;n++)i.set(t[n],n);return i},Ns=vt(class extends Pe{constructor(t){if(super(t),t.type!==ne.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,r,e){let i;e===void 0?e=r:r!==void 0&&(i=r);let n=[],s=[],o=0;for(let l of t)n[o]=i?i(l,o):o,s[o]=e(l,o),o++;return{values:s,keys:n}}render(t,r,e){return this.dt(t,r,e).values}update(t,[r,e,i]){let n=Ds(t),{values:s,keys:o}=this.dt(r,e,i);if(!Array.isArray(n))return this.ut=o,s;let l=this.ut??=[],c=[],h,p,m=0,g=n.length-1,v=0,x=s.length-1;for(;m<=g&&v<=x;)if(n[m]===null)m++;else if(n[g]===null)g--;else if(l[m]===o[v])c[v]=Re(n[m],s[v]),m++,v++;else if(l[g]===o[x])c[x]=Re(n[g],s[x]),g--,x--;else if(l[m]===o[x])c[x]=Re(n[m],s[x]),yt(t,c[x+1],n[m]),m++,x--;else if(l[g]===o[v])c[v]=Re(n[g],s[v]),yt(t,n[m],n[g]),g--,v++;else if(h===void 0&&(h=Hs(o,v,x),p=Hs(l,m,g)),h.has(l[m]))if(h.has(l[g])){let E=p.get(o[v]),R=E!==void 0?n[E]:null;if(R===null){let J=yt(t,n[m]);Re(J,s[v]),c[v]=J}else c[v]=Re(R,s[v]),yt(t,n[m],R),n[E]=null;v++}else Oi(n[g]),g--;else Oi(n[m]),m++;for(;v<=x;){let E=yt(t,c[x+1]);Re(E,s[v]),c[v++]=E}for(;m<=g;){let E=n[m++];E!==null&&Oi(E)}return this.ut=o,Ni(t,c),B}});function bt(t,r){let e=t.entities?.[r];return e?e.area_id!=null?e.area_id:e.device_id?t.devices?.[e.device_id]?.area_id??null:null:null}function A(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function Ii(t,r){return r==null?{kind:"house"}:{kind:t,id:r}}function Os(t,r){return`${A(t)}\0${r}`}function be(t,r){return Os(t,r)}function Fi(t,r){return Os(t,r)}function Mi(t,r,e=[]){let i=t;if(!i?.entities)return[];let n=i.entities,s=i.areas??{},o=r.kind==="area"?new Set([r.id]):r.kind==="floor"?new Set(Object.values(s).filter(c=>c.floor_id===r.id).map(c=>c.area_id)):null,l=c=>{let h=bt(i,c.entity_id);return h==null?!1:o===null?!0:o.has(h)};return Object.values(n).filter(l).filter(c=>c.platform!=="ambience").filter(c=>e.length===0||e.includes(c.entity_id.split(".")[0])).map(c=>c.entity_id).sort()}var Dr=vt(class extends Pe{constructor(t){if(super(t),t.type!==ne.PROPERTY&&t.type!==ne.ATTRIBUTE&&t.type!==ne.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Rs(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[r]){if(r===B||r===$)return r;let e=t.element,i=t.name;if(t.type===ne.PROPERTY){if(r===e[i])return B}else if(t.type===ne.BOOLEAN_ATTRIBUTE){if(!!r===e.hasAttribute(i))return B}else if(t.type===ne.ATTRIBUTE&&e.getAttribute(i)===r+"")return B;return Ni(t),r}});function wt(t){let{checked:r,dataTest:e,onChange:i,className:n,onClick:s,disabled:o}=t;return customElements.get("ha-switch")?d`<ha-switch
      class=${n??$}
      data-test=${e}
      ?disabled=${o??!1}
      .checked=${Dr(r)}
...
`;function zi(t){if(t.enabled===!1)return{severity:null,missing:[],overlap:[],shadowed:!1,configIssues:[]};let r=t.missing_entities??[],e=t.overlap_entities??[],i=t.config_issues??[],n=t.shadowed_by!=null;return{severity:r.length>0||i.length>0?"error":e.length>0||n?"warning":null,missing:r,overlap:e,shadowed:n,configIssues:i}}function Is(t){let r=null;for(let e of t){let i=zi(e).severity;if(i==="error")return"error";i==="warning"&&(r="warning")}return r}function Fs(t){return t.filter(r=>zi(r).severity!=null).length}var Va={missing_workday_sensor:["ui.badge_needs_workday_sensor","needs a workday sensor"],missing_workday_calendar:["ui.badge_needs_workday_calendar","needs a workday calendar"],missing_weather_entity:["ui.badge_needs_weather_entity","needs a weather entity"],missing_weather_group:["ui.badge_missing_weather_group","missing weather group {id}"],missing_period:["ui.badge_missing_period","missing period {id}"],missing_lux_range:["ui.badge_missing_lux_range","missing lux range {id}"],unexposed_action:["ui.badge_unexposed_action","action {id} not exposed"]};function Ms(t,r){let e=Va[r.kind];return(e?a(t,e[0],e[1]):r.kind).replace("{id}",r.ref)}var xt=null;function Ui(t,r){let e=Is(r);if(!e)return"";let i=Fs(r),n=a(t,"ui.problems_count","{n} scene(s) have problems").replace("{n}",String(i));return d`<ambience-problem-flag
  ...
  `,u([f()],we.prototype,"severity",2),u([f({attribute:!1})],we.prototype,"details",2),u([f()],we.prototype,"summary",2),u([_()],we.prototype,"_open",2),we=u([w("ambience-problem-flag")],we);function se(t){return t.enabled===!1?{scenes:t.scenes??[],enabled:!1}:{scenes:t.scenes??[]}}function D(){return(t,r)=>{let e=Symbol(String(r));Object.defineProperty(t,r,{get(){return this[e]},set(i){Object.is(this[e],i)||(this[e]=i,this._host?.requestUpdate())},configurable:!0,enumerable:!0})}}var P=class{constructor(r){this._host=r;this.areas=[];this.floors=[];this.areaConfigs=new Map;this.floorConfigs=new Map;this.house={scenes:[]};this.switchEntityIds=new Map;this.live=new Map;this.areasLoaded=!1;this.conditions=[];this.actions=[];this.categories=[];this.schemas={};this.staticLoaded=!1;this.error="";this.canUndo=!1;this.canRedo=!1;this.undoAction=null;this.redoAction=null;this.staleScopes=[];this._onExposedActionsChanged=async()=>{try{let r=await zt(this._hass);if(!this._host.isConnected)return;this.actions=r,await this._refreshSchemas(r),await this.reloadConfigs()}catch{}};this._onCategoriesChanged=async()=>{try{let r=await tt(this._hass);if(!this._host.isConnected)return;this.categories=r}catch{}};this._onConditionsChanged=async()=>{try{let[r,e]=await Promise.all([Ut(this._hass),Wt(this._hass)]);if(!this._host.isConnected)return;this.dayConfig=r,this.weatherConfig=e}catch{}};r.addController(this)}get _hass(){return this._host.hass}hostConnected(){window.addEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.addEventListener("ambience-categories-changed",this._onCategoriesChanged),window.addEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick=setInterval(()=>{for(let r of this.switchEntityIds.values())if(this._hass.states?.[r]?.state==="off"){this._host.requestUpdate();return}},1e3)}hostDisconnected(){window.removeEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.removeEventListener("ambience-categories-changed",this._onCategoriesChanged),window.removeEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick&&clearInterval(this._tick),this._tick=void 0,this._unsubArea?.(),this._unsubArea=void 0,this._unsubFloor?.(),this._unsubFloor=void 0,this._unsubEntity?.(),this._unsubEntity=void 0,this._unsubLive?.(),this._unsubLive=void 0,this._unsubHistory?.(),this._unsubHistory=void 0}async subscribe(r,e){this._isScopeLocked=e;let i=this._hass.connection.subscribeEvents(v=>{v.data.action==="remove"&&r({kind:"area",id:v.data.area_id}),this.refreshAreas(),v.data.action!=="update"&&this.refreshSwitches()},"area_registry_updated"),n=this._hass.connection.subscribeEvents(v=>{v.data.action==="remove"&&r({kind:"floor",id:v.data.floor_id}),this.refreshFloors(),v.data.action!=="update"&&this.refreshSwitches()},"floor_registry_updated"),s=this._hass.connection.subscribeEvents(v=>{v.data.action!=="update"&&v.data.entity_id.startsWith("switch.")&&this.refreshSwitches()},"entity_registry_updated"),o=$s(this._hass,v=>this._onLive(v)),l=ks(this._hass,v=>this._onHistory(v)),[c,h,p,m,g]=await Promise.all([i,n,s,o,l]);this._host.isConnected?(this._unsubArea=c,this._unsubFloor=h,this._unsubEntity=p,this._unsubLive=m,this._unsubHistory=g):(c(),h(),p(),m(),g())}_onLive(r){let e=(i,n)=>{let s=be(Ii(n.scope_kind,n.scope_id),n.category);i.set(s,{matched:n.matched,applied:n.applied})};if(r.type==="snapshot"){let i=new Map;for(let n of r.units)e(i,n);this.live=i}else{let i=new Map(this.live);e(i,r),this.live=i}}async loadStatic(){try{let[r,e,i,n,s,o,l]=await Promise.all([Ai(this._hass),zt(this._hass),Pi(this._hass),Ri(this._hass),Ut(this._hass),Wt(this._hass),tt(this._hass)]);if(!this._host.isConnected)return;this.conditions=r,this.actions=e,this.periods=i,this.luxRanges=n,this.dayConfig=s,this.weatherConfig=o,this.categories=l,this.staticLoaded=!0,await this._refreshSchemas(e)}catch(r){this.error=C(this._hass,r)}}async _refreshSchemas(r){let e=await Promise.all(r.map(async n=>{try{let s=await Ae(this._hass,n.id);return[n.id,s]}catch{return[n.id,null]}}));if(!this._host.isConnected)return;let i={};for(let[n,s]of e)s&&(i[n]=s);this.schemas=i}async refreshAreas(){try{let r=await Xn(this._hass),e=this.areaConfigs,i=new Map;if(await Promise.all(r.map(async n=>{let s=e.get(n.area_id);if(s){i.set(n.area_id,s);return}i.set(n.area_id,se(await Si(this._hass,n.area_id)))})),!this._host.isConnected)return;this.areas=r,this.areaConfigs=i}catch(r){this.error=C(this._hass,r)}finally{this._host.isConnected&&(this.areasLoaded=!0)}}async refreshFloors(){try{let r=(await es(this._hass)).slice().sort((n,s)=>n.name.localeCompare(s.name)),e=this.floorConfigs,i=new Map;if(await Promise.all(r.map(async n=>{let s=e.get(n.floor_id);if(s){i.set(n.floor_id,s);return}i.set(n.floor_id,se(await Ti(this._hass,n.floor_id)))})),!this._host.isConnected)return;this.floors=r,this.floorConfigs=i}catch(r){this.error=C(this._hass,r)}}async refreshHouse(){try{let r=se(await Li(this._hass));if(!this._host.isConnected)return;this.house=r}catch(r){this.error=C(this._hass,r)}}async reloadConfigs(){let[r,e,i]=await Promise.all([Promise.all(this.areas.map(async n=>[n.area_id,se(await Si(this._hass,n.area_id))])),Promise.all(this.floors.map(async n=>[n.floor_id,se(await Ti(this._hass,n.floor_id))])),Li(this._hass)]);this._host.isConnected&&(this.areaConfigs=new Map(r),this.floorConfigs=new Map(e),this.house=se(i))}async refreshSwitches(){try{let r=await ps(this._hass);if(!this._host.isConnected)return;this.switchEntityIds=new Map(r.map(e=>{let i=e.scope_kind==="house"?{kind:"house"}:{kind:e.scope_kind,id:e.scope_id};return[A(i),e.entity_id]}))}catch(r){this.error=C(this._hass,r)}}getConfig(r){return r.kind==="house"?this.house:r.kind==="area"?this.areaConfigs.get(r.id):this.floorConfigs.get(r.id)}setConfig(r,e){if(r.kind==="house")this.house=e;else if(r.kind==="area"){let i=new Map(this.areaConfigs);i.set(r.id,e),this.areaConfigs=i}else{let i=new Map(this.floorConfigs);i.set(r.id,e),this.floorConfigs=i}}async mutate(r,e,i){let n=this.getConfig(r);this.setConfig(r,e),this.error="";try{let s;return r.kind==="house"?s=await is(this._hass,e,i):r.kind==="area"?s=await Zn(this._hass,r.id,e,i):s=await ts(this._hass,r.id,e,i),this.setConfig(r,se(s.config)),!0}catch(s){return n&&this.setConfig(r,n),this.error=C(this._hass,s),!1}}async reloadScope(r){try{let e;if(r.kind==="house"?e=se(await Li(this._hass)):r.kind==="area"?e=se(await Si(this._hass,r.id)):e=se(await Ti(this._hass,r.id)),!this._host.isConnected)return;this.setConfig(r,e)}catch(e){this.error=C(this._hass,e)}}_applyHistoryResult(r){!r.ok||!r.config||r.scope_kind===void 0||this.setConfig(Ii(r.scope_kind,r.scope_id??null),se(r.config))}async undo(){this.error="";try{this._applyHistoryResult(await Es(this._hass))}catch(r){this.error=C(this._hass,r)}}async redo(){this.error="";try{this._applyHistoryResult(await Cs(this._hass))}catch(r){this.error=C(this._hass,r)}}_onHistory(r){if(this.canUndo=r.can_undo,this.canRedo=r.can_redo,this.undoAction=r.undo,this.redoAction=r.redo,!r.changed_scope)return;let e=Ii(r.changed_scope.scope_kind,r.changed_scope.scope_id);if(r.is_self){this.clearStale(e);return}this._isScopeLocked?.(e)?this._markStale(e):this.reloadScope(e)}isScopeStale(r){let e=A(r);return this.staleScopes.some(i=>A(i)===e)}_markStale(r){this.isScopeStale(r)||(this.staleScopes=[...this.staleScopes,r])}clearStale(r){if(!this.isScopeStale(r))return;let e=A(r);this.staleScopes=this.staleScopes.filter(i=>A(i)!==e)}async refreshStaleScope(r){this.clearStale(r),await this.reloadScope(r)}};u([D()],P.prototype,"areas",2),u([D()],P.prototype,"floors",2),u([D()],P.prototype,"areaConfigs",2),u([D()],P.prototype,"floorConfigs",2),u([D()],P.prototype,"house",2),u([D()],P.prototype,"switchEntityIds",2),u([D()],P.prototype,"live",2),u([D()],P.prototype,"areasLoaded",2),u([D()],P.prototype,"conditions",2),u([D()],P.prototype,"actions",2),u([D()],P.prototype,"categories",2),u([D()],P.prototype,"schemas",2),u([D()],P.prototype,"periods",2),u([D()],P.prototype,"luxRanges",2),u([D()],P.prototype,"dayConfig",2),u([D()],P.prototype,"weatherConfig",2),u([D()],P.prototype,"staticLoaded",2),u([D()],P.prototype,"error",2),u([D()],P.prototype,"canUndo",2),u([D()],P.prototype,"canRedo",2),u([D()],P.prototype,"undoAction",2),u([D()],P.prototype,"redoAction",2),u([D()],P.prototype,"staleScopes",2);var xe=class extends b{constructor(){super(...arguments);this.text="";this.multiline=!1;this._open=!1;this._onDocClick=e=>{e.composedPath().includes(this)||this._close()};this._onKeydown=e=>{e.key==="Escape"&&this._close()}}_toggle(e){e.stopPropagation(),this._open?this._close():this._openPopover()}_openPopover(){this._open=!0,document.addEventListener("click",this._onDocClick,!0),document.addEventListener("keydown",this._onKeydown)}_close(){this._open&&(this._open=!1,document.removeEventListener("click",this._onDocClick,!0),document.removeEventListener("keydown",this._onKeydown),this.renderRoot.querySelector(".trigger")?.focus())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick,!0),document.removeEventListener("keydown",this._onKeydown)}render(){return d`
      <button
        class="trigger"
  ...
  `,u([f({attribute:!1})],xe.prototype,"hass",2),u([f()],xe.prototype,"text",2),u([f({type:Boolean})],xe.prototype,"multiline",2),u([_()],xe.prototype,"_open",2),xe=u([w("ambience-help")],xe);var de=class extends b{constructor(){super(...arguments);this.items=[];this.muted=!1;this._open=!1;this._onKeydown=e=>{e.key==="Escape"&&this._open&&(this._open=!1)}}_triggerLabel(){return this.label??a(this.hass,"ui.more_actions","More actions")}_select(e,i){i.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("menu-action",{detail:{id:e},bubbles:!0,composed:!0}))}_renderItems(){return this.items.map(e=>d`
    ...
    `}_renderMenu(){return d`
      ...
      ${this._open?d`
          ...
          `:$}
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this._onKeydown)}disconnectedCallback(){this.removeEventListener("keydown",this._onKeydown),super.disconnectedCallback()}render(){return this._renderMenu()}};de.styles=y`
  ...
  `,u([f()],De.prototype,"kind",2),u([f()],De.prototype,"label",2),u([_()],De.prototype,"_open",2),De=u([w("ambience-live-dot")],De);var js=["entity_id","device_id","area_id","label_id"];function ce(t){let r=t.target&&typeof t.target=="object"?t.target:t.entity_ids?.length?{entity_id:t.entity_ids}:{},e={};for(let i of js){let n=r[i],s=Array.isArray(n)?n.filter(o=>typeof o=="string"):[];s.length&&(e[i]=s)}return e}function He(t){return js.every(r=>!t[r]?.length)}function zs(t,r,e){if(He(e))return[];let i=new Set(e.entity_id??[]),n=new Set(e.device_id??[]),s=new Set(e.area_id??[]),o=new Set(e.label_id??[]),l=new Set(i);if(n.size||s.size||o.size)for(let c of Mi(t,r,[])){let h=t.entities?.[c],p=bt(t,c);((h?.device_id?n.has(h.device_id):!1)||(p?s.has(p):!1)||(h?.labels?.some(g=>o.has(g))??!1))&&l.add(c)}return[...l].sort()}function qa(t){return t.style.pointerEvents="none",t.style.willChange="transform",()=>{t.style.pointerEvents="",t.style.willChange="",t.style.transform=""}}function Wi(t,r,e={}){let i=t.pointerId;try{t.target?.setPointerCapture?.(i)}catch{}let n=e.follow??null,s=t.clientX,o=t.clientY,l=n?qa(n):null,c=g=>{g.pointerId===i&&(r.onMove(g.clientX,g.clientY),n&&(n.style.transform=`translate(${g.clientX-s}px, ${g.clientY-o}px)`))},h=g=>{g.pointerId===i&&(m(),r.onEnd(g.clientX,g.clientY))},p=g=>{g.pointerId===i&&(m(),r.onCancel())},m=()=>{window.removeEventListener("pointermove",c,!0),window.removeEventListener("pointerup",h,!0),window.removeEventListener("pointercancel",p,!0),l?.()};return window.addEventListener("pointermove",c,!0),window.addEventListener("pointerup",h,!0),window.addEventListener("pointercancel",p,!0),m}function Bi(t,r){let e=document.elementFromPoint?.(t,r)??null;if(!e)return null;for(;e.shadowRoot;){let i=e.shadowRoot.elementFromPoint?.(t,r);if(!i||i===e)break;e=i}return e}var $t=class{constructor(r,e,i={}){this.host=r;this.onReorder=e;this.from=null;this.over=null;this.moved=!1;this._cancelDrag=null;this._locate=i.locate??((n,s)=>this._domLocate(n,s)),r.addController(this)}hostDisconnected(){this._reset()}start(r,e){if(!e.isPrimary||e.button>0)return;this._reset(),this.from=r,this.moved=!1,this.host.requestUpdate();let i=e.target?.closest("[data-drag-index]");this._cancelDrag=Wi(e,{onMove:(n,s)=>this._hover(this._locate(n,s)),onEnd:(n,s)=>this.drop(this._locate(n,s)),onCancel:()=>this.end()},{follow:i})}_hover(r){if(this.from===null)return;let e=r===null||r===this.from?null:r;e!==null&&(this.moved=!0),this.over!==e&&(this.over=e,this.host.requestUpdate())}drop(r){let e=this.from;this._reset(),!(e===null||r===null||e===r)&&this.onReorder(e,r)}end(){this._reset()}_domLocate(r,e){let i=this.host.renderRoot,s=(i?.elementFromPoint?i.elementFromPoint(r,e):Bi(r,e))?.closest?.("[data-drag-index]");if(!s)return null;let o=Number(s.getAttribute("data-drag-index"));return Number.isNaN(o)?null:o}_reset(){this._cancelDrag?.(),this._cancelDrag=null;let r=this.from!==null||this.over!==null;this.from=null,this.over=null,r&&this.host.requestUpdate()}};var Ka={light:"mdi:lightbulb",switch:"mdi:toggle-switch-variant",binary_sensor:"mdi:motion-sensor",sensor:"mdi:eye",person:"mdi:account",device_tracker:"mdi:account",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:cast",lock:"mdi:lock",fan:"mdi:fan",weather:"mdi:weather-partly-cloudy",input_boolean:"mdi:toggle-switch",event:"mdi:eye-check",script:"mdi:script-text",template:"mdi:code-braces"},Nr="mdi:eye";function M(t,r){let e=t?.states?.[r]?.attributes?.friendly_name;return typeof e=="string"&&e?e:r}function Ga(t,r){let e=t?.states?.[r]?.attributes?.icon;if(typeof e=="string"&&e)return e;let i=r.split(".")[0];return Ka[i]??Nr}function qt(t,r){let e=t?.states?.[r];return e&&customElements.get("ha-state-icon")?d`<ha-state-icon class="row-icon" .hass=${t} .stateObj=${e}></ha-state-icon>`:d`<ha-icon class="row-icon" icon=${Ga(t,r)}></ha-icon>`}var Us=y`
  .row-icon {
    flex: 0 0 auto;
    color: var(--secondary-text-color, #888);
    --mdc-icon-size: 22px;
...
`;function Ws(t){return t.normalize("NFC").toLowerCase().split(/[^\p{L}\p{N}]+/u).filter(Boolean)}function Ya(t,r){let e=Ws(t),i=Ws(r);if(i.length===0)return!0;for(let n=0;n+i.length<=e.length;n++)if(i.every((s,o)=>e[n+o]===s))return!0;return!1}function Bs(t,r){let e=M(t,r);if(!t)return e;let i=bt(t,r),n=i?t.areas?.[i]?.name??"":"";return!n||Ya(e,n)?e:`${n} \xB7 ${e}`}function L(t,r){t.dispatchEvent(new CustomEvent("value-changed",{detail:{value:r},bubbles:!0,composed:!0}))}var Qa=[{name:"duration",selector:{duration:{enable_day:!1}}}];function Kt(t){return!!t&&(t.h!==0||t.m!==0||t.s!==0)}function kt(t,r){return Kt(t)&&r==="less_than"?"less_than":void 0}function Gt(t){return t==="less_than"?"<":"\u2265"}var Ne=class extends b{constructor(){super(...arguments);this.value=null;this.mode="at_least"}willUpdate(e){(e.has("hass")||this._modeSchema===void 0)&&(this._modeSchema=[{name:"for_mode",required:!0,selector:{select:{mode:"dropdown",options:this._modeOptions()}}}])}get _d(){return this.value??{h:0,m:0,s:0}}_emit(e,i){this.value=e,this.mode=i,L(this,{...e,mode:i})}_setDuration(e){this._emit(e,this.mode)}_setMode(e){this._emit(this._d,e)}_modeOptions(){return[{value:"at_least",label:a(this.hass,"ui.for_at_least","at least")},{value:"less_than",label:a(this.hass,"ui.for_less_than","less than")}]}_renderMode(){if(customElements.get("ha-form"))return d`<ha-form
  ...
  `,u([f({attribute:!1})],Ne.prototype,"hass",2),u([f({attribute:!1})],Ne.prototype,"value",2),u([f({attribute:!1})],Ne.prototype,"mode",2),Ne=u([w("ambience-for-duration")],Ne);function Xt(t,r,e){if(r&&e){let i=e[r]?.fields?.[t];if(i&&typeof i=="object"){let n=i.name;if(typeof n=="string"&&n)return n}}return z(t)}function Yi(t,r,e){return t.name?.trim()?t.name:r??a(e,"ui.new_scene_default","New scene")}function Ct(t,r,e){return r==null?a(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?Xi(r,e):t==="day"?el(r,e):t==="weather"?nl(r,e):t==="sun"?sl(r,e):t==="state"?Ur(r,e):t==="script"?Xa(r,e):t==="people"?Za(r,e):t==="occupancy"?ol(r,e):t==="unavailable"?hl(r,e):t==="lux"?pl(r,e):t==="template"?Ja(r,e):String(r)}function Ja(t,r={}){return t===null?a(r.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function Xa(t,r={}){if(t===null)return a(r.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=Qt(r,t.script),i=t.args??{},n=Object.keys(i).sort();if(n.length===0)return e;let s=n.map(o=>`${Mr(r.hass,t.script,o)}: ${Oe(r.hass,i[o])}`).join(", ");return`${e} (${s})`}function Mr(t,r,e){let i=r.replace(/^script\./,""),s=t?.services?.script?.[i]?.fields?.[e]?.name;return typeof s=="string"&&s?s:z(e)}function Qt(t,r){let i=t.hass?.states?.[r]?.attributes?.friendly_name;if(typeof i=="string"&&i)return i;let n=r.indexOf("."),s=n>=0?r.slice(n+1):r;return s.charAt(0).toUpperCase()+s.slice(1)}function Vs(t,r){return t==="home"?a(r.hass,"people_summary.home","Home"):Qt(r,t)}function Za(t,r={}){if(t==null)return a(r.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let o=Qt(r,t.who[0]),c=t.quant==="nobody"!=!!t.negate?a(r.hass,"people_summary.is_not_at","is not at"):a(r.hass,"people_summary.is_at","is at"),h=`${o} ${c} ${Vs(e,r)}`;return t.for&&Jt(t.for)?`${h} ${a(r.hass,"ui.for_prefix","for")} ${Gt(t.for_mode)}${Gi(t.for)}`:h}let i;if(Array.isArray(t.who)){let o=t.quant??"any",l=o==="any"?a(r.hass,"ui.people_mode_any","Any of:"):o==="everyone"?a(r.hass,"ui.people_mode_all","All of:"):a(r.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>Qt(r,h)).join(", ");i=`${l} (${c})`}else{let o=t.quant??"everyone";i=o==="nobody"?a(r.hass,"ui.people_mode_nobody","Nobody"):o==="any"?a(r.hass,"ui.people_mode_anybody","Anybody"):a(r.hass,"ui.people_mode_everybody","Everybody")}let n=t.negate?a(r.hass,"people_summary.is_not_at","is not at"):a(r.hass,"people_summary.is_at","is at"),s=`${i} ${n} ${Vs(e,r)}`;return t.for&&Jt(t.for)?`${s} ${a(r.hass,"ui.for_prefix","for")} ${Gt(t.for_mode)}${Gi(t.for)}`:s}function el(t,r={}){if(t===null)return a(r.hass,"day_summary.any","any");let e=t.include??[],i=t.exclude??[],n=e.length===0?a(r.hass,"day_summary.any_day","any day"):e.map(o=>qs(o,r)).join(", ");if(i.length===0)return n;let s=a(r.hass,"day_summary.except","except");return`${n} (${s} ${i.map(o=>qs(o,r)).join(", ")})`}function qs(t,r){switch(t.kind){case"weekday":return t.days.map(e=>ki(r.hass,e)).join("/");case"day_of_month":return`${a(r.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${ft(r.hass,t.month)} ${t.day}`;case"date_range":return`${ft(r.hass,t.from.month)} ${t.from.day} \u2192 ${ft(r.hass,t.to.month)} ${t.to.day}`;case"last_day":return a(r.hass,"day_summary.last_day","Last day");case"workday":return a(r.hass,"day_summary.workday","Workday");case"holiday":return a(r.hass,"day_summary.holiday","Holiday");case"first_workday":return a(r.hass,"day_summary.first_workday","First workday");case"last_workday":return a(r.hass,"day_summary.last_workday","Last workday")}}function jr(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var tl=["entity_id","device_id","area_id","label_id","floor_id"],Ks=2;function il(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let r=t;if(!Object.keys(r).every(n=>tl.includes(n)))return null;let e=r.entity_id,i=typeof e=="string"?[e]:Array.isArray(e)?e.filter(n=>typeof n=="string"):[];return i.length?i:null}function Oe(t,r){let e=il(r);if(!e)return jr(r);let i=e.slice(0,Ks).map(o=>Qt({hass:t},o)),n=e.length-Ks;return`[${n>0?`${i.join(", ")} +${n} more`:i.join(", ")}]`}function Qi(t){if(!(!t||typeof t!="object")){for(let r of Object.values(t))if(r&&typeof r=="object"){let e=r.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function rl(t){return t.split(/[\s_-]+/).filter(r=>r!=="").map(r=>r.charAt(0).toUpperCase()+r.slice(1).toLowerCase()).join(" ")}function nl(t,r={}){if(t===null)return a(r.hass,"ui.summary_any","any");let e=new Map((r.weatherGroups??[]).map(o=>[o.id,o.label])),i=(t.groups??[]).map(o=>e.get(o)??rl(o)).join("/"),n=(t.thresholds??[]).map(o=>`${jt(r.hass,o.attribute)} ${U(r.hass,o.op)} ${o.value}`).join(", "),s=[i,n].filter(o=>o!=="");return s.length===0?a(r.hass,"ui.summary_any","any"):s.join(", ")}function sl(t,r={}){if(t===null)return a(r.hass,"ui.summary_any","any");let e=[],i=t.elevation;i&&(i.min!=null&&i.max!=null?e.push(`${i.min}\xB0\u2013${i.max}\xB0`):i.min!=null?e.push(`\u2265${i.min}\xB0`):i.max!=null&&e.push(`\u2264${i.max}\xB0`));let n=t.azimuth;if(n){n.sectors?.length&&e.push(n.sectors.join("/"));for(let s of n.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?a(r.hass,"ui.summary_any","any"):e.join(", ")}function Ji(t,r){return Bs(t.hass,r)}function ol(t,r={}){if(t==null||!t.sensors?.length)return a(r.hass,"ui.summary_any","any");let e=t.sensors.map(o=>Ji(r,o)),i=t.occupied===!1?a(r.hass,"occupancy_summary.clear","clear"):a(r.hass,"occupancy_summary.detected","detected"),n=t.negate?`${a(r.hass,"occupancy_summary.not","not")} `:"",s;return e.length===1?s=`${e[0]} is ${n}${i}`:s=`${t.quant==="all"?a(r.hass,"occupancy_summary.all_of","all of"):a(r.hass,"occupancy_summary.any_of","any of")} (${e.join(", ")}) ${n}${i}`,t.for&&Jt(t.for)?`${s} ${a(r.hass,"ui.for_prefix","for")} ${Gt(t.for_mode)}${Gi(t.for)}`:s}function al(t,r){if(r==null||typeof r!="object")return!1;if(t==="occupancy")return!!r.negate;if(t==="people"){let e=r;return!!e.negate&&Array.isArray(e.who)&&e.who.length===1}return!1}function ll(t){return{...t,negate:!1}}function Or(t){if(t.kind==="and"||t.kind==="or"){let r=t.items.map(Or);return r.length===1?r[0]:{...t,items:r}}return t.kind==="not"?{...t,item:Or(t.item)}:t}function Yt(t){if(t.kind==="is_not")return t.for&&Jt(t.for)?null:{...t,kind:"is"};if(t.kind==="not"){let r=t.item.kind;return r==="is"||r===">"||r===">="||r==="<"||r==="<="||r==="and"||r==="or"?t.item:null}if(t.kind==="or"){let r=[];for(let e of t.items){let i=Yt(e);if(!i)return null;r.push(i)}return r.length===1?r[0]:{kind:"and",items:r}}return null}function dl(t,r){let e=Et("state",t,r);return(t.kind==="and"||t.kind==="or")&&t.items.length>1?`(${e})`:e}function Vi(t,r,e){let i=[],n=[];for(let p of t.items){let m=Yt(p);m?n.push(m):i.push(p)}let s=` ${U(r.hass,"or")} `,o=i.map(p=>Ir(p,r)).join(s),l="";if(n.length){let p=n.length===1?n[0]:{kind:"and",items:n};l=`${a(r.hass,"blocker_summary.until","until")} ${dl(p,r)}`}let c=[o,l].filter(p=>p!=="").join(s),h=i.length+(n.length?1:0);return e&&h>1?`(${c})`:c}function qi(t,r){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return Ki(t,r,!1);if(t.kind==="and"){let e=` ${U(r.hass,"and")} `;return t.items.map(i=>Ir(i,r)).join(e)}if(t.kind==="or")return Vi(t,r,!1);if(t.kind==="not"){let e=t.item;return e.kind==="is"?Ki(e,r,!0):`${U(r.hass,"not")} ${Ir(e,r)}`}return""}function Ir(t,r){return t.kind==="or"?Vi(t,r,!0):t.kind==="and"?`(${qi(t,r)})`:qi(t,r)}function cl(t,r,e){let i=Or(t);if(i.kind==="and"){let s=[],o=[];for(let h of i.items){let p=Yt(h);p?o.push(p):s.push(h)}let l=[];if(s.length>0){let h=s.length===1?s[0]:{kind:"and",items:s};l=[h.kind==="or"?Vi(h,r,!e):qi(h,r)]}let c=o.map(h=>Et("state",h,r));return{guards:l,releases:c}}if(i.kind==="or"){let s=Yt(i);return s?{guards:[],releases:[Et("state",s,r)]}:{guards:[Vi(i,r,!e)],releases:[]}}let n=Yt(i);return n?{guards:[],releases:[Et("state",n,r)]}:{guards:[qi(i,r)],releases:[]}}var ul=new Set(["occupancy","people","state","lux","unavailable","script","template","day","time_of_day","weather"]);function Et(t,r,e){let i=Ct(t,r,e);return ul.has(t)?i:`${G(e.hass,t)}: ${i}`}function Qs(t,r={}){let e=a(r.hass,"blocker_summary.block","Block"),i=Object.keys(t.when).filter(m=>t.when[m]!=null);if(r.priorities){let m=r.priorities;i=i.sort((g,v)=>{let x=m.get(g),E=m.get(v);return x===void 0&&E===void 0?0:(E??-1/0)-(x??-1/0)})}let n=[],s=[];for(let m of i){let g=t.when[m];if(m==="state"){let v=cl(g,r,i.length===1);s.push(...v.guards),n.push(...v.releases);continue}al(m,g)?n.push(Et(m,ll(g),r)):s.push(Et(m,g,r))}let o=a(r.hass,"blocker_summary.until","until"),l=` ${a(r.hass,"blocker_summary.or","or")} `,c=` ${a(r.hass,"blocker_summary.and","and")} `,h=n.join(l),p=s.join(c);if(n.length&&s.length){let m=a(r.hass,"blocker_summary.while_lead","While"),g=a(r.hass,"blocker_summary.block_mid","block");return`${m} ${p}, ${g} ${o} ${h}`}if(n.length)return`${e} ${o} ${h}`;if(s.length){let m=a(r.hass,"blocker_summary.while","while");return`${e} ${m} ${p}`}return`${e} ${a(r.hass,"blocker_summary.always","always")}`}function hl(t,r={}){if(t==null||!t.entities?.length)return a(r.hass,"ui.summary_any","any");let e=t.entities.map(s=>Ji(r,s)),i=a(r.hass,"unavailable_summary.unavailable","unavailable");return e.length===1?`${e[0]} ${i}`:`${a(r.hass,"unavailable_summary.any_of","any of")} (${e.join(", ")}) ${i}`}function zr(t,r,e="any lux"){return t!=null&&r!=null?`${t}\u2013${r} lx`:r!=null?`<${r} lx`:t!=null?`\u2265${t} lx`:e}function pl(t,r={}){if(t==null||!t.sensors?.length)return a(r.hass,"ui.summary_any","any");let e=t.sensors.map(s=>Ji(r,s)),i=t.range!=null?mt(r.hass,t.range,r.luxRanges?.custom??{}):zr(t.min,t.max);return e.length===1?`${e[0]} ${i}`:`${t.quant==="all"?a(r.hass,"lux_summary.all_of","all of"):a(r.hass,"lux_summary.any_of","any of")} (${e.join(", ")}) ${i}`}function Ur(t,r={}){return t==null?a(r.hass,"ui.summary_any","any"):Fr(t,r)}function Ki(t,r,e){let i=U(r.hass,t.kind),n=Ji(r,t.entity_id),s=r.hass?.states?.[t.entity_id],l=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.map(m=>Se(r.hass,s,t.attribute,m)).join("/"),c=t.attribute?`${n}.${xi(r.hass,s,t.attribute)}`:n,h=e?`${U(r.hass,"not")} `:"",p=`${c} ${i} ${h}${l}`;return t.for&&Jt(t.for)?`${p} ${a(r.hass,"ui.for_prefix","for")} ${Gt(t.for_mode)}${Gi(t.for)}`:p}function Fr(t,r){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return Ki(t,r,!1);if(t.kind==="and"||t.kind==="or"){let e=` ${U(r.hass,t.kind)} `;return t.items.map(i=>Gs(i,r)).join(e)}if(t.kind==="not"){let e=t.item;return e.kind==="is"?Ki(e,r,!0):`${U(r.hass,"not")} ${Gs(e,r)}`}return""}function Gs(t,r){return t.kind==="and"||t.kind==="or"?`(${Fr(t,r)})`:Fr(t,r)}function Jt(t){return t.h>0||t.m>0||t.s>0}function Gi(t){let r=[];return t.h&&r.push(`${t.h}h`),t.m&&r.push(`${t.m}m`),t.s&&r.push(`${t.s}s`),r.length?r.join(" "):"0s"}function Xi(t,r){if(t===null)return a(r.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],i=r.periods?.custom??{};return e.map(n=>"period"in n?Le(r.hass,n.period,i):`${Ys(n.from,r)} \u2192 ${Ys(n.to,r)}`).join(", ")}function Ys(t,r){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Te(r.hass,t.anchor),i=e;if(t.offset_min!==0){let n=Math.abs(t.offset_min),s=n%60===0?`${n/60}${a(r.hass,"ui.unit_hour_abbr","h")}`:`${n}${a(r.hass,"ui.unit_min_abbr","m")}`;i=`${e}${t.offset_min<0?"-":"+"}${s}`}if(t.clamp){let n=t.clamp.dir==="not_before"?a(r.hass,"ui.clamp_not_before","not before"):a(r.hass,"ui.clamp_not_after","not after"),s=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;i=`${i} (${n} ${s})`}return i}function ml(t,r){return pt(t.service,r.exposedActions,()=>r.schemas?.[t.service]?.name?.trim()||$i(r.hass,t.service))}function fl(t,r){let e=new Set;for(let i of t){let n=i.indexOf(".");n>0&&e.add(i.slice(0,n))}return e.size===1?[...e][0]:a(r.hass,"ui.target_noun","target")}function gl(t,r){return t?.areas?.[r]?.name??r}function _l(t,r){return t?.labels?.[r]?.name??r}function vl(t,r){return t?.devices?.[r]?.name??r}function Js(t,r){let e=ml(t,r),i=ce(t),n=i.entity_id??[],s=i.area_id??[],o=i.label_id??[],l=i.device_id??[],c=n.length>0||s.length>0||o.length>0||l.length>0,h;if(!c)h=a(r.hass,"ui.no_targets","(no targets)");else{let m=[];if(n.length>0){let v=fl(n,r);n.length===1?m.push(`1 ${v}`):m.push(`${n.length} ${v}s`)}let g=r.hass;for(let v of s)m.push(`${gl(g,v)} ${a(r.hass,"ui.target_type_area","(area)")}`);for(let v of o)m.push(`${_l(g,v)} ${a(r.hass,"ui.target_type_label","(label)")}`);for(let v of l)m.push(`${vl(g,v)} ${a(r.hass,"ui.target_type_device","(device)")}`);h=m.join(", ")}let p=Object.entries(t.params).filter(([,m])=>m!=null&&m!=="").map(([m,g])=>`${Xt(m,t.service,r.schemas)}: ${Oe(r.hass,g)}`).join(", ");return p?`${e}: ${h}, ${p}`:`${e}: ${h}`}var O=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this.collapsedCategories=[];this.liveSuppressed=!1;this._drag=new $t(this,(e,i)=>this._emit("reorder-scenes",{from:e,to:i}));this._expanded=new Set}willUpdate(e){e.has("scenes")&&(this._expanded=new Set)}_renderSectionHeader(e,i,n){return d`<div
...
`)}
  ...
  `,u([f({attribute:!1})],O.prototype,"scenes",2),u([f({attribute:!1})],O.prototype,"periods",2),u([f({attribute:!1})],O.prototype,"luxRanges",2),u([f({attribute:!1})],O.prototype,"weatherConfig",2),u([f({attribute:!1})],O.prototype,"hass",2),u([f({attribute:!1})],O.prototype,"conditions",2),u([f({attribute:!1})],O.prototype,"availableActions",2),u([f({attribute:!1})],O.prototype,"schemas",2),u([f({attribute:!1})],O.prototype,"categories",2),u([f({attribute:!1})],O.prototype,"filterCategory",2),u([f({attribute:!1})],O.prototype,"collapsedCategories",2),u([f({attribute:!1})],O.prototype,"scope",2),u([f({attribute:!1})],O.prototype,"live",2),u([f({attribute:!1})],O.prototype,"liveSuppressed",2),u([_()],O.prototype,"_expanded",2),O=u([w("ambience-scenes-list")],O);var Xs=vt(class extends Pe{constructor(t){if(super(t),t.type!==ne.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(r=>t[r]).join(" ")+" "}update(t,[r]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(let i in r)r[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(r)}let e=t.element.classList;for(let i of this.st)i in r||(e.remove(i),this.st.delete(i));for(let i in r){let n=!!r[i];n===this.st.has(i)||this.nt?.has(i)||(n?(e.add(i),this.st.add(i)):(e.remove(i),this.st.delete(i)))}return B}});var $e=class extends b{constructor(){super(...arguments);this.target=null;this.value={};this.label="";this._schema=[];this._onTargetFormChange=e=>{e.stopPropagation(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e.detail.value.target??{}},bubbles:!0,composed:!0}))}}willUpdate(e){e.has("target")&&(this._schema=this._targetSchema())}_targetSchema(){let i=(Array.isArray(this.target?.entity)?this.target.entity[0]:this.target?.entity)?.domain,n={};return i&&(n.entity=[{domain:i}]),[{name:"target",selector:{target:n}}]}render(){return customElements.get("ha-form")?d`
        <ha-form
          .hass=${this.hass}
          .schema=${this._schema}
        ...
        ></ha-form>
      `:d`<div data-target-fallback></div>`}};u([f({attribute:!1})],$e.prototype,"hass",2),u([f({attribute:!1})],$e.prototype,"target",2),u([f({attribute:!1})],$e.prototype,"value",2),u([f()],$e.prototype,"label",2),u([_()],$e.prototype,"_schema",2),$e=u([w("ambience-target-picker")],$e);var V=class extends b{constructor(){super(...arguments);this.target={};this.params={};this._schema=void 0;this._schemaError=null;this._exposedMissing=!1;this._formSchema=[];this._perFieldSchemas={};this._schemaServiceId=null;this._onTargetChanged=e=>{e.stopPropagation(),this._emit("target-changed",{target:e.detail.value})};this._onFieldInput=e=>i=>{i.stopPropagation();let n=i.target,s={...this.params,[e]:n.value};this._emit("params-changed",{params:s})};this._onHaFormChanged=e=>{e.stopPropagation(),this._emit("params-changed",{params:{...this.params,...e.detail.value}})}}connectedCallback(){super.connectedCallback(),ae(this)}willUpdate(e){if((e.has("exposed")&&e.get("exposed")?.id!==this.exposed?.id||e.has("hass")&&this._schema===void 0&&this._schemaServiceId!==this.exposed?.id)&&this._loadSchema(),(e.has("exposed")||e.has("_schema"))&&(this._formSchema=this._buildFormSchema()),e.has("_formSchema")||e.has("_schema")||e.has("exposed")){let i={};for(let n of this._formSchema)i[n.name]=[n];this._perFieldSchemas=i}}async _loadSchema(){if(this.exposed===void 0&&this.hass){this._exposedMissing=!0,this._schema=null,this._schemaServiceId=null;return}let e=this.exposed?.id;if(!e||!this.hass){this._exposedMissing=!1,this._schema=void 0,this._schemaServiceId=null;return}this._exposedMissing=!1,this._schemaServiceId=e,this._schemaError=null,this._schema=void 0;try{let i=await Ae(this.hass,e);if(this._schemaServiceId!==e)return;this._schema=i}catch(i){if(this._schemaServiceId!==e)return;this._schema=null,this._schemaError=C(this.hass,i)}}_buildFormSchema(){let e=this._schema,i=this.exposed;if(!e||!i)return[];let n=new Set(i.visible_fields??[]),s=[];for(let[o,l]of Object.entries(e.fields))n.has(o)&&s.push({name:o,selector:l.selector??{text:{}},required:!!l.required,description:typeof l.description=="string"&&l.description?l.description:void 0});return s}updated(e){super.updated?.(e),e.has("_schema")&&this.dispatchEvent(new CustomEvent("target-mode-changed",{detail:{hasTarget:this.hasTarget()},bubbles:!0,composed:!0}))}_hasTarget(){let e=this._schema?.target??null;return!e||typeof e!="object"?!1:Object.keys(e).length>0}hasTarget(){return this._schema===void 0?!1:this._hasTarget()}_resolvedCount(){return!this.hass||!this.scope?0:zs(this.hass,this.scope,this.target??{}).length}_renderCountPreview(){if(He(this.target??{}))return"";let e=this._resolvedCount(),i=this.scope,n=!i||i.kind==="house"?a(this.hass,"ui.house","House"):i.id,s=a(this.hass,"ui.target_resolves_count","\u2192 resolves to {n} entities in {scope}",{n:String(e),scope:n});return d`<div class=${Xs({"count-preview":!0,warn:e===0})} data-count-preview>${s}</div>`}_renderTargetPicker(){if(!this._hasTarget())return"";let e=this._schema?.target??null,i=a(this.hass,"ui.target","Target");return d`
    ...
    `}_emit(e,i){this.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}_renderRawConfig(){let e=this.service??this.exposed?.id;if(!e)return"";let i=Object.entries(this.params??{}),n=ce({service:e,target:this.target,params:this.params}),s=n.entity_id??[],o=!He(n);return d`
  ...
  `,u([f({attribute:!1})],V.prototype,"hass",2),u([f({attribute:!1})],V.prototype,"scope",2),u([f({attribute:!1})],V.prototype,"exposed",2),u([f({attribute:!1})],V.prototype,"service",2),u([f({attribute:!1})],V.prototype,"target",2),u([f({attribute:!1})],V.prototype,"params",2),u([_()],V.prototype,"_schema",2),u([_()],V.prototype,"_schemaError",2),u([_()],V.prototype,"_exposedMissing",2),u([_()],V.prototype,"_formSchema",2),u([_()],V.prototype,"_perFieldSchemas",2),V=u([w("ambience-action-slot")],V);function fo(t){return typeof t>"u"||t===null}function yl(t){return typeof t=="object"&&t!==null}function bl(t){return Array.isArray(t)?t:fo(t)?[]:[t]}function wl(t,r){var e,i,n,s;if(r)for(s=Object.keys(r),e=0,i=s.length;e<i;e+=1)n=s[e],t[n]=r[n];return t}function xl(t,r){var e="",i;for(i=0;i<r;i+=1)e+=t;return e}function $l(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var kl=fo,El=yl,Cl=bl,Sl=xl,Tl=$l,Ll=wl,F={isNothing:kl,isObject:El,toArray:Cl,repeat:Sl,isNegativeZero:Tl,extend:Ll};function go(t,r){var e="",i=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!r&&t.mark.snippet&&(e+=`

`+t.mark.snippet),i+" "+e):i}function ei(t,r){Error.call(this),this.name="YAMLException",this.reason=t,this.mark=r,this.message=go(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}ei.prototype=Object.create(Error.prototype);ei.prototype.constructor=ei;ei.prototype.toString=function(r){return this.name+": "+go(this,r)};var Z=ei;function Wr(t,r,e,i,n){var s="",o="",l=Math.floor(n/2)-1;return i-r>l&&(s=" ... ",r=i-l+s.length),e-i>l&&(o=" ...",e=i+l-o.length),{str:s+t.slice(r,e).replace(/\t/g,"\u2192")+o,pos:i-r+s.length}}function Br(t,r){return F.repeat(" ",r-t.length)+t}function Al(t,r){if(r=Object.create(r||null),!t.buffer)return null;r.maxLength||(r.maxLength=79),typeof r.indent!="number"&&(r.indent=1),typeof r.linesBefore!="number"&&(r.linesBefore=3),typeof r.linesAfter!="number"&&(r.linesAfter=2);for(var e=/\r?\n|\r|\0/g,i=[0],n=[],s,o=-1;s=e.exec(t.buffer);)n.push(s.index),i.push(s.index+s[0].length),t.position<=s.index&&o<0&&(o=i.length-2);o<0&&(o=i.length-1);var l="",c,h,p=Math.min(t.line+r.linesAfter,n.length).toString().length,m=r.maxLength-(r.indent+p+3);for(c=1;c<=r.linesBefore&&!(o-c<0);c++)h=Wr(t.buffer,i[o-c],n[o-c],t.position-(i[o]-i[o-c]),m),l=F.repeat(" ",r.indent)+Br((t.line-c+1).toString(),p)+" | "+h.str+`
...
`;return l.replace(/\n$/,"")}var Pl=Al,Rl=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Dl=["scalar","sequence","mapping"];function Hl(t){var r={};return t!==null&&Object.keys(t).forEach(function(e){t[e].forEach(function(i){r[String(i)]=e})}),r}function Nl(t,r){if(r=r||{},Object.keys(r).forEach(function(e){if(Rl.indexOf(e)===-1)throw new Z('Unknown option "'+e+'" is met in definition of "'+t+'" YAML type.')}),this.options=r,this.tag=t,this.kind=r.kind||null,this.resolve=r.resolve||function(){return!0},this.construct=r.construct||function(e){return e},this.instanceOf=r.instanceOf||null,this.predicate=r.predicate||null,this.represent=r.represent||null,this.representName=r.representName||null,this.defaultStyle=r.defaultStyle||null,this.multi=r.multi||!1,this.styleAliases=Hl(r.styleAliases||null),Dl.indexOf(this.kind)===-1)throw new Z('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var q=Nl;function Zs(t,r){var e=[];return t[r].forEach(function(i){var n=e.length;e.forEach(function(s,o){s.tag===i.tag&&s.kind===i.kind&&s.multi===i.multi&&(n=o)}),e[n]=i}),e}function Ol(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},r,e;function i(n){n.multi?(t.multi[n.kind].push(n),t.multi.fallback.push(n)):t[n.kind][n.tag]=t.fallback[n.tag]=n}for(r=0,e=arguments.length;r<e;r+=1)arguments[r].forEach(i);return t}function qr(t){return this.extend(t)}qr.prototype.extend=function(r){var e=[],i=[];if(r instanceof q)i.push(r);else if(Array.isArray(r))i=i.concat(r);else if(r&&(Array.isArray(r.implicit)||Array.isArray(r.explicit)))r.implicit&&(e=e.concat(r.implicit)),r.explicit&&(i=i.concat(r.explicit));else throw new Z("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.forEach(function(s){if(!(s instanceof q))throw new Z("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new Z("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new Z("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(s){if(!(s instanceof q))throw new Z("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var n=Object.create(qr.prototype);return n.implicit=(this.implicit||[]).concat(e),n.explicit=(this.explicit||[]).concat(i),n.compiledImplicit=Zs(n,"implicit"),n.compiledExplicit=Zs(n,"explicit"),n.compiledTypeMap=Ol(n.compiledImplicit,n.compiledExplicit),n};var Il=qr,Fl=new q("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),Ml=new q("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),jl=new q("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),zl=new Il({explicit:[Fl,Ml,jl]});function Ul(t){if(t===null)return!0;var r=t.length;return r===1&&t==="~"||r===4&&(t==="null"||t==="Null"||t==="NULL")}function Wl(){return null}function Bl(t){return t===null}var Vl=new q("tag:yaml.org,2002:null",{kind:"scalar",resolve:Ul,construct:Wl,predicate:Bl,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function ql(t){if(t===null)return!1;var r=t.length;return r===4&&(t==="true"||t==="True"||t==="TRUE")||r===5&&(t==="false"||t==="False"||t==="FALSE")}function Kl(t){return t==="true"||t==="True"||t==="TRUE"}function Gl(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var Yl=new q("tag:yaml.org,2002:bool",{kind:"scalar",resolve:ql,construct:Kl,predicate:Gl,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function Ql(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function Jl(t){return 48<=t&&t<=55}function Xl(t){return 48<=t&&t<=57}function Zl(t){if(t===null)return!1;var r=t.length,e=0,i=!1,n;if(!r)return!1;if(n=t[e],(n==="-"||n==="+")&&(n=t[++e]),n==="0"){if(e+1===r)return!0;if(n=t[++e],n==="b"){for(e++;e<r;e++)if(n=t[e],n!=="_"){if(n!=="0"&&n!=="1")return!1;i=!0}return i&&n!=="_"}if(n==="x"){for(e++;e<r;e++)if(n=t[e],n!=="_"){if(!Ql(t.charCodeAt(e)))return!1;i=!0}return i&&n!=="_"}if(n==="o"){for(e++;e<r;e++)if(n=t[e],n!=="_"){if(!Jl(t.charCodeAt(e)))return!1;i=!0}return i&&n!=="_"}}if(n==="_")return!1;for(;e<r;e++)if(n=t[e],n!=="_"){if(!Xl(t.charCodeAt(e)))return!1;i=!0}return!(!i||n==="_")}function ed(t){var r=t,e=1,i;if(r.indexOf("_")!==-1&&(r=r.replace(/_/g,"")),i=r[0],(i==="-"||i==="+")&&(i==="-"&&(e=-1),r=r.slice(1),i=r[0]),r==="0")return 0;if(i==="0"){if(r[1]==="b")return e*parseInt(r.slice(2),2);if(r[1]==="x")return e*parseInt(r.slice(2),16);if(r[1]==="o")return e*parseInt(r.slice(2),8)}return e*parseInt(r,10)}function td(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!F.isNegativeZero(t)}var id=new q("tag:yaml.org,2002:int",{kind:"scalar",resolve:Zl,construct:ed,predicate:td,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),rd=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function nd(t){return!(t===null||!rd.test(t)||t[t.length-1]==="_")}function sd(t){var r,e;return r=t.replace(/_/g,"").toLowerCase(),e=r[0]==="-"?-1:1,"+-".indexOf(r[0])>=0&&(r=r.slice(1)),r===".inf"?e===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:r===".nan"?NaN:e*parseFloat(r,10)}var od=/^[-+]?[0-9]+e/;function ad(t,r){var e;if(isNaN(t))switch(r){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(r){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(r){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(F.isNegativeZero(t))return"-0.0";return e=t.toString(10),od.test(e)?e.replace("e",".e"):e}function ld(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||F.isNegativeZero(t))}var dd=new q("tag:yaml.org,2002:float",{kind:"scalar",resolve:nd,construct:sd,predicate:ld,represent:ad,defaultStyle:"lowercase"}),cd=zl.extend({implicit:[Vl,Yl,id,dd]}),ud=cd,_o=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),vo=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function hd(t){return t===null?!1:_o.exec(t)!==null||vo.exec(t)!==null}function pd(t){var r,e,i,n,s,o,l,c=0,h=null,p,m,g;if(r=_o.exec(t),r===null&&(r=vo.exec(t)),r===null)throw new Error("Date resolve error");if(e=+r[1],i=+r[2]-1,n=+r[3],!r[4])return new Date(Date.UTC(e,i,n));if(s=+r[4],o=+r[5],l=+r[6],r[7]){for(c=r[7].slice(0,3);c.length<3;)c+="0";c=+c}return r[9]&&(p=+r[10],m=+(r[11]||0),h=(p*60+m)*6e4,r[9]==="-"&&(h=-h)),g=new Date(Date.UTC(e,i,n,s,o,l,c)),h&&g.setTime(g.getTime()-h),g}function md(t){return t.toISOString()}var fd=new q("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:hd,construct:pd,instanceOf:Date,represent:md});function gd(t){return t==="<<"||t===null}var _d=new q("tag:yaml.org,2002:merge",{kind:"scalar",resolve:gd}),Jr=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function vd(t){if(t===null)return!1;var r,e,i=0,n=t.length,s=Jr;for(e=0;e<n;e++)if(r=s.indexOf(t.charAt(e)),!(r>64)){if(r<0)return!1;i+=6}return i%8===0}function yd(t){var r,e,i=t.replace(/[\r\n=]/g,""),n=i.length,s=Jr,o=0,l=[];for(r=0;r<n;r++)r%4===0&&r&&(l.push(o>>16&255),l.push(o>>8&255),l.push(o&255)),o=o<<6|s.indexOf(i.charAt(r));return e=n%4*6,e===0?(l.push(o>>16&255),l.push(o>>8&255),l.push(o&255)):e===18?(l.push(o>>10&255),l.push(o>>2&255)):e===12&&l.push(o>>4&255),new Uint8Array(l)}function bd(t){var r="",e=0,i,n,s=t.length,o=Jr;for(i=0;i<s;i++)i%3===0&&i&&(r+=o[e>>18&63],r+=o[e>>12&63],r+=o[e>>6&63],r+=o[e&63]),e=(e<<8)+t[i];return n=s%3,n===0?(r+=o[e>>18&63],r+=o[e>>12&63],r+=o[e>>6&63],r+=o[e&63]):n===2?(r+=o[e>>10&63],r+=o[e>>4&63],r+=o[e<<2&63],r+=o[64]):n===1&&(r+=o[e>>2&63],r+=o[e<<4&63],r+=o[64],r+=o[64]),r}function wd(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var xd=new q("tag:yaml.org,2002:binary",{kind:"scalar",resolve:vd,construct:yd,predicate:wd,represent:bd}),$d=Object.prototype.hasOwnProperty,kd=Object.prototype.toString;function Ed(t){if(t===null)return!0;var r=[],e,i,n,s,o,l=t;for(e=0,i=l.length;e<i;e+=1){if(n=l[e],o=!1,kd.call(n)!=="[object Object]")return!1;for(s in n)if($d.call(n,s))if(!o)o=!0;else return!1;if(!o)return!1;if(r.indexOf(s)===-1)r.push(s);else return!1}return!0}function Cd(t){return t!==null?t:[]}var Sd=new q("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Ed,construct:Cd}),Td=Object.prototype.toString;function Ld(t){if(t===null)return!0;var r,e,i,n,s,o=t;for(s=new Array(o.length),r=0,e=o.length;r<e;r+=1){if(i=o[r],Td.call(i)!=="[object Object]"||(n=Object.keys(i),n.length!==1))return!1;s[r]=[n[0],i[n[0]]]}return!0}function Ad(t){if(t===null)return[];var r,e,i,n,s,o=t;for(s=new Array(o.length),r=0,e=o.length;r<e;r+=1)i=o[r],n=Object.keys(i),s[r]=[n[0],i[n[0]]];return s}var Pd=new q("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Ld,construct:Ad}),Rd=Object.prototype.hasOwnProperty;function Dd(t){if(t===null)return!0;var r,e=t;for(r in e)if(Rd.call(e,r)&&e[r]!==null)return!1;return!0}function Hd(t){return t!==null?t:{}}var Nd=new q("tag:yaml.org,2002:set",{kind:"mapping",resolve:Dd,construct:Hd}),yo=ud.extend({implicit:[fd,_d],explicit:[xd,Sd,Pd,Nd]}),Fe=Object.prototype.hasOwnProperty,Zi=1,bo=2,wo=3,er=4,Vr=1,Od=2,eo=3,Id=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Fd=/[\x85\u2028\u2029]/,Md=/[,\[\]\{\}]/,xo=/^(?:!|!!|![a-z\-]+!)$/i,$o=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function to(t){return Object.prototype.toString.call(t)}function ue(t){return t===10||t===13}function rt(t){return t===9||t===32}function ee(t){return t===9||t===32||t===10||t===13}function Tt(t){return t===44||t===91||t===93||t===123||t===125}function jd(t){var r;return 48<=t&&t<=57?t-48:(r=t|32,97<=r&&r<=102?r-97+10:-1)}function zd(t){return t===120?2:t===117?4:t===85?8:0}function Ud(t){return 48<=t&&t<=57?t-48:-1}function io(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function Wd(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function ko(t,r,e){r==="__proto__"?Object.defineProperty(t,r,{configurable:!0,enumerable:!0,writable:!0,value:e}):t[r]=e}var Eo=new Array(256),Co=new Array(256);for(it=0;it<256;it++)Eo[it]=io(it)?1:0,Co[it]=io(it);var it;function Bd(t,r){this.input=t,this.filename=r.filename||null,this.schema=r.schema||yo,this.onWarning=r.onWarning||null,this.legacy=r.legacy||!1,this.json=r.json||!1,this.listener=r.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function So(t,r){var e={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return e.snippet=Pl(e),new Z(r,e)}function k(t,r){throw So(t,r)}function tr(t,r){t.onWarning&&t.onWarning.call(null,So(t,r))}var ro={YAML:function(r,e,i){var n,s,o;r.version!==null&&k(r,"duplication of %YAML directive"),i.length!==1&&k(r,"YAML directive accepts exactly one argument"),n=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),n===null&&k(r,"ill-formed argument of the YAML directive"),s=parseInt(n[1],10),o=parseInt(n[2],10),s!==1&&k(r,"unacceptable YAML version of the document"),r.version=i[0],r.checkLineBreaks=o<2,o!==1&&o!==2&&tr(r,"unsupported YAML version of the document")},TAG:function(r,e,i){var n,s;i.length!==2&&k(r,"TAG directive accepts exactly two arguments"),n=i[0],s=i[1],xo.test(n)||k(r,"ill-formed tag handle (first argument) of the TAG directive"),Fe.call(r.tagMap,n)&&k(r,'there is a previously declared suffix for "'+n+'" tag handle'),$o.test(s)||k(r,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{k(r,"tag prefix is malformed: "+s)}r.tagMap[n]=s}};function Ie(t,r,e,i){var n,s,o,l;if(r<e){if(l=t.input.slice(r,e),i)for(n=0,s=l.length;n<s;n+=1)o=l.charCodeAt(n),o===9||32<=o&&o<=1114111||k(t,"expected valid JSON character");else Id.test(l)&&k(t,"the stream contains non-printable characters");t.result+=l}}function no(t,r,e,i){var n,s,o,l;for(F.isObject(e)||k(t,"cannot merge mappings; the provided source object is unacceptable"),n=Object.keys(e),o=0,l=n.length;o<l;o+=1)s=n[o],Fe.call(r,s)||(ko(r,s,e[s]),i[s]=!0)}function Lt(t,r,e,i,n,s,o,l,c){var h,p;if(Array.isArray(n))for(n=Array.prototype.slice.call(n),h=0,p=n.length;h<p;h+=1)Array.isArray(n[h])&&k(t,"nested arrays are not supported inside keys"),typeof n=="object"&&to(n[h])==="[object Object]"&&(n[h]="[object Object]");if(typeof n=="object"&&to(n)==="[object Object]"&&(n="[object Object]"),n=String(n),r===null&&(r={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(h=0,p=s.length;h<p;h+=1)no(t,r,s[h],e);else no(t,r,s,e);else!t.json&&!Fe.call(e,n)&&Fe.call(r,n)&&(t.line=o||t.line,t.lineStart=l||t.lineStart,t.position=c||t.position,k(t,"duplicated mapping key")),ko(r,n,s),delete e[n];return r}function Xr(t){var r;r=t.input.charCodeAt(t.position),r===10?t.position++:r===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):k(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function I(t,r,e){for(var i=0,n=t.input.charCodeAt(t.position);n!==0;){for(;rt(n);)n===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),n=t.input.charCodeAt(++t.position);if(r&&n===35)do n=t.input.charCodeAt(++t.position);while(n!==10&&n!==13&&n!==0);if(ue(n))for(Xr(t),n=t.input.charCodeAt(t.position),i++,t.lineIndent=0;n===32;)t.lineIndent++,n=t.input.charCodeAt(++t.position);else break}return e!==-1&&i!==0&&t.lineIndent<e&&tr(t,"deficient indentation"),i}function nr(t){var r=t.position,e;return e=t.input.charCodeAt(r),!!((e===45||e===46)&&e===t.input.charCodeAt(r+1)&&e===t.input.charCodeAt(r+2)&&(r+=3,e=t.input.charCodeAt(r),e===0||ee(e)))}function Zr(t,r){r===1?t.result+=" ":r>1&&(t.result+=F.repeat(`
`,r-1))}function Vd(t,r,e){var i,n,s,o,l,c,h,p,m=t.kind,g=t.result,v;if(v=t.input.charCodeAt(t.position),ee(v)||Tt(v)||v===35||v===38||v===42||v===33||v===124||v===62||v===39||v===34||v===37||v===64||v===96||(v===63||v===45)&&(n=t.input.charCodeAt(t.position+1),ee(n)||e&&Tt(n)))return!1;for(t.kind="scalar",t.result="",s=o=t.position,l=!1;v!==0;){if(v===58){if(n=t.input.charCodeAt(t.position+1),ee(n)||e&&Tt(n))break}else if(v===35){if(i=t.input.charCodeAt(t.position-1),ee(i))break}else{if(t.position===t.lineStart&&nr(t)||e&&Tt(v))break;if(ue(v))if(c=t.line,h=t.lineStart,p=t.lineIndent,I(t,!1,-1),t.lineIndent>=r){l=!0,v=t.input.charCodeAt(t.position);continue}else{t.position=o,t.line=c,t.lineStart=h,t.lineIndent=p;break}}l&&(Ie(t,s,o,!1),Zr(t,t.line-c),s=o=t.position,l=!1),rt(v)||(o=t.position+1),v=t.input.charCodeAt(++t.position)}return Ie(t,s,o,!1),t.result?!0:(t.kind=m,t.result=g,!1)}function qd(t,r){var e,i,n;if(e=t.input.charCodeAt(t.position),e!==39)return!1;for(t.kind="scalar",t.result="",t.position++,i=n=t.position;(e=t.input.charCodeAt(t.position))!==0;)if(e===39)if(Ie(t,i,t.position,!0),e=t.input.charCodeAt(++t.position),e===39)i=t.position,t.position++,n=t.position;else return!0;else ue(e)?(Ie(t,i,n,!0),Zr(t,I(t,!1,r)),i=n=t.position):t.position===t.lineStart&&nr(t)?k(t,"unexpected end of the document within a single quoted scalar"):(t.position++,n=t.position);k(t,"unexpected end of the stream within a single quoted scalar")}function Kd(t,r){var e,i,n,s,o,l;if(l=t.input.charCodeAt(t.position),l!==34)return!1;for(t.kind="scalar",t.result="",t.position++,e=i=t.position;(l=t.input.charCodeAt(t.position))!==0;){if(l===34)return Ie(t,e,t.position,!0),t.position++,!0;if(l===92){if(Ie(t,e,t.position,!0),l=t.input.charCodeAt(++t.position),ue(l))I(t,!1,r);else if(l<256&&Eo[l])t.result+=Co[l],t.position++;else if((o=zd(l))>0){for(n=o,s=0;n>0;n--)l=t.input.charCodeAt(++t.position),(o=jd(l))>=0?s=(s<<4)+o:k(t,"expected hexadecimal character");t.result+=Wd(s),t.position++}else k(t,"unknown escape sequence");e=i=t.position}else ue(l)?(Ie(t,e,i,!0),Zr(t,I(t,!1,r)),e=i=t.position):t.position===t.lineStart&&nr(t)?k(t,"unexpected end of the document within a double quoted scalar"):(t.position++,i=t.position)}k(t,"unexpected end of the stream within a double quoted scalar")}function Gd(t,r){var e=!0,i,n,s,o=t.tag,l,c=t.anchor,h,p,m,g,v,x=Object.create(null),E,R,J,T;if(T=t.input.charCodeAt(t.position),T===91)p=93,v=!1,l=[];else if(T===123)p=125,v=!0,l={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=l),T=t.input.charCodeAt(++t.position);T!==0;){if(I(t,!0,r),T=t.input.charCodeAt(t.position),T===p)return t.position++,t.tag=o,t.anchor=c,t.kind=v?"mapping":"sequence",t.result=l,!0;e?T===44&&k(t,"expected the node content, but found ','"):k(t,"missed comma between flow collection entries"),R=E=J=null,m=g=!1,T===63&&(h=t.input.charCodeAt(t.position+1),ee(h)&&(m=g=!0,t.position++,I(t,!0,r))),i=t.line,n=t.lineStart,s=t.position,At(t,r,Zi,!1,!0),R=t.tag,E=t.result,I(t,!0,r),T=t.input.charCodeAt(t.position),(g||t.line===i)&&T===58&&(m=!0,T=t.input.charCodeAt(++t.position),I(t,!0,r),At(t,r,Zi,!1,!0),J=t.result),v?Lt(t,l,x,R,E,J,i,n,s):m?l.push(Lt(t,null,x,R,E,J,i,n,s)):l.push(E),I(t,!0,r),T=t.input.charCodeAt(t.position),T===44?(e=!0,T=t.input.charCodeAt(++t.position)):e=!1}k(t,"unexpected end of the stream within a flow collection")}function Yd(t,r){var e,i,n=Vr,s=!1,o=!1,l=r,c=0,h=!1,p,m;if(m=t.input.charCodeAt(t.position),m===124)i=!1;else if(m===62)i=!0;else return!1;for(t.kind="scalar",t.result="";m!==0;)if(m=t.input.charCodeAt(++t.position),m===43||m===45)Vr===n?n=m===43?eo:Od:k(t,"repeat of a chomping mode identifier");else if((p=Ud(m))>=0)p===0?k(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):o?k(t,"repeat of an indentation width identifier"):(l=r+p-1,o=!0);else break;if(rt(m)){do m=t.input.charCodeAt(++t.position);while(rt(m));if(m===35)do m=t.input.charCodeAt(++t.position);while(!ue(m)&&m!==0)}for(;m!==0;){for(Xr(t),t.lineIndent=0,m=t.input.charCodeAt(t.position);(!o||t.lineIndent<l)&&m===32;)t.lineIndent++,m=t.input.charCodeAt(++t.position);if(!o&&t.lineIndent>l&&(l=t.lineIndent),ue(m)){c++;continue}if(t.lineIndent<l){n===eo?t.result+=F.repeat(`
...
`,c):t.result+=F.repeat(`
`,s?1+c:c),s=!0,o=!0,c=0,e=t.position;!ue(m)&&m!==0;)m=t.input.charCodeAt(++t.position);Ie(t,e,t.position,!1)}return!0}function so(t,r){var e,i=t.tag,n=t.anchor,s=[],o,l=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),!(c!==45||(o=t.input.charCodeAt(t.position+1),!ee(o))));){if(l=!0,t.position++,I(t,!0,-1)&&t.lineIndent<=r){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,At(t,r,wo,!1,!0),s.push(t.result),I(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>r)&&c!==0)k(t,"bad indentation of a sequence entry");else if(t.lineIndent<r)break}return l?(t.tag=i,t.anchor=n,t.kind="sequence",t.result=s,!0):!1}function Qd(t,r,e){var i,n,s,o,l,c,h=t.tag,p=t.anchor,m={},g=Object.create(null),v=null,x=null,E=null,R=!1,J=!1,T;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=m),T=t.input.charCodeAt(t.position);T!==0;){if(!R&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),i=t.input.charCodeAt(t.position+1),s=t.line,(T===63||T===58)&&ee(i))T===63?(R&&(Lt(t,m,g,v,x,null,o,l,c),v=x=E=null),J=!0,R=!0,n=!0):R?(R=!1,n=!0):k(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,T=i;else{if(o=t.line,l=t.lineStart,c=t.position,!At(t,e,bo,!1,!0))break;if(t.line===s){for(T=t.input.charCodeAt(t.position);rt(T);)T=t.input.charCodeAt(++t.position);if(T===58)T=t.input.charCodeAt(++t.position),ee(T)||k(t,"a whitespace character is expected after the key-value separator within a block mapping"),R&&(Lt(t,m,g,v,x,null,o,l,c),v=x=E=null),J=!0,R=!1,n=!1,v=t.tag,x=t.result;else if(J)k(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(J)k(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>r)&&(R&&(o=t.line,l=t.lineStart,c=t.position),At(t,r,er,!0,n)&&(R?x=t.result:E=t.result),R||(Lt(t,m,g,v,x,E,o,l,c),v=x=E=null),I(t,!0,-1),T=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>r)&&T!==0)k(t,"bad indentation of a mapping entry");else if(t.lineIndent<r)break}return R&&Lt(t,m,g,v,x,null,o,l,c),J&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=m),J}function Jd(t){var r,e=!1,i=!1,n,s,o;if(o=t.input.charCodeAt(t.position),o!==33)return!1;if(t.tag!==null&&k(t,"duplication of a tag property"),o=t.input.charCodeAt(++t.position),o===60?(e=!0,o=t.input.charCodeAt(++t.position)):o===33?(i=!0,n="!!",o=t.input.charCodeAt(++t.position)):n="!",r=t.position,e){do o=t.input.charCodeAt(++t.position);while(o!==0&&o!==62);t.position<t.length?(s=t.input.slice(r,t.position),o=t.input.charCodeAt(++t.position)):k(t,"unexpected end of the stream within a verbatim tag")}else{for(;o!==0&&!ee(o);)o===33&&(i?k(t,"tag suffix cannot contain exclamation marks"):(n=t.input.slice(r-1,t.position+1),xo.test(n)||k(t,"named tag handle cannot contain such characters"),i=!0,r=t.position+1)),o=t.input.charCodeAt(++t.position);s=t.input.slice(r,t.position),Md.test(s)&&k(t,"tag suffix cannot contain flow indicator characters")}s&&!$o.test(s)&&k(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{k(t,"tag name is malformed: "+s)}return e?t.tag=s:Fe.call(t.tagMap,n)?t.tag=t.tagMap[n]+s:n==="!"?t.tag="!"+s:n==="!!"?t.tag="tag:yaml.org,2002:"+s:k(t,'undeclared tag handle "'+n+'"'),!0}function Xd(t){var r,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&k(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),r=t.position;e!==0&&!ee(e)&&!Tt(e);)e=t.input.charCodeAt(++t.position);return t.position===r&&k(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(r,t.position),!0}function Zd(t){var r,e,i;if(i=t.input.charCodeAt(t.position),i!==42)return!1;for(i=t.input.charCodeAt(++t.position),r=t.position;i!==0&&!ee(i)&&!Tt(i);)i=t.input.charCodeAt(++t.position);return t.position===r&&k(t,"name of an alias node must contain at least one character"),e=t.input.slice(r,t.position),Fe.call(t.anchorMap,e)||k(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],I(t,!0,-1),!0}function At(t,r,e,i,n){var s,o,l,c=1,h=!1,p=!1,m,g,v,x,E,R;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=o=l=er===e||wo===e,i&&I(t,!0,-1)&&(h=!0,t.lineIndent>r?c=1:t.lineIndent===r?c=0:t.lineIndent<r&&(c=-1)),c===1)for(;Jd(t)||Xd(t);)I(t,!0,-1)?(h=!0,l=s,t.lineIndent>r?c=1:t.lineIndent===r?c=0:t.lineIndent<r&&(c=-1)):l=!1;if(l&&(l=h||n),(c===1||er===e)&&(Zi===e||bo===e?E=r:E=r+1,R=t.position-t.lineStart,c===1?l&&(so(t,R)||Qd(t,R,E))||Gd(t,E)?p=!0:(o&&Yd(t,E)||qd(t,E)||Kd(t,E)?p=!0:Zd(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&k(t,"alias node should not have any properties")):Vd(t,E,Zi===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=l&&so(t,R))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&k(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),m=0,g=t.implicitTypes.length;m<g;m+=1)if(x=t.implicitTypes[m],x.resolve(t.result)){t.result=x.construct(t.result),t.tag=x.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(Fe.call(t.typeMap[t.kind||"fallback"],t.tag))x=t.typeMap[t.kind||"fallback"][t.tag];else for(x=null,v=t.typeMap.multi[t.kind||"fallback"],m=0,g=v.length;m<g;m+=1)if(t.tag.slice(0,v[m].tag.length)===v[m].tag){x=v[m];break}x||k(t,"unknown tag !<"+t.tag+">"),t.result!==null&&x.kind!==t.kind&&k(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+x.kind+'", not "'+t.kind+'"'),x.resolve(t.result,t.tag)?(t.result=x.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):k(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function ec(t){var r=t.position,e,i,n,s=!1,o;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(o=t.input.charCodeAt(t.position))!==0&&(I(t,!0,-1),o=t.input.charCodeAt(t.position),!(t.lineIndent>0||o!==37));){for(s=!0,o=t.input.charCodeAt(++t.position),e=t.position;o!==0&&!ee(o);)o=t.input.charCodeAt(++t.position);for(i=t.input.slice(e,t.position),n=[],i.length<1&&k(t,"directive name must not be less than one character in length");o!==0;){for(;rt(o);)o=t.input.charCodeAt(++t.position);if(o===35){do o=t.input.charCodeAt(++t.position);while(o!==0&&!ue(o));break}if(ue(o))break;for(e=t.position;o!==0&&!ee(o);)o=t.input.charCodeAt(++t.position);n.push(t.input.slice(e,t.position))}o!==0&&Xr(t),Fe.call(ro,i)?ro[i](t,i,n):tr(t,'unknown document directive "'+i+'"')}if(I(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,I(t,!0,-1)):s&&k(t,"directives end mark is expected"),At(t,t.lineIndent-1,er,!1,!0),I(t,!0,-1),t.checkLineBreaks&&Fd.test(t.input.slice(r,t.position))&&tr(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&nr(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,I(t,!0,-1));return}if(t.position<t.length-1)k(t,"end of the stream or a document separator is expected");else return}function To(t,r){t=String(t),r=r||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Bd(t,r),i=t.indexOf("\0");for(i!==-1&&(e.position=i,k(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)ec(e);return e.documents}function tc(t,r,e){r!==null&&typeof r=="object"&&typeof e>"u"&&(e=r,r=null);var i=To(t,e);if(typeof r!="function")return i;for(var n=0,s=i.length;n<s;n+=1)r(i[n])}function ic(t,r){var e=To(t,r);if(e.length!==0){if(e.length===1)return e[0];throw new Z("expected a single document in the stream, but found more")}}var rc=tc,nc=ic,Lo={loadAll:rc,load:nc},Ao=Object.prototype.toString,Po=Object.prototype.hasOwnProperty,en=65279,sc=9,ti=10,oc=13,ac=32,lc=33,dc=34,Kr=35,cc=37,uc=38,hc=39,pc=42,Ro=44,mc=45,ir=58,fc=61,gc=62,_c=63,vc=64,Do=91,Ho=93,yc=96,No=123,bc=124,Oo=125,K={};K[0]="\\0";K[7]="\\a";K[8]="\\b";K[9]="\\t";K[10]="\\n";K[11]="\\v";K[12]="\\f";K[13]="\\r";K[27]="\\e";K[34]='\\"';K[92]="\\\\";K[133]="\\N";K[160]="\\_";K[8232]="\\L";K[8233]="\\P";var wc=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],xc=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function $c(t,r){var e,i,n,s,o,l,c;if(r===null)return{};for(e={},i=Object.keys(r),n=0,s=i.length;n<s;n+=1)o=i[n],l=String(r[o]),o.slice(0,2)==="!!"&&(o="tag:yaml.org,2002:"+o.slice(2)),c=t.compiledTypeMap.fallback[o],c&&Po.call(c.styleAliases,l)&&(l=c.styleAliases[l]),e[o]=l;return e}function kc(t){var r,e,i;if(r=t.toString(16).toUpperCase(),t<=255)e="x",i=2;else if(t<=65535)e="u",i=4;else if(t<=4294967295)e="U",i=8;else throw new Z("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+F.repeat("0",i-r.length)+r}var Ec=1,ii=2;function Cc(t){this.schema=t.schema||yo,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=F.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=$c(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?ii:Ec,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function oo(t,r){for(var e=F.repeat(" ",r),i=0,n=-1,s="",o,l=t.length;i<l;)n=t.indexOf(`
`,i),n===-1?(o=t.slice(i),i=l):(o=t.slice(i,n+1),i=n+1),o.length&&o!==`
`&&(s+=e),s+=o;return s}function Gr(t,r){return`
`+F.repeat(" ",t.indent*r)}function Sc(t,r){var e,i,n;for(e=0,i=t.implicitTypes.length;e<i;e+=1)if(n=t.implicitTypes[e],n.resolve(r))return!0;return!1}function rr(t){return t===ac||t===sc}function ri(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==en||65536<=t&&t<=1114111}function ao(t){return ri(t)&&t!==en&&t!==oc&&t!==ti}function lo(t,r,e){var i=ao(t),n=i&&!rr(t);return(e?i:i&&t!==Ro&&t!==Do&&t!==Ho&&t!==No&&t!==Oo)&&t!==Kr&&!(r===ir&&!n)||ao(r)&&!rr(r)&&t===Kr||r===ir&&n}function Tc(t){return ri(t)&&t!==en&&!rr(t)&&t!==mc&&t!==_c&&t!==ir&&t!==Ro&&t!==Do&&t!==Ho&&t!==No&&t!==Oo&&t!==Kr&&t!==uc&&t!==pc&&t!==lc&&t!==bc&&t!==fc&&t!==gc&&t!==hc&&t!==dc&&t!==cc&&t!==vc&&t!==yc}function Lc(t){return!rr(t)&&t!==ir}function Zt(t,r){var e=t.charCodeAt(r),i;return e>=55296&&e<=56319&&r+1<t.length&&(i=t.charCodeAt(r+1),i>=56320&&i<=57343)?(e-55296)*1024+i-56320+65536:e}function Io(t){var r=/^\n* /;return r.test(t)}var Fo=1,Yr=2,Mo=3,jo=4,St=5;function Ac(t,r,e,i,n,s,o,l){var c,h=0,p=null,m=!1,g=!1,v=i!==-1,x=-1,E=Tc(Zt(t,0))&&Lc(Zt(t,t.length-1));if(r||o)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Zt(t,c),!ri(h))return St;E=E&&lo(h,p,l),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Zt(t,c),h===ti)m=!0,v&&(g=g||c-x-1>i&&t[x+1]!==" ",x=c);else if(!ri(h))return St;E=E&&lo(h,p,l),p=h}g=g||v&&c-x-1>i&&t[x+1]!==" "}return!m&&!g?E&&!o&&!n(t)?Fo:s===ii?St:Yr:e>9&&Io(t)?St:o?s===ii?St:Yr:g?jo:Mo}function Pc(t,r,e,i,n){t.dump=(function(){if(r.length===0)return t.quotingType===ii?'""':"''";if(!t.noCompatMode&&(wc.indexOf(r)!==-1||xc.test(r)))return t.quotingType===ii?'"'+r+'"':"'"+r+"'";var s=t.indent*Math.max(1,e),o=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),l=i||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return Sc(t,h)}switch(Ac(r,l,t.indent,o,c,t.quotingType,t.forceQuotes&&!i,n)){case Fo:return r;case Yr:return"'"+r.replace(/'/g,"''")+"'";case Mo:return"|"+co(r,t.indent)+uo(oo(r,s));case jo:return">"+co(r,t.indent)+uo(oo(Rc(r,o),s));case St:return'"'+Dc(r)+'"';default:throw new Z("impossible error: invalid scalar style")}})()}function co(t,r){var e=Io(t)?String(r):"",i=t[t.length-1]===`
`,n=i&&(t[t.length-2]===`
`||t===`
`),s=n?"+":i?"":"-";return e+s+`
`}function uo(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function Rc(t,r){for(var e=/(\n+)([^\n]*)/g,i=(function(){var h=t.indexOf(`
...
`+t.slice(o+1):c+=t.slice(n),c.slice(1)}function Dc(t){for(var r="",e=0,i,n=0;n<t.length;e>=65536?n+=2:n++)e=Zt(t,n),i=K[e],!i&&ri(e)?(r+=t[n],e>=65536&&(r+=t[n+1])):r+=i||kc(e);return r}function Hc(t,r,e){var i="",n=t.tag,s,o,l;for(s=0,o=e.length;s<o;s+=1)l=e[s],t.replacer&&(l=t.replacer.call(e,String(s),l)),(ke(t,r,l,!1,!1)||typeof l>"u"&&ke(t,r,null,!1,!1))&&(i!==""&&(i+=","+(t.condenseFlow?"":" ")),i+=t.dump);t.tag=n,t.dump="["+i+"]"}function po(t,r,e,i){var n="",s=t.tag,o,l,c;for(o=0,l=e.length;o<l;o+=1)c=e[o],t.replacer&&(c=t.replacer.call(e,String(o),c)),(ke(t,r+1,c,!0,!0,!1,!0)||typeof c>"u"&&ke(t,r+1,null,!0,!0,!1,!0))&&((!i||n!=="")&&(n+=Gr(t,r)),t.dump&&ti===t.dump.charCodeAt(0)?n+="-":n+="- ",n+=t.dump);t.tag=s,t.dump=n||"[]"}function Nc(t,r,e){var i="",n=t.tag,s=Object.keys(e),o,l,c,h,p;for(o=0,l=s.length;o<l;o+=1)p="",i!==""&&(p+=", "),t.condenseFlow&&(p+='"'),c=s[o],h=e[c],t.replacer&&(h=t.replacer.call(e,c,h)),ke(t,r,c,!1,!1)&&(t.dump.length>1024&&(p+="? "),p+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),ke(t,r,h,!1,!1)&&(p+=t.dump,i+=p));t.tag=n,t.dump="{"+i+"}"}function Oc(t,r,e,i){var n="",s=t.tag,o=Object.keys(e),l,c,h,p,m,g;if(t.sortKeys===!0)o.sort();else if(typeof t.sortKeys=="function")o.sort(t.sortKeys);else if(t.sortKeys)throw new Z("sortKeys must be a boolean or a function");for(l=0,c=o.length;l<c;l+=1)g="",(!i||n!=="")&&(g+=Gr(t,r)),h=o[l],p=e[h],t.replacer&&(p=t.replacer.call(e,h,p)),ke(t,r+1,h,!0,!0,!0)&&(m=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,m&&(t.dump&&ti===t.dump.charCodeAt(0)?g+="?":g+="? "),g+=t.dump,m&&(g+=Gr(t,r)),ke(t,r+1,p,!0,m)&&(t.dump&&ti===t.dump.charCodeAt(0)?g+=":":g+=": ",g+=t.dump,n+=g));t.tag=s,t.dump=n||"{}"}function mo(t,r,e){var i,n,s,o,l,c;for(n=e?t.explicitTypes:t.implicitTypes,s=0,o=n.length;s<o;s+=1)if(l=n[s],(l.instanceOf||l.predicate)&&(!l.instanceOf||typeof r=="object"&&r instanceof l.instanceOf)&&(!l.predicate||l.predicate(r))){if(e?l.multi&&l.representName?t.tag=l.representName(r):t.tag=l.tag:t.tag="?",l.represent){if(c=t.styleMap[l.tag]||l.defaultStyle,Ao.call(l.represent)==="[object Function]")i=l.represent(r,c);else if(Po.call(l.represent,c))i=l.represent[c](r,c);else throw new Z("!<"+l.tag+'> tag resolver accepts not "'+c+'" style');t.dump=i}return!0}return!1}function ke(t,r,e,i,n,s,o){t.tag=null,t.dump=e,mo(t,e,!1)||mo(t,e,!0);var l=Ao.call(t.dump),c=i,h;i&&(i=t.flowLevel<0||t.flowLevel>r);var p=l==="[object Object]"||l==="[object Array]",m,g;if(p&&(m=t.duplicates.indexOf(e),g=m!==-1),(t.tag!==null&&t.tag!=="?"||g||t.indent!==2&&r>0)&&(n=!1),g&&t.usedDuplicates[m])t.dump="*ref_"+m;else{if(p&&g&&!t.usedDuplicates[m]&&(t.usedDuplicates[m]=!0),l==="[object Object]")i&&Object.keys(t.dump).length!==0?(Oc(t,r,t.dump,n),g&&(t.dump="&ref_"+m+t.dump)):(Nc(t,r,t.dump),g&&(t.dump="&ref_"+m+" "+t.dump));else if(l==="[object Array]")i&&t.dump.length!==0?(t.noArrayIndent&&!o&&r>0?po(t,r-1,t.dump,n):po(t,r,t.dump,n),g&&(t.dump="&ref_"+m+t.dump)):(Hc(t,r,t.dump),g&&(t.dump="&ref_"+m+" "+t.dump));else if(l==="[object String]")t.tag!=="?"&&Pc(t,t.dump,r,s,c);else{if(l==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new Z("unacceptable kind of an object to dump "+l)}t.tag!==null&&t.tag!=="?"&&(h=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?h="!"+h:h.slice(0,18)==="tag:yaml.org,2002:"?h="!!"+h.slice(18):h="!<"+h+">",t.dump=h+" "+t.dump)}return!0}function Ic(t,r){var e=[],i=[],n,s;for(Qr(t,e,i),n=0,s=i.length;n<s;n+=1)r.duplicates.push(e[i[n]]);r.usedDuplicates=new Array(s)}function Qr(t,r,e){var i,n,s;if(t!==null&&typeof t=="object")if(n=r.indexOf(t),n!==-1)e.indexOf(n)===-1&&e.push(n);else if(r.push(t),Array.isArray(t))for(n=0,s=t.length;n<s;n+=1)Qr(t[n],r,e);else for(i=Object.keys(t),n=0,s=i.length;n<s;n+=1)Qr(t[i[n]],r,e)}function Fc(t,r){r=r||{};var e=new Cc(r);e.noRefs||Ic(t,e);var i=t;return e.replacer&&(i=e.replacer.call({"":i},"",i)),ke(e,0,i,!0,!0)?e.dump+`
`:""}var Mc=Fc,jc={dump:Mc};function tn(t,r){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+r+" instead, which is now safe by default.")}}var zo=Lo.load,qm=Lo.loadAll,sr=jc.dump;var Km=tn("safeLoad","load"),Gm=tn("safeLoadAll","loadAll"),Ym=tn("safeDump","dump");var he=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>Mr(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let n=this._currentFields()?.[e.name]?.description;return typeof n=="string"?n:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=sr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=sr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=sr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=zo(e)}catch(c){this._yamlError=c.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=a(this.hass,"ui.yaml_expect_object","Expected an object");return}let n=i,s=n.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=a(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=n.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=a(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let l=n.triggers;if(l!==void 0&&(!Array.isArray(l)||!l.every(c=>typeof c=="string"))){this._yamlError=a(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:l})}_emit(e){this.value=e,L(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(n=>`script.${n}`)}_label(e){return M(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},n={};for(let[s,o]of Object.entries(i))o&&Object.hasOwn(o,"default")&&(n[s]=o.default);return n}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,n])=>({name:i,required:n.required,selector:n.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),n=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return d`
      <div class="section">
  ...
  `,u([f({attribute:!1})],he.prototype,"hass",2),u([f({attribute:!1})],he.prototype,"value",2),u([_()],he.prototype,"_mode",2),u([_()],he.prototype,"_yamlText",2),u([_()],he.prototype,"_yamlError",2),he=u([w("ambience-script-predicate-input")],he);var zc=["dawn","sunrise","noon","sunset","dusk","midnight"],nt=class extends b{constructor(){super(...arguments);this.value={kind:"time",hh:12,mm:0}}_emit(e){L(this,e)}_onKindChange(e){let i=e.target.value;i!==this.value.kind&&(i==="time"?this._emit({kind:"time",hh:12,mm:0}):this._emit({kind:"sun",anchor:"sunset",offset_min:0}))}_onTimeChange(e){if(this.value.kind!=="time")return;let i=e.target.value,[n,s]=i.split(":").map(o=>parseInt(o,10));Number.isNaN(n)||Number.isNaN(s)||this._emit({kind:"time",hh:n,mm:s})}_onAnchorChange(e){if(this.value.kind!=="sun")return;let i=e.target.value;this._emit({...this.value,anchor:i})}_onOffsetChange(e){if(this.value.kind!=="sun")return;let i=e.target.value.trim(),n=i===""?0:parseInt(i,10);Number.isNaN(n)||this._emit({...this.value,offset_min:n})}_onClampDirChange(e){if(this.value.kind!=="sun")return;let i=e.target.value;if(i===""){this._emit({kind:"sun",anchor:this.value.anchor,offset_min:this.value.offset_min});return}let n=this.value.clamp??Uc();this._emit({...this.value,clamp:{dir:i,hh:n.hh,mm:n.mm}})}_onClampTimeChange(e){if(this.value.kind!=="sun"||!this.value.clamp)return;let i=e.target.value,[n,s]=i.split(":").map(o=>parseInt(o,10));Number.isNaN(n)||Number.isNaN(s)||this._emit({...this.value,clamp:{dir:this.value.clamp.dir,hh:n,mm:s}})}_renderTime(e){let i=`${String(e.hh).padStart(2,"0")}:${String(e.mm).padStart(2,"0")}`;return d`<input type="time" .value=${i} @input=${this._onTimeChange} />`}_renderSun(e){let i=Wc(e.offset_min,this.hass),n=e.clamp?.dir??"",s=e.clamp?`${String(e.clamp.hh).padStart(2,"0")}:${String(e.clamp.mm).padStart(2,"0")}`:"";return d`
      <div class="sun">
        <div class="row">
          <select @change=${this._onAnchorChange}>
            ${zc.map(o=>d`<option value=${o} ?selected=${o===e.anchor}>${Te(this.hass,o)}</option>`)}
          </select>
          <input
            type="number"
            step="1"
  ...
  `,u([f({attribute:!1})],nt.prototype,"hass",2),u([f({attribute:!1})],nt.prototype,"value",2),nt=u([w("ambience-time-endpoint")],nt);function Uc(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function Wc(t,r){if(t===0)return"";let e=Math.abs(t),i=t<0?"\u2212":"+";if(e%60===0){let n=e/60,s=n===1?a(r,"ui.unit_hour","hour"):a(r,"ui.unit_hours","hours");return`${i}${n} ${s}`}return`${i}${e} ${a(r,"ui.unit_min","min")}`}function or(t,r){if(!t)return[];let e=Object.keys(t.builtins??{}),i=r?e.slice().sort(r):e,n=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(o=>!(o in(t.builtins??{})));return[...i.filter(o=>!n.has(o)),...s]}var pe=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._error=""}static{this.styles=y`
    :host { display: block; }
  ...
  `}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){try{this._view=await this._list(),this._error=""}catch(e){this._error=C(this.hass,e)}}async _saveState(e){try{await this._save(e,this._view.hidden),this._error=""}catch(i){return this._error=C(this.hass,i),!1}return await this._reload(),!0}_onEdit(e,i){this._modal={mode:"edit",id:e,initial:i}}async _onDelete(e){let i={...this._view.custom};delete i[e],await this._saveState(i)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:i,definition:n}=e.detail;await this._saveState({...this._view.custom,[i]:n})&&(this._modal={mode:"closed"})}_onModalCancel(){this._modal={mode:"closed"}}_takenIds(){return new Set([...Object.keys(this._view.builtins),...Object.keys(this._view.custom)])}_renderBuiltinRow(e,i,n){return d`
        ...
        <div class="entry-header">
          <select @change=${l=>this._onSelectChange(i,l)}>
            ...
            ${s.map(l=>d`<option value=${l}>
                ${Le(this.hass,l,o)}${o[l]&&!this.periods?.builtins[l]?a(this.hass,"ui.custom_suffix"," (custom)"):""}
              </option>`)}
          </select>
    ...
    .chip-label { flex: 1; }
  `,u([f({attribute:!1})],me.prototype,"value",2),u([f({attribute:!1})],me.prototype,"periods",2),u([f({attribute:!1})],me.prototype,"hass",2),u([_()],me.prototype,"_entries",2),u([_()],me.prototype,"_openIdx",2),me=u([w("ambience-time-of-day-input")],me);function st(t,r,e,i,n,s){return customElements.get("ha-form")?d`<ha-form
      class=${r}
      .hass=${t}
  ...
  </select>`}function Pt(t,r,e,i,n){return customElements.get("ha-form")?d`<ha-form
      class="field"
      data-field="sensors"
      .hass=${t}
      .schema=${r}
  ...
  `,u([f({attribute:!1})],Ee.prototype,"hass",2),u([f({attribute:!1})],Ee.prototype,"value",2),u([f({attribute:!1})],Ee.prototype,"groups",2),u([f({attribute:!1})],Ee.prototype,"weatherEntity",2),Ee=u([w("ambience-weather-predicate-input")],Ee);var Gc=["NW","N","NE","W",null,"E","SW","S","SE"],ot=class extends b{constructor(){super(...arguments);this.value=null}_current(){let e=this.value?.azimuth?.ranges??[];return{elevation:this.value?.elevation??null,sectors:[...this.value?.azimuth?.sectors??[]],range:e.length?{...e[0]}:null}}_emit(e){let i={};e.elevation&&(e.elevation.min!=null||e.elevation.max!=null)&&(i.elevation=e.elevation);let n={};e.sectors.length&&(n.sectors=e.sectors),e.range&&(n.ranges=[e.range]),(n.sectors||n.ranges)&&(i.azimuth=n),this.value=i.elevation||i.azimuth?i:null,L(this,this.value)}_setElevation(e){this._emit({...this._current(),elevation:e})}_setSectors(e){this._emit({...this._current(),sectors:e})}_setRange(e){this._emit({...this._current(),range:e})}_mode(e){return!e||e.min==null&&e.max==null?"any":e.min!=null&&e.max!=null?"between":e.min!=null?"above":"below"}_onModeChange(e,i){let n=i?.min??0,s=i?.max??0;e==="any"?this._setElevation(null):e==="above"?this._setElevation({min:n}):e==="below"?this._setElevation({max:s}):this._setElevation({min:n,max:s})}_toggleSector(e,i,n){this._setSectors(n?[...e,i]:e.filter(s=>s!==i))}_renderSectors(e){return d`<div class="sectors">${Gc.map(i=>i===null?d`<span class="spacer"></span>`:d`<label>
  ...
  `,u([f({attribute:!1})],at.prototype,"hass",2),u([f({attribute:!1})],at.prototype,"value",2),at=u([w("ambience-people-predicate-input")],at);var lt=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[]}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_build(e){let i={...this._cur(),...e},n={sensors:i.sensors??[]};if(i.occupied===!1&&(n.occupied=!1),i.quant==="all"&&(n.quant="all"),Kt(i.for)){n.for=i.for;let s=kt(i.for,i.for_mode);s&&(n.for_mode=s)}return i.negate===!0&&(n.negate=!0),n}_emit(e){this.value=e,L(this,e)}_setSensors(e){this._emit(this._build({sensors:e}))}_setOccupied(e){this._emit(this._build({occupied:e}))}_setNegate(e){this._emit(this._build({negate:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setFor(e){let{mode:i,...n}=e;this._emit(this._build({for:n,for_mode:i??"at_least"}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"binary_sensor",device_class:["occupancy","presence","motion"],multiple:!0}}}]}_renderSensors(){return Pt(this.hass,this._sensorSchema(),this._sensors(),"binary_sensor.a, binary_sensor.b",e=>this._setSensors(e))}_renderNegate(e){return st(this.hass,"negate","negate",e?"is_not":"is",[{value:"is",label:a(this.hass,"ui.occupancy_is","is")},{value:"is_not",label:a(this.hass,"ui.occupancy_is_not","is not")}],i=>this._setNegate(i==="is_not"))}_renderOccupied(e){return st(this.hass,"state","state",e?"occupied":"vacant",[{value:"occupied",label:a(this.hass,"ui.occupancy_detected","Detected")},{value:"vacant",label:a(this.hass,"ui.occupancy_clear","Clear")}],i=>this._setOccupied(i==="occupied"))}_renderQuant(e){return st(this.hass,"quant","quant",e,[{value:"any",label:a(this.hass,"ui.occupancy_any","Any of")},{value:"all",label:a(this.hass,"ui.occupancy_all","All of")}],i=>this._setQuant(i))}_renderFor(){return d`<ambience-for-duration
    ...
    .for-row { display: flex; gap: 0.25rem; align-items: center; }
    .for-row input[type='number'] { width: 3.5rem; }
  `,u([f({attribute:!1})],lt.prototype,"hass",2),u([f({attribute:!1})],lt.prototype,"value",2),lt=u([w("ambience-occupancy-predicate-input")],lt);function Zo(t,r){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?a(r,"ui.unavailable_select_one","Select at least one entity"):null}var Qc=[{name:"sensors",selector:{entity:{multiple:!0}}}],dt=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,L(this,i)}render(){return d`
      <div class="row">
        ${Pt(this.hass,Qc,this._entities(),"binary_sensor.a, light.b",e=>this._setEntities(e))}
      </div>
    `}};dt.styles=y`
    :host {
      display: block;
  ...
  `,u([f({attribute:!1})],Ue.prototype,"value",2),u([f({attribute:!1})],Ue.prototype,"hass",2),u([_()],Ue.prototype,"_preview",2),Ue=u([w("ambience-template-predicate-input")],Ue);var re=class extends b{constructor(){super(...arguments);this.value=null;this._onChild=e=>{e.stopPropagation(),this._emit(e.detail.value)}}_emit(e){L(this,e)}_onText(e){let i=e.target.value;this._emit(i.trim()===""?null:i)}render(){return this.condition.input==="time_of_day"?d`
  ...
  `,u([f({attribute:!1})],re.prototype,"condition",2),u([f({attribute:!1})],re.prototype,"value",2),u([f({attribute:!1})],re.prototype,"periods",2),u([f({attribute:!1})],re.prototype,"luxRanges",2),u([f({attribute:!1})],re.prototype,"dayConfig",2),u([f({attribute:!1})],re.prototype,"weatherConfig",2),u([f({attribute:!1})],re.prototype,"hass",2),re=u([w("ambience-condition-input")],re);function Zc(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function eu(t){return t==="people"?{quant:"everyone",where:"home"}:null}function ta(t,r){return!!t&&!!r&&A(t)===A(r)}var tu={state:Qo,day:Vo,lux:Bo,unavailable:Zo},S=class extends b{constructor(){super(...arguments);this.open=!1;this.scene=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.takenNames=new Map;this.saveError="";this.scopeChangedElsewhere=!1;this._staleAcknowledged=!1;this._draft=null;this._open=null;this._showError=!1;this._addOrder=[];this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onDescriptionInput=e=>{this._setDescription(e.target.value)};this._onDescriptionHaForm=e=>{e.stopPropagation(),this._setDescription(e.detail.value.description??"")};this._descriptionLabel=()=>a(this.hass,"ui.description","Description");this._onAddCondition=e=>{let i=e.target,n=i.value;i.value="",this._addCondition(n)};this._onAddConditionHaForm=e=>{e.stopPropagation();let i=e.detail.value.add;i!==S._ADD_CONDITION_PLACEHOLDER&&this._addCondition(i)};this._onAddAction=e=>{let i=e.target,n=i.value;i.value="",this._addActionSlot(n)};this._onAddActionHaForm=e=>{e.stopPropagation();let i=e.detail.value.add;i!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(i)};this._onApplyToggle=e=>{if(!this._draft)return;let i={...this._draft};e.target.checked?i.apply="always":delete i.apply,this._draft=i}}_onConditionInvalid(e,i){i?this._conditionError.set(e,i):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),ae(this)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.scene?JSON.parse(JSON.stringify(this.scene)):null,this._scope=this.scope,this._open=null,this._showError=!1,this._addOrder=[],this._conditionError=new Map,this._staleAcknowledged=!1),e.has("scopeChangedElsewhere")&&!this.scopeChangedElsewhere&&(this._staleAcknowledged=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let i=this.scopes[e];if(!i||!this._draft||(this._scope=i.scope,!this.hass))return;let n=new Set(Mi(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>{let{entity_ids:o,...l}=s,c=ce(s),h=c.entity_id?.filter(m=>n.has(m)),p={...h?.length?{entity_id:h}:{},...c.area_id?{area_id:c.area_id}:{},...c.device_id?{device_id:c.device_id}:{},...c.label_id?{label_id:c.label_id}:{}};return{...l,target:p}})}}_renderDestination(){return d`
...
`;function ia(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function dn(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),ia(n,r))};return d`<span
    ...
    @keydown=${i}
    >${e}</span
  >`}function ra(t,r){return dn(t,r,M(t,r))}var ru=new Set(["occupancy","people","lux","state"]);function nu(t,r,e,i,n){let s=iu(t,r,e,i);if(!n?.length||!ru.has(r))return s;let o=[],l=n.map(p=>({id:p,name:M(t,p)})).sort((p,m)=>m.name.length-p.name.length);for(let{id:p,name:m}of l)for(let g=0;g<=s.length;){let v=s.indexOf(m,g);if(v===-1)break;let x=v+m.length;if(!o.some(E=>v<E.end&&E.start<x)){o.push({start:v,end:x,id:p,name:m});break}g=v+1}if(o.length===0)return s;o.sort((p,m)=>p.start-m.start);let c=[],h=0;for(let p of o)p.start>h&&c.push(s.slice(h,p.start)),c.push(dn(t,p.id,p.name)),h=p.end;return h<s.length&&c.push(s.slice(h)),d`${c}`}var su={has_time:["ui.cause_has_time","Periodic time check"],switch:["ui.cause_switch","Switch turned on"],manual:["ui.cause_manual","Manual apply"],startup:["ui.cause_startup","Startup"],reloaded:["ui.cause_reloaded","Reloaded"],simulated:["ui.cause_simulated","Simulation"]},ou={clock:["ui.cause_clock","Time of day"],sun:["ui.cause_sun","Sun position"],reapply:["ui.cause_reapply","Re-run"]};function fe(t){return t??"?"}function na(t,r){if(r.kind==="entity")return`${r.entity_id} ${fe(r.old)} \u2192 ${fe(r.new)}`;if(r.kind==="duration"){let s=a(t,"ui.cause_duration_for","for");return r.entity_id?`${r.entity_id} ${fe(r.new)} ${s} ${fe(r.detail)}`:`${fe(r.new)} ${s} ${fe(r.detail)}`}let e=su[r.kind];if(e)return a(t,e[0],e[1]);let i=ou[r.kind],n=i?a(t,i[0],i[1]):z(r.kind);return r.detail?`${n} ${r.detail}`:n}function au(t,r){if(!ur(r)||!r.entity_id)return d`${na(t,r)}`;let e=dn(t,r.entity_id,r.entity_id);return r.kind==="duration"?d`${e} ${fe(r.new)} ${a(t,"ui.cause_duration_for","for")} ${fe(r.detail)}`:d`${e} ${fe(r.old)} → ${fe(r.new)}`}function ur(t){return t.kind==="entity"||t.kind==="duration"&&!!t.entity_id}function sa(t,r){let e=t.entity_id?r?.states?.[t.entity_id]:void 0,i=n=>n===null?"?":Se(r,e,null,n);return{old:i(t.old),new:i(t.new)}}function lu(t,r){if(!ur(t))return na(r,t);let e=t.entity_id?M(r,t.entity_id):"?",i=sa(t,r);return t.kind==="duration"?`${e}: ${i.new} ${a(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:`${e}: ${i.old} \u2192 ${i.new}`}function du(t,r){if(!ur(t)||!t.entity_id)return d`${lu(t,r)}`;let e=ra(r,t.entity_id),i=sa(t,r);return t.kind==="duration"?d`${e}: ${i.new} ${a(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:d`${e}: ${i.old} → ${i.new}`}var cu={acted:["ui.outcome_label_acted","applied"],no_op:["ui.outcome_label_no_op","blocked"],debounced:["ui.outcome_label_debounced","unchanged"],no_match:["ui.outcome_label_no_match","no match"],skipped_switch_off:["ui.outcome_label_skipped","skipped"],skipped_scope_disabled:["ui.outcome_label_skipped","skipped"],skipped_unavailable:["ui.outcome_label_skipped","skipped"]};function uu(t,r){let e=cu[r];return e?a(t,e[0],e[1]):r.replace(/_/g," ")}function dr(t,r,e,i,n,s){return r===1?a(t,e,n,{n:String(r)}):a(t,i,s,{n:String(r)})}function oa(t,r){let e=r.winner_name??a(t,"ui.winner_default","The matching scene");switch(r.outcome){case"acted":{let i=r.actions.filter(h=>!h.unexposed),n=r.actions.length-i.length;if(i.length===0&&n){let h=dr(t,n,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions");return a(t,"ui.outcome_summary_acted_all_skipped","{winner} matched \u2014 {skipped_phrase} skipped (not exposed); nothing applied.",{winner:e,skipped_phrase:h})}let s=dr(t,i.length,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions"),o=la(i),l=n?a(t,"ui.outcome_summary_skipped_tail"," ({skipped} skipped \u2014 not exposed)",{skipped:String(n)}):"",c=dr(t,o,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities");return o?a(t,"ui.outcome_summary_acted_entities","Applied {winner} \u2014 {acts} on {entities}.{tail}",{winner:e,acts:s,entities:c,tail:l}):a(t,"ui.outcome_summary_acted","Applied {winner} \u2014 {acts}.{tail}",{winner:e,acts:s,tail:l})}case"no_op":return a(t,"ui.outcome_summary_no_op","{winner} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.",{winner:e});case"debounced":return a(t,"ui.outcome_summary_debounced","{winner} matched, but it's already applied \u2014 nothing was re-sent.",{winner:e});case"no_match":return a(t,"ui.outcome_summary_no_match","No scene matched \u2014 nothing applied.");case"skipped_switch_off":return a(t,"ui.outcome_summary_skipped_switch_off","Skipped \u2014 the category switch is off.");case"skipped_scope_disabled":return a(t,"ui.outcome_summary_skipped_scope_disabled","Skipped \u2014 the scope is disabled.");case"skipped_unavailable":return a(t,"ui.outcome_summary_skipped_unavailable","Skipped \u2014 the triggering entity went unavailable; devices left as they are.");default:return""}}function aa(t,r,e){return pt(t,r,()=>e?.[t]?.name?.trim()||wi(t))}function hu(t,r,e,i){let n=Object.entries(t.params??{}).filter(([,o])=>o!=null&&o!=="").map(([o,l])=>`${Xt(o,t.service,e)}: ${Oe(r,l)}`).join(", "),s=aa(t.service,i,e);return n?`${s} \xB7 ${n}`:s}function la(t){return t.reduce((r,e)=>r+(e.entity_ids?.length??0),0)}function pu(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"||t==="skipped_unavailable"}function mu(t,r,e){let i=t.index+1,n=a(r,"ui.trace_scene_prefix","Scene #");return t.disabled?d`<div class="scene disabled">${n}${i} ${t.name??"\u2014"}: ${a(r,"ui.trace_scene_disabled","disabled")}</div>`:t.evaluated?d`
    ...
    ${t.predicates.map(s=>d`
        <div class="pred ${s.passed?"pass":"fail"}" style="padding-left:1rem">
          ${s.passed?"\u2713":"\u2717"} ${G(r,s.condition_key)}${s.detail?d` <span class="dim">[${nu(r,s.condition_key,s.detail,e,s.entity_ids)}]</span>`:$}
        </div>`)}
  `:d`<div class="scene skipped">${n}${i} ${t.name??"\u2014"}: ${a(r,"ui.trace_scene_not_reached","not reached")}</div>`}function hr(t,r,e,i,n,s={},o){let l=t.actions.filter(g=>!g.unexposed),c=l.map(g=>aa(g.service,o,n)).join(", "),h=la(l),p=t.explanation!==null||t.actions.length>0||pu(t.outcome),m=g=>{(g.key==="Enter"||g.key===" ")&&!g.repeat&&(g.preventDefault(),e())};return d`
    <div class="eval">
      <div
        ...
        @keydown=${p?m:void 0}
      >
        <span class="label">${uu(i,t.outcome)}</span>
        <span class="ts">${t.timestamp?new Date(t.timestamp).toLocaleTimeString():""}</span>
      </div>
      <div class="eval-body">
        <div class="cause-line">${a(i,"ui.trigger_prefix","Trigger: ")}${du(t.cause,i)}</div>
  ...
  `}function fu(t,r,e,i,n){let s=oa(r,t),o=ur(t.cause);return d`
    <div class="why">
      ${o?d`<div class="raw-trigger">${a(r,"ui.trigger_prefix","Trigger: ")}${au(r,t.cause)}</div>`:$}
      ...
      ${t.explanation?d`<div class="section">
            ...
            <div class="scenes">${t.explanation.scenes.map(l=>mu(l,r,i))}</div>
          </div>`:$}
  ...
  `}var We=class{constructor(r,e){this._onKeydown=r=>{this._host.open&&r.key==="Escape"&&this._close()};this._onBackdrop=()=>{this._host.open&&this._close()};this._host=r,this._close=e,r.addController(this)}hostConnected(){document.addEventListener("keydown",this._onKeydown),this._host.addEventListener("click",this._onBackdrop)}hostDisconnected(){document.removeEventListener("keydown",this._onKeydown),this._host.removeEventListener("click",this._onBackdrop)}};var j=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1;new We(this,()=>this._onClose())}disconnectedCallback(){super.disconnectedCallback(),this._stopPoll()}_startPoll(){this._poll||(this._poll=setInterval(()=>this._checkNew(),5e3))}_stopPoll(){this._poll&&(clearInterval(this._poll),this._poll=void 0)}updated(e){e.has("open")&&(this.open?this._startPoll():this._stopPoll()),this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(i=>i.scope_kind===this.scope.scope_kind&&i.scope_id===this.scope.scope_id&&i.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await Ar(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=C(this.hass,e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(o=>o.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let i=await Promise.all(e.map(async s=>{try{return[s,await Ae(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let n={...this._schemas};for(let s of i)s&&(n[s[0]]=s[1]);this._schemas=n}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let i=this._mine(await Ar(this.hass))[0]?.timestamp??null,n=this._records[0]?.timestamp??null;i&&(!n||i>n)&&(this._hasNew=!0)}catch{}}_toggle(e){let i=new Set(this._expanded);i.has(e)?i.delete(e):i.add(e),this._expanded=i}async _download(){try{await Ss(this.hass,this.scope,this.category)}catch(e){this._error=C(this.hass,e)}}async _clear(){try{await xs(this.hass),await this._load()}catch(e){this._error=C(this.hass,e)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return $;let e=this.categoryName??this.category;return d`
    ...
    `],u([f({attribute:!1})],j.prototype,"hass",2),u([f({attribute:!1})],j.prototype,"periods",2),u([f({attribute:!1})],j.prototype,"exposedActions",2),u([f({attribute:!1})],j.prototype,"scope",2),u([f()],j.prototype,"category",2),u([f()],j.prototype,"categoryName",2),u([f({type:Boolean,reflect:!0})],j.prototype,"open",2),u([_()],j.prototype,"_records",2),u([_()],j.prototype,"_schemas",2),u([_()],j.prototype,"_expanded",2),u([_()],j.prototype,"_loading",2),u([_()],j.prototype,"_error",2),u([_()],j.prototype,"_hasNew",2),j=u([w("ambience-traces-modal")],j);var gu={time:"mdi:clock-outline",sun:"mdi:weather-sunny"},Y=class extends b{constructor(){super(...arguments);this.categoryName="";this.scenes=[];this.open=!1;this._triggers=[];this._opaque=!1;this._loading=!1;this._error="";this._loadSeq=0}willUpdate(e){super.willUpdate?.(e);let i=e.has("open")||e.has("scope")||e.has("category");this.open&&(i||e.has("scenes"))&&(i&&(this._triggers=[],this._opaque=!1),this._load())}get _scopeId(){return this.scope.kind==="house"?null:this.scope.id}async _load(){let e=++this._loadSeq;this._loading=!0,this._error="";try{let i=await rs(this.hass,this.scope.kind,this._scopeId,this.category);if(e!==this._loadSeq)return;this._triggers=i.triggers,this._opaque=i.opaque}catch(i){if(e!==this._loadSeq)return;this._error=C(this.hass,i)}finally{e===this._loadSeq&&(this._loading=!1)}}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_openMoreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_entityName(e){return M(this.hass,e)}get _sortedTriggers(){let e=s=>this._entityName(s.entity_id).toLowerCase(),i=this._triggers.filter(s=>s.kind==="entity").sort((s,o)=>e(s).localeCompare(e(o))),n=this._triggers.filter(s=>s.kind!=="entity");return[...i,...n]}_sunPart(e){let i=Te(this.hass,e.anchor);if(e.offset===0)return i;let n=a(this.hass,"ui.unit_min","min");return`${i} ${e.offset>0?"+":""}${e.offset} ${n}`}_rowContent(e){switch(e.kind){case"entity":return{title:this._entityName(e.entity_id),detail:e.entity_id};case"time":{let i=e.clocks.map(n=>`${String(n.hour).padStart(2,"0")}:${String(n.minute).padStart(2,"0")}`);return e.date_rollover&&i.push(a(this.hass,"ui.auto_trigger_date_rollover","Local midnight (date rollover)")),e.has_time&&i.push(a(this.hass,"ui.auto_trigger_periodic","periodic re-check")),{title:a(this.hass,"ui.auto_trigger_group_time","Time"),detail:i.join(", ")}}case"sun":return{title:a(this.hass,"ui.auto_trigger_group_sun","Sun"),detail:e.suns.map(i=>this._sunPart(i)).join(", ")}}}_renderRowIcon(e){return e.kind==="entity"?qt(this.hass,e.entity_id):d`<ha-icon
      class="row-icon"
      icon=${gu[e.kind]??Nr}
  ...
  `,u([f({attribute:!1})],Y.prototype,"hass",2),u([f({attribute:!1})],Y.prototype,"scope",2),u([f()],Y.prototype,"category",2),u([f()],Y.prototype,"categoryName",2),u([f({attribute:!1})],Y.prototype,"scenes",2),u([f({type:Boolean,reflect:!0})],Y.prototype,"open",2),u([_()],Y.prototype,"_triggers",2),u([_()],Y.prototype,"_opaque",2),u([_()],Y.prototype,"_loading",2),u([_()],Y.prototype,"_error",2),Y=u([w("ambience-auto-triggers-modal")],Y);function da(t,r){return r==="not_home"?a(t,"ui.away","Away"):r==="home"?a(t,"ui.home","Home"):z(r)}function ca(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(r=>[r.name,r.live_value==null?"":String(r.live_value)])),for:{h:0,m:0,s:0}}}function pr(t){return String(t).padStart(2,"0")}function ua(t){return`${t.getFullYear()}-${pr(t.getMonth()+1)}-${pr(t.getDate())}`}function ha(t){return`${pr(t.getHours())}:${pr(t.getMinutes())}`}var N=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1;new We(this,()=>this._onClose())}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=ua(e),this._time=ha(e);try{let i=await Ts(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=i.knobs,this._hasTime=i.has_time;let n={},s={};for(let o of i.knobs)o.kind==="entity"?n[o.entity_id]=ca(o):s[this._vkey(o)]=o.live_value;this._values=n,this._verdicts=s,this._loading=!1}catch(i){this._error=C(this.hass,i),this._loading=!1}}_setState(e,i){this._values={...this._values,[e]:{...this._values[e],state:i}}}_setAttr(e,i,n){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[i]:n}}}}_setFor(e,i,n){let s=this._values[e],o=Number.isFinite(n)&&n>0?Math.trunc(n):0;this._values={...this._values,[e]:{...s,for:{...s.for,[i]:o}}}}_setVerdict(e,i){this._verdicts={...this._verdicts,[e]:i}}_resetWhen(){let e=new Date;this._date=ua(e),this._time=ha(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:ca(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let i of this._knobs){if(i.kind!=="entity")continue;let n=this._values[i.entity_id];if(!n)continue;let s={};for(let l of i.attributes){let c=n.attributes[l.name];if(!(c===void 0||c===""))if(l.control==="number"){let h=Number(c);Number.isNaN(h)||(s[l.name]=h)}else s[l.name]=c}let o={attributes:s};n.state!==""&&(o.state=n.state),(n.for.h||n.for.m||n.for.s)&&(o.for=n.for),(o.state!==void 0||o.for!==void 0||Object.keys(s).length>0)&&(e[i.entity_id]=o)}return e}_buildVerdicts(){let e={};for(let i of this._knobs)i.kind==="verdict"&&(e[i.condition]||(e[i.condition]={}),e[i.condition][i.key]=this._verdicts[this._vkey(i)]??i.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`);if(!this._date||!this._time||Number.isNaN(e.getTime())){this._error=a(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}let i=e.toISOString();try{this._result=await Ls(this.hass,this.scope,this.category,i,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(n){this._error=C(this.hass,n)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?d`
      ...
      ${e.attributes.map((s,o)=>d`
        <div class="row attr ${o===e.attributes.length-1?"last-attr":""}">
          <div class="row-text"><div class="row-title">${da(this.hass,s.name)}</div></div>
          <div class="row-ctrl">
    ...
    `}_renderAttrControl(e,i,n){let s=o=>this._setAttr(e.entity_id,i.name,o.target.value);if(i.control==="select"){let o=ze(this.hass)[e.entity_id];return d`<select data-attr=${`${e.entity_id}:${i.name}`} .value=${n} @change=${s}>
        ${(i.options??[n]).map(l=>d`<option value=${l} ?selected=${l===n}>${Se(this.hass,o,i.name,l)}</option>`)}
      ...
      @input=${s} />`}_renderControl(e,i){if(e.control==="select")return d`<select data-entity=${e.entity_id} .value=${i}
        ...
        ${(e.options??[i]).map(s=>d`<option value=${s} ?selected=${s===i}>${da(this.hass,s)}</option>`)}
    ...
    >
      ...
      <span class="countdown">${_u(l)}</span>
  ...
  `,u([f({attribute:!1})],ge.prototype,"hass",2),u([_()],ge.prototype,"_defaults",2),u([_()],ge.prototype,"_reapply",2),u([_()],ge.prototype,"_exposed",2),u([_()],ge.prototype,"_error",2),ge=u([w("ambience-ambience-settings")],ge);function pa(){let t=globalThis.crypto;if(t?.randomUUID)return t.randomUUID().replace(/-/g,"");if(t?.getRandomValues){let r=t.getRandomValues(new Uint8Array(16));return Array.from(r,e=>e.toString(16).padStart(2,"0")).join("")}return Array.from({length:4},()=>Math.floor(Math.random()*4294967296).toString(16).padStart(8,"0")).join("")}var _e=class extends b{constructor(){super(...arguments);this._categories=[];this._error="";this._editing=null;this._modalError=""}async connectedCallback(){super.connectedCallback();try{this._categories=await tt(this.hass)}catch(e){this._error=C(this.hass,e)}}_sorted(){return[...this._categories].sort((e,i)=>e.name.localeCompare(i.name))}_validate(e){let i=e.name.trim();if(i==="")return a(this.hass,"ui.category_name_blank_error","Category names can't be empty.");let n=i.toLocaleLowerCase();return this._categories.some(o=>o.id!==e.id&&o.name.trim().toLocaleLowerCase()===n)?a(this.hass,"ui.category_name_duplicate_error","Two categories can't have the same name."):""}_openEditor(e){this._editing={...e},this._modalError=""}_addCategory(){let e=pa();this._editing={id:e,name:""},this._modalError=""}_closeModal(){this._editing=null,this._modalError=""}_patchDraft(e){this._editing&&(this._editing={...this._editing,...e})}_onName(e){this._patchDraft({name:e.target.value})}_onIcon(e){this._patchDraft({icon:e||void 0})}_onColor(e){this._patchDraft({color:e})}_save(){if(!this._editing)return;let e=this._validate(this._editing);if(e){this._modalError=e;return}let i={...this._editing,name:this._editing.name.trim()},n=this._categories.some(s=>s.id===i.id);this._categories=n?this._categories.map(s=>s.id===i.id?i:s):[...this._categories,i],this._closeModal(),bs(this.hass,this._categories).then(()=>{window.dispatchEvent(new CustomEvent("ambience-categories-changed"))}).catch(s=>{this._error=C(this.hass,s)})}_deleteCategory(){if(!this._editing)return;let e=this._editing.id;if(this._categories.length<=1){this._modalError=a(this.hass,"ui.category_delete_blocked_last","You can't delete the last category.");return}let i=this._categories;this._categories=this._categories.filter(n=>n.id!==e),ws(this.hass,e).then(()=>{this._closeModal(),window.dispatchEvent(new CustomEvent("ambience-categories-changed"))}).catch(n=>{this._categories=i;let s=n.code;s==="category_in_use"?this._modalError=a(this.hass,"ui.category_delete_blocked_in_use","This category still has scenes \u2014 move or delete them first."):s==="category_last"?this._modalError=a(this.hass,"ui.category_delete_blocked_last","You can't delete the last category."):this._modalError=C(this.hass,n)})}_renderIconField(){return customElements.get("ha-icon-picker")?d`<ha-icon-picker
    ...
    />`}_renderSwatches(){let e=this._editing.color;return d`
      <div class="swatches">
        ${Pr.map(i=>{let n=Dn(this.hass,i.id,i.label);return d`<button
            type="button"
    ...
    `}render(){return d`
      ${this._error?d`<p class="error">${this._error}</p>`:""}
      <div class="list">
        ${this._sorted().map(e=>{let i=Rr(e.color);return d`<button class="category-row" @click=${()=>this._openEditor(e)}>
  ...
  `,u([f({attribute:!1})],_e.prototype,"hass",2),u([_()],_e.prototype,"_categories",2),u([_()],_e.prototype,"_error",2),u([_()],_e.prototype,"_editing",2),u([_()],_e.prototype,"_modalError",2),_e=u([w("ambience-categories-settings")],_e);var Ce=class extends b{constructor(){super(...arguments);this.conditionName="";this.conditionDescription="";this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}render(){let e=G(this.hass,this.conditionName);return d`
      <div class="card">
  ...
  `,u([f({attribute:!1})],Ce.prototype,"hass",2),u([f()],Ce.prototype,"conditionName",2),u([f()],Ce.prototype,"conditionDescription",2),u([_()],Ce.prototype,"_expanded",2),Ce=u([w("ambience-condition-card")],Ce);var bu=/^[a-z][a-z0-9_]*$/;function wu(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var di=y`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,oe=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=di}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!bu.test(e)?a(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?a(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":a(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??wu(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return d`
    ...
    `],u([f({attribute:!1})],ct.prototype,"initial",2),u([_()],ct.prototype,"_def",2),ct=u([w("ambience-period-edit-modal")],ct);function ma(t,r){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Te(r,t.anchor);if(t.offset_min===0)return e;let i=Math.abs(t.offset_min),n=i%60===0?`${i/60}${a(r,"ui.unit_hour_abbr","h")}`:`${i}${a(r,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${n}`}var mr=class extends pe{_list(){return Pi(this.hass)}async _save(r,e){await ls(this.hass,r,e)}_label(r,e){return Le(this.hass,r,e)}_formatDef(r){return`${ma(r.from,this.hass)} \u2192 ${ma(r.to,this.hass)}`}_headingKey(){return["ui.periods_heading","Periods"]}_addKey(){return["ui.add_custom_period","+ Add custom period"]}_renderModal(){let r=this._modal;return r.mode==="edit"?d`<ambience-period-edit-modal
        .hass=${this.hass}
        .existingId=${r.id}
        .initial=${r.initial}
  ...
  `,u([f({attribute:!1})],qe.prototype,"hass",2),u([_()],qe.prototype,"_config",2),u([_()],qe.prototype,"_expanded",2),qe=u([w("ambience-weather-config")],qe);var fa={time_of_day:t=>d`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>d`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>d`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>d`<ambience-weather-config .hass=${t}></ambience-weather-config>`},$u=new Set(Object.keys(fa)),Ke=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await Ai(this.hass)}catch(e){this._error=C(this.hass,e)}}render(){let e=this._conditions.filter(i=>$u.has(i.name)).slice().sort((i,n)=>n.priority-i.priority);return d`
  ...
  `,u([f({attribute:!1})],Ke.prototype,"hass",2),u([_()],Ke.prototype,"_conditions",2),u([_()],Ke.prototype,"_error",2),Ke=u([w("ambience-conditions-settings")],Ke);function ga(t,r){let e=t?.config?.components;return Array.isArray(e)&&e.includes(r)}var ku="fado",Eu="https://my.home-assistant.io/redirect/hacs_repository/?owner=clintongormley&repository=ha-fado",H=class extends b{constructor(){super(...arguments);this._actions=[];this._services=[];this._schemas={};this._fieldSchemas={};this._addSchema=[];this._serviceById=new Map;this._availableServices=[];this._expanded=new Set;this._adding=!1;this._loadError=null;this._saveError=null;this._loaded=!1;this._fadoNoticeDismissed=!1;this._editingDefault=null;this._editingOriginalValue=void 0;this._editingOriginalHad=!1;this._drag=new $t(this,(e,i)=>{let n=[...this._actions],[s]=n.splice(e,1);n.splice(i,0,s),this._actions=n,this._autoSave()});this._onDocPointerDown=e=>{if(!this._adding&&this._editingDefault===null)return;let i=e.composedPath(),n=i.some(s=>s instanceof Element&&H._OVERLAY_TAG_RE.test(s.localName));this._collapseAddFormOnClickAway(i,n),this._cancelEditingDefaultOnClickAway(i,n)}}_collapseAddFormOnClickAway(e,i){if(!this._adding)return;let n=this.shadowRoot?.querySelector(".add-row");!(!!n&&e.includes(n))&&!i&&(this._adding=!1)}_cancelEditingDefaultOnClickAway(e,i){if(this._editingDefault===null)return;let n=this.shadowRoot?.querySelector(`.field-row-editor[data-editing-key="${this._editingDefault}"]`);(!n||!e.includes(n))&&!i&&this._cancelEditingDefault()}connectedCallback(){super.connectedCallback(),this._fadoNoticeDismissed=Qn(),document.addEventListener("pointerdown",this._onDocPointerDown),customElements.get("ha-service-picker")||customElements.whenDefined("ha-service-picker").then(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerdown",this._onDocPointerDown)}_startEditingDefault(e,i){let s=this._actions.find(o=>o.id===e)?.defaults??{};this._editingOriginalHad=i in s,this._editingOriginalValue=s[i],this._editingDefault=`${e}:${i}`}_saveEditingDefault(){this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1,this._autoSave()}_cancelEditingDefault(){let e=this._editingDefault;if(e){let i=e.indexOf(":"),n=e.slice(0,i),s=e.slice(i+1);this._actions=this._actions.map(o=>{if(o.id!==n)return o;let l={...o.defaults??{}};return this._editingOriginalHad?l[s]=this._editingOriginalValue:delete l[s],{...o,defaults:l}})}this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}async firstUpdated(){await this._reload()}willUpdate(e){if(e.has("_actions")||e.has("_schemas")){let i={};for(let n of this._actions){let s=this._schemas[n.id];if(s)for(let[o,l]of Object.entries(s.fields))i[`${n.id}:${o}`]=[{name:o,selector:l.selector??{text:{}},required:!1}]}this._fieldSchemas=i}if(e.has("_services")&&(this._serviceById=new Map(this._services.map(i=>[i.id,i]))),e.has("_actions")||e.has("_services")){let i=new Set(this._actions.map(n=>n.id));this._availableServices=this._services.filter(n=>!i.has(n.id)),this._addSchema=[{name:"service",selector:{select:{options:this._availableServices.map(n=>({value:n.id,label:this._addOptionLabel(n.id)})),custom_value:!0,mode:"dropdown",sort:!0}}}]}}async _reload(){this._loadError=null;try{let[e,i]=await Promise.all([zt(this.hass),ss(this.hass)]);this._actions=e,this._services=i}catch(e){this._loadError=C(this.hass,e);return}await Promise.all(this._actions.map(e=>this._ensureSchema(e.id))),this._loaded=!0}async _ensureSchema(e){if(!(e in this._schemas))try{let i=await Ae(this.hass,e);this._schemas={...this._schemas,[e]:i}}catch{this._schemas={...this._schemas,[e]:null}}}_setShowInEditor(e,i,n){this._actions=this._actions.map(s=>{if(s.id!==e)return s;let o=new Set(s.visible_fields??[]);return n?o.add(i):o.delete(i),{...s,visible_fields:[...o]}}),this._autoSave()}_setDefault(e,i,n){this._actions=this._actions.map(s=>s.id!==e?s:{...s,defaults:{...s.defaults??{},[i]:n}})}_clearDefault(e,i){this._actions=this._actions.map(n=>{if(n.id!==e)return n;let s={...n.defaults??{}};return delete s[i],{...n,defaults:s}})}_setLabel(e,i){this._actions=this._actions.map(n=>n.id===e?{...n,label:i}:n)}_toggleExpand(e){this._expanded.has(e)?this._expanded=new Set:(this._expanded=new Set([e]),this._ensureSchema(e))}async _addService(e){if(e&&this._services.some(i=>i.id===e)){if(this._actions.some(i=>i.id===e)){this._expanded=new Set([e]),this._adding=!1;return}await this._ensureSchema(e),this._actions=[...this._actions,{id:e,label:this._labelForService(e),visible_fields:[],defaults:{}}],this._expanded=new Set([e]),this._adding=!1,this._autoSave()}}_removeService(e){this._actions=this._actions.filter(n=>n.id!==e);let i=new Set(this._expanded);i.delete(e),this._expanded=i,this._autoSave()}async _autoSave(){this._saveError=null;try{await ns(this.hass,this._actions),window.dispatchEvent(new CustomEvent("ambience-exposed-actions-changed"))}catch(e){this._saveError=C(this.hass,e)}}render(){return this._loadError!==null?d`
    ...
    `:d`<div>${a(this.hass,"ui.loading","Loading\u2026")}</div>`}_renderFadoNotice(){return this._fadoNoticeDismissed||ga(this.hass,ku)?"":d`
