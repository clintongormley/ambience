...
`;function at(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return je(t)}function Ht(t,n="New rule"){return t.name&&t.name.trim()?t.name:n}function ot(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?Dt(n,e):t==="day"?Es(n,e):t==="weather"?Rs(n,e):t==="sun"?Ps(n,e):t==="state"?gr(n,e):t==="script"?ws(n,e):t==="people"?ks(n,e):t==="template"?xs(n,e):String(n)}function xs(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function ws(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=st(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(a=>`${fr(n.hass,t.script,a)}: ${fe(n.hass,r[a])}`).join(", ");return`${e} (${s})`}function fr(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:je(e)}function st(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Ti(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):st(n,t)}function ks(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let a=st(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${a} ${c} ${Ti(e,n)}`;return t.for&&pr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:h}let r;if(Array.isArray(t.who)){let a=t.quant??"any",o=a==="any"?d(n.hass,"ui.people_mode_any","Any of:"):a==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>st(n,h)).join(", ");r=`${o} (${c})`}else{let a=t.quant??"everyone";r=a==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):a==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Ti(e,n)}`;return t.for&&pr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:s}function Es(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(a=>Li(a,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(a=>Li(a,n)).join(", ")})`}function Li(t,n){switch(t.kind){case"weekday":return t.days.map(e=>wt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${Fe(n.hass,t.month)} ${t.day}`;case"date_range":return`${Fe(n.hass,t.from.month)} ${t.from.day} \u2192 ${Fe(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Ss={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function je(t){return he(t)}function Cs(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var Ts=["entity_id","device_id","area_id","label_id","floor_id"],Ai=2;function Ls(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>Ts.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function fe(t,n){let e=Ls(n);if(!e)return Cs(n);let r=e.slice(0,Ai).map(a=>st({hass:t},a)),i=e.length-Ai;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function Ot(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function As(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function Rs(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(a=>[a.id,a.label])),r=(t.groups??[]).map(a=>e.get(a)??As(a)).join("/"),i=(t.thresholds??[]).map(a=>`${rt(n.hass,a.attribute)} ${Ss[a.op]??a.op} ${a.value}`).join(", "),s=[r,i].filter(a=>a!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function Ps(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function Hi(t,n){return Y(t.hass,n)}function Oi(t,n){return Hi({hass:t},n)}function gr(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):hr(t,n)}function hr(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<="){let e=K(n.hass,t.kind),i=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.join("/"),s=Hi(n,t.entity_id),o=`${t.attribute?`${s}.${t.attribute}`:s} ${e} ${i}`;return t.for&&pr(t.for)?`${o} ${d(n.hass,"ui.for_prefix","for")} \u2265${mr(t.for)}`:o}if(t.kind==="and"||t.kind==="or"){let e=` ${K(n.hass,t.kind)} `;return t.items.map(r=>Ri(r,n)).join(e)}return t.kind==="not"?`${K(n.hass,"not")} ${Ri(t.item,n)}`:""}function Ri(t,n){return t.kind==="and"||t.kind==="or"?`(${hr(t,n)})`:hr(t,n)}function pr(t){return t.h>0||t.m>0||t.s>0}function mr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function Dt(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?ie(n.hass,i.period,r):`${Pi(i.from,n)} \u2192 ${Pi(i.to,n)}`).join(", ")}function Pi(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Ne(n.hass,t.anchor);if(t.offset_min===0)return e;let r=Math.abs(t.offset_min),i=r%60===0?`${r/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${r}${d(n.hass,"ui.unit_min_abbr","m")}`;return`${e}${t.offset_min<0?"-":"+"}${i}`}function Hs(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label&&e.label.trim()?e.label:xt(n.hass,t.service)}function Os(t,n){let e=t.service.indexOf(".");return e>0?t.service.slice(0,e):d(n.hass,"ui.target_noun","target")}function Di(t,n){let e=Hs(t,n),r=Os(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let a=Object.entries(t.params).filter(([,o])=>o!=null&&o!=="").map(([o,c])=>`${at(o,t.service,n.schemas)}: ${fe(n.hass,c)}`).join(", ");return a?`${e}: ${s}, ${a}`:`${e}: ${s}`}var ze=class{constructor(n,e){this.host=n;this.onReorder=e;this.from=null;this.over=null;n.addController(this)}hostDisconnected(){this._reset()}start(n,e,r){this.from=n,e?.dataTransfer&&r&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setDragImage(r,16,16)),this.host.requestUpdate()}dragOver(n,e){this.from===null||e===this.from||(n.preventDefault(),this.over!==e&&(this.over=e,this.host.requestUpdate()))}drop(n){let e=this.from;this._reset(),!(e===null||e===n)&&this.onReorder(e,n)}end(){this._reset()}_reset(){let n=this.from!==null||this.over!==null;this.from=null,this.over=null,n&&this.host.requestUpdate()}};var I=class extends y{constructor(){super(...arguments);this.rules=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this._drag=new ze(this,(e,r)=>this._emit("reorder-rules",{from:e,to:r}));this._expanded=new Set}_renderSectionHeader(e){return l`<div
  ...
  `,u([p({attribute:!1})],M.prototype,"hass",2),u([p({attribute:!1})],M.prototype,"scope",2),u([p({attribute:!1})],M.prototype,"exposed",2),u([p({attribute:!1})],M.prototype,"entityIds",2),u([p({attribute:!1})],M.prototype,"params",2),u([f()],M.prototype,"_schema",2),u([f()],M.prototype,"_schemaError",2),u([f()],M.prototype,"_exposedMissing",2),u([f()],M.prototype,"_formSchema",2),u([f()],M.prototype,"_perFieldSchemas",2),M=u([b("ambience-action-slot")],M);function tn(t){return typeof t>"u"||t===null}function Ds(t){return typeof t=="object"&&t!==null}function Ns(t){return Array.isArray(t)?t:tn(t)?[]:[t]}function Fs(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function Is(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function Ms(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var js=tn,zs=Ds,Ws=Ns,Us=Is,Bs=Ms,qs=Fs,H={isNothing:js,isObject:zs,toArray:Ws,repeat:Us,isNegativeZero:Bs,extend:qs};function rn(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`

`+t.mark.snippet),r+" "+e):r}function dt(t,n){Error.call(this),this.name="YAMLException",this.reason=t,this.mark=n,this.message=rn(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}dt.prototype=Object.create(Error.prototype);dt.prototype.constructor=dt;dt.prototype.toString=function(n){return this.name+": "+rn(this,n)};var j=dt;function vr(t,n,e,r,i){var s="",a="",o=Math.floor(i/2)-1;return r-n>o&&(s=" ... ",n=r-o+s.length),e-r>o&&(a=" ...",e=r+o-a.length),{str:s+t.slice(n,e).replace(/\t/g,"\u2192")+a,pos:r-n+s.length}}function _r(t,n){return H.repeat(" ",n-t.length)+t}function Gs(t,n){if(n=Object.create(n||null),!t.buffer)return null;n.maxLength||(n.maxLength=79),typeof n.indent!="number"&&(n.indent=1),typeof n.linesBefore!="number"&&(n.linesBefore=3),typeof n.linesAfter!="number"&&(n.linesAfter=2);for(var e=/\r?\n|\r|\0/g,r=[0],i=[],s,a=-1;s=e.exec(t.buffer);)i.push(s.index),r.push(s.index+s[0].length),t.position<=s.index&&a<0&&(a=r.length-2);a<0&&(a=r.length-1);var o="",c,h,m=Math.min(t.line+n.linesAfter,i.length).toString().length,g=n.maxLength-(n.indent+m+3);for(c=1;c<=n.linesBefore&&!(a-c<0);c++)h=vr(t.buffer,r[a-c],i[a-c],t.position-(r[a]-r[a-c]),g),o=H.repeat(" ",n.indent)+_r((t.line-c+1).toString(),m)+" | "+h.str+`
`+o;for(h=vr(t.buffer,r[a],i[a],t.position,g),o+=H.repeat(" ",n.indent)+_r((t.line+1).toString(),m)+" | "+h.str+`
`,o+=H.repeat("-",n.indent+m+3+h.pos)+`^
`,c=1;c<=n.linesAfter&&!(a+c>=i.length);c++)h=vr(t.buffer,r[a+c],i[a+c],t.position-(r[a]-r[a+c]),g),o+=H.repeat(" ",n.indent)+_r((t.line+c+1).toString(),m)+" | "+h.str+`
`;return o.replace(/\n$/,"")}var Ks=Gs,Ys=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Vs=["scalar","sequence","mapping"];function Qs(t){var n={};return t!==null&&Object.keys(t).forEach(function(e){t[e].forEach(function(r){n[String(r)]=e})}),n}function Js(t,n){if(n=n||{},Object.keys(n).forEach(function(e){if(Ys.indexOf(e)===-1)throw new j('Unknown option "'+e+'" is met in definition of "'+t+'" YAML type.')}),this.options=n,this.tag=t,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(e){return e},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.representName=n.representName||null,this.defaultStyle=n.defaultStyle||null,this.multi=n.multi||!1,this.styleAliases=Qs(n.styleAliases||null),Vs.indexOf(this.kind)===-1)throw new j('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var D=Js;function ji(t,n){var e=[];return t[n].forEach(function(r){var i=e.length;e.forEach(function(s,a){s.tag===r.tag&&s.kind===r.kind&&s.multi===r.multi&&(i=a)}),e[i]=r}),e}function Xs(){var t={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},n,e;function r(i){i.multi?(t.multi[i.kind].push(i),t.multi.fallback.push(i)):t[i.kind][i.tag]=t.fallback[i.tag]=i}for(n=0,e=arguments.length;n<e;n+=1)arguments[n].forEach(r);return t}function br(t){return this.extend(t)}br.prototype.extend=function(n){var e=[],r=[];if(n instanceof D)r.push(n);else if(Array.isArray(n))r=r.concat(n);else if(n&&(Array.isArray(n.implicit)||Array.isArray(n.explicit)))n.implicit&&(e=e.concat(n.implicit)),n.explicit&&(r=r.concat(n.explicit));else throw new j("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.forEach(function(s){if(!(s instanceof D))throw new j("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(s.loadKind&&s.loadKind!=="scalar")throw new j("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(s.multi)throw new j("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),r.forEach(function(s){if(!(s instanceof D))throw new j("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var i=Object.create(br.prototype);return i.implicit=(this.implicit||[]).concat(e),i.explicit=(this.explicit||[]).concat(r),i.compiledImplicit=ji(i,"implicit"),i.compiledExplicit=ji(i,"explicit"),i.compiledTypeMap=Xs(i.compiledImplicit,i.compiledExplicit),i};var Zs=br,ea=new D("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),ta=new D("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),ra=new D("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),ia=new Zs({explicit:[ea,ta,ra]});function na(t){if(t===null)return!0;var n=t.length;return n===1&&t==="~"||n===4&&(t==="null"||t==="Null"||t==="NULL")}function sa(){return null}function aa(t){return t===null}var oa=new D("tag:yaml.org,2002:null",{kind:"scalar",resolve:na,construct:sa,predicate:aa,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function la(t){if(t===null)return!1;var n=t.length;return n===4&&(t==="true"||t==="True"||t==="TRUE")||n===5&&(t==="false"||t==="False"||t==="FALSE")}function da(t){return t==="true"||t==="True"||t==="TRUE"}function ca(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var ua=new D("tag:yaml.org,2002:bool",{kind:"scalar",resolve:la,construct:da,predicate:ca,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"});function ha(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function pa(t){return 48<=t&&t<=55}function ma(t){return 48<=t&&t<=57}function fa(t){if(t===null)return!1;var n=t.length,e=0,r=!1,i;if(!n)return!1;if(i=t[e],(i==="-"||i==="+")&&(i=t[++e]),i==="0"){if(e+1===n)return!0;if(i=t[++e],i==="b"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(i!=="0"&&i!=="1")return!1;r=!0}return r&&i!=="_"}if(i==="x"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(!ha(t.charCodeAt(e)))return!1;r=!0}return r&&i!=="_"}if(i==="o"){for(e++;e<n;e++)if(i=t[e],i!=="_"){if(!pa(t.charCodeAt(e)))return!1;r=!0}return r&&i!=="_"}}if(i==="_")return!1;for(;e<n;e++)if(i=t[e],i!=="_"){if(!ma(t.charCodeAt(e)))return!1;r=!0}return!(!r||i==="_")}function ga(t){var n=t,e=1,r;if(n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),r=n[0],(r==="-"||r==="+")&&(r==="-"&&(e=-1),n=n.slice(1),r=n[0]),n==="0")return 0;if(r==="0"){if(n[1]==="b")return e*parseInt(n.slice(2),2);if(n[1]==="x")return e*parseInt(n.slice(2),16);if(n[1]==="o")return e*parseInt(n.slice(2),8)}return e*parseInt(n,10)}function va(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!H.isNegativeZero(t)}var _a=new D("tag:yaml.org,2002:int",{kind:"scalar",resolve:fa,construct:ga,predicate:va,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0o"+t.toString(8):"-0o"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),ya=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function ba(t){return!(t===null||!ya.test(t)||t[t.length-1]==="_")}function $a(t){var n,e;return n=t.replace(/_/g,"").toLowerCase(),e=n[0]==="-"?-1:1,"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?e===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:e*parseFloat(n,10)}var xa=/^[-+]?[0-9]+e/;function wa(t,n){var e;if(isNaN(t))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(H.isNegativeZero(t))return"-0.0";return e=t.toString(10),xa.test(e)?e.replace("e",".e"):e}function ka(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||H.isNegativeZero(t))}var Ea=new D("tag:yaml.org,2002:float",{kind:"scalar",resolve:ba,construct:$a,predicate:ka,represent:wa,defaultStyle:"lowercase"}),Sa=ia.extend({implicit:[oa,ua,_a,Ea]}),Ca=Sa,nn=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),sn=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Ta(t){return t===null?!1:nn.exec(t)!==null||sn.exec(t)!==null}function La(t){var n,e,r,i,s,a,o,c=0,h=null,m,g,_;if(n=nn.exec(t),n===null&&(n=sn.exec(t)),n===null)throw new Error("Date resolve error");if(e=+n[1],r=+n[2]-1,i=+n[3],!n[4])return new Date(Date.UTC(e,r,i));if(s=+n[4],a=+n[5],o=+n[6],n[7]){for(c=n[7].slice(0,3);c.length<3;)c+="0";c=+c}return n[9]&&(m=+n[10],g=+(n[11]||0),h=(m*60+g)*6e4,n[9]==="-"&&(h=-h)),_=new Date(Date.UTC(e,r,i,s,a,o,c)),h&&_.setTime(_.getTime()-h),_}function Aa(t){return t.toISOString()}var Ra=new D("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Ta,construct:La,instanceOf:Date,represent:Aa});function Pa(t){return t==="<<"||t===null}var Ha=new D("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Pa}),Er=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Oa(t){if(t===null)return!1;var n,e,r=0,i=t.length,s=Er;for(e=0;e<i;e++)if(n=s.indexOf(t.charAt(e)),!(n>64)){if(n<0)return!1;r+=6}return r%8===0}function Da(t){var n,e,r=t.replace(/[\r\n=]/g,""),i=r.length,s=Er,a=0,o=[];for(n=0;n<i;n++)n%4===0&&n&&(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)),a=a<<6|s.indexOf(r.charAt(n));return e=i%4*6,e===0?(o.push(a>>16&255),o.push(a>>8&255),o.push(a&255)):e===18?(o.push(a>>10&255),o.push(a>>2&255)):e===12&&o.push(a>>4&255),new Uint8Array(o)}function Na(t){var n="",e=0,r,i,s=t.length,a=Er;for(r=0;r<s;r++)r%3===0&&r&&(n+=a[e>>18&63],n+=a[e>>12&63],n+=a[e>>6&63],n+=a[e&63]),e=(e<<8)+t[r];return i=s%3,i===0?(n+=a[e>>18&63],n+=a[e>>12&63],n+=a[e>>6&63],n+=a[e&63]):i===2?(n+=a[e>>10&63],n+=a[e>>4&63],n+=a[e<<2&63],n+=a[64]):i===1&&(n+=a[e>>2&63],n+=a[e<<4&63],n+=a[64],n+=a[64]),n}function Fa(t){return Object.prototype.toString.call(t)==="[object Uint8Array]"}var Ia=new D("tag:yaml.org,2002:binary",{kind:"scalar",resolve:Oa,construct:Da,predicate:Fa,represent:Na}),Ma=Object.prototype.hasOwnProperty,ja=Object.prototype.toString;function za(t){if(t===null)return!0;var n=[],e,r,i,s,a,o=t;for(e=0,r=o.length;e<r;e+=1){if(i=o[e],a=!1,ja.call(i)!=="[object Object]")return!1;for(s in i)if(Ma.call(i,s))if(!a)a=!0;else return!1;if(!a)return!1;if(n.indexOf(s)===-1)n.push(s);else return!1}return!0}function Wa(t){return t!==null?t:[]}var Ua=new D("tag:yaml.org,2002:omap",{kind:"sequence",resolve:za,construct:Wa}),Ba=Object.prototype.toString;function qa(t){if(t===null)return!0;var n,e,r,i,s,a=t;for(s=new Array(a.length),n=0,e=a.length;n<e;n+=1){if(r=a[n],Ba.call(r)!=="[object Object]"||(i=Object.keys(r),i.length!==1))return!1;s[n]=[i[0],r[i[0]]]}return!0}function Ga(t){if(t===null)return[];var n,e,r,i,s,a=t;for(s=new Array(a.length),n=0,e=a.length;n<e;n+=1)r=a[n],i=Object.keys(r),s[n]=[i[0],r[i[0]]];return s}var Ka=new D("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:qa,construct:Ga}),Ya=Object.prototype.hasOwnProperty;function Va(t){if(t===null)return!0;var n,e=t;for(n in e)if(Ya.call(e,n)&&e[n]!==null)return!1;return!0}function Qa(t){return t!==null?t:{}}var Ja=new D("tag:yaml.org,2002:set",{kind:"mapping",resolve:Va,construct:Qa}),an=Ca.extend({implicit:[Ra,Ha],explicit:[Ia,Ua,Ka,Ja]}),ve=Object.prototype.hasOwnProperty,Nt=1,on=2,ln=3,Ft=4,yr=1,Xa=2,zi=3,Za=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,eo=/[\x85\u2028\u2029]/,to=/[,\[\]\{\}]/,dn=/^(?:!|!!|![a-z\-]+!)$/i,cn=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Wi(t){return Object.prototype.toString.call(t)}function X(t){return t===10||t===13}function Te(t){return t===9||t===32}function z(t){return t===9||t===32||t===10||t===13}function Ue(t){return t===44||t===91||t===93||t===123||t===125}function ro(t){var n;return 48<=t&&t<=57?t-48:(n=t|32,97<=n&&n<=102?n-97+10:-1)}function io(t){return t===120?2:t===117?4:t===85?8:0}function no(t){return 48<=t&&t<=57?t-48:-1}function Ui(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"\x85":t===95?"\xA0":t===76?"\u2028":t===80?"\u2029":""}function so(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function un(t,n,e){n==="__proto__"?Object.defineProperty(t,n,{configurable:!0,enumerable:!0,writable:!0,value:e}):t[n]=e}var hn=new Array(256),pn=new Array(256);for(Ce=0;Ce<256;Ce++)hn[Ce]=Ui(Ce)?1:0,pn[Ce]=Ui(Ce);var Ce;function ao(t,n){this.input=t,this.filename=n.filename||null,this.schema=n.schema||an,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function mn(t,n){var e={name:t.filename,buffer:t.input.slice(0,-1),position:t.position,line:t.line,column:t.position-t.lineStart};return e.snippet=Ks(e),new j(n,e)}function x(t,n){throw mn(t,n)}function It(t,n){t.onWarning&&t.onWarning.call(null,mn(t,n))}var Bi={YAML:function(n,e,r){var i,s,a;n.version!==null&&x(n,"duplication of %YAML directive"),r.length!==1&&x(n,"YAML directive accepts exactly one argument"),i=/^([0-9]+)\.([0-9]+)$/.exec(r[0]),i===null&&x(n,"ill-formed argument of the YAML directive"),s=parseInt(i[1],10),a=parseInt(i[2],10),s!==1&&x(n,"unacceptable YAML version of the document"),n.version=r[0],n.checkLineBreaks=a<2,a!==1&&a!==2&&It(n,"unsupported YAML version of the document")},TAG:function(n,e,r){var i,s;r.length!==2&&x(n,"TAG directive accepts exactly two arguments"),i=r[0],s=r[1],dn.test(i)||x(n,"ill-formed tag handle (first argument) of the TAG directive"),ve.call(n.tagMap,i)&&x(n,'there is a previously declared suffix for "'+i+'" tag handle'),cn.test(s)||x(n,"ill-formed tag prefix (second argument) of the TAG directive");try{s=decodeURIComponent(s)}catch{x(n,"tag prefix is malformed: "+s)}n.tagMap[i]=s}};function ge(t,n,e,r){var i,s,a,o;if(n<e){if(o=t.input.slice(n,e),r)for(i=0,s=o.length;i<s;i+=1)a=o.charCodeAt(i),a===9||32<=a&&a<=1114111||x(t,"expected valid JSON character");else Za.test(o)&&x(t,"the stream contains non-printable characters");t.result+=o}}function qi(t,n,e,r){var i,s,a,o;for(H.isObject(e)||x(t,"cannot merge mappings; the provided source object is unacceptable"),i=Object.keys(e),a=0,o=i.length;a<o;a+=1)s=i[a],ve.call(n,s)||(un(n,s,e[s]),r[s]=!0)}function Be(t,n,e,r,i,s,a,o,c){var h,m;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),h=0,m=i.length;h<m;h+=1)Array.isArray(i[h])&&x(t,"nested arrays are not supported inside keys"),typeof i=="object"&&Wi(i[h])==="[object Object]"&&(i[h]="[object Object]");if(typeof i=="object"&&Wi(i)==="[object Object]"&&(i="[object Object]"),i=String(i),n===null&&(n={}),r==="tag:yaml.org,2002:merge")if(Array.isArray(s))for(h=0,m=s.length;h<m;h+=1)qi(t,n,s[h],e);else qi(t,n,s,e);else!t.json&&!ve.call(e,i)&&ve.call(n,i)&&(t.line=a||t.line,t.lineStart=o||t.lineStart,t.position=c||t.position,x(t,"duplicated mapping key")),un(n,i,s),delete e[i];return n}function Sr(t){var n;n=t.input.charCodeAt(t.position),n===10?t.position++:n===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):x(t,"a line break is expected"),t.line+=1,t.lineStart=t.position,t.firstTabInLine=-1}function R(t,n,e){for(var r=0,i=t.input.charCodeAt(t.position);i!==0;){for(;Te(i);)i===9&&t.firstTabInLine===-1&&(t.firstTabInLine=t.position),i=t.input.charCodeAt(++t.position);if(n&&i===35)do i=t.input.charCodeAt(++t.position);while(i!==10&&i!==13&&i!==0);if(X(i))for(Sr(t),i=t.input.charCodeAt(t.position),r++,t.lineIndent=0;i===32;)t.lineIndent++,i=t.input.charCodeAt(++t.position);else break}return e!==-1&&r!==0&&t.lineIndent<e&&It(t,"deficient indentation"),r}function zt(t){var n=t.position,e;return e=t.input.charCodeAt(n),!!((e===45||e===46)&&e===t.input.charCodeAt(n+1)&&e===t.input.charCodeAt(n+2)&&(n+=3,e=t.input.charCodeAt(n),e===0||z(e)))}function Cr(t,n){n===1?t.result+=" ":n>1&&(t.result+=H.repeat(`
`,n-1))}function oo(t,n,e){var r,i,s,a,o,c,h,m,g=t.kind,_=t.result,$;if($=t.input.charCodeAt(t.position),z($)||Ue($)||$===35||$===38||$===42||$===33||$===124||$===62||$===39||$===34||$===37||$===64||$===96||($===63||$===45)&&(i=t.input.charCodeAt(t.position+1),z(i)||e&&Ue(i)))return!1;for(t.kind="scalar",t.result="",s=a=t.position,o=!1;$!==0;){if($===58){if(i=t.input.charCodeAt(t.position+1),z(i)||e&&Ue(i))break}else if($===35){if(r=t.input.charCodeAt(t.position-1),z(r))break}else{if(t.position===t.lineStart&&zt(t)||e&&Ue($))break;if(X($))if(c=t.line,h=t.lineStart,m=t.lineIndent,R(t,!1,-1),t.lineIndent>=n){o=!0,$=t.input.charCodeAt(t.position);continue}else{t.position=a,t.line=c,t.lineStart=h,t.lineIndent=m;break}}o&&(ge(t,s,a,!1),Cr(t,t.line-c),s=a=t.position,o=!1),Te($)||(a=t.position+1),$=t.input.charCodeAt(++t.position)}return ge(t,s,a,!1),t.result?!0:(t.kind=g,t.result=_,!1)}function lo(t,n){var e,r,i;if(e=t.input.charCodeAt(t.position),e!==39)return!1;for(t.kind="scalar",t.result="",t.position++,r=i=t.position;(e=t.input.charCodeAt(t.position))!==0;)if(e===39)if(ge(t,r,t.position,!0),e=t.input.charCodeAt(++t.position),e===39)r=t.position,t.position++,i=t.position;else return!0;else X(e)?(ge(t,r,i,!0),Cr(t,R(t,!1,n)),r=i=t.position):t.position===t.lineStart&&zt(t)?x(t,"unexpected end of the document within a single quoted scalar"):(t.position++,i=t.position);x(t,"unexpected end of the stream within a single quoted scalar")}function co(t,n){var e,r,i,s,a,o;if(o=t.input.charCodeAt(t.position),o!==34)return!1;for(t.kind="scalar",t.result="",t.position++,e=r=t.position;(o=t.input.charCodeAt(t.position))!==0;){if(o===34)return ge(t,e,t.position,!0),t.position++,!0;if(o===92){if(ge(t,e,t.position,!0),o=t.input.charCodeAt(++t.position),X(o))R(t,!1,n);else if(o<256&&hn[o])t.result+=pn[o],t.position++;else if((a=io(o))>0){for(i=a,s=0;i>0;i--)o=t.input.charCodeAt(++t.position),(a=ro(o))>=0?s=(s<<4)+a:x(t,"expected hexadecimal character");t.result+=so(s),t.position++}else x(t,"unknown escape sequence");e=r=t.position}else X(o)?(ge(t,e,r,!0),Cr(t,R(t,!1,n)),e=r=t.position):t.position===t.lineStart&&zt(t)?x(t,"unexpected end of the document within a double quoted scalar"):(t.position++,r=t.position)}x(t,"unexpected end of the stream within a double quoted scalar")}function uo(t,n){var e=!0,r,i,s,a=t.tag,o,c=t.anchor,h,m,g,_,$,k=Object.create(null),E,A,q,C;if(C=t.input.charCodeAt(t.position),C===91)m=93,$=!1,o=[];else if(C===123)m=125,$=!0,o={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=o),C=t.input.charCodeAt(++t.position);C!==0;){if(R(t,!0,n),C=t.input.charCodeAt(t.position),C===m)return t.position++,t.tag=a,t.anchor=c,t.kind=$?"mapping":"sequence",t.result=o,!0;e?C===44&&x(t,"expected the node content, but found ','"):x(t,"missed comma between flow collection entries"),A=E=q=null,g=_=!1,C===63&&(h=t.input.charCodeAt(t.position+1),z(h)&&(g=_=!0,t.position++,R(t,!0,n))),r=t.line,i=t.lineStart,s=t.position,qe(t,n,Nt,!1,!0),A=t.tag,E=t.result,R(t,!0,n),C=t.input.charCodeAt(t.position),(_||t.line===r)&&C===58&&(g=!0,C=t.input.charCodeAt(++t.position),R(t,!0,n),qe(t,n,Nt,!1,!0),q=t.result),$?Be(t,o,k,A,E,q,r,i,s):g?o.push(Be(t,null,k,A,E,q,r,i,s)):o.push(E),R(t,!0,n),C=t.input.charCodeAt(t.position),C===44?(e=!0,C=t.input.charCodeAt(++t.position)):e=!1}x(t,"unexpected end of the stream within a flow collection")}function ho(t,n){var e,r,i=yr,s=!1,a=!1,o=n,c=0,h=!1,m,g;if(g=t.input.charCodeAt(t.position),g===124)r=!1;else if(g===62)r=!0;else return!1;for(t.kind="scalar",t.result="";g!==0;)if(g=t.input.charCodeAt(++t.position),g===43||g===45)yr===i?i=g===43?zi:Xa:x(t,"repeat of a chomping mode identifier");else if((m=no(g))>=0)m===0?x(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?x(t,"repeat of an indentation width identifier"):(o=n+m-1,a=!0);else break;if(Te(g)){do g=t.input.charCodeAt(++t.position);while(Te(g));if(g===35)do g=t.input.charCodeAt(++t.position);while(!X(g)&&g!==0)}for(;g!==0;){for(Sr(t),t.lineIndent=0,g=t.input.charCodeAt(t.position);(!a||t.lineIndent<o)&&g===32;)t.lineIndent++,g=t.input.charCodeAt(++t.position);if(!a&&t.lineIndent>o&&(o=t.lineIndent),X(g)){c++;continue}if(t.lineIndent<o){i===zi?t.result+=H.repeat(`
...
`,c):t.result+=H.repeat(`
`,s?1+c:c),s=!0,a=!0,c=0,e=t.position;!X(g)&&g!==0;)g=t.input.charCodeAt(++t.position);ge(t,e,t.position,!1)}return!0}function Gi(t,n){var e,r=t.tag,i=t.anchor,s=[],a,o=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,x(t,"tab characters must not be used in indentation")),!(c!==45||(a=t.input.charCodeAt(t.position+1),!z(a))));){if(o=!0,t.position++,R(t,!0,-1)&&t.lineIndent<=n){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,qe(t,n,ln,!1,!0),s.push(t.result),R(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>n)&&c!==0)x(t,"bad indentation of a sequence entry");else if(t.lineIndent<n)break}return o?(t.tag=r,t.anchor=i,t.kind="sequence",t.result=s,!0):!1}function po(t,n,e){var r,i,s,a,o,c,h=t.tag,m=t.anchor,g={},_=Object.create(null),$=null,k=null,E=null,A=!1,q=!1,C;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=g),C=t.input.charCodeAt(t.position);C!==0;){if(!A&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,x(t,"tab characters must not be used in indentation")),r=t.input.charCodeAt(t.position+1),s=t.line,(C===63||C===58)&&z(r))C===63?(A&&(Be(t,g,_,$,k,null,a,o,c),$=k=E=null),q=!0,A=!0,i=!0):A?(A=!1,i=!0):x(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,C=r;else{if(a=t.line,o=t.lineStart,c=t.position,!qe(t,e,on,!1,!0))break;if(t.line===s){for(C=t.input.charCodeAt(t.position);Te(C);)C=t.input.charCodeAt(++t.position);if(C===58)C=t.input.charCodeAt(++t.position),z(C)||x(t,"a whitespace character is expected after the key-value separator within a block mapping"),A&&(Be(t,g,_,$,k,null,a,o,c),$=k=E=null),q=!0,A=!1,i=!1,$=t.tag,k=t.result;else if(q)x(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=m,!0}else if(q)x(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=m,!0}if((t.line===s||t.lineIndent>n)&&(A&&(a=t.line,o=t.lineStart,c=t.position),qe(t,n,Ft,!0,i)&&(A?k=t.result:E=t.result),A||(Be(t,g,_,$,k,E,a,o,c),$=k=E=null),R(t,!0,-1),C=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>n)&&C!==0)x(t,"bad indentation of a mapping entry");else if(t.lineIndent<n)break}return A&&Be(t,g,_,$,k,null,a,o,c),q&&(t.tag=h,t.anchor=m,t.kind="mapping",t.result=g),q}function mo(t){var n,e=!1,r=!1,i,s,a;if(a=t.input.charCodeAt(t.position),a!==33)return!1;if(t.tag!==null&&x(t,"duplication of a tag property"),a=t.input.charCodeAt(++t.position),a===60?(e=!0,a=t.input.charCodeAt(++t.position)):a===33?(r=!0,i="!!",a=t.input.charCodeAt(++t.position)):i="!",n=t.position,e){do a=t.input.charCodeAt(++t.position);while(a!==0&&a!==62);t.position<t.length?(s=t.input.slice(n,t.position),a=t.input.charCodeAt(++t.position)):x(t,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!z(a);)a===33&&(r?x(t,"tag suffix cannot contain exclamation marks"):(i=t.input.slice(n-1,t.position+1),dn.test(i)||x(t,"named tag handle cannot contain such characters"),r=!0,n=t.position+1)),a=t.input.charCodeAt(++t.position);s=t.input.slice(n,t.position),to.test(s)&&x(t,"tag suffix cannot contain flow indicator characters")}s&&!cn.test(s)&&x(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{x(t,"tag name is malformed: "+s)}return e?t.tag=s:ve.call(t.tagMap,i)?t.tag=t.tagMap[i]+s:i==="!"?t.tag="!"+s:i==="!!"?t.tag="tag:yaml.org,2002:"+s:x(t,'undeclared tag handle "'+i+'"'),!0}function fo(t){var n,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&x(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),n=t.position;e!==0&&!z(e)&&!Ue(e);)e=t.input.charCodeAt(++t.position);return t.position===n&&x(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(n,t.position),!0}function go(t){var n,e,r;if(r=t.input.charCodeAt(t.position),r!==42)return!1;for(r=t.input.charCodeAt(++t.position),n=t.position;r!==0&&!z(r)&&!Ue(r);)r=t.input.charCodeAt(++t.position);return t.position===n&&x(t,"name of an alias node must contain at least one character"),e=t.input.slice(n,t.position),ve.call(t.anchorMap,e)||x(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],R(t,!0,-1),!0}function qe(t,n,e,r,i){var s,a,o,c=1,h=!1,m=!1,g,_,$,k,E,A;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=a=o=Ft===e||ln===e,r&&R(t,!0,-1)&&(h=!0,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)),c===1)for(;mo(t)||fo(t);)R(t,!0,-1)?(h=!0,o=s,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)):o=!1;if(o&&(o=h||i),(c===1||Ft===e)&&(Nt===e||on===e?E=n:E=n+1,A=t.position-t.lineStart,c===1?o&&(Gi(t,A)||po(t,A,E))||uo(t,E)?m=!0:(a&&ho(t,E)||lo(t,E)||co(t,E)?m=!0:go(t)?(m=!0,(t.tag!==null||t.anchor!==null)&&x(t,"alias node should not have any properties")):oo(t,E,Nt===e)&&(m=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(m=o&&Gi(t,A))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&x(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),g=0,_=t.implicitTypes.length;g<_;g+=1)if(k=t.implicitTypes[g],k.resolve(t.result)){t.result=k.construct(t.result),t.tag=k.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(ve.call(t.typeMap[t.kind||"fallback"],t.tag))k=t.typeMap[t.kind||"fallback"][t.tag];else for(k=null,$=t.typeMap.multi[t.kind||"fallback"],g=0,_=$.length;g<_;g+=1)if(t.tag.slice(0,$[g].tag.length)===$[g].tag){k=$[g];break}k||x(t,"unknown tag !<"+t.tag+">"),t.result!==null&&k.kind!==t.kind&&x(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+k.kind+'", not "'+t.kind+'"'),k.resolve(t.result,t.tag)?(t.result=k.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):x(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||m}function vo(t){var n=t.position,e,r,i,s=!1,a;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(a=t.input.charCodeAt(t.position))!==0&&(R(t,!0,-1),a=t.input.charCodeAt(t.position),!(t.lineIndent>0||a!==37));){for(s=!0,a=t.input.charCodeAt(++t.position),e=t.position;a!==0&&!z(a);)a=t.input.charCodeAt(++t.position);for(r=t.input.slice(e,t.position),i=[],r.length<1&&x(t,"directive name must not be less than one character in length");a!==0;){for(;Te(a);)a=t.input.charCodeAt(++t.position);if(a===35){do a=t.input.charCodeAt(++t.position);while(a!==0&&!X(a));break}if(X(a))break;for(e=t.position;a!==0&&!z(a);)a=t.input.charCodeAt(++t.position);i.push(t.input.slice(e,t.position))}a!==0&&Sr(t),ve.call(Bi,r)?Bi[r](t,r,i):It(t,'unknown document directive "'+r+'"')}if(R(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,R(t,!0,-1)):s&&x(t,"directives end mark is expected"),qe(t,t.lineIndent-1,Ft,!1,!0),R(t,!0,-1),t.checkLineBreaks&&eo.test(t.input.slice(n,t.position))&&It(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&zt(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,R(t,!0,-1));return}if(t.position<t.length-1)x(t,"end of the stream or a document separator is expected");else return}function fn(t,n){t=String(t),n=n||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new ao(t,n),r=t.indexOf("\0");for(r!==-1&&(e.position=r,x(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)vo(e);return e.documents}function _o(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var r=fn(t,e);if(typeof n!="function")return r;for(var i=0,s=r.length;i<s;i+=1)n(r[i])}function yo(t,n){var e=fn(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new j("expected a single document in the stream, but found more")}}var bo=_o,$o=yo,gn={loadAll:bo,load:$o},vn=Object.prototype.toString,_n=Object.prototype.hasOwnProperty,Tr=65279,xo=9,ct=10,wo=13,ko=32,Eo=33,So=34,$r=35,Co=37,To=38,Lo=39,Ao=42,yn=44,Ro=45,Mt=58,Po=61,Ho=62,Oo=63,Do=64,bn=91,$n=93,No=96,xn=123,Fo=124,wn=125,N={};N[0]="\\0";N[7]="\\a";N[8]="\\b";N[9]="\\t";N[10]="\\n";N[11]="\\v";N[12]="\\f";N[13]="\\r";N[27]="\\e";N[34]='\\"';N[92]="\\\\";N[133]="\\N";N[160]="\\_";N[8232]="\\L";N[8233]="\\P";var Io=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],Mo=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function jo(t,n){var e,r,i,s,a,o,c;if(n===null)return{};for(e={},r=Object.keys(n),i=0,s=r.length;i<s;i+=1)a=r[i],o=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),c=t.compiledTypeMap.fallback[a],c&&_n.call(c.styleAliases,o)&&(o=c.styleAliases[o]),e[a]=o;return e}function zo(t){var n,e,r;if(n=t.toString(16).toUpperCase(),t<=255)e="x",r=2;else if(t<=65535)e="u",r=4;else if(t<=4294967295)e="U",r=8;else throw new j("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+H.repeat("0",r-n.length)+n}var Wo=1,ut=2;function Uo(t){this.schema=t.schema||an,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=H.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=jo(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?ut:Wo,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Ki(t,n){for(var e=H.repeat(" ",n),r=0,i=-1,s="",a,o=t.length;r<o;)i=t.indexOf(`
`,r),i===-1?(a=t.slice(r),r=o):(a=t.slice(r,i+1),r=i+1),a.length&&a!==`
`&&(s+=e),s+=a;return s}function xr(t,n){return`
`+H.repeat(" ",t.indent*n)}function Bo(t,n){var e,r,i;for(e=0,r=t.implicitTypes.length;e<r;e+=1)if(i=t.implicitTypes[e],i.resolve(n))return!0;return!1}function jt(t){return t===ko||t===xo}function ht(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==Tr||65536<=t&&t<=1114111}function Yi(t){return ht(t)&&t!==Tr&&t!==wo&&t!==ct}function Vi(t,n,e){var r=Yi(t),i=r&&!jt(t);return(e?r:r&&t!==yn&&t!==bn&&t!==$n&&t!==xn&&t!==wn)&&t!==$r&&!(n===Mt&&!i)||Yi(n)&&!jt(n)&&t===$r||n===Mt&&i}function qo(t){return ht(t)&&t!==Tr&&!jt(t)&&t!==Ro&&t!==Oo&&t!==Mt&&t!==yn&&t!==bn&&t!==$n&&t!==xn&&t!==wn&&t!==$r&&t!==To&&t!==Ao&&t!==Eo&&t!==Fo&&t!==Po&&t!==Ho&&t!==Lo&&t!==So&&t!==Co&&t!==Do&&t!==No}function Go(t){return!jt(t)&&t!==Mt}function lt(t,n){var e=t.charCodeAt(n),r;return e>=55296&&e<=56319&&n+1<t.length&&(r=t.charCodeAt(n+1),r>=56320&&r<=57343)?(e-55296)*1024+r-56320+65536:e}function kn(t){var n=/^\n* /;return n.test(t)}var En=1,wr=2,Sn=3,Cn=4,We=5;function Ko(t,n,e,r,i,s,a,o){var c,h=0,m=null,g=!1,_=!1,$=r!==-1,k=-1,E=qo(lt(t,0))&&Go(lt(t,t.length-1));if(n||a)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=lt(t,c),!ht(h))return We;E=E&&Vi(h,m,o),m=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=lt(t,c),h===ct)g=!0,$&&(_=_||c-k-1>r&&t[k+1]!==" ",k=c);else if(!ht(h))return We;E=E&&Vi(h,m,o),m=h}_=_||$&&c-k-1>r&&t[k+1]!==" "}return!g&&!_?E&&!a&&!i(t)?En:s===ut?We:wr:e>9&&kn(t)?We:a?s===ut?We:wr:_?Cn:Sn}function Yo(t,n,e,r,i){t.dump=(function(){if(n.length===0)return t.quotingType===ut?'""':"''";if(!t.noCompatMode&&(Io.indexOf(n)!==-1||Mo.test(n)))return t.quotingType===ut?'"'+n+'"':"'"+n+"'";var s=t.indent*Math.max(1,e),a=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),o=r||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return Bo(t,h)}switch(Ko(n,o,t.indent,a,c,t.quotingType,t.forceQuotes&&!r,i)){case En:return n;case wr:return"'"+n.replace(/'/g,"''")+"'";case Sn:return"|"+Qi(n,t.indent)+Ji(Ki(n,s));case Cn:return">"+Qi(n,t.indent)+Ji(Ki(Vo(n,a),s));case We:return'"'+Qo(n)+'"';default:throw new j("impossible error: invalid scalar style")}})()}function Qi(t,n){var e=kn(t)?String(n):"",r=t[t.length-1]===`
`,i=r&&(t[t.length-2]===`
`||t===`
`),s=i?"+":r?"":"-";return e+s+`
`}function Ji(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function Vo(t,n){for(var e=/(\n+)([^\n]*)/g,r=(function(){var h=t.indexOf(`
`);return h=h!==-1?h:t.length,e.lastIndex=h,Xi(t.slice(0,h),n)})(),i=t[0]===`
`||t[0]===" ",s,a;a=e.exec(t);){var o=a[1],c=a[2];s=c[0]===" ",r+=o+(!i&&!s&&c!==""?`
`:"")+Xi(c,n),i=s}return r}function Xi(t,n){if(t===""||t[0]===" ")return t;for(var e=/ [^ ]/g,r,i=0,s,a=0,o=0,c="";r=e.exec(t);)o=r.index,o-i>n&&(s=a>i?a:o,c+=`
`+t.slice(i,s),i=s+1),a=o;return c+=`
`,t.length-i>n&&a>i?c+=t.slice(i,a)+`
`+t.slice(a+1):c+=t.slice(i),c.slice(1)}function Qo(t){for(var n="",e=0,r,i=0;i<t.length;e>=65536?i+=2:i++)e=lt(t,i),r=N[e],!r&&ht(e)?(n+=t[i],e>=65536&&(n+=t[i+1])):n+=r||zo(e);return n}function Jo(t,n,e){var r="",i=t.tag,s,a,o;for(s=0,a=e.length;s<a;s+=1)o=e[s],t.replacer&&(o=t.replacer.call(e,String(s),o)),(se(t,n,o,!1,!1)||typeof o>"u"&&se(t,n,null,!1,!1))&&(r!==""&&(r+=","+(t.condenseFlow?"":" ")),r+=t.dump);t.tag=i,t.dump="["+r+"]"}function Zi(t,n,e,r){var i="",s=t.tag,a,o,c;for(a=0,o=e.length;a<o;a+=1)c=e[a],t.replacer&&(c=t.replacer.call(e,String(a),c)),(se(t,n+1,c,!0,!0,!1,!0)||typeof c>"u"&&se(t,n+1,null,!0,!0,!1,!0))&&((!r||i!=="")&&(i+=xr(t,n)),t.dump&&ct===t.dump.charCodeAt(0)?i+="-":i+="- ",i+=t.dump);t.tag=s,t.dump=i||"[]"}function Xo(t,n,e){var r="",i=t.tag,s=Object.keys(e),a,o,c,h,m;for(a=0,o=s.length;a<o;a+=1)m="",r!==""&&(m+=", "),t.condenseFlow&&(m+='"'),c=s[a],h=e[c],t.replacer&&(h=t.replacer.call(e,c,h)),se(t,n,c,!1,!1)&&(t.dump.length>1024&&(m+="? "),m+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),se(t,n,h,!1,!1)&&(m+=t.dump,r+=m));t.tag=i,t.dump="{"+r+"}"}function Zo(t,n,e,r){var i="",s=t.tag,a=Object.keys(e),o,c,h,m,g,_;if(t.sortKeys===!0)a.sort();else if(typeof t.sortKeys=="function")a.sort(t.sortKeys);else if(t.sortKeys)throw new j("sortKeys must be a boolean or a function");for(o=0,c=a.length;o<c;o+=1)_="",(!r||i!=="")&&(_+=xr(t,n)),h=a[o],m=e[h],t.replacer&&(m=t.replacer.call(e,h,m)),se(t,n+1,h,!0,!0,!0)&&(g=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,g&&(t.dump&&ct===t.dump.charCodeAt(0)?_+="?":_+="? "),_+=t.dump,g&&(_+=xr(t,n)),se(t,n+1,m,!0,g)&&(t.dump&&ct===t.dump.charCodeAt(0)?_+=":":_+=": ",_+=t.dump,i+=_));t.tag=s,t.dump=i||"{}"}function en(t,n,e){var r,i,s,a,o,c;for(i=e?t.explicitTypes:t.implicitTypes,s=0,a=i.length;s<a;s+=1)if(o=i[s],(o.instanceOf||o.predicate)&&(!o.instanceOf||typeof n=="object"&&n instanceof o.instanceOf)&&(!o.predicate||o.predicate(n))){if(e?o.multi&&o.representName?t.tag=o.representName(n):t.tag=o.tag:t.tag="?",o.represent){if(c=t.styleMap[o.tag]||o.defaultStyle,vn.call(o.represent)==="[object Function]")r=o.represent(n,c);else if(_n.call(o.represent,c))r=o.represent[c](n,c);else throw new j("!<"+o.tag+'> tag resolver accepts not "'+c+'" style');t.dump=r}return!0}return!1}function se(t,n,e,r,i,s,a){t.tag=null,t.dump=e,en(t,e,!1)||en(t,e,!0);var o=vn.call(t.dump),c=r,h;r&&(r=t.flowLevel<0||t.flowLevel>n);var m=o==="[object Object]"||o==="[object Array]",g,_;if(m&&(g=t.duplicates.indexOf(e),_=g!==-1),(t.tag!==null&&t.tag!=="?"||_||t.indent!==2&&n>0)&&(i=!1),_&&t.usedDuplicates[g])t.dump="*ref_"+g;else{if(m&&_&&!t.usedDuplicates[g]&&(t.usedDuplicates[g]=!0),o==="[object Object]")r&&Object.keys(t.dump).length!==0?(Zo(t,n,t.dump,i),_&&(t.dump="&ref_"+g+t.dump)):(Xo(t,n,t.dump),_&&(t.dump="&ref_"+g+" "+t.dump));else if(o==="[object Array]")r&&t.dump.length!==0?(t.noArrayIndent&&!a&&n>0?Zi(t,n-1,t.dump,i):Zi(t,n,t.dump,i),_&&(t.dump="&ref_"+g+t.dump)):(Jo(t,n,t.dump),_&&(t.dump="&ref_"+g+" "+t.dump));else if(o==="[object String]")t.tag!=="?"&&Yo(t,t.dump,n,s,c);else{if(o==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new j("unacceptable kind of an object to dump "+o)}t.tag!==null&&t.tag!=="?"&&(h=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?h="!"+h:h.slice(0,18)==="tag:yaml.org,2002:"?h="!!"+h.slice(18):h="!<"+h+">",t.dump=h+" "+t.dump)}return!0}function el(t,n){var e=[],r=[],i,s;for(kr(t,e,r),i=0,s=r.length;i<s;i+=1)n.duplicates.push(e[r[i]]);n.usedDuplicates=new Array(s)}function kr(t,n,e){var r,i,s;if(t!==null&&typeof t=="object")if(i=n.indexOf(t),i!==-1)e.indexOf(i)===-1&&e.push(i);else if(n.push(t),Array.isArray(t))for(i=0,s=t.length;i<s;i+=1)kr(t[i],n,e);else for(r=Object.keys(t),i=0,s=r.length;i<s;i+=1)kr(t[r[i]],n,e)}function tl(t,n){n=n||{};var e=new Uo(n);e.noRefs||el(t,e);var r=t;return e.replacer&&(r=e.replacer.call({"":r},"",r)),se(e,0,r,!0,!0)?e.dump+`
`:""}var rl=tl,il={dump:rl};function Lr(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Tn=gn.load,_c=gn.loadAll,Wt=il.dump;var yc=Lr("safeLoad","load"),bc=Lr("safeLoadAll","loadAll"),$c=Lr("safeDump","dump");var Z=class extends y{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>fr(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let i=this._currentFields()?.[e.name]?.description;return typeof i=="string"?i:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Wt(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Wt(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Wt(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Tn(e)}catch(c){this._yamlError=c.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError="Expected an object";return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError="`script` must be a 'script.<name>' string";return}let a=i.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError="`args` must be an object if present";return}let o=i.triggers;if(o!==void 0&&(!Array.isArray(o)||!o.every(c=>typeof c=="string"))){this._yamlError="`triggers` must be a list of entity_id strings if present";return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:o})}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){return Y(this.hass,e)}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,a]of Object.entries(r))a&&Object.prototype.hasOwnProperty.call(a,"default")&&(i[s]=a.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
      <div class="section">
        ...
        <div class="entry-header">
          <select @change=${o=>this._onSelectChange(r,o)}>
            ...
            ${s.map(o=>l`<option value=${o}>
                ${ie(this.hass,o,a)}${a[o]&&!this.periods?.builtins[o]?d(this.hass,"ui.custom_suffix"," (custom)"):""}
              </option>`)}
          </select>
  ...
  `,u([p({attribute:!1})],oe.prototype,"hass",2),u([p({attribute:!1})],oe.prototype,"value",2),u([f()],oe.prototype,"_openPath",2),u([f()],oe.prototype,"_showError",2),oe=u([b("ambience-state-predicate-input")],oe);var On=["everybody","anybody","nobody","any","all","none"],Dn=new Set(["any","all","none"]),Or={everybody:"everyone",anybody:"any",nobody:"nobody",any:"any",all:"everyone",none:"nobody"},Re=class extends y{constructor(){super(...arguments);this.value=null;this._lastSelected=[]}_statesMap(){return this.hass?.states??{}}_entitiesOfDomain(e){let r=this._statesMap(),i=`${e}.`;return Object.keys(r).filter(s=>s.startsWith(i)).sort().map(s=>({id:s,name:Y(this.hass,s)}))}_persons(){return this._entitiesOfDomain("person")}_zones(){return this._entitiesOfDomain("zone")}_cur(){return this.value??{}}_who(){return this.value?.who??[]}_hasWhoKey(){return this.value!=null&&Array.isArray(this.value.who)}_mode(){if(this._hasWhoKey())switch(this._cur().quant??"any"){case"any":return"any";case"everyone":return"all";case"nobody":return"none"}switch(this._cur().quant??"everyone"){case"nobody":return"nobody";case"any":return"anybody";default:return"everybody"}}_hasFor(e){return!!e&&(e.h!==0||e.m!==0||e.s!==0)}_isNegativeQuant(){return Or[this._mode()]==="nobody"}_effectiveNegate(){return!this._isNegativeQuant()&&!!this._cur().negate}_emitMode(e){let r=this._cur(),i=r.where??"home",s={quant:Or[e],where:i};r.negate&&Or[e]!=="nobody"&&(s.negate=!0),Dn.has(e)&&(this._hasWhoKey()?s.who=[...this._who()]:this._lastSelected.length>0?s.who=[...this._lastSelected]:s.who=this._persons().map(a=>a.id)),this._hasFor(r.for)&&(s.for=r.for),this._emit(s)}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_setMode(e){this._emitMode(e)}_setWhere(e){let r=this._cur(),i={quant:r.quant??"everyone",where:e};this._effectiveNegate()&&(i.negate=!0),this._hasWhoKey()&&(i.who=[...this._who()]),this._hasFor(r.for)&&(i.for=r.for),this._emit(i)}_setNegate(e){let r=this._cur(),i={quant:r.quant??"everyone",where:r.where??"home"};e&&(i.negate=!0),this._hasWhoKey()&&(i.who=[...this._who()]),this._hasFor(r.for)&&(i.for=r.for),this._emit(i)}_togglePerson(e,r){let i=r?[...this._who(),e]:this._who().filter(o=>o!==e);i.length>0&&(this._lastSelected=[...i]);let s=this._cur(),a={quant:s.quant??"any",where:s.where??"home",who:i};this._effectiveNegate()&&(a.negate=!0),this._hasFor(s.for)&&(a.for=s.for),this._emit(a)}_setFor(e){let r=this._cur(),i={quant:r.quant??"everyone",where:r.where??"home"};this._effectiveNegate()&&(i.negate=!0),this._hasWhoKey()&&(i.who=[...this._who()]),this._hasFor(e)&&(i.for=e),this._emit(i)}_forSchema(){return[{name:"duration",selector:{duration:{enable_day:!1}}}]}_forData(){let e=this._cur().for??{h:0,m:0,s:0};return{duration:{hours:e.h,minutes:e.m,seconds:e.s}}}_setForFromHaForm(e){this._setFor({h:e?.hours??0,m:e?.minutes??0,s:e?.seconds??0})}_modeLabel(e){switch(e){case"everybody":return d(this.hass,"ui.people_mode_everybody","Everybody");case"anybody":return d(this.hass,"ui.people_mode_anybody","Anybody");case"nobody":return d(this.hass,"ui.people_mode_nobody","Nobody");case"any":return d(this.hass,"ui.people_mode_any","Any of:");case"all":return d(this.hass,"ui.people_mode_all","All of:");case"none":return d(this.hass,"ui.people_mode_none","None of:")}}_renderMode(e){if(customElements.get("ha-form")){let r=[{name:"mode",required:!0,selector:{select:{mode:"dropdown",options:On.map(i=>({value:i,label:this._modeLabel(i)}))}}}];return l`<ha-form
    ...
    >
      ${On.map(r=>l`<option value=${r} ?selected=${r===e}>${this._modeLabel(r)}</option>`)}
  ...
  `,u([p({attribute:!1})],V.prototype,"condition",2),u([p({attribute:!1})],V.prototype,"value",2),u([p({attribute:!1})],V.prototype,"periods",2),u([p({attribute:!1})],V.prototype,"dayConfig",2),u([p({attribute:!1})],V.prototype,"weatherConfig",2),u([p({attribute:!1})],V.prototype,"hass",2),V=u([b("ambience-condition-input")],V);function hl(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function pl(t){return t==="people"?{quant:"everyone",where:"home"}:null}function Fn(t,n){return!!t&&!!n&&Q(t)===Q(n)}var S=class extends y{constructor(){super(...arguments);this.open=!1;this.rule=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.autoEditScope=!1;this._draft=null;this._open=null;this._showError=!1;this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onDestinationChange=e=>{this._setDestination(Number(e.target.value))};this._onDestinationChangeHaForm=e=>{e.stopPropagation(),this._setDestination(Number(e.detail.value.destination))};this._onAddCondition=e=>{let r=e.target,i=r.value;r.value="",this._addCondition(i)};this._onAddConditionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_CONDITION_PLACEHOLDER&&this._addCondition(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onConditionInvalid(e,r){r?this._conditionError.set(e,r):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),pe(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._scope=this.scope,this._open=this.autoEditScope&&this.scopes.length>0?{kind:"destination"}:null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let r=this.scopes[e];if(!r||!this._draft||(this._scope=r.scope,!this.hass))return;let i=new Set(Ct(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(a=>i.has(a))}))}}_renderDestination(){if(this.scopes.length===0)return"";let e=Math.max(0,this.scopes.findIndex(r=>Fn(r.scope,this._scope)));return customElements.get("ha-form")?this._renderDestinationHaForm(e):l`
    ...
    `}_renderActionRow(e,r){let i=this.availableActions.find(m=>m.id===e.service),s=i?.reapply_seconds??0,a=this._isOpen({kind:"action",idx:r}),o=Di(e,{hass:this.hass,exposedActions:this.availableActions,schemas:this.schemas}),c=Mi(e,s),h=s>0&&c>0;return l`
...
`;function fl(t){return t.kind==="entity"?`${t.entity_id} ${t.old} \u2192 ${t.new}`:t.detail?`${he(t.kind)} ${t.detail}`:he(t.kind)}function gl(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,a])=>`${at(s,t.service,e)}: ${fe(n,a)}`).join(", "),i=tt(t.service);return r?`${i} \xB7 ${r}`:i}function vl(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function _l(t,n){let e=t.index+1;return t.disabled?l`<div class="rule disabled">Rule #${e} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
  ...
  `:l`<div class="rule skipped">Rule #${e} ${t.name??"\u2014"}: not evaluated</div>`}function Bt(t,n,e,r,i){let s=t.actions.map(c=>tt(c.service)).join(", "),a=vl(t.actions),o=t.explanation!==null||t.actions.length>0;return l`
    <div class="eval">
      <div class="top">
      ...
      ${t.actions.length?l`<div class="action-summary">→ ${s}
            ${a?l`<span class="n">· ${a} ${a===1?"entity":"entities"}</span>`:w}</div>`:w}
    ...
    <div class="why">
      ...
      ${t.actions.length?l`<div class="section">
            ...
            ${t.actions.map(r=>l`<div class="action-block">
                ...
                ${(r.entity_ids??[]).map(i=>l`<div class="entity">${Oi(n,i)}</div>`)}
              </div>`)}
          </div>`:w}
    </div>
  `}var F=class extends y{constructor(){super(...arguments);this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1}connectedCallback(){super.connectedCallback(),this._poll=setInterval(()=>this._checkNew(),5e3)}disconnectedCallback(){super.disconnectedCallback(),this._poll&&clearInterval(this._poll)}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(r=>r.scope_kind===this.scope.scope_kind&&r.scope_id===this.scope.scope_id&&r.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await cr(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=e.message||String(e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(a=>a.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let r=await Promise.all(e.map(async s=>{try{return[s,await me(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let i={...this._schemas};for(let s of r)s&&(i[s[0]]=s[1]);this._schemas=i}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let r=this._mine(await cr(this.hass))[0]?.timestamp??null,i=this._records[0]?.timestamp??null;r&&(!i||r>i)&&(this._hasNew=!0)}catch{}}_toggle(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return w;let e=this.categoryName??this.category;return l`
    ...
    `}_renderControl(e,r){if(e.control==="select")return l`<select data-entity=${e.entity_id} .value=${r}
      ...
      .value=${r}
      @input=${s=>this._setState(e.entity_id,s.target.value)} />`}_renderVerdict(e){let r=this._vkey(e),i=this._verdicts[r]??e.live_value,s=e.entity_id?Y(this.hass,e.entity_id):e.label,a=e.entity_id?ur(this.hass,e.entity_id):l`<ha-icon class="row-icon" icon="mdi:code-braces"></ha-icon>`;return l`
      <div class="row">
        ${a}
        <div class="row-text">
    ...
    `],u([p({attribute:!1})],P.prototype,"hass",2),u([p({attribute:!1})],P.prototype,"scope",2),u([p()],P.prototype,"category",2),u([p()],P.prototype,"categoryName",2),u([p({type:Boolean,reflect:!0})],P.prototype,"open",2),u([f()],P.prototype,"_knobs",2),u([f()],P.prototype,"_hasTime",2),u([f()],P.prototype,"_loading",2),u([f()],P.prototype,"_error",2),u([f()],P.prototype,"_values",2),u([f()],P.prototype,"_verdicts",2),u([f()],P.prototype,"_date",2),u([f()],P.prototype,"_time",2),u([f()],P.prototype,"_result",2),u([f()],P.prototype,"_expanded",2),P=u([b("ambience-simulator-modal")],P);function Gt(t){return{rules:t.rules??[]}}var Dr=1024;function wl(t,n,e){if(t!==void 0&&n!==void 0)return Math.floor((t+n)/2);let r=e.map(i=>i.priority??0);return t===void 0&&n===void 0?Dr:t===void 0?Math.max(...r)+Dr:Math.min(...r)-Dr}var T=class extends y{constructor(){super(...arguments);this._areas=[];this._floors=[];this._areaConfigs=new Map;this._floorConfigs=new Map;this._house={rules:[]};this._switchEntityIds=new Map;this._conditions=[];this._actions=[];this._categories=[];this._schemas={};this._expanded=new Set;this._error="";this._editing=null;this._viewingTraces=null;this._viewingSimulator=null;this._filterCategory="";this._filterOpen=!1;this._onExposedActionsChanged=async()=>{try{let e=await nt(this.hass);if(!this.isConnected)return;this._actions=e,await this._refreshSchemas(e)}catch{}}}async _refreshSchemas(e){let r=await Promise.all(e.map(async s=>{try{let a=await me(this.hass,s.id);return[s.id,a]}catch{return[s.id,null]}}));if(!this.isConnected)return;let i={};for(let[s,a]of r)a&&(i[s]=a);this._schemas=i}async connectedCallback(){super.connectedCallback(),window.addEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),await this._loadStatic(),await Promise.all([this._refreshAreas(),this._refreshFloors(),this._refreshHouse(),this._refreshSwitches()]),await this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),this._unsubArea?.(),this._unsubArea=void 0,this._unsubFloor?.(),this._unsubFloor=void 0}async _loadStatic(){try{let[e,r,i,s,a,o]=await Promise.all([Tt(this.hass),nt(this.hass),Lt(this.hass),At(this.hass),Rt(this.hass),Pt(this.hass)]);if(!this.isConnected)return;this._conditions=e,this._actions=r,this._periods=i,this._dayConfig=s,this._weatherConfig=a,this._categories=o,await this._refreshSchemas(r)}catch(e){this._error=e.message||String(e)}}async _refreshAreas(){try{let e=await ni(this.hass),r=this._areaConfigs,i=new Map;if(await Promise.all(e.map(async s=>{let a=r.get(s.area_id);if(a){i.set(s.area_id,a);return}i.set(s.area_id,Gt(await si(this.hass,s.area_id)))})),!this.isConnected)return;this._areas=e,this._areaConfigs=i}catch(e){this._error=e.message||String(e)}}async _refreshFloors(){try{let e=(await oi(this.hass)).slice().sort((s,a)=>s.name.localeCompare(a.name)),r=this._floorConfigs,i=new Map;if(await Promise.all(e.map(async s=>{let a=r.get(s.floor_id);if(a){i.set(s.floor_id,a);return}i.set(s.floor_id,Gt(await li(this.hass,s.floor_id)))})),!this.isConnected)return;this._floors=e,this._floorConfigs=i}catch(e){this._error=e.message||String(e)}}async _refreshHouse(){try{let e=Gt(await ci(this.hass));if(!this.isConnected)return;this._house=e}catch(e){this._error=e.message||String(e)}}async _refreshSwitches(){try{let e=await xi(this.hass);if(!this.isConnected)return;this._switchEntityIds=new Map(e.map(r=>{let i=r.scope_kind==="house"?{kind:"house"}:{kind:r.scope_kind,id:r.scope_id};return[Q(i),r.entity_id]}))}catch(e){this._error=e.message||String(e)}}async _subscribe(){let e=this.hass.connection.subscribeEvents(a=>{if(a.data.action==="remove"){let o=a.data.area_id,c=new Set(this._expanded);c.delete(`area:${o}`),this._expanded=c,this._editing?.scope.kind==="area"&&this._editing.scope.id===o&&(this._editing=null)}this._refreshAreas(),a.data.action!=="update"&&this._refreshSwitches()},"area_registry_updated"),r=this.hass.connection.subscribeEvents(a=>{if(a.data.action==="remove"){let o=a.data.floor_id,c=new Set(this._expanded);c.delete(`floor:${o}`),this._expanded=c,this._editing?.scope.kind==="floor"&&this._editing.scope.id===o&&(this._editing=null)}this._refreshFloors(),a.data.action!=="update"&&this._refreshSwitches()},"floor_registry_updated"),[i,s]=await Promise.all([e,r]);this.isConnected?(this._unsubArea=i,this._unsubFloor=s):(i(),s())}_getConfig(e){return e.kind==="house"?this._house:e.kind==="area"?this._areaConfigs.get(e.id):this._floorConfigs.get(e.id)}_setConfig(e,r){if(e.kind==="house")this._house=r;else if(e.kind==="area"){let i=new Map(this._areaConfigs);i.set(e.id,r),this._areaConfigs=i}else{let i=new Map(this._floorConfigs);i.set(e.id,r),this._floorConfigs=i}}async _mutate(e,r){let i=this._getConfig(e);this._setConfig(e,r),this._error="";try{let s;return e.kind==="house"?s=await ui(this.hass,r):e.kind==="area"?s=await ai(this.hass,e.id,r):s=await di(this.hass,e.id,r),this._setConfig(e,Gt(s.config)),!0}catch(s){return i&&this._setConfig(e,i),this._error=s.message||String(s),!1}}_toggleExpand(e){let r=Q(e),i=new Set(this._expanded);i.has(r)?i.delete(r):i.add(r),this._expanded=i}_addRule(e){let r=this._getConfig(e);r&&(this._editing={scope:e,index:r.rules.length,isNew:!0})}_editRule(e,r){this._editing={scope:e,index:r.detail.index,isNew:!1}}_duplicateRule(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules[r.detail.index];if(!s)return;let a=it(JSON.parse(JSON.stringify(s)));this._editing={scope:e,index:i.rules.length,isNew:!0,seed:a}}_deleteRule(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules.filter((a,o)=>o!==r.detail.index);this._mutate(e,{...i,rules:s})}_reorderRules(e,r){let i=this._getConfig(e);if(!i)return;let{from:s,to:a}=r.detail,o=i.rules[s];if(!o||i.rules[a]?.category!==o.category)return;let c=[...i.rules];c.splice(s,1),c.splice(a,0,o);let h=E=>c[E]&&c[E].category===o.category,m=a-1;for(;m>=0&&!h(m);)m--;let g=a+1;for(;g<c.length&&!h(g);)g++;let _=m>=0?c[m].priority:void 0,$=g<c.length?c[g].priority:void 0,k=wl(_,$,i.rules.filter(E=>E.category===o.category));c[a]={...o,priority:k,pinned:!0},this._mutate(e,{...i,rules:c})}_unpinRule(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules.map((a,o)=>o===r.detail.index?{...a,pinned:!1}:a);this._mutate(e,{...i,rules:s})}_toggleRuleEnabled(e,r){let i=this._getConfig(e);if(!i)return;let s=i.rules.map((a,o)=>{if(o!==r.detail.index)return a;if(r.detail.enabled){let c={...a};return delete c.enabled,c}return{...a,enabled:!1}});this._mutate(e,{...i,rules:s})}async _saveRule(e){let r=this._editing;if(this._editing=null,!r)return;let{rule:i,scope:s}=e.detail;if(Q(s)===Q(r.scope)){let h=this._getConfig(s);if(!h)return;let m=[...h.rules];r.isNew?m.push(i):m[r.index]=i,await this._mutate(s,{...h,rules:m});return}let a=it(i),o=this._getConfig(s);if(!o)return;if(await this._mutate(s,{...o,rules:[...o.rules,a]})&&!r.isNew){let h=this._getConfig(r.scope);if(h){let m=h.rules.filter((g,_)=>_!==r.index);await this._mutate(r.scope,{...h,rules:m})}}}async _callApi(e){this._error="";try{await e()}catch(r){this._error=r.message||String(r)}}_applyRules(e,r){return this._callApi(()=>fi(this.hass,e,r))}_runRuleActions(e,r){return this._callApi(()=>gi(this.hass,e,r.detail.index))}_cancelRule(){this._editing=null}_onScopeMenu(e,r,i,s){s==="run"&&this._applyRules(e)}_showTraces(e,r){let i=this._categories.find(s=>s.id===r);this._viewingTraces={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},category:r,categoryName:i?.name??null}}_showSimulator(e,r){let i=this._categories.find(s=>s.id===r);this._viewingSimulator={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},category:r,categoryName:i?.name??null}}_selectFilter(e){this._filterCategory=e,this._filterOpen=!1}_renderFilterEntry(e){return e===null?l`
  ...
  `,u([p({attribute:!1})],$e.prototype,"hass",2),u([f()],$e.prototype,"_config",2),u([f()],$e.prototype,"_warnings",2),$e=u([b("ambience-day-config")],$e);var Sl=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],ce=class extends y{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),this._config=await Rt(this.hass)}async _persist(){let e=await yi(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[]}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:Sl.map(e=>({value:e,label:Ie(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
      ...
      ></ha-form>`;let i=r.conditions.map(s=>Ie(this.hass,s));return l`<span class="conditions-list">${i.join(", ")}</span>`}_renderGroup(e,r){let i=this._expanded.has(r.id),s=r.conditions.map(a=>Ie(this.hass,a)).join(", ");return l`
      <div class="group">
