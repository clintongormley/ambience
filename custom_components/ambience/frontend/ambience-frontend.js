...
`)}
  ...
  `,c([m({attribute:!1})],N.prototype,"scenes",2),c([m({attribute:!1})],N.prototype,"periods",2),c([m({attribute:!1})],N.prototype,"luxRanges",2),c([m({attribute:!1})],N.prototype,"weatherConfig",2),c([m({attribute:!1})],N.prototype,"hass",2),c([m({attribute:!1})],N.prototype,"conditions",2),c([m({attribute:!1})],N.prototype,"availableActions",2),c([m({attribute:!1})],N.prototype,"schemas",2),c([m({attribute:!1})],N.prototype,"categories",2),c([m({attribute:!1})],N.prototype,"filterCategory",2),c([m({attribute:!1})],N.prototype,"collapsedCategories",2),c([m({attribute:!1})],N.prototype,"scope",2),c([m({attribute:!1})],N.prototype,"live",2),c([m({attribute:!1})],N.prototype,"liveSuppressed",2),c([_()],N.prototype,"_expanded",2),N=c([w("ambience-scenes-list")],N);var de=class extends b{constructor(){super(...arguments);this.entities=[];this.value=[];this.target=null;this.label=" "}_filteredEntities(){return Es(this.entities,this.target)}connectedCallback(){super.connectedCallback(),ie(this)}_emit(e){T(this,e)}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let i=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this._filteredEntities()}}}],n=this.label;return d`
      <ha-form
        .hass=${this.hass}
        .schema=${i}
...
`:""}var wc=bc,xc={dump:wc};function Vr(t,r){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+r+" instead, which is now safe by default.")}}var To=go.load,um=go.loadAll,Qi=xc.dump;var hm=Vr("safeLoad","load"),pm=Vr("safeLoadAll","loadAll"),mm=Vr("safeDump","dump");var ue=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>Ar(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let n=this._currentFields()?.[e.name]?.description;return typeof n=="string"?n:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Qi(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Qi(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Qi(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=To(e)}catch(u){this._yamlError=u.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=a(this.hass,"ui.yaml_expect_object","Expected an object");return}let n=i,s=n.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=a(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=n.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=a(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let l=n.triggers;if(l!==void 0&&(!Array.isArray(l)||!l.every(u=>typeof u=="string"))){this._yamlError=a(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:l})}_emit(e){this.value=e,T(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(n=>`script.${n}`)}_label(e){return z(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},n={};for(let[s,o]of Object.entries(i))o&&Object.hasOwn(o,"default")&&(n[s]=o.default);return n}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,n])=>({name:i,required:n.required,selector:n.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),n=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return d`
  ...
  `,c([m({attribute:!1})],Ie.prototype,"value",2),c([m({attribute:!1})],Ie.prototype,"hass",2),c([_()],Ie.prototype,"_preview",2),Ie=c([w("ambience-template-predicate-input")],Ie);var ne=class extends b{constructor(){super(...arguments);this.value=null;this._onChild=e=>{e.stopPropagation(),this._emit(e.detail.value)}}_emit(e){T(this,e)}_onText(e){let i=e.target.value;this._emit(i.trim()===""?null:i)}render(){return this.condition.input==="time_of_day"?d`
  ...
  `,c([m({attribute:!1})],ne.prototype,"condition",2),c([m({attribute:!1})],ne.prototype,"value",2),c([m({attribute:!1})],ne.prototype,"periods",2),c([m({attribute:!1})],ne.prototype,"luxRanges",2),c([m({attribute:!1})],ne.prototype,"dayConfig",2),c([m({attribute:!1})],ne.prototype,"weatherConfig",2),c([m({attribute:!1})],ne.prototype,"hass",2),ne=c([w("ambience-condition-input")],ne);function Oc(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function Nc(t){return t==="people"?{quant:"everyone",where:"home"}:null}function Wo(t,r){return!!t&&!!r&&L(t)===L(r)}var Ic={state:Fo,day:Do,lux:Ro,unavailable:zo},S=class extends b{constructor(){super(...arguments);this.open=!1;this.scene=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.takenNames=new Map;this.saveError="";this.scopeChangedElsewhere=!1;this._draft=null;this._open=null;this._showError=!1;this._addOrder=[];this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onDescriptionInput=e=>{this._setDescription(e.target.value)};this._onDescriptionHaForm=e=>{e.stopPropagation(),this._setDescription(e.detail.value.description??"")};this._descriptionLabel=()=>a(this.hass,"ui.description","Description");this._onAddCondition=e=>{let i=e.target,n=i.value;i.value="",this._addCondition(n)};this._onAddConditionHaForm=e=>{e.stopPropagation();let i=e.detail.value.add;i!==S._ADD_CONDITION_PLACEHOLDER&&this._addCondition(i)};this._onAddAction=e=>{let i=e.target,n=i.value;i.value="",this._addActionSlot(n)};this._onAddActionHaForm=e=>{e.stopPropagation();let i=e.detail.value.add;i!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(i)};this._onApplyToggle=e=>{if(!this._draft)return;let i={...this._draft};e.target.checked?i.apply="always":delete i.apply,this._draft=i}}_onConditionInvalid(e,i){i?this._conditionError.set(e,i):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),ie(this)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.scene?JSON.parse(JSON.stringify(this.scene)):null,this._scope=this.scope,this._open=null,this._showError=!1,this._addOrder=[],this._conditionError=new Map)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let i=this.scopes[e];if(!i||!this._draft||(this._scope=i.scope,!this.hass))return;let n=new Set(Di(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(o=>n.has(o))}))}}_renderDestination(){return d`
    ...
    `}_save(){if(!this._draft)return;if(this._nameError()!==null){this._showError=!0,this._open={kind:"name"};return}for(let i of Object.keys(this._draft.when))if(this._draft.when[i]!=null&&this._validationError({kind:"condition",id:i})!==null){this._showError=!0,this._open={kind:"condition",id:i};return}for(let i=0;i<this._draft.actions.length;i++)if(this._validationError({kind:"action",idx:i})!==null){this._showError=!0,this._open={kind:"action",idx:i};return}let e=Object.fromEntries(Object.entries(this._draft.when).filter(([,i])=>i!=null));this.dispatchEvent(new CustomEvent("save-scene",{detail:{scene:{...this._draft,when:e},scope:this._scope},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel-scene",{bubbles:!0,composed:!0}))}render(){if(!this._draft)return d``;let e=this._visibleConditions();return d`
      <div class="modal" @click=${this._onModalClick}>
        <div class="content">
          ${this.scopeChangedElsewhere?d`<div class="stale-notice">
                  ${a(this.hass,"ui.history_stale_editor","Scenes here changed in another tab. Saving overwrites them; cancel to discard your edits and load the latest.")}
                </div>`:""}
  ...
  `],S._DESCRIPTION_SCHEMA=[{name:"description",selector:{text:{multiline:!0}}}],S._ADD_CONDITION_PLACEHOLDER="__add_condition__",S._ADD_ACTION_PLACEHOLDER="__add_action__",c([m({type:Boolean,reflect:!0})],S.prototype,"open",2),c([m({attribute:!1})],S.prototype,"scene",2),c([m({attribute:!1})],S.prototype,"conditions",2),c([m({attribute:!1})],S.prototype,"periods",2),c([m({attribute:!1})],S.prototype,"luxRanges",2),c([m({attribute:!1})],S.prototype,"dayConfig",2),c([m({attribute:!1})],S.prototype,"weatherConfig",2),c([m({attribute:!1})],S.prototype,"availableActions",2),c([m({attribute:!1})],S.prototype,"categories",2),c([m({attribute:!1})],S.prototype,"schemas",2),c([m({attribute:!1})],S.prototype,"hass",2),c([m({attribute:!1})],S.prototype,"scope",2),c([m({attribute:!1})],S.prototype,"scopes",2),c([m({attribute:!1})],S.prototype,"takenNames",2),c([m({attribute:!1})],S.prototype,"saveError",2),c([m({attribute:!1})],S.prototype,"scopeChangedElsewhere",2),c([_()],S.prototype,"_draft",2),c([_()],S.prototype,"_scope",2),c([_()],S.prototype,"_open",2),c([_()],S.prototype,"_showError",2),c([_()],S.prototype,"_addOrder",2),c([_()],S.prototype,"_serviceHasTarget",2),S=c([w("ambience-scene-editor")],S);function Fc(t,r,e,i){return r==="time_of_day"?Se(t,e,i):r==="weather"?ht(t,e):e}var ir=y`
...
`;function Bo(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function Zr(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Bo(n,r))};return d`<span
  ...
  `,c([m({attribute:!1})],K.prototype,"hass",2),c([m({attribute:!1})],K.prototype,"scope",2),c([m()],K.prototype,"category",2),c([m()],K.prototype,"categoryName",2),c([m({attribute:!1})],K.prototype,"scenes",2),c([m({type:Boolean,reflect:!0})],K.prototype,"open",2),c([_()],K.prototype,"_triggers",2),c([_()],K.prototype,"_opaque",2),c([_()],K.prototype,"_loading",2),c([_()],K.prototype,"_error",2),K=c([w("ambience-auto-triggers-modal")],K);function Jo(t,r){return r==="not_home"?a(t,"ui.away","Away"):r==="home"?a(t,"ui.home","Home"):j(r)}function Xo(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(r=>[r.name,r.live_value==null?"":String(r.live_value)])),for:{h:0,m:0,s:0}}}function sr(t){return String(t).padStart(2,"0")}function Zo(t){return`${t.getFullYear()}-${sr(t.getMonth()+1)}-${sr(t.getDate())}`}function ea(t){return`${sr(t.getHours())}:${sr(t.getMinutes())}`}var H=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1;new Fe(this,()=>this._onClose())}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=Zo(e),this._time=ea(e);try{let i=await _s(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=i.knobs,this._hasTime=i.has_time;let n={},s={};for(let o of i.knobs)o.kind==="entity"?n[o.entity_id]=Xo(o):s[this._vkey(o)]=o.live_value;this._values=n,this._verdicts=s,this._loading=!1}catch(i){this._error=C(this.hass,i),this._loading=!1}}_setState(e,i){this._values={...this._values,[e]:{...this._values[e],state:i}}}_setAttr(e,i,n){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[i]:n}}}}_setFor(e,i,n){let s=this._values[e],o=Number.isFinite(n)&&n>0?Math.trunc(n):0;this._values={...this._values,[e]:{...s,for:{...s.for,[i]:o}}}}_setVerdict(e,i){this._verdicts={...this._verdicts,[e]:i}}_resetWhen(){let e=new Date;this._date=Zo(e),this._time=ea(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:Xo(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let i of this._knobs){if(i.kind!=="entity")continue;let n=this._values[i.entity_id];if(!n)continue;let s={};for(let l of i.attributes){let u=n.attributes[l.name];if(!(u===void 0||u===""))if(l.control==="number"){let h=Number(u);Number.isNaN(h)||(s[l.name]=h)}else s[l.name]=u}let o={attributes:s};n.state!==""&&(o.state=n.state),(n.for.h||n.for.m||n.for.s)&&(o.for=n.for),(o.state!==void 0||o.for!==void 0||Object.keys(s).length>0)&&(e[i.entity_id]=o)}return e}_buildVerdicts(){let e={};for(let i of this._knobs)i.kind==="verdict"&&(e[i.condition]||(e[i.condition]={}),e[i.condition][i.key]=this._verdicts[this._vkey(i)]??i.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`);if(!this._date||!this._time||Number.isNaN(e.getTime())){this._error=a(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}let i=e.toISOString();try{this._result=await gs(this.hass,this.scope,this.category,i,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(n){this._error=C(this.hass,n)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?d`
    ...
    `}_historyCaption(){return this._store.canUndo?a(this.hass,"ui.history_undo_tooltip","Undo: {change}",{change:this._historyLabel(this._store.undoAction)}):this._store.canRedo?a(this.hass,"ui.history_redo_tooltip","Redo: {change}",{change:this._historyLabel(this._store.redoAction)}):""}_editingScopeIsStale(){let e=this._editing;return e!==null&&this._store.staleScopes.some(i=>L(i)===L(e.scope))}render(){let e=this._historyCaption();return d`
      ...
      ${this._renderBanners()}
      <ul>
        ${$s(this._orderedScopeRows(),i=>L(i.scope),i=>this._renderScopeRow(i.scope,i.name,i.cfg,i.rowClass))}
      ...
      ></ambience-simulator-modal>
    `}_renderScopeRow(e,i,n,s){let o=this._expanded.has(L(e)),l=e.kind==="house"?"":e.id,u=this._isSwitchedOff(e)?"off":this._matchingSceneCount(n)===0?"empty":"",h=n.enabled===!1;return d`
