...
`;function ut(t,r){return d`<span class="category-swatch" style=${Ei(t)}>
    ...
    `],u([m({attribute:!1})],ae.prototype,"hass",2),u([g()],ae.prototype,"_categories",2),u([g()],ae.prototype,"_filterCategory",2),u([g()],ae.prototype,"_open",2),u([g()],ae.prototype,"_loaded",2),ae=u([w("ambience-category-filter")],ae);var ye={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Si=t=>(...r)=>({_$litDirective$:t,values:r}),ht=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,i){this._$Ct=r,this._$AM=e,this._$Ci=i}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var{I:ko}=gn,hs=t=>t;var ms=t=>t.strings===void 0,ps=()=>document.createComment(""),pt=(t,r,e)=>{let i=t._$AA.parentNode,n=r===void 0?t._$AB:r._$AA;if(e===void 0){let s=i.insertBefore(ps(),n),a=i.insertBefore(ps(),n);e=new ko(s,a,t,t.options)}else{let s=e._$AB.nextSibling,a=e._$AM,l=a!==t;if(l){let c;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(c=t._$AU)!==a._$AU&&e._$AP(c)}if(s!==n||l){let c=e._$AA;for(;c!==s;){let h=hs(c).nextSibling;hs(i).insertBefore(c,n),c=h}}}return e},Se=(t,r,e=t)=>(t._$AI(r,e),t),Eo={},Ti=(t,r=Eo)=>t._$AH=r,fs=t=>t._$AH,Li=t=>{t._$AR(),t._$AA.remove()};var gs=(t,r,e)=>{let i=new Map;for(let n=r;n<=e;n++)i.set(t[n],n);return i},_s=Si(class extends ht{constructor(t){if(super(t),t.type!==ye.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,r,e){let i;e===void 0?e=r:r!==void 0&&(i=r);let n=[],s=[],a=0;for(let l of t)n[a]=i?i(l,a):a,s[a]=e(l,a),a++;return{values:s,keys:n}}render(t,r,e){return this.dt(t,r,e).values}update(t,[r,e,i]){let n=fs(t),{values:s,keys:a}=this.dt(r,e,i);if(!Array.isArray(n))return this.ut=a,s;let l=this.ut??=[],c=[],h,p,f=0,_=n.length-1,v=0,x=s.length-1;for(;f<=_&&v<=x;)if(n[f]===null)f++;else if(n[_]===null)_--;else if(l[f]===a[v])c[v]=Se(n[f],s[v]),f++,v++;else if(l[_]===a[x])c[x]=Se(n[_],s[x]),_--,x--;else if(l[f]===a[x])c[x]=Se(n[f],s[x]),pt(t,c[x+1],n[f]),f++,x--;else if(l[_]===a[v])c[v]=Se(n[_],s[v]),pt(t,n[f],n[_]),_--,v++;else if(h===void 0&&(h=gs(a,v,x),p=gs(l,f,_)),h.has(l[f]))if(h.has(l[_])){let E=p.get(a[v]),A=E!==void 0?n[E]:null;if(A===null){let Y=pt(t,n[f]);Se(Y,s[v]),c[v]=Y}else c[v]=Se(A,s[v]),pt(t,n[f],A),n[E]=null;v++}else Li(n[_]),_--;else Li(n[f]),f++;for(;v<=x;){let E=pt(t,c[x+1]);Se(E,s[v]),c[v++]=E}for(;f<=_;){let E=n[f++];E!==null&&Li(E)}return this.ut=a,Ti(t,c),Q}});function O(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function vs(t,r){return`${O(t)}\0${r}`}function It(t,r){return vs(t,r)}function Ai(t,r){return vs(t,r)}function ys(t,r){if(!r||r.entity==null)return[...t];let e=Array.isArray(r.entity)?r.entity:[r.entity];if(e.length===0)return[...t];let i=new Set,n=!1;for(let s of e){if(!s||typeof s!="object")continue;let a=s.domain;if(a==null){n=!0;continue}if(Array.isArray(a))for(let l of a)typeof l=="string"&&i.add(l);else typeof a=="string"&&i.add(a)}return n||i.size===0?[...t]:t.filter(s=>{let a=s.indexOf(".");return a<0?!1:i.has(s.slice(0,a))})}function Pi(t,r,e=[]){let i=t;if(!i?.entities)return[];let n=i.entities,s=i.devices??{},a=i.areas??{},l=r.kind==="area"?new Set([r.id]):r.kind==="floor"?new Set(Object.values(a).filter(h=>h.floor_id===r.id).map(h=>h.area_id)):null,c=h=>{let p=h.area_id??(h.device_id?s[h.device_id]?.area_id??null:null);return p==null?!1:l===null?!0:l.has(p)};return Object.values(n).filter(c).filter(h=>h.platform!=="ambience").filter(h=>e.length===0||e.includes(h.entity_id.split(".")[0])).map(h=>h.entity_id).sort()}var $r=Si(class extends ht{constructor(t){if(super(t),t.type!==ye.PROPERTY&&t.type!==ye.ATTRIBUTE&&t.type!==ye.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ms(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[r]){if(r===Q||r===$)return r;let e=t.element,i=t.name;if(t.type===ye.PROPERTY){if(r===e[i])return Q}else if(t.type===ye.BOOLEAN_ATTRIBUTE){if(!!r===e.hasAttribute(i))return Q}else if(t.type===ye.ATTRIBUTE&&e.getAttribute(i)===r+"")return Q;return Ti(t),r}});function mt(t){let{checked:r,dataTest:e,onChange:i,className:n,onClick:s,disabled:a}=t;return customElements.get("ha-switch")?d`<ha-switch
      class=${n??$}
      data-test=${e}
      ?disabled=${a??!1}
      .checked=${$r(r)}
    ...
    @click=${s}
    @change=${i}
  />`}function Ft(t){let{priority:r,pinned:e,shadowed_by:i,...n}=t;return n}function bs(t,r){if(r<0||r>=t.length)return[];let e=new Set(t[r].entity_ids??[]),i=new Set;return t.forEach((n,s)=>{if(s!==r)for(let a of n.entity_ids??[])e.has(a)||i.add(a)}),[...i]}var kr={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Mt(t,r){return t.kind==="house"?kr.house:t.kind==="floor"?r?.floors?.[t.id]?.icon||kr.floor:r?.areas?.[t.id]?.icon||kr.area}function Ri(t){if(t.enabled===!1)return{severity:null,missing:[],overlap:[],shadowed:!1,configIssues:[]};let r=t.missing_entities??[],e=t.overlap_entities??[],i=t.config_issues??[],n=t.shadowed_by!=null;return{severity:r.length>0||i.length>0?"error":e.length>0||n?"warning":null,missing:r,overlap:e,shadowed:n,configIssues:i}}function ws(t){let r=null;for(let e of t){let i=Ri(e).severity;if(i==="error")return"error";i==="warning"&&(r="warning")}return r}function xs(t){return t.filter(r=>Ri(r).severity!=null).length}var Co={missing_workday_sensor:["ui.badge_needs_workday_sensor","needs a workday sensor"],missing_workday_calendar:["ui.badge_needs_workday_calendar","needs a workday calendar"],missing_weather_entity:["ui.badge_needs_weather_entity","needs a weather entity"],missing_weather_group:["ui.badge_missing_weather_group","missing weather group {id}"],missing_period:["ui.badge_missing_period","missing period {id}"],missing_lux_range:["ui.badge_missing_lux_range","missing lux range {id}"],unexposed_action:["ui.badge_unexposed_action","action {id} not exposed"]};function $s(t,r){let e=Co[r.kind];return(e?o(t,e[0],e[1]):r.kind).replace("{id}",r.ref)}var ft=null;function Di(t,r){let e=ws(r);if(!e)return"";let i=xs(r),n=o(t,"ui.problems_count","{n} scene(s) have problems").replace("{n}",String(i));return d`<ambience-problem-flag
    .severity=${e}
    .details=${[n]}
    .summary=${n}
  ...
  `,u([m({attribute:!1})],le.prototype,"items",2),u([m({attribute:!1})],le.prototype,"hass",2),u([m()],le.prototype,"label",2),u([m({type:Boolean,reflect:!0})],le.prototype,"muted",2),u([g()],le.prototype,"_open",2),le=u([w("ambience-kebab-menu")],le);function So(t){return t.style.pointerEvents="none",t.style.willChange="transform",()=>{t.style.pointerEvents="",t.style.willChange="",t.style.transform=""}}function Hi(t,r,e={}){let i=t.pointerId;try{t.target?.setPointerCapture?.(i)}catch{}let n=e.follow??null,s=t.clientX,a=t.clientY,l=n?So(n):null,c=_=>{_.pointerId===i&&(r.onMove(_.clientX,_.clientY),n&&(n.style.transform=`translate(${_.clientX-s}px, ${_.clientY-a}px)`))},h=_=>{_.pointerId===i&&(f(),r.onEnd(_.clientX,_.clientY))},p=_=>{_.pointerId===i&&(f(),r.onCancel())},f=()=>{window.removeEventListener("pointermove",c,!0),window.removeEventListener("pointerup",h,!0),window.removeEventListener("pointercancel",p,!0),l?.()};return window.addEventListener("pointermove",c,!0),window.addEventListener("pointerup",h,!0),window.addEventListener("pointercancel",p,!0),f}function Oi(t,r){let e=document.elementFromPoint?.(t,r)??null;if(!e)return null;for(;e.shadowRoot;){let i=e.shadowRoot.elementFromPoint?.(t,r);if(!i||i===e)break;e=i}return e}var gt=class{constructor(r,e,i={}){this.host=r;this.onReorder=e;this.from=null;this.over=null;this.moved=!1;this._cancelDrag=null;this._locate=i.locate??((n,s)=>this._domLocate(n,s)),r.addController(this)}hostDisconnected(){this._reset()}start(r,e){if(!e.isPrimary||e.button>0)return;this._reset(),this.from=r,this.moved=!1,this.host.requestUpdate();let i=e.target?.closest("[data-drag-index]");this._cancelDrag=Hi(e,{onMove:(n,s)=>this._hover(this._locate(n,s)),onEnd:(n,s)=>this.drop(this._locate(n,s)),onCancel:()=>this.end()},{follow:i})}_hover(r){if(this.from===null)return;let e=r===null||r===this.from?null:r;e!==null&&(this.moved=!0),this.over!==e&&(this.over=e,this.host.requestUpdate())}drop(r){let e=this.from;this._reset(),!(e===null||r===null||e===r)&&this.onReorder(e,r)}end(){this._reset()}_domLocate(r,e){let i=this.host.renderRoot,s=(i?.elementFromPoint?i.elementFromPoint(r,e):Oi(r,e))?.closest?.("[data-drag-index]");if(!s)return null;let a=Number(s.getAttribute("data-drag-index"));return Number.isNaN(a)?null:a}_reset(){this._cancelDrag?.(),this._cancelDrag=null;let r=this.from!==null||this.over!==null;this.from=null,this.over=null,r&&this.host.requestUpdate()}};var To={light:"mdi:lightbulb",switch:"mdi:toggle-switch-variant",binary_sensor:"mdi:motion-sensor",sensor:"mdi:eye",person:"mdi:account",device_tracker:"mdi:account",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:cast",lock:"mdi:lock",fan:"mdi:fan",weather:"mdi:weather-partly-cloudy",input_boolean:"mdi:toggle-switch",event:"mdi:eye-check",script:"mdi:script-text",template:"mdi:code-braces"},Er="mdi:eye";function j(t,r){let e=t?.states?.[r]?.attributes?.friendly_name;return typeof e=="string"&&e?e:r}function Lo(t,r){let e=t?.states?.[r]?.attributes?.icon;if(typeof e=="string"&&e)return e;let i=r.split(".")[0];return To[i]??Er}function jt(t,r){let e=t?.states?.[r];return e&&customElements.get("ha-state-icon")?d`<ha-state-icon class="row-icon" .hass=${t} .stateObj=${e}></ha-state-icon>`:d`<ha-icon class="row-icon" icon=${Lo(t,r)}></ha-icon>`}var ks=y`
  .row-icon {
    flex: 0 0 auto;
    color: var(--secondary-text-color, #888);
    --mdc-icon-size: 22px;
...
`)}
  ...
  `,u([m({attribute:!1})],z.prototype,"scenes",2),u([m({attribute:!1})],z.prototype,"periods",2),u([m({attribute:!1})],z.prototype,"luxRanges",2),u([m({attribute:!1})],z.prototype,"weatherConfig",2),u([m({attribute:!1})],z.prototype,"hass",2),u([m({attribute:!1})],z.prototype,"conditions",2),u([m({attribute:!1})],z.prototype,"availableActions",2),u([m({attribute:!1})],z.prototype,"schemas",2),u([m({attribute:!1})],z.prototype,"categories",2),u([m({attribute:!1})],z.prototype,"filterCategory",2),u([m({attribute:!1})],z.prototype,"collapsedCategories",2),u([g()],z.prototype,"_expanded",2),z=u([w("ambience-scenes-list")],z);var de=class extends b{constructor(){super(...arguments);this.entities=[];this.value=[];this.target=null;this.label=" "}_filteredEntities(){return ys(this.entities,this.target)}connectedCallback(){super.connectedCallback(),ie(this)}_emit(e){T(this,e)}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let i=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this._filteredEntities()}}}],n=this.label;return d`
      <ha-form
        .hass=${this.hass}
        .schema=${i}
  ...
  `,u([m({attribute:!1})],U.prototype,"hass",2),u([m({attribute:!1})],U.prototype,"scope",2),u([m({attribute:!1})],U.prototype,"exposed",2),u([m({attribute:!1})],U.prototype,"service",2),u([m({attribute:!1})],U.prototype,"entityIds",2),u([m({attribute:!1})],U.prototype,"params",2),u([m({attribute:!1})],U.prototype,"excludeEntities",2),u([g()],U.prototype,"_schema",2),u([g()],U.prototype,"_schemaError",2),u([g()],U.prototype,"_exposedMissing",2),u([g()],U.prototype,"_formSchema",2),u([g()],U.prototype,"_perFieldSchemas",2),U=u([w("ambience-action-slot")],U);var Ae=class extends b{constructor(){super(...arguments);this.text="";this._open=!1;this._onDocClick=e=>{e.composedPath().includes(this)||this._close()};this._onKeydown=e=>{e.key==="Escape"&&this._close()}}_toggle(e){e.stopPropagation(),this._open?this._close():this._openPopover()}_openPopover(){this._open=!0,document.addEventListener("click",this._onDocClick,!0),document.addEventListener("keydown",this._onKeydown)}_close(){this._open&&(this._open=!1,document.removeEventListener("click",this._onDocClick,!0),document.removeEventListener("keydown",this._onKeydown),this.renderRoot.querySelector(".trigger")?.focus())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick,!0),document.removeEventListener("keydown",this._onKeydown)}render(){return d`
      <button
        class="trigger"
...
`,c):t.result+=N.repeat(`
`,s?1+c:c),s=!0,a=!0,c=0,e=t.position;!ce(f)&&f!==0;)f=t.input.charCodeAt(++t.position);Pe(t,e,t.position,!1)}return!0}function zs(t,r){var e,i=t.tag,n=t.anchor,s=[],a,l=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),!(c!==45||(a=t.input.charCodeAt(t.position+1),!ee(a))));){if(l=!0,t.position++,H(t,!0,-1)&&t.lineIndent<=r){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,xt(t,r,ia,!1,!0),s.push(t.result),H(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>r)&&c!==0)k(t,"bad indentation of a sequence entry");else if(t.lineIndent<r)break}return l?(t.tag=i,t.anchor=n,t.kind="sequence",t.result=s,!0):!1}function Cd(t,r,e){var i,n,s,a,l,c,h=t.tag,p=t.anchor,f={},_=Object.create(null),v=null,x=null,E=null,A=!1,Y=!1,L;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=f),L=t.input.charCodeAt(t.position);L!==0;){if(!A&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,k(t,"tab characters must not be used in indentation")),i=t.input.charCodeAt(t.position+1),s=t.line,(L===63||L===58)&&ee(i))L===63?(A&&(wt(t,f,_,v,x,null,a,l,c),v=x=E=null),Y=!0,A=!0,n=!0):A?(A=!1,n=!0):k(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,L=i;else{if(a=t.line,l=t.lineStart,c=t.position,!xt(t,e,ta,!1,!0))break;if(t.line===s){for(L=t.input.charCodeAt(t.position);Qe(L);)L=t.input.charCodeAt(++t.position);if(L===58)L=t.input.charCodeAt(++t.position),ee(L)||k(t,"a whitespace character is expected after the key-value separator within a block mapping"),A&&(wt(t,f,_,v,x,null,a,l,c),v=x=E=null),Y=!0,A=!1,n=!1,v=t.tag,x=t.result;else if(Y)k(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(Y)k(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>r)&&(A&&(a=t.line,l=t.lineStart,c=t.position),xt(t,r,Wi,!0,n)&&(A?x=t.result:E=t.result),A||(wt(t,f,_,v,x,E,a,l,c),v=x=E=null),H(t,!0,-1),L=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>r)&&L!==0)k(t,"bad indentation of a mapping entry");else if(t.lineIndent<r)break}return A&&wt(t,f,_,v,x,null,a,l,c),Y&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=f),Y}function Sd(t){var r,e=!1,i=!1,n,s,a;if(a=t.input.charCodeAt(t.position),a!==33)return!1;if(t.tag!==null&&k(t,"duplication of a tag property"),a=t.input.charCodeAt(++t.position),a===60?(e=!0,a=t.input.charCodeAt(++t.position)):a===33?(i=!0,n="!!",a=t.input.charCodeAt(++t.position)):n="!",r=t.position,e){do a=t.input.charCodeAt(++t.position);while(a!==0&&a!==62);t.position<t.length?(s=t.input.slice(r,t.position),a=t.input.charCodeAt(++t.position)):k(t,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!ee(a);)a===33&&(i?k(t,"tag suffix cannot contain exclamation marks"):(n=t.input.slice(r-1,t.position+1),ra.test(n)||k(t,"named tag handle cannot contain such characters"),i=!0,r=t.position+1)),a=t.input.charCodeAt(++t.position);s=t.input.slice(r,t.position),fd.test(s)&&k(t,"tag suffix cannot contain flow indicator characters")}s&&!na.test(s)&&k(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{k(t,"tag name is malformed: "+s)}return e?t.tag=s:Re.call(t.tagMap,n)?t.tag=t.tagMap[n]+s:n==="!"?t.tag="!"+s:n==="!!"?t.tag="tag:yaml.org,2002:"+s:k(t,'undeclared tag handle "'+n+'"'),!0}function Td(t){var r,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&k(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),r=t.position;e!==0&&!ee(e)&&!bt(e);)e=t.input.charCodeAt(++t.position);return t.position===r&&k(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(r,t.position),!0}function Ld(t){var r,e,i;if(i=t.input.charCodeAt(t.position),i!==42)return!1;for(i=t.input.charCodeAt(++t.position),r=t.position;i!==0&&!ee(i)&&!bt(i);)i=t.input.charCodeAt(++t.position);return t.position===r&&k(t,"name of an alias node must contain at least one character"),e=t.input.slice(r,t.position),Re.call(t.anchorMap,e)||k(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],H(t,!0,-1),!0}function xt(t,r,e,i,n){var s,a,l,c=1,h=!1,p=!1,f,_,v,x,E,A;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=a=l=Wi===e||ia===e,i&&H(t,!0,-1)&&(h=!0,t.lineIndent>r?c=1:t.lineIndent===r?c=0:t.lineIndent<r&&(c=-1)),c===1)for(;Sd(t)||Td(t);)H(t,!0,-1)?(h=!0,l=s,t.lineIndent>r?c=1:t.lineIndent===r?c=0:t.lineIndent<r&&(c=-1)):l=!1;if(l&&(l=h||n),(c===1||Wi===e)&&(Ui===e||ta===e?E=r:E=r+1,A=t.position-t.lineStart,c===1?l&&(zs(t,A)||Cd(t,A,E))||kd(t,E)?p=!0:(a&&Ed(t,E)||xd(t,E)||$d(t,E)?p=!0:Ld(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&k(t,"alias node should not have any properties")):wd(t,E,Ui===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=l&&zs(t,A))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&k(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),f=0,_=t.implicitTypes.length;f<_;f+=1)if(x=t.implicitTypes[f],x.resolve(t.result)){t.result=x.construct(t.result),t.tag=x.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(Re.call(t.typeMap[t.kind||"fallback"],t.tag))x=t.typeMap[t.kind||"fallback"][t.tag];else for(x=null,v=t.typeMap.multi[t.kind||"fallback"],f=0,_=v.length;f<_;f+=1)if(t.tag.slice(0,v[f].tag.length)===v[f].tag){x=v[f];break}x||k(t,"unknown tag !<"+t.tag+">"),t.result!==null&&x.kind!==t.kind&&k(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+x.kind+'", not "'+t.kind+'"'),x.resolve(t.result,t.tag)?(t.result=x.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):k(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function Ad(t){var r=t.position,e,i,n,s=!1,a;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(a=t.input.charCodeAt(t.position))!==0&&(H(t,!0,-1),a=t.input.charCodeAt(t.position),!(t.lineIndent>0||a!==37));){for(s=!0,a=t.input.charCodeAt(++t.position),e=t.position;a!==0&&!ee(a);)a=t.input.charCodeAt(++t.position);for(i=t.input.slice(e,t.position),n=[],i.length<1&&k(t,"directive name must not be less than one character in length");a!==0;){for(;Qe(a);)a=t.input.charCodeAt(++t.position);if(a===35){do a=t.input.charCodeAt(++t.position);while(a!==0&&!ce(a));break}if(ce(a))break;for(e=t.position;a!==0&&!ee(a);)a=t.input.charCodeAt(++t.position);n.push(t.input.slice(e,t.position))}a!==0&&zr(t),Re.call(Ms,i)?Ms[i](t,i,n):Bi(t,'unknown document directive "'+i+'"')}if(H(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,H(t,!0,-1)):s&&k(t,"directives end mark is expected"),xt(t,t.lineIndent-1,Wi,!1,!0),H(t,!0,-1),t.checkLineBreaks&&md.test(t.input.slice(r,t.position))&&Bi(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&Ki(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,H(t,!0,-1));return}if(t.position<t.length-1)k(t,"end of the stream or a document separator is expected");else return}function da(t,r){t=String(t),r=r||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new bd(t,r),i=t.indexOf("\0");for(i!==-1&&(e.position=i,k(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)Ad(e);return e.documents}function Pd(t,r,e){r!==null&&typeof r=="object"&&typeof e>"u"&&(e=r,r=null);var i=da(t,e);if(typeof r!="function")return i;for(var n=0,s=i.length;n<s;n+=1)r(i[n])}function Rd(t,r){var e=da(t,r);if(e.length!==0){if(e.length===1)return e[0];throw new Z("expected a single document in the stream, but found more")}}var Dd=Pd,Hd=Rd,ca={loadAll:Dd,load:Hd},ua=Object.prototype.toString,ha=Object.prototype.hasOwnProperty,Wr=65279,Od=9,Gt=10,Nd=13,Id=32,Fd=33,Md=34,Nr=35,jd=37,zd=38,Ud=39,Wd=42,pa=44,Bd=45,qi=58,qd=61,Vd=62,Kd=63,Gd=64,ma=91,fa=93,Yd=96,ga=123,Qd=124,_a=125,q={};q[0]="\\0";q[7]="\\a";q[8]="\\b";q[9]="\\t";q[10]="\\n";q[11]="\\v";q[12]="\\f";q[13]="\\r";q[27]="\\e";q[34]='\\"';q[92]="\\\\";q[133]="\\N";q[160]="\\_";q[8232]="\\L";q[8233]="\\P";var Jd=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],Xd=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function Zd(t,r){var e,i,n,s,a,l,c;if(r===null)return{};for(e={},i=Object.keys(r),n=0,s=i.length;n<s;n+=1)a=i[n],l=String(r[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),c=t.compiledTypeMap.fallback[a],c&&ha.call(c.styleAliases,l)&&(l=c.styleAliases[l]),e[a]=l;return e}function ec(t){var r,e,i;if(r=t.toString(16).toUpperCase(),t<=255)e="x",i=2;else if(t<=65535)e="u",i=4;else if(t<=4294967295)e="U",i=8;else throw new Z("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+N.repeat("0",i-r.length)+r}var tc=1,Yt=2;function ic(t){this.schema=t.schema||ea,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=N.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=Zd(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?Yt:tc,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Us(t,r){for(var e=N.repeat(" ",r),i=0,n=-1,s="",a,l=t.length;i<l;)n=t.indexOf(`
`,i),n===-1?(a=t.slice(i),i=l):(a=t.slice(i,n+1),i=n+1),a.length&&a!==`
`&&(s+=e),s+=a;return s}function Ir(t,r){return`
`+N.repeat(" ",t.indent*r)}function rc(t,r){var e,i,n;for(e=0,i=t.implicitTypes.length;e<i;e+=1)if(n=t.implicitTypes[e],n.resolve(r))return!0;return!1}function Vi(t){return t===Id||t===Od}function Qt(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==Wr||65536<=t&&t<=1114111}function Ws(t){return Qt(t)&&t!==Wr&&t!==Nd&&t!==Gt}function Bs(t,r,e){var i=Ws(t),n=i&&!Vi(t);return(e?i:i&&t!==pa&&t!==ma&&t!==fa&&t!==ga&&t!==_a)&&t!==Nr&&!(r===qi&&!n)||Ws(r)&&!Vi(r)&&t===Nr||r===qi&&n}function nc(t){return Qt(t)&&t!==Wr&&!Vi(t)&&t!==Bd&&t!==Kd&&t!==qi&&t!==pa&&t!==ma&&t!==fa&&t!==ga&&t!==_a&&t!==Nr&&t!==zd&&t!==Wd&&t!==Fd&&t!==Qd&&t!==qd&&t!==Vd&&t!==Ud&&t!==Md&&t!==jd&&t!==Gd&&t!==Yd}function sc(t){return!Vi(t)&&t!==qi}function Vt(t,r){var e=t.charCodeAt(r),i;return e>=55296&&e<=56319&&r+1<t.length&&(i=t.charCodeAt(r+1),i>=56320&&i<=57343)?(e-55296)*1024+i-56320+65536:e}function va(t){var r=/^\n* /;return r.test(t)}var ya=1,Fr=2,ba=3,wa=4,yt=5;function ac(t,r,e,i,n,s,a,l){var c,h=0,p=null,f=!1,_=!1,v=i!==-1,x=-1,E=nc(Vt(t,0))&&sc(Vt(t,t.length-1));if(r||a)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Vt(t,c),!Qt(h))return yt;E=E&&Bs(h,p,l),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Vt(t,c),h===Gt)f=!0,v&&(_=_||c-x-1>i&&t[x+1]!==" ",x=c);else if(!Qt(h))return yt;E=E&&Bs(h,p,l),p=h}_=_||v&&c-x-1>i&&t[x+1]!==" "}return!f&&!_?E&&!a&&!n(t)?ya:s===Yt?yt:Fr:e>9&&va(t)?yt:a?s===Yt?yt:Fr:_?wa:ba}function oc(t,r,e,i,n){t.dump=(function(){if(r.length===0)return t.quotingType===Yt?'""':"''";if(!t.noCompatMode&&(Jd.indexOf(r)!==-1||Xd.test(r)))return t.quotingType===Yt?'"'+r+'"':"'"+r+"'";var s=t.indent*Math.max(1,e),a=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),l=i||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return rc(t,h)}switch(ac(r,l,t.indent,a,c,t.quotingType,t.forceQuotes&&!i,n)){case ya:return r;case Fr:return"'"+r.replace(/'/g,"''")+"'";case ba:return"|"+qs(r,t.indent)+Vs(Us(r,s));case wa:return">"+qs(r,t.indent)+Vs(Us(lc(r,a),s));case yt:return'"'+dc(r)+'"';default:throw new Z("impossible error: invalid scalar style")}})()}function qs(t,r){var e=va(t)?String(r):"",i=t[t.length-1]===`
`,n=i&&(t[t.length-2]===`
`||t===`
`),s=n?"+":i?"":"-";return e+s+`
`}function Vs(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function lc(t,r){for(var e=/(\n+)([^\n]*)/g,i=(function(){var h=t.indexOf(`
`);return h=h!==-1?h:t.length,e.lastIndex=h,Ks(t.slice(0,h),r)})(),n=t[0]===`
`||t[0]===" ",s,a;a=e.exec(t);){var l=a[1],c=a[2];s=c[0]===" ",i+=l+(!n&&!s&&c!==""?`
`:"")+Ks(c,r),n=s}return i}function Ks(t,r){if(t===""||t[0]===" ")return t;for(var e=/ [^ ]/g,i,n=0,s,a=0,l=0,c="";i=e.exec(t);)l=i.index,l-n>r&&(s=a>n?a:l,c+=`
`+t.slice(n,s),n=s+1),a=l;return c+=`
`,t.length-n>r&&a>n?c+=t.slice(n,a)+`
`+t.slice(a+1):c+=t.slice(n),c.slice(1)}function dc(t){for(var r="",e=0,i,n=0;n<t.length;e>=65536?n+=2:n++)e=Vt(t,n),i=q[e],!i&&Qt(e)?(r+=t[n],e>=65536&&(r+=t[n+1])):r+=i||ec(e);return r}function cc(t,r,e){var i="",n=t.tag,s,a,l;for(s=0,a=e.length;s<a;s+=1)l=e[s],t.replacer&&(l=t.replacer.call(e,String(s),l)),(we(t,r,l,!1,!1)||typeof l>"u"&&we(t,r,null,!1,!1))&&(i!==""&&(i+=","+(t.condenseFlow?"":" ")),i+=t.dump);t.tag=n,t.dump="["+i+"]"}function Gs(t,r,e,i){var n="",s=t.tag,a,l,c;for(a=0,l=e.length;a<l;a+=1)c=e[a],t.replacer&&(c=t.replacer.call(e,String(a),c)),(we(t,r+1,c,!0,!0,!1,!0)||typeof c>"u"&&we(t,r+1,null,!0,!0,!1,!0))&&((!i||n!=="")&&(n+=Ir(t,r)),t.dump&&Gt===t.dump.charCodeAt(0)?n+="-":n+="- ",n+=t.dump);t.tag=s,t.dump=n||"[]"}function uc(t,r,e){var i="",n=t.tag,s=Object.keys(e),a,l,c,h,p;for(a=0,l=s.length;a<l;a+=1)p="",i!==""&&(p+=", "),t.condenseFlow&&(p+='"'),c=s[a],h=e[c],t.replacer&&(h=t.replacer.call(e,c,h)),we(t,r,c,!1,!1)&&(t.dump.length>1024&&(p+="? "),p+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),we(t,r,h,!1,!1)&&(p+=t.dump,i+=p));t.tag=n,t.dump="{"+i+"}"}function hc(t,r,e,i){var n="",s=t.tag,a=Object.keys(e),l,c,h,p,f,_;if(t.sortKeys===!0)a.sort();else if(typeof t.sortKeys=="function")a.sort(t.sortKeys);else if(t.sortKeys)throw new Z("sortKeys must be a boolean or a function");for(l=0,c=a.length;l<c;l+=1)_="",(!i||n!=="")&&(_+=Ir(t,r)),h=a[l],p=e[h],t.replacer&&(p=t.replacer.call(e,h,p)),we(t,r+1,h,!0,!0,!0)&&(f=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,f&&(t.dump&&Gt===t.dump.charCodeAt(0)?_+="?":_+="? "),_+=t.dump,f&&(_+=Ir(t,r)),we(t,r+1,p,!0,f)&&(t.dump&&Gt===t.dump.charCodeAt(0)?_+=":":_+=": ",_+=t.dump,n+=_));t.tag=s,t.dump=n||"{}"}function Ys(t,r,e){var i,n,s,a,l,c;for(n=e?t.explicitTypes:t.implicitTypes,s=0,a=n.length;s<a;s+=1)if(l=n[s],(l.instanceOf||l.predicate)&&(!l.instanceOf||typeof r=="object"&&r instanceof l.instanceOf)&&(!l.predicate||l.predicate(r))){if(e?l.multi&&l.representName?t.tag=l.representName(r):t.tag=l.tag:t.tag="?",l.represent){if(c=t.styleMap[l.tag]||l.defaultStyle,ua.call(l.represent)==="[object Function]")i=l.represent(r,c);else if(ha.call(l.represent,c))i=l.represent[c](r,c);else throw new Z("!<"+l.tag+'> tag resolver accepts not "'+c+'" style');t.dump=i}return!0}return!1}function we(t,r,e,i,n,s,a){t.tag=null,t.dump=e,Ys(t,e,!1)||Ys(t,e,!0);var l=ua.call(t.dump),c=i,h;i&&(i=t.flowLevel<0||t.flowLevel>r);var p=l==="[object Object]"||l==="[object Array]",f,_;if(p&&(f=t.duplicates.indexOf(e),_=f!==-1),(t.tag!==null&&t.tag!=="?"||_||t.indent!==2&&r>0)&&(n=!1),_&&t.usedDuplicates[f])t.dump="*ref_"+f;else{if(p&&_&&!t.usedDuplicates[f]&&(t.usedDuplicates[f]=!0),l==="[object Object]")i&&Object.keys(t.dump).length!==0?(hc(t,r,t.dump,n),_&&(t.dump="&ref_"+f+t.dump)):(uc(t,r,t.dump),_&&(t.dump="&ref_"+f+" "+t.dump));else if(l==="[object Array]")i&&t.dump.length!==0?(t.noArrayIndent&&!a&&r>0?Gs(t,r-1,t.dump,n):Gs(t,r,t.dump,n),_&&(t.dump="&ref_"+f+t.dump)):(cc(t,r,t.dump),_&&(t.dump="&ref_"+f+" "+t.dump));else if(l==="[object String]")t.tag!=="?"&&oc(t,t.dump,r,s,c);else{if(l==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new Z("unacceptable kind of an object to dump "+l)}t.tag!==null&&t.tag!=="?"&&(h=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?h="!"+h:h.slice(0,18)==="tag:yaml.org,2002:"?h="!!"+h.slice(18):h="!<"+h+">",t.dump=h+" "+t.dump)}return!0}function pc(t,r){var e=[],i=[],n,s;for(Mr(t,e,i),n=0,s=i.length;n<s;n+=1)r.duplicates.push(e[i[n]]);r.usedDuplicates=new Array(s)}function Mr(t,r,e){var i,n,s;if(t!==null&&typeof t=="object")if(n=r.indexOf(t),n!==-1)e.indexOf(n)===-1&&e.push(n);else if(r.push(t),Array.isArray(t))for(n=0,s=t.length;n<s;n+=1)Mr(t[n],r,e);else for(i=Object.keys(t),n=0,s=i.length;n<s;n+=1)Mr(t[i[n]],r,e)}function mc(t,r){r=r||{};var e=new ic(r);e.noRefs||pc(t,e);var i=t;return e.replacer&&(i=e.replacer.call({"":i},"",i)),we(e,0,i,!0,!0)?e.dump+`
`:""}var fc=mc,gc={dump:fc};function Br(t,r){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+r+" instead, which is now safe by default.")}}var xa=ca.load,Xp=ca.loadAll,Gi=gc.dump;var Zp=Br("safeLoad","load"),em=Br("safeLoadAll","loadAll"),tm=Br("safeDump","dump");var ue=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>Tr(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let n=this._currentFields()?.[e.name]?.description;return typeof n=="string"?n:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Gi(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Gi(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Gi(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=xa(e)}catch(c){this._yamlError=c.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=o(this.hass,"ui.yaml_expect_object","Expected an object");return}let n=i,s=n.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=o(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let a=n.args;if(a!==void 0&&(typeof a!="object"||Array.isArray(a)||a===null)){this._yamlError=o(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let l=n.triggers;if(l!==void 0&&(!Array.isArray(l)||!l.every(c=>typeof c=="string"))){this._yamlError=o(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:a??{},triggers:l})}_emit(e){this.value=e,T(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(n=>`script.${n}`)}_label(e){return j(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},n={};for(let[s,a]of Object.entries(i))a&&Object.hasOwn(a,"default")&&(n[s]=a.default);return n}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,n])=>({name:i,required:n.required,selector:n.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),n=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return d`
      <div class="section">
  ...
  `,u([m({attribute:!1})],He.prototype,"hass",2),u([m({attribute:!1})],He.prototype,"value",2),u([m({attribute:!1})],He.prototype,"dayConfig",2),He=u([w("ambience-day-predicate-input")],He);var Sa=["temperature","apparent_temperature","humidity","wind_speed","pressure"],Ta=["<","<=",">",">="],La={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},xe=class extends b{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let i=e.groups.length===0&&e.thresholds.length===0;this.value=i?null:e,T(this,this.value)}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,i){let n=this._current();n.thresholds=n.thresholds.map((s,a)=>a===e?i:s),this._emit(n)}_removeThreshold(e){let i=this._current();i.thresholds=i.thresholds.filter((n,s)=>s!==e),this._emit(i)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:Sa.map(i=>({value:i,label:Dt(this.hass,i)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:Ta.map(i=>({value:i,label:La[i]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,i){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:gr(this.hass,i,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?d`<ha-form
        .hass=${this.hass}
      ...
      ${Sa.map(n=>d`<option value=${n} ?selected=${n===i.attribute}>${Dt(this.hass,n)}</option>`)}
      ...
      ${Ta.map(n=>d`<option value=${n} ?selected=${n===i.op}>${La[n]}</option>`)}
  ...
  `,u([m({attribute:!1})],et.prototype,"hass",2),u([m({attribute:!1})],et.prototype,"value",2),et=u([w("ambience-people-predicate-input")],et);var tt=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[]}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_build(e){let i={...this._cur(),...e},n={sensors:i.sensors??[]};if(i.occupied===!1&&(n.occupied=!1),i.quant==="all"&&(n.quant="all"),zt(i.for)){n.for=i.for;let s=_t(i.for,i.for_mode);s&&(n.for_mode=s)}return i.negate===!0&&(n.negate=!0),n}_emit(e){this.value=e,T(this,e)}_setSensors(e){this._emit(this._build({sensors:e}))}_setOccupied(e){this._emit(this._build({occupied:e}))}_setNegate(e){this._emit(this._build({negate:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setFor(e){let{mode:i,...n}=e;this._emit(this._build({for:n,for_mode:i??"at_least"}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"binary_sensor",device_class:["occupancy","presence","motion"],multiple:!0}}}]}_renderSensors(){return $t(this.hass,this._sensorSchema(),this._sensors(),"binary_sensor.a, binary_sensor.b",e=>this._setSensors(e))}_renderNegate(e){return Xe(this.hass,"negate","negate",e?"is_not":"is",[{value:"is",label:o(this.hass,"ui.occupancy_is","is")},{value:"is_not",label:o(this.hass,"ui.occupancy_is_not","is not")}],i=>this._setNegate(i==="is_not"))}_renderOccupied(e){return Xe(this.hass,"state","state",e?"occupied":"vacant",[{value:"occupied",label:o(this.hass,"ui.occupancy_detected","Detected")},{value:"vacant",label:o(this.hass,"ui.occupancy_clear","Clear")}],i=>this._setOccupied(i==="occupied"))}_renderQuant(e){return Xe(this.hass,"quant","quant",e,[{value:"any",label:o(this.hass,"ui.occupancy_any","Any of")},{value:"all",label:o(this.hass,"ui.occupancy_all","All of")}],i=>this._setQuant(i))}_renderFor(){return d`<ambience-for-duration
    ...
    .for-row { display: flex; gap: 0.25rem; align-items: center; }
    .for-row input[type='number'] { width: 3.5rem; }
  `,u([m({attribute:!1})],tt.prototype,"hass",2),u([m({attribute:!1})],tt.prototype,"value",2),tt=u([w("ambience-occupancy-predicate-input")],tt);function Ha(t,r){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?o(r,"ui.unavailable_select_one","Select at least one entity"):null}var Cc=[{name:"sensors",selector:{entity:{multiple:!0}}}],it=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,T(this,i)}render(){return d`
      <div class="row">
        ...
        ${s?d`
          <div class="body">
            <ambience-action-slot
              ...
              .excludeEntities=${bs(this._draft?.actions??[],i)}
              .params=${e.params}
...
`;function Ia(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function Jr(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Ia(n,r))};return d`<span
    class="entity-link"
    role="button"
    tabindex="0"
    ...
    @keydown=${i}
    >${e}</span
  >`}function Fa(t,r){return Jr(t,r,ji(t,r))}var Dc=new Set(["occupancy","people","lux","state"]);function Hc(t,r,e,i,n){let s=Rc(t,r,e,i);if(!n?.length||!Dc.has(r))return s;let a=[],l=n.map(p=>({id:p,name:ji(t,p)})).sort((p,f)=>f.name.length-p.name.length);for(let{id:p,name:f}of l)for(let _=0;_<=s.length;){let v=s.indexOf(f,_);if(v===-1)break;let x=v+f.length;if(!a.some(E=>v<E.end&&E.start<x)){a.push({start:v,end:x,id:p,name:f});break}_=v+1}if(a.length===0)return s;a.sort((p,f)=>p.start-f.start);let c=[],h=0;for(let p of a)p.start>h&&c.push(s.slice(h,p.start)),c.push(Jr(t,p.id,p.name)),h=p.end;return h<s.length&&c.push(s.slice(h)),d`${c}`}var Oc={has_time:["ui.cause_has_time","Periodic time check"],switch:["ui.cause_switch","Switch turned on"],manual:["ui.cause_manual","Manual apply"],startup:["ui.cause_startup","Startup"],reloaded:["ui.cause_reloaded","Reloaded"],simulated:["ui.cause_simulated","Simulation"]},Nc={clock:["ui.cause_clock","Time of day"],sun:["ui.cause_sun","Sun position"],reapply:["ui.cause_reapply","Re-run"]};function me(t){return t??"?"}function Ma(t,r){if(r.kind==="entity")return`${r.entity_id} ${me(r.old)} \u2192 ${me(r.new)}`;if(r.kind==="duration"){let s=o(t,"ui.cause_duration_for","for");return r.entity_id?`${r.entity_id} ${me(r.new)} ${s} ${me(r.detail)}`:`${me(r.new)} ${s} ${me(r.detail)}`}let e=Oc[r.kind];if(e)return o(t,e[0],e[1]);let i=Nc[r.kind],n=i?o(t,i[0],i[1]):F(r.kind);return r.detail?`${n} ${r.detail}`:n}function Ic(t,r){if(!tr(r)||!r.entity_id)return d`${Ma(t,r)}`;let e=Jr(t,r.entity_id,r.entity_id);return r.kind==="duration"?d`${e} ${me(r.new)} ${o(t,"ui.cause_duration_for","for")} ${me(r.detail)}`:d`${e} ${me(r.old)} → ${me(r.new)}`}function tr(t){return t.kind==="entity"||t.kind==="duration"&&!!t.entity_id}function ja(t,r){let e=t.entity_id?r?.states?.[t.entity_id]:void 0,i=n=>n===null?"?":ot(r,e,null,n);return{old:i(t.old),new:i(t.new)}}function Fc(t,r){if(!tr(t))return Ma(r,t);let e=t.entity_id?ji(r,t.entity_id):"?",i=ja(t,r);return t.kind==="duration"?`${e}: ${i.new} ${o(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:`${e}: ${i.old} \u2192 ${i.new}`}function Mc(t,r){if(!tr(t)||!t.entity_id)return d`${Fc(t,r)}`;let e=Fa(r,t.entity_id),i=ja(t,r);return t.kind==="duration"?d`${e}: ${i.new} ${o(r,"ui.cause_duration_for","for")} ${t.detail??"?"}`:d`${e}: ${i.old} → ${i.new}`}var jc={acted:["ui.outcome_label_acted","applied"],no_op:["ui.outcome_label_no_op","blocked"],debounced:["ui.outcome_label_debounced","unchanged"],no_match:["ui.outcome_label_no_match","no match"],skipped_switch_off:["ui.outcome_label_skipped","skipped"],skipped_scope_disabled:["ui.outcome_label_skipped","skipped"],skipped_unavailable:["ui.outcome_label_skipped","skipped"]};function zc(t,r){let e=jc[r];return e?o(t,e[0],e[1]):r.replace(/_/g," ")}function Zi(t,r,e,i,n,s){return r===1?o(t,e,n,{n:String(r)}):o(t,i,s,{n:String(r)})}function za(t,r){let e=r.winner_name??o(t,"ui.winner_default","The matching scene");switch(r.outcome){case"acted":{let i=r.actions.filter(h=>!h.unexposed),n=r.actions.length-i.length;if(i.length===0&&n){let h=Zi(t,n,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions");return o(t,"ui.outcome_summary_acted_all_skipped","{winner} matched \u2014 {skipped_phrase} skipped (not exposed); nothing applied.",{winner:e,skipped_phrase:h})}let s=Zi(t,i.length,"ui.count_action_one","ui.count_action_other","{n} action","{n} actions"),a=Wa(i),l=n?o(t,"ui.outcome_summary_skipped_tail"," ({skipped} skipped \u2014 not exposed)",{skipped:String(n)}):"",c=Zi(t,a,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities");return a?o(t,"ui.outcome_summary_acted_entities","Applied {winner} \u2014 {acts} on {entities}.{tail}",{winner:e,acts:s,entities:c,tail:l}):o(t,"ui.outcome_summary_acted","Applied {winner} \u2014 {acts}.{tail}",{winner:e,acts:s,tail:l})}case"no_op":return o(t,"ui.outcome_summary_no_op","{winner} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.",{winner:e});case"debounced":return o(t,"ui.outcome_summary_debounced","{winner} matched, but it's already applied \u2014 nothing was re-sent.",{winner:e});case"no_match":return o(t,"ui.outcome_summary_no_match","No scene matched \u2014 nothing applied.");case"skipped_switch_off":return o(t,"ui.outcome_summary_skipped_switch_off","Skipped \u2014 the category switch is off.");case"skipped_scope_disabled":return o(t,"ui.outcome_summary_skipped_scope_disabled","Skipped \u2014 the scope is disabled.");case"skipped_unavailable":return o(t,"ui.outcome_summary_skipped_unavailable","Skipped \u2014 the triggering entity went unavailable; devices left as they are.");default:return""}}function Ua(t,r,e){return at(t,r,()=>e?.[t]?.name?.trim()||pi(t))}function Uc(t,r,e,i){let n=Object.entries(t.params??{}).filter(([,a])=>a!=null&&a!=="").map(([a,l])=>`${qt(a,t.service,e)}: ${Le(r,l)}`).join(", "),s=Ua(t.service,i,e);return n?`${s} \xB7 ${n}`:s}function Wa(t){return t.reduce((r,e)=>r+(e.entity_ids?.length??0),0)}function Wc(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"||t==="skipped_unavailable"}function Bc(t,r,e){let i=t.index+1,n=o(r,"ui.trace_scene_prefix","Scene #");return t.disabled?d`<div class="scene disabled">${n}${i} ${t.name??"\u2014"}: ${o(r,"ui.trace_scene_disabled","disabled")}</div>`:t.evaluated?d`
  ...
  `:d`<div class="scene skipped">${n}${i} ${t.name??"\u2014"}: ${o(r,"ui.trace_scene_not_reached","not reached")}</div>`}function ir(t,r,e,i,n,s={},a){let l=t.actions.filter(_=>!_.unexposed),c=l.map(_=>Ua(_.service,a,n)).join(", "),h=Wa(l),p=t.explanation!==null||t.actions.length>0||Wc(t.outcome),f=_=>{(_.key==="Enter"||_.key===" ")&&!_.repeat&&(_.preventDefault(),e())};return d`
    <div class="eval">
      <div
      ...
      <div class="eval-body">
        ...
        ${l.length?d`<div class="action-summary">→ ${c}
              ${h?d`<span class="n">· ${Zi(i,h,"ui.count_entity_one","ui.count_entity_other","{n} entity","{n} entities")}</span>`:$}</div>`:r?$:d`<div class="action-summary">${za(i,t)}</div>`}
      </div>
      ${r?qc(t,i,n,s,a):$}
    </div>
  `}function qc(t,r,e,i,n){let s=za(r,t),a=tr(t.cause);return d`
    <div class="why">
  ...
  `}var Ne=class{constructor(r,e){this._onKeydown=r=>{this._host.open&&r.key==="Escape"&&this._close()};this._onBackdrop=()=>{this._host.open&&this._close()};this._host=r,this._close=e,r.addController(this)}hostConnected(){document.addEventListener("keydown",this._onKeydown),this._host.addEventListener("click",this._onBackdrop)}hostDisconnected(){document.removeEventListener("keydown",this._onKeydown),this._host.removeEventListener("click",this._onBackdrop)}};var I=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1;new Ne(this,()=>this._onClose())}disconnectedCallback(){super.disconnectedCallback(),this._stopPoll()}_startPoll(){this._poll||(this._poll=setInterval(()=>this._checkNew(),5e3))}_stopPoll(){this._poll&&(clearInterval(this._poll),this._poll=void 0)}updated(e){e.has("open")&&(this.open?this._startPoll():this._stopPoll()),this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(i=>i.scope_kind===this.scope.scope_kind&&i.scope_id===this.scope.scope_id&&i.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await br(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=C(this.hass,e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(a=>a.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let i=await Promise.all(e.map(async s=>{try{return[s,await Ce(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let n={...this._schemas};for(let s of i)s&&(n[s[0]]=s[1]);this._schemas=n}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let i=this._mine(await br(this.hass))[0]?.timestamp??null,n=this._records[0]?.timestamp??null;i&&(!n||i>n)&&(this._hasNew=!0)}catch{}}_toggle(e){let i=new Set(this._expanded);i.has(e)?i.delete(e):i.add(e),this._expanded=i}async _download(){try{await ds(this.hass,this.scope,this.category)}catch(e){this._error=C(this.hass,e)}}async _clear(){try{await ls(this.hass),await this._load()}catch(e){this._error=C(this.hass,e)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return $;let e=this.categoryName??this.category;return d`
    ...
    `],u([m({attribute:!1})],I.prototype,"hass",2),u([m({attribute:!1})],I.prototype,"periods",2),u([m({attribute:!1})],I.prototype,"exposedActions",2),u([m({attribute:!1})],I.prototype,"scope",2),u([m()],I.prototype,"category",2),u([m()],I.prototype,"categoryName",2),u([m({type:Boolean,reflect:!0})],I.prototype,"open",2),u([g()],I.prototype,"_records",2),u([g()],I.prototype,"_schemas",2),u([g()],I.prototype,"_expanded",2),u([g()],I.prototype,"_loading",2),u([g()],I.prototype,"_error",2),u([g()],I.prototype,"_hasNew",2),I=u([w("ambience-traces-modal")],I);var Vc={time:"mdi:clock-outline",sun:"mdi:weather-sunny"},K=class extends b{constructor(){super(...arguments);this.categoryName="";this.scenes=[];this.open=!1;this._triggers=[];this._opaque=!1;this._loading=!1;this._error="";this._loadSeq=0}willUpdate(e){super.willUpdate?.(e);let i=e.has("open")||e.has("scope")||e.has("category");this.open&&(i||e.has("scenes"))&&(i&&(this._triggers=[],this._opaque=!1),this._load())}get _scopeId(){return this.scope.kind==="house"?null:this.scope.id}async _load(){let e=++this._loadSeq;this._loading=!0,this._error="";try{let i=await Wn(this.hass,this.scope.kind,this._scopeId,this.category);if(e!==this._loadSeq)return;this._triggers=i.triggers,this._opaque=i.opaque}catch(i){if(e!==this._loadSeq)return;this._error=C(this.hass,i)}finally{e===this._loadSeq&&(this._loading=!1)}}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_openMoreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_entityName(e){return j(this.hass,e)}get _sortedTriggers(){let e=s=>this._entityName(s.entity_id).toLowerCase(),i=this._triggers.filter(s=>s.kind==="entity").sort((s,a)=>e(s).localeCompare(e(a))),n=this._triggers.filter(s=>s.kind!=="entity");return[...i,...n]}_sunPart(e){let i=ke(this.hass,e.anchor);if(e.offset===0)return i;let n=o(this.hass,"ui.unit_min","min");return`${i} ${e.offset>0?"+":""}${e.offset} ${n}`}_rowContent(e){switch(e.kind){case"entity":return{title:this._entityName(e.entity_id),detail:e.entity_id};case"time":{let i=e.clocks.map(n=>`${String(n.hour).padStart(2,"0")}:${String(n.minute).padStart(2,"0")}`);return e.date_rollover&&i.push(o(this.hass,"ui.auto_trigger_date_rollover","Local midnight (date rollover)")),e.has_time&&i.push(o(this.hass,"ui.auto_trigger_periodic","periodic re-check")),{title:o(this.hass,"ui.auto_trigger_group_time","Time"),detail:i.join(", ")}}case"sun":return{title:o(this.hass,"ui.auto_trigger_group_sun","Sun"),detail:e.suns.map(i=>this._sunPart(i)).join(", ")}}}_renderRowIcon(e){return e.kind==="entity"?jt(this.hass,e.entity_id):d`<ha-icon
      class="row-icon"
      icon=${Vc[e.kind]??Er}
  ...
  `,u([m({attribute:!1})],K.prototype,"hass",2),u([m({attribute:!1})],K.prototype,"scope",2),u([m()],K.prototype,"category",2),u([m()],K.prototype,"categoryName",2),u([m({attribute:!1})],K.prototype,"scenes",2),u([m({type:Boolean,reflect:!0})],K.prototype,"open",2),u([g()],K.prototype,"_triggers",2),u([g()],K.prototype,"_opaque",2),u([g()],K.prototype,"_loading",2),u([g()],K.prototype,"_error",2),K=u([w("ambience-auto-triggers-modal")],K);function Ba(t,r){return r==="not_home"?o(t,"ui.away","Away"):r==="home"?o(t,"ui.home","Home"):F(r)}function qa(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(r=>[r.name,r.live_value==null?"":String(r.live_value)])),for:{h:0,m:0,s:0}}}function rr(t){return String(t).padStart(2,"0")}function Va(t){return`${t.getFullYear()}-${rr(t.getMonth()+1)}-${rr(t.getDate())}`}function Ka(t){return`${rr(t.getHours())}:${rr(t.getMinutes())}`}var P=class extends b{constructor(){super();this.exposedActions=[];this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1;new Ne(this,()=>this._onClose())}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=Va(e),this._time=Ka(e);try{let i=await cs(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=i.knobs,this._hasTime=i.has_time;let n={},s={};for(let a of i.knobs)a.kind==="entity"?n[a.entity_id]=qa(a):s[this._vkey(a)]=a.live_value;this._values=n,this._verdicts=s,this._loading=!1}catch(i){this._error=C(this.hass,i),this._loading=!1}}_setState(e,i){this._values={...this._values,[e]:{...this._values[e],state:i}}}_setAttr(e,i,n){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[i]:n}}}}_setFor(e,i,n){let s=this._values[e],a=Number.isFinite(n)&&n>0?Math.trunc(n):0;this._values={...this._values,[e]:{...s,for:{...s.for,[i]:a}}}}_setVerdict(e,i){this._verdicts={...this._verdicts,[e]:i}}_resetWhen(){let e=new Date;this._date=Va(e),this._time=Ka(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:qa(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let i of this._knobs){if(i.kind!=="entity")continue;let n=this._values[i.entity_id];if(!n)continue;let s={};for(let l of i.attributes){let c=n.attributes[l.name];if(!(c===void 0||c===""))if(l.control==="number"){let h=Number(c);Number.isNaN(h)||(s[l.name]=h)}else s[l.name]=c}let a={attributes:s};n.state!==""&&(a.state=n.state),(n.for.h||n.for.m||n.for.s)&&(a.for=n.for),(a.state!==void 0||a.for!==void 0||Object.keys(s).length>0)&&(e[i.entity_id]=a)}return e}_buildVerdicts(){let e={};for(let i of this._knobs)i.kind==="verdict"&&(e[i.condition]||(e[i.condition]={}),e[i.condition][i.key]=this._verdicts[this._vkey(i)]??i.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`);if(!this._date||!this._time||Number.isNaN(e.getTime())){this._error=o(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}let i=e.toISOString();try{this._result=await us(this.hass,this.scope,this.category,i,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(n){this._error=C(this.hass,n)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?d`
      ...
      ${e.attributes.map((s,a)=>d`
        <div class="row attr ${a===e.attributes.length-1?"last-attr":""}">
          <div class="row-text"><div class="row-title">${Ba(this.hass,s.name)}</div></div>
          <div class="row-ctrl">
    ...
    `}_renderControl(e,i){if(e.control==="select")return d`<select data-entity=${e.entity_id} .value=${i}
        ...
        ${(e.options??[i]).map(s=>d`<option value=${s} ?selected=${s===i}>${Ba(this.hass,s)}</option>`)}
    ...
    </button>`}_renderScopeSwitch(e,i){let n=i.enabled!==!1;return mt({checked:n,dataTest:"scope-switch",onChange:async l=>{l.stopPropagation();try{await es(this.hass,e,!n),await Promise.all([this._store.reloadScope(e),this._store.refreshSwitches()])}catch(c){this._store.error=C(this.hass,c)}},className:"scope-switch",onClick:l=>l.stopPropagation()})}};G.styles=[y`
      :host {
        display: block;
        padding: 1rem;
  ...
  `,u([m({attribute:!1})],$e.prototype,"hass",2),u([m()],$e.prototype,"conditionName",2),u([m()],$e.prototype,"conditionDescription",2),u([g()],$e.prototype,"_expanded",2),$e=u([w("ambience-condition-card")],$e);var Qc=/^[a-z][a-z0-9_]*$/;function Jc(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var ti=y`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,se=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=ti}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!Qc.test(e)?o(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?o(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":o(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??Jc(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return d`
    ...
    `}_validateDef(){return this._min==null&&this._max==null?o(this.hass,"ui.lux_error_need_bound","Enter a min, a max, or both."):this._min!=null&&this._min<0||this._max!=null&&this._max<0?o(this.hass,"ui.lux_error_negative","Bounds must be 0 or greater."):this._min!=null&&this._max!=null&&this._min>=this._max?o(this.hass,"ui.lux_error_order","Min must be less than max."):""}_buildDefinition(){let e={label:this._label.trim()||null};return this._min!=null&&(e.min=this._min),this._max!=null&&(e.max=this._max),e}};Ie.styles=[ti,y`
      ...
      .row .field { flex: 1; }
    `],u([m({attribute:!1})],Ie.prototype,"initial",2),u([g()],Ie.prototype,"_min",2),u([g()],Ie.prototype,"_max",2),Ie=u([w("ambience-lux-edit-modal")],Ie);var sr=class extends he{_list(){return ki(this.hass)}async _save(r,e){await Yn(this.hass,r,e)}_label(r,e){return lt(this.hass,r,e)}_formatDef(r){return Ar(r.min,r.max,"any")}_headingKey(){return["ui.lux_heading","Lux ranges"]}_addKey(){return["ui.add_custom_lux_range","+ Add custom lux range"]}_renderModal(){let r=this._modal;return r.mode==="edit"?d`<ambience-lux-edit-modal
        .hass=${this.hass}
        .existingId=${r.id}
        .initial=${r.initial}
        .takenIds=${this._takenIds()}
  ...
  `,u([m({attribute:!1})],ze.prototype,"hass",2),u([m({attribute:!1})],ze.prototype,"initialTab",2),u([g()],ze.prototype,"_tab",2),ze=u([w("ambience-settings-view")],ze);var Ue=class extends b{constructor(){super();this.open=!1;new Ne(this,()=>this._close())}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?d`
      <div
        class="modal"
        role="dialog"
        aria-modal="true"
  ...
  `}connectedCallback(){super.connectedCallback(),ie(this),this.addEventListener("ambience-open-settings",this._onOpenSettings),this.addEventListener("ambience-filter-changed",this._onFilterChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("ambience-open-settings",this._onOpenSettings),this.removeEventListener("ambience-filter-changed",this._onFilterChanged)}render(){let e={dark:!!this.hass.themes?.darkMode,title:o(this.hass,"ui.panel_title","Ambience")};return d`
      ...
      ></ambience-settings-modal>
    `}};u([m({attribute:!1})],nt.prototype,"hass",2),u([g()],nt.prototype,"_settingsOpen",2),u([g()],nt.prototype,"_settingsTab",2),u([g()],nt.prototype,"_filterCategory",2);vn("ambience-frontend",nt);export{nt as AmbienceFrontend};
