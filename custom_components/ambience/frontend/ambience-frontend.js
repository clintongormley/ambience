...
`;function ht(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return qe(t)}function Kt(t,n="New scene"){return t.name?.trim()?t.name:n}function pt(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?Yt(n,e):t==="day"?Qs(n,e):t==="weather"?io(n,e):t==="sun"?no(n,e):t==="state"?Cr(n,e):t==="script"?Vs(n,e):t==="people"?Js(n,e):t==="template"?Ys(n,e):String(n)}function Ys(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function Vs(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=ut(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(o=>`${Er(n.hass,t.script,o)}: ${ve(n.hass,r[o])}`).join(", ");return`${e} (${s})`}function Er(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:qe(e)}function ut(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Xi(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):ut(n,t)}function Js(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let o=ut(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${o} ${c} ${Xi(e,n)}`;return t.for&&kr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${Sr(t.for)}`:h}let r;if(Array.isArray(t.who)){let o=t.quant??"any",a=o==="any"?d(n.hass,"ui.people_mode_any","Any of:"):o==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>ut(n,h)).join(", ");r=`${a} (${c})`}else{let o=t.quant??"everyone";r=o==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):o==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Xi(e,n)}`;return t.for&&kr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${Sr(t.for)}`:s}function Qs(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(o=>Zi(o,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(o=>Zi(o,n)).join(", ")})`}function Zi(t,n){switch(t.kind){case"weekday":return t.days.map(e=>Dt(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${je(n.hass,t.month)} ${t.day}`;case"date_range":return`${je(n.hass,t.from.month)} ${t.from.day} \u2192 ${je(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}var Xs={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function qe(t){return fe(t)}function Zs(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var eo=["entity_id","device_id","area_id","label_id","floor_id"],en=2;function to(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>eo.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function ve(t,n){let e=to(n);if(!e)return Zs(n);let r=e.slice(0,en).map(o=>ut({hass:t},o)),i=e.length-en;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function Gt(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function ro(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function io(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(o=>[o.id,o.label])),r=(t.groups??[]).map(o=>e.get(o)??ro(o)).join("/"),i=(t.thresholds??[]).map(o=>`${ot(n.hass,o.attribute)} ${Xs[o.op]??o.op} ${o.value}`).join(", "),s=[r,i].filter(o=>o!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function no(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function nn(t,n){return J(t.hass,n)}function sn(t,n){return nn({hass:t},n)}function Cr(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):xr(t,n)}function xr(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<="){let e=V(n.hass,t.kind),i=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.join("/"),s=nn(n,t.entity_id),a=`${t.attribute?`${s}.${t.attribute}`:s} ${e} ${i}`;return t.for&&kr(t.for)?`${a} ${d(n.hass,"ui.for_prefix","for")} \u2265${Sr(t.for)}`:a}if(t.kind==="and"||t.kind==="or"){let e=` ${V(n.hass,t.kind)} `;return t.items.map(r=>tn(r,n)).join(e)}return t.kind==="not"?`${V(n.hass,"not")} ${tn(t.item,n)}`:""}function tn(t,n){return t.kind==="and"||t.kind==="or"?`(${xr(t,n)})`:xr(t,n)}function kr(t){return t.h>0||t.m>0||t.s>0}function Sr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function Yt(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?oe(n.hass,i.period,r):`${rn(i.from,n)} \u2192 ${rn(i.to,n)}`).join(", ")}function rn(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=Me(n.hass,t.anchor),r=e;if(t.offset_min!==0){let i=Math.abs(t.offset_min),s=i%60===0?`${i/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${i}${d(n.hass,"ui.unit_min_abbr","m")}`;r=`${e}${t.offset_min<0?"-":"+"}${s}`}if(t.clamp){let i=t.clamp.dir==="not_before"?d(n.hass,"ui.clamp_not_before","not before"):d(n.hass,"ui.clamp_not_after","not after"),s=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;r=`${r} (${i} ${s})`}return r}function so(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label?.trim()?e.label:Pt(n.hass,t.service)}function oo(t,n){let e=t.service.indexOf(".");return e>0?t.service.slice(0,e):d(n.hass,"ui.target_noun","target")}function on(t,n){let e=so(t,n),r=oo(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let o=Object.entries(t.params).filter(([,a])=>a!=null&&a!=="").map(([a,c])=>`${ht(a,t.service,n.schemas)}: ${ve(n.hass,c)}`).join(", ");return o?`${e}: ${s}, ${o}`:`${e}: ${s}`}var z=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this._drag=new Be(this,(e,r)=>this._emit("reorder-scenes",{from:e,to:r}));this._expanded=new Set}_renderSectionHeader(e){return l`<div
  ...
  `,u([m({attribute:!1})],O.prototype,"hass",2),u([m({attribute:!1})],O.prototype,"scope",2),u([m({attribute:!1})],O.prototype,"exposed",2),u([m({attribute:!1})],O.prototype,"entityIds",2),u([m({attribute:!1})],O.prototype,"params",2),u([m({attribute:!1})],O.prototype,"excludeEntities",2),u([g()],O.prototype,"_schema",2),u([g()],O.prototype,"_schemaError",2),u([g()],O.prototype,"_exposedMissing",2),u([g()],O.prototype,"_formSchema",2),u([g()],O.prototype,"_perFieldSchemas",2),O=u([w("ambience-action-slot")],O);function En(t){return typeof t>"u"||t===null}function ao(t){return typeof t=="object"&&t!==null}function lo(t){return Array.isArray(t)?t:En(t)?[]:[t]}function co(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function uo(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function ho(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var po=En,mo=ao,fo=lo,go=uo,_o=ho,vo=co,D={isNothing:po,isObject:mo,toArray:fo,repeat:go,isNegativeZero:_o,extend:vo};function Cn(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`
...
`;function Bl(t){return t.kind==="entity"?`${t.entity_id} ${t.old} \u2192 ${t.new}`:t.detail?`${fe(t.kind)} ${t.detail}`:fe(t.kind)}function ql(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,o])=>`${ht(s,t.service,e)}: ${ve(n,o)}`).join(", "),i=st(t.service);return r?`${i} \xB7 ${r}`:i}function Kl(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function Gl(t,n){let e=t.index+1;return t.disabled?l`<div class="scene disabled">Scene #${e} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
    ...
    ${t.predicates.map(r=>l`
        <div class="pred ${r.passed?"pass":"fail"}" style="padding-left:1rem">
          ${r.passed?"\u2713":"\u2717"} ${q(n,r.condition_key)}${r.detail?l` <span class="dim">[${Ul(n,r.condition_key,r.detail)}]</span>`:S}
        </div>`)}
  ...
  `,u([m({attribute:!1})],ke.prototype,"hass",2),u([g()],ke.prototype,"_config",2),u([g()],ke.prototype,"_warnings",2),ke=u([w("ambience-day-config")],ke);var id=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],pe=class extends b{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),this._config=await zt(this.hass)}async _persist(){let e=await ji(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[]}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:id.map(e=>({value:e,label:ze(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
    ...
    .warnings ul { margin: 0.3rem 0 0 0; padding-left: 1.2rem; }
  `,u([m({attribute:!1})],pe.prototype,"hass",2),u([g()],pe.prototype,"_config",2),u([g()],pe.prototype,"_warnings",2),u([g()],pe.prototype,"_expanded",2),pe=u([w("ambience-weather-config")],pe);var nd=new Set(["time_of_day","day","weather"]),Se=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await It(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._conditions.filter(r=>nd.has(r.name)).slice().sort((r,i)=>i.priority-r.priority);return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      ${e.map(r=>l`
