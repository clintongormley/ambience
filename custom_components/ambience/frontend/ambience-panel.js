...
var tt=Object.defineProperty;var it=Object.getOwnPropertyDescriptor;var a=(n,i,e,t)=>{for(var r=t>1?void 0:t?it(i,e):i,s=n.length-1,o;s>=0;s--)(o=n[s])&&(r=(t?o(i,e,r):o(r))||r);return t&&r&&tt(i,e,r),r};var ee=globalThis,te=ee.ShadowRoot&&(ee.ShadyCSS===void 0||ee.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,he=Symbol(),ke=new WeakMap,W=class{constructor(i,e,t){if(this._$cssResult$=!0,t!==he)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this.t=e}get styleSheet(){let i=this.o,e=this.t;if(te&&i===void 0){let t=e!==void 0&&e.length===1;t&&(i=ke.get(e)),i===void 0&&((this.o=i=new CSSStyleSheet).replaceSync(this.cssText),t&&ke.set(e,i))}return i}toString(){return this.cssText}},Ee=n=>new W(typeof n=="string"?n:n+"",void 0,he),m=(n,...i)=>{let e=n.length===1?n[0]:i.reduce((t,r,s)=>t+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+n[s+1],n[0]);return new W(e,n,he)},Se=(n,i)=>{if(te)n.adoptedStyleSheets=i.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of i){let t=document.createElement("style"),r=ee.litNonce;r!==void 0&&t.setAttribute("nonce",r),t.textContent=e.cssText,n.appendChild(t)}},pe=te?n=>n:n=>n instanceof CSSStyleSheet?(i=>{let e="";for(let t of i.cssRules)e+=t.cssText;return Ee(e)})(n):n;var{is:rt,defineProperty:st,getOwnPropertyDescriptor:nt,getOwnPropertyNames:ot,getOwnPropertySymbols:at,getPrototypeOf:lt}=Object,ie=globalThis,Ce=ie.trustedTypes,dt=Ce?Ce.emptyScript:"",ct=ie.reactiveElementPolyfillSupport,B=(n,i)=>n,V={toAttribute(n,i){switch(i){case Boolean:n=n?dt:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,i){let e=n;switch(i){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},re=(n,i)=>!rt(n,i),Ae={attribute:!0,type:String,converter:V,reflect:!1,useDefault:!1,hasChanged:re};Symbol.metadata??=Symbol("metadata"),ie.litPropertyMetadata??=new WeakMap;var A=class extends HTMLElement{static addInitializer(i){this._$Ei(),(this.l??=[]).push(i)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(i,e=Ae){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(i)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(i,e),!e.noAccessor){let t=Symbol(),r=this.getPropertyDescriptor(i,t,e);r!==void 0&&st(this.prototype,i,r)}}static getPropertyDescriptor(i,e,t){let{get:r,set:s}=nt(this.prototype,i)??{get(){return this[e]},set(o){this[e]=o}};return{get:r,set(o){let d=r?.call(this);s?.call(this,o),this.requestUpdate(i,d,t)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??Ae}static _$Ei(){if(this.hasOwnProperty(B("elementProperties")))return;let i=lt(this);i.finalize(),i.l!==void 0&&(this.l=[...i.l]),this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(B("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(B("properties"))){let e=this.properties,t=[...ot(e),...at(e)];for(let r of t)this.createProperty(r,e[r])}let i=this[Symbol.metadata];if(i!==null){let e=litPropertyMetadata.get(i);if(e!==void 0)for(let[t,r]of e)this.elementProperties.set(t,r)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let r=this._$Eu(e,t);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(i){let e=[];if(Array.isArray(i)){let t=new Set(i.flat(1/0).reverse());for(let r of t)e.unshift(pe(r))}else i!==void 0&&e.push(pe(i));return e}static _$Eu(i,e){let t=e.attribute;return t===!1?void 0:typeof t=="string"?t:typeof i=="string"?i.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(i=>i(this))}addController(i){(this._$EO??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected&&i.hostConnected?.()}removeController(i){this._$EO?.delete(i)}_$E_(){let i=new Map,e=this.constructor.elementProperties;for(let t of e.keys())this.hasOwnProperty(t)&&(i.set(t,this[t]),delete this[t]);i.size>0&&(this._$Ep=i)}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Se(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(i=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this._$EO?.forEach(i=>i.hostDisconnected?.())}attributeChangedCallback(i,e,t){this._$AK(i,t)}_$ET(i,e){let t=this.constructor.elementProperties.get(i),r=this.constructor._$Eu(i,t);if(r!==void 0&&t.reflect===!0){let s=(t.converter?.toAttribute!==void 0?t.converter:V).toAttribute(e,t.type);this._$Em=i,s==null?this.removeAttribute(r):this.setAttribute(r,s),this._$Em=null}}_$AK(i,e){let t=this.constructor,r=t._$Eh.get(i);if(r!==void 0&&this._$Em!==r){let s=t.getPropertyOptions(r),o=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:V;this._$Em=r;let d=o.fromAttribute(e,s.type);this[r]=d??this._$Ej?.get(r)??d,this._$Em=null}}requestUpdate(i,e,t,r=!1,s){if(i!==void 0){let o=this.constructor;if(r===!1&&(s=this[i]),t??=o.getPropertyOptions(i),!((t.hasChanged??re)(s,e)||t.useDefault&&t.reflect&&s===this._$Ej?.get(i)&&!this.hasAttribute(o._$Eu(i,t))))return;this.C(i,e,t)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(i,e,{useDefault:t,reflect:r,wrapped:s},o){t&&!(this._$Ej??=new Map).has(i)&&(this._$Ej.set(i,o??e??this[i]),s!==!0||o!==void 0)||(this._$AL.has(i)||(this.hasUpdated||t||(e=void 0),this._$AL.set(i,e)),r===!0&&this._$Em!==i&&(this._$Eq??=new Set).add(i))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let i=this.scheduleUpdate();return i!=null&&await i,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,s]of this._$Ep)this[r]=s;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[r,s]of t){let{wrapped:o}=s,d=this[r];o!==!0||this._$AL.has(r)||d===void 0||this.C(r,void 0,s,d)}}let i=!1,e=this._$AL;try{i=this.shouldUpdate(e),i?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(t){throw i=!1,this._$EM(),t}i&&this._$AE(e)}willUpdate(i){}_$AE(i){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(i)),this.updated(i)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(i){return!0}update(i){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(i){}firstUpdated(i){}};A.elementStyles=[],A.shadowRootOptions={mode:"open"},A[B("elementProperties")]=new Map,A[B("finalized")]=new Map,ct?.({ReactiveElement:A}),(ie.reactiveElementVersions??=[]).push("2.1.2");var ye=globalThis,Pe=n=>n,se=ye.trustedTypes,He=se?se.createPolicy("lit-html",{createHTML:n=>n}):void 0,Oe="$lit$",R=`lit$${Math.random().toFixed(9).slice(2)}$`,De="?"+R,ht=`<${De}>`,D=document,J=()=>D.createComment(""),X=n=>n===null||typeof n!="object"&&typeof n!="function",be=Array.isArray,pt=n=>be(n)||typeof n?.[Symbol.iterator]=="function",ue=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Te=/-->/g,Re=/>/g,N=RegExp(`>|${ue}(?:([^\\s"'>=/]+)(${ue}*=${ue}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Me=/'/g,Ie=/"/g,je=/^(?:script|style|textarea|title)$/i,$e=n=>(i,...e)=>({_$litType$:n,strings:i,values:e}),l=$e(1),Pt=$e(2),Ht=$e(3),j=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Ne=new WeakMap,O=D.createTreeWalker(D,129);function Le(n,i){if(!be(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return He!==void 0?He.createHTML(i):i}var ut=(n,i)=>{let e=n.length-1,t=[],r,s=i===2?"<svg>":i===3?"<math>":"",o=K;for(let d=0;d<e;d++){let c=n[d],v,y,f=-1,C=0;for(;C<c.length&&(o.lastIndex=C,y=o.exec(c),y!==null);)C=o.lastIndex,o===K?y[1]==="!--"?o=Te:y[1]!==void 0?o=Re:y[2]!==void 0?(je.test(y[2])&&(r=RegExp("</"+y[2],"g")),o=N):y[3]!==void 0&&(o=N):o===N?y[0]===">"?(o=r??K,f=-1):y[1]===void 0?f=-2:(f=o.lastIndex-y[2].length,v=y[1],o=y[3]===void 0?N:y[3]==='"'?Ie:Me):o===Ie||o===Me?o=N:o===Te||o===Re?o=K:(o=N,r=void 0);let T=o===N&&n[d+1].startsWith("/>")?" ":"";s+=o===K?c+ht:f>=0?(t.push(v),c.slice(0,f)+Oe+c.slice(f)+R+T):c+R+(f===-2?d:T)}return[Le(n,s+(n[e]||"<?>")+(i===2?"</svg>":i===3?"</math>":"")),t]},G=class n{constructor({strings:i,_$litType$:e},t){let r;this.parts=[];let s=0,o=0,d=i.length-1,c=this.parts,[v,y]=ut(i,e);if(this.el=n.createElement(v,t),O.currentNode=this.el.content,e===2||e===3){let f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(r=O.nextNode())!==null&&c.length<d;){if(r.nodeType===1){if(r.hasAttributes())for(let f of r.getAttributeNames())if(f.endsWith(Oe)){let C=y[o++],T=r.getAttribute(f).split(R),Q=/([.?@])?(.*)/.exec(C);c.push({type:1,index:s,name:Q[2],strings:T,ctor:Q[1]==="."?fe:Q[1]==="?"?ge:Q[1]==="@"?ve:F}),r.removeAttribute(f)}else f.startsWith(R)&&(c.push({type:6,index:s}),r.removeAttribute(f));if(je.test(r.tagName)){let f=r.textContent.split(R),C=f.length-1;if(C>0){r.textContent=se?se.emptyScript:"";for(let T=0;T<C;T++)r.append(f[T],J()),O.nextNode(),c.push({type:2,index:++s});r.append(f[C],J())}}}else if(r.nodeType===8)if(r.data===De)c.push({type:2,index:s});else{let f=-1;for(;(f=r.data.indexOf(R,f+1))!==-1;)c.push({type:7,index:s}),f+=R.length-1}s++}}static createElement(i,e){let t=D.createElement("template");return t.innerHTML=i,t}};function z(n,i,e=n,t){if(i===j)return i;let r=t!==void 0?e._$Co?.[t]:e._$Cl,s=X(i)?void 0:i._$litDirective$;return r?.constructor!==s&&(r?._$AO?.(!1),s===void 0?r=void 0:(r=new s(n),r._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=r:e._$Cl=r),r!==void 0&&(i=z(n,r._$AS(n,i.values),r,t)),i}var me=class{constructor(i,e){this._$AV=[],this._$AN=void 0,this._$AD=i,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(i){let{el:{content:e},parts:t}=this._$AD,r=(i?.creationScope??D).importNode(e,!0);O.currentNode=r;let s=O.nextNode(),o=0,d=0,c=t[0];for(;c!==void 0;){if(o===c.index){let v;c.type===2?v=new Y(s,s.nextSibling,this,i):c.type===1?v=new c.ctor(s,c.name,c.strings,this,i):c.type===6&&(v=new _e(s,this,i)),this._$AV.push(v),c=t[++d]}o!==c?.index&&(s=O.nextNode(),o++)}return O.currentNode=D,r}p(i){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(i,t,e),e+=t.strings.length-2):t._$AI(i[e])),e++}},Y=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(i,e,t,r){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=i,this._$AB=e,this._$AM=t,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let i=this._$AA.parentNode,e=this._$AM;return e!==void 0&&i?.nodeType===11&&(i=e.parentNode),i}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(i,e=this){i=z(this,i,e),X(i)?i===_||i==null||i===""?(this._$AH!==_&&this._$AR(),this._$AH=_):i!==this._$AH&&i!==j&&this._(i):i._$litType$!==void 0?this.$(i):i.nodeType!==void 0?this.T(i):pt(i)?this.k(i):this._(i)}O(i){return this._$AA.parentNode.insertBefore(i,this._$AB)}T(i){this._$AH!==i&&(this._$AR(),this._$AH=this.O(i))}_(i){this._$AH!==_&&X(this._$AH)?this._$AA.nextSibling.data=i:this.T(D.createTextNode(i)),this._$AH=i}$(i){let{values:e,_$litType$:t}=i,r=typeof t=="number"?this._$AC(i):(t.el===void 0&&(t.el=G.createElement(Le(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===r)this._$AH.p(e);else{let s=new me(r,this),o=s.u(this.options);s.p(e),this.T(o),this._$AH=s}}_$AC(i){let e=Ne.get(i.strings);return e===void 0&&Ne.set(i.strings,e=new G(i)),e}k(i){be(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,r=0;for(let s of i)r===e.length?e.push(t=new n(this.O(J()),this.O(J()),this,this.options)):t=e[r],t._$AI(s),r++;r<e.length&&(this._$AR(t&&t._$AB.nextSibling,r),e.length=r)}_$AR(i=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);i!==this._$AB;){let t=Pe(i).nextSibling;Pe(i).remove(),i=t}}setConnected(i){this._$AM===void 0&&(this._$Cv=i,this._$AP?.(i))}},F=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(i,e,t,r,s){this.type=1,this._$AH=_,this._$AN=void 0,this.element=i,this.name=e,this._$AM=r,this.options=s,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=_}_$AI(i,e=this,t,r){let s=this.strings,o=!1;if(s===void 0)i=z(this,i,e,0),o=!X(i)||i!==this._$AH&&i!==j,o&&(this._$AH=i);else{let d=i,c,v;for(i=s[0],c=0;c<s.length-1;c++)v=z(this,d[t+c],e,c),v===j&&(v=this._$AH[c]),o||=!X(v)||v!==this._$AH[c],v===_?i=_:i!==_&&(i+=(v??"")+s[c+1]),this._$AH[c]=v}o&&!r&&this.j(i)}j(i){i===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,i??"")}},fe=class extends F{constructor(){super(...arguments),this.type=3}j(i){this.element[this.name]=i===_?void 0:i}},ge=class extends F{constructor(){super(...arguments),this.type=4}j(i){this.element.toggleAttribute(this.name,!!i&&i!==_)}},ve=class extends F{constructor(i,e,t,r,s){super(i,e,t,r,s),this.type=5}_$AI(i,e=this){if((i=z(this,i,e,0)??_)===j)return;let t=this._$AH,r=i===_&&t!==_||i.capture!==t.capture||i.once!==t.once||i.passive!==t.passive,s=i!==_&&(t===_||r);r&&this.element.removeEventListener(this.name,this,t),s&&this.element.addEventListener(this.name,this,i),this._$AH=i}handleEvent(i){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,i):this._$AH.handleEvent(i)}},_e=class{constructor(i,e,t){this.element=i,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(i){z(this,i)}};var mt=ye.litHtmlPolyfillSupport;mt?.(G,Y),(ye.litHtmlVersions??=[]).push("3.3.2");var Ue=(n,i,e)=>{let t=e?.renderBefore??i,r=t._$litPart$;if(r===void 0){let s=e?.renderBefore??null;t._$litPart$=r=new Y(i.insertBefore(J(),s),s,void 0,e??{})}return r._$AI(n),r};var xe=globalThis,u=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let i=super.createRenderRoot();return this.renderOptions.renderBefore??=i.firstChild,i}update(i){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(i),this._$Do=Ue(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return j}};u._$litElement$=!0,u.finalized=!0,xe.litElementHydrateSupport?.({LitElement:u});var ft=xe.litElementPolyfillSupport;ft?.({LitElement:u});(xe.litElementVersions??=[]).push("4.2.2");var g=n=>(i,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(n,i)}):customElements.define(n,i)};var gt={attribute:!0,type:String,converter:V,reflect:!1,hasChanged:re},vt=(n=gt,i,e)=>{let{kind:t,metadata:r}=e,s=globalThis.litPropertyMetadata.get(r);if(s===void 0&&globalThis.litPropertyMetadata.set(r,s=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),s.set(e.name,n),t==="accessor"){let{name:o}=e;return{set(d){let c=i.get.call(this);i.set.call(this,d),this.requestUpdate(o,c,n,!0,d)},init(d){return d!==void 0&&this.C(o,void 0,n,d),d}}}if(t==="setter"){let{name:o}=e;return function(d){let c=this[o];i.call(this,d),this.requestUpdate(o,c,n,!0,d)}}throw Error("Unsupported decorator location: "+t)};function h(n){return(i,e)=>typeof e=="object"?vt(n,i,e):((t,r,s)=>{let o=r.hasOwnProperty(s);return r.constructor.createProperty(s,t),o?Object.getOwnPropertyDescriptor(r,s):void 0})(n,i,e)}function p(n){return h({...n,state:!0,attribute:!1})}var _t=["ha-input","ha-textfield","ha-form"],yt=["ha-input","ha-textfield"];function ze(){for(let n of yt)if(customElements.get(n))return n;return null}function M(n,i){for(let e of _t)customElements.get(e)||customElements.whenDefined(e).then(()=>n.requestUpdate())}async function Fe(n){return n.callWS({type:"ambience/areas/list"})}async function qe(n,i){return n.callWS({type:"ambience/area/get",area_id:i})}async function We(n,i,e){return n.callWS({type:"ambience/area/save",area_id:i,config:e})}async function Be(n){return n.callWS({type:"ambience/matchers/list"})}async function Ve(n){return n.callWS({type:"ambience/actions/list"})}async function oe(n){return n.callWS({type:"ambience/time_of_day_periods/list"})}async function Ke(n,i,e){return n.callWS({type:"ambience/time_of_day_periods/save",custom:i,hidden:e})}async function Je(n){return n.callWS({type:"ambience/time_of_day_periods/reset"})}function we(n,i,e){let t=n?.localize?.(i);return t&&t!==i?t:e}function Xe(n){let i=n.replaceAll("_"," ").toLowerCase();return i.charAt(0).toUpperCase()+i.slice(1)}function ae(n,i){return we(n,`component.ambience.matcher.${i}`,Xe(i))}function le(n,i){return we(n,`component.ambience.action.${i}`,Xe(i))}function L(n,i,e){let t=e[i]?.label;if(t)return t;let r=i.charAt(0).toUpperCase()+i.slice(1);return we(n,`component.ambience.time_of_day_period.${i}`,r)}function de(n,i,e){return i==null?"(any)":n==="time_of_day"?ce(i,e):String(i)}function ce(n,i){if(n===null)return"any";let e=Array.isArray(n)?n:[n],t=i.periods?.custom??{};return e.map(r=>"period"in r?L(i.hass,r.period,t):`${Ge(r.from)}\u2192${Ge(r.to)}`).join(", ")}function Ge(n){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;if(n.offset_min===0)return n.anchor;let i=Math.abs(n.offset_min),e=i%60===0?`${i/60}h`:`${i}m`;return`${n.anchor}${n.offset_min<0?"-":"+"}${e}`}function Ye(n,i,e){let t=le(e.hass,n.action),r=i?.domains?.[0]??"target",s=n.entity_ids.length,o;s===0?o="(no targets)":s===1?o=`1 ${r}`:o=`${s} ${r}s`;let d=Object.entries(n.params).filter(([,c])=>c!=null&&c!=="").map(([c,v])=>`${c} ${v}`).join(", ");return d?`${t}: ${o}, ${d}`:`${t}: ${o}`}var w=class extends u{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this._dragFrom=null;this._dragOver=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_summary(e){let t=Object.keys(e.when).filter(o=>e.when[o]!=null),r=t.length===0?"any":t.map(o=>`${ae(this.hass,o)}: ${de(o,e.when[o],{hass:this.hass,periods:this.periods})}`).join(", "),s=e.actions.length;return`${r} \xB7 ${s} action${s===1?"":"s"}`}_onDragStart(e){this._dragFrom=e}_onDragOver(e,t){this._dragFrom===null||t===this._dragFrom||(e.preventDefault(),this._dragOver=t)}_onDrop(e){let t=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(t===null||t===e)&&this._emit("reorder-rules",{from:t,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,t){let r=t.name||`Rule ${e+1}`;window.confirm(`Delete "${r}"?`)&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
        ...
        <div class="entry-header">
          <select @change=${d=>this._onSelectChange(t,d)}>
            ...
            ${s.map(d=>l`<option value=${d}>
                ${L(this.hass,d,o)}${o[d]&&!this.periods?.builtins[d]?" (custom)":""}
              </option>`)}
          </select>
  ...
  `,a([h({attribute:!1})],S.prototype,"matcher",2),a([h({attribute:!1})],S.prototype,"value",2),a([h({attribute:!1})],S.prototype,"sceneSuggestions",2),a([h({attribute:!1})],S.prototype,"periods",2),a([h({attribute:!1})],S.prototype,"hass",2),S=a([g("ambience-matcher-input")],S);var I=class extends u{constructor(){super(...arguments);this.entities=[];this.value=[]}connectedCallback(){super.connectedCallback(),M(this,this.hass)}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let e=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this.entities}}}];return l`
      <ha-form
        .hass=${this.hass}
        .schema=${e}
    ...
    `}render(){return customElements.get("ha-form")?this._renderHaForm():this._renderFallback()}};I.styles=m`
    :host { display: block; }
    .empty {
      color: var(--secondary-text-color, #888);
      font-style: italic;
  ...
  `,a([h({attribute:!1})],I.prototype,"hass",2),a([h({attribute:!1})],I.prototype,"entities",2),a([h({attribute:!1})],I.prototype,"value",2),I=a([g("ambience-target-picker")],I);var b=class extends u{constructor(){super(...arguments);this.open=!1;this.rule=null;this.matchers=[];this.sceneSuggestions=[];this.availableActions=[];this._draft=null;this._open=null;this._showError=!1;this._onNameInput=e=>{this._setName(e.target.value)}}connectedCallback(){super.connectedCallback(),M(this,this.hass)}willUpdate(e){e.has("rule")&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._open=null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_renderNameSlot(){let e=this._draft.name??"",t=this._isOpen({kind:"name"});return l`
    ...
    `}_addActionSlot(){if(!this._draft)return;let e={action:"set_light",entity_ids:[],params:{}},t=this._draft.actions.length;this._draft={...this._draft,actions:[...this._draft.actions,e]},this._open={kind:"action",idx:t}}_updateActionAt(e,t){if(!this._draft)return;let r=this._draft.actions.map((s,o)=>o===e?t(s):s);this._draft={...this._draft,actions:r}}_changeActionType(e,t){this._updateActionAt(e,()=>{let r=this.availableActions.find(o=>o.name===t),s={};return r?.target_params.forEach(o=>{"default"in o&&(s[o.name]=o.default)}),{action:t,entity_ids:[],params:s}})}_deleteAction(e){this._draft&&(this._draft={...this._draft,actions:this._draft.actions.filter((t,r)=>r!==e)},this._open?.kind==="action"&&this._open.idx===e&&(this._open=null))}_setActionTargets(e,t){this._updateActionAt(e,r=>({...r,entity_ids:t}))}_paramLabel(e){let t=e.replaceAll("_"," ").toLowerCase();return t.charAt(0).toUpperCase()+t.slice(1)}_updateActionParam(e,t,r){this._updateActionAt(e,s=>{let o={...s.params},d=r;if(t.type==="int"?d=r===""?void 0:parseInt(r,10):t.type==="number"?d=r===""?void 0:parseFloat(r):t.type==="boolean"&&(d=r==="true"),typeof d=="number"&&Number.isFinite(d)){let c=d;typeof t.min=="number"&&c<t.min&&(c=t.min),typeof t.max=="number"&&c>t.max&&(c=t.max),d=c}return d===void 0?delete o[t.name]:o[t.name]=d,{...s,params:o}})}_renderActionParams(e,t,r){let s=r?.target_params??[];return l`
      ...
      `)}
    `}_renderActionRow(e,t){let r=this.availableActions.find(c=>c.name===e.action),s=this._isOpen({kind:"action",idx:t}),o=Ye(e,r,{hass:this.hass}),d=Ze(this.hass,this.areaId,r?.domains??[]);return l`
  ...
  `,a([h({attribute:!1})],x.prototype,"existingId",2),a([h({attribute:!1})],x.prototype,"initial",2),a([h({attribute:!1})],x.prototype,"takenIds",2),a([p()],x.prototype,"_id",2),a([p()],x.prototype,"_label",2),a([p()],x.prototype,"_def",2),a([p()],x.prototype,"_error",2),x=a([g("ambience-period-edit-modal")],x);function et(n){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;if(n.offset_min===0)return n.anchor;let i=Math.abs(n.offset_min),e=i%60===0?`${i/60}h`:`${i}m`;return`${n.anchor}${n.offset_min<0?"-":"+"}${e}`}function wt(n){return`${et(n.from)} \u2192 ${et(n.to)}`}var H=class extends u{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){this._view=await oe(this.hass)}_effective(){let e=new Set(this._view.hidden),t=[];for(let[r,s]of Object.entries(this._view.builtins)){if(e.has(r))continue;let o=this._view.custom[r];o?t.push({id:r,defn:o,provenance:"builtin-edited"}):t.push({id:r,defn:s,provenance:"builtin"})}for(let[r,s]of Object.entries(this._view.custom))r in this._view.builtins||t.push({id:r,defn:s,provenance:"custom"});return t}async _saveState(e,t){let r=await Ke(this.hass,e,t);this._warnings=r.warnings,await this._reload()}_onEdit(e,t){this._modal={mode:"edit",id:e,initial:t}}async _onDelete(e){if(e in this._view.builtins){let r={...this._view.custom};delete r[e],await this._saveState(r,[...this._view.hidden,e])}else{let r={...this._view.custom};delete r[e],await this._saveState(r,this._view.hidden)}}async _onRevertEdited(e){let t={...this._view.custom};delete t[e],await this._saveState(t,this._view.hidden)}async _onRevertHidden(e){await this._saveState(this._view.custom,this._view.hidden.filter(t=>t!==e))}async _onResetAll(){let e=Object.keys(this._view.custom).length,t=this._view.hidden.length,r=`This will clear ${e} custom period(s) and restore ${t} hidden built-in(s). Continue?`;confirm(r)&&(await Je(this.hass),this._warnings=[],await this._reload())}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:t,definition:r}=e.detail,s={...this._view.custom,[t]:r},o=this._view.hidden.filter(d=>d!==t);this._modal={mode:"closed"},await this._saveState(s,o)}_onModalCancel(){this._modal={mode:"closed"}}_renderRow(e){let t=this._view.custom,r=e.provenance==="builtin-edited",s=e.provenance==="custom";return l`
      <div class="row">
        <span class="name">${L(this.hass,e.id,t)}</span>
        <span class="def">${wt(e.defn)}</span>
    ...
    `}_renderHiddenRow(e){return l`
      <div class="row">
        <span class="name">${L(this.hass,e,{})}</span>
  ...
  `,a([h({attribute:!1})],H.prototype,"hass",2),a([p()],H.prototype,"_view",2),a([p()],H.prototype,"_modal",2),a([p()],H.prototype,"_warnings",2),H=a([g("ambience-periods-view")],H);var U=class extends u{constructor(){super(...arguments);this._view="areas"}connectedCallback(){super.connectedCallback(),M(this)}render(){return l`
      <header>
        <h1>Ambience</h1>
        <nav>
          <button
  ...
  `,a([h({attribute:!1})],U.prototype,"hass",2),a([p()],U.prototype,"_view",2),U=a([g("ambience-panel")],U);export{U as AmbiencePanel};
