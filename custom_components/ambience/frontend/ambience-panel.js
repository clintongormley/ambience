...
\f\r"'\`<>=]|("|')|))|$)`,"g"),at=/'/g,ot=/"/g,ht=/^(?:script|style|textarea|title)$/i,Ge=n=>(s,...e)=>({_$litType$:n,strings:s,values:e}),l=Ge(1),Ar=Ge(2),Ir=Ge(3),J=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),lt=new WeakMap,B=K.createTreeWalker(K,129);function ct(n,s){if(!Ue(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return st!==void 0?st.createHTML(s):s}var Jt=(n,s)=>{let e=n.length-1,t=[],r,i=s===2?"<svg>":s===3?"<math>":"",a=oe;for(let u=0;u<e;u++){let h=n[u],p,v,y=-1,D=0;for(;D<h.length&&(a.lastIndex=D,v=a.exec(h),v!==null);)D=a.lastIndex,a===oe?v[1]==="!--"?a=it:v[1]!==void 0?a=nt:v[2]!==void 0?(ht.test(v[2])&&(r=RegExp("</"+v[2],"g")),a=V):v[3]!==void 0&&(a=V):a===V?v[0]===">"?(a=r??oe,y=-1):v[1]===void 0?y=-2:(y=a.lastIndex-v[2].length,p=v[1],a=v[3]===void 0?V:v[3]==='"'?ot:at):a===ot||a===at?a=V:a===it||a===nt?a=oe:(a=V,r=void 0);let z=a===V&&n[u+1].startsWith("/>")?" ":"";i+=a===oe?h+Bt:y>=0?(t.push(p),h.slice(0,y)+dt+h.slice(y)+j+z):h+j+(y===-2?u:z)}return[ct(n,i+(n[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},ue=class n{constructor({strings:s,_$litType$:e},t){let r;this.parts=[];let i=0,a=0,u=s.length-1,h=this.parts,[p,v]=Jt(s,e);if(this.el=n.createElement(p,t),B.currentNode=this.el.content,e===2||e===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(r=B.nextNode())!==null&&h.length<u;){if(r.nodeType===1){if(r.hasAttributes())for(let y of r.getAttributeNames())if(y.endsWith(dt)){let D=v[a++],z=r.getAttribute(y).split(j),fe=/([.?@])?(.*)/.exec(D);h.push({type:1,index:i,name:fe[2],strings:z,ctor:fe[1]==="."?Oe:fe[1]==="?"?Fe:fe[1]==="@"?ze:ee}),r.removeAttribute(y)}else y.startsWith(j)&&(h.push({type:6,index:i}),r.removeAttribute(y));if(ht.test(r.tagName)){let y=r.textContent.split(j),D=y.length-1;if(D>0){r.textContent=be?be.emptyScript:"";for(let z=0;z<D;z++)r.append(y[z],le()),B.nextNode(),h.push({type:2,index:++i});r.append(y[D],le())}}}else if(r.nodeType===8)if(r.data===ut)h.push({type:2,index:i});else{let y=-1;for(;(y=r.data.indexOf(j,y+1))!==-1;)h.push({type:7,index:i}),y+=j.length-1}i++}}static createElement(s,e){let t=K.createElement("template");return t.innerHTML=s,t}};function Q(n,s,e=n,t){if(s===J)return s;let r=t!==void 0?e._$Co?.[t]:e._$Cl,i=de(s)?void 0:s._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),i===void 0?r=void 0:(r=new i(n),r._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=r:e._$Cl=r),r!==void 0&&(s=Q(n,r._$AS(n,s.values),r,t)),s}var Me=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,r=(s?.creationScope??K).importNode(e,!0);B.currentNode=r;let i=B.nextNode(),a=0,u=0,h=t[0];for(;h!==void 0;){if(a===h.index){let p;h.type===2?p=new he(i,i.nextSibling,this,s):h.type===1?p=new h.ctor(i,h.name,h.strings,this,s):h.type===6&&(p=new je(i,this,s)),this._$AV.push(p),h=t[++u]}a!==h?.index&&(i=B.nextNode(),a++)}return B.currentNode=K,r}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},he=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=Q(this,s,e),de(s)?s===b||s==null||s===""?(this._$AH!==b&&this._$AR(),this._$AH=b):s!==this._$AH&&s!==J&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):Kt(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==b&&de(this._$AH)?this._$AA.nextSibling.data=s:this.T(K.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,r=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=ue.createElement(ct(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===r)this._$AH.p(e);else{let i=new Me(r,this),a=i.u(this.options);i.p(e),this.T(a),this._$AH=i}}_$AC(s){let e=lt.get(s.strings);return e===void 0&&lt.set(s.strings,e=new ue(s)),e}k(s){Ue(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,r=0;for(let i of s)r===e.length?e.push(t=new n(this.O(le()),this.O(le()),this,this.options)):t=e[r],t._$AI(i),r++;r<e.length&&(this._$AR(t&&t._$AB.nextSibling,r),e.length=r)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=rt(s).nextSibling;rt(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},ee=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,r,i){this.type=1,this._$AH=b,this._$AN=void 0,this.element=s,this.name=e,this._$AM=r,this.options=i,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=b}_$AI(s,e=this,t,r){let i=this.strings,a=!1;if(i===void 0)s=Q(this,s,e,0),a=!de(s)||s!==this._$AH&&s!==J,a&&(this._$AH=s);else{let u=s,h,p;for(s=i[0],h=0;h<i.length-1;h++)p=Q(this,u[t+h],e,h),p===J&&(p=this._$AH[h]),a||=!de(p)||p!==this._$AH[h],p===b?s=b:s!==b&&(s+=(p??"")+i[h+1]),this._$AH[h]=p}a&&!r&&this.j(s)}j(s){s===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},Oe=class extends ee{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===b?void 0:s}},Fe=class extends ee{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==b)}},ze=class extends ee{constructor(s,e,t,r,i){super(s,e,t,r,i),this.type=5}_$AI(s,e=this){if((s=Q(this,s,e,0)??b)===J)return;let t=this._$AH,r=s===b&&t!==b||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,i=s!==b&&(t===b||r);r&&this.element.removeEventListener(this.name,this,t),i&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},je=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){Q(this,s)}};var Yt=We.litHtmlPolyfillSupport;Yt?.(ue,he),(We.litHtmlVersions??=[]).push("3.3.2");var mt=(n,s,e)=>{let t=e?.renderBefore??s,r=t._$litPart$;if(r===void 0){let i=e?.renderBefore??null;t._$litPart$=r=new he(s.insertBefore(le(),i),i,void 0,e??{})}return r._$AI(n),r};var qe=globalThis,f=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=mt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return J}};f._$litElement$=!0,f.finalized=!0,qe.litElementHydrateSupport?.({LitElement:f});var Xt=qe.litElementPolyfillSupport;Xt?.({LitElement:f});(qe.litElementVersions??=[]).push("4.2.2");var g=n=>(s,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(n,s)}):customElements.define(n,s)};var Zt={attribute:!0,type:String,converter:ae,reflect:!1,hasChanged:ye},Qt=(n=Zt,s,e)=>{let{kind:t,metadata:r}=e,i=globalThis.litPropertyMetadata.get(r);if(i===void 0&&globalThis.litPropertyMetadata.set(r,i=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),i.set(e.name,n),t==="accessor"){let{name:a}=e;return{set(u){let h=s.get.call(this);s.set.call(this,u),this.requestUpdate(a,h,n,!0,u)},init(u){return u!==void 0&&this.C(a,void 0,n,u),u}}}if(t==="setter"){let{name:a}=e;return function(u){let h=this[a];s.call(this,u),this.requestUpdate(a,h,n,!0,u)}}throw Error("Unsupported decorator location: "+t)};function c(n){return(s,e)=>typeof e=="object"?Qt(n,s,e):((t,r,i)=>{let a=r.hasOwnProperty(i);return r.constructor.createProperty(i,t),a?Object.getOwnPropertyDescriptor(r,i):void 0})(n,s,e)}function m(n){return c({...n,state:!0,attribute:!1})}function C(n,s,e){let t=n?.localize?.(s);return t&&t!==s?t:e}function Ve(n){let s=n.replaceAll("_"," ").toLowerCase();return s.charAt(0).toUpperCase()+s.slice(1)}function te(n,s){return C(n,`component.ambience.matcher.${s}`,Ve(s))}function pt(n,s){return C(n,`component.ambience.action.${s}`,Ve(s))}function re(n,s){return C(n,`component.ambience.anchor.${s}`,Ve(s))}function Y(n,s,e){let t=e[s]?.label;if(t)return t;let r=s.charAt(0).toUpperCase()+s.slice(1);return C(n,`component.ambience.time_of_day_period.${s}`,r)}function o(n,s,e){return C(n,`component.ambience.${s}`,e)}var er=["mon","tue","wed","thu","fri","sat","sun"],tr=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];function we(n,s){return C(n,`component.ambience.weekday.${er[s]}`,tr[s]??String(s))}var rr={weekday:"Day of week",day_of_month:"Day of month",date:"Date (annual)",date_range:"Date range (annual)",last_day:"Last day of month",workday:"Workday",holiday:"Holiday",first_workday:"First workday of month",last_workday:"Last workday of month"};function ke(n,s){return C(n,`component.ambience.day_item.${s}`,rr[s]??s)}var sr=["January","February","March","April","May","June","July","August","September","October","November","December"];function se(n,s){return C(n,`component.ambience.month.${s}`,sr[s-1]??String(s))}var ir={"clear-night":"Clear (night)",cloudy:"Cloudy",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning-rainy",partlycloudy:"Partly cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy-rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy (variant)",exceptional:"Exceptional"};function xe(n,s){return C(n,`component.ambience.weather_condition.${s}`,ir[s]??s)}var nr={temperature:"Temperature",apparent_temperature:"Apparent temperature",humidity:"Humidity",wind_speed:"Wind speed",pressure:"Pressure"};function ce(n,s){return C(n,`component.ambience.weather_attr.${s}`,nr[s]??s)}var ar={temperature:"\xB0C",apparent_temperature:"\xB0C",humidity:"%",wind_speed:"m/s",pressure:"hPa"},or={temperature:"temperature",apparent_temperature:"temperature",wind_speed:"wind_speed",pressure:"pressure"},lr={temperature:"temperature_unit",apparent_temperature:"temperature_unit",wind_speed:"wind_speed_unit",pressure:"pressure_unit"};function Be(n,s,e){if(s==="humidity")return"%";let t=lr[s];if(t){let a=e?.attributes?.[t];if(typeof a=="string"&&a)return a}let r=or[s],i=n?.config?.unit_system;return r&&i&&typeof i[r]=="string"?i[r]:ar[s]??""}var dr={is:"is",is_not:"is not",">":">",">=":"\u2265","<":"<","<=":"\u2264",and:"AND",or:"OR",and_not:"AND NOT",or_not:"OR NOT",not:"NOT"};function P(n,s){return C(n,`component.ambience.state_op.${s}`,dr[s]??s)}var ur=["ha-input","ha-textfield","ha-form"],hr=["ha-input","ha-textfield"];function ft(){for(let n of hr)if(customElements.get(n))return n;return null}function W(n,s){for(let e of ur)customElements.get(e)||customElements.whenDefined(e).then(()=>n.requestUpdate())}async function _t(n){return n.callWS({type:"ambience/areas/list"})}async function gt(n,s){return n.callWS({type:"ambience/area/get",area_id:s})}async function vt(n,s,e){return n.callWS({type:"ambience/area/save",area_id:s,config:e})}async function Ee(n){return n.callWS({type:"ambience/matchers/list"})}async function yt(n){return n.callWS({type:"ambience/actions/list"})}async function Se(n){return n.callWS({type:"ambience/time_of_day_periods/list"})}async function bt(n,s,e){return n.callWS({type:"ambience/time_of_day_periods/save",custom:s,hidden:e})}async function Ce(n){return n.callWS({type:"ambience/matchers/enabled/list"})}async function $t(n,s){return n.callWS({type:"ambience/matchers/enabled/save",enabled:s})}async function Pe(n){return n.callWS({type:"ambience/matchers/day/config/list"})}async function wt(n,s,e){return n.callWS({type:"ambience/matchers/day/config/save",workday_sensor:s,workday_calendar:e})}async function Te(n){return n.callWS({type:"ambience/matchers/weather/config/list"})}async function kt(n,s,e){return n.callWS({type:"ambience/matchers/weather/config/save",entity:s,groups:e})}async function xt(n,s){return n.callWS({type:"ambience/state/known_states",entity_id:s})}function Le(n,s="New rule"){if(n.name&&n.name.trim())return n.name;let e=n.when?.scene;return typeof e=="string"&&e.trim()?e:s}function Ne(n,s,e){return s==null?o(e.hass,"ui.summary_any_paren","(any)"):n==="time_of_day"?De(s,e):n==="day"?cr(s,e):n==="weather"?fr(s,e):n==="state"?Ke(s,e):String(s)}function cr(n,s={}){if(n===null)return o(s.hass,"day_summary.any","any");let e=n.include??[],t=n.exclude??[],r=e.length===0?o(s.hass,"day_summary.any_day","any day"):e.map(a=>Et(a,s)).join(", ");if(t.length===0)return r;let i=o(s.hass,"day_summary.except","except");return`${r} (${i} ${t.map(a=>Et(a,s)).join(", ")})`}function Et(n,s){switch(n.kind){case"weekday":return n.days.map(e=>we(s.hass,e)).join("/");case"day_of_month":return`${o(s.hass,"day_summary.day_prefix","day")} ${n.days}`;case"date":return`${se(s.hass,n.month)} ${n.day}`;case"date_range":return`${se(s.hass,n.from.month)} ${n.from.day} \u2192 ${se(s.hass,n.to.month)} ${n.to.day}`;case"last_day":return o(s.hass,"day_summary.last_day","last day");case"workday":return o(s.hass,"day_summary.workday","workday");case"holiday":return o(s.hass,"day_summary.holiday","holiday");case"first_workday":return o(s.hass,"day_summary.first_workday","first workday");case"last_workday":return o(s.hass,"day_summary.last_workday","last workday")}}var mr={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function pr(n){return n.split(/[\s_-]+/).filter(s=>s!=="").map(s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase()).join(" ")}function fr(n,s={}){if(n===null)return o(s.hass,"ui.summary_any","any");let e=new Map((s.weatherGroups??[]).map(a=>[a.id,a.label])),t=(n.groups??[]).map(a=>e.get(a)??pr(a)).join("/"),r=(n.thresholds??[]).map(a=>`${ce(s.hass,a.attribute)} ${mr[a.op]??a.op} ${a.value}`).join(", "),i=[t,r].filter(a=>a!=="");return i.length===0?o(s.hass,"ui.summary_any","any"):i.join(", ")}function _r(n,s){let t=n.hass?.states?.[s]?.attributes?.friendly_name;return typeof t=="string"&&t?t:s}function Ke(n,s={}){return n==null?o(s.hass,"ui.summary_any","any"):He(n,s)}function He(n,s){if(n.kind==="is"||n.kind==="is_not"||n.kind===">"||n.kind===">="||n.kind==="<"||n.kind==="<="){let e=P(s.hass,n.kind),r=n.kind!=="is"&&n.kind!=="is_not"?n.states[0]??"":n.states.join("/"),i=_r(s,n.entity_id),u=`${n.attribute?`${i}.${n.attribute}`:i} ${e} ${r}`;return n.for&&vr(n.for)?`${u} ${o(s.hass,"ui.for_prefix","for")} \u2265${yr(n.for)}`:u}if(n.kind==="and"||n.kind==="or"){let e=` ${P(s.hass,n.kind)} `;return n.items.map(t=>gr(t,s)).join(e)}return n.kind==="not"?`${P(s.hass,"not")} (${He(n.item,s)})`:""}function gr(n,s){return n.kind==="and"||n.kind==="or"?`(${He(n,s)})`:He(n,s)}function vr(n){return n.h>0||n.m>0||n.s>0}function yr(n){let s=[];return n.h&&s.push(`${n.h}h`),n.m&&s.push(`${n.m}m`),n.s&&s.push(`${n.s}s`),s.length?s.join(" "):"0s"}function De(n,s){if(n===null)return o(s.hass,"ui.summary_any","any");let e=Array.isArray(n)?n:[n],t=s.periods?.custom??{};return e.map(r=>"period"in r?Y(s.hass,r.period,t):`${St(r.from,s)} \u2192 ${St(r.to,s)}`).join(", ")}function St(n,s){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;let e=re(s.hass,n.anchor);if(n.offset_min===0)return e;let t=Math.abs(n.offset_min),r=t%60===0?`${t/60}${o(s.hass,"ui.unit_hour_abbr","h")}`:`${t}${o(s.hass,"ui.unit_min_abbr","m")}`;return`${e}${n.offset_min<0?"-":"+"}${r}`}function Ct(n,s,e){let t=pt(e.hass,n.action),r=s?.domains?.[0]??o(e.hass,"ui.target_noun","target"),i=n.entity_ids.length,a;i===0?a=o(e.hass,"ui.no_targets","(no targets)"):i===1?a=`1 ${r}`:a=`${i} ${r}s`;let u={};for(let p of s?.target_params??[])p.unit&&(u[p.name]=p.unit);let h=Object.entries(n.params).filter(([,p])=>p!=null&&p!=="").map(([p,v])=>`${p} ${v}${u[p]??""}`).join(", ");return h?`${t}: ${a}, ${h}`:`${t}: ${a}`}var x=class extends f{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this._dragFrom=null;this._dragOver=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_summary(e){let t=new Map((this.matchers??[]).map(h=>[h.name,h.priority])),r=Object.keys(e.when).filter(h=>e.when[h]!=null&&(h==="scene"||!this.enabledMatchers||this.enabledMatchers.includes(h))).sort((h,p)=>(t.get(h)??1/0)-(t.get(p)??1/0)),i=r.length===0?o(this.hass,"ui.summary_any","any"):r.map(h=>`${te(this.hass,h)}: ${Ne(h,e.when[h],{hass:this.hass,periods:this.periods,weatherGroups:this.weatherConfig?.groups})}`).join(", "),a=e.actions.length,u=a===1?o(this.hass,"ui.action_singular","action"):o(this.hass,"ui.action_plural","actions");return`${i} \xB7 ${a} ${u}`}_onDragStart(e){this._dragFrom=e}_onDragOver(e,t){this._dragFrom===null||t===this._dragFrom||(e.preventDefault(),this._dragOver=t)}_onDrop(e){let t=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(t===null||t===e)&&this._emit("reorder-rules",{from:t,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,t){let r=t.name||o(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(e+1));window.confirm(o(this.hass,"ui.confirm_delete",'Delete "{name}"?').replace("{name}",r))&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
  ...
  `,d([c({attribute:!1})],I.prototype,"hass",2),d([c({attribute:!1})],I.prototype,"value",2),d([c({attribute:!1})],I.prototype,"groups",2),d([c({attribute:!1})],I.prototype,"weatherEntity",2),I=d([g("ambience-weather-predicate-input")],I);var w=class extends f{constructor(){super(...arguments);this.value={kind:"is",entity_id:"",states:[]};this._knownStates=[]}async updated(e){if(e.has("value")){let r=e.get("value")?.entity_id,i=this.value.entity_id;if(i&&i!==r&&this.hass)try{let a=await xt(this.hass,i);this._knownStates=a.states}catch{this._knownStates=[]}}}_normalize(e){let t={...e};return t.attribute===""&&(t.attribute=null),t.for&&t.for.h===0&&t.for.m===0&&t.for.s===0&&(t.for=null),t}_emit(e){let t=this._normalize(e);this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t},bubbles:!0,composed:!0}))}_autoFlipOp(e){let t=this._isNumericTargetFor(e),r=this._isNumericOp(e.kind);return t&&!r?{...e,kind:">"}:!t&&r?{...e,kind:"is"}:e}_setEntity(e){this._emit(this._autoFlipOp({...this.value,entity_id:e,states:[],attribute:null}))}_setAttribute(e){this._emit(this._autoFlipOp({...this.value,attribute:e}))}_setOp(e){this._emit({...this.value,kind:e})}_setStates(e){this._emit({...this.value,states:e})}_setValueAt(e,t){if(this._isNumericOp(this.value.kind)){this._setStates([t]);return}let r=this.value.states.slice();t===""?r.splice(e,1):r[e]=t,this._setStates(r)}_addValue(e){e&&this._setStates([...this.value.states,e])}_removeValueAt(e){let t=this.value.states.slice();t.splice(e,1),this._setStates(t)}_setForDuration(e){this._emit({...this.value,for:e})}_entitySchema(){return[{name:"entity_id",required:!0,selector:{entity:{}}}]}_knownAttributesFor(e){if(!e)return[];let r=this.hass?.states?.[e]?.attributes;return r?Object.keys(r).sort():[]}_attributeSchema(){let e=this._knownAttributesFor(this.value.entity_id);return[{name:"attribute",selector:{select:{mode:"dropdown",custom_value:!0,options:[{value:w._STATE_SENTINEL,label:w._STATE_SENTINEL},...e.map(t=>({value:t,label:t}))]}}}]}_attributeData(){let e=this.value.attribute;return e?{attribute:e}:{attribute:w._STATE_SENTINEL}}_setAttributeFromHaForm(e){e===w._STATE_SENTINEL?this._setAttribute(""):this._setAttribute(e)}_isNumericOp(e){return w._NUMERIC_OPS.includes(e)}_isNumericTargetFor(e){let r=this.hass?.states?.[e.entity_id];if(!r)return!1;if(e.attribute)return typeof r.attributes?.[e.attribute]=="number";let i=r.state;return typeof i!="string"||i===""||i==="unknown"||i==="unavailable"?!1:Number.isFinite(Number(i))}_opSchema(){let e=this._isNumericTargetFor(this.value)?[...w._NUMERIC_OPS]:["is","is_not"];return e.includes(this.value.kind)||e.push(this.value.kind),[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:e.map(t=>({value:t,label:P(this.hass,t)}))}}}]}_currentAttributeValue(){return this.value.attribute?this.hass?.states?.[this.value.entity_id]?.attributes?.[this.value.attribute]:void 0}_valueSchema(){if(this._isNumericOp(this.value.kind))return[{name:"value",selector:{number:{mode:"box",step:"any"}}}];let e;if(this.value.attribute){let t=this._currentAttributeValue();e=t==null?[]:[String(t)]}else e=this._knownStates;return[{name:"value",selector:{select:{mode:"dropdown",custom_value:!0,options:e.map(t=>({value:t,label:t}))}}}]}_forSchema(){return[{name:"duration",selector:{duration:{enable_day:!1}}}]}_forData(){let e=this.value.for??{h:0,m:0,s:0};return{duration:{hours:e.h,minutes:e.m,seconds:e.s}}}_setForFromHaForm(e){this._setForDuration({h:e?.hours??0,m:e?.minutes??0,s:e?.seconds??0})}_renderEntity(){return customElements.get("ha-form")?l`<ha-form
        data-field="entity"
        .hass=${this.hass}
  ...
  `,w._STATE_SENTINEL="State",w._NUMERIC_OPS=[">",">=","<","<="],d([c({attribute:!1})],w.prototype,"hass",2),d([c({attribute:!1})],w.prototype,"value",2),d([m()],w.prototype,"_knownStates",2),w=d([g("ambience-state-expr-atom")],w);function At(n,s){return n===null||s===null||n.length!==s.length?!1:n.every((e,t)=>e===s[t])}var T=class extends f{constructor(){super(...arguments);this.path=[];this.openPath=null;this.errorPath=null;this.errorMessage=null}_emit(e,t={}){this.dispatchEvent(new CustomEvent(e,{detail:{path:this.path,...t},bubbles:!0,composed:!0}))}_emitAt(e,t,r={}){this.dispatchEvent(new CustomEvent(t,{detail:{path:e,...r},bubbles:!0,composed:!0}))}_atomIsComplete(e){return!!e.entity_id&&e.states.some(t=>t!=="")}_isErrorTarget(){return At(this.path,this.errorPath)}_renderAtomCard(e){let t=this._atomIsComplete(e),r=At(this.path,this.openPath),i=t?Ke(e,{hass:this.hass}):o(this.hass,"ui.state_new_condition","(new condition)");return l`
    ...
    `}render(){let e=this.value.kind==="not",t=e?this.value.item:this.value;return t.kind==="and"||t.kind==="or"?this._renderGroup(t,e):this._renderAtomCard(t)}};T.styles=_`
    :host { display: block; }
    .group {
      border: 1px solid var(--divider-color, #e0e0e0);
      border-radius: 4px;
  ...
  `,d([c({attribute:!1})],T.prototype,"hass",2),d([c({attribute:!1})],T.prototype,"value",2),d([c({attribute:!1})],T.prototype,"path",2),d([c({attribute:!1})],T.prototype,"openPath",2),d([c({attribute:!1})],T.prototype,"errorPath",2),d([c({attribute:!1})],T.prototype,"errorMessage",2),T=d([g("ambience-state-expr-node")],T);function Er(n,s){return n===null||s===null||n.length!==s.length?!1:n.every((e,t)=>e===s[t])}var R=class extends f{constructor(){super(...arguments);this.value=null;this._openPath=null;this._showError=!1;this._onNodeChange=e=>{e.stopPropagation(),this._replaceAt(e.detail.path,e.detail.value)};this._onNodeRemove=e=>{e.stopPropagation(),this._removeAt(e.detail.path)};this._onNodeWrap=e=>{e.stopPropagation(),this._wrapAt(e.detail.path,e.detail.op)};this._onNodeAddChild=e=>{e.stopPropagation(),this._addChildAt(e.detail.path,"is")};this._onNodeToggleNot=e=>{e.stopPropagation(),this._toggleNotAt(e.detail.path)};this._onNodeSetOp=e=>{e.stopPropagation(),this._setGroupOpAt(e.detail.path,e.detail.op)};this._onNodeOpen=e=>{if(e.stopPropagation(),this._openPath!==null){let t=this._atomAt(this._openPath);if(t&&this._atomError(t)!==null){this._showError=!0;return}}this._openPath!==null&&Er(this._openPath,e.detail.path)?this._openPath=null:this._openPath=e.detail.path,this._showError=!1}}connectedCallback(){super.connectedCallback(),this.addEventListener("node-change",this._onNodeChange),this.addEventListener("node-remove",this._onNodeRemove),this.addEventListener("node-wrap",this._onNodeWrap),this.addEventListener("node-add-child",this._onNodeAddChild),this.addEventListener("node-toggle-not",this._onNodeToggleNot),this.addEventListener("node-set-op",this._onNodeSetOp),this.addEventListener("node-open",this._onNodeOpen)}_emit(e){this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_emptyAtom(){return{kind:"is",entity_id:"",states:[]}}_addFirstAtom(){this._openPath=[],this._emit(this._emptyAtom())}_replaceAt(e,t){let r=this._patch(this.value,e,()=>t);this._emit(r)}_removeAt(e){if(e.length===0){this._emit(null);return}let t=this._patch(this.value,e,()=>null);this._emit(t)}_wrapAt(e,t){let r=this._patch(this.value,e,i=>i&&{kind:t,items:[i]});this._emit(r)}_addChildAt(e,t){let r=null,i=this._patch(this.value,e,a=>{if(a&&(a.kind==="and"||a.kind==="or")){let u=[...a.items,this._emptyAtom()];return r=[...e,u.length-1],{...a,items:u}}return a});r!==null&&(this._openPath=r),this._emit(i)}_toggleNotAt(e){let t=this._patch(this.value,e,r=>r&&(r.kind==="not"?r.item:{kind:"not",item:r}));this._emit(t)}_setGroupOpAt(e,t){let r=t==="and_not"||t==="or_not",i=t==="and"||t==="and_not"?"and":"or",a=this._patch(this.value,e,u=>{if(!u)return u;let h=null;if(u.kind==="and"||u.kind==="or")h=u;else if(u.kind==="not"){let v=u.item;(v.kind==="and"||v.kind==="or")&&(h=v)}if(!h)return u;let p={kind:i,items:h.items};return r?{kind:"not",item:p}:p});this._emit(a)}_patch(e,t,r){if(t.length===0)return r(e);if(e==null)return e;let[i,...a]=t;if(e.kind==="and"||e.kind==="or"){let u=e.items.slice(),h=this._patch(u[i],a,r);return h===null?u.splice(i,1):u[i]=h,u.length===0?null:u.length===1?u[0]:{...e,items:u}}if(e.kind==="not"){let u=this._patch(e.item,t,r);return u==null?null:{kind:"not",item:u}}return e}_atomAt(e){return this._walk(this.value,e)}_walk(e,t){return e?e.kind==="not"?this._walk(e.item,t):t.length===0?e.kind==="and"||e.kind==="or"?null:e:e.kind==="and"||e.kind==="or"?this._walk(e.items[t[0]]??null,t.slice(1)):null:null}_atomError(e){if(!e.entity_id)return o(this.hass,"ui.state_err_entity","Entity is required");if(e.kind!=="is"&&e.kind!=="is_not"){let r=e.states[0];if(!r)return o(this.hass,"ui.state_err_value","Value is required");if(!Number.isFinite(Number(r)))return o(this.hass,"ui.state_err_numeric","Value must be a number")}else if(!e.states.some(r=>r!==""))return o(this.hass,"ui.state_err_state","State is required");return null}willUpdate(e){if(e.has("value")){let t=this.value;if(t&&this._openPath===null&&t.kind!=="and"&&t.kind!=="or"&&(this._openPath=[]),this._showError&&this._openPath!==null){let r=this._atomAt(this._openPath);(!r||this._atomError(r)===null)&&(this._showError=!1)}}}_addAtRoot(){let e=this.value;if(e==null){this._addFirstAtom();return}if(e.kind==="and"||e.kind==="or"){this._addChildAt([],"is");return}this._openPath=[1],this._emit({kind:"and",items:[e,this._emptyAtom()]})}_setOpen(e){this._openPath=e}_renderRootToolbar(){return l`
  ...
  `,d([c({attribute:!1})],k.prototype,"hass",2),d([m()],k.prototype,"_areas",2),d([m()],k.prototype,"_matchers",2),d([m()],k.prototype,"_actions",2),d([m()],k.prototype,"_periods",2),d([m()],k.prototype,"_dayConfig",2),d([m()],k.prototype,"_weatherConfig",2),d([m()],k.prototype,"_configs",2),d([m()],k.prototype,"_expanded",2),d([m()],k.prototype,"_error",2),d([m()],k.prototype,"_editing",2),d([m()],k.prototype,"_enabledMatchers",2),k=d([g("ambience-areas-list")],k);var N=class extends f{constructor(){super(...arguments);this.matcherName="";this.matcherDescription="";this.enabled=!1;this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}_onToggle(e){e.stopPropagation();let t=e.target.checked;this.dispatchEvent(new CustomEvent("enable-changed",{detail:{enabled:t},bubbles:!0,composed:!0}))}render(){let e=te(this.hass,this.matcherName);return l`
      <div class="card">
