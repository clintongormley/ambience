...
`;function at(t,n){return l`<span class="category-swatch" style=${dr(t)}>
    ...
    `],u([m({attribute:!1})],oe.prototype,"hass",2),u([g()],oe.prototype,"_categories",2),u([g()],oe.prototype,"_filterCategory",2),u([g()],oe.prototype,"_open",2),u([g()],oe.prototype,"_loaded",2),oe=u([w("ambience-category-filter")],oe);var me={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ur=t=>(...n)=>({_$litDirective$:t,values:n}),lt=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,e,r){this._$Ct=n,this._$AM=e,this._$Ci=r}_$AS(n,e){return this.update(n,e)}update(n,e){return this.render(...e)}};var{I:Yo}=Ji,Mn=t=>t;var zn=t=>t.strings===void 0,jn=()=>document.createComment(""),dt=(t,n,e)=>{let r=t._$AA.parentNode,i=n===void 0?t._$AB:n._$AA;if(e===void 0){let s=r.insertBefore(jn(),i),o=r.insertBefore(jn(),i);e=new Yo(s,o,t,t.options)}else{let s=e._$AB.nextSibling,o=e._$AM,a=o!==t;if(a){let c;e._$AQ?.(t),e._$AM=t,e._$AP!==void 0&&(c=t._$AU)!==o._$AU&&e._$AP(c)}if(s!==i||a){let c=e._$AA;for(;c!==s;){let h=Mn(c).nextSibling;Mn(r).insertBefore(c,i),c=h}}}return e},ke=(t,n,e=t)=>(t._$AI(n,e),t),Go={},hr=(t,n=Go)=>t._$AH=n,Un=t=>t._$AH,pr=t=>{t._$AR(),t._$AA.remove()};var ai=ur(class extends lt{constructor(t){if(super(t),t.type!==me.PROPERTY&&t.type!==me.ATTRIBUTE&&t.type!==me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!zn(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[n]){if(n===q||n===$)return n;let e=t.element,r=t.name;if(t.type===me.PROPERTY){if(n===e[r])return q}else if(t.type===me.BOOLEAN_ATTRIBUTE){if(!!n===e.hasAttribute(r))return q}else if(t.type===me.ATTRIBUTE&&e.getAttribute(r)===n+"")return q;return hr(t),n}});var Wn=(t,n,e)=>{let r=new Map;for(let i=n;i<=e;i++)r.set(t[i],i);return r},Bn=ur(class extends lt{constructor(t){if(super(t),t.type!==me.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,n,e){let r;e===void 0?e=n:n!==void 0&&(r=n);let i=[],s=[],o=0;for(let a of t)i[o]=r?r(a,o):o,s[o]=e(a,o),o++;return{values:s,keys:i}}render(t,n,e){return this.dt(t,n,e).values}update(t,[n,e,r]){let i=Un(t),{values:s,keys:o}=this.dt(n,e,r);if(!Array.isArray(i))return this.ut=o,s;let a=this.ut??=[],c=[],h,p,f=0,_=i.length-1,y=0,k=s.length-1;for(;f<=_&&y<=k;)if(i[f]===null)f++;else if(i[_]===null)_--;else if(a[f]===o[y])c[y]=ke(i[f],s[y]),f++,y++;else if(a[_]===o[k])c[k]=ke(i[_],s[k]),_--,k--;else if(a[f]===o[k])c[k]=ke(i[f],s[k]),dt(t,c[k+1],i[f]),f++,k--;else if(a[_]===o[y])c[y]=ke(i[_],s[y]),dt(t,i[f],i[_]),_--,y++;else if(h===void 0&&(h=Wn(o,y,k),p=Wn(a,f,_)),h.has(a[f]))if(h.has(a[_])){let E=p.get(o[y]),L=E!==void 0?i[E]:null;if(L===null){let V=dt(t,i[f]);ke(V,s[y]),c[y]=V}else c[y]=ke(L,s[y]),dt(t,i[f],L),i[E]=null;y++}else pr(i[_]),_--;else pr(i[f]),f++;for(;y<=k;){let E=dt(t,c[k+1]);ke(E,s[y]),c[y++]=E}for(;f<=_;){let E=i[f++];E!==null&&pr(E)}return this.ut=o,hr(t,c),q}});function O(t){return t.kind==="house"?"house":`${t.kind}:${t.id}`}function mr(t,n){return`${O(t)}\0${n}`}function Vn(t,n){if(!n||n.entity==null)return[...t];let e=Array.isArray(n.entity)?n.entity:[n.entity];if(e.length===0)return[...t];let r=new Set,i=!1;for(let s of e){if(!s||typeof s!="object")continue;let o=s.domain;if(o==null){i=!0;continue}if(Array.isArray(o))for(let a of o)typeof a=="string"&&r.add(a);else typeof o=="string"&&r.add(o)}return i||r.size===0?[...t]:t.filter(s=>{let o=s.indexOf(".");return o<0?!1:r.has(s.slice(0,o))})}function fr(t,n,e=[]){let r=t;if(!r?.entities)return[];let i=r.entities,s=r.devices??{},o=r.areas??{},a=n.kind==="area"?new Set([n.id]):n.kind==="floor"?new Set(Object.values(o).filter(h=>h.floor_id===n.id).map(h=>h.area_id)):null,c=h=>{let p=h.area_id??(h.device_id?s[h.device_id]?.area_id??null:null);return p==null?!1:a===null?!0:a.has(p)};return Object.values(i).filter(c).filter(h=>e.length===0||e.includes(h.entity_id.split(".")[0])).map(h=>h.entity_id).sort()}function Tt(t){let{priority:n,pinned:e,shadowed_by:r,...i}=t;return i}function qn(t,n){if(n<0||n>=t.length)return[];let e=new Set(t[n].entity_ids??[]),r=new Set;return t.forEach((i,s)=>{if(s!==n)for(let o of i.entity_ids??[])e.has(o)||r.add(o)}),[...r]}var li={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Lt(t,n){return t.kind==="house"?li.house:t.kind==="floor"?n?.floors?.[t.id]?.icon||li.floor:n?.areas?.[t.id]?.icon||li.area}function Ve(t){return t.enabled===!1?{scenes:t.scenes??[],enabled:!1}:{scenes:t.scenes??[]}}function I(){return(t,n)=>{let e=Symbol(String(n));Object.defineProperty(t,n,{get(){return this[e]},set(r){Object.is(this[e],r)||(this[e]=r,this._host?.requestUpdate())},configurable:!0,enumerable:!0})}}var P=class{constructor(n){this._host=n;this.areas=[];this.floors=[];this.areaConfigs=new Map;this.floorConfigs=new Map;this.house={scenes:[]};this.switchEntityIds=new Map;this.areasLoaded=!1;this.conditions=[];this.actions=[];this.categories=[];this.schemas={};this.staticLoaded=!1;this.error="";this._onExposedActionsChanged=async()=>{try{let n=await Et(this._hass);if(!this._host.isConnected)return;this.actions=n,await this._refreshSchemas(n)}catch{}};this._onCategoriesChanged=async()=>{try{let n=await Be(this._hass);if(!this._host.isConnected)return;this.categories=n}catch{}};this._onConditionsChanged=async()=>{try{let[n,e]=await Promise.all([St(this._hass),Ct(this._hass)]);if(!this._host.isConnected)return;this.dayConfig=n,this.weatherConfig=e}catch{}};n.addController(this)}get _hass(){return this._host.hass}hostConnected(){window.addEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.addEventListener("ambience-categories-changed",this._onCategoriesChanged),window.addEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick=setInterval(()=>{for(let n of this.switchEntityIds.values())if(this._hass.states?.[n]?.state==="off"){this._host.requestUpdate();return}},1e3)}hostDisconnected(){window.removeEventListener("ambience-exposed-actions-changed",this._onExposedActionsChanged),window.removeEventListener("ambience-categories-changed",this._onCategoriesChanged),window.removeEventListener("ambience-conditions-changed",this._onConditionsChanged),this._tick&&clearInterval(this._tick),this._tick=void 0,this._unsubArea?.(),this._unsubArea=void 0,this._unsubFloor?.(),this._unsubFloor=void 0}async subscribe(n){let e=this._hass.connection.subscribeEvents(o=>{o.data.action==="remove"&&n({kind:"area",id:o.data.area_id}),this.refreshAreas(),o.data.action!=="update"&&this.refreshSwitches()},"area_registry_updated"),r=this._hass.connection.subscribeEvents(o=>{o.data.action==="remove"&&n({kind:"floor",id:o.data.floor_id}),this.refreshFloors(),o.data.action!=="update"&&this.refreshSwitches()},"floor_registry_updated"),[i,s]=await Promise.all([e,r]);this._host.isConnected?(this._unsubArea=i,this._unsubFloor=s):(i(),s())}async loadStatic(){try{let[n,e,r,i,s,o,a]=await Promise.all([or(this._hass),Et(this._hass),ar(this._hass),lr(this._hass),St(this._hass),Ct(this._hass),Be(this._hass)]);if(!this._host.isConnected)return;this.conditions=n,this.actions=e,this.periods=r,this.luxRanges=i,this.dayConfig=s,this.weatherConfig=o,this.categories=a,this.staticLoaded=!0,await this._refreshSchemas(e)}catch(n){this.error=n.message||String(n)}}async _refreshSchemas(n){let e=await Promise.all(n.map(async i=>{try{let s=await $e(this._hass,i.id);return[i.id,s]}catch{return[i.id,null]}}));if(!this._host.isConnected)return;let r={};for(let[i,s]of e)s&&(r[i]=s);this.schemas=r}async refreshAreas(){try{let n=await gn(this._hass),e=this.areaConfigs,r=new Map;if(await Promise.all(n.map(async i=>{let s=e.get(i.area_id);if(s){r.set(i.area_id,s);return}r.set(i.area_id,Ve(await Xr(this._hass,i.area_id)))})),!this._host.isConnected)return;this.areas=n,this.areaConfigs=r}catch(n){this.error=n.message||String(n)}finally{this._host.isConnected&&(this.areasLoaded=!0)}}async refreshFloors(){try{let n=(await vn(this._hass)).slice().sort((i,s)=>i.name.localeCompare(s.name)),e=this.floorConfigs,r=new Map;if(await Promise.all(n.map(async i=>{let s=e.get(i.floor_id);if(s){r.set(i.floor_id,s);return}r.set(i.floor_id,Ve(await Jr(this._hass,i.floor_id)))})),!this._host.isConnected)return;this.floors=n,this.floorConfigs=r}catch(n){this.error=n.message||String(n)}}async refreshHouse(){try{let n=Ve(await Zr(this._hass));if(!this._host.isConnected)return;this.house=n}catch(n){this.error=n.message||String(n)}}async refreshSwitches(){try{let n=await Pn(this._hass);if(!this._host.isConnected)return;this.switchEntityIds=new Map(n.map(e=>{let r=e.scope_kind==="house"?{kind:"house"}:{kind:e.scope_kind,id:e.scope_id};return[O(r),e.entity_id]}))}catch(n){this.error=n.message||String(n)}}getConfig(n){return n.kind==="house"?this.house:n.kind==="area"?this.areaConfigs.get(n.id):this.floorConfigs.get(n.id)}setConfig(n,e){if(n.kind==="house")this.house=e;else if(n.kind==="area"){let r=new Map(this.areaConfigs);r.set(n.id,e),this.areaConfigs=r}else{let r=new Map(this.floorConfigs);r.set(n.id,e),this.floorConfigs=r}}async mutate(n,e){let r=this.getConfig(n);this.setConfig(n,e),this.error="";try{let i;return n.kind==="house"?i=await bn(this._hass,e):n.kind==="area"?i=await _n(this._hass,n.id,e):i=await yn(this._hass,n.id,e),this.setConfig(n,Ve(i.config)),!0}catch(i){return r&&this.setConfig(n,r),this.error=i.message||String(i),!1}}async reloadScope(n){try{let e;if(n.kind==="house"?e=Ve(await Zr(this._hass)):n.kind==="area"?e=Ve(await Xr(this._hass,n.id)):e=Ve(await Jr(this._hass,n.id)),!this._host.isConnected)return;this.setConfig(n,e)}catch(e){this.error=e.message||String(e)}}};u([I()],P.prototype,"areas",2),u([I()],P.prototype,"floors",2),u([I()],P.prototype,"areaConfigs",2),u([I()],P.prototype,"floorConfigs",2),u([I()],P.prototype,"house",2),u([I()],P.prototype,"switchEntityIds",2),u([I()],P.prototype,"areasLoaded",2),u([I()],P.prototype,"conditions",2),u([I()],P.prototype,"actions",2),u([I()],P.prototype,"categories",2),u([I()],P.prototype,"schemas",2),u([I()],P.prototype,"periods",2),u([I()],P.prototype,"luxRanges",2),u([I()],P.prototype,"dayConfig",2),u([I()],P.prototype,"weatherConfig",2),u([I()],P.prototype,"staticLoaded",2),u([I()],P.prototype,"error",2);var fe=class extends b{constructor(){super(...arguments);this.items=[];this._open=!1;this._onKeydown=e=>{e.key==="Escape"&&this._open&&(this._open=!1)}}_triggerLabel(){return this.label??d(this.hass,"ui.more_actions","More actions")}_select(e,r){r.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("menu-action",{detail:{id:e},bubbles:!0,composed:!0}))}_renderItems(){return this.items.map(e=>l`
    ...
    `}_renderMenu(){return l`
      ...
      ${this._open?l`
          ...
          `:$}
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this._onKeydown)}disconnectedCallback(){this.removeEventListener("keydown",this._onKeydown),super.disconnectedCallback()}render(){return this._renderMenu()}};fe.styles=v`
  ...
  `,u([m({attribute:!1})],fe.prototype,"items",2),u([m({attribute:!1})],fe.prototype,"hass",2),u([m()],fe.prototype,"label",2),u([g()],fe.prototype,"_open",2),fe=u([w("ambience-kebab-menu")],fe);function Qo(t){return t.style.pointerEvents="none",t.style.willChange="transform",()=>{t.style.pointerEvents="",t.style.willChange="",t.style.transform=""}}function gr(t,n,e={}){let r=t.pointerId;try{t.target?.setPointerCapture?.(r)}catch{}let i=e.follow??null,s=t.clientX,o=t.clientY,a=i?Qo(i):null,c=_=>{_.pointerId===r&&(n.onMove(_.clientX,_.clientY),i&&(i.style.transform=`translate(${_.clientX-s}px, ${_.clientY-o}px)`))},h=_=>{_.pointerId===r&&(f(),n.onEnd(_.clientX,_.clientY))},p=_=>{_.pointerId===r&&(f(),n.onCancel())},f=()=>{window.removeEventListener("pointermove",c,!0),window.removeEventListener("pointerup",h,!0),window.removeEventListener("pointercancel",p,!0),a?.()};return window.addEventListener("pointermove",c,!0),window.addEventListener("pointerup",h,!0),window.addEventListener("pointercancel",p,!0),f}function _r(t,n){let e=document.elementFromPoint?.(t,n)??null;if(!e)return null;for(;e.shadowRoot;){let r=e.shadowRoot.elementFromPoint?.(t,n);if(!r||r===e)break;e=r}return e}var ct=class{constructor(n,e,r={}){this.host=n;this.onReorder=e;this.from=null;this.over=null;this.moved=!1;this._cancelDrag=null;this._locate=r.locate??((i,s)=>this._domLocate(i,s)),n.addController(this)}hostDisconnected(){this._reset()}start(n,e){if(!e.isPrimary||e.button>0)return;this._reset(),this.from=n,this.moved=!1,this.host.requestUpdate();let r=e.target?.closest("[data-drag-index]");this._cancelDrag=gr(e,{onMove:(i,s)=>this._hover(this._locate(i,s)),onEnd:(i,s)=>this.drop(this._locate(i,s)),onCancel:()=>this.end()},{follow:r})}_hover(n){if(this.from===null)return;let e=n===null||n===this.from?null:n;e!==null&&(this.moved=!0),this.over!==e&&(this.over=e,this.host.requestUpdate())}drop(n){let e=this.from;this._reset(),!(e===null||n===null||e===n)&&this.onReorder(e,n)}end(){this._reset()}_domLocate(n,e){let r=this.host.renderRoot,s=(r?.elementFromPoint?r.elementFromPoint(n,e):_r(n,e))?.closest?.("[data-drag-index]");if(!s)return null;let o=Number(s.getAttribute("data-drag-index"));return Number.isNaN(o)?null:o}_reset(){this._cancelDrag?.(),this._cancelDrag=null;let n=this.from!==null||this.over!==null;this.from=null,this.over=null,n&&this.host.requestUpdate()}};var Xo={light:"mdi:lightbulb",switch:"mdi:toggle-switch-variant",binary_sensor:"mdi:motion-sensor",sensor:"mdi:eye",person:"mdi:account",device_tracker:"mdi:account",climate:"mdi:thermostat",cover:"mdi:window-shutter",media_player:"mdi:cast",lock:"mdi:lock",fan:"mdi:fan",weather:"mdi:weather-partly-cloudy",input_boolean:"mdi:toggle-switch",event:"mdi:eye-check",script:"mdi:script-text",template:"mdi:code-braces"},di="mdi:eye";function j(t,n){let e=t?.states?.[n]?.attributes?.friendly_name;return typeof e=="string"&&e?e:n}function Jo(t,n){let e=t?.states?.[n]?.attributes?.icon;if(typeof e=="string"&&e)return e;let r=n.split(".")[0];return Xo[r]??di}function Rt(t,n){let e=t?.states?.[n];return e&&customElements.get("ha-state-icon")?l`<ha-state-icon class="row-icon" .hass=${t} .stateObj=${e}></ha-state-icon>`:l`<ha-icon class="row-icon" icon=${Jo(t,n)}></ha-icon>`}var Kn=v`
  .row-icon {
    flex: 0 0 auto;
    color: var(--secondary-text-color, #888);
    --mdc-icon-size: 22px;
...
`;function At(t,n,e){if(n&&e){let r=e[n]?.fields?.[t];if(r&&typeof r=="object"){let i=r.name;if(typeof i=="string"&&i)return i}}return N(t)}function br(t,n="New scene"){return t.name?.trim()?t.name:n}function Dt(t,n,e){return n==null?d(e.hass,"ui.summary_any_paren","(any)"):t==="time_of_day"?xr(n,e):t==="day"?ra(n,e):t==="weather"?aa(n,e):t==="sun"?la(n,e):t==="state"?mi(n,e):t==="script"?ea(n,e):t==="people"?ta(n,e):t==="occupancy"?da(n,e):t==="lux"?ca(n,e):t==="template"?Zo(n,e):String(n)}function Zo(t,n={}){return t===null?d(n.hass,"ui.summary_any_paren","(any)"):typeof t!="object"||typeof t.template!="string"?String(t):t.template}function ea(t,n={}){if(t===null)return d(n.hass,"ui.summary_any_paren","(any)");if(typeof t!="object"||typeof t.script!="string")return String(t);let e=Pt(n,t.script),r=t.args??{},i=Object.keys(r).sort();if(i.length===0)return e;let s=i.map(o=>`${ui(n.hass,t.script,o)}: ${Ee(n.hass,r[o])}`).join(", ");return`${e} (${s})`}function ui(t,n,e){let r=n.replace(/^script\./,""),s=t?.services?.script?.[r]?.fields?.[e]?.name;return typeof s=="string"&&s?s:N(e)}function Pt(t,n){let r=t.hass?.states?.[n]?.attributes?.friendly_name;if(typeof r=="string"&&r)return r;let i=n.indexOf("."),s=i>=0?n.slice(i+1):n;return s.charAt(0).toUpperCase()+s.slice(1)}function Yn(t,n){return t==="home"?d(n.hass,"people_summary.home","Home"):Pt(n,t)}function ta(t,n={}){if(t==null)return d(n.hass,"ui.summary_any","any");let e=t.where??"home";if(Array.isArray(t.who)&&t.who.length===1){let o=Pt(n,t.who[0]),c=t.quant==="nobody"!=!!t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),h=`${o} ${c} ${Yn(e,n)}`;return t.for&&vr(t.for)?`${h} ${d(n.hass,"ui.for_prefix","for")} \u2265${yr(t.for)}`:h}let r;if(Array.isArray(t.who)){let o=t.quant??"any",a=o==="any"?d(n.hass,"ui.people_mode_any","Any of:"):o==="everyone"?d(n.hass,"ui.people_mode_all","All of:"):d(n.hass,"ui.people_mode_none","None of:"),c=t.who.map(h=>Pt(n,h)).join(", ");r=`${a} (${c})`}else{let o=t.quant??"everyone";r=o==="nobody"?d(n.hass,"ui.people_mode_nobody","Nobody"):o==="any"?d(n.hass,"ui.people_mode_anybody","Anybody"):d(n.hass,"ui.people_mode_everybody","Everybody")}let i=t.negate?d(n.hass,"people_summary.is_not_at","is not at"):d(n.hass,"people_summary.is_at","is at"),s=`${r} ${i} ${Yn(e,n)}`;return t.for&&vr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${yr(t.for)}`:s}function ra(t,n={}){if(t===null)return d(n.hass,"day_summary.any","any");let e=t.include??[],r=t.exclude??[],i=e.length===0?d(n.hass,"day_summary.any_day","any day"):e.map(o=>Gn(o,n)).join(", ");if(r.length===0)return i;let s=d(n.hass,"day_summary.except","except");return`${i} (${s} ${r.map(o=>Gn(o,n)).join(", ")})`}function Gn(t,n){switch(t.kind){case"weekday":return t.days.map(e=>ir(n.hass,e)).join("/");case"day_of_month":return`${d(n.hass,"day_summary.day_prefix","Day")} ${t.days}`;case"date":return`${st(n.hass,t.month)} ${t.day}`;case"date_range":return`${st(n.hass,t.from.month)} ${t.from.day} \u2192 ${st(n.hass,t.to.month)} ${t.to.day}`;case"last_day":return d(n.hass,"day_summary.last_day","Last day");case"workday":return d(n.hass,"day_summary.workday","Workday");case"holiday":return d(n.hass,"day_summary.holiday","Holiday");case"first_workday":return d(n.hass,"day_summary.first_workday","First workday");case"last_workday":return d(n.hass,"day_summary.last_workday","Last workday")}}function ia(t){return typeof t=="string"?t:typeof t=="number"||typeof t=="boolean"?String(t):JSON.stringify(t)}var na=["entity_id","device_id","area_id","label_id","floor_id"],Qn=2;function sa(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let n=t;if(!Object.keys(n).every(i=>na.includes(i)))return null;let e=n.entity_id,r=typeof e=="string"?[e]:Array.isArray(e)?e.filter(i=>typeof i=="string"):[];return r.length?r:null}function Ee(t,n){let e=sa(n);if(!e)return ia(n);let r=e.slice(0,Qn).map(o=>Pt({hass:t},o)),i=e.length-Qn;return`[${i>0?`${r.join(", ")} +${i} more`:r.join(", ")}]`}function wr(t){if(!(!t||typeof t!="object")){for(let n of Object.values(t))if(n&&typeof n=="object"){let e=n.unit_of_measurement;if(typeof e=="string"&&e)return e}}}function oa(t){return t.split(/[\s_-]+/).filter(n=>n!=="").map(n=>n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()).join(" ")}function aa(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=new Map((n.weatherGroups??[]).map(o=>[o.id,o.label])),r=(t.groups??[]).map(o=>e.get(o)??oa(o)).join("/"),i=(t.thresholds??[]).map(o=>`${kt(n.hass,o.attribute)} ${J(n.hass,o.op)} ${o.value}`).join(", "),s=[r,i].filter(o=>o!=="");return s.length===0?d(n.hass,"ui.summary_any","any"):s.join(", ")}function la(t,n={}){if(t===null)return d(n.hass,"ui.summary_any","any");let e=[],r=t.elevation;r&&(r.min!=null&&r.max!=null?e.push(`${r.min}\xB0\u2013${r.max}\xB0`):r.min!=null?e.push(`\u2265${r.min}\xB0`):r.max!=null&&e.push(`\u2264${r.max}\xB0`));let i=t.azimuth;if(i){i.sectors?.length&&e.push(i.sectors.join("/"));for(let s of i.ranges??[])e.push(`${s.from}\xB0\u2013${s.to}\xB0`)}return e.length===0?d(n.hass,"ui.summary_any","any"):e.join(", ")}function es(t,n){return j(t.hass,n)}function hi(t,n){return es({hass:t},n)}function da(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(o=>j(n.hass,o)),r=t.occupied===!1?d(n.hass,"occupancy_summary.clear","clear"):d(n.hass,"occupancy_summary.detected","detected"),i=t.negate?`${d(n.hass,"occupancy_summary.not","not")} `:"",s;return e.length===1?s=`${e[0]} is ${i}${r}`:s=`${t.quant==="all"?d(n.hass,"occupancy_summary.all_of","all of"):d(n.hass,"occupancy_summary.any_of","any of")} (${e.join(", ")}) ${i}${r}`,t.for&&vr(t.for)?`${s} ${d(n.hass,"ui.for_prefix","for")} \u2265${yr(t.for)}`:s}function pi(t,n,e="any lux"){return t!=null&&n!=null?`${t}\u2013${n} lx`:n!=null?`<${n} lx`:t!=null?`\u2265${t} lx`:e}function ca(t,n={}){if(t==null||!t.sensors?.length)return d(n.hass,"ui.summary_any","any");let e=t.sensors.map(s=>j(n.hass,s)),r=t.range!=null?nt(n.hass,t.range,n.luxRanges?.custom??{}):pi(t.min,t.max);return e.length===1?`${e[0]} ${r}`:`${t.quant==="all"?d(n.hass,"lux_summary.all_of","all of"):d(n.hass,"lux_summary.any_of","any of")} (${e.join(", ")}) ${r}`}function mi(t,n={}){return t==null?d(n.hass,"ui.summary_any","any"):ci(t,n)}function Xn(t,n,e){let r=J(n.hass,t.kind),i=es(n,t.entity_id),s=n.hass?.states?.[t.entity_id],a=t.kind!=="is"&&t.kind!=="is_not"?t.states[0]??"":t.states.map(f=>it(n.hass,s,t.attribute,f)).join("/"),c=t.attribute?`${i}.${tr(n.hass,s,t.attribute)}`:i,h=e?`${J(n.hass,"not")} `:"",p=`${c} ${r} ${h}${a}`;return t.for&&vr(t.for)?`${p} ${d(n.hass,"ui.for_prefix","for")} \u2265${yr(t.for)}`:p}function ci(t,n){if(t.kind==="is"||t.kind==="is_not"||t.kind===">"||t.kind===">="||t.kind==="<"||t.kind==="<=")return Xn(t,n,!1);if(t.kind==="and"||t.kind==="or"){let e=` ${J(n.hass,t.kind)} `;return t.items.map(r=>Jn(r,n)).join(e)}if(t.kind==="not"){let e=t.item;return e.kind==="is"?Xn(e,n,!0):`${J(n.hass,"not")} ${Jn(e,n)}`}return""}function Jn(t,n){return t.kind==="and"||t.kind==="or"?`(${ci(t,n)})`:ci(t,n)}function vr(t){return t.h>0||t.m>0||t.s>0}function yr(t){let n=[];return t.h&&n.push(`${t.h}h`),t.m&&n.push(`${t.m}m`),t.s&&n.push(`${t.s}s`),n.length?n.join(" "):"0s"}function xr(t,n){if(t===null)return d(n.hass,"ui.summary_any","any");let e=Array.isArray(t)?t:[t],r=n.periods?.custom??{};return e.map(i=>"period"in i?xe(n.hass,i.period,r):`${Zn(i.from,n)} \u2192 ${Zn(i.to,n)}`).join(", ")}function Zn(t,n){if(t.kind==="time")return`${String(t.hh).padStart(2,"0")}:${String(t.mm).padStart(2,"0")}`;let e=we(n.hass,t.anchor),r=e;if(t.offset_min!==0){let i=Math.abs(t.offset_min),s=i%60===0?`${i/60}${d(n.hass,"ui.unit_hour_abbr","h")}`:`${i}${d(n.hass,"ui.unit_min_abbr","m")}`;r=`${e}${t.offset_min<0?"-":"+"}${s}`}if(t.clamp){let i=t.clamp.dir==="not_before"?d(n.hass,"ui.clamp_not_before","not before"):d(n.hass,"ui.clamp_not_after","not after"),s=`${String(t.clamp.hh).padStart(2,"0")}:${String(t.clamp.mm).padStart(2,"0")}`;r=`${r} (${i} ${s})`}return r}function ua(t,n){let e=n.exposedActions?.find(r=>r.id===t.service);return e?.label?.trim()?e.label:rr(n.hass,t.service)}function ha(t,n){let e=new Set;for(let r of t.entity_ids){let i=r.indexOf(".");i>0&&e.add(r.slice(0,i))}return e.size===1?[...e][0]:d(n.hass,"ui.target_noun","target")}function ts(t,n){let e=ua(t,n),r=ha(t,n),i=t.entity_ids.length,s;i===0?s=d(n.hass,"ui.no_targets","(no targets)"):i===1?s=`1 ${r}`:s=`${i} ${r}s`;let o=Object.entries(t.params).filter(([,a])=>a!=null&&a!=="").map(([a,c])=>`${At(a,t.service,n.schemas)}: ${Ee(n.hass,c)}`).join(", ");return o?`${e}: ${s}, ${o}`:`${e}: ${s}`}var z=class extends b{constructor(){super(...arguments);this.scenes=[];this.availableActions=[];this.schemas={};this.categories=[];this.filterCategory="";this._drag=new ct(this,(e,r)=>this._emit("reorder-scenes",{from:e,to:r}));this._expanded=new Set}willUpdate(e){e.has("scenes")&&(this._expanded=new Set)}_renderSectionHeader(e){return l`<div
  ...
  `,u([m({attribute:!1})],z.prototype,"scenes",2),u([m({attribute:!1})],z.prototype,"periods",2),u([m({attribute:!1})],z.prototype,"luxRanges",2),u([m({attribute:!1})],z.prototype,"weatherConfig",2),u([m({attribute:!1})],z.prototype,"hass",2),u([m({attribute:!1})],z.prototype,"conditions",2),u([m({attribute:!1})],z.prototype,"availableActions",2),u([m({attribute:!1})],z.prototype,"schemas",2),u([m({attribute:!1})],z.prototype,"categories",2),u([m({attribute:!1})],z.prototype,"filterCategory",2),u([g()],z.prototype,"_expanded",2),z=u([w("ambience-scenes-list")],z);function rs(t,n){let e=t.trim();if(e==="")return null;let r=Number(e);return Number.isNaN(r)?null:r<=0?n?0:null:Math.max(10,Math.round(r))}function is(t){return rs(t,!1)}function ns(t){return rs(t,!0)}function ss(t,n){return"reapply_seconds"in t?t.reapply_seconds??0:n}function os(t){return t%60===0?`${t/60} min`:t<60?`${t} sec`:`${Math.floor(t/60)} min ${t%60} sec`}function T(t,n){t.dispatchEvent(new CustomEvent("value-changed",{detail:{value:n},bubbles:!0,composed:!0}))}var ae=class extends b{constructor(){super(...arguments);this.entities=[];this.value=[];this.target=null;this.label=" "}_filteredEntities(){return Vn(this.entities,this.target)}connectedCallback(){super.connectedCallback(),ee(this)}_emit(e){T(this,e)}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let r=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this._filteredEntities()}}}],i=this.label;return l`
      <ha-form
        .hass=${this.hass}
        .schema=${r}
  ...
  `,u([m({attribute:!1})],ae.prototype,"hass",2),u([m({attribute:!1})],ae.prototype,"entities",2),u([m({attribute:!1})],ae.prototype,"value",2),u([m({attribute:!1})],ae.prototype,"target",2),u([m()],ae.prototype,"label",2),ae=u([w("ambience-target-picker")],ae);var U=class extends b{constructor(){super(...arguments);this.entityIds=[];this.params={};this.excludeEntities=[];this._schema=void 0;this._schemaError=null;this._exposedMissing=!1;this._formSchema=[];this._perFieldSchemas={};this._schemaServiceId=null;this._onTargetChanged=e=>{e.stopPropagation(),this._emit("entity-ids-changed",{entityIds:e.detail.value})};this._onFieldInput=e=>r=>{r.stopPropagation();let i=r.target,s={...this.params,[e]:i.value};this._emit("params-changed",{params:s})};this._onHaFormChanged=e=>{e.stopPropagation(),this._emit("params-changed",{params:{...this.params,...e.detail.value}})}}connectedCallback(){super.connectedCallback(),ee(this)}willUpdate(e){if((e.has("exposed")&&e.get("exposed")?.id!==this.exposed?.id||e.has("hass")&&this._schema===void 0&&this._schemaServiceId!==this.exposed?.id)&&this._loadSchema(),(e.has("exposed")||e.has("_schema"))&&(this._formSchema=this._buildFormSchema()),e.has("_formSchema")||e.has("_schema")||e.has("exposed")){let r={};for(let i of this._formSchema)r[i.name]=[i];this._perFieldSchemas=r}}async _loadSchema(){if(this.exposed===void 0&&this.hass){this._exposedMissing=!0,this._schema=null,this._schemaServiceId=null;return}let e=this.exposed?.id;if(!e||!this.hass){this._exposedMissing=!1,this._schema=void 0,this._schemaServiceId=null;return}this._exposedMissing=!1,this._schemaServiceId=e,this._schemaError=null,this._schema=void 0;try{let r=await $e(this.hass,e);if(this._schemaServiceId!==e)return;this._schema=r}catch(r){if(this._schemaServiceId!==e)return;this._schema=null,this._schemaError=r instanceof Error?r.message:String(r)}}_buildFormSchema(){let e=this._schema,r=this.exposed;if(!e||!r)return[];let i=new Set(r.visible_fields??[]),s=[];for(let[o,a]of Object.entries(e.fields))i.has(o)&&s.push({name:o,selector:a.selector??{text:{}},required:!!a.required,description:typeof a.description=="string"&&a.description?a.description:void 0});return s}updated(e){super.updated?.(e),e.has("_schema")&&this.dispatchEvent(new CustomEvent("target-mode-changed",{detail:{hasTarget:this.hasTarget()},bubbles:!0,composed:!0}))}_hasTarget(){let e=this._schema?.target??null;return!e||typeof e!="object"?!1:Object.keys(e).length>0}hasTarget(){return this._schema===void 0?!1:this._hasTarget()}_scopeEntities(){return!this.scope||!this.hass?[]:fr(this.hass,this.scope,[])}_renderTargetPicker(){if(!this._hasTarget())return"";let e=new Set(this.excludeEntities),r=this._scopeEntities().filter(o=>!e.has(o)),i=this._schema?.target??null,s=d(this.hass,"ui.target","Target");return l`
    ...
    `}_emit(e,r){this.dispatchEvent(new CustomEvent(e,{detail:r,bubbles:!0,composed:!0}))}render(){if(this._schema===null)return this._exposedMissing?l`
      ...
      `;if(this._schema===void 0)return l`<div>${d(this.hass,"ui.loading","Loading\u2026")}</div>`;let e=this._renderTargetPicker(),r=this._renderFieldsForm();return e===""&&r===""?l`<div class="no-params">${d(this.hass,"ui.action_no_parameters","This action has no configurable fields.")}</div>`:l`${e}${r}`}};U.styles=v`
    :host { display: block; }
    label {
  ...
  `,u([m({attribute:!1})],U.prototype,"hass",2),u([m({attribute:!1})],U.prototype,"scope",2),u([m({attribute:!1})],U.prototype,"exposed",2),u([m({attribute:!1})],U.prototype,"entityIds",2),u([m({attribute:!1})],U.prototype,"params",2),u([m({attribute:!1})],U.prototype,"excludeEntities",2),u([g()],U.prototype,"_schema",2),u([g()],U.prototype,"_schemaError",2),u([g()],U.prototype,"_exposedMissing",2),u([g()],U.prototype,"_formSchema",2),u([g()],U.prototype,"_perFieldSchemas",2),U=u([w("ambience-action-slot")],U);function xs(t){return typeof t>"u"||t===null}function pa(t){return typeof t=="object"&&t!==null}function ma(t){return Array.isArray(t)?t:xs(t)?[]:[t]}function fa(t,n){var e,r,i,s;if(n)for(s=Object.keys(n),e=0,r=s.length;e<r;e+=1)i=s[e],t[i]=n[i];return t}function ga(t,n){var e="",r;for(r=0;r<n;r+=1)e+=t;return e}function _a(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}var va=xs,ya=pa,ba=ma,wa=ga,xa=_a,$a=fa,H={isNothing:va,isObject:ya,toArray:ba,repeat:wa,isNegativeZero:xa,extend:$a};function $s(t,n){var e="",r=t.reason||"(unknown reason)";return t.mark?(t.mark.name&&(e+='in "'+t.mark.name+'" '),e+="("+(t.mark.line+1)+":"+(t.mark.column+1)+")",!n&&t.mark.snippet&&(e+=`

`+t.mark.snippet),r+" "+e):r}function Ot(t,n){Error.call(this),this.name="YAMLException",this.reason=t,this.mark=n,this.message=$s(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Ot.prototype=Object.create(Error.prototype);Ot.prototype.constructor=Ot;Ot.prototype.toString=function(n){return this.name+": "+$s(this,n)};var K=Ot;function fi(t,n,e,r,i){var s="",o="",a=Math.floor(i/2)-1;return r-n>a&&(s=" ... ",n=r-a+s.length),e-r>a&&(o=" ...",e=r+a-o.length),{str:s+t.slice(n,e).replace(/\t/g,"\u2192")+o,pos:r-n+s.length}}function gi(t,n){return H.repeat(" ",n-t.length)+t}function ka(t,n){if(n=Object.create(n||null),!t.buffer)return null;n.maxLength||(n.maxLength=79),typeof n.indent!="number"&&(n.indent=1),typeof n.linesBefore!="number"&&(n.linesBefore=3),typeof n.linesAfter!="number"&&(n.linesAfter=2);for(var e=/\r?\n|\r|\0/g,r=[0],i=[],s,o=-1;s=e.exec(t.buffer);)i.push(s.index),r.push(s.index+s[0].length),t.position<=s.index&&o<0&&(o=r.length-2);o<0&&(o=r.length-1);var a="",c,h,p=Math.min(t.line+n.linesAfter,i.length).toString().length,f=n.maxLength-(n.indent+p+3);for(c=1;c<=n.linesBefore&&!(o-c<0);c++)h=fi(t.buffer,r[o-c],i[o-c],t.position-(r[o]-r[o-c]),f),a=H.repeat(" ",n.indent)+gi((t.line-c+1).toString(),p)+" | "+h.str+`
...
`,c):t.result+=H.repeat(`
`,s?1+c:c),s=!0,o=!0,c=0,e=t.position;!le(f)&&f!==0;)f=t.input.charCodeAt(++t.position);Se(t,e,t.position,!1)}return!0}function ps(t,n){var e,r=t.tag,i=t.anchor,s=[],o,a=!1,c;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=s),c=t.input.charCodeAt(t.position);c!==0&&(t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,x(t,"tab characters must not be used in indentation")),!(c!==45||(o=t.input.charCodeAt(t.position+1),!Y(o))));){if(a=!0,t.position++,D(t,!0,-1)&&t.lineIndent<=n){s.push(null),c=t.input.charCodeAt(t.position);continue}if(e=t.line,mt(t,n,Ts,!1,!0),s.push(t.result),D(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===e||t.lineIndent>n)&&c!==0)x(t,"bad indentation of a sequence entry");else if(t.lineIndent<n)break}return a?(t.tag=r,t.anchor=i,t.kind="sequence",t.result=s,!0):!1}function Bl(t,n,e){var r,i,s,o,a,c,h=t.tag,p=t.anchor,f={},_=Object.create(null),y=null,k=null,E=null,L=!1,V=!1,C;if(t.firstTabInLine!==-1)return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=f),C=t.input.charCodeAt(t.position);C!==0;){if(!L&&t.firstTabInLine!==-1&&(t.position=t.firstTabInLine,x(t,"tab characters must not be used in indentation")),r=t.input.charCodeAt(t.position+1),s=t.line,(C===63||C===58)&&Y(r))C===63?(L&&(pt(t,f,_,y,k,null,o,a,c),y=k=E=null),V=!0,L=!0,i=!0):L?(L=!1,i=!0):x(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,C=r;else{if(o=t.line,a=t.lineStart,c=t.position,!mt(t,e,Cs,!1,!0))break;if(t.line===s){for(C=t.input.charCodeAt(t.position);Ke(C);)C=t.input.charCodeAt(++t.position);if(C===58)C=t.input.charCodeAt(++t.position),Y(C)||x(t,"a whitespace character is expected after the key-value separator within a block mapping"),L&&(pt(t,f,_,y,k,null,o,a,c),y=k=E=null),V=!0,L=!1,i=!1,y=t.tag,k=t.result;else if(V)x(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=h,t.anchor=p,!0}else if(V)x(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=h,t.anchor=p,!0}if((t.line===s||t.lineIndent>n)&&(L&&(o=t.line,a=t.lineStart,c=t.position),mt(t,n,kr,!0,i)&&(L?k=t.result:E=t.result),L||(pt(t,f,_,y,k,E,o,a,c),y=k=E=null),D(t,!0,-1),C=t.input.charCodeAt(t.position)),(t.line===s||t.lineIndent>n)&&C!==0)x(t,"bad indentation of a mapping entry");else if(t.lineIndent<n)break}return L&&pt(t,f,_,y,k,null,o,a,c),V&&(t.tag=h,t.anchor=p,t.kind="mapping",t.result=f),V}function Vl(t){var n,e=!1,r=!1,i,s,o;if(o=t.input.charCodeAt(t.position),o!==33)return!1;if(t.tag!==null&&x(t,"duplication of a tag property"),o=t.input.charCodeAt(++t.position),o===60?(e=!0,o=t.input.charCodeAt(++t.position)):o===33?(r=!0,i="!!",o=t.input.charCodeAt(++t.position)):i="!",n=t.position,e){do o=t.input.charCodeAt(++t.position);while(o!==0&&o!==62);t.position<t.length?(s=t.input.slice(n,t.position),o=t.input.charCodeAt(++t.position)):x(t,"unexpected end of the stream within a verbatim tag")}else{for(;o!==0&&!Y(o);)o===33&&(r?x(t,"tag suffix cannot contain exclamation marks"):(i=t.input.slice(n-1,t.position+1),Ls.test(i)||x(t,"named tag handle cannot contain such characters"),r=!0,n=t.position+1)),o=t.input.charCodeAt(++t.position);s=t.input.slice(n,t.position),Dl.test(s)&&x(t,"tag suffix cannot contain flow indicator characters")}s&&!Rs.test(s)&&x(t,"tag name cannot contain such characters: "+s);try{s=decodeURIComponent(s)}catch{x(t,"tag name is malformed: "+s)}return e?t.tag=s:Ce.call(t.tagMap,i)?t.tag=t.tagMap[i]+s:i==="!"?t.tag="!"+s:i==="!!"?t.tag="tag:yaml.org,2002:"+s:x(t,'undeclared tag handle "'+i+'"'),!0}function ql(t){var n,e;if(e=t.input.charCodeAt(t.position),e!==38)return!1;for(t.anchor!==null&&x(t,"duplication of an anchor property"),e=t.input.charCodeAt(++t.position),n=t.position;e!==0&&!Y(e)&&!ht(e);)e=t.input.charCodeAt(++t.position);return t.position===n&&x(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(n,t.position),!0}function Kl(t){var n,e,r;if(r=t.input.charCodeAt(t.position),r!==42)return!1;for(r=t.input.charCodeAt(++t.position),n=t.position;r!==0&&!Y(r)&&!ht(r);)r=t.input.charCodeAt(++t.position);return t.position===n&&x(t,"name of an alias node must contain at least one character"),e=t.input.slice(n,t.position),Ce.call(t.anchorMap,e)||x(t,'unidentified alias "'+e+'"'),t.result=t.anchorMap[e],D(t,!0,-1),!0}function mt(t,n,e,r,i){var s,o,a,c=1,h=!1,p=!1,f,_,y,k,E,L;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,s=o=a=kr===e||Ts===e,r&&D(t,!0,-1)&&(h=!0,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)),c===1)for(;Vl(t)||ql(t);)D(t,!0,-1)?(h=!0,a=s,t.lineIndent>n?c=1:t.lineIndent===n?c=0:t.lineIndent<n&&(c=-1)):a=!1;if(a&&(a=h||i),(c===1||kr===e)&&($r===e||Cs===e?E=n:E=n+1,L=t.position-t.lineStart,c===1?a&&(ps(t,L)||Bl(t,L,E))||Ul(t,E)?p=!0:(o&&Wl(t,E)||jl(t,E)||zl(t,E)?p=!0:Kl(t)?(p=!0,(t.tag!==null||t.anchor!==null)&&x(t,"alias node should not have any properties")):Ml(t,E,$r===e)&&(p=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(p=a&&ps(t,L))),t.tag===null)t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);else if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&x(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),f=0,_=t.implicitTypes.length;f<_;f+=1)if(k=t.implicitTypes[f],k.resolve(t.result)){t.result=k.construct(t.result),t.tag=k.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else if(t.tag!=="!"){if(Ce.call(t.typeMap[t.kind||"fallback"],t.tag))k=t.typeMap[t.kind||"fallback"][t.tag];else for(k=null,y=t.typeMap.multi[t.kind||"fallback"],f=0,_=y.length;f<_;f+=1)if(t.tag.slice(0,y[f].tag.length)===y[f].tag){k=y[f];break}k||x(t,"unknown tag !<"+t.tag+">"),t.result!==null&&k.kind!==t.kind&&x(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+k.kind+'", not "'+t.kind+'"'),k.resolve(t.result,t.tag)?(t.result=k.construct(t.result,t.tag),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):x(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")}return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||p}function Yl(t){var n=t.position,e,r,i,s=!1,o;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap=Object.create(null),t.anchorMap=Object.create(null);(o=t.input.charCodeAt(t.position))!==0&&(D(t,!0,-1),o=t.input.charCodeAt(t.position),!(t.lineIndent>0||o!==37));){for(s=!0,o=t.input.charCodeAt(++t.position),e=t.position;o!==0&&!Y(o);)o=t.input.charCodeAt(++t.position);for(r=t.input.slice(e,t.position),i=[],r.length<1&&x(t,"directive name must not be less than one character in length");o!==0;){for(;Ke(o);)o=t.input.charCodeAt(++t.position);if(o===35){do o=t.input.charCodeAt(++t.position);while(o!==0&&!le(o));break}if(le(o))break;for(e=t.position;o!==0&&!Y(o);)o=t.input.charCodeAt(++t.position);i.push(t.input.slice(e,t.position))}o!==0&&ki(t),Ce.call(us,r)?us[r](t,r,i):Er(t,'unknown document directive "'+r+'"')}if(D(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,D(t,!0,-1)):s&&x(t,"directives end mark is expected"),mt(t,t.lineIndent-1,kr,!1,!0),D(t,!0,-1),t.checkLineBreaks&&Al.test(t.input.slice(n,t.position))&&Er(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&Tr(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,D(t,!0,-1));return}if(t.position<t.length-1)x(t,"end of the stream or a document separator is expected");else return}function Os(t,n){t=String(t),n=n||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var e=new Fl(t,n),r=t.indexOf("\0");for(r!==-1&&(e.position=r,x(e,"null byte is not allowed in input")),e.input+="\0";e.input.charCodeAt(e.position)===32;)e.lineIndent+=1,e.position+=1;for(;e.position<e.length-1;)Yl(e);return e.documents}function Gl(t,n,e){n!==null&&typeof n=="object"&&typeof e>"u"&&(e=n,n=null);var r=Os(t,e);if(typeof n!="function")return r;for(var i=0,s=r.length;i<s;i+=1)n(r[i])}function Ql(t,n){var e=Os(t,n);if(e.length!==0){if(e.length===1)return e[0];throw new K("expected a single document in the stream, but found more")}}var Xl=Gl,Jl=Ql,Ns={loadAll:Xl,load:Jl},Is=Object.prototype.toString,Fs=Object.prototype.hasOwnProperty,Si=65279,Zl=9,Nt=10,ed=13,td=32,rd=33,id=34,yi=35,nd=37,sd=38,od=39,ad=42,Ms=44,ld=45,Sr=58,dd=61,cd=62,ud=63,hd=64,js=91,zs=93,pd=96,Us=123,md=124,Ws=125,B={};B[0]="\\0";B[7]="\\a";B[8]="\\b";B[9]="\\t";B[10]="\\n";B[11]="\\v";B[12]="\\f";B[13]="\\r";B[27]="\\e";B[34]='\\"';B[92]="\\\\";B[133]="\\N";B[160]="\\_";B[8232]="\\L";B[8233]="\\P";var fd=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],gd=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function _d(t,n){var e,r,i,s,o,a,c;if(n===null)return{};for(e={},r=Object.keys(n),i=0,s=r.length;i<s;i+=1)o=r[i],a=String(n[o]),o.slice(0,2)==="!!"&&(o="tag:yaml.org,2002:"+o.slice(2)),c=t.compiledTypeMap.fallback[o],c&&Fs.call(c.styleAliases,a)&&(a=c.styleAliases[a]),e[o]=a;return e}function vd(t){var n,e,r;if(n=t.toString(16).toUpperCase(),t<=255)e="x",r=2;else if(t<=65535)e="u",r=4;else if(t<=4294967295)e="U",r=8;else throw new K("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+e+H.repeat("0",r-n.length)+n}var yd=1,It=2;function bd(t){this.schema=t.schema||Ss,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=H.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=_d(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.quotingType=t.quotingType==='"'?It:yd,this.forceQuotes=t.forceQuotes||!1,this.replacer=typeof t.replacer=="function"?t.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function ms(t,n){for(var e=H.repeat(" ",n),r=0,i=-1,s="",o,a=t.length;r<a;)i=t.indexOf(`
`,r),i===-1?(o=t.slice(r),r=a):(o=t.slice(r,i+1),r=i+1),o.length&&o!==`
`&&(s+=e),s+=o;return s}function bi(t,n){return`
`+H.repeat(" ",t.indent*n)}function wd(t,n){var e,r,i;for(e=0,r=t.implicitTypes.length;e<r;e+=1)if(i=t.implicitTypes[e],i.resolve(n))return!0;return!1}function Cr(t){return t===td||t===Zl}function Ft(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==Si||65536<=t&&t<=1114111}function fs(t){return Ft(t)&&t!==Si&&t!==ed&&t!==Nt}function gs(t,n,e){var r=fs(t),i=r&&!Cr(t);return(e?r:r&&t!==Ms&&t!==js&&t!==zs&&t!==Us&&t!==Ws)&&t!==yi&&!(n===Sr&&!i)||fs(n)&&!Cr(n)&&t===yi||n===Sr&&i}function xd(t){return Ft(t)&&t!==Si&&!Cr(t)&&t!==ld&&t!==ud&&t!==Sr&&t!==Ms&&t!==js&&t!==zs&&t!==Us&&t!==Ws&&t!==yi&&t!==sd&&t!==ad&&t!==rd&&t!==md&&t!==dd&&t!==cd&&t!==od&&t!==id&&t!==nd&&t!==hd&&t!==pd}function $d(t){return!Cr(t)&&t!==Sr}function Ht(t,n){var e=t.charCodeAt(n),r;return e>=55296&&e<=56319&&n+1<t.length&&(r=t.charCodeAt(n+1),r>=56320&&r<=57343)?(e-55296)*1024+r-56320+65536:e}function Bs(t){var n=/^\n* /;return n.test(t)}var Vs=1,wi=2,qs=3,Ks=4,ut=5;function kd(t,n,e,r,i,s,o,a){var c,h=0,p=null,f=!1,_=!1,y=r!==-1,k=-1,E=xd(Ht(t,0))&&$d(Ht(t,t.length-1));if(n||o)for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Ht(t,c),!Ft(h))return ut;E=E&&gs(h,p,a),p=h}else{for(c=0;c<t.length;h>=65536?c+=2:c++){if(h=Ht(t,c),h===Nt)f=!0,y&&(_=_||c-k-1>r&&t[k+1]!==" ",k=c);else if(!Ft(h))return ut;E=E&&gs(h,p,a),p=h}_=_||y&&c-k-1>r&&t[k+1]!==" "}return!f&&!_?E&&!o&&!i(t)?Vs:s===It?ut:wi:e>9&&Bs(t)?ut:o?s===It?ut:wi:_?Ks:qs}function Ed(t,n,e,r,i){t.dump=(function(){if(n.length===0)return t.quotingType===It?'""':"''";if(!t.noCompatMode&&(fd.indexOf(n)!==-1||gd.test(n)))return t.quotingType===It?'"'+n+'"':"'"+n+"'";var s=t.indent*Math.max(1,e),o=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-s),a=r||t.flowLevel>-1&&e>=t.flowLevel;function c(h){return wd(t,h)}switch(kd(n,a,t.indent,o,c,t.quotingType,t.forceQuotes&&!r,i)){case Vs:return n;case wi:return"'"+n.replace(/'/g,"''")+"'";case qs:return"|"+_s(n,t.indent)+vs(ms(n,s));case Ks:return">"+_s(n,t.indent)+vs(ms(Sd(n,o),s));case ut:return'"'+Cd(n)+'"';default:throw new K("impossible error: invalid scalar style")}})()}function _s(t,n){var e=Bs(t)?String(n):"",r=t[t.length-1]===`
`,i=r&&(t[t.length-2]===`
`||t===`
`),s=i?"+":r?"":"-";return e+s+`
`}function vs(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function Sd(t,n){for(var e=/(\n+)([^\n]*)/g,r=(function(){var h=t.indexOf(`
`);return h=h!==-1?h:t.length,e.lastIndex=h,ys(t.slice(0,h),n)})(),i=t[0]===`
`||t[0]===" ",s,o;o=e.exec(t);){var a=o[1],c=o[2];s=c[0]===" ",r+=a+(!i&&!s&&c!==""?`
`:"")+ys(c,n),i=s}return r}function ys(t,n){if(t===""||t[0]===" ")return t;for(var e=/ [^ ]/g,r,i=0,s,o=0,a=0,c="";r=e.exec(t);)a=r.index,a-i>n&&(s=o>i?o:a,c+=`
`+t.slice(i,s),i=s+1),o=a;return c+=`
`,t.length-i>n&&o>i?c+=t.slice(i,o)+`
`+t.slice(o+1):c+=t.slice(i),c.slice(1)}function Cd(t){for(var n="",e=0,r,i=0;i<t.length;e>=65536?i+=2:i++)e=Ht(t,i),r=B[e],!r&&Ft(e)?(n+=t[i],e>=65536&&(n+=t[i+1])):n+=r||vd(e);return n}function Td(t,n,e){var r="",i=t.tag,s,o,a;for(s=0,o=e.length;s<o;s+=1)a=e[s],t.replacer&&(a=t.replacer.call(e,String(s),a)),(ge(t,n,a,!1,!1)||typeof a>"u"&&ge(t,n,null,!1,!1))&&(r!==""&&(r+=","+(t.condenseFlow?"":" ")),r+=t.dump);t.tag=i,t.dump="["+r+"]"}function bs(t,n,e,r){var i="",s=t.tag,o,a,c;for(o=0,a=e.length;o<a;o+=1)c=e[o],t.replacer&&(c=t.replacer.call(e,String(o),c)),(ge(t,n+1,c,!0,!0,!1,!0)||typeof c>"u"&&ge(t,n+1,null,!0,!0,!1,!0))&&((!r||i!=="")&&(i+=bi(t,n)),t.dump&&Nt===t.dump.charCodeAt(0)?i+="-":i+="- ",i+=t.dump);t.tag=s,t.dump=i||"[]"}function Ld(t,n,e){var r="",i=t.tag,s=Object.keys(e),o,a,c,h,p;for(o=0,a=s.length;o<a;o+=1)p="",r!==""&&(p+=", "),t.condenseFlow&&(p+='"'),c=s[o],h=e[c],t.replacer&&(h=t.replacer.call(e,c,h)),ge(t,n,c,!1,!1)&&(t.dump.length>1024&&(p+="? "),p+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),ge(t,n,h,!1,!1)&&(p+=t.dump,r+=p));t.tag=i,t.dump="{"+r+"}"}function Rd(t,n,e,r){var i="",s=t.tag,o=Object.keys(e),a,c,h,p,f,_;if(t.sortKeys===!0)o.sort();else if(typeof t.sortKeys=="function")o.sort(t.sortKeys);else if(t.sortKeys)throw new K("sortKeys must be a boolean or a function");for(a=0,c=o.length;a<c;a+=1)_="",(!r||i!=="")&&(_+=bi(t,n)),h=o[a],p=e[h],t.replacer&&(p=t.replacer.call(e,h,p)),ge(t,n+1,h,!0,!0,!0)&&(f=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,f&&(t.dump&&Nt===t.dump.charCodeAt(0)?_+="?":_+="? "),_+=t.dump,f&&(_+=bi(t,n)),ge(t,n+1,p,!0,f)&&(t.dump&&Nt===t.dump.charCodeAt(0)?_+=":":_+=": ",_+=t.dump,i+=_));t.tag=s,t.dump=i||"{}"}function ws(t,n,e){var r,i,s,o,a,c;for(i=e?t.explicitTypes:t.implicitTypes,s=0,o=i.length;s<o;s+=1)if(a=i[s],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof n=="object"&&n instanceof a.instanceOf)&&(!a.predicate||a.predicate(n))){if(e?a.multi&&a.representName?t.tag=a.representName(n):t.tag=a.tag:t.tag="?",a.represent){if(c=t.styleMap[a.tag]||a.defaultStyle,Is.call(a.represent)==="[object Function]")r=a.represent(n,c);else if(Fs.call(a.represent,c))r=a.represent[c](n,c);else throw new K("!<"+a.tag+'> tag resolver accepts not "'+c+'" style');t.dump=r}return!0}return!1}function ge(t,n,e,r,i,s,o){t.tag=null,t.dump=e,ws(t,e,!1)||ws(t,e,!0);var a=Is.call(t.dump),c=r,h;r&&(r=t.flowLevel<0||t.flowLevel>n);var p=a==="[object Object]"||a==="[object Array]",f,_;if(p&&(f=t.duplicates.indexOf(e),_=f!==-1),(t.tag!==null&&t.tag!=="?"||_||t.indent!==2&&n>0)&&(i=!1),_&&t.usedDuplicates[f])t.dump="*ref_"+f;else{if(p&&_&&!t.usedDuplicates[f]&&(t.usedDuplicates[f]=!0),a==="[object Object]")r&&Object.keys(t.dump).length!==0?(Rd(t,n,t.dump,i),_&&(t.dump="&ref_"+f+t.dump)):(Ld(t,n,t.dump),_&&(t.dump="&ref_"+f+" "+t.dump));else if(a==="[object Array]")r&&t.dump.length!==0?(t.noArrayIndent&&!o&&n>0?bs(t,n-1,t.dump,i):bs(t,n,t.dump,i),_&&(t.dump="&ref_"+f+t.dump)):(Td(t,n,t.dump),_&&(t.dump="&ref_"+f+" "+t.dump));else if(a==="[object String]")t.tag!=="?"&&Ed(t,t.dump,n,s,c);else{if(a==="[object Undefined]")return!1;if(t.skipInvalid)return!1;throw new K("unacceptable kind of an object to dump "+a)}t.tag!==null&&t.tag!=="?"&&(h=encodeURI(t.tag[0]==="!"?t.tag.slice(1):t.tag).replace(/!/g,"%21"),t.tag[0]==="!"?h="!"+h:h.slice(0,18)==="tag:yaml.org,2002:"?h="!!"+h.slice(18):h="!<"+h+">",t.dump=h+" "+t.dump)}return!0}function Pd(t,n){var e=[],r=[],i,s;for(xi(t,e,r),i=0,s=r.length;i<s;i+=1)n.duplicates.push(e[r[i]]);n.usedDuplicates=new Array(s)}function xi(t,n,e){var r,i,s;if(t!==null&&typeof t=="object")if(i=n.indexOf(t),i!==-1)e.indexOf(i)===-1&&e.push(i);else if(n.push(t),Array.isArray(t))for(i=0,s=t.length;i<s;i+=1)xi(t[i],n,e);else for(r=Object.keys(t),i=0,s=r.length;i<s;i+=1)xi(t[r[i]],n,e)}function Ad(t,n){n=n||{};var e=new bd(n);e.noRefs||Pd(t,e);var r=t;return e.replacer&&(r=e.replacer.call({"":r},"",r)),ge(e,0,r,!0,!0)?e.dump+`
`:""}var Dd=Ad,Hd={dump:Dd};function Ci(t,n){return function(){throw new Error("Function yaml."+t+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Ys=Ns.load,Uh=Ns.loadAll,Lr=Hd.dump;var Wh=Ci("safeLoad","load"),Bh=Ci("safeLoadAll","loadAll"),Vh=Ci("safeDump","dump");var de=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>ui(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let i=this._currentFields()?.[e.name]?.description;return typeof i=="string"?i:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=Lr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=Lr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=Lr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let r;try{r=Ys(e)}catch(c){this._yamlError=c.message;return}if(r==null){this._yamlError=null,this._emit(null);return}if(typeof r!="object"||Array.isArray(r)){this._yamlError=d(this.hass,"ui.yaml_expect_object","Expected an object");return}let i=r,s=i.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=d(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=i.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=d(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let a=i.triggers;if(a!==void 0&&(!Array.isArray(a)||!a.every(c=>typeof c=="string"))){this._yamlError=d(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:a})}_emit(e){this.value=e,T(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(i=>`script.${i}`)}_label(e){return j(this.hass,e)}_fieldsFor(e){if(!e)return;let r=e.replace(/^script\./,"");return this.hass?.services?.script?.[r]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let r=this._fieldsFor(e)??{},i={};for(let[s,o]of Object.entries(r))o&&Object.hasOwn(o,"default")&&(i[s]=o.default);return i}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([r,i])=>({name:r,required:i.required,selector:i.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(r=>r!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,r=this._argsSchema(),i=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=r.length>0;return l`
      <div class="section">
      ...
      <div class="sun">
        <div class="row">
          <select @change=${this._onAnchorChange}>
            ${Od.map(o=>l`<option value=${o} ?selected=${o===e.anchor}>${we(this.hass,o)}</option>`)}
          </select>
          <input
            type="number"
            step="1"
  ...
  `,u([m({attribute:!1})],Ye.prototype,"hass",2),u([m({attribute:!1})],Ye.prototype,"value",2),Ye=u([w("ambience-time-endpoint")],Ye);function Nd(){let t=new Date;return{hh:t.getHours(),mm:t.getMinutes()}}function Id(t,n){if(t===0)return"";let e=Math.abs(t),r=t<0?"\u2212":"+";if(e%60===0){let i=e/60,s=i===1?d(n,"ui.unit_hour","hour"):d(n,"ui.unit_hours","hours");return`${r}${i} ${s}`}return`${r}${e} ${d(n,"ui.unit_min","min")}`}function Te(t){return t.scope_kind==="house"?"House":t.scope_kind==="floor"?`Floor: ${t.scope_id??""}`:t.scope_id??""}function Rr(t,n){if(!t)return[];let e=Object.keys(t.builtins??{}),r=n?e.slice().sort(n):e,i=new Set(t.hidden??[]),s=Object.keys(t.custom??{}).filter(o=>!(o in(t.builtins??{})));return[...r.filter(o=>!i.has(o)),...s]}var ie=class extends b{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[];this._error=""}static{this.styles=v`
    :host { display: block; }
  ...
  `}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){try{this._view=await this._list(),this._error=""}catch(e){this._error=e.message||String(e)}}async _saveState(e){try{let r=await this._save(e,this._view.hidden);this._warnings=r.warnings,this._error=""}catch(r){return this._error=r.message||String(r),!1}return await this._reload(),!0}_onEdit(e,r){this._modal={mode:"edit",id:e,initial:r}}async _onDelete(e){let r={...this._view.custom};delete r[e],await this._saveState(r)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:r,definition:i}=e.detail;await this._saveState({...this._view.custom,[r]:i})&&(this._modal={mode:"closed"})}_onModalCancel(){this._modal={mode:"closed"}}_takenIds(){return new Set([...Object.keys(this._view.builtins),...Object.keys(this._view.custom)])}_renderBuiltinRow(e,r,i){return l`
    ...
    `}render(){let e=this._view.custom,[r,i]=this._headingKey(),[s,o]=this._addKey(),[a,c]=this._warningTextKey();return l`
      ...
      ${this._warnings.length?l`<div class="warnings">
            ...
            <ul>
              ${this._warnings.map(h=>l`<li>${Te(h)} / "${h.scene_name}" → ${h.missing_id}</li>`)}
            </ul>
          </div>`:""}
        ...
        <div class="entry-header">
          <select @change=${a=>this._onSelectChange(r,a)}>
            ...
            ${s.map(a=>l`<option value=${a}>
                ${xe(this.hass,a,o)}${o[a]&&!this.periods?.builtins[a]?d(this.hass,"ui.custom_suffix"," (custom)"):""}
              </option>`)}
          </select>
  ...
  </select>`}function Pr(t,n,e,r,i){return customElements.get("ha-form")?l`<ha-form
      class="field"
      data-field="sensors"
      .hass=${t}
      .schema=${n}
  ...
  />`}var Ti="__custom__";function Xs(t,n){if(t==null||typeof t!="object")return null;let e=t;if(typeof e.range=="string")return null;let{min:r,max:i}=e;return typeof r=="number"&&r<0||typeof i=="number"&&i<0?d(n,"ui.lux_error_negative","Bounds must be 0 or greater."):typeof r=="number"&&typeof i=="number"&&r>=i?d(n,"ui.lux_error_order","Min must be less than max."):null}var Le=class extends b{constructor(){super(...arguments);this.value=null}_cur(){return this.value??{sensors:[],range:this._defaultRangeId()}}_sensors(){return this._cur().sensors??[]}_showQuant(){return this._sensors().length>1}_effectiveRangeIds(){return Rr(this.luxRanges)}_defaultRangeId(){return this._effectiveRangeIds()[0]??"dark"}_isCustom(e){return e.range==null}_build(e){let r={...this._cur(),...e},i={sensors:r.sensors??[]};return this._isCustom(r)?(r.min!=null&&(i.min=r.min),r.max!=null&&(i.max=r.max)):i.range=r.range??this._defaultRangeId(),r.quant==="all"&&(i.quant="all"),i}_emit(e){this.value=e,T(this,e)}_setSensors(e){this._emit(this._build({sensors:e}))}_setQuant(e){this._emit(this._build({quant:e}))}_setBand(e){if(e===Ti){let r=this._cur();this._emit(this._build({range:void 0,min:r.min??0,max:r.max}))}else this._emit(this._build({range:e,min:void 0,max:void 0}))}_setMin(e){this._emit(this._build({min:e}))}_setMax(e){this._emit(this._build({max:e}))}_sensorSchema(){return[{name:"sensors",selector:{entity:{domain:"sensor",device_class:["illuminance"],multiple:!0}}}]}_renderSensors(){return Pr(this.hass,this._sensorSchema(),this._sensors(),"sensor.a, sensor.b",e=>this._setSensors(e))}_renderBand(e){let r=this._isCustom(e),i=[...this._effectiveRangeIds().map(a=>({value:a,label:nt(this.hass,a,this.luxRanges?.custom??{})})),{value:Ti,label:d(this.hass,"ui.custom_range","Custom range")}],s=Ge(this.hass,"band","band",r?Ti:e.range??this._defaultRangeId(),i,a=>this._setBand(a));if(!r)return s;let o=a=>a==null?"":String(a);return l`${s}
  ...
  `,u([m({attribute:!1})],Re.prototype,"hass",2),u([m({attribute:!1})],Re.prototype,"value",2),u([m({attribute:!1})],Re.prototype,"dayConfig",2),Re=u([w("ambience-day-predicate-input")],Re);var Zs=["temperature","apparent_temperature","humidity","wind_speed","pressure"],eo=["<","<=",">",">="],to={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},_e=class extends b{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let r=e.groups.length===0&&e.thresholds.length===0;this.value=r?null:e,T(this,this.value)}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,r){let i=this._current();i.thresholds=i.thresholds.map((s,o)=>o===e?r:s),this._emit(i)}_removeThreshold(e){let r=this._current();r.thresholds=r.thresholds.filter((i,s)=>s!==e),this._emit(r)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:Zs.map(r=>({value:r,label:kt(this.hass,r)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:eo.map(r=>({value:r,label:to[r]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,r){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Qr(this.hass,r,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
      ...
      ${Zs.map(i=>l`<option value=${i} ?selected=${i===r.attribute}>${kt(this.hass,i)}</option>`)}
      ...
      ${eo.map(i=>l`<option value=${i} ?selected=${i===r.op}>${to[i]}</option>`)}
  ...
  `,u([m({attribute:!1})],ne.prototype,"hass",2),u([m({attribute:!1})],ne.prototype,"value",2),u([g()],ne.prototype,"_openPath",2),u([g()],ne.prototype,"_showError",2),u([g()],ne.prototype,"_dragFrom",2),u([g()],ne.prototype,"_dragOverPath",2),ne=u([w("ambience-state-predicate-input")],ne);var no=["everybody","anybody","nobody","any","all","none"],so=new Set(["any","all","none"]),Di={everybody:"everyone",anybody:"any",nobody:"nobody",any:"any",all:"everyone",none:"nobody"},Je=class extends b{constructor(){super(...arguments);this.value=null;this._lastSelected=[]}_persons(){return Ai(this.hass,"person")}_zones(){return Ai(this.hass,"zone")}_cur(){return this.value??{}}_who(){return this.value?.who??[]}_hasWhoKey(){return this.value!=null&&Array.isArray(this.value.who)}_mode(){if(this._hasWhoKey())switch(this._cur().quant??"any"){case"any":return"any";case"everyone":return"all";case"nobody":return"none"}switch(this._cur().quant??"everyone"){case"nobody":return"nobody";case"any":return"anybody";default:return"everybody"}}_hasFor(e){return!!e&&(e.h!==0||e.m!==0||e.s!==0)}_isNegativeQuant(){return Di[this._mode()]==="nobody"}_effectiveNegate(){return!this._isNegativeQuant()&&!!this._cur().negate}_emitMode(e){let r=this._cur(),i=r.where??"home",s={quant:Di[e],where:i};r.negate&&Di[e]!=="nobody"&&(s.negate=!0),so.has(e)&&(this._hasWhoKey()?s.who=[...this._who()]:this._lastSelected.length>0?s.who=[...this._lastSelected]:s.who=this._persons().map(o=>o.id)),this._hasFor(r.for)&&(s.for=r.for),this._emit(s)}_emit(e){this.value=e,T(this,e)}_setMode(e){this._emitMode(e)}_setWhere(e){let r=this._cur(),i={quant:r.quant??"everyone",where:e};this._effectiveNegate()&&(i.negate=!0),this._hasWhoKey()&&(i.who=[...this._who()]),this._hasFor(r.for)&&(i.for=r.for),this._emit(i)}_setNegate(e){let r=this._cur(),i={quant:r.quant??"everyone",where:r.where??"home"};e&&(i.negate=!0),this._hasWhoKey()&&(i.who=[...this._who()]),this._hasFor(r.for)&&(i.for=r.for),this._emit(i)}_togglePerson(e,r){let i=r?[...this._who(),e]:this._who().filter(a=>a!==e);i.length>0&&(this._lastSelected=[...i]);let s=this._cur(),o={quant:s.quant??"any",where:s.where??"home",who:i};this._effectiveNegate()&&(o.negate=!0),this._hasFor(s.for)&&(o.for=s.for),this._emit(o)}_setFor(e){let r=this._cur(),i={quant:r.quant??"everyone",where:r.where??"home"};this._effectiveNegate()&&(i.negate=!0),this._hasWhoKey()&&(i.who=[...this._who()]),this._hasFor(e)&&(i.for=e),this._emit(i)}_modeLabel(e){switch(e){case"everybody":return d(this.hass,"ui.people_mode_everybody","Everybody");case"anybody":return d(this.hass,"ui.people_mode_anybody","Anybody");case"nobody":return d(this.hass,"ui.people_mode_nobody","Nobody");case"any":return d(this.hass,"ui.people_mode_any","Any of:");case"all":return d(this.hass,"ui.people_mode_all","All of:");case"none":return d(this.hass,"ui.people_mode_none","None of:")}}_renderMode(e){if(customElements.get("ha-form")){let r=[{name:"mode",required:!0,selector:{select:{mode:"dropdown",options:no.map(i=>({value:i,label:this._modeLabel(i)}))}}}];return l`<ha-form
    ...
    >
      ${no.map(r=>l`<option value=${r} ?selected=${r===e}>${this._modeLabel(r)}</option>`)}
  ...
  `,u([m({attribute:!1})],Pe.prototype,"value",2),u([m({attribute:!1})],Pe.prototype,"hass",2),u([g()],Pe.prototype,"_preview",2),Pe=u([w("ambience-template-predicate-input")],Pe);var re=class extends b{constructor(){super(...arguments);this.value=null;this._onChild=e=>{e.stopPropagation(),this._emit(e.detail.value)}}_emit(e){T(this,e)}_onText(e){let r=e.target.value;this._emit(r.trim()===""?null:r)}render(){return this.condition.input==="time_of_day"?l`
  ...
  `,u([m({attribute:!1})],re.prototype,"condition",2),u([m({attribute:!1})],re.prototype,"value",2),u([m({attribute:!1})],re.prototype,"periods",2),u([m({attribute:!1})],re.prototype,"luxRanges",2),u([m({attribute:!1})],re.prototype,"dayConfig",2),u([m({attribute:!1})],re.prototype,"weatherConfig",2),u([m({attribute:!1})],re.prototype,"hass",2),re=u([w("ambience-condition-input")],re);function Kd(t){return t!=null&&typeof t=="object"&&Array.isArray(t.who)&&t.who.length===0}function Yd(t){return t==="people"?{quant:"everyone",where:"home"}:null}function ao(t,n){return!!t&&!!n&&O(t)===O(n)}var Gd={state:io,day:Js,lux:Xs},S=class extends b{constructor(){super(...arguments);this.open=!1;this.scene=null;this.conditions=[];this.availableActions=[];this.categories=[];this.schemas={};this.scopes=[];this.takenNames=new Map;this.saveError="";this._draft=null;this._open=null;this._showError=!1;this._addOrder=[];this._serviceHasTarget=new Map;this._conditionError=new Map;this._onNameInput=e=>{this._setName(e.target.value)};this._onAddCondition=e=>{let r=e.target,i=r.value;r.value="",this._addCondition(i)};this._onAddConditionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_CONDITION_PLACEHOLDER&&this._addCondition(r)};this._onAddAction=e=>{let r=e.target,i=r.value;r.value="",this._addActionSlot(i)};this._onAddActionHaForm=e=>{e.stopPropagation();let r=e.detail.value.add;r!==S._ADD_ACTION_PLACEHOLDER&&this._addActionSlot(r)}}_onConditionInvalid(e,r){r?this._conditionError.set(e,r):this._conditionError.delete(e)}connectedCallback(){super.connectedCallback(),ee(this)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.scene?JSON.parse(JSON.stringify(this.scene)):null,this._scope=this.scope,this._open=null,this._showError=!1,this._addOrder=[],this._conditionError=new Map)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_setDestination(e){let r=this.scopes[e];if(!r||!this._draft||(this._scope=r.scope,!this.hass))return;let i=new Set(fr(this.hass,this._scope,[]));this._draft={...this._draft,actions:this._draft.actions.map(s=>({...s,entity_ids:s.entity_ids.filter(o=>i.has(o))}))}}_renderDestination(){return l`
    ...
    `}_renderDestinationSlot(){if(this.scopes.length===0)return"";if(this._isOpen({kind:"destination"}))return l`
      ...
      `;let e=this.scopes.find(r=>ao(r.scope,this._scope))??this.scopes[0];return l`
    ...
    `}_renderActionRow(e,r){let i=this.availableActions.find(p=>p.id===e.service),s=i?.reapply_seconds??0,o=this._isOpen({kind:"action",idx:r}),a=ts(e,{hass:this.hass,exposedActions:this.availableActions,schemas:this.schemas}),c=ss(e,s),h=s>0&&c>0;return l`
...
`;function lo(t,n){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:n},bubbles:!0,composed:!0}))}function co(t,n){return l`<span
    class="entity-link"
    role="button"
    tabindex="0"
    title="Show more info"
    @click=${r=>lo(r,t)}
    @keydown=${r=>{(r.key==="Enter"||r.key===" ")&&!r.repeat&&(r.preventDefault(),lo(r,t))}}
    >${n}</span
  >`}function uo(t,n){return co(n,hi(t,n))}var Xd={has_time:"Periodic time check",switch:"Switch turned on",manual:"Manual apply",startup:"Startup",reloaded:"Reloaded",reapply:"Periodic refresh",simulated:"Simulation"},Jd={clock:"Time of day",sun:"Sun position"};function Ae(t){return t??"?"}function ho(t){if(t.kind==="entity")return`${t.entity_id} ${Ae(t.old)} \u2192 ${Ae(t.new)}`;if(t.kind==="duration")return`${t.entity_id} ${Ae(t.new)} for ${Ae(t.detail)}`;let n=Xd[t.kind];if(n)return n;let e=Jd[t.kind]??N(t.kind);return t.detail?`${e} ${t.detail}`:e}function Zd(t){if(!Or(t)||!t.entity_id)return l`${ho(t)}`;let n=co(t.entity_id,t.entity_id);return t.kind==="duration"?l`${n} ${Ae(t.new)} for ${Ae(t.detail)}`:l`${n} ${Ae(t.old)} → ${Ae(t.new)}`}function Or(t){return t.kind==="entity"||t.kind==="duration"}function po(t,n){let e=t.entity_id?n?.states?.[t.entity_id]:void 0,r=i=>i===null?"?":it(n,e,null,i);return{old:r(t.old),new:r(t.new)}}function ec(t,n){if(!Or(t))return ho(t);let e=t.entity_id?hi(n,t.entity_id):"?",r=po(t,n);return t.kind==="duration"?`${e}: ${r.new} for ${t.detail??"?"}`:`${e}: ${r.old} \u2192 ${r.new}`}function tc(t,n){if(!Or(t)||!t.entity_id)return l`${ec(t,n)}`;let e=uo(n,t.entity_id),r=po(t,n);return t.kind==="duration"?l`${e}: ${r.new} for ${t.detail??"?"}`:l`${e}: ${r.old} → ${r.new}`}var rc={acted:"applied",no_op:"blocked",debounced:"unchanged",no_match:"no match",reapplied:"refreshed",skipped_switch_off:"skipped",skipped_scope_disabled:"skipped"};function ic(t){return rc[t]??t.replace(/_/g," ")}function mo(t){let n=t.winner_name??"The matching scene";switch(t.outcome){case"acted":{let e=Hi(t.actions.length,"action","actions"),r=fo(t.actions);return r?`Applied ${n} \u2014 ${e} on ${Hi(r,"entity","entities")}.`:`Applied ${n} \u2014 ${e}.`}case"no_op":return`${n} matched but has no actions \u2014 it blocks lower scenes from applying. Nothing changed.`;case"debounced":return`${n} matched, but it's already applied \u2014 nothing was re-sent.`;case"no_match":return"No scene matched \u2014 nothing applied.";case"reapplied":return`Periodic refresh re-sent ${n}'s actions.`;case"skipped_switch_off":return"Skipped \u2014 the category switch is off.";case"skipped_scope_disabled":return"Skipped \u2014 the scope is disabled.";default:return""}}function nc(t,n,e){let r=Object.entries(t.params??{}).filter(([,s])=>s!=null&&s!=="").map(([s,o])=>`${At(s,t.service,e)}: ${Ee(n,o)}`).join(", "),i=$t(t.service);return r?`${i} \xB7 ${r}`:i}function fo(t){return t.reduce((n,e)=>n+(e.entity_ids?.length??0),0)}function Hi(t,n,e){return`${t} ${t===1?n:e}`}function sc(t){return t==="skipped_switch_off"||t==="skipped_scope_disabled"}function oc(t,n,e){let r=t.index+1;return t.disabled?l`<div class="scene disabled">Scene #${r} ${t.name??"\u2014"}: disabled</div>`:t.evaluated?l`
    ...
    ${t.predicates.map(i=>l`
        <div class="pred ${i.passed?"pass":"fail"}" style="padding-left:1rem">
          ${i.passed?"\u2713":"\u2717"} ${X(n,i.condition_key)}${i.detail?l` <span class="dim">[${Qd(n,i.condition_key,i.detail,e)}]</span>`:$}
        </div>`)}
  `:l`<div class="scene skipped">Scene #${r} ${t.name??"\u2014"}: not reached</div>`}function Nr(t,n,e,r,i,s={}){let o=t.actions.map(p=>$t(p.service)).join(", "),a=fo(t.actions),c=t.explanation!==null||t.actions.length>0||sc(t.outcome),h=p=>{(p.key==="Enter"||p.key===" ")&&!p.repeat&&(p.preventDefault(),e())};return l`
    <div class="eval">
      <div
  ...
  `}var De=class{constructor(n,e){this._onKeydown=n=>{this._host.open&&n.key==="Escape"&&this._close()};this._onBackdrop=()=>{this._host.open&&this._close()};this._host=n,this._close=e,n.addController(this)}hostConnected(){document.addEventListener("keydown",this._onKeydown),this._host.addEventListener("click",this._onBackdrop)}hostDisconnected(){document.removeEventListener("keydown",this._onKeydown),this._host.removeEventListener("click",this._onBackdrop)}};var M=class extends b{constructor(){super();this.category="";this.categoryName=null;this.open=!1;this._records=[];this._schemas={};this._expanded=new Set;this._loading=!0;this._error="";this._hasNew=!1;new De(this,()=>this._onClose())}disconnectedCallback(){super.disconnectedCallback(),this._stopPoll()}_startPoll(){this._poll||(this._poll=setInterval(()=>this._checkNew(),5e3))}_stopPoll(){this._poll&&(clearInterval(this._poll),this._poll=void 0)}updated(e){e.has("open")&&(this.open?this._startPoll():this._stopPoll()),this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_mine(e){return e.filter(r=>r.scope_kind===this.scope.scope_kind&&r.scope_id===this.scope.scope_id&&r.category===this.category)}async _load(){this._error="",this._loading=!0,this._hasNew=!1,this._expanded=new Set;try{let e=await ni(this.hass);if(!this.isConnected)return;this._records=this._mine(e),this._loading=!1,this._loadSchemas()}catch(e){this._error=e.message||String(e),this._loading=!1}}async _loadSchemas(){let e=[...new Set(this._records.flatMap(s=>s.actions.map(o=>o.service)))].filter(s=>!(s in this._schemas));if(e.length===0)return;let r=await Promise.all(e.map(async s=>{try{return[s,await $e(this.hass,s)]}catch{return null}}));if(!this.isConnected)return;let i={...this._schemas};for(let s of r)s&&(i[s[0]]=s[1]);this._schemas=i}async _checkNew(){if(!(!this.open||!this.isConnected||document.visibilityState!=="visible"))try{let r=this._mine(await ni(this.hass))[0]?.timestamp??null,i=this._records[0]?.timestamp??null;r&&(!i||r>i)&&(this._hasNew=!0)}catch{}}_toggle(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}async _download(){try{await Nn(this.hass,this.scope,this.category)}catch(e){this._error=e.message||String(e)}}async _clear(){try{await On(this.hass),await this._load()}catch(e){this._error=e.message||String(e)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open)return $;let e=this.categoryName??this.category;return l`
    ...
    `],u([m({attribute:!1})],M.prototype,"hass",2),u([m({attribute:!1})],M.prototype,"periods",2),u([m({attribute:!1})],M.prototype,"scope",2),u([m()],M.prototype,"category",2),u([m()],M.prototype,"categoryName",2),u([m({type:Boolean,reflect:!0})],M.prototype,"open",2),u([g()],M.prototype,"_records",2),u([g()],M.prototype,"_schemas",2),u([g()],M.prototype,"_expanded",2),u([g()],M.prototype,"_loading",2),u([g()],M.prototype,"_error",2),u([g()],M.prototype,"_hasNew",2),M=u([w("ambience-traces-modal")],M);var lc={time:"mdi:clock-outline",sun:"mdi:weather-sunny",reapply:"mdi:refresh"},G=class extends b{constructor(){super(...arguments);this.scopeName="";this.scenes=[];this.open=!1;this._triggers=[];this._opaque=!1;this._loading=!1;this._error="";this._loadSeq=0}willUpdate(e){super.willUpdate?.(e),this.open&&(e.has("open")||e.has("scenes")||e.has("scope"))&&((e.has("open")||e.has("scope"))&&(this._triggers=[],this._opaque=!1),this._load())}get _scopeId(){return this.scope.kind==="house"?null:this.scope.id}async _load(){let e=++this._loadSeq;this._loading=!0,this._error="";try{let r=await wn(this.hass,this.scope.kind,this._scopeId);if(e!==this._loadSeq)return;this._triggers=r.triggers,this._opaque=r.opaque}catch(r){if(e!==this._loadSeq)return;this._error=r.message||String(r)}finally{e===this._loadSeq&&(this._loading=!1)}}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_openMoreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_entityName(e){return j(this.hass,e)}get _sortedTriggers(){let e=s=>this._entityName(s.entity_id).toLowerCase(),r=this._triggers.filter(s=>s.kind==="entity").sort((s,o)=>e(s).localeCompare(e(o))),i=this._triggers.filter(s=>s.kind!=="entity");return[...r,...i]}_sunPart(e){let r=we(this.hass,e.anchor);if(e.offset===0)return r;let i=d(this.hass,"ui.unit_min","min");return`${r} ${e.offset>0?"+":""}${e.offset} ${i}`}_rowContent(e){switch(e.kind){case"entity":return{title:this._entityName(e.entity_id),detail:e.entity_id};case"time":{let r=e.clocks.map(i=>`${String(i.hour).padStart(2,"0")}:${String(i.minute).padStart(2,"0")}`);return e.date_rollover&&r.push(d(this.hass,"ui.auto_trigger_date_rollover","Local midnight (date rollover)")),e.has_time&&r.push(d(this.hass,"ui.auto_trigger_periodic","periodic re-check")),{title:d(this.hass,"ui.auto_trigger_group_time","Time"),detail:r.join(", ")}}case"sun":return{title:d(this.hass,"ui.auto_trigger_group_sun","Sun"),detail:e.suns.map(r=>this._sunPart(r)).join(", ")};case"reapply":return{title:d(this.hass,"ui.auto_trigger_reapply","Re-apply"),detail:`${d(this.hass,"ui.auto_trigger_every","every")} ${os(e.interval_seconds)}`}}}_renderRowIcon(e){return e.kind==="entity"?Rt(this.hass,e.entity_id):l`<ha-icon
      class="row-icon"
      icon=${lc[e.kind]??di}
  ...
  `,u([m({attribute:!1})],G.prototype,"hass",2),u([m({attribute:!1})],G.prototype,"scope",2),u([m()],G.prototype,"scopeName",2),u([m({attribute:!1})],G.prototype,"scenes",2),u([m({type:Boolean,reflect:!0})],G.prototype,"open",2),u([g()],G.prototype,"_triggers",2),u([g()],G.prototype,"_opaque",2),u([g()],G.prototype,"_loading",2),u([g()],G.prototype,"_error",2),G=u([w("ambience-auto-triggers-modal")],G);function go(t,n){return n==="not_home"?d(t,"ui.away","Away"):n==="home"?d(t,"ui.home","Home"):N(n)}function _o(t){return{state:t.live_state??"",attributes:Object.fromEntries(t.attributes.map(n=>[n.name,n.live_value==null?"":String(n.live_value)])),for:{h:0,m:0,s:0}}}function Ir(t){return String(t).padStart(2,"0")}function vo(t){return`${t.getFullYear()}-${Ir(t.getMonth()+1)}-${Ir(t.getDate())}`}function yo(t){return`${Ir(t.getHours())}:${Ir(t.getMinutes())}`}var A=class extends b{constructor(){super();this.category="";this.categoryName=null;this.open=!1;this._knobs=[];this._hasTime=!1;this._loading=!0;this._error="";this._values={};this._verdicts={};this._date="";this._time="";this._result=null;this._expanded=!1;new De(this,()=>this._onClose())}updated(e){this.open&&(e.has("open")||e.has("category")||e.has("scope"))&&this._load()}_vkey(e){return`${e.condition}:${e.key}`}async _load(){this._error="",this._loading=!0,this._result=null,this._expanded=!1;let e=new Date;this._date=vo(e),this._time=yo(e);try{let r=await In(this.hass,this.scope,this.category);if(!this.isConnected)return;this._knobs=r.knobs,this._hasTime=r.has_time;let i={},s={};for(let o of r.knobs)o.kind==="entity"?i[o.entity_id]=_o(o):s[this._vkey(o)]=o.live_value;this._values=i,this._verdicts=s,this._loading=!1}catch(r){this._error=r.message||String(r),this._loading=!1}}_setState(e,r){this._values={...this._values,[e]:{...this._values[e],state:r}}}_setAttr(e,r,i){let s=this._values[e];this._values={...this._values,[e]:{...s,attributes:{...s.attributes,[r]:i}}}}_setFor(e,r,i){let s=this._values[e],o=Number.isFinite(i)&&i>0?Math.trunc(i):0;this._values={...this._values,[e]:{...s,for:{...s.for,[r]:o}}}}_setVerdict(e,r){this._verdicts={...this._verdicts,[e]:r}}_resetWhen(){let e=new Date;this._date=vo(e),this._time=yo(e)}_resetEntity(e){this._values={...this._values,[e.entity_id]:_o(e)}}_resetVerdict(e){this._verdicts={...this._verdicts,[this._vkey(e)]:e.live_value}}_buildOverrides(){let e={};for(let r of this._knobs){if(r.kind!=="entity")continue;let i=this._values[r.entity_id];if(!i)continue;let s={};for(let a of r.attributes){let c=i.attributes[a.name];if(!(c===void 0||c===""))if(a.control==="number"){let h=Number(c);Number.isNaN(h)||(s[a.name]=h)}else s[a.name]=c}let o={attributes:s};i.state!==""&&(o.state=i.state),(i.for.h||i.for.m||i.for.s)&&(o.for=i.for),(o.state!==void 0||o.for!==void 0||Object.keys(s).length>0)&&(e[r.entity_id]=o)}return e}_buildVerdicts(){let e={};for(let r of this._knobs)r.kind==="verdict"&&(e[r.condition]||(e[r.condition]={}),e[r.condition][r.key]=this._verdicts[this._vkey(r)]??r.live_value);return e}async _run(){this._error="";let e=new Date(`${this._date}T${this._time}`);if(!this._date||!this._time||Number.isNaN(e.getTime())){this._error=d(this.hass,"ui.invalid_datetime","Enter a valid date and time.");return}let r=e.toISOString();try{this._result=await Fn(this.hass,this.scope,this.category,r,this._buildOverrides(),this._buildVerdicts()),this._expanded=!1}catch(i){this._error=i.message||String(i)}}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      <div class="modal" role="dialog" aria-modal="true" @click=${e=>e.stopPropagation()}>
        ...
        <div class="body">
          ...
          ${this._loading?l`<p>${d(this.hass,"ui.loading","Loading\u2026")}</p>`:l`
            ...
            ${this._result?l`<div class="result">${Nr(this._result,this._expanded,()=>this._expanded=!this._expanded,this.hass,void 0,this.periods?.custom??{})}</div>`:$}
          `}
        </div>
    ...
    `],u([m({attribute:!1})],A.prototype,"hass",2),u([m({attribute:!1})],A.prototype,"periods",2),u([m({attribute:!1})],A.prototype,"scope",2),u([m()],A.prototype,"category",2),u([m()],A.prototype,"categoryName",2),u([m({type:Boolean,reflect:!0})],A.prototype,"open",2),u([g()],A.prototype,"_knobs",2),u([g()],A.prototype,"_hasTime",2),u([g()],A.prototype,"_loading",2),u([g()],A.prototype,"_error",2),u([g()],A.prototype,"_values",2),u([g()],A.prototype,"_verdicts",2),u([g()],A.prototype,"_date",2),u([g()],A.prototype,"_time",2),u([g()],A.prototype,"_result",2),u([g()],A.prototype,"_expanded",2),A=u([w("ambience-simulator-modal")],A);function dc(t){let n=Math.floor(t/3600),e=Math.floor(t%3600/60),r=t%60,i=s=>String(s).padStart(2,"0");return n>0?`${n}:${i(e)}:${i(r)}`:`${e}:${i(r)}`}var Oi=1024;function cc(t,n,e){if(t!==void 0&&n!==void 0)return Math.floor((t+n)/2);let r=e.map(i=>i.priority??0);return t===void 0&&n===void 0?Oi:t===void 0?Math.max(...r)+Oi:Math.min(...r)-Oi}var Q=class extends b{constructor(){super(...arguments);this._store=new P(this);this._expanded=new Set(hn());this._conditionsHintDismissed=!1;this._editing=null;this._sceneEditorError="";this._savingScene=!1;this._viewingTraces=null;this._viewingSimulator=null;this._autoTriggers=null;this.filterCategory=""}async connectedCallback(){super.connectedCallback(),this._conditionsHintDismissed=mn(),await this._store.loadStatic(),await Promise.all([this._store.refreshAreas(),this._store.refreshFloors(),this._store.refreshHouse(),this._store.refreshSwitches()]),await this._store.subscribe(e=>this._onScopeRemoved(e))}_onScopeRemoved(e){let r=O(e),i=new Set(this._expanded);i.delete(r),this._setExpanded(i),this._editing&&O(this._editing.scope)===r&&(this._editing=null)}_setExpanded(e){this._expanded=e,pn([...e])}_toggleExpand(e){let r=O(e),i=new Set(this._expanded);i.has(r)?i.delete(r):i.add(r),this._setExpanded(i)}_addScene(e,r){let i=this._store.getConfig(e);i&&(this._sceneEditorError="",this._editing={scope:e,index:i.scenes.length,isNew:!0,category:r})}_editScene(e,r){this._sceneEditorError="",this._editing={scope:e,index:r.detail.index,isNew:!1}}_duplicateScene(e,r){let i=this._store.getConfig(e);if(!i)return;let s=i.scenes[r.detail.index];if(!s)return;let o=Tt(JSON.parse(JSON.stringify(s)));this._sceneEditorError="",this._editing={scope:e,index:i.scenes.length,isNew:!0,seed:o}}_deleteScene(e,r){let i=this._store.getConfig(e);if(!i)return;let s=i.scenes.filter((o,a)=>a!==r.detail.index);this._store.mutate(e,{...i,scenes:s})}_reorderScenes(e,r){let i=this._store.getConfig(e);if(!i)return;let{from:s,to:o}=r.detail,a=i.scenes[s];if(!a||i.scenes[o]?.category!==a.category)return;let c=[...i.scenes];c.splice(s,1),c.splice(o,0,a);let h=E=>c[E]&&c[E].category===a.category,p=o-1;for(;p>=0&&!h(p);)p--;let f=o+1;for(;f<c.length&&!h(f);)f++;let _=p>=0?c[p].priority:void 0,y=f<c.length?c[f].priority:void 0,k=cc(_,y,i.scenes.filter(E=>E.category===a.category));c[o]={...a,priority:k,pinned:!0},this._store.mutate(e,{...i,scenes:c})}_unpinScene(e,r){let i=this._store.getConfig(e);if(!i)return;let s=i.scenes.map((o,a)=>a===r.detail.index?{...o,pinned:!1}:o);this._store.mutate(e,{...i,scenes:s})}_toggleSceneEnabled(e,r){let i=this._store.getConfig(e);if(!i)return;let s=i.scenes.map((o,a)=>{if(a!==r.detail.index)return o;if(r.detail.enabled){let c={...o};return delete c.enabled,c}return{...o,enabled:!1}});this._store.mutate(e,{...i,scenes:s})}async _saveScene(e){if(this._savingScene)return;let r=this._editing;if(!r)return;let{scene:i,scope:s}=e.detail;this._savingScene=!0,this._sceneEditorError="";try{if(O(s)===O(r.scope)){let h=this._store.getConfig(s);if(!h)return;let p=[...h.scenes];r.isNew?p.push(i):p[r.index]=i,await this._store.mutate(s,{...h,scenes:p})?this._editing=null:this._sceneEditorError=this._takeError();return}let o=Tt(i),a=this._store.getConfig(s);if(!a)return;if(!await this._store.mutate(s,{...a,scenes:[...a.scenes,o]})){this._sceneEditorError=this._takeError();return}if(this._editing=null,!r.isNew){let h=this._store.getConfig(r.scope);if(h){let p=h.scenes.filter((f,_)=>_!==r.index);await this._store.mutate(r.scope,{...h,scenes:p})}}}finally{this._savingScene=!1}}_takeError(){let e=this._store.error;return this._store.error="",e}async _callApi(e){this._store.error="";try{await e()}catch(r){this._store.error=r.message||String(r)}}_applyScenes(e,r){return this._callApi(()=>kn(this.hass,e,r))}_runSceneActions(e,r){return this._callApi(()=>En(this.hass,e,r.detail.index))}_cancelScene(){this._sceneEditorError="",this._editing=null}_onScopeMenu(e,r,i,s){s==="run"?this._applyScenes(e):s==="auto"&&(this._autoTriggers={scope:e,name:r})}_showTraces(e,r){let i=this._store.categories.find(s=>s.id===r);this._viewingTraces={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},category:r,categoryName:i?.name??null}}_showSimulator(e,r){let i=this._store.categories.find(s=>s.id===r);this._viewingSimulator={scope:{scope_kind:e.kind,scope_id:"id"in e?e.id:null},category:r,categoryName:i?.name??null}}_defaultCategoryId(){return this.filterCategory!==""?this.filterCategory:[...this._store.categories].sort((r,i)=>r.name.localeCompare(i.name))[0]?.id??""}get _editingScene(){return this._editing?this._editing.seed?this._editing.seed:this._editing.isNew?{when:{},actions:[],category:this._editing.category??this._defaultCategoryId()}:this._store.getConfig(this._editing.scope)?.scenes[this._editing.index]??null:null}get _editorConditions(){return this._editing?this._store.conditions.slice().sort((e,r)=>r.priority-e.priority):[]}get _takenSceneNames(){let e=new Map,r=this._editing,i=(s,o)=>{if(!o)return;let a=!!r&&!r.isNew&&O(r.scope)===O(s);o.scenes.forEach((c,h)=>{if(a&&h===r.index)return;let p=c.name?.trim().toLowerCase();if(!p)return;let f=mr(s,c.category),_=e.get(f);_||(_=new Set,e.set(f,_)),_.add(p)})};i({kind:"house"},this._store.house);for(let s of this._store.floors)i({kind:"floor",id:s.floor_id},this._store.floorConfigs.get(s.floor_id));for(let s of this._store.areas)i({kind:"area",id:s.area_id},this._store.areaConfigs.get(s.area_id));return e}get _scopeOptions(){return[{scope:{kind:"house"},label:d(this.hass,"ui.scope_house","House")},...this._store.floors.map(e=>({scope:{kind:"floor",id:e.floor_id},label:e.name})),...this._store.areas.map(e=>({scope:{kind:"area",id:e.area_id},label:e.name}))]}_matchingSceneCount(e){return this.filterCategory===""?e.scenes.length:e.scenes.filter(r=>r.category===this.filterCategory).length}_summary(e){if(e.scenes.length===0)return d(this.hass,"ui.not_configured","not configured");let r=this._matchingSceneCount(e),i=r===1?d(this.hass,"ui.scene_singular","scene"):d(this.hass,"ui.scene_plural","scenes");return`${r} ${i}`}get _weatherUnconfigured(){return!this._store.weatherConfig||this._store.weatherConfig.entity==null}get _workdayUnconfigured(){let e=this._store.dayConfig;return!e||e.workday_sensor==null&&e.workday_calendar==null}get _conditionsUnconfigured(){return this._weatherUnconfigured||this._workdayUnconfigured}_conditionsHintText(){let e=this._weatherUnconfigured,r=this._workdayUnconfigured;return e&&r?{title:d(this.hass,"ui.conditions_hint_title","Optional: set up Workday & Weather"),body:d(this.hass,"ui.conditions_hint_body","Configure Workday and Weather in Conditions to use them in your scene conditions.")}:r?{title:d(this.hass,"ui.conditions_hint_title_workday","Optional: set up Workday"),body:d(this.hass,"ui.conditions_hint_body_workday","Configure Workday in Conditions to use it in your scene conditions.")}:{title:d(this.hass,"ui.conditions_hint_title_weather","Optional: set up Weather"),body:d(this.hass,"ui.conditions_hint_body_weather","Configure Weather in Conditions to use it in your scene conditions.")}}_openSettings(e){this.dispatchEvent(new CustomEvent("ambience-open-settings",{detail:{tab:e},bubbles:!0,composed:!0}))}_dismissConditionsHint(){this._conditionsHintDismissed=!0,fn()}_renderBanners(){if(!this._store.staticLoaded)return"";if(this._store.actions.length===0)return l`
      ...
      ${this._renderBanners()}
      <ul>
        ${Bn(this._orderedScopeRows(),e=>O(e.scope),e=>this._renderScopeRow(e.scope,e.name,e.cfg,e.rowClass))}
    ...
    </button>`}_renderScopeSwitch(e,r){let i=r.enabled!==!1,s=a=>a.stopPropagation(),o=async a=>{a.stopPropagation();try{await An(this.hass,e,!i),await this._store.reloadScope(e)}catch(c){this._store.error=c.message||String(c)}};return customElements.get("ha-switch")?l`<ha-switch
        class="scope-switch"
  ...
  `,u([m({attribute:!1})],He.prototype,"hass",2),u([g()],He.prototype,"_defaults",2),u([g()],He.prototype,"_error",2),He=u([w("ambience-ambience-settings")],He);function bo(){let t=globalThis.crypto;if(t?.randomUUID)return t.randomUUID().replace(/-/g,"");if(t?.getRandomValues){let n=t.getRandomValues(new Uint8Array(16));return Array.from(n,e=>e.toString(16).padStart(2,"0")).join("")}return Array.from({length:4},()=>Math.floor(Math.random()*4294967296).toString(16).padStart(8,"0")).join("")}var ue=class extends b{constructor(){super(...arguments);this._categories=[];this._error="";this._editing=null;this._modalError=""}async connectedCallback(){super.connectedCallback();try{this._categories=await Be(this.hass)}catch(e){this._error=e.message||String(e)}}_sorted(){return[...this._categories].sort((e,r)=>e.name.localeCompare(r.name))}_validate(e){let r=e.name.trim();if(r==="")return d(this.hass,"ui.category_name_blank_error","Category names can't be empty.");let i=r.toLocaleLowerCase();return this._categories.some(o=>o.id!==e.id&&o.name.trim().toLocaleLowerCase()===i)?d(this.hass,"ui.category_name_duplicate_error","Two categories can't have the same name."):""}_openEditor(e){this._editing={...e},this._modalError=""}_addCategory(){let e=bo();this._editing={id:e,name:""},this._modalError=""}_closeModal(){this._editing=null,this._modalError=""}_patchDraft(e){this._editing&&(this._editing={...this._editing,...e})}_onName(e){this._patchDraft({name:e.target.value})}_onIcon(e){this._patchDraft({icon:e||void 0})}_onColor(e){this._patchDraft({color:e})}_save(){if(!this._editing)return;let e=this._validate(this._editing);if(e){this._modalError=e;return}let r={...this._editing,name:this._editing.name.trim()},i=this._categories.some(s=>s.id===r.id);this._categories=i?this._categories.map(s=>s.id===r.id?r:s):[...this._categories,r],this._closeModal(),Dn(this.hass,this._categories).then(()=>{window.dispatchEvent(new CustomEvent("ambience-categories-changed"))}).catch(s=>{this._error=s.message||String(s)})}_deleteCategory(){if(!this._editing)return;let e=this._editing.id;if(this._categories.length<=1){this._modalError=d(this.hass,"ui.category_delete_blocked_last","You can't delete the last category.");return}let r=this._categories;this._categories=this._categories.filter(i=>i.id!==e),Hn(this.hass,e).then(()=>{this._closeModal(),window.dispatchEvent(new CustomEvent("ambience-categories-changed"))}).catch(i=>{this._categories=r;let s=i.code;s==="category_in_use"?this._modalError=d(this.hass,"ui.category_delete_blocked_in_use","This category still has scenes \u2014 move or delete them first."):s==="category_last"?this._modalError=d(this.hass,"ui.category_delete_blocked_last","You can't delete the last category."):this._modalError=i.message||String(i)})}_renderIconField(){return customElements.get("ha-icon-picker")?l`<ha-icon-picker
    ...
    `}render(){return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      <div class="list">
        ${this._sorted().map(e=>{let r=oi(e.color);return l`<button class="category-row" @click=${()=>this._openEditor(e)}>
  ...
  `,u([m({attribute:!1})],ue.prototype,"hass",2),u([g()],ue.prototype,"_categories",2),u([g()],ue.prototype,"_error",2),u([g()],ue.prototype,"_editing",2),u([g()],ue.prototype,"_modalError",2),ue=u([w("ambience-categories-settings")],ue);var ve=class extends b{constructor(){super(...arguments);this.conditionName="";this.conditionDescription="";this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}render(){let e=X(this.hass,this.conditionName);return l`
      <div class="card">
  ...
  `,u([m({attribute:!1})],ve.prototype,"hass",2),u([m()],ve.prototype,"conditionName",2),u([m()],ve.prototype,"conditionDescription",2),u([g()],ve.prototype,"_expanded",2),ve=u([w("ambience-condition-card")],ve);var uc=/^[a-z][a-z0-9_]*$/;function hc(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var Wt=v`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,se=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=Wt}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!uc.test(e)?d(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?d(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":d(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??hc(this._label),r=this._validateName(e)||this._validateDef();if(r){this._error=r,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return l`
    ...
    `],u([m({attribute:!1})],Oe.prototype,"initial",2),u([g()],Oe.prototype,"_min",2),u([g()],Oe.prototype,"_max",2),Oe=u([w("ambience-lux-edit-modal")],Oe);var Mr=class extends ie{_list(){return lr(this.hass)}_save(n,e){return Cn(this.hass,n,e)}_label(n,e){return nt(this.hass,n,e)}_formatDef(n){return pi(n.min,n.max,"any")}_headingKey(){return["ui.lux_heading","Lux ranges"]}_addKey(){return["ui.add_custom_lux_range","+ Add custom lux range"]}_warningTextKey(){return["ui.lux_warning_text","some scenes now reference missing lux ranges:"]}_renderModal(){let n=this._modal;return n.mode==="edit"?l`<ambience-lux-edit-modal
      ...
      ${this._warnings.length?l`
        <div class="warnings">
          ...
          <ul>
            ${this._warnings.map(r=>l`<li>${Te(r)} / "${r.scene_name}" → ${r.reason}</li>`)}
          </ul>
        </div>
      `:""}
    `}};ye.styles=v`
  ...
  `,u([m({attribute:!1})],ye.prototype,"hass",2),u([g()],ye.prototype,"_config",2),u([g()],ye.prototype,"_warnings",2),u([g()],ye.prototype,"_error",2),ye=u([w("ambience-day-config")],ye);var pc=["clear-night","cloudy","fog","hail","lightning","lightning-rainy","partlycloudy","pouring","rainy","snowy","snowy-rainy","sunny","windy","windy-variant","exceptional"],be=class extends b{constructor(){super(...arguments);this._config={entity:null,groups:[]};this._warnings=[];this._expanded=new Set}async connectedCallback(){super.connectedCallback(),ee(this),this._config=await Ct(this.hass)}async _persist(){let e=await Ln(this.hass,this._config.entity,this._config.groups);this._warnings=e.warnings??[],window.dispatchEvent(new CustomEvent("ambience-conditions-changed"))}_onEntityChange(e){this._config={...this._config,entity:e.detail.value||null},this._persist()}_nextGroupId(e){let r=new Set(e.map(i=>i.id));for(let i=1;i<=e.length+1;i++){let s=`group_${i}`;if(!r.has(s))return s}return`group_${e.length+1}`}_addGroup(){let e=this._nextGroupId(this._config.groups);this._config={...this._config,groups:[...this._config.groups,{id:e,label:"",conditions:[]}]},this._expanded=new Set([...this._expanded,e]),this._persist()}_toggleExpand(e){let r=new Set(this._expanded);r.has(e)?r.delete(e):r.add(e),this._expanded=r}_updateGroup(e,r){this._config={...this._config,groups:this._config.groups.map((i,s)=>s===e?{...i,...r}:i)},this._persist()}_removeGroup(e){let r=this._config.groups[e];if(this._config={...this._config,groups:this._config.groups.filter((i,s)=>s!==e)},r){let i=new Set(this._expanded);i.delete(r.id),this._expanded=i}this._persist()}_conditionsSchema(){return[{name:"conditions",selector:{select:{multiple:!0,mode:"dropdown",options:pc.map(e=>({value:e,label:ot(this.hass,e)}))}}}]}_renderConditions(e,r){if(customElements.get("ha-form"))return l`<ha-form
    ...
    `}render(){return l`
      ...
      ${this._warnings.length?l`
        <div class="warnings">
          ...
          <ul>${this._warnings.map(e=>l`<li>${Te(e)} / "${e.scene_name}" → ${e.reason}</li>`)}</ul>
        </div>
      `:""}
    `}};be.styles=v`
    :host { display: block; }
    ...
    .warnings ul { margin: 0.3rem 0 0 0; padding-left: 1.2rem; }
  `,u([m({attribute:!1})],be.prototype,"hass",2),u([g()],be.prototype,"_config",2),u([g()],be.prototype,"_warnings",2),u([g()],be.prototype,"_expanded",2),be=u([w("ambience-weather-config")],be);var xo={time_of_day:t=>l`<ambience-time-of-day-config .hass=${t}></ambience-time-of-day-config>`,lux:t=>l`<ambience-lux-config .hass=${t}></ambience-lux-config>`,day:t=>l`<ambience-day-config .hass=${t}></ambience-day-config>`,weather:t=>l`<ambience-weather-config .hass=${t}></ambience-weather-config>`},mc=new Set(Object.keys(xo)),Ne=class extends b{constructor(){super(...arguments);this._conditions=[];this._error=""}async connectedCallback(){super.connectedCallback();try{this._conditions=await or(this.hass)}catch(e){this._error=e.message||String(e)}}render(){let e=this._conditions.filter(r=>mc.has(r.name)).slice().sort((r,i)=>i.priority-r.priority);return l`
      ${this._error?l`<p class="error">${this._error}</p>`:""}
      ${e.map(r=>l`
  ...
  `,u([m({attribute:!1})],Ne.prototype,"hass",2),u([g()],Ne.prototype,"_conditions",2),u([g()],Ne.prototype,"_error",2),Ne=u([w("ambience-conditions-settings")],Ne);var R=class extends b{constructor(){super(...arguments);this._actions=[];this._services=[];this._schemas={};this._fieldSchemas={};this._addSchema=[];this._serviceById=new Map;this._availableServices=[];this._expanded=new Set;this._adding=!1;this._warnings=[];this._loadError=null;this._saveError=null;this._loaded=!1;this._editingDefault=null;this._editingOriginalValue=void 0;this._editingOriginalHad=!1;this._drag=new ct(this,(e,r)=>{let i=[...this._actions],[s]=i.splice(e,1);i.splice(r,0,s),this._actions=i,this._autoSave()});this._onDocPointerDown=e=>{if(!this._adding&&this._editingDefault===null)return;let r=e.composedPath(),i=r.some(s=>s instanceof Element&&R._OVERLAY_TAG_RE.test(s.localName));this._collapseAddFormOnClickAway(r,i),this._cancelEditingDefaultOnClickAway(r,i)}}_collapseAddFormOnClickAway(e,r){if(!this._adding)return;let i=this.shadowRoot?.querySelector(".add-row");!(!!i&&e.includes(i))&&!r&&(this._adding=!1)}_cancelEditingDefaultOnClickAway(e,r){if(this._editingDefault===null)return;let i=this.shadowRoot?.querySelector(`.field-row-editor[data-editing-key="${this._editingDefault}"]`);(!i||!e.includes(i))&&!r&&this._cancelEditingDefault()}connectedCallback(){super.connectedCallback(),document.addEventListener("pointerdown",this._onDocPointerDown),customElements.get("ha-service-picker")||customElements.whenDefined("ha-service-picker").then(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerdown",this._onDocPointerDown)}_startEditingDefault(e,r){let s=this._actions.find(o=>o.id===e)?.defaults??{};this._editingOriginalHad=r in s,this._editingOriginalValue=s[r],this._editingDefault=`${e}:${r}`}_saveEditingDefault(){this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1,this._autoSave()}_cancelEditingDefault(){let e=this._editingDefault;if(e){let r=e.indexOf(":"),i=e.slice(0,r),s=e.slice(r+1);this._actions=this._actions.map(o=>{if(o.id!==i)return o;let a={...o.defaults??{}};return this._editingOriginalHad?a[s]=this._editingOriginalValue:delete a[s],{...o,defaults:a}})}this._editingDefault=null,this._editingOriginalValue=void 0,this._editingOriginalHad=!1}async firstUpdated(){await this._reload()}willUpdate(e){if(e.has("_actions")||e.has("_schemas")){let r={};for(let i of this._actions){let s=this._schemas[i.id];if(s)for(let[o,a]of Object.entries(s.fields))r[`${i.id}:${o}`]=[{name:o,selector:a.selector??{text:{}},required:!1}]}this._fieldSchemas=r}if(e.has("_services")&&(this._serviceById=new Map(this._services.map(r=>[r.id,r]))),e.has("_actions")||e.has("_services")){let r=new Set(this._actions.map(i=>i.id));this._availableServices=this._services.filter(i=>!r.has(i.id)),this._addSchema=[{name:"service",selector:{select:{options:this._availableServices.map(i=>({value:i.id,label:this._addOptionLabel(i.id)})),custom_value:!0,mode:"dropdown",sort:!0}}}]}}async _reload(){this._loadError=null;try{let[e,r]=await Promise.all([Et(this.hass),$n(this.hass)]);this._actions=e,this._services=r}catch(e){this._loadError=e instanceof Error?e.message:String(e);return}await Promise.all(this._actions.map(e=>this._ensureSchema(e.id))),this._loaded=!0}async _ensureSchema(e){if(!(e in this._schemas))try{let r=await $e(this.hass,e);this._schemas={...this._schemas,[e]:r}}catch{this._schemas={...this._schemas,[e]:null}}}_setShowInEditor(e,r,i){this._actions=this._actions.map(s=>{if(s.id!==e)return s;let o=new Set(s.visible_fields??[]);return i?o.add(r):o.delete(r),{...s,visible_fields:[...o]}}),this._autoSave()}_setDefault(e,r,i){this._actions=this._actions.map(s=>s.id!==e?s:{...s,defaults:{...s.defaults??{},[r]:i}})}_clearDefault(e,r){this._actions=this._actions.map(i=>{if(i.id!==e)return i;let s={...i.defaults??{}};return delete s[r],{...i,defaults:s}})}_setLabel(e,r){this._actions=this._actions.map(i=>i.id===e?{...i,label:r}:i)}_setReapplyEnabled(e,r){this._actions=this._actions.map(i=>{if(i.id!==e)return i;if(!r){let{reapply_seconds:s,...o}=i;return o}return{...i,reapply_seconds:300}}),this._autoSave()}_setReapplySeconds(e,r){let i=is(r);i!==null&&(this._actions=this._actions.map(s=>s.id!==e?s:{...s,reapply_seconds:i}),this._autoSave())}_toggleExpand(e){this._expanded.has(e)?this._expanded=new Set:(this._expanded=new Set([e]),this._ensureSchema(e))}async _addService(e){if(e&&this._services.some(r=>r.id===e)){if(this._actions.some(r=>r.id===e)){this._expanded=new Set([e]),this._adding=!1;return}await this._ensureSchema(e),this._actions=[...this._actions,{id:e,label:this._labelForService(e),visible_fields:[],defaults:{}}],this._expanded=new Set([e]),this._adding=!1,this._autoSave()}}_removeService(e){this._actions=this._actions.filter(i=>i.id!==e);let r=new Set(this._expanded);r.delete(e),this._expanded=r,this._autoSave()}async _autoSave(){this._saveError=null,this._warnings=[];try{let e=await xn(this.hass,this._actions);this._warnings=e.warnings??[],window.dispatchEvent(new CustomEvent("ambience-exposed-actions-changed"))}catch(e){this._saveError=e instanceof Error?e.message:String(e)}}render(){return this._loadError!==null?l`
    ...
    >
      ...
      ${this._warnings.map(e=>l`<li>
          ${Te(e)}${e.scene_name?l` — <em>${e.scene_name}</em>`:""}: ${e.reason}
        </li>`)}
    </ul>`}};R.styles=v`
    :host { display: block; }
    .card {
  ...
  `}connectedCallback(){super.connectedCallback(),ee(this),this.addEventListener("ambience-open-settings",this._onOpenSettings),this.addEventListener("ambience-filter-changed",this._onFilterChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("ambience-open-settings",this._onOpenSettings),this.removeEventListener("ambience-filter-changed",this._onFilterChanged)}render(){let e={dark:!!this.hass.themes?.darkMode,title:d(this.hass,"ui.panel_title","Ambience")};return l`
      ...
      ></ambience-settings-modal>
    `}};u([m({attribute:!1})],tt.prototype,"hass",2),u([g()],tt.prototype,"_settingsOpen",2),u([g()],tt.prototype,"_settingsTab",2),u([g()],tt.prototype,"_filterCategory",2);en("ambience-frontend",tt);export{tt as AmbienceFrontend};
