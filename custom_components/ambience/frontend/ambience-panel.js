...
\f\r"'\`<>=]|("|')|))|$)`,"g"),at=/'/g,ot=/"/g,ut=/^(?:script|style|textarea|title)$/i,Ge=n=>(s,...e)=>({_$litType$:n,strings:s,values:e}),l=Ge(1),Tr=Ge(2),Dr=Ge(3),J=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),lt=new WeakMap,K=V.createTreeWalker(V,129);function ct(n,s){if(!Ue(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return st!==void 0?st.createHTML(s):s}var Vt=(n,s)=>{let e=n.length-1,t=[],r,i=s===2?"<svg>":s===3?"<math>":"",a=oe;for(let h=0;h<e;h++){let u=n[h],f,v,y=-1,A=0;for(;A<u.length&&(a.lastIndex=A,v=a.exec(u),v!==null);)A=a.lastIndex,a===oe?v[1]==="!--"?a=it:v[1]!==void 0?a=nt:v[2]!==void 0?(ut.test(v[2])&&(r=RegExp("</"+v[2],"g")),a=B):v[3]!==void 0&&(a=B):a===B?v[0]===">"?(a=r??oe,y=-1):v[1]===void 0?y=-2:(y=a.lastIndex-v[2].length,f=v[1],a=v[3]===void 0?B:v[3]==='"'?ot:at):a===ot||a===at?a=B:a===it||a===nt?a=oe:(a=B,r=void 0);let O=a===B&&n[h+1].startsWith("/>")?" ":"";i+=a===oe?u+Bt:y>=0?(t.push(f),u.slice(0,y)+dt+u.slice(y)+z+O):u+z+(y===-2?h:O)}return[ct(n,i+(n[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},he=class n{constructor({strings:s,_$litType$:e},t){let r;this.parts=[];let i=0,a=0,h=s.length-1,u=this.parts,[f,v]=Vt(s,e);if(this.el=n.createElement(f,t),K.currentNode=this.el.content,e===2||e===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(r=K.nextNode())!==null&&u.length<h;){if(r.nodeType===1){if(r.hasAttributes())for(let y of r.getAttributeNames())if(y.endsWith(dt)){let A=v[a++],O=r.getAttribute(y).split(z),fe=/([.?@])?(.*)/.exec(A);u.push({type:1,index:i,name:fe[2],strings:O,ctor:fe[1]==="."?Oe:fe[1]==="?"?ze:fe[1]==="@"?Fe:ee}),r.removeAttribute(y)}else y.startsWith(z)&&(u.push({type:6,index:i}),r.removeAttribute(y));if(ut.test(r.tagName)){let y=r.textContent.split(z),A=y.length-1;if(A>0){r.textContent=be?be.emptyScript:"";for(let O=0;O<A;O++)r.append(y[O],le()),K.nextNode(),u.push({type:2,index:++i});r.append(y[A],le())}}}else if(r.nodeType===8)if(r.data===ht)u.push({type:2,index:i});else{let y=-1;for(;(y=r.data.indexOf(z,y+1))!==-1;)u.push({type:7,index:i}),y+=z.length-1}i++}}static createElement(s,e){let t=V.createElement("template");return t.innerHTML=s,t}};function Q(n,s,e=n,t){if(s===J)return s;let r=t!==void 0?e._$Co?.[t]:e._$Cl,i=de(s)?void 0:s._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),i===void 0?r=void 0:(r=new i(n),r._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=r:e._$Cl=r),r!==void 0&&(s=Q(n,r._$AS(n,s.values),r,t)),s}var Me=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,r=(s?.creationScope??V).importNode(e,!0);K.currentNode=r;let i=K.nextNode(),a=0,h=0,u=t[0];for(;u!==void 0;){if(a===u.index){let f;u.type===2?f=new ue(i,i.nextSibling,this,s):u.type===1?f=new u.ctor(i,u.name,u.strings,this,s):u.type===6&&(f=new je(i,this,s)),this._$AV.push(f),u=t[++h]}a!==u?.index&&(i=K.nextNode(),a++)}return K.currentNode=V,r}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},ue=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=Q(this,s,e),de(s)?s===b||s==null||s===""?(this._$AH!==b&&this._$AR(),this._$AH=b):s!==this._$AH&&s!==J&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):Kt(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==b&&de(this._$AH)?this._$AA.nextSibling.data=s:this.T(V.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,r=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=he.createElement(ct(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===r)this._$AH.p(e);else{let i=new Me(r,this),a=i.u(this.options);i.p(e),this.T(a),this._$AH=i}}_$AC(s){let e=lt.get(s.strings);return e===void 0&&lt.set(s.strings,e=new he(s)),e}k(s){Ue(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,r=0;for(let i of s)r===e.length?e.push(t=new n(this.O(le()),this.O(le()),this,this.options)):t=e[r],t._$AI(i),r++;r<e.length&&(this._$AR(t&&t._$AB.nextSibling,r),e.length=r)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=rt(s).nextSibling;rt(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},ee=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,r,i){this.type=1,this._$AH=b,this._$AN=void 0,this.element=s,this.name=e,this._$AM=r,this.options=i,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=b}_$AI(s,e=this,t,r){let i=this.strings,a=!1;if(i===void 0)s=Q(this,s,e,0),a=!de(s)||s!==this._$AH&&s!==J,a&&(this._$AH=s);else{let h=s,u,f;for(s=i[0],u=0;u<i.length-1;u++)f=Q(this,h[t+u],e,u),f===J&&(f=this._$AH[u]),a||=!de(f)||f!==this._$AH[u],f===b?s=b:s!==b&&(s+=(f??"")+i[u+1]),this._$AH[u]=f}a&&!r&&this.j(s)}j(s){s===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},Oe=class extends ee{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===b?void 0:s}},ze=class extends ee{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==b)}},Fe=class extends ee{constructor(s,e,t,r,i){super(s,e,t,r,i),this.type=5}_$AI(s,e=this){if((s=Q(this,s,e,0)??b)===J)return;let t=this._$AH,r=s===b&&t!==b||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,i=s!==b&&(t===b||r);r&&this.element.removeEventListener(this.name,this,t),i&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},je=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){Q(this,s)}};var Jt=We.litHtmlPolyfillSupport;Jt?.(he,ue),(We.litHtmlVersions??=[]).push("3.3.2");var pt=(n,s,e)=>{let t=e?.renderBefore??s,r=t._$litPart$;if(r===void 0){let i=e?.renderBefore??null;t._$litPart$=r=new ue(s.insertBefore(le(),i),i,void 0,e??{})}return r._$AI(n),r};var qe=globalThis,m=class extends T{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=pt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return J}};m._$litElement$=!0,m.finalized=!0,qe.litElementHydrateSupport?.({LitElement:m});var Yt=qe.litElementPolyfillSupport;Yt?.({LitElement:m});(qe.litElementVersions??=[]).push("4.2.2");var g=n=>(s,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(n,s)}):customElements.define(n,s)};var Xt={attribute:!0,type:String,converter:ae,reflect:!1,hasChanged:ye},Zt=(n=Xt,s,e)=>{let{kind:t,metadata:r}=e,i=globalThis.litPropertyMetadata.get(r);if(i===void 0&&globalThis.litPropertyMetadata.set(r,i=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),i.set(e.name,n),t==="accessor"){let{name:a}=e;return{set(h){let u=s.get.call(this);s.set.call(this,h),this.requestUpdate(a,u,n,!0,h)},init(h){return h!==void 0&&this.C(a,void 0,n,h),h}}}if(t==="setter"){let{name:a}=e;return function(h){let u=this[a];s.call(this,h),this.requestUpdate(a,u,n,!0,h)}}throw Error("Unsupported decorator location: "+t)};function c(n){return(s,e)=>typeof e=="object"?Zt(n,s,e):((t,r,i)=>{let a=r.hasOwnProperty(i);return r.constructor.createProperty(i,t),a?Object.getOwnPropertyDescriptor(r,i):void 0})(n,s,e)}function p(n){return c({...n,state:!0,attribute:!1})}function C(n,s,e){let t=n?.localize?.(s);return t&&t!==s?t:e}function Be(n){let s=n.replaceAll("_"," ").toLowerCase();return s.charAt(0).toUpperCase()+s.slice(1)}function te(n,s){return C(n,`component.ambience.matcher.${s}`,Be(s))}function mt(n,s){return C(n,`component.ambience.action.${s}`,Be(s))}function re(n,s){return C(n,`component.ambience.anchor.${s}`,Be(s))}function Y(n,s,e){let t=e[s]?.label;if(t)return t;let r=s.charAt(0).toUpperCase()+s.slice(1);return C(n,`component.ambience.time_of_day_period.${s}`,r)}function o(n,s,e){return C(n,`component.ambience.${s}`,e)}var Qt=["mon","tue","wed","thu","fri","sat","sun"],er=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];function we(n,s){return C(n,`component.ambience.weekday.${Qt[s]}`,er[s]??String(s))}var tr={weekday:"Day of week",day_of_month:"Day of month",date:"Date (annual)",date_range:"Date range (annual)",last_day:"Last day of month",workday:"Workday",holiday:"Holiday",first_workday:"First workday of month",last_workday:"Last workday of month"};function ke(n,s){return C(n,`component.ambience.day_item.${s}`,tr[s]??s)}var rr=["January","February","March","April","May","June","July","August","September","October","November","December"];function se(n,s){return C(n,`component.ambience.month.${s}`,rr[s-1]??String(s))}var sr={"clear-night":"Clear (night)",cloudy:"Cloudy",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning-rainy",partlycloudy:"Partly cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy-rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy (variant)",exceptional:"Exceptional"};function xe(n,s){return C(n,`component.ambience.weather_condition.${s}`,sr[s]??s)}var ir={temperature:"Temperature",apparent_temperature:"Apparent temperature",humidity:"Humidity",wind_speed:"Wind speed",pressure:"Pressure"};function ce(n,s){return C(n,`component.ambience.weather_attr.${s}`,ir[s]??s)}var nr={temperature:"\xB0C",apparent_temperature:"\xB0C",humidity:"%",wind_speed:"m/s",pressure:"hPa"},ar={temperature:"temperature",apparent_temperature:"temperature",wind_speed:"wind_speed",pressure:"pressure"},or={temperature:"temperature_unit",apparent_temperature:"temperature_unit",wind_speed:"wind_speed_unit",pressure:"pressure_unit"};function Ke(n,s,e){if(s==="humidity")return"%";let t=or[s];if(t){let a=e?.attributes?.[t];if(typeof a=="string"&&a)return a}let r=ar[s],i=n?.config?.unit_system;return r&&i&&typeof i[r]=="string"?i[r]:nr[s]??""}var lr={is:"is",is_not:"is not",and:"AND",or:"OR",and_not:"AND NOT",or_not:"OR NOT",not:"NOT"};function x(n,s){return C(n,`component.ambience.state_op.${s}`,lr[s]??s)}var dr=["ha-input","ha-textfield","ha-form"],hr=["ha-input","ha-textfield"];function ft(){for(let n of hr)if(customElements.get(n))return n;return null}function F(n,s){for(let e of dr)customElements.get(e)||customElements.whenDefined(e).then(()=>n.requestUpdate())}async function _t(n){return n.callWS({type:"ambience/areas/list"})}async function gt(n,s){return n.callWS({type:"ambience/area/get",area_id:s})}async function vt(n,s,e){return n.callWS({type:"ambience/area/save",area_id:s,config:e})}async function Ee(n){return n.callWS({type:"ambience/matchers/list"})}async function yt(n){return n.callWS({type:"ambience/actions/list"})}async function Se(n){return n.callWS({type:"ambience/time_of_day_periods/list"})}async function bt(n,s,e){return n.callWS({type:"ambience/time_of_day_periods/save",custom:s,hidden:e})}async function Ce(n){return n.callWS({type:"ambience/matchers/enabled/list"})}async function $t(n,s){return n.callWS({type:"ambience/matchers/enabled/save",enabled:s})}async function Pe(n){return n.callWS({type:"ambience/matchers/day/config/list"})}async function wt(n,s,e){return n.callWS({type:"ambience/matchers/day/config/save",workday_sensor:s,workday_calendar:e})}async function He(n){return n.callWS({type:"ambience/matchers/weather/config/list"})}async function kt(n,s,e){return n.callWS({type:"ambience/matchers/weather/config/save",entity:s,groups:e})}async function xt(n,s){return n.callWS({type:"ambience/state/known_states",entity_id:s})}function Ae(n,s="New rule"){if(n.name&&n.name.trim())return n.name;let e=n.when?.scene;return typeof e=="string"&&e.trim()?e:s}function Te(n,s,e){return s==null?o(e.hass,"ui.summary_any_paren","(any)"):n==="time_of_day"?De(s,e):n==="day"?ur(s,e):n==="weather"?mr(s,e):n==="state"?Ve(s,e):String(s)}function ur(n,s={}){if(n===null)return o(s.hass,"day_summary.any","any");let e=n.include??[],t=n.exclude??[],r=e.length===0?o(s.hass,"day_summary.any_day","any day"):e.map(a=>Et(a,s)).join(", ");if(t.length===0)return r;let i=o(s.hass,"day_summary.except","except");return`${r} (${i} ${t.map(a=>Et(a,s)).join(", ")})`}function Et(n,s){switch(n.kind){case"weekday":return n.days.map(e=>we(s.hass,e)).join("/");case"day_of_month":return`${o(s.hass,"day_summary.day_prefix","day")} ${n.days}`;case"date":return`${se(s.hass,n.month)} ${n.day}`;case"date_range":return`${se(s.hass,n.from.month)} ${n.from.day} \u2192 ${se(s.hass,n.to.month)} ${n.to.day}`;case"last_day":return o(s.hass,"day_summary.last_day","last day");case"workday":return o(s.hass,"day_summary.workday","workday");case"holiday":return o(s.hass,"day_summary.holiday","holiday");case"first_workday":return o(s.hass,"day_summary.first_workday","first workday");case"last_workday":return o(s.hass,"day_summary.last_workday","last workday")}}var cr={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function pr(n){return n.split(/[\s_-]+/).filter(s=>s!=="").map(s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase()).join(" ")}function mr(n,s={}){if(n===null)return o(s.hass,"ui.summary_any","any");let e=new Map((s.weatherGroups??[]).map(a=>[a.id,a.label])),t=(n.groups??[]).map(a=>e.get(a)??pr(a)).join("/"),r=(n.thresholds??[]).map(a=>`${ce(s.hass,a.attribute)} ${cr[a.op]??a.op} ${a.value}`).join(", "),i=[t,r].filter(a=>a!=="");return i.length===0?o(s.hass,"ui.summary_any","any"):i.join(", ")}function Ve(n,s={}){return n==null?o(s.hass,"ui.summary_any","any"):Le(n,s)}function Le(n,s){if(n.kind==="is"||n.kind==="is_not"){let e=n.kind==="is"?x(s.hass,"is"):x(s.hass,"is_not"),t=n.states.join("/"),i=`${n.attribute?`${n.entity_id}.${n.attribute}`:n.entity_id} ${e} ${t}`;return n.for&&_r(n.for)?`${i} ${o(s.hass,"ui.for_prefix","for")} \u2265${gr(n.for)}`:i}if(n.kind==="and"||n.kind==="or"){let e=` ${x(s.hass,n.kind)} `;return n.items.map(t=>fr(t,s)).join(e)}return n.kind==="not"?`${x(s.hass,"not")} (${Le(n.item,s)})`:""}function fr(n,s){return n.kind==="and"||n.kind==="or"?`(${Le(n,s)})`:Le(n,s)}function _r(n){return n.h>0||n.m>0||n.s>0}function gr(n){let s=[];return n.h&&s.push(`${n.h}h`),n.m&&s.push(`${n.m}m`),n.s&&s.push(`${n.s}s`),s.length?s.join(" "):"0s"}function De(n,s){if(n===null)return o(s.hass,"ui.summary_any","any");let e=Array.isArray(n)?n:[n],t=s.periods?.custom??{};return e.map(r=>"period"in r?Y(s.hass,r.period,t):`${St(r.from,s)} \u2192 ${St(r.to,s)}`).join(", ")}function St(n,s){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;let e=re(s.hass,n.anchor);if(n.offset_min===0)return e;let t=Math.abs(n.offset_min),r=t%60===0?`${t/60}${o(s.hass,"ui.unit_hour_abbr","h")}`:`${t}${o(s.hass,"ui.unit_min_abbr","m")}`;return`${e}${n.offset_min<0?"-":"+"}${r}`}function Ct(n,s,e){let t=mt(e.hass,n.action),r=s?.domains?.[0]??o(e.hass,"ui.target_noun","target"),i=n.entity_ids.length,a;i===0?a=o(e.hass,"ui.no_targets","(no targets)"):i===1?a=`1 ${r}`:a=`${i} ${r}s`;let h={};for(let f of s?.target_params??[])f.unit&&(h[f.name]=f.unit);let u=Object.entries(n.params).filter(([,f])=>f!=null&&f!=="").map(([f,v])=>`${f} ${v}${h[f]??""}`).join(", ");return u?`${t}: ${a}, ${u}`:`${t}: ${a}`}var k=class extends m{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this._dragFrom=null;this._dragOver=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_summary(e){let t=new Map((this.matchers??[]).map(u=>[u.name,u.priority])),r=Object.keys(e.when).filter(u=>e.when[u]!=null&&(u==="scene"||!this.enabledMatchers||this.enabledMatchers.includes(u))).sort((u,f)=>(t.get(u)??1/0)-(t.get(f)??1/0)),i=r.length===0?o(this.hass,"ui.summary_any","any"):r.map(u=>`${te(this.hass,u)}: ${Te(u,e.when[u],{hass:this.hass,periods:this.periods,weatherGroups:this.weatherConfig?.groups})}`).join(", "),a=e.actions.length,h=a===1?o(this.hass,"ui.action_singular","action"):o(this.hass,"ui.action_plural","actions");return`${i} \xB7 ${a} ${h}`}_onDragStart(e){this._dragFrom=e}_onDragOver(e,t){this._dragFrom===null||t===this._dragFrom||(e.preventDefault(),this._dragOver=t)}_onDrop(e){let t=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(t===null||t===e)&&this._emit("reorder-rules",{from:t,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,t){let r=t.name||o(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(e+1));window.confirm(o(this.hass,"ui.confirm_delete",'Delete "{name}"?').replace("{name}",r))&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
        ...
        ${this.rules.map((e,t)=>l`
            ...
            >
              ...
              <div class="body">
                ...
                >
                  ${Ae(e,o(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(t+1)))}
                </div>
  ...
  `,d([c({attribute:!1})],j.prototype,"hass",2),d([c({attribute:!1})],j.prototype,"value",2),d([c({attribute:!1})],j.prototype,"dayConfig",2),j=d([g("ambience-day-predicate-input")],j);var At=["temperature","apparent_temperature","humidity","wind_speed","pressure"],Tt=["<","<=",">",">="],Dt={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},D=class extends m{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let t=e.groups.length===0&&e.thresholds.length===0;this.value=t?null:e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,t){let r=this._current();r.thresholds=r.thresholds.map((i,a)=>a===e?t:i),this._emit(r)}_removeThreshold(e){let t=this._current();t.thresholds=t.thresholds.filter((r,i)=>i!==e),this._emit(t)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:At.map(t=>({value:t,label:ce(this.hass,t)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:Tt.map(t=>({value:t,label:Dt[t]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,t){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Ke(this.hass,t,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
        .hass=${this.hass}
      ...
      ${Tt.map(r=>l`<option value=${r} ?selected=${r===t.op}>${Dt[r]}</option>`)}
      ...
      ></ha-form>`;let r=Ke(this.hass,t.attribute,this._entityState());return l`<span class="value-wrap">
  ...
  `,d([c({attribute:!1})],D.prototype,"hass",2),d([c({attribute:!1})],D.prototype,"value",2),d([c({attribute:!1})],D.prototype,"groups",2),d([c({attribute:!1})],D.prototype,"weatherEntity",2),D=d([g("ambience-weather-predicate-input")],D);var W=class extends m{constructor(){super(...arguments);this.value={kind:"is",entity_id:"",states:[]};this._knownStates=[]}async updated(e){if(e.has("value")){let r=e.get("value")?.entity_id,i=this.value.entity_id;if(i&&i!==r&&this.hass)try{let a=await xt(this.hass,i);this._knownStates=a.states}catch{this._knownStates=[]}}}_normalize(e){let t={...e};return t.attribute===""&&(t.attribute=null),t.for&&t.for.h===0&&t.for.m===0&&t.for.s===0&&(t.for=null),t}_emit(e){let t=this._normalize(e);this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t},bubbles:!0,composed:!0}))}_setEntity(e){this._emit({...this.value,entity_id:e,states:[],attribute:null})}_setAttribute(e){this._emit({...this.value,attribute:e})}_setOp(e){this._emit({...this.value,kind:e})}_setStates(e){this._emit({...this.value,states:e})}_setValueAt(e,t){let r=this.value.states.slice();t===""?r.splice(e,1):r[e]=t,this._setStates(r)}_addValue(e){e&&this._setStates([...this.value.states,e])}_removeValueAt(e){let t=this.value.states.slice();t.splice(e,1),this._setStates(t)}_setForDuration(e){this._emit({...this.value,for:e})}_entitySchema(){return[{name:"entity_id",required:!0,selector:{entity:{}}}]}_knownAttributesFor(e){if(!e)return[];let r=this.hass?.states?.[e]?.attributes;return r?Object.keys(r).sort():[]}_attributeSchema(){return[{name:"attribute",selector:{select:{mode:"dropdown",custom_value:!0,options:this._knownAttributesFor(this.value.entity_id).map(t=>({value:t,label:t}))}}}]}_opSchema(){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:[{value:"is",label:x(this.hass,"is")},{value:"is_not",label:x(this.hass,"is_not")}]}}}]}_valueSchema(){return[{name:"value",selector:{select:{mode:"dropdown",custom_value:!0,options:this._knownStates.map(e=>({value:e,label:e}))}}}]}_forSchema(){return[{name:"duration",selector:{duration:{enable_day:!1}}}]}_forData(){let e=this.value.for??{h:0,m:0,s:0};return{duration:{hours:e.h,minutes:e.m,seconds:e.s}}}_setForFromHaForm(e){this._setForDuration({h:e?.hours??0,m:e?.minutes??0,s:e?.seconds??0})}_renderEntity(){return customElements.get("ha-form")?l`<ha-form
        data-field="entity"
        .hass=${this.hass}
  ...
  `,d([c({attribute:!1})],W.prototype,"hass",2),d([c({attribute:!1})],W.prototype,"value",2),d([p()],W.prototype,"_knownStates",2),W=d([g("ambience-state-expr-atom")],W);function kr(n,s){return n===null||s===null||n.length!==s.length?!1:n.every((e,t)=>e===s[t])}var I=class extends m{constructor(){super(...arguments);this.path=[];this.openPath=null}_emit(e,t={}){this.dispatchEvent(new CustomEvent(e,{detail:{path:this.path,...t},bubbles:!0,composed:!0}))}_emitAt(e,t,r={}){this.dispatchEvent(new CustomEvent(t,{detail:{path:e,...r},bubbles:!0,composed:!0}))}_atomIsComplete(e){return!!e.entity_id&&e.states.length>0}_renderAtomCard(e){let t=this._atomIsComplete(e),r=!t||kr(this.path,this.openPath),i=t?Ve(e,{hass:this.hass}):o(this.hass,"ui.state_new_condition","(new condition)");return l`
      ...
      <div class="group">
        <div class="group-header">
          <select class="group-op"
            ...
            <option value="and"     ?selected=${r==="and"}    >${x(this.hass,"and")}</option>
            <option value="or"      ?selected=${r==="or"}     >${x(this.hass,"or")}</option>
            <option value="and_not" ?selected=${r==="and_not"}>${x(this.hass,"and_not")}</option>
            <option value="or_not"  ?selected=${r==="or_not"} >${x(this.hass,"or_not")}</option>
          </select>
        </div>
  ...
  `,d([c({attribute:!1})],E.prototype,"matcher",2),d([c({attribute:!1})],E.prototype,"value",2),d([c({attribute:!1})],E.prototype,"sceneSuggestions",2),d([c({attribute:!1})],E.prototype,"periods",2),d([c({attribute:!1})],E.prototype,"dayConfig",2),d([c({attribute:!1})],E.prototype,"weatherConfig",2),d([c({attribute:!1})],E.prototype,"hass",2),E=d([g("ambience-matcher-input")],E);var G=class extends m{constructor(){super(...arguments);this.entities=[];this.value=[]}connectedCallback(){super.connectedCallback(),F(this,this.hass)}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let e=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this.entities}}}];return l`
      <ha-form
        .hass=${this.hass}
        .schema=${e}
  ...
  `,d([c({attribute:!1})],w.prototype,"hass",2),d([p()],w.prototype,"_areas",2),d([p()],w.prototype,"_matchers",2),d([p()],w.prototype,"_actions",2),d([p()],w.prototype,"_periods",2),d([p()],w.prototype,"_dayConfig",2),d([p()],w.prototype,"_weatherConfig",2),d([p()],w.prototype,"_configs",2),d([p()],w.prototype,"_expanded",2),d([p()],w.prototype,"_error",2),d([p()],w.prototype,"_editing",2),d([p()],w.prototype,"_enabledMatchers",2),w=d([g("ambience-areas-list")],w);var L=class extends m{constructor(){super(...arguments);this.matcherName="";this.matcherDescription="";this.enabled=!1;this._expanded=!1}_toggleExpand(){this._expanded=!this._expanded}_onToggle(e){e.stopPropagation();let t=e.target.checked;this.dispatchEvent(new CustomEvent("enable-changed",{detail:{enabled:t},bubbles:!0,composed:!0}))}render(){let e=te(this.hass,this.matcherName);return l`
      <div class="card">
  ...
  `,d([c({attribute:!1})],S.prototype,"hass",2),d([c({attribute:!1})],S.prototype,"existingId",2),d([c({attribute:!1})],S.prototype,"initial",2),d([c({attribute:!1})],S.prototype,"takenIds",2),d([p()],S.prototype,"_label",2),d([p()],S.prototype,"_def",2),d([p()],S.prototype,"_error",2),S=d([g("ambience-period-edit-modal")],S);function It(n,s){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;let e=re(s,n.anchor);if(n.offset_min===0)return e;let t=Math.abs(n.offset_min),r=t%60===0?`${t/60}${o(s,"ui.unit_hour_abbr","h")}`:`${t}${o(s,"ui.unit_min_abbr","m")}`;return`${e}${n.offset_min<0?"-":"+"}${r}`}function Nt(n,s){return`${It(n.from,s)} \u2192 ${It(n.to,s)}`}var N=class extends m{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){this._view=await Se(this.hass)}async _saveState(e){let t=await bt(this.hass,e,this._view.hidden);this._warnings=t.warnings,await this._reload()}_onEdit(e,t){this._modal={mode:"edit",id:e,initial:t}}async _onDelete(e){let t={...this._view.custom};delete t[e],await this._saveState(t)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:t,definition:r}=e.detail,i={...this._view.custom,[t]:r};this._modal={mode:"closed"},await this._saveState(i)}_onModalCancel(){this._modal={mode:"closed"}}_renderBuiltinRow(e,t,r){return l`
      <div class="row ${r?"overridden":""}">
        <span class="name">${Y(this.hass,e,{})}</span>
        <span class="def">${Nt(t,this.hass)}</span>
  ...
  `,d([c({attribute:!1})],M.prototype,"hass",2),d([p()],M.prototype,"_matchers",2),d([p()],M.prototype,"_enabled",2),d([p()],M.prototype,"_error",2),M=d([g("ambience-configuration-view")],M);var Z=class extends m{constructor(){super(...arguments);this._view="areas"}connectedCallback(){super.connectedCallback(),F(this)}render(){return l`
      <header>
