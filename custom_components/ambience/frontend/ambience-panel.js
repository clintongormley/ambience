...
\f\r"'\`<>=]|("|')|))|$)`,"g"),at=/'/g,ot=/"/g,ht=/^(?:script|style|textarea|title)$/i,Ue=n=>(s,...e)=>({_$litType$:n,strings:s,values:e}),l=Ue(1),Ar=Ue(2),Ir=Ue(3),J=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),lt=new WeakMap,B=K.createTreeWalker(K,129);function ct(n,s){if(!We(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return st!==void 0?st.createHTML(s):s}var Yt=(n,s)=>{let e=n.length-1,t=[],r,i=s===2?"<svg>":s===3?"<math>":"",a=oe;for(let u=0;u<e;u++){let h=n[u],p,v,y=-1,D=0;for(;D<h.length&&(a.lastIndex=D,v=a.exec(h),v!==null);)D=a.lastIndex,a===oe?v[1]==="!--"?a=it:v[1]!==void 0?a=nt:v[2]!==void 0?(ht.test(v[2])&&(r=RegExp("</"+v[2],"g")),a=V):v[3]!==void 0&&(a=V):a===V?v[0]===">"?(a=r??oe,y=-1):v[1]===void 0?y=-2:(y=a.lastIndex-v[2].length,p=v[1],a=v[3]===void 0?V:v[3]==='"'?ot:at):a===ot||a===at?a=V:a===it||a===nt?a=oe:(a=V,r=void 0);let z=a===V&&n[u+1].startsWith("/>")?" ":"";i+=a===oe?h+Kt:y>=0?(t.push(p),h.slice(0,y)+dt+h.slice(y)+j+z):h+j+(y===-2?u:z)}return[ct(n,i+(n[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},ue=class n{constructor({strings:s,_$litType$:e},t){let r;this.parts=[];let i=0,a=0,u=s.length-1,h=this.parts,[p,v]=Yt(s,e);if(this.el=n.createElement(p,t),B.currentNode=this.el.content,e===2||e===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(r=B.nextNode())!==null&&h.length<u;){if(r.nodeType===1){if(r.hasAttributes())for(let y of r.getAttributeNames())if(y.endsWith(dt)){let D=v[a++],z=r.getAttribute(y).split(j),fe=/([.?@])?(.*)/.exec(D);h.push({type:1,index:i,name:fe[2],strings:z,ctor:fe[1]==="."?Me:fe[1]==="?"?Oe:fe[1]==="@"?Fe:ee}),r.removeAttribute(y)}else y.startsWith(j)&&(h.push({type:6,index:i}),r.removeAttribute(y));if(ht.test(r.tagName)){let y=r.textContent.split(j),D=y.length-1;if(D>0){r.textContent=be?be.emptyScript:"";for(let z=0;z<D;z++)r.append(y[z],le()),B.nextNode(),h.push({type:2,index:++i});r.append(y[D],le())}}}else if(r.nodeType===8)if(r.data===ut)h.push({type:2,index:i});else{let y=-1;for(;(y=r.data.indexOf(j,y+1))!==-1;)h.push({type:7,index:i}),y+=j.length-1}i++}}static createElement(s,e){let t=K.createElement("template");return t.innerHTML=s,t}};function Q(n,s,e=n,t){if(s===J)return s;let r=t!==void 0?e._$Co?.[t]:e._$Cl,i=de(s)?void 0:s._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),i===void 0?r=void 0:(r=new i(n),r._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=r:e._$Cl=r),r!==void 0&&(s=Q(n,r._$AS(n,s.values),r,t)),s}var Re=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,r=(s?.creationScope??K).importNode(e,!0);B.currentNode=r;let i=B.nextNode(),a=0,u=0,h=t[0];for(;h!==void 0;){if(a===h.index){let p;h.type===2?p=new he(i,i.nextSibling,this,s):h.type===1?p=new h.ctor(i,h.name,h.strings,this,s):h.type===6&&(p=new ze(i,this,s)),this._$AV.push(p),h=t[++u]}a!==h?.index&&(i=B.nextNode(),a++)}return B.currentNode=K,r}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},he=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=Q(this,s,e),de(s)?s===b||s==null||s===""?(this._$AH!==b&&this._$AR(),this._$AH=b):s!==this._$AH&&s!==J&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):Jt(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==b&&de(this._$AH)?this._$AA.nextSibling.data=s:this.T(K.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,r=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=ue.createElement(ct(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===r)this._$AH.p(e);else{let i=new Re(r,this),a=i.u(this.options);i.p(e),this.T(a),this._$AH=i}}_$AC(s){let e=lt.get(s.strings);return e===void 0&&lt.set(s.strings,e=new ue(s)),e}k(s){We(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,r=0;for(let i of s)r===e.length?e.push(t=new n(this.O(le()),this.O(le()),this,this.options)):t=e[r],t._$AI(i),r++;r<e.length&&(this._$AR(t&&t._$AB.nextSibling,r),e.length=r)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=rt(s).nextSibling;rt(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},ee=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,r,i){this.type=1,this._$AH=b,this._$AN=void 0,this.element=s,this.name=e,this._$AM=r,this.options=i,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=b}_$AI(s,e=this,t,r){let i=this.strings,a=!1;if(i===void 0)s=Q(this,s,e,0),a=!de(s)||s!==this._$AH&&s!==J,a&&(this._$AH=s);else{let u=s,h,p;for(s=i[0],h=0;h<i.length-1;h++)p=Q(this,u[t+h],e,h),p===J&&(p=this._$AH[h]),a||=!de(p)||p!==this._$AH[h],p===b?s=b:s!==b&&(s+=(p??"")+i[h+1]),this._$AH[h]=p}a&&!r&&this.j(s)}j(s){s===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},Me=class extends ee{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===b?void 0:s}},Oe=class extends ee{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==b)}},Fe=class extends ee{constructor(s,e,t,r,i){super(s,e,t,r,i),this.type=5}_$AI(s,e=this){if((s=Q(this,s,e,0)??b)===J)return;let t=this._$AH,r=s===b&&t!==b||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,i=s!==b&&(t===b||r);r&&this.element.removeEventListener(this.name,this,t),i&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},ze=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){Q(this,s)}};var Xt=je.litHtmlPolyfillSupport;Xt?.(ue,he),(je.litHtmlVersions??=[]).push("3.3.2");var mt=(n,s,e)=>{let t=e?.renderBefore??s,r=t._$litPart$;if(r===void 0){let i=e?.renderBefore??null;t._$litPart$=r=new he(s.insertBefore(le(),i),i,void 0,e??{})}return r._$AI(n),r};var Ge=globalThis,f=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=mt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return J}};f._$litElement$=!0,f.finalized=!0,Ge.litElementHydrateSupport?.({LitElement:f});var Zt=Ge.litElementPolyfillSupport;Zt?.({LitElement:f});(Ge.litElementVersions??=[]).push("4.2.2");var g=n=>(s,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(n,s)}):customElements.define(n,s)};var Qt={attribute:!0,type:String,converter:ae,reflect:!1,hasChanged:ye},er=(n=Qt,s,e)=>{let{kind:t,metadata:r}=e,i=globalThis.litPropertyMetadata.get(r);if(i===void 0&&globalThis.litPropertyMetadata.set(r,i=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),i.set(e.name,n),t==="accessor"){let{name:a}=e;return{set(u){let h=s.get.call(this);s.set.call(this,u),this.requestUpdate(a,h,n,!0,u)},init(u){return u!==void 0&&this.C(a,void 0,n,u),u}}}if(t==="setter"){let{name:a}=e;return function(u){let h=this[a];s.call(this,u),this.requestUpdate(a,h,n,!0,u)}}throw Error("Unsupported decorator location: "+t)};function c(n){return(s,e)=>typeof e=="object"?er(n,s,e):((t,r,i)=>{let a=r.hasOwnProperty(i);return r.constructor.createProperty(i,t),a?Object.getOwnPropertyDescriptor(r,i):void 0})(n,s,e)}function m(n){return c({...n,state:!0,attribute:!1})}function C(n,s,e){let t=n?.localize?.(s);return t&&t!==s?t:e}function qe(n){let s=n.replaceAll("_"," ").toLowerCase();return s.charAt(0).toUpperCase()+s.slice(1)}function te(n,s){return C(n,`component.ambience.matcher.${s}`,qe(s))}function pt(n,s){return C(n,`component.ambience.action.${s}`,qe(s))}function re(n,s){return C(n,`component.ambience.anchor.${s}`,qe(s))}function Y(n,s,e){let t=e[s]?.label;if(t)return t;let r=s.charAt(0).toUpperCase()+s.slice(1);return C(n,`component.ambience.time_of_day_period.${s}`,r)}function o(n,s,e){return C(n,`component.ambience.${s}`,e)}var tr=["mon","tue","wed","thu","fri","sat","sun"],rr=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];function we(n,s){return C(n,`component.ambience.weekday.${tr[s]}`,rr[s]??String(s))}var sr={weekday:"Day of week",day_of_month:"Day of month",date:"Date (annual)",date_range:"Date range (annual)",last_day:"Last day of month",workday:"Workday",holiday:"Holiday",first_workday:"First workday of month",last_workday:"Last workday of month"};function ke(n,s){return C(n,`component.ambience.day_item.${s}`,sr[s]??s)}var ir=["January","February","March","April","May","June","July","August","September","October","November","December"];function se(n,s){return C(n,`component.ambience.month.${s}`,ir[s-1]??String(s))}var nr={"clear-night":"Clear (night)",cloudy:"Cloudy",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning-rainy",partlycloudy:"Partly cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy-rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy (variant)",exceptional:"Exceptional"};function xe(n,s){return C(n,`component.ambience.weather_condition.${s}`,nr[s]??s)}var ar={temperature:"Temperature",apparent_temperature:"Apparent temperature",humidity:"Humidity",wind_speed:"Wind speed",pressure:"Pressure"};function ce(n,s){return C(n,`component.ambience.weather_attr.${s}`,ar[s]??s)}var or={temperature:"\xB0C",apparent_temperature:"\xB0C",humidity:"%",wind_speed:"m/s",pressure:"hPa"},lr={temperature:"temperature",apparent_temperature:"temperature",wind_speed:"wind_speed",pressure:"pressure"},dr={temperature:"temperature_unit",apparent_temperature:"temperature_unit",wind_speed:"wind_speed_unit",pressure:"pressure_unit"};function Ve(n,s,e){if(s==="humidity")return"%";let t=dr[s];if(t){let a=e?.attributes?.[t];if(typeof a=="string"&&a)return a}let r=lr[s],i=n?.config?.unit_system;return r&&i&&typeof i[r]=="string"?i[r]:or[s]??""}var ur={is:"is",is_not:"is not",">":">",">=":"\u2265","<":"<","<=":"\u2264",and:"AND",or:"OR",and_not:"AND NOT",or_not:"OR NOT",not:"NOT"};function T(n,s){return C(n,`component.ambience.state_op.${s}`,ur[s]??s)}var hr=["ha-input","ha-textfield","ha-form"],cr=["ha-input","ha-textfield"];function ft(){for(let n of cr)if(customElements.get(n))return n;return null}function W(n,s){for(let e of hr)customElements.get(e)||customElements.whenDefined(e).then(()=>n.requestUpdate())}async function _t(n){return n.callWS({type:"ambience/areas/list"})}async function gt(n,s){return n.callWS({type:"ambience/area/get",area_id:s})}async function vt(n,s,e){return n.callWS({type:"ambience/area/save",area_id:s,config:e})}async function Ee(n){return n.callWS({type:"ambience/matchers/list"})}async function yt(n){return n.callWS({type:"ambience/actions/list"})}async function Se(n){return n.callWS({type:"ambience/time_of_day_periods/list"})}async function bt(n,s,e){return n.callWS({type:"ambience/time_of_day_periods/save",custom:s,hidden:e})}async function Ce(n){return n.callWS({type:"ambience/matchers/enabled/list"})}async function $t(n,s){return n.callWS({type:"ambience/matchers/enabled/save",enabled:s})}async function Pe(n){return n.callWS({type:"ambience/matchers/day/config/list"})}async function wt(n,s,e){return n.callWS({type:"ambience/matchers/day/config/save",workday_sensor:s,workday_calendar:e})}async function Te(n){return n.callWS({type:"ambience/matchers/weather/config/list"})}async function kt(n,s,e){return n.callWS({type:"ambience/matchers/weather/config/save",entity:s,groups:e})}async function xt(n,s){return n.callWS({type:"ambience/state/known_states",entity_id:s})}function He(n,s="New rule"){if(n.name&&n.name.trim())return n.name;let e=n.when?.scene;return typeof e=="string"&&e.trim()?e:s}function Le(n,s,e){return s==null?o(e.hass,"ui.summary_any_paren","(any)"):n==="time_of_day"?Ne(s,e):n==="day"?mr(s,e):n==="weather"?_r(s,e):n==="state"?Ke(s,e):String(s)}function mr(n,s={}){if(n===null)return o(s.hass,"day_summary.any","any");let e=n.include??[],t=n.exclude??[],r=e.length===0?o(s.hass,"day_summary.any_day","any day"):e.map(a=>Et(a,s)).join(", ");if(t.length===0)return r;let i=o(s.hass,"day_summary.except","except");return`${r} (${i} ${t.map(a=>Et(a,s)).join(", ")})`}function Et(n,s){switch(n.kind){case"weekday":return n.days.map(e=>we(s.hass,e)).join("/");case"day_of_month":return`${o(s.hass,"day_summary.day_prefix","day")} ${n.days}`;case"date":return`${se(s.hass,n.month)} ${n.day}`;case"date_range":return`${se(s.hass,n.from.month)} ${n.from.day} \u2192 ${se(s.hass,n.to.month)} ${n.to.day}`;case"last_day":return o(s.hass,"day_summary.last_day","last day");case"workday":return o(s.hass,"day_summary.workday","workday");case"holiday":return o(s.hass,"day_summary.holiday","holiday");case"first_workday":return o(s.hass,"day_summary.first_workday","first workday");case"last_workday":return o(s.hass,"day_summary.last_workday","last workday")}}var pr={"<":"<","<=":"\u2264",">":">",">=":"\u2265"};function fr(n){return n.split(/[\s_-]+/).filter(s=>s!=="").map(s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase()).join(" ")}function _r(n,s={}){if(n===null)return o(s.hass,"ui.summary_any","any");let e=new Map((s.weatherGroups??[]).map(a=>[a.id,a.label])),t=(n.groups??[]).map(a=>e.get(a)??fr(a)).join("/"),r=(n.thresholds??[]).map(a=>`${ce(s.hass,a.attribute)} ${pr[a.op]??a.op} ${a.value}`).join(", "),i=[t,r].filter(a=>a!=="");return i.length===0?o(s.hass,"ui.summary_any","any"):i.join(", ")}function gr(n,s){let t=n.hass?.states?.[s]?.attributes?.friendly_name;return typeof t=="string"&&t?t:s}function Ke(n,s={}){return n==null?o(s.hass,"ui.summary_any","any"):Be(n,s)}function Be(n,s){if(n.kind==="is"||n.kind==="is_not"||n.kind===">"||n.kind===">="||n.kind==="<"||n.kind==="<="){let e=T(s.hass,n.kind),r=n.kind!=="is"&&n.kind!=="is_not"?n.states[0]??"":n.states.join("/"),i=gr(s,n.entity_id),u=`${n.attribute?`${i}.${n.attribute}`:i} ${e} ${r}`;return n.for&&vr(n.for)?`${u} ${o(s.hass,"ui.for_prefix","for")} \u2265${yr(n.for)}`:u}if(n.kind==="and"||n.kind==="or"){let e=` ${T(s.hass,n.kind)} `;return n.items.map(t=>St(t,s)).join(e)}return n.kind==="not"?`${T(s.hass,"not")} ${St(n.item,s)}`:""}function St(n,s){return n.kind==="and"||n.kind==="or"?`(${Be(n,s)})`:Be(n,s)}function vr(n){return n.h>0||n.m>0||n.s>0}function yr(n){let s=[];return n.h&&s.push(`${n.h}h`),n.m&&s.push(`${n.m}m`),n.s&&s.push(`${n.s}s`),s.length?s.join(" "):"0s"}function Ne(n,s){if(n===null)return o(s.hass,"ui.summary_any","any");let e=Array.isArray(n)?n:[n],t=s.periods?.custom??{};return e.map(r=>"period"in r?Y(s.hass,r.period,t):`${Ct(r.from,s)} \u2192 ${Ct(r.to,s)}`).join(", ")}function Ct(n,s){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;let e=re(s.hass,n.anchor);if(n.offset_min===0)return e;let t=Math.abs(n.offset_min),r=t%60===0?`${t/60}${o(s.hass,"ui.unit_hour_abbr","h")}`:`${t}${o(s.hass,"ui.unit_min_abbr","m")}`;return`${e}${n.offset_min<0?"-":"+"}${r}`}function Pt(n,s,e){let t=pt(e.hass,n.action),r=s?.domains?.[0]??o(e.hass,"ui.target_noun","target"),i=n.entity_ids.length,a;i===0?a=o(e.hass,"ui.no_targets","(no targets)"):i===1?a=`1 ${r}`:a=`${i} ${r}s`;let u={};for(let p of s?.target_params??[])p.unit&&(u[p.name]=p.unit);let h=Object.entries(n.params).filter(([,p])=>p!=null&&p!=="").map(([p,v])=>`${p} ${v}${u[p]??""}`).join(", ");return h?`${t}: ${a}, ${h}`:`${t}: ${a}`}var x=class extends f{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this._dragFrom=null;this._dragOver=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_summary(e){let t=new Map((this.matchers??[]).map(h=>[h.name,h.priority])),r=Object.keys(e.when).filter(h=>e.when[h]!=null&&(h==="scene"||!this.enabledMatchers||this.enabledMatchers.includes(h))).sort((h,p)=>(t.get(h)??1/0)-(t.get(p)??1/0)),i=r.length===0?o(this.hass,"ui.summary_any","any"):r.map(h=>`${te(this.hass,h)}: ${Le(h,e.when[h],{hass:this.hass,periods:this.periods,weatherGroups:this.weatherConfig?.groups})}`).join(", "),a=e.actions.length,u=a===1?o(this.hass,"ui.action_singular","action"):o(this.hass,"ui.action_plural","actions");return`${i} \xB7 ${a} ${u}`}_onDragStart(e){this._dragFrom=e}_onDragOver(e,t){this._dragFrom===null||t===this._dragFrom||(e.preventDefault(),this._dragOver=t)}_onDrop(e){let t=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(t===null||t===e)&&this._emit("reorder-rules",{from:t,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,t){let r=t.name||o(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(e+1));window.confirm(o(this.hass,"ui.confirm_delete",'Delete "{name}"?').replace("{name}",r))&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
        ...
        ${this.rules.map((e,t)=>l`
            ...
            >
              ...
              <div class="body">
                ...
                >
                  ${He(e,o(this.hass,"ui.rule_n","Rule {n}").replace("{n}",String(t+1)))}
                </div>
  ...
  `,d([c({attribute:!1})],U.prototype,"hass",2),d([c({attribute:!1})],U.prototype,"value",2),d([c({attribute:!1})],U.prototype,"dayConfig",2),U=d([g("ambience-day-predicate-input")],U);var Nt=["temperature","apparent_temperature","humidity","wind_speed","pressure"],Dt=["<","<=",">",">="],At={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},I=class extends f{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let t=e.groups.length===0&&e.thresholds.length===0;this.value=t?null:e,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,t){let r=this._current();r.thresholds=r.thresholds.map((i,a)=>a===e?t:i),this._emit(r)}_removeThreshold(e){let t=this._current();t.thresholds=t.thresholds.filter((r,i)=>i!==e),this._emit(t)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:Nt.map(t=>({value:t,label:ce(this.hass,t)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:Dt.map(t=>({value:t,label:At[t]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,t){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Ve(this.hass,t,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
      ...
      ${Nt.map(r=>l`<option value=${r} ?selected=${r===t.attribute}>${ce(this.hass,r)}</option>`)}
  ...
  `,w._STATE_SENTINEL="State",w._NUMERIC_OPS=[">",">=","<","<="],d([c({attribute:!1})],w.prototype,"hass",2),d([c({attribute:!1})],w.prototype,"value",2),d([m()],w.prototype,"_knownStates",2),w=d([g("ambience-state-expr-atom")],w);function It(n,s){return n===null||s===null||n.length!==s.length?!1:n.every((e,t)=>e===s[t])}var P=class extends f{constructor(){super(...arguments);this.path=[];this.openPath=null;this.errorPath=null;this.errorMessage=null}_emit(e,t={}){this.dispatchEvent(new CustomEvent(e,{detail:{path:this.path,...t},bubbles:!0,composed:!0}))}_emitAt(e,t,r={}){this.dispatchEvent(new CustomEvent(t,{detail:{path:e,...r},bubbles:!0,composed:!0}))}_atomIsComplete(e){return!!e.entity_id&&e.states.some(t=>t!=="")}_isErrorTarget(){return It(this.path,this.errorPath)}_renderAtomCard(e){let t=this._atomIsComplete(e),r=It(this.path,this.openPath),i=t?Ke(e,{hass:this.hass}):o(this.hass,"ui.state_new_condition","(new condition)");return l`
  ...
  `,d([c({attribute:!1})],G.prototype,"hass",2),d([c({attribute:!1})],G.prototype,"entities",2),d([c({attribute:!1})],G.prototype,"value",2),G=d([g("ambience-target-picker")],G);var $=class extends f{constructor(){super(...arguments);this.open=!1;this.rule=null;this.matchers=[];this.sceneSuggestions=[];this.availableActions=[];this._draft=null;this._open=null;this._showError=!1;this._onNameInput=e=>{this._setName(e.target.value)}}connectedCallback(){super.connectedCallback(),W(this,this.hass)}willUpdate(e){e.has("open")&&this.open&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._open=null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_renderNameSlot(){let e=this._draft.name??"";if(this._isOpen({kind:"name"}))return l`
      ...
      `;let r=He(this._draft,o(this.hass,"ui.new_rule","New rule"));return l`
    ...
    `}_renderNameInputControl(e){let t=ft();return t==="ha-input"?l`<ha-input label=${o(this.hass,"ui.name_optional","Name (optional)")} .value=${e} @input=${this._onNameInput}></ha-input>`:t==="ha-textfield"?l`<ha-textfield label=${o(this.hass,"ui.name_optional","Name (optional)")} .value=${e} @input=${this._onNameInput}></ha-textfield>`:l`<input type="text" .value=${e} @input=${this._onNameInput} />`}_isOpen(e){return this._open===null?!1:e.kind==="name"&&this._open.kind==="name"?!0:e.kind==="matcher"&&this._open.kind==="matcher"?e.id===this._open.id:e.kind==="action"&&this._open.kind==="action"?e.idx===this._open.idx:!1}_validationError(e){if(e===null||e.kind==="name"||e.kind==="matcher")return null;let t=this._draft?.actions[e.idx];if(!t)return null;if(t.entity_ids.length===0)return o(this.hass,"ui.at_least_one_target","At least one target is required.");let r=this.availableActions.find(i=>i.name===t.action);if(!r)return null;for(let i of r.target_params){if(!i.required)continue;let a=t.params[i.name];if(a==null||a==="")return o(this.hass,"ui.param_required","{param} is required.").replace("{param}",this._paramLabel(i.name))}return null}_tryCloseCurrent(){return this._open===null?!0:this._validationError(this._open)!==null?(this._showError=!0,!1):(this._open=null,this._showError=!1,!0)}_toggleSlot(e){if(this._isOpen(e)){this._tryCloseCurrent();return}this._open!==null&&!this._tryCloseCurrent()||(this._open=e,this._showError=!1)}_onModalClick(e){for(let t of e.composedPath())if(t instanceof Element&&(t.classList.contains("slot")||t.classList.contains("actions-bar")))return;this._tryCloseCurrent()}_setPredicate(e,t){if(!this._draft)return;let r={...this._draft.when};t==null?delete r[e]:r[e]=t,this._draft={...this._draft,when:r}}_renderMatcherRow(e){let t=this._draft.when[e.name]??null,r=this._isOpen({kind:"matcher",id:e.name}),i=e.input==="scene_combobox";if(r&&i)return l`
      ...
      `;let a=Le(e.name,t,{hass:this.hass,periods:this.periods});return l`
    ...
    `}_addActionSlot(){if(!this._draft)return;let e={action:"set_light",entity_ids:[],params:{}},t=this._draft.actions.length;this._draft={...this._draft,actions:[...this._draft.actions,e]},this._open={kind:"action",idx:t}}_updateActionAt(e,t){if(!this._draft)return;let r=this._draft.actions.map((i,a)=>a===e?t(i):i);this._draft={...this._draft,actions:r}}_deleteAction(e){this._draft&&(this._draft={...this._draft,actions:this._draft.actions.filter((t,r)=>r!==e)},this._open?.kind==="action"&&this._open.idx===e&&(this._open=null))}_setActionTargets(e,t){this._updateActionAt(e,r=>({...r,entity_ids:t}))}_paramLabel(e){let t=e.replaceAll("_"," ").toLowerCase();return t.charAt(0).toUpperCase()+t.slice(1)}_updateActionParam(e,t,r){this._updateActionAt(e,i=>{let a={...i.params},u=r;if(t.type==="int"?u=r===""?void 0:parseInt(r,10):t.type==="number"?u=r===""?void 0:parseFloat(r):t.type==="boolean"&&(u=r==="true"),typeof u=="number"&&Number.isFinite(u)){let h=u;typeof t.min=="number"&&h<t.min&&(h=t.min),typeof t.max=="number"&&h>t.max&&(h=t.max),u=h}return u===void 0?delete a[t.name]:a[t.name]=u,{...i,params:a}})}_renderActionParams(e,t,r){let i=r?.target_params??[];return l`
      ...
      `)}
    `}_renderActionRow(e,t){let r=this.availableActions.find(h=>h.name===e.action),i=this._isOpen({kind:"action",idx:t}),a=Pt(e,r,{hass:this.hass}),u=Tt(this.hass,this.areaId,r?.domains??[]);return l`
  ...
  `,d([c({attribute:!1})],S.prototype,"hass",2),d([c({attribute:!1})],S.prototype,"existingId",2),d([c({attribute:!1})],S.prototype,"initial",2),d([c({attribute:!1})],S.prototype,"takenIds",2),d([m()],S.prototype,"_label",2),d([m()],S.prototype,"_def",2),d([m()],S.prototype,"_error",2),S=d([g("ambience-period-edit-modal")],S);function Rt(n,s){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;let e=re(s,n.anchor);if(n.offset_min===0)return e;let t=Math.abs(n.offset_min),r=t%60===0?`${t/60}${o(s,"ui.unit_hour_abbr","h")}`:`${t}${o(s,"ui.unit_min_abbr","m")}`;return`${e}${n.offset_min<0?"-":"+"}${r}`}function Mt(n,s){return`${Rt(n.from,s)} \u2192 ${Rt(n.to,s)}`}var M=class extends f{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){this._view=await Se(this.hass)}async _saveState(e){let t=await bt(this.hass,e,this._view.hidden);this._warnings=t.warnings,await this._reload()}_onEdit(e,t){this._modal={mode:"edit",id:e,initial:t}}async _onDelete(e){let t={...this._view.custom};delete t[e],await this._saveState(t)}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:t,definition:r}=e.detail,i={...this._view.custom,[t]:r};this._modal={mode:"closed"},await this._saveState(i)}_onModalCancel(){this._modal={mode:"closed"}}_renderBuiltinRow(e,t,r){return l`
      <div class="row ${r?"overridden":""}">
        <span class="name">${Y(this.hass,e,{})}</span>
        <span class="def">${Mt(t,this.hass)}</span>
