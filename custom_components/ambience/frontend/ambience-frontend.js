...
`;function bt(t,r){return l`<span class="category-swatch" style=${zi(t)}>
    ...
    @click=${s}
    @change=${i}
  />`}function Yt(t){let{priority:r,pinned:e,shadowed_by:i,...n}=t;return n}function bo(t,r){if(r<0||r>=t.length)return[];let e=new Set(t[r].entity_ids??[]),i=new Set;return t.forEach((n,s)=>{if(s!==r)for(let o of n.entity_ids??[])e.has(o)||i.add(o)}),[...i]}var Jr={house:"mdi:home",floor:"mdi:layers",area:"mdi:texture-box"};function Qt(t,r){return t.kind==="house"?Jr.house:t.kind==="floor"?r?.floors?.[t.id]?.icon||Jr.floor:r?.areas?.[t.id]?.icon||Jr.area}var wo=y`
  .banner {
    display: flex;
...
`;var ge=class extends b{constructor(){super(...arguments);this.value=null;this._mode="form";this._yamlText="";this._yamlError=null;this._computeFieldLabel=e=>rn(this.hass,this._picked??"",e.name);this._computeFieldHelper=e=>{let n=this._currentFields()?.[e.name]?.description;return typeof n=="string"?n:""}}willUpdate(e){super.willUpdate?.(e),e.has("value")&&this._mode==="form"&&(this._yamlText=fr(this.value??{}))}connectedCallback(){super.connectedCallback(),this._yamlText=fr(this.value??{})}_setMode(e){e==="form"&&this._yamlError!==null||(e==="yaml"&&(this._yamlText=fr(this.value??{})),this._mode=e)}_onYamlInput(e){this._yamlText=e;let i;try{i=mr(e)}catch(u){this._yamlError=u.message;return}if(i==null){this._yamlError=null,this._emit(null);return}if(typeof i!="object"||Array.isArray(i)){this._yamlError=a(this.hass,"ui.yaml_expect_object","Expected an object");return}let n=i,s=n.script;if(typeof s!="string"||!s.startsWith("script.")){this._yamlError=a(this.hass,"ui.yaml_script_string","`script` must be a 'script.<name>' string");return}let o=n.args;if(o!==void 0&&(typeof o!="object"||Array.isArray(o)||o===null)){this._yamlError=a(this.hass,"ui.yaml_args_object","`args` must be an object if present");return}let d=n.triggers;if(d!==void 0&&(!Array.isArray(d)||!d.every(u=>typeof u=="string"))){this._yamlError=a(this.hass,"ui.yaml_triggers_list","`triggers` must be a list of entity_id strings if present");return}this._yamlError=null,this._emit({script:s,args:o??{},triggers:d})}_emit(e){this.value=e,A(this,this.value)}_scriptIds(){let e=this.hass?.services;return Object.keys(e?.script??{}).sort().map(n=>`script.${n}`)}_label(e){return Ue(this.hass,e)}_fieldsFor(e){if(!e)return;let i=e.replace(/^script\./,"");return this.hass?.services?.script?.[i]?.fields}get _picked(){return this.value&&typeof this.value=="object"?this.value.script:null}_currentFields(){return this._fieldsFor(this._picked)}_defaultArgs(e){let i=this._fieldsFor(e)??{},n={};for(let[s,o]of Object.entries(i))o&&Object.hasOwn(o,"default")&&(n[s]=o.default);return n}_pickerSchema(){return[{name:"script",selector:{select:{mode:"dropdown",options:this._scriptIds().map(e=>({value:e,label:this._label(e)}))}}}]}_pickScript(e){if(!e){this._emit(null);return}this._emit({script:e,args:this._defaultArgs(e)})}_argsSchema(){let e=this._currentFields();return e?Object.entries(e).map(([i,n])=>({name:i,required:n.required,selector:n.selector??{text:{}}})):[]}_updateArgs(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:e,triggers:this.value.triggers})}get _triggers(){return this.value&&typeof this.value=="object"&&this.value.triggers||[]}_setTriggers(e){!this.value||typeof this.value!="object"||this._emit({script:this.value.script,args:this.value.args,triggers:e})}_removeTrigger(e){this._setTriggers(this._triggers.filter(i=>i!==e))}_addTrigger(e){this._triggers.includes(e)||this._setTriggers([...this._triggers,e])}render(){let e=this._picked,i=this._argsSchema(),n=(this.value&&typeof this.value=="object"?this.value.args:{})??{},s=i.length>0;return l`
  ...
  `,c([m({attribute:!1})],We.prototype,"hass",2),c([m({attribute:!1})],We.prototype,"value",2),c([m({attribute:!1})],We.prototype,"dayConfig",2),We=c([w("ambience-day-predicate-input")],We);var La=["temperature","apparent_temperature","humidity","wind_speed","pressure"],Ta=["<","<=",">",">="],Pa={"<":"<","<=":"\u2264",">":">",">=":"\u2265"},Te=class extends b{constructor(){super(...arguments);this.value=null;this.groups=[]}_current(){return this.value===null?{groups:[],thresholds:[]}:{groups:[...this.value.groups],thresholds:[...this.value.thresholds]}}_emit(e){let i=e.groups.length===0&&e.thresholds.length===0;this.value=i?null:e,A(this,this.value)}_setGroups(e){this._emit({...this._current(),groups:e})}_addThreshold(){let e=this._current();e.thresholds=[...e.thresholds,{attribute:"temperature",op:"<",value:0}],this._emit(e)}_updateThreshold(e,i){let n=this._current();n.thresholds=n.thresholds.map((s,o)=>o===e?i:s),this._emit(n)}_removeThreshold(e){let i=this._current();i.thresholds=i.thresholds.filter((n,s)=>s!==e),this._emit(i)}_attributeSchema(e){return[{name:"attribute",required:!0,selector:{select:{mode:"dropdown",options:La.map(i=>({value:i,label:Ut(this.hass,i)}))}}}]}_opSchema(e){return[{name:"op",required:!0,selector:{select:{mode:"dropdown",options:Ta.map(i=>({value:i,label:Pa[i]}))}}}]}_entityState(){let e=this.weatherEntity;return e?this.hass?.states?.[e]:void 0}_valueSchema(e,i){return[{name:"value",required:!0,selector:{number:{mode:"box",unit_of_measurement:Fr(this.hass,i,this._entityState())}}}]}_groupsSchema(){return[{name:"groups",selector:{select:{multiple:!0,mode:"list",options:this.groups.map(e=>({value:e.id,label:e.label}))}}}]}_renderGroups(e){return customElements.get("ha-form")?l`<ha-form
      ...
      ${La.map(n=>l`<option value=${n} ?selected=${n===i.attribute}>${Ut(this.hass,n)}</option>`)}
      ...
      ${Ta.map(n=>l`<option value=${n} ?selected=${n===i.op}>${Pa[n]}</option>`)}
  ...
  `,c([m({attribute:!1})],ut.prototype,"hass",2),c([m({attribute:!1})],ut.prototype,"value",2),ut=c([w("ambience-occupancy-predicate-input")],ut);function Ia(t,r){if(t==null)return null;let e=t.entities;return!Array.isArray(e)||e.length===0?a(r,"ui.unavailable_select_one","Select at least one entity"):null}var Nu=[{name:"sensors",selector:{entity:{multiple:!0}}}],ht=class extends b{constructor(){super(...arguments);this.value=null}_entities(){return this.value?.entities??[]}_setEntities(e){let i=e.length?{entities:e}:null;this.value=i,A(this,i)}render(){return l`
      <div class="row">
        ${Ht(this.hass,Nu,this._entities(),"binary_sensor.a, light.b",e=>this._setEntities(e))}
      </div>
    `}};ht.styles=y`
    :host {
      display: block;
...
`;function Ma(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function Rn(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Ma(n,r))};return l`<span
    class="entity-link"
    role="button"
    tabindex="0"
  ...
  `,c([m({attribute:!1})],Pe.prototype,"hass",2),c([m()],Pe.prototype,"conditionName",2),c([m()],Pe.prototype,"conditionDescription",2),c([_()],Pe.prototype,"_expanded",2),Pe=c([w("ambience-condition-card")],Pe);var oh=/^[a-z][a-z0-9_]*$/;function ah(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var fi=y`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,ue=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=fi}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!oh.test(e)?a(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?a(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":a(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??ah(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return l`
  ...
  `],I._OVERLAY_TAG_RE=/vaadin|combo-box|overlay|listbox|menu|mwc-|md-/i,c([m({attribute:!1})],I.prototype,"hass",2),c([_()],I.prototype,"_actions",2),c([_()],I.prototype,"_services",2),c([_()],I.prototype,"_schemas",2),c([_()],I.prototype,"_fieldSchemas",2),c([_()],I.prototype,"_addSchema",2),c([_()],I.prototype,"_expanded",2),c([_()],I.prototype,"_adding",2),c([_()],I.prototype,"_loadError",2),c([_()],I.prototype,"_saveError",2),c([_()],I.prototype,"_loaded",2),c([_()],I.prototype,"_fadoNoticeDismissed",2),c([_()],I.prototype,"_editingDefault",2),c([_()],I.prototype,"_editingOriginalValue",2),c([_()],I.prototype,"_editingOriginalHad",2),I=c([w("ambience-actions-settings")],I);var B=class extends Error{constructor(r){super(r),this.name="ImportError"}};function Ar(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function hh(t){if(!Ar(t))throw new B("`scope` must be an object with a `kind`.");let r=t.kind;if(r==="house")return{kind:"house"};if(r==="area"||r==="floor"){if(typeof t.id!="string"||t.id==="")throw new B(`A ${r} scope needs a non-empty \`id\`.`);return{kind:r,id:t.id}}throw new B("`scope.kind` must be one of: area, floor, house.")}function ph(t){if(!Array.isArray(t))throw new B("`scenes` must be a list.");return t.map((r,e)=>{if(!Ar(r))throw new B(`Scene ${e+1} must be an object.`);if(typeof r.category!="string"||r.category==="")throw new B(`Scene ${e+1} is missing a \`category\`.`);return r})}function mh(t){if(t!==void 0){if(!Ar(t)||typeof t.id!="string"||t.id==="")throw new B("`category` must be an object with a non-empty `id`.");return t}}function Ja(t){let r;try{r=mr(t)}catch(n){throw new B(`Could not parse YAML/JSON: ${n.message}`)}if(!Ar(r))throw new B("Import must be a YAML/JSON object (an `ambience_import` block).");let e=Number(r.ambience_import);if(r.ambience_import===void 0||!Number.isFinite(e)||e<1)throw new B("Missing or invalid `ambience_import` marker \u2014 is this an Ambience import block?");if(e>1)throw new B(`This is import format v${e}, but this Ambience only understands v1 \u2014 update Ambience.`);let i=r.mode??"merge";if(i!=="merge"&&i!=="replace")throw new B("`mode` must be `merge` or `replace`.");return{ambience_import:e,scope:hh(r.scope),category:mh(r.category),mode:i,scenes:ph(r.scenes)}}function Hn(t){return`${t.category}\0${(t.name??"").trim().toLowerCase()}`}function Sr(t){return t.name??"(unnamed)"}function Xa(t,r,e){let i=new Set(e.map(v=>v.id)),n=t.category?.id,s=t.category&&!i.has(t.category.id)?t.category:null,o=new Set(i);n&&o.add(n);let d=[...new Set(t.scenes.map(v=>v.category).filter(v=>!o.has(v)))],u=r.scenes??[],h=[],p=[],f=[],g;if(t.mode==="replace"){let v=new Set(t.scenes.map(x=>x.category));for(let x of u)v.has(x.category)&&f.push(Sr(x));g=u.filter(x=>!v.has(x.category));for(let x of t.scenes)h.push(Sr(x)),g.push(x)}else{g=u.map(x=>({...x}));let v=new Map(g.map((x,C)=>[Hn(x),C]));for(let x of t.scenes){let P=(x.name??"").trim()!==""?v.get(Hn(x)):void 0;P!==void 0?(g[P]=x,p.push(Sr(x))):(v.set(Hn(x),g.length),g.push(x),h.push(Sr(x)))}}return{scope:t.scope,mode:t.mode,newCategory:s,unknownCategories:d,adds:h,updates:p,removes:f,resultConfig:{...r,scenes:g}}}var fh=Ct("reference/ai/mcp-server"),_h=Ct("reference/ai/download-and-paste"),gh=`${Xr}/issues/new`,ae=class extends b{constructor(){super(...arguments);this.text="";this.error=null;this.preview=null;this.categories=[];this.busy=!1;this.done=null}async _download(){try{await no(this.hass)}catch(e){this.error=E(this.hass,e)}}async _onFile(e){let i=e.target,n=i.files?.[0];if(i.value="",!!n){this.error=null,this.done=null,this.preview=null;try{this.text=await n.text()}catch(s){this.error=E(this.hass,s);return}await this._doPreview()}}async _doPreview(){this.done=null;try{let e=Ja(this.text),[i,n]=await Promise.all([oo(this.hass,e.scope),Ce(this.hass)]);this.categories=n,this.preview=Xa(e,i,n),this.error=null}catch(e){this.preview=null,this.error=e instanceof B?e.message:E(this.hass,e)}}async _confirm(){let e=this.preview;if(!(!e||e.unknownCategories.length>0||this.busy)){this.busy=!0;try{await so(this.hass,e.resultConfig),e.newCategory&&await Fi(this.hass,[...this.categories,e.newCategory]),await ao(this.hass,e.scope,e.resultConfig,{action:"import",scene_name:null},{minimisePins:!0}),window.dispatchEvent(new CustomEvent("ambience-config-imported")),e.newCategory&&window.dispatchEvent(new CustomEvent("ambience-categories-changed")),this.done=a(this.hass,"ui.import_done","Imported successfully."),this.preview=null,this.text=""}catch(i){this.error=E(this.hass,i)}finally{this.busy=!1}}}_list(e,i){return i.length===0?$:l`<div>${e}<ul>${i.map(n=>l`<li>${n}</li>`)}</ul></div>`}_renderPreview(e){let i=e.scope.kind==="house"?e.scope.kind:`${e.scope.kind} ${e.scope.id}`;return l`
    ...
    `}render(){return l`
      ...
      <div class="mcp">
        <div class="mcp-title">${a(this.hass,"ui.import_mcp_title","Author live with the MCP server")}</div>
        <div class="mcp-body">
          ${a(this.hass,"ui.import_mcp_desc","Install the MCP server for the fastest authoring and editing experience with Claude Code or Claude Desktop.")}
          <a class="help-link" href=${fh} target="_blank" rel="noopener noreferrer"
            >${a(this.hass,"ui.import_mcp_link","Set up the MCP server")}</a
          >
        </div>
      </div>
      <div class="paste-heading">${a(this.hass,"ui.import_paste_title","Alternatively, download and paste into any AI")}</div>
      <ol class="steps">
        <li>
          ...
          <div class="step-body">
            ...
            <a class="help-link" href=${_h} target="_blank" rel="noopener noreferrer"
      ...
      <div class="feedback">
        ...
        <div class="fb-body">
          ...
          <a class="fb-link" href=${gh} target="_blank" rel="noopener noreferrer"
  ...
  `,c([m({attribute:!1})],Re.prototype,"hass",2),c([m({attribute:!1})],Re.prototype,"initialTab",2),c([_()],Re.prototype,"_tab",2),c([_()],Re.prototype,"_aiEnabled",2),Re=c([w("ambience-settings-view")],Re);var Xe=class extends b{constructor(){super();this.open=!1;new Ge(this,()=>this._close())}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return this.open?l`
      <div
        class="modal"
        role="dialog"
        aria-modal="true"
  ...
  `,c([m({attribute:!1})],Xe.prototype,"hass",2),c([m({type:Boolean,reflect:!0})],Xe.prototype,"open",2),c([m({attribute:!1})],Xe.prototype,"initialTab",2),Xe=c([w("ambience-settings-modal")],Xe);function vh(t){let r=t.indexOf("?");return r===-1?"":new URLSearchParams(t.slice(r+1)).get("fe")??""}var Za={runningFrontendHash(){return vh(import.meta.url)}};var yh={reload(){location.reload()}},_i=class extends b{constructor(){super(...arguments);this._serverVersion=null;this._checked=!1}static{this.styles=y`
    :host {
      display: block;
    }
    .message {
