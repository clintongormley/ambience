...
`)}
  ...
  `,c([m({attribute:!1})],U.prototype,"hass",2),c([m({attribute:!1})],U.prototype,"scope",2),c([m({attribute:!1})],U.prototype,"exposed",2),c([m({attribute:!1})],U.prototype,"service",2),c([m({attribute:!1})],U.prototype,"entityIds",2),c([m({attribute:!1})],U.prototype,"params",2),c([m({attribute:!1})],U.prototype,"excludeEntities",2),c([g()],U.prototype,"_schema",2),c([g()],U.prototype,"_schemaError",2),c([g()],U.prototype,"_exposedMissing",2),c([g()],U.prototype,"_formSchema",2),c([g()],U.prototype,"_perFieldSchemas",2),U=c([w("ambience-action-slot")],U);var xe=class extends b{constructor(){super(...arguments);this.text="";this.multiline=!1;this._open=!1;this._onDocClick=e=>{e.composedPath().includes(this)||this._close()};this._onKeydown=e=>{e.key==="Escape"&&this._close()}}_toggle(e){e.stopPropagation(),this._open?this._close():this._openPopover()}_openPopover(){this._open=!0,document.addEventListener("click",this._onDocClick,!0),document.addEventListener("keydown",this._onKeydown)}_close(){this._open&&(this._open=!1,document.removeEventListener("click",this._onDocClick,!0),document.removeEventListener("keydown",this._onKeydown),this.renderRoot.querySelector(".trigger")?.focus())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick,!0),document.removeEventListener("keydown",this._onKeydown)}render(){return d`
      <button
        class="trigger"
