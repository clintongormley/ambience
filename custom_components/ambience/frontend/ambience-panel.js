...
var it=Object.defineProperty;var st=Object.getOwnPropertyDescriptor;var a=(n,r,e,t)=>{for(var i=t>1?void 0:t?st(r,e):r,s=n.length-1,o;s>=0;s--)(o=n[s])&&(i=(t?o(r,e,i):o(i))||i);return t&&i&&it(r,e,i),i};var ee=globalThis,te=ee.ShadowRoot&&(ee.ShadyCSS===void 0||ee.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,pe=Symbol(),Ce=new WeakMap,W=class{constructor(r,e,t){if(this._$cssResult$=!0,t!==pe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=r,this.t=e}get styleSheet(){let r=this.o,e=this.t;if(te&&r===void 0){let t=e!==void 0&&e.length===1;t&&(r=Ce.get(e)),r===void 0&&((this.o=r=new CSSStyleSheet).replaceSync(this.cssText),t&&Ce.set(e,r))}return r}toString(){return this.cssText}},Se=n=>new W(typeof n=="string"?n:n+"",void 0,pe),f=(n,...r)=>{let e=n.length===1?n[0]:r.reduce((t,i,s)=>t+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[s+1],n[0]);return new W(e,n,pe)},Ae=(n,r)=>{if(te)n.adoptedStyleSheets=r.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of r){let t=document.createElement("style"),i=ee.litNonce;i!==void 0&&t.setAttribute("nonce",i),t.textContent=e.cssText,n.appendChild(t)}},me=te?n=>n:n=>n instanceof CSSStyleSheet?(r=>{let e="";for(let t of r.cssRules)e+=t.cssText;return Se(e)})(n):n;var{is:nt,defineProperty:ot,getOwnPropertyDescriptor:at,getOwnPropertyNames:lt,getOwnPropertySymbols:dt,getPrototypeOf:ct}=Object,re=globalThis,Pe=re.trustedTypes,ht=Pe?Pe.emptyScript:"",ut=re.reactiveElementPolyfillSupport,B=(n,r)=>n,V={toAttribute(n,r){switch(r){case Boolean:n=n?ht:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,r){let e=n;switch(r){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},ie=(n,r)=>!nt(n,r),He={attribute:!0,type:String,converter:V,reflect:!1,useDefault:!1,hasChanged:ie};Symbol.metadata??=Symbol("metadata"),re.litPropertyMetadata??=new WeakMap;var A=class extends HTMLElement{static addInitializer(r){this._$Ei(),(this.l??=[]).push(r)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(r,e=He){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(r)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(r,e),!e.noAccessor){let t=Symbol(),i=this.getPropertyDescriptor(r,t,e);i!==void 0&&ot(this.prototype,r,i)}}static getPropertyDescriptor(r,e,t){let{get:i,set:s}=at(this.prototype,r)??{get(){return this[e]},set(o){this[e]=o}};return{get:i,set(o){let d=i?.call(this);s?.call(this,o),this.requestUpdate(r,d,t)},configurable:!0,enumerable:!0}}static getPropertyOptions(r){return this.elementProperties.get(r)??He}static _$Ei(){if(this.hasOwnProperty(B("elementProperties")))return;let r=ct(this);r.finalize(),r.l!==void 0&&(this.l=[...r.l]),this.elementProperties=new Map(r.elementProperties)}static finalize(){if(this.hasOwnProperty(B("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(B("properties"))){let e=this.properties,t=[...lt(e),...dt(e)];for(let i of t)this.createProperty(i,e[i])}let r=this[Symbol.metadata];if(r!==null){let e=litPropertyMetadata.get(r);if(e!==void 0)for(let[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let i=this._$Eu(e,t);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(r){let e=[];if(Array.isArray(r)){let t=new Set(r.flat(1/0).reverse());for(let i of t)e.unshift(me(i))}else r!==void 0&&e.push(me(r));return e}static _$Eu(r,e){let t=e.attribute;return t===!1?void 0:typeof t=="string"?t:typeof r=="string"?r.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(r=>r(this))}addController(r){(this._$EO??=new Set).add(r),this.renderRoot!==void 0&&this.isConnected&&r.hostConnected?.()}removeController(r){this._$EO?.delete(r)}_$E_(){let r=new Map,e=this.constructor.elementProperties;for(let t of e.keys())this.hasOwnProperty(t)&&(r.set(t,this[t]),delete this[t]);r.size>0&&(this._$Ep=r)}createRenderRoot(){let r=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ae(r,this.constructor.elementStyles),r}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(r=>r.hostConnected?.())}enableUpdating(r){}disconnectedCallback(){this._$EO?.forEach(r=>r.hostDisconnected?.())}attributeChangedCallback(r,e,t){this._$AK(r,t)}_$ET(r,e){let t=this.constructor.elementProperties.get(r),i=this.constructor._$Eu(r,t);if(i!==void 0&&t.reflect===!0){let s=(t.converter?.toAttribute!==void 0?t.converter:V).toAttribute(e,t.type);this._$Em=r,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null}}_$AK(r,e){let t=this.constructor,i=t._$Eh.get(r);if(i!==void 0&&this._$Em!==i){let s=t.getPropertyOptions(i),o=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:V;this._$Em=i;let d=o.fromAttribute(e,s.type);this[i]=d??this._$Ej?.get(i)??d,this._$Em=null}}requestUpdate(r,e,t,i=!1,s){if(r!==void 0){let o=this.constructor;if(i===!1&&(s=this[r]),t??=o.getPropertyOptions(r),!((t.hasChanged??ie)(s,e)||t.useDefault&&t.reflect&&s===this._$Ej?.get(r)&&!this.hasAttribute(o._$Eu(r,t))))return;this.C(r,e,t)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(r,e,{useDefault:t,reflect:i,wrapped:s},o){t&&!(this._$Ej??=new Map).has(r)&&(this._$Ej.set(r,o??e??this[r]),s!==!0||o!==void 0)||(this._$AL.has(r)||(this.hasUpdated||t||(e=void 0),this._$AL.set(r,e)),i===!0&&this._$Em!==r&&(this._$Eq??=new Set).add(r))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let r=this.scheduleUpdate();return r!=null&&await r,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[i,s]of t){let{wrapped:o}=s,d=this[i];o!==!0||this._$AL.has(i)||d===void 0||this.C(i,void 0,s,d)}}let r=!1,e=this._$AL;try{r=this.shouldUpdate(e),r?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(t){throw r=!1,this._$EM(),t}r&&this._$AE(e)}willUpdate(r){}_$AE(r){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(r)),this.updated(r)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(r){return!0}update(r){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(r){}firstUpdated(r){}};A.elementStyles=[],A.shadowRootOptions={mode:"open"},A[B("elementProperties")]=new Map,A[B("finalized")]=new Map,ut?.({ReactiveElement:A}),(re.reactiveElementVersions??=[]).push("2.1.2");var $e=globalThis,Re=n=>n,se=$e.trustedTypes,Te=se?se.createPolicy("lit-html",{createHTML:n=>n}):void 0,Le="$lit$",T=`lit$${Math.random().toFixed(9).slice(2)}$`,je="?"+T,pt=`<${je}>`,D=document,J=()=>D.createComment(""),X=n=>n===null||typeof n!="object"&&typeof n!="function",xe=Array.isArray,mt=n=>xe(n)||typeof n?.[Symbol.iterator]=="function",fe=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Me=/-->/g,Ne=/>/g,I=RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ie=/'/g,Oe=/"/g,Ue=/^(?:script|style|textarea|title)$/i,we=n=>(r,...e)=>({_$litType$:n,strings:r,values:e}),l=we(1),Mt=we(2),Nt=we(3),L=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),De=new WeakMap,O=D.createTreeWalker(D,129);function ze(n,r){if(!xe(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Te!==void 0?Te.createHTML(r):r}var ft=(n,r)=>{let e=n.length-1,t=[],i,s=r===2?"<svg>":r===3?"<math>":"",o=K;for(let d=0;d<e;d++){let c=n[d],m,_,g=-1,S=0;for(;S<c.length&&(o.lastIndex=S,_=o.exec(c),_!==null);)S=o.lastIndex,o===K?_[1]==="!--"?o=Me:_[1]!==void 0?o=Ne:_[2]!==void 0?(Ue.test(_[2])&&(i=RegExp("</"+_[2],"g")),o=I):_[3]!==void 0&&(o=I):o===I?_[0]===">"?(o=i??K,g=-1):_[1]===void 0?g=-2:(g=o.lastIndex-_[2].length,m=_[1],o=_[3]===void 0?I:_[3]==='"'?Oe:Ie):o===Oe||o===Ie?o=I:o===Me||o===Ne?o=K:(o=I,i=void 0);let R=o===I&&n[d+1].startsWith("/>")?" ":"";s+=o===K?c+pt:g>=0?(t.push(m),c.slice(0,g)+Le+c.slice(g)+T+R):c+T+(g===-2?d:R)}return[ze(n,s+(n[e]||"<?>")+(r===2?"</svg>":r===3?"</math>":"")),t]},G=class n{constructor({strings:r,_$litType$:e},t){let i;this.parts=[];let s=0,o=0,d=r.length-1,c=this.parts,[m,_]=ft(r,e);if(this.el=n.createElement(m,t),O.currentNode=this.el.content,e===2||e===3){let g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(i=O.nextNode())!==null&&c.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(let g of i.getAttributeNames())if(g.endsWith(Le)){let S=_[o++],R=i.getAttribute(g).split(T),Q=/([.?@])?(.*)/.exec(S);c.push({type:1,index:s,name:Q[2],strings:R,ctor:Q[1]==="."?ve:Q[1]==="?"?_e:Q[1]==="@"?ye:q}),i.removeAttribute(g)}else g.startsWith(T)&&(c.push({type:6,index:s}),i.removeAttribute(g));if(Ue.test(i.tagName)){let g=i.textContent.split(T),S=g.length-1;if(S>0){i.textContent=se?se.emptyScript:"";for(let R=0;R<S;R++)i.append(g[R],J()),O.nextNode(),c.push({type:2,index:++s});i.append(g[S],J())}}}else if(i.nodeType===8)if(i.data===je)c.push({type:2,index:s});else{let g=-1;for(;(g=i.data.indexOf(T,g+1))!==-1;)c.push({type:7,index:s}),g+=T.length-1}s++}}static createElement(r,e){let t=D.createElement("template");return t.innerHTML=r,t}};function F(n,r,e=n,t){if(r===L)return r;let i=t!==void 0?e._$Co?.[t]:e._$Cl,s=X(r)?void 0:r._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(n),i._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=i:e._$Cl=i),i!==void 0&&(r=F(n,i._$AS(n,r.values),i,t)),r}var ge=class{constructor(r,e){this._$AV=[],this._$AN=void 0,this._$AD=r,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(r){let{el:{content:e},parts:t}=this._$AD,i=(r?.creationScope??D).importNode(e,!0);O.currentNode=i;let s=O.nextNode(),o=0,d=0,c=t[0];for(;c!==void 0;){if(o===c.index){let m;c.type===2?m=new Y(s,s.nextSibling,this,r):c.type===1?m=new c.ctor(s,c.name,c.strings,this,r):c.type===6&&(m=new be(s,this,r)),this._$AV.push(m),c=t[++d]}o!==c?.index&&(s=O.nextNode(),o++)}return O.currentNode=D,i}p(r){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(r,t,e),e+=t.strings.length-2):t._$AI(r[e])),e++}},Y=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(r,e,t,i){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=r,this._$AB=e,this._$AM=t,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let r=this._$AA.parentNode,e=this._$AM;return e!==void 0&&r?.nodeType===11&&(r=e.parentNode),r}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(r,e=this){r=F(this,r,e),X(r)?r===y||r==null||r===""?(this._$AH!==y&&this._$AR(),this._$AH=y):r!==this._$AH&&r!==L&&this._(r):r._$litType$!==void 0?this.$(r):r.nodeType!==void 0?this.T(r):mt(r)?this.k(r):this._(r)}O(r){return this._$AA.parentNode.insertBefore(r,this._$AB)}T(r){this._$AH!==r&&(this._$AR(),this._$AH=this.O(r))}_(r){this._$AH!==y&&X(this._$AH)?this._$AA.nextSibling.data=r:this.T(D.createTextNode(r)),this._$AH=r}$(r){let{values:e,_$litType$:t}=r,i=typeof t=="number"?this._$AC(r):(t.el===void 0&&(t.el=G.createElement(ze(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===i)this._$AH.p(e);else{let s=new ge(i,this),o=s.u(this.options);s.p(e),this.T(o),this._$AH=s}}_$AC(r){let e=De.get(r.strings);return e===void 0&&De.set(r.strings,e=new G(r)),e}k(r){xe(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,i=0;for(let s of r)i===e.length?e.push(t=new n(this.O(J()),this.O(J()),this,this.options)):t=e[i],t._$AI(s),i++;i<e.length&&(this._$AR(t&&t._$AB.nextSibling,i),e.length=i)}_$AR(r=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);r!==this._$AB;){let t=Re(r).nextSibling;Re(r).remove(),r=t}}setConnected(r){this._$AM===void 0&&(this._$Cv=r,this._$AP?.(r))}},q=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(r,e,t,i,s){this.type=1,this._$AH=y,this._$AN=void 0,this.element=r,this.name=e,this._$AM=i,this.options=s,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=y}_$AI(r,e=this,t,i){let s=this.strings,o=!1;if(s===void 0)r=F(this,r,e,0),o=!X(r)||r!==this._$AH&&r!==L,o&&(this._$AH=r);else{let d=r,c,m;for(r=s[0],c=0;c<s.length-1;c++)m=F(this,d[t+c],e,c),m===L&&(m=this._$AH[c]),o||=!X(m)||m!==this._$AH[c],m===y?r=y:r!==y&&(r+=(m??"")+s[c+1]),this._$AH[c]=m}o&&!i&&this.j(r)}j(r){r===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,r??"")}},ve=class extends q{constructor(){super(...arguments),this.type=3}j(r){this.element[this.name]=r===y?void 0:r}},_e=class extends q{constructor(){super(...arguments),this.type=4}j(r){this.element.toggleAttribute(this.name,!!r&&r!==y)}},ye=class extends q{constructor(r,e,t,i,s){super(r,e,t,i,s),this.type=5}_$AI(r,e=this){if((r=F(this,r,e,0)??y)===L)return;let t=this._$AH,i=r===y&&t!==y||r.capture!==t.capture||r.once!==t.once||r.passive!==t.passive,s=r!==y&&(t===y||i);i&&this.element.removeEventListener(this.name,this,t),s&&this.element.addEventListener(this.name,this,r),this._$AH=r}handleEvent(r){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,r):this._$AH.handleEvent(r)}},be=class{constructor(r,e,t){this.element=r,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(r){F(this,r)}};var gt=$e.litHtmlPolyfillSupport;gt?.(G,Y),($e.litHtmlVersions??=[]).push("3.3.2");var Fe=(n,r,e)=>{let t=e?.renderBefore??r,i=t._$litPart$;if(i===void 0){let s=e?.renderBefore??null;t._$litPart$=i=new Y(r.insertBefore(J(),s),s,void 0,e??{})}return i._$AI(n),i};var ke=globalThis,p=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let r=super.createRenderRoot();return this.renderOptions.renderBefore??=r.firstChild,r}update(r){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(r),this._$Do=Fe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}};p._$litElement$=!0,p.finalized=!0,ke.litElementHydrateSupport?.({LitElement:p});var vt=ke.litElementPolyfillSupport;vt?.({LitElement:p});(ke.litElementVersions??=[]).push("4.2.2");var v=n=>(r,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(n,r)}):customElements.define(n,r)};var _t={attribute:!0,type:String,converter:V,reflect:!1,hasChanged:ie},yt=(n=_t,r,e)=>{let{kind:t,metadata:i}=e,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),s.set(e.name,n),t==="accessor"){let{name:o}=e;return{set(d){let c=r.get.call(this);r.set.call(this,d),this.requestUpdate(o,c,n,!0,d)},init(d){return d!==void 0&&this.C(o,void 0,n,d),d}}}if(t==="setter"){let{name:o}=e;return function(d){let c=this[o];r.call(this,d),this.requestUpdate(o,c,n,!0,d)}}throw Error("Unsupported decorator location: "+t)};function h(n){return(r,e)=>typeof e=="object"?yt(n,r,e):((t,i,s)=>{let o=i.hasOwnProperty(s);return i.constructor.createProperty(s,t),o?Object.getOwnPropertyDescriptor(i,s):void 0})(n,r,e)}function u(n){return h({...n,state:!0,attribute:!1})}var bt=["ha-input","ha-textfield","ha-form"],$t=["ha-input","ha-textfield"];function qe(){for(let n of $t)if(customElements.get(n))return n;return null}function M(n,r){for(let e of bt)customElements.get(e)||customElements.whenDefined(e).then(()=>n.requestUpdate())}async function We(n){return n.callWS({type:"ambience/areas/list"})}async function Be(n,r){return n.callWS({type:"ambience/area/get",area_id:r})}async function Ve(n,r,e){return n.callWS({type:"ambience/area/save",area_id:r,config:e})}async function Ke(n){return n.callWS({type:"ambience/matchers/list"})}async function Je(n){return n.callWS({type:"ambience/actions/list"})}async function oe(n){return n.callWS({type:"ambience/time_of_day_periods/list"})}async function Xe(n,r,e){return n.callWS({type:"ambience/time_of_day_periods/save",custom:r,hidden:e})}async function Ge(n){return n.callWS({type:"ambience/time_of_day_periods/reset"})}function ae(n,r,e){let t=n?.localize?.(r);return t&&t!==r?t:e}function Ee(n){let r=n.replaceAll("_"," ").toLowerCase();return r.charAt(0).toUpperCase()+r.slice(1)}function le(n,r){return ae(n,`component.ambience.matcher.${r}`,Ee(r))}function Ye(n,r){return ae(n,`component.ambience.action.${r}`,Ee(r))}function de(n,r){return ae(n,`component.ambience.anchor.${r}`,Ee(r))}function j(n,r,e){let t=e[r]?.label;if(t)return t;let i=r.charAt(0).toUpperCase()+r.slice(1);return ae(n,`component.ambience.time_of_day_period.${r}`,i)}function ce(n,r="New rule"){if(n.name&&n.name.trim())return n.name;let e=n.when?.scene;return typeof e=="string"&&e.trim()?e:r}function he(n,r,e){return r==null?"(any)":n==="time_of_day"?ue(r,e):String(r)}function ue(n,r){if(n===null)return"any";let e=Array.isArray(n)?n:[n],t=r.periods?.custom??{};return e.map(i=>"period"in i?j(r.hass,i.period,t):`${Ze(i.from,r)} \u2192 ${Ze(i.to,r)}`).join(", ")}function Ze(n,r){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;let e=de(r.hass,n.anchor);if(n.offset_min===0)return e;let t=Math.abs(n.offset_min),i=t%60===0?`${t/60}h`:`${t}m`;return`${e}${n.offset_min<0?"-":"+"}${i}`}function Qe(n,r,e){let t=Ye(e.hass,n.action),i=r?.domains?.[0]??"target",s=n.entity_ids.length,o;s===0?o="(no targets)":s===1?o=`1 ${i}`:o=`${s} ${i}s`;let d={};for(let m of r?.target_params??[])m.unit&&(d[m.name]=m.unit);let c=Object.entries(n.params).filter(([,m])=>m!=null&&m!=="").map(([m,_])=>`${m} ${_}${d[m]??""}`).join(", ");return c?`${t}: ${o}, ${c}`:`${t}: ${o}`}var w=class extends p{constructor(){super(...arguments);this.rules=[];this.autoSort=!0;this._dragFrom=null;this._dragOver=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_summary(e){let t=Object.keys(e.when).filter(o=>e.when[o]!=null),i=t.length===0?"any":t.map(o=>`${le(this.hass,o)}: ${he(o,e.when[o],{hass:this.hass,periods:this.periods})}`).join(", "),s=e.actions.length;return`${i} \xB7 ${s} action${s===1?"":"s"}`}_onDragStart(e){this._dragFrom=e}_onDragOver(e,t){this._dragFrom===null||t===this._dragFrom||(e.preventDefault(),this._dragOver=t)}_onDrop(e){let t=this._dragFrom;this._dragFrom=null,this._dragOver=null,!(t===null||t===e)&&this._emit("reorder-rules",{from:t,to:e})}_onDragEnd(){this._dragFrom=null,this._dragOver=null}_confirmDelete(e,t){let i=t.name||`Rule ${e+1}`;window.confirm(`Delete "${i}"?`)&&this._emit("delete-rule",{index:e})}render(){return this.rules.length===0?l`
  ...
  `,a([h({attribute:!1})],k.prototype,"hass",2),a([h()],k.prototype,"value",2),a([h({attribute:!1})],k.prototype,"suggestions",2),a([u()],k.prototype,"_schema",2),a([u()],k.prototype,"_open",2),k=a([v("ambience-scene-combobox")],k);function xt(n){return n.name==="scene"?"Scene name":n.name}var wt=["dawn","sunrise","noon","sunset","dusk","midnight"],U=class extends p{constructor(){super(...arguments);this.value={kind:"time",hh:12,mm:0}}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onKindChange(e){let t=e.target.value;t!==this.value.kind&&(t==="time"?this._emit({kind:"time",hh:12,mm:0}):this._emit({kind:"sun",anchor:"sunset",offset_min:0}))}_onTimeChange(e){if(this.value.kind!=="time")return;let t=e.target.value,[i,s]=t.split(":").map(o=>parseInt(o,10));Number.isNaN(i)||Number.isNaN(s)||this._emit({kind:"time",hh:i,mm:s})}_onAnchorChange(e){if(this.value.kind!=="sun")return;let t=e.target.value;this._emit({kind:"sun",anchor:t,offset_min:this.value.offset_min})}_onOffsetChange(e){if(this.value.kind!=="sun")return;let t=parseInt(e.target.value,10);Number.isNaN(t)||this._emit({kind:"sun",anchor:this.value.anchor,offset_min:t})}_renderTime(e){let t=`${String(e.hh).padStart(2,"0")}:${String(e.mm).padStart(2,"0")}`;return l`<input type="time" .value=${t} @input=${this._onTimeChange} />`}_renderSun(e){let t=kt(e.offset_min);return l`
      <select @change=${this._onAnchorChange}>
        ${wt.map(i=>l`<option value=${i} ?selected=${i===e.anchor}>${de(this.hass,i)}</option>`)}
      </select>
      <input
        type="number"
        step="1"
  ...
  `,a([h({attribute:!1})],C.prototype,"matcher",2),a([h({attribute:!1})],C.prototype,"value",2),a([h({attribute:!1})],C.prototype,"sceneSuggestions",2),a([h({attribute:!1})],C.prototype,"periods",2),a([h({attribute:!1})],C.prototype,"hass",2),C=a([v("ambience-matcher-input")],C);var N=class extends p{constructor(){super(...arguments);this.entities=[];this.value=[]}connectedCallback(){super.connectedCallback(),M(this,this.hass)}_emit(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let e=[{name:"entity_ids",label:"",selector:{entity:{multiple:!0,include_entities:this.entities}}}];return l`
      <ha-form
        .hass=${this.hass}
        .schema=${e}
  ...
  `,a([h({attribute:!1})],N.prototype,"hass",2),a([h({attribute:!1})],N.prototype,"entities",2),a([h({attribute:!1})],N.prototype,"value",2),N=a([v("ambience-target-picker")],N);var b=class extends p{constructor(){super(...arguments);this.open=!1;this.rule=null;this.matchers=[];this.sceneSuggestions=[];this.availableActions=[];this._draft=null;this._open=null;this._showError=!1;this._onNameInput=e=>{this._setName(e.target.value)}}connectedCallback(){super.connectedCallback(),M(this,this.hass)}willUpdate(e){e.has("rule")&&(this._draft=this.rule?JSON.parse(JSON.stringify(this.rule)):null,this._open=null,this._showError=!1)}_setName(e){this._draft&&(this._draft={...this._draft,name:e||void 0})}_renderNameSlot(){let e=this._draft.name??"";if(this._isOpen({kind:"name"}))return l`
    ...
    `}_renderNameInputControl(e){let t=qe();return t==="ha-input"?l`<ha-input label="Name (optional)" .value=${e} @input=${this._onNameInput}></ha-input>`:t==="ha-textfield"?l`<ha-textfield label="Name (optional)" .value=${e} @input=${this._onNameInput}></ha-textfield>`:l`<input type="text" .value=${e} @input=${this._onNameInput} />`}_isOpen(e){return this._open===null?!1:e.kind==="name"&&this._open.kind==="name"?!0:e.kind==="matcher"&&this._open.kind==="matcher"?e.id===this._open.id:e.kind==="action"&&this._open.kind==="action"?e.idx===this._open.idx:!1}_validationError(e){if(e===null||e.kind==="name"||e.kind==="matcher")return null;let t=this._draft?.actions[e.idx];if(!t)return null;if(t.entity_ids.length===0)return"At least one target is required.";let i=this.availableActions.find(s=>s.name===t.action);if(!i)return null;for(let s of i.target_params){if(!s.required)continue;let o=t.params[s.name];if(o==null||o==="")return`${this._paramLabel(s.name)} is required.`}return null}_tryCloseCurrent(){return this._open===null?!0:this._validationError(this._open)!==null?(this._showError=!0,!1):(this._open=null,this._showError=!1,!0)}_toggleSlot(e){if(this._isOpen(e)){this._tryCloseCurrent();return}this._open!==null&&!this._tryCloseCurrent()||(this._open=e,this._showError=!1)}_onModalClick(e){for(let t of e.composedPath())if(t instanceof Element&&(t.classList.contains("slot")||t.classList.contains("actions-bar")))return;this._tryCloseCurrent()}_setPredicate(e,t){if(!this._draft)return;let i={...this._draft.when};t==null?delete i[e]:i[e]=t,this._draft={...this._draft,when:i}}_renderMatcherRow(e){let t=this._draft.when[e.name]??null,i=this._isOpen({kind:"matcher",id:e.name}),s=e.input==="scene_combobox";if(i&&s)return l`
      ...
      `;let o=he(e.name,t,{hass:this.hass,periods:this.periods});return l`
    ...
    `}_addActionSlot(){if(!this._draft)return;let e={action:"set_light",entity_ids:[],params:{}},t=this._draft.actions.length;this._draft={...this._draft,actions:[...this._draft.actions,e]},this._open={kind:"action",idx:t}}_updateActionAt(e,t){if(!this._draft)return;let i=this._draft.actions.map((s,o)=>o===e?t(s):s);this._draft={...this._draft,actions:i}}_deleteAction(e){this._draft&&(this._draft={...this._draft,actions:this._draft.actions.filter((t,i)=>i!==e)},this._open?.kind==="action"&&this._open.idx===e&&(this._open=null))}_setActionTargets(e,t){this._updateActionAt(e,i=>({...i,entity_ids:t}))}_paramLabel(e){let t=e.replaceAll("_"," ").toLowerCase();return t.charAt(0).toUpperCase()+t.slice(1)}_updateActionParam(e,t,i){this._updateActionAt(e,s=>{let o={...s.params},d=i;if(t.type==="int"?d=i===""?void 0:parseInt(i,10):t.type==="number"?d=i===""?void 0:parseFloat(i):t.type==="boolean"&&(d=i==="true"),typeof d=="number"&&Number.isFinite(d)){let c=d;typeof t.min=="number"&&c<t.min&&(c=t.min),typeof t.max=="number"&&c>t.max&&(c=t.max),d=c}return d===void 0?delete o[t.name]:o[t.name]=d,{...s,params:o}})}_renderActionParams(e,t,i){let s=i?.target_params??[];return l`
      ${s.map(o=>l`
        <div class="param-row">
      ...
      `)}
    `}_renderActionRow(e,t){let i=this.availableActions.find(c=>c.name===e.action),s=this._isOpen({kind:"action",idx:t}),o=Qe(e,i,{hass:this.hass}),d=et(this.hass,this.areaId,i?.domains??[]);return l`
  ...
  `,a([h({attribute:!1})],$.prototype,"hass",2),a([u()],$.prototype,"_areas",2),a([u()],$.prototype,"_matchers",2),a([u()],$.prototype,"_actions",2),a([u()],$.prototype,"_periods",2),a([u()],$.prototype,"_configs",2),a([u()],$.prototype,"_expanded",2),a([u()],$.prototype,"_error",2),a([u()],$.prototype,"_editing",2),a([u()],$.prototype,"_matchersModalArea",2),$=a([v("ambience-areas-list")],$);var Et=/^[a-z][a-z0-9_]*$/;function Ct(n){return n.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var x=class extends p{constructor(){super(...arguments);this.initial={from:{kind:"time",hh:9,mm:0},to:{kind:"time",hh:17,mm:0},label:null};this.takenIds=new Set;this._label="";this._def=this.initial;this._error=""}connectedCallback(){super.connectedCallback(),this._label=this.initial.label??"",this._def=this.initial}_onLabelInput(e){this._label=e.target.value}_onFromChange(e){e.stopPropagation(),this._def={...this._def,from:e.detail.value}}_onToChange(e){e.stopPropagation(),this._def={...this._def,to:e.detail.value}}_validate(e){if(!this.existingId){if(!this._label.trim())return"Please enter a name.";if(!e||!Et.test(e))return"Name must start with a letter.";if(this.takenIds.has(e))return"A period with this name already exists. Choose a different name."}return""}_onSave(){let e=this.existingId??Ct(this._label),t=this._validate(e);if(t){this._error=t,this.performUpdate();return}let i={from:this._def.from,to:this._def.to,label:this._label.trim()||null};this.dispatchEvent(new CustomEvent("period-save",{detail:{id:e,definition:i},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent("period-cancel",{bubbles:!0,composed:!0}))}render(){let e=this.existingId?`Edit "${this.initial?.label??this.existingId}"`:"Add custom period";return l`
  ...
  `,a([h({attribute:!1})],x.prototype,"hass",2),a([h({attribute:!1})],x.prototype,"existingId",2),a([h({attribute:!1})],x.prototype,"initial",2),a([h({attribute:!1})],x.prototype,"takenIds",2),a([u()],x.prototype,"_label",2),a([u()],x.prototype,"_def",2),a([u()],x.prototype,"_error",2),x=a([v("ambience-period-edit-modal")],x);function rt(n){if(n.kind==="time")return`${String(n.hh).padStart(2,"0")}:${String(n.mm).padStart(2,"0")}`;if(n.offset_min===0)return n.anchor;let r=Math.abs(n.offset_min),e=r%60===0?`${r/60}h`:`${r}m`;return`${n.anchor}${n.offset_min<0?"-":"+"}${e}`}function St(n){return`${rt(n.from)} \u2192 ${rt(n.to)}`}var H=class extends p{constructor(){super(...arguments);this._view={builtins:{},custom:{},hidden:[]};this._modal={mode:"closed"};this._warnings=[]}async connectedCallback(){super.connectedCallback(),await this._reload()}async _reload(){this._view=await oe(this.hass)}_effective(){let e=new Set(this._view.hidden),t=[];for(let[i,s]of Object.entries(this._view.builtins)){if(e.has(i))continue;let o=this._view.custom[i];o?t.push({id:i,defn:o,provenance:"builtin-edited"}):t.push({id:i,defn:s,provenance:"builtin"})}for(let[i,s]of Object.entries(this._view.custom))i in this._view.builtins||t.push({id:i,defn:s,provenance:"custom"});return t}async _saveState(e,t){let i=await Xe(this.hass,e,t);this._warnings=i.warnings,await this._reload()}_onEdit(e,t){this._modal={mode:"edit",id:e,initial:t}}async _onDelete(e){if(e in this._view.builtins){let i={...this._view.custom};delete i[e],await this._saveState(i,[...this._view.hidden,e])}else{let i={...this._view.custom};delete i[e],await this._saveState(i,this._view.hidden)}}async _onRevertEdited(e){let t={...this._view.custom};delete t[e],await this._saveState(t,this._view.hidden)}async _onRevertHidden(e){await this._saveState(this._view.custom,this._view.hidden.filter(t=>t!==e))}async _onResetAll(){let e=Object.keys(this._view.custom).length,t=this._view.hidden.length,i=`This will clear ${e} custom period(s) and restore ${t} hidden built-in(s). Continue?`;confirm(i)&&(await Ge(this.hass),this._warnings=[],await this._reload())}_onAdd(){this._modal={mode:"add"}}async _onModalSave(e){e.stopPropagation();let{id:t,definition:i}=e.detail,s={...this._view.custom,[t]:i},o=this._view.hidden.filter(d=>d!==t);this._modal={mode:"closed"},await this._saveState(s,o)}_onModalCancel(){this._modal={mode:"closed"}}_renderRow(e){let t=this._view.custom,i=e.provenance==="builtin-edited",s=e.provenance==="custom";return l`
      <div class="row">
        <span class="name">${j(this.hass,e.id,t)}</span>
        <span class="def">${St(e.defn)}</span>
  ...
  `,a([h({attribute:!1})],H.prototype,"hass",2),a([u()],H.prototype,"_view",2),a([u()],H.prototype,"_modal",2),a([u()],H.prototype,"_warnings",2),H=a([v("ambience-periods-view")],H);var z=class extends p{constructor(){super(...arguments);this._view="areas"}connectedCallback(){super.connectedCallback(),M(this)}render(){return l`
      <header>
        <h1>Ambience</h1>
        <nav>
          <button
  ...
  `,a([h({attribute:!1})],z.prototype,"hass",2),a([u()],z.prototype,"_view",2),z=a([v("ambience-panel")],z);export{z as AmbiencePanel};
