...
`)}
  ...
  `,c([m({attribute:!1})],O.prototype,"scenes",2),c([m({attribute:!1})],O.prototype,"periods",2),c([m({attribute:!1})],O.prototype,"luxRanges",2),c([m({attribute:!1})],O.prototype,"weatherConfig",2),c([m({attribute:!1})],O.prototype,"hass",2),c([m({attribute:!1})],O.prototype,"conditions",2),c([m({attribute:!1})],O.prototype,"availableActions",2),c([m({attribute:!1})],O.prototype,"schemas",2),c([m({attribute:!1})],O.prototype,"categories",2),c([m({attribute:!1})],O.prototype,"filterCategory",2),c([m({attribute:!1})],O.prototype,"collapsedCategories",2),c([m({attribute:!1})],O.prototype,"scope",2),c([m({attribute:!1})],O.prototype,"live",2),c([m({attribute:!1})],O.prototype,"liveSuppressed",2),c([g()],O.prototype,"_expanded",2),O=c([w("ambience-scenes-list")],O);var de=class extends b{constructor(){super(...arguments);this.entities=[];this.value=[];this.target=null;this.label=" "}_filteredEntities(){return Ns(this.entities,this.target)}connectedCallback(){super.connectedCallback(),ie(this)}_emit(e){L(this,e)}_onHaFormChange(e){e.stopPropagation(),this._emit(e.detail.value.entity_ids??[])}_renderHaForm(){let i=[{name:"entity_ids",selector:{entity:{multiple:!0,include_entities:this._filteredEntities()}}}],n=this.label;return d`
      <ha-form
        .hass=${this.hass}
        .schema=${i}
...
`;function Zo(t,r){t.stopPropagation(),t.currentTarget.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}function an(t,r,e){let i=n=>{(n.key==="Enter"||n.key===" ")&&!n.repeat&&(n.preventDefault(),Zo(n,r))};return d`<span
  ...
  `,c([m({attribute:!1})],Ee.prototype,"hass",2),c([m()],Ee.prototype,"conditionName",2),c([m()],Ee.prototype,"conditionDescription",2),c([g()],Ee.prototype,"_expanded",2),Ee=c([w("ambience-condition-card")],Ee);var mu=/^[a-z][a-z0-9_]*$/;function fu(t){return t.toLowerCase().trim().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}var si=y`
  :host {
    position: fixed; inset: 0;
    display: flex; align-items: center; justify-content: center;
    background: rgba(0, 0, 0, 0.45); z-index: 1000;
...
`,oe=class extends b{constructor(){super(...arguments);this.takenIds=new Set;this._label="";this._error=""}static{this.styles=si}connectedCallback(){super.connectedCallback(),this._label=this._initialLabel()??""}_onLabelInput(e){this._label=e.target.value}_validateName(e){return this.existingId?"":this._label.trim()?!e||!mu.test(e)?a(this.hass,"ui.error_start_letter","Name must start with a letter."):this.takenIds.has(e)?a(this.hass,"ui.error_name_exists","An entry with this name already exists. Choose a different name."):"":a(this.hass,"ui.error_enter_name","Please enter a name.")}_onSave(){let e=this.existingId??fu(this._label),i=this._validateName(e)||this._validateDef();if(i){this._error=i,this.performUpdate();return}this.dispatchEvent(new CustomEvent(this._saveEvent,{detail:{id:e,definition:this._buildDefinition()},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent(this._cancelEvent,{bubbles:!0,composed:!0}))}render(){let e=this.existingId?this._editTitleTemplate().replace("{name}",this._initialLabel()??this.existingId):this._addTitle();return d`
  ...
  `}connectedCallback(){super.connectedCallback(),ie(this),this.addEventListener("ambience-open-settings",this._onOpenSettings),this.addEventListener("ambience-filter-changed",this._onFilterChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("ambience-open-settings",this._onOpenSettings),this.removeEventListener("ambience-filter-changed",this._onFilterChanged)}render(){let e={dark:!!this.hass.themes?.darkMode,title:a(this.hass,"ui.panel_title","Ambience")};return d`
      ...
      ></ambience-settings-modal>
    `}};c([m({attribute:!1})],lt.prototype,"hass",2),c([g()],lt.prototype,"_settingsOpen",2),c([g()],lt.prototype,"_settingsTab",2),c([g()],lt.prototype,"_filterCategory",2);Sn("ambience-frontend",lt);export{lt as AmbienceFrontend};
